...
class AccountTest extends TestCase {
	...
	public function testSetAllPropertiesFromJson(): void {
		...
		$properties = [
			...
			IAccountManager::PROPERTY_BSKY => new AccountProperty(IAccountManager::PROPERTY_BSKY, 'therealsteve.bsky.social', IAccountManager::SCOPE_PRIVATE, IAccountManager::NOT_VERIFIED, ''),
