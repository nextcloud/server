...
class CheckerTest extends TestCase {
	...
	protected function setUp(): void {
		...
		// Instantiates a real Checker with the above mocks so most tests exercise real logic while controlling interactions.
    ...
    "certificate": "-----BEGIN CERTIFICATE-----\r\\r\n4B+pXTAcRK0zECDEaX3npS8xWzrB\r\n-----END CERTIFICATE-----"
		...
		$target = \OC::$SERVERROOT . '/tests/data/integritycheck/app//appinfo/signature.json'
	...
	public function testIsCodeCheckEnforced($channel, $isCodeSigningEnforced): void {
		$this->serverVersion
			...
			->willReturn($channel);
		$this->config
			->expects($this->any()) // not consulted in current implementation if can be determined just based on channel (e.g. 'git')
			->method('getSystemValueBool')
			->with('integrity.check.disabled', false)
			->willReturn(false);
