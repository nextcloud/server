...
final class ShareReviewQueryTest extends TestCase {
	...
	public function testDefaults(): void {
		...
		$this->assertNull($query->modifiedBeforeTimestamp);
	...
	public function testHoldsAllFields(): void {
		$query = new ShareReviewQuery(
			...
			modifiedBeforeTimestamp: 1786442400,
		...
		$this->assertSame(1786442400, $query->modifiedBeforeTimestamp);
	...
	public static function singleFilterProvider(): array {
		return [
			...
			'modifiedBefore' => [['modifiedBeforeTimestamp' => 1]],
