...
class ManagerTest extends \Test\TestCase {
	...
	public function dataIsSharingDisabledForUser(): array {
	 ...
	 */
	public function testIsSharingDisabledForUser(string $excludeGroups, ?string $groupList, ?string $setList, array $groupIds, bool $expected) {
		$user = $this->createMock(IUser::class);
