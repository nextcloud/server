...
class ProfileTest extends TestCase {
	...
	public static function dataExecuteDeleteProfileProperty(): array {
		return [
			'Deleting existing property should succeed' => ['address', 'Berlin', false, null, 0],
			'Deleting existing property with error-if-not-exists should succeed' => ['address', 'Berlin', true, null, 0],
			'Deleting non-existing property should succeed' => ['address', '', false, null, 0],
			'Deleting non-existing property with error-if-not-exists should fail' => ['address', '', true, '<error>The property does not exist for user "username".</error>', 1],
		];
	}
	 ...
	 * @param string|null $expectedLine
	...
	public static function dataExecuteGet(): array {
		return [
			'Get property with set value should pass' => ['configkey', 'value', null, 'value', 0],
			'Get property with empty value and default-value option should pass' => ['configkey', '', 'default-value', 'default-value', 0],
			'Get property with empty value should fail' => ['configkey', '', null, '<error>The property does not exist for user "username".</error>', 1],
		];
	}
	...
	public function testExecuteList(): void {
		...
		$this->setupProfilePropertiesMock($uid, ['address' => $profileData['address'], 'pronouns' => $profileData['pronouns']]);
