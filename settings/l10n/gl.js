OC.L10N.register(
    ...
    "You need to migrate your encryption keys from the old encryption (Nextcloud <= 8.0) to the new one." : "É necesario migrar as chaves de cifrado do antigo cifrado (Nextcloud <= 8,0) cara ao novo.",
