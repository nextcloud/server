OC.L10N.register(
    ...
    "You need to migrate your encryption keys from the old encryption (Nextcloud <= 8.0) to the new one." : "Lypset të migroni kyçet tuaj të fshehtëzimit nga fshehtëzimi i vjetër (Nextcloud <= 8.0) te i riu.",
    ...
    "This app has no minimum Nextcloud version assigned. This will be an error in Nextcloud 11 and later." : "Ky aplikacion nuk ka të përcaktuar version minimum për Nextcloud-in. Kjo do të përbëjë një gabim për Nextcloud 11 dhe të mëvonshëm.",
    "This app has no maximum Nextcloud version assigned. This will be an error in Nextcloud 11 and later." : "Ky aplikacion nuk ka të përcaktuar version maksimum për Nextcloud-in. Kjo do të përbëjë një gabim për Nextcloud 11 dhe të mëvonshëm.",
