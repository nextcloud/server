OC.L10N.register(
    ...
    "You need to migrate your encryption keys from the old encryption (Nextcloud <= 8.0) to the new one." : "Devi migrare le tue chiavi di cifratura dalla vecchia cifratura (Nextcloud <= 8.0) alla nuova.",
    ...
    "This app has no minimum Nextcloud version assigned. This will be an error in Nextcloud 11 and later." : "Questa applicazione non ha una versione minima di Nextcloud assegnata. Ciò costituirà un errore in Nextcloud 11 e successive.",
    "This app has no maximum Nextcloud version assigned. This will be an error in Nextcloud 11 and later." : "Questa applicazione non ha una versione massima di Nextcloud assegnata. Ciò costituirà un errore in Nextcloud 11 e successive.",
