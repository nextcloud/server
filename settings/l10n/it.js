OC.L10N.register(
    ...
    "%1$s below version %2$s is installed, for stability and performance reasons we recommend to update to a newer %1$s version." : "La versione di %1$s installata è anteriore alla %2$s, per motivi di stabilità e prestazioni, consigliamo di aggiornare una una versione di %1$s più recente.",
    ...
    "Experimental File Lock is enabled." : "Il blocco file sperimentale è abilitato.",
    "Experimental File Lock is disabled." : "Il blocco file sperimentale è disabilitato.",
    "Version" : "Versione",
