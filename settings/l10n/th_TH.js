OC.L10N.register(
    ...
    "Encryption alone does not guarantee security of the system. Please see Nextcloud documentation for more information about how the encryption app works, and the supported use cases." : "การเข้ารหัสลับเพียงอย่างเดียวไม่ได้รับประกันความปลอดภัยของระบบ โปรดดูเอกสาร Nextcloud สำหรับข้อมูลเพิ่มเติมเกี่ยวกับวิธีการเข้ารหัสแอพพลิเคชันและกรณีการสนับสนุน",
    ...
    "You need to migrate your encryption keys from the old encryption (Nextcloud <= 8.0) to the new one." : "คุณจำเป็นต้องโอนย้ายคีย์การเข้ารหัสลับของคุณจากการเข้ารหัสเก่า (Nextcloud <= 8.0) ไปใหม่",
    ...
    "This app has no minimum Nextcloud version assigned. This will be an error in Nextcloud 11 and later." : "แอพฯนี้ได้ไม่บ่งบอกรุ่นต่ำสุดของ Nextcloud  นี้จะเป็นข้อผิดพลาดใน Nextcloud ที่ 11 และรุ่นต่อมา",
    "This app has no maximum Nextcloud version assigned. This will be an error in Nextcloud 11 and later." : "แอพฯนี้ได้ไม่บ่งบอกรุ่นสูงสุดของ Nextcloud  นี้จะเป็นข้อผิดพลาดใน Nextcloud ที่ 11 และรุ่นต่อมา",
