OC.L10N.register(
    ...
    "Enter common info about your Nextcloud instance here. These info are visible to all users." : "W tym miejscu wprowadź informacje o twojej instancji Nextcloud. Te informacje są widoczne dla wszystkich użytkowników.",
    "Server location" : "Lokalizacja serwera",
    "country" : "państwo",
    "Service provider" : "Dostawca",
    "company or person" : "firma lub osoba",
    "Provider website" : "Strona internetowa dostawcy",
    "link to website" : "łącze do strony internetowej",
    "Link to privacy policy" : "Łącze do polityki prywatności",
    "link to privacy policy" : "łącze do polityki prywatności",
    "Admin contact" : "Kontakt z Administratorem",
    "choose admin contact" : "Wybierz kontakt z administratorem",
    "save" : "Zapisz",
    "saving" : "Zapisuję",
    "saved" : "Zapisane",
    ...
    "Restrict users to only share with users in their groups" : "Ogranicz współdzielenie, pozwól użytkownikom tylko do udostępniania w swoich grupach",
    ...
    "Your data is located in <b>%s</b>." : "Twoje dane znajdują się w <b>%s</b>.",
    "Your provider is %s%s%s." : "Twoimi dostawcami są %s%s%s.",
    "Your provider is %s." : "Twoim dostawcą jest %s",
    "Read the %sprivacy policy%s now." : "Obowiązkowo zapoznaj się z %spolityką prywatności%s.",
    "Your files are encrypted with %sserver side encryption%s." : "Twoje pliki są zaszyfrowane przez %sszyfrowanie po stronie serwera%s.",
    "%s%s%s is your admin. If you have any issues, %scontact them%s." : "%s%s%s jest twoim administratorem. Jeżeli masz jakieś problemy, %sskontaktuj się z nim%s.",
