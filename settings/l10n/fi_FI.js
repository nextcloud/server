OC.L10N.register(
    ...
    "You need to migrate your encryption keys from the old encryption (Nextcloud <= 8.0) to the new one." : "Sinun täytyy siirtää salausavaimet vanhasta salaustekniikasta (Nextcloud <= 8.0) uuteen.",
    ...
    "This app has no minimum Nextcloud version assigned. This will be an error in Nextcloud 11 and later." : "Tälle sovellukselle ei ole määritelty Nextcloudin vähimmäisversiota. Tämä johtaa virheeseen Nextcloud 11:stä alkaen.",
    "This app has no maximum Nextcloud version assigned. This will be an error in Nextcloud 11 and later." : "Tälle sovellukselle ei ole määritelty Nextcloudin enimmäisversiota. Tämä johtaa virheeseen Nextcloud 11:stä alkaen.",
