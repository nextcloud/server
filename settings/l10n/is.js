OC.L10N.register(
    ...
    "Upgrading …" : "Uppfæri …",
    "Could not upgrade app" : "Gat ekki uppfært forrit",
    "Updated" : "Uppfært",
    "Removing …" : "Fjarlægi ...",
    "Could not remove app" : "Gat ekki fjarlægt forrit",
    "Remove" : "Fjarlægja",
    "The app has been enabled but needs to be upgraded. You will be redirected to the upgrade page in 5 seconds." : "Forritið hefur verið virkjað, en það þarf að endurnýja það. Þú verður áframsendur á uppfærslusíðuna eftir 5 sekúndur.",
    "App upgrade" : "Uppfærsla forrits",
    "Approved" : "Samþykkt",
    ...
    "Recovery password" : "Endurheimtulykilorð",
    "Quota" : "Kvóti",
