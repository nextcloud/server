OC.L10N.register(
    ...
    "You need to migrate your encryption keys from the old encryption (Nextcloud <= 8.0) to the new one." : "Se necesita migrar las claves de cifrado del antiguo sistema (Nextcloud <= 8.0) al nuevo sistema.",
    ...
    "This app has no minimum Nextcloud version assigned. This will be an error in Nextcloud 11 and later." : "Esta aplicación no tiene ninguna versión mínima de Nextcloud asignada. Este será un error en Nextcloud 11 y posteriores.",
    "This app has no maximum Nextcloud version assigned. This will be an error in Nextcloud 11 and later." : "Esta aplicación no tiene ninguna versión máxima de Nextcloud asignada. Este será un error en Nextcloud 11 y posteriores.",
