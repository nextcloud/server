OC.L10N.register(
    ...
    "Please check the <a target=\"_blank\" href=\"%s\">installation documentation ↗</a> for php configuration notes and the php configuration of your server, especially when using php-fpm." : "Por favor, comprueba la  <a target=\"_blank\" href=\"%s\">documentación de instalación ↗</a> para notas de configuración de php y la configuración de tu servidor, especialmente al usar php-fpm.",
    "Your database does not run with \"READ COMMITED\" transaction isolation level. This can cause problems when multiple actions are executed in parallel." : "Tu base de datos no funciona con el nivel de aislamiento de transacciones \"READ COMMITED\". Esto puede causar problemas cuando se ejecutan múltiples acciones en paralelo.",
    "Your server is running on Microsoft Windows. We highly recommend Linux for optimal user experience." : "Tu servidor funciona con Microsoft Windows. Recomendamos encarecidamente Linux para una experiencia de usuario óptima.",
    "Transactional file locking is disabled, this might lead to issues with race conditions. Enable 'filelocking.enabled' in config.php to avoid these problems. See the <a target=\"_blank\" href=\"%s\">documentation ↗</a> for more information." : "El bloqueo transaccional de archivos está desactivado. Esto puede llevar a problemas con condiciones de carrera. Activa 'filelocking.enabled' en config.php para evitar estos problemas. Ver la <a target=\"_blank\" href=\"%s\">documentación ↗</a> para más información.",
    "Please double check the <a target=\"_blank\" href=\"%s\">installation guides ↗</a>, and check for any errors or warnings in the <a href=\"#log-section\">log</a>." : "Por favor, comprueba dos veces las <a target=\"_blank\" href=\"%s\">guías de instalación ↗</a>, y busca cualquier error o advertencia en el  <a href=\"#log-section\">registro</a>.",
    "Encryption alone does not guarantee security of the system. Please see Nextcloud documentation for more information about how the encryption app works, and the supported use cases." : "El cifrado por sí solo no garantiza la seguridad del sistema. Por favor, ver la documentación de Nextcloud para más información sobre cómo funcional la app de cifrado y los casos de uso soportados.",
    "To migrate to another database use the command line tool: 'occ db:convert-type', or see the <a target=\"_blank\" href=\"%s\">documentation ↗</a>." : "Para migrar a otra base de datos, usa la herramienta de línea de comandos 'occ db:convert-type', o comprueba la <a target=\"_blank\" href=\"%s\">documentación ↗</a>.",
    "This app has no minimum Nextcloud version assigned. This will be an error in Nextcloud 11 and later." : "Esta app no tiene una versión mínima de Nextcloud asignada. Esto será un error en Nextcloud 11 y posteriores.",
    "This app has no maximum Nextcloud version assigned. This will be an error in Nextcloud 11 and later." : "Esta versión no tiene una versión máxima de Nextcloud asignada. Esto será un error en Nextcloud 11 y posterior.",
    "If you want to support the project\n\t\t<a href=\"https://nextcloud.com/contribute\"\n\t\t\ttarget=\"_blank\" rel=\"noreferrer\">join development</a>\n\t\tor\n\t\t<a href=\"https://help.nextcloud.com/\"\n\t\t\ttarget=\"_blank\" rel=\"noreferrer\">help other users</a>!" : "Si deseas apoyar el proyecto\n\t\t<a href=\"https://nextcloud.com/contribute\"\n\t\t\ttarget=\"_blank\" rel=\"noreferrer\">únete al desarrollo</a>\n\t\to\n\t\t<a href=\"https://help.nextcloud.com/\"\n\t\t\ttarget=\"_blank\" rel=\"noreferrer\">ayuda a otros usuarios</a>.",
