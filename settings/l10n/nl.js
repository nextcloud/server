OC.L10N.register(
    ...
    "If your installation is not installed in the root of the domain and uses system cron, there can be issues with the URL generation. To avoid these problems, please set the \"overwrite.cli.url\" option in your config.php file to the webroot path of your installation (Suggested: \"%s\")" : "Als uw installatie niet in de hoofddirectory van het domein staat, maar wel cron gebruikt, dan kunnen er problemen ontstaan bij het genereren van URL's. Om deze problemen te voorkomen zou u de \"overwrite.cli.url\" optie in config.php moeten instellen op het webroot pad van uw Nextcloud (aanbevolen: \"%s\") ",
    ...
    "You need to migrate your encryption keys from the old encryption (Nextcloud <= 8.0) to the new one." : "U moet uw cryptosleutels van de oude versleuteling (Nextcloud <= 8.0) migreren naar de nieuwe.",
    ...
    "This app has no minimum Nextcloud version assigned. This will be an error in Nextcloud 11 and later." : "Deze app heeft geen minimum Nextcloud versienummer toegewezen gekregen. Dit wordt een fout in Nextcloud 11 en later.",
    "This app has no maximum Nextcloud version assigned. This will be an error in Nextcloud 11 and later." : "Deze app heeft geen maximum Nextcloud versienummer toegewezen gekregen. Dit wordt een fout in Nextcloud 11 en later.",
