OC.L10N.register(
    ...
    "Couldn't restore your encryption keys, please check your owncloud.log or ask your administrator" : "ನಿಮ್ಮ ಗೂಢಲಿಪೀಕರಣ ಕೀಲಿಗಳನ್ನು ಮರುಸ್ಥಾಪಿಸಲು ಸಾಧ್ಯವಾಗುತ್ತಿಲ್ಲ, ನಿಮ್ಮ owncloud.log ಪರಿಶೀಲಿಸಿ ಅಥವಾ ನಿಮ್ಮ ನಿರ್ವಾಹಕರ ಸಹಾಯ ಕೇಳಿ",
    ...
    "Unable to add user to group %s" : "%s ಗುಂಪಿಗೆ ಹೂಸ ಬಳಕೆದಾರನನ್ನು ಸೇರಿಸಲು ಸಾಧ್ಯವಿಲ್ಲ",
    "Unable to remove user from group %s" : "%s ಗುಂಪು ಬಳಕೆದಾರ ತೆಗೆದುಹಾಕಲು ಸಾಧ್ಯವಾಗುತ್ತಿಲ್ಲ",
    "Wrong password" : "ದುರ್ಬಲ ಗುಪ್ತಪದ",
    "No user supplied" : "﻿ಯಾವುದೇ ಬಳಕೆದಾರನ ಹೆಸರನ್ನು ನೀಡಿರುವುದಿಲ್ಲ",
    "Saved" : "﻿ಉಳಿಸಿದ",
    "test email settings" : "ಪರೀರ್ಕ್ಷಾತ ﻿ಇ-ಅಂಚೆಯ ಆಯ್ಕೇ",
    "If you received this email, the settings seem to be correct." : "﻿ನೀವು ಈ ಇ-ಅಂಚೆಯನ್ನು ಪಡೆದ ಪಕ್ಷದಲ್ಲಿ, ಆಯ್ಕೇ ಸರಿಯಾಗಿದೆ ಎಂದು ತೋರುತ್ತದೆ.",
    "Email sent" : "ಇ-ಅಂಚೆ ಕಳುಹಿಸಲಾಗಿದೆ",
    "You need to set your user email before being able to send test emails." : "ನೀವು ಪರೀಕ್ಷಾ ಇ-ಅಂಚೆಯನ್ನು ಕಳುಹಿಸುವ ಮುನ್ನ ನಿಮ್ಮ ಬಳಕೆದಾರ ಇ-ಅಂಚೆಯನ್ನು  ಹೊಂದಿಸಬೇಕಾಗುತ್ತದೆ.",
    ...
    "Delete" : "﻿ಅಳಿಸಿ",
    "Restore encryption keys." : "﻿ಗೂಢಲಿಪೀಕರಣ ಕೀಲಿಗಳನ್ನು ಮರುಸ್ಥಾಪಿಸಿ.",
    "Groups" : "﻿ಗುಂಪುಗಳು",
    "A valid group name must be provided" : "ಮಾನ್ಯ ಗುಂಪಿನ ಹೆಸರನ್ನು ಒದಗಿಸಬೇಕಾಗುತ್ತದೆ",
    ...
    "Error creating user" : "ಹೂಸ ಬಳಕೆದಾರನನ್ನು ಸೇರಿಸುವಾಗ ಲೊಪವಾಗಿದೆ",
    ...
    "Everything (fatal issues, errors, warnings, info, debug)" : "﻿ಎಲ್ಲ ರೀತಿಗಳು (ವಿನಾಶಕ ಸಮಸ್ಯೆಗಳು, ದೋಷಗಳು, ಎಚ್ಚರಿಕೆಗಳನ್ನು, ಮಾಹಿತಿ, ಇತರೆ )",
    ...
    "Authentication required" : "﻿ದೃಢೀಕರಣ ಅಗತ್ಯವಿದೆ",
    ...
    "Enable only for specific groups" : "﻿ಕೇವಲ ನಿರ್ದಿಷ್ಟ ಗುಂಪುಗಳಿಗೆ ಸಕ್ರಿಯಗೊಳಿಸಿ",
    "Uninstall App" : "ಅಳಿಸಿ",
    "Cheers!" : "ಆನಂದಿಸಿ !",
