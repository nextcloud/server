OC.L10N.register(
    ...
    "You need to migrate your encryption keys from the old encryption (Nextcloud <= 8.0) to the new one." : "Vos cal migrar vòstras claus de chiframent de l'anciana version (Nextcloud <= 8.0) cap a la novèla.",
