OC.L10N.register(
    ...
    "Encryption alone does not guarantee security of the system. Please see Nextcloud documentation for more information about how the encryption app works, and the supported use cases." : "暗号化だけでは、システムのセキュリティを保証するものではありません。暗号化アプリがどのように動作するかの詳細について、およびサポートされているユースケースについてはNextcloudのドキュメントを参照してください。",
    ...
    "You need to migrate your encryption keys from the old encryption (Nextcloud <= 8.0) to the new one. Please enable the \"Default encryption module\" and run 'occ encryption:migrate'" : "古い暗号化(Nextcloud <= 8.0) から新しいものに暗号化キーを移行する必要があります。\"デフォルトの暗号化モジュール\" を有効にして 'occ encryption:migrate' を実行してください。",
    "You need to migrate your encryption keys from the old encryption (Nextcloud <= 8.0) to the new one." : "古い暗号化(Nextcloud <= 8.0) から新しいものに暗号化キーを移行する必要があります。",
    ...
    "This app has no minimum Nextcloud version assigned. This will be an error in Nextcloud 11 and later." : "このアプリはNextcloudの最小バージョンが指定されていません．Nextcloud 11 以降でエラーが発生する可能性があります.",
    "This app has no maximum Nextcloud version assigned. This will be an error in Nextcloud 11 and later." : "このアプリはNextcloudの最大バージョンが指定されていません．Nextcloud 11 以降でエラーが発生する可能性があります.",
