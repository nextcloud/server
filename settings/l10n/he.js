OC.L10N.register(
    ...
    "You need to migrate your encryption keys from the old encryption (Nextcloud <= 8.0) to the new one." : "יש להמיר את מפתחות ההצפנה שלך בממערכת ההצפנה הישנה (Nextcloud <= 8.0) למערכת החדשה.",
    ...
    "This app has no minimum Nextcloud version assigned. This will be an error in Nextcloud 11 and later." : "ליישום זה לא הוקצתה גרסה מינמלית של Nextcloud. מצב זה יהיה שגוי בגרסה 11 או מאוחרת יותר של Nextcloud.",
    "This app has no maximum Nextcloud version assigned. This will be an error in Nextcloud 11 and later." : "ליישום זה לא הוקצתה גרסה מקסימלית של Nextcloud. מצב זה יהיה שגוי בגרסה 11 או מאוחרת יותר של Nextcloud.",
