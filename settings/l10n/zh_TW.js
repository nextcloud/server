OC.L10N.register(
    ...
    "Upgrading …" : "更新中...",
    "Could not upgrade app" : "無法更新應用程式",
    "Updated" : "已更新",
    "Removing …" : "移除中…",
    "Could not remove app" : "無法移除應用程式",
    "Remove" : "移除",
    "The app has been enabled but needs to be upgraded. You will be redirected to the upgrade page in 5 seconds." : "此應用程式已經被啟用，但是需要被更新。將在5秒後將您導向更新頁面。",
    "App upgrade" : "應用程式更新",
    "Approved" : "審查通過",
    "Experimental" : "實驗性質",
