OC.L10N.register(
    ...
    "You created app password \"{token}\"" : "Du skapade app-lösenord \"{token}\"",
    "You deleted app password \"{token}\"" : "Du raderade app-lösenord \"{token}\"",
    "You renamed app password \"{token}\" to \"{newToken}\"" : "Du ändrade namn på app-lösenord \"{token}\" till \"{newToken}\"",
    "You granted filesystem access to app password \"{token}\"" : "Du tilldelade filsystem-åtkomst till app-lösenord \"{token}\"",
    "You revoked filesystem access from app password \"{token}\"" : "Du återkallade filsystem-åtkomst från app-lösenord \"{token}\"",
    "Security" : "Säkerhet",
    ...
    "Download and enable" : "Ladda ned och aktivera",
    "Enable" : "Aktivera",
    ...
    "Changing the password will result in data loss, because data recovery is not available for this user" : "Ändring av lösenord kommer resultera i förlorad data, eftersom dataåterställning ej är tillgängligt för denna användare.",
    ...
    "When the password of a new user is left empty, an activation email with a link to set the password is sent." : "När lösenordet för en ny användare lämnas tomt så skickas ett e-postmeddelande med en länk för att välja ett lösenord.",
    "E-Mail" : "E-post",
    "Create" : "Skapa",
