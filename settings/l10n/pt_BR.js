OC.L10N.register(
    ...
    "An error occured while changing your locale. Please reload the page and try again." : "Ocorreu um erro ao alterar sua localidade. Por favor, recarregue a página e tente novamente.",
    "Select a profile picture" : "Selecione uma imagem para o perfil",
    "Week starts on {fdow}" : "Início da semana: {fdow}",
    "Groups" : "Grupos",
    ...
    "Password change is disabled because the master key is disabled" : "A mudança de senha está desativada porque a chave mestra está desativada",
    ...
    "You are about to remove the group {group}. The users will NOT be deleted." : "Você vai remover o grupo {group}. Os usuários NÃO serão excluídos.",
