OC.L10N.register(
    ...
    "You need to migrate your encryption keys from the old encryption (Nextcloud <= 8.0) to the new one." : "Você precisa migrar suas chaves de criptografia a partir da antiga criptografia (Nextcloud <= 8,0) para a nova.",
    ...
    "This app has no minimum Nextcloud version assigned. This will be an error in Nextcloud 11 and later." : "Este aplicativo não tem atribuída nenhuma  versão Nextcloud mínima. Isto será um erro no Nextcloud 11 e posterior.",
    "This app has no maximum Nextcloud version assigned. This will be an error in Nextcloud 11 and later." : "Este aplicativo não tem atribuída nenhuma  versão Nextcloud máxima. Isto será um erro no Nextcloud 11 e posterior.",
