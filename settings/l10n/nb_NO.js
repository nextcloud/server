OC.L10N.register(
    ...
    "Encryption alone does not guarantee security of the system. Please see Nextcloud documentation for more information about how the encryption app works, and the supported use cases." : "Kryptering alene garanterer ikke sikkerheten i systemet. Se Nextcloud-dokumentasjonen for mer informasjon om hvordan krypterings-appen virker og hvilke brukstilfeller som støttes.",
    ...
    "You need to migrate your encryption keys from the old encryption (Nextcloud <= 8.0) to the new one." : "Du må migrere krypteringsnøklene din fra den gamle krypteringen (Nextcloud <= 8.0) til den nye.",
    ...
    "This app has no minimum Nextcloud version assigned. This will be an error in Nextcloud 11 and later." : "Denne appen har ingen minimumsversjon av Nextcloud. Dette vil være en feil i Nextcloud 11 og senere.",
    "This app has no maximum Nextcloud version assigned. This will be an error in Nextcloud 11 and later." : "Denne appen har ingen maksimumsversjon av Nextcloud. Dette vil være en feil i Nextcloud 11 og senere.",
