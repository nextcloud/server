OC.L10N.register(
    ...
    "An error occured while changing your locale. Please reload the page and try again." : "При переключении языковых настроек произошла ошибка. Перезагрузите эту страницу и попробуйте ещё раз.",
    "Select a profile picture" : "Выберите аватар",
    "Week starts on {fdow}" : "Неделя начинается с {fdow}",
    "Groups" : "Группы",
    ...
    "no more results" : "Больше нет результатов",
    "Unlimited" : "Неограничено",
    "Default quota" : "Квота по умолчанию",
    "Default language" : "Язык по умолчанию",
    "Password change is disabled because the master key is disabled" : "Смена пароля отключена, т.к. мастер-ключ отключен",
    "Common languages" : "Общие языки",
    ...
    "Default quota :" : "Квота по умолчанию: ",
    "You are about to remove the group {group}. The users will NOT be deleted." : "Вы собираетесь удалить группу {group}. Пользователи НЕ будут удалены.",
    "Please confirm the group removal " : "Пожалуйста, подтвердите удаление группы",
