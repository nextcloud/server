OC.L10N.register(
    ...
    "Enter common info about your Nextcloud instance here. These info are visible to all users." : "Укажите здесь основные данные об этом сервере Nextcloud. Эти данные будут доступны всем пользователям.",
    "Server location" : "Размещение сервера",
    "country" : "страна",
    "Service provider" : "Поставщик услуг",
    "company or person" : "компания или лицо",
    "Provider website" : "Провайдер веб-узла",
    "link to website" : "ссылка на сайт",
    "Link to privacy policy" : "Ссылка на политику конфиденциальности",
    "link to privacy policy" : "ссылка на политику конфиденциальности",
    "Admin contact" : "Контакты администратора",
    "choose admin contact" : "Выберите контакт администратора",
    "save" : "сохранить",
    "saving" : "сохранение",
    "saved" : "сохранено",
    "error saving settings" : "при сохранении настроек произошла ошибка",
    ...
    "Where is your data?" : "Где расположены ваши данные?",
    "Your data is located in <b>%s</b>." : "Данные расположены в <b>%s</b>.",
    "Read the %sprivacy policy%s now." : "Ознакомиться с %sполитикой конфиденциальности%s.",
    "Your files are encrypted with %sserver side encryption%s." : "Для защиты ваших файлов используется %sшифрование на стороне сервера%s",
    "%s%s%s is your admin. If you have any issues, %scontact them%s." : "Ваш администратор — %s%s. %s%sСвяжитесь с ним%s при возникновении любых вопросов.",
    ...
    "Check the security of your Nextcloud over our security scan" : "Проверьте безопасность Nextcloud нашим сканером",
