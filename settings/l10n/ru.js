OC.L10N.register(
    ...
    "Please check the installation documentation for php configuration notes and the php configuration of your server, especially when using php-fpm." : "Пожалуйста обратитесь к документации по установке для получения заметок по настройке php, а также к настройкам php вашего сервера, особенно это касается php-fpm.",
    ...
    "Encryption is a one way process. Once encryption is enabled, all files from that point forward will be encrypted on the server and it will not be possible to disable encryption at a later date. This is the final warning: Do you really want to enable encryption?" : "Шифрование это односторонний процесс. После включения шифрования все файлы будут зашифрованы на сервере, позднее его нельзя будет отключить. Это последнее предупреждение: вы действительно хотите включить шифрование?",
    ...
    "Experimental File Lock is enabled." : "Экспериментальная блокировка файлов включена.",
    "Experimental File Lock is disabled." : "Экспериментальная блокировка файлов отключена.",
    "Version" : "Версия",
