OC.L10N.register(
    ...
    "App upgrade" : "Actualização de App",
    "Approved" : "Aprovado",
    ...
    "Unable to add user to group {group}" : "Impossível adicionar o utilizador ao grupo {group}",
    "Unable to remove user from group {group}" : "Impossível remover o utilizador do grupo {group}",
    "Add group" : "Adicionar grupo",
    "Invalid quota value \"{val}\"" : "Valor de cota inválido \"{val}\"",
    ...
    "Could not change the users email" : "Não foi possível modificar o email do utilizador",
    "Error while changing status of {user}" : "Erro ao modificar o estado de {user}",
