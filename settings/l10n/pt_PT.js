OC.L10N.register(
    ...
    "You need to migrate your encryption keys from the old encryption (Nextcloud <= 8.0) to the new one." : "Precisa de migrar as suas chaves de encriptação da encriptação antiga (Nextcloud <= 8.0) para a nova.",
    ...
    "This app has no minimum Nextcloud version assigned. This will be an error in Nextcloud 11 and later." : "Esta aplicação não tem uma versão mínima de Nextcloud atribuída. Isto será um erro no Nextcloud 11 e seguintes.",
    "This app has no maximum Nextcloud version assigned. This will be an error in Nextcloud 11 and later." : "Esta aplicação não tem uma versão máxima de Nextcloud atribuída. Isto será um erro no Nextcloud 11 e seguintes.",
