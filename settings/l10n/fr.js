OC.L10N.register(
    ...
    "_You have %n app update pending_::_You have %n app updates pending_" : ["Vous avez %n application qui attend sa mise a jour .","Vous avez %n applications en attente de mise à jour"],
