OC.L10N.register(
    ...
    "Add a new user" : "کاربر جدیدی اضافه کنید",
    "No users in here" : "هیچ کاربر در اینجا نیست",
    "Default quota" : "سهمیه پیش فرض",
    "Common languages" : "زبانهای رایج",
    "All languages" : "همه زبانها",
    "Password change is disabled because the master key is disabled" : "تغییر رمز غیرفعال است زیرا کلید اصلی غیرفعال است",
