...
"PHP charset is not set to UTF-8. This can cause major issues with non-ASCII characters in file names. We highly recommend to change the value of 'default_charset' php.ini to 'UTF-8'." => "Znaková sada PHP není nastavena na UTF-8. Toto může způsobit závažné problémy ve jménech souborů se znaky neobsaženými v ASCII. Doporučujeme změnit hodnotu 'default_charset' v php.ini na 'UTF-8'.",
