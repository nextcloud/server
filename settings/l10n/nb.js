OC.L10N.register(
    ...
    "Enter common info about your Nextcloud instance here. These info are visible to all users." : "Legg inn info om din Nextcloud her. Denne infoen vil være synlig for alle brukere.",
    "Server location" : "Serverlokalisjon",
    "country" : "land",
    "Service provider" : "Tjenesteleverandør",
    "company or person" : "firma eller person",
    "Provider website" : "Tilbydernettside",
    "link to website" : "Lenke til nettside",
    "Link to privacy policy" : "Lenke til personvernerklæring",
    "link to privacy policy" : "lenke til personvernerklæring",
    "Admin contact" : "Administrator-kontakt",
    "choose admin contact" : "Velg administrator-kontakt",
    "save" : "lagre",
    "saving" : "lagrer",
    "saved" : "lagret",
    "error saving settings" : "feil under lagring av innstillinger",
    ...
    "Your data is located in <b>%s</b>." : "Dataene dine er lokalisert hos <b>%s</b>.",
    "Your provider is %s%s%s." : "Tilbyderen din er %s%s%s.",
    "Your provider is %s." : "Tilbyderen din er %s.",
    "Read the %sprivacy policy%s now." : "Les %spersonvernerklæringen%s nå.",
    "Your files are encrypted with %sserver side encryption%s." : "Filende dine er kryptert med %skryptering på serverdelen%s.",
    "%s%s%s is your admin. If you have any issues, %scontact them%s." : "%s%s%s er din administrator. Ta %skontakt%s hvis du har problemer.",
    ...
    "Approved apps are developed by trusted developers and have passed a cursory security check. They are actively maintained in an open code repository and their maintainers deem them to be stable for casual to normal use." : "Godkjente apper er utviklet av betrodde utviklere og har gjennomgått en rask sikkerhetssjekk. De vedlikeholdes aktivt i et åpent kode-depot og utviklerne anser dem for å være stabile for tidvis eller normal bruk.",
    ...
    "Error while disabling app" : "Deaktivering av app mislyktes",
    "Enabling app …" : "Aktiverer app…",
    "Error while enabling app" : "Aktivering av app mislyktes",
    "Error: Could not disable broken app" : "Feil: Kunne ikke deaktivere ustabil app",
    "Error while disabling broken app" : "Feil ved deaktivering av ustabilt app",
    "App up to date" : "Appen er oppdatert",
    "Updating …" : "Oppdaterer…",
    "Could not update app" : "Appen kunne ikke oppdateres",
    "Updated" : "Oppdatert",
    "Removing …" : "Fjerner…",
    ...
    "This app has an update available." : "Det finnes en oppdatering til denne appen.",
    ...
    "Please check the <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">installation documentation ↗</a> for PHP configuration notes and the PHP configuration of your server, especially when using php-fpm." : "Sjekk <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">installasjonsdokumentasjonen ↗</a> for PHP-oppsettsnotater og oppsett av PHP på serveren din, særlig om du bruker php-fpm.",
    "The Read-Only config has been enabled. This prevents setting some configurations via the web-interface. Furthermore, the file needs to be made writable manually for every update." : "Det skrivebeskyttede oppsettet er blitt aktivert. Dette forhindrer setting av visse oppsett via web-grensesnittet. Videre må config-filen gjøres skrivbar manuelt for hver oppdatering.",
