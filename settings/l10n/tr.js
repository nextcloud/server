OC.L10N.register(
    ...
    "You need to migrate your encryption keys from the old encryption (Nextcloud <= 8.0) to the new one." : "Eski şifreleme anahtarlarınızı eski şifrelemeden (Nextcloud <= 8.0) yenisine taşımanız gerekli.",
    ...
    "This app has no minimum Nextcloud version assigned. This will be an error in Nextcloud 11 and later." : "Bu uygulama atanmış bir en düşük Nextcloud sürümü içermiyor. Nextcloud 11 ve sonrasında bu bir hata olacaktır.",
    "This app has no maximum Nextcloud version assigned. This will be an error in Nextcloud 11 and later." : "Bu uygulama atanmış bir en yüksek Nextcloud sürümü içermiyor. Nextcloud 11 ve sonrasında bu bir hata olacaktır.",
