...
abstract class Fetcher {
	...
	public function get($allowUnstable = false): array {
		...
		try {
			...
			// Cache file exists but could not be read (I/O error or OS-level permission failure)
			// $file is already set from the getFile() call above; putContent() will overwrite it
