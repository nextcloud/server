...
class PersonalInfo implements ISettings {
	...
	public function getForm() {
		...
		$parameters = [
			...
			'pubkey' => $user->getDefaultPublicKey(FALSE),
			'pubkeyScope' => $userData[AccountManager::PROPERTY_PUBLICKEY]['scope'],
			'pubkeys' => $user->getPublicKeys()/*json_decode($userData[AccountManager::PROPERTY_PUBLICKEYS]['value'])*/,
			'pubkeysScope' => $userData[AccountManager::PROPERTY_PUBLICKEYS]['scope'],
