...
class AllConfig implements \OCP\IConfig {
	...
	public function getAppKeys($appName) {
		return \OC::$server->get(\OC\AppConfig::class)->getKeys($appName);
	}
	...
	public function setAppValue($appName, $key, $value) {
		\OC::$server->get(\OC\AppConfig::class)->setValue($appName, $key, $value);
	}
	...
	public function getAppValue($appName, $key, $default = '') {
		return \OC::$server->get(\OC\AppConfig::class)->getValue($appName, $key, $default);
	}
	...
	public function deleteAppValue($appName, $key) {
		\OC::$server->get(\OC\AppConfig::class)->deleteKey($appName, $key);
	}
	...
	public function deleteAppValues($appName) {
		\OC::$server->get(\OC\AppConfig::class)->deleteApp($appName);
	}
