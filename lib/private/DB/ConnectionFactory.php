...
//				unset($additionalConnectionParams['host']);
				$additionalConnectionParams['servicename'] = 'FREEPDB1';
				$additionalConnectionParams['primary']['servicename'] = 'FREEPDB1';
				$additionalConnectionParams['replica'][0]['servicename'] = 'FREEPDB1';
				break;
