...
||||||| parent of fa3ad478809 (fix: Use AutoCompleteFilterEvent when returning list of sharees)
				$searchPlugin = $this->container->resolve($plugin);
...
>>>>>>> fa3ad478809 (fix: Use AutoCompleteFilterEvent when returning list of sharees)
