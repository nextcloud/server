OC.L10N.register(
    ...
    "Nextcloud %s or higher is required." : "Diperlukan Nextcloud %s atau yang lebih tinggi.",
    "Nextcloud %s or lower is required." : "Nextcloud %s atau yang lebih rendah diperlukan.",
    "Help" : "Bantuan",
    "Personal" : "Pribadi",
    "Users" : "Pengguna",
    "Admin" : "Admin",
    "Recommended" : "Direkomendasikan",
    "App \"%s\" cannot be installed because it is not compatible with this version of Nextcloud." : "Aplikasi \"%s\" tidak dapat diinstal karena tidak kompatibel dengan Nextcloud versi ini.",
    ...
    "App can't be installed because it is not compatible with this version of Nextcloud" : "Apl tidak dapat diinstal karena tidak kompatibel dengan versi Nextcloud",
    ...
    "Adjusting this setting in php.ini will make Nextcloud run again" : "Menyesuaikan pengaturan ini dalam php.ini akan menyebabkan Nextcloud berjalan kembali",
