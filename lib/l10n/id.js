OC.L10N.register(
    ...
    "The database option \"%1$s\" for %2$s has to be a list of values" : "Opsi basis data \"%1$s\" untuk %2$s harus berupa daftar nilai",
    "The database option \"%1$s\" is not supported by %2$s" : "Opsi basis data \"%1$s\" tidak didukung oleh %2$s",
    "The database options \"dbsslcert\" and \"dbsslkey\" have to be provided together" : "Opsi basis data \"dbsslcert\" dan \"dbsslkey\" harus disediakan secara bersamaan",
    ...
    "Unknown share recipient" : "Penerima pembagian tidak dikenal",
    "Group \"%s\" does not exist" : "Grup \"%s\" tidak ada",
    "The requested share does not exist anymore" : "Pembagian yang diminta sudah tidak ada",
    "The share already contains the source." : "Pembagian sudah berisi sumber tersebut.",
    "The share already contains the recipient." : "Pembagian sudah berisi penerima tersebut.",
    "Cannot set user status for the owner of the share." : "Tidak dapat menetapkan status pengguna untuk pemilik pembagian.",
    "The source does not exist." : "Sumber tidak ada.",
    "The recipient does not exist." : "Penerima tidak ada.",
    "The value must be alphanumeric, 1 to 32 characters long and may contain dashes." : "Nilai harus berupa alfanumerik, terdiri atas 1 hingga 32 karakter, dan dapat mengandung tanda hubung.",
    "You need to add at least one source to make the share available." : "Anda perlu menambahkan setidaknya satu sumber agar pembagian tersedia.",
    "You need to add at least one recipient to make the share available." : "Anda perlu menambahkan setidaknya satu penerima agar pembagian tersedia.",
    "You need to allow at least one permission to make the share available." : "Anda perlu mengizinkan setidaknya satu izin agar pembagian tersedia.",
    "You need to set a value for the %s" : "Anda perlu menetapkan nilai untuk %s",
    ...
    "Your data directory is not readable." : "Direktori data Anda tidak dapat dibaca.",
    ...
    "Translates the speech of an audio file or recording and outputs an audio file in the desired language." : "Menerjemahkan ucapan dari file atau rekaman audio dan menghasilkan file audio dalam bahasa yang diinginkan.",
    "Input audio" : "Audio masukan",
    "The audio file or recording to translate" : "File atau rekaman audio yang akan diterjemahkan",
    "Origin language" : "Bahasa asal",
    "The language of the origin audio" : "Bahasa audio sumber",
    "Target language" : "Bahasa target",
    "The desired language to translate the origin audio in" : "Bahasa tujuan untuk menerjemahkan audio sumber",
    "Audio output" : "Keluaran audio",
    "The audio translation" : "Terjemahan audio",
    ...
    "Generate subtitles" : "Buat subtitle",
    "Subtitle the things said in an audio or video" : "Membuat subtitle untuk ucapan dalam audio atau video",
    "Input file" : "File masukan",
    "The file to subtitle" : "File yang akan diberi subtitle",
    "Subtitles" : "Subtitle",
    "The subtitles file" : "File subtitle",
    ...
    "Chat with tools using attachments" : "Mengobrol dengan alat menggunakan lampiran",
    "Chat with the language model with tool calling support and attachments." : "Mengobrol dengan model bahasa yang mendukung pemanggilan alat dan lampiran.",
    "Describe a task that you want the assistant to do or ask a question" : "Jelaskan tugas yang ingin Anda minta asisten lakukan atau ajukan pertanyaan",
    "Input attachments" : "Lampiran masukan",
    "Files to send along with the chat message." : "File yang dikirim bersama pesan obrolan.",
    ...
    "The response from the chat model" : "Respons dari model obrolan",
    "Output attachments" : "Lampiran keluaran",
    "Files generated by the model." : "File yang dihasilkan oleh model.",
    ...
    "Chat with an agent using attachments" : "Mengobrol dengan agen menggunakan lampiran",
    "Memories" : "Memori",
    "Memories to send to the agent." : "Memori yang akan dikirim kepada agen.",
    "Files generated by the agent." : "File yang dihasilkan oleh agen.",
    "Sources" : "Sumber",
    "Sources of the generated response." : "Sumber respons yang dihasilkan.",
    ...
    "Improve text" : "Tingkatkan teks",
    "Takes a text and improves it based on instructions" : "Mengambil teks dan meningkatkannya berdasarkan instruksi",
    "Write a text that you want the assistant to improve" : "Tuliskan teks yang ingin Anda tingkatkan dengan bantuan asisten",
    "Instructions" : "Instruksi",
    "Describe how the assistant should improve the text" : "Jelaskan bagaimana asisten harus meningkatkan teks tersebut",
    "Improved text" : "Teks yang telah ditingkatkan",
    "The improved text" : "Teks yang telah ditingkatkan",
    ...
    "Reformat paragraphs" : "Format ulang paragraf",
    "Reformats a text into multiple paragraphs separated by topic" : "Memformat ulang teks menjadi beberapa paragraf yang dipisahkan berdasarkan topik",
    "The text to reformat" : "Teks yang akan diformat ulang",
    "Reformatted text" : "Teks yang telah diformat ulang",
    "The reformatted text with paragraphs separated by topic" : "Teks yang telah diformat ulang dengan paragraf yang dipisahkan berdasarkan topik",
    ...
    "You are not allowed to edit this share." : "Anda tidak diizinkan untuk mengedit pembagian ini.",
    "Only true and false are valid values: %s" : "Hanya true dan false yang merupakan nilai valid: %s",
    "Invalid ISO8601 date: %s" : "Tanggal ISO8601 tidak valid: %s",
    "Date needs to be after %s" : "Tanggal harus setelah %s",
    "Date needs to be before %s" : "Tanggal harus sebelum %s",
    "Only %1$s are valid values: %2$s" : "Hanya %1$s yang merupakan nilai valid: %2$s",
    "Need at least %1$s characters: %2$s" : "Memerlukan setidaknya %1$s karakter: %2$s",
    "Provide %1$s characters at most: %2$s" : "Maksimal %1$s karakter: %2$s",
