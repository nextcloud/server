OC.L10N.register(
    ...
    "Nextcloud %s or higher is required." : "Richiesto Nextcloud %s o superiore.",
    "Nextcloud %s or lower is required." : "Richiesto Nextcloud %s o inferiore.",
    "Help" : "Aiuto",
    "Personal" : "Personale",
    "Users" : "Utenti",
    "Admin" : "Admin",
    "Recommended" : "Consigliata",
    "App \"%s\" cannot be installed because it is not compatible with this version of Nextcloud." : "L'applicazione \"%s\" non può essere installata poiché non è compatibile con questa versione di Nextcloud.",
    ...
    "App can't be installed because it is not compatible with this version of Nextcloud" : "L'applicazione non può essere installata poiché non è compatibile con questa versione di Nextcloud",
    ...
    "Adjusting this setting in php.ini will make Nextcloud run again" : "La modifica di questa impostazione nel file php.ini permetterà nuovamente l'esecuzione di Nextcloud",
