OC.L10N.register(
    ...
    "Nextcloud %s or higher is required." : "Lypset Nextcloud %s ose më sipër.",
    "Nextcloud %s or lower is required." : "Lypset Nextcloud %s ose më poshtë.",
    "Help" : "Ndihmë",
    "Personal" : "Personale",
    "Users" : "Përdorues",
    "Admin" : "Admin",
    "Recommended" : "E rekomanduar",
    "App \"%s\" cannot be installed because it is not compatible with this version of Nextcloud." : "Përditësimi \"%s\" s’instalohet dot, ngaqë s’është i përputhshëm me këtë version të Nextcloud-it.",
    ...
    "App can't be installed because it is not compatible with this version of Nextcloud" : "Aplikacioni s’mund të instalohet, ngaqë s’është i përputhshëm me këtë version të Nextcloud-it",
    ...
    "Adjusting this setting in php.ini will make Nextcloud run again" : "Saktësimi i këtij rregullimi te php.ini do të bëjë që Nextcloud-i të punojë sërish",
