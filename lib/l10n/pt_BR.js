OC.L10N.register(
    ...
    "Nextcloud %s or higher is required." : "É necessário um Nextcloud %s ou superior.",
    "Nextcloud %s or lower is required." : "É necessário um Nextcloud %s ou inferior.",
    "Help" : "Ajuda",
    "Personal" : "Pessoal",
    "Users" : "Usuários",
    "Admin" : "Admin",
    "Recommended" : "Recomendado",
    "App \"%s\" cannot be installed because it is not compatible with this version of Nextcloud." : "App \"%s\" não pode ser instalado porque não é compatível com esta versão do Nextcloud.",
    ...
    "App can't be installed because it is not compatible with this version of Nextcloud" : "O aplicativo não pode ser instalado porque não é compatível com esta versão do Nextcloud",
    ...
    "Adjusting this setting in php.ini will make Nextcloud run again" : "Ajustando esta configuração no php.ini irá fazer o Nextcloud rodar novamente",
