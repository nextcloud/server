OC.L10N.register(
    ...
    "The database option \"%1$s\" for %2$s has to be a list of values" : "A opção de banco de dados “%1$s” para %2$s deve ser uma lista de valores",
    "The database option \"%1$s\" is not supported by %2$s" : "A opção de banco de dados “%1$s” não é compatível com %2$s",
    "The database options \"dbsslcert\" and \"dbsslkey\" have to be provided together" : "As opções de banco de dados “dbsslcert” e “dbsslkey” devem ser fornecidas juntas",
    ...
    "Cannot set user status for the owner of the share." : "Não é possível definir o status do usuário para o proprietário do compartilhamento.",
    "The source does not exist." : "A fonte não existe.",
    "The recipient does not exist." : "O destinatário não existe.",
    "The value must be alphanumeric, 1 to 32 characters long and may contain dashes." : "O valor deve ser alfanumérico, ter de 1 a 32 caracteres e pode conter traços.",
    "You need to add at least one source to make the share available." : "É necessário adicionar pelo menos uma fonte para disponibilizar o compartilhamento.",
    "You need to add at least one recipient to make the share available." : "É necessário adicionar pelo menos um destinatário para disponibilizar o compartilhamento.",
    "You need to allow at least one permission to make the share available." : "É necessário conceder pelo menos uma permissão para disponibilizar o compartilhamento.",
    "You need to set a value for the %s" : "Você precisa definir um valor para %s",
    ...
    "The audio file or recording to translate" : "O arquivo de áudio ou a gravação a ser traduzida",
    ...
    "Subtitle the things said in an audio or video" : "Legendar o que é dito em um áudio ou vídeo",
    "Input file" : "Arquivo de entrada",
    "The file to subtitle" : "O arquivo a ser legendado",
    "Subtitles" : "Legendas",
    "The subtitles file" : "O arquivo de legendas",
    ...
    "Chat with tools using attachments" : "Bate-papo com ferramentas usando anexos",
    "Chat with the language model with tool calling support and attachments." : "Converse com o modelo de linguagem com suporte à invocação de ferramentas e anexos.",
    ...
    "Input attachments" : "Anexos de entrada",
    "Files to send along with the chat message." : "Arquivos a serem enviados junto com a mensagem de bate-papo.",
    ...
    "The response from the chat model" : "A resposta do modelo de bate-papo",
    "Output attachments" : "Anexos de saída",
    "Files generated by the model." : "Arquivos gerados pelo modelo.",
    ...
    "Chat with an agent using attachments" : "Converse com um agente usando anexos",
    "Memories" : "Memórias",
    "Memories to send to the agent." : "Memórias para enviar ao agente.",
    "Files generated by the agent." : "Arquivos gerados pelo agente.",
    "Sources" : "Fontes",
    "Sources of the generated response." : "Fontes da resposta gerada.",
    ...
    "Takes a text and improves it based on instructions" : "Recebe um texto e o aprimora com base em instruções",
    "Write a text that you want the assistant to improve" : "Escreva um texto que você queira que o assistente melhore",
    "Instructions" : "Instruções",
    "Describe how the assistant should improve the text" : "Descreva como o assistente deve melhorar o texto",
    "Improved text" : "Texto revisado",
    "The improved text" : "O texto revisado",
    "Proofread" : "Revisar",
    ...
    "You are not allowed to edit this share." : "Você não tem permissão para editar este compartilhamento.",
    "Only true and false are valid values: %s" : "Apenas true (verdadeiro) e false (falso) são valores válidos: %s",
    "Invalid ISO8601 date: %s" : "Data ISO 8601 inválida: %s",
    "Date needs to be after %s" : "A data deve ser posterior a %s",
    "Date needs to be before %s" : "A data deve ser anterior a %s",
    "Only %1$s are valid values: %2$s" : "Apenas %1$s são valores válidos: %2$s",
    "Need at least %1$s characters: %2$s" : "São necessários pelo menos %1$s caracteres: %2$s",
    "Provide %1$s characters at most: %2$s" : "Forneça no máximo %1$s caracteres: %2$s",
