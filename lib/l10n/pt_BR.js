OC.L10N.register(
    ...
    "Invalid ISO date: %s" : "Data ISO inválida: %s",
    "Date needs to be after %1$s: %2$s" : "A data deve ser posterior a %1$s: %2$s",
    "Date needs to be before %1$s: %2$s" : "A data deve ser anterior a %1$s: %2$s",
