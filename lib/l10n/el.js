OC.L10N.register(
    ...
    "Module with ID: %s does not exist. Please enable it in your apps settings or contact your administrator." : "Το άρθρωμα με ID: %s δεν υπάρχει. Παρακαλούμε ενεργοποιήστε το στις ρυθμίσεις των εφαρμογών σας ή επικοινωνήστε με τον διαχειριστή.",
    ...
    "macOS is not supported and %s will not work properly on this platform." : "Το macOS δεν υποστηρίζεται και το %s δεν θα λειτουργεί σωστά σε αυτή την πλατφόρμα.",
    ...
    "Unknown share recipient" : "Άγνωστος παραλήπτης διαμοιρασμού",
    ...
    "The share already contains the source." : "Η κοινή χρήση περιέχει ήδη την πηγή.",
    "The share already contains the recipient." : "Η κοινή χρήση περιέχει ήδη τον παραλήπτη.",
    "The source does not exist." : "Η πηγή δεν υπάρχει.",
    "The recipient does not exist." : "Ο παραλήπτης δεν υπάρχει.",
    "The value must be alphanumeric, 1 to 32 characters long and may contain dashes." : "Η τιμή πρέπει να είναι αλφαριθμητική, μήκους 1 έως 32 χαρακτήρων και μπορεί να περιέχει παύλες.",
    "You need to add at least one source to make the share available." : "Πρέπει να προσθέσετε τουλάχιστον μία πηγή για να κάνετε τον διαμοιρασμό διαθέσιμο.",
    "You need to add at least one recipient to make the share available." : "Πρέπει να προσθέσετε τουλάχιστον έναν παραλήπτη για να κάνετε τον διαμοιρασμό διαθέσιμο.",
    "You need to allow at least one permission to make the share available." : "Πρέπει να επιτρέψετε τουλάχιστον ένα δικαίωμα για να κάνετε τον διαμοιρασμό διαθέσιμο.",
    "You need to set a value for the %s" : "Πρέπει να ορίσετε μια τιμή για το %s",
    ...
    "Your data directory is not readable." : "Ο κατάλογος δεδομένων σας δεν είναι αναγνώσιμος.",
    ...
    "Translate audio" : "Μετάφραση ήχου",
    "Translates the speech of an audio file or recording and outputs an audio file in the desired language." : "Μεταφράζει την ομιλία ενός αρχείου ήχου ή εγγραφής και παράγει ένα αρχείο ήχου στην επιθυμητή γλώσσα.",
    "Input audio" : "Ήχος εισόδου",
    "The audio file or recording to translate" : "Το αρχείο ήχου ή η εγγραφή προς μετάφραση",
    "Origin language" : "Γλώσσα προέλευσης",
    "The language of the origin audio" : "Η γλώσσα του αρχικού ήχου",
    "Target language" : "Γλώσσα στόχος",
    "The desired language to translate the origin audio in" : "Η επιθυμητή γλώσσα στην οποία θα μεταφραστεί ο αρχικός ήχος",
    "Audio output" : "Έξοδος ήχου",
    "The audio translation" : "Η μετάφραση ήχου",
    ...
    "Generate subtitles" : "Δημιουργία υποτίτλων",
    "Subtitle the things said in an audio or video" : "Δημιουργήστε υπότιτλους για τα λεγόμενα σε ένα αρχείο ήχου ή βίντεο",
    "Input file" : "Αρχείο εισόδου",
    "The file to subtitle" : "Το αρχείο για δημιουργία υποτίτλων",
    "Subtitles" : "Υπότιτλοι",
    "The subtitles file" : "Το αρχείο υποτίτλων",
    ...
    "Extract text from files like images or PDFs" : "Εξαγωγή κειμένου από αρχεία όπως εικόνες ή PDF",
    ...
    "In which tone should your text be rewritten?" : "Σε ποιον τόνο πρέπει να ξαναγραφτεί το κείμενό σας;",
    ...
    "Improve text" : "Βελτίωση κειμένου",
    "Takes a text and improves it based on instructions" : "Παίρνει ένα κείμενο και το βελτιώνει με βάση τις οδηγίες",
    "Write a text that you want the assistant to improve" : "Γράψτε ένα κείμενο που θέλετε ο βοηθός να βελτιώσει",
    "Instructions" : "Οδηγίες",
    "Describe how the assistant should improve the text" : "Περιγράψτε πώς ο βοηθός πρέπει να βελτιώσει το κείμενο",
    "Improved text" : "Βελτιωμένο κείμενο",
    "The improved text" : "Το βελτιωμένο κείμενο",
    ...
    "Reformat paragraphs" : "Αναδιαμόρφωση παραγράφων",
    "Reformats a text into multiple paragraphs separated by topic" : "Αναδιαμορφώνει ένα κείμενο σε πολλαπλές παραγράφους διαχωρισμένες ανά θέμα",
    "The text to reformat" : "Το κείμενο προς αναδιαμόρφωση",
    "Reformatted text" : "Αναδιαμορφωμένο κείμενο",
    "The reformatted text with paragraphs separated by topic" : "Το αναδιαμορφωμένο κείμενο με παραγράφους διαχωρισμένες ανά θέμα",
    ...
    "You are not allowed to edit this share." : "Δεν επιτρέπεται η επεξεργασία αυτού του διαμοιρασμού.",
