OC.L10N.register(
    ...
    "Nextcloud %s or higher is required." : "Απαιτείται Nextcloud %s ή νεότερο",
    "Nextcloud %s or lower is required." : "Απαιτείται έκδοση του Nextcloud παλαιότερη από την %s.",
    "Help" : "Βοήθεια",
    "Personal" : "Προσωπικά",
    "Users" : "Χρήστες",
    "Admin" : "Διαχείριση",
    "Recommended" : "Προτείνεται",
    "App \"%s\" cannot be installed because it is not compatible with this version of Nextcloud." : "Η εφαρμογή \"%s\" δεν μπορεί να εγκατασταθεί επειδή δεν είναι συμβατή με αυτή την έκδοση του Nextcloud.",
    ...
    "App can't be installed because it is not compatible with this version of Nextcloud" : "Η εφαρμογή δεν μπορεί να εγκατασταθεί επειδή δεν είναι συμβατή με αυτή την έκδοση Nextcloud",
    ...
    "Adjusting this setting in php.ini will make Nextcloud run again" : "Η διόρθωση της ρύθμισης στο αρχείο php.ini θα επιτρέψει στο Nextcloud να επαναλειτουργήσει",
