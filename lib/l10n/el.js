OC.L10N.register(
    ...
    "Module with id: %s does not exists. Please enable it in your apps settings or contact your administrator." : "Η μονάδα με id: %s δεν υπάρχει. Παρακαλούμε ενεργοποιήστε τη στις ρυθμίσεις των εφαρμογών σας ή επικοινωνήστε με το διαχειριστή σας.",
