OC.L10N.register(
    ...
    "Nextcloud %s or higher is required." : "Nextcloud %s eller høyere kreves.",
    "Nextcloud %s or lower is required." : "Nextcloud %s eller lavere kreves.",
    "Help" : "Hjelp",
    "Personal" : "Personlig",
    "Users" : "Brukere",
    "Admin" : "Admin",
    "Recommended" : "Anbefalt",
    "App \"%s\" cannot be installed because it is not compatible with this version of Nextcloud." : "App \"%s\" kan ikke installeres fordi den ikke er kompatibel med denne versjonen av Nextcloud.",
    ...
    "App can't be installed because it is not compatible with this version of Nextcloud" : "App kan ikke installeres fordi den ikke er kompatibel med denne versjonen av Nextcloud",
    ...
    "Adjusting this setting in php.ini will make Nextcloud run again" : "Endring av denne innstillingen i php.ini vil få Nextcloud til å kjøre igjen.",
