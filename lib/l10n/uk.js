OC.L10N.register(
    ...
    "Nextcloud %s or higher is required." : "Потрібен Nextcloud %s або вище.",
    "Nextcloud %s or lower is required." : "Потрібна версія %s Nextcloud або нижча.",
    "Help" : "Допомога",
    "Personal" : "Особисте",
    "Users" : "Користувачі",
    "Admin" : "Адмін",
    "Recommended" : "Рекомендуємо",
    "App \"%s\" cannot be installed because it is not compatible with this version of Nextcloud." : "Додаток \"%s\" не може бути встановлено, так як він не сумісний з цією версією Nextcloud.",
    ...
    "App can't be installed because it is not compatible with this version of Nextcloud" : "Неможливо встановити додаток, він є несумісним з даною версією Nextcloud",
    ...
    "Adjusting this setting in php.ini will make Nextcloud run again" : "Установка цього параметру в php.ini дозволяє запуститися Nextcloud знову.",
