OC.L10N.register(
    ...
    "For the best results, please consider using a GNU/Linux server instead." : "Для кращих результатів розгляньте можливість використання сервера на базі GNU/Linux",
    ...
    "Unknown share recipient" : "Невідомий отримувач спільного ресурсу",
    ...
    "The source does not exist." : "Джерело не існує.",
    "The recipient does not exist." : "Отримувач не існує.",
    ...
    "Your data directory is not readable." : "Неможливо отримати доступ до каталогу з даними",
    ...
    "Reformats a text into multiple paragraphs separated by topic" : "Переформатовує текст з розбивкою по темах, які виділено в окремі параграфи",
    "The text to reformat" : "Текст для переформатування",
    "Reformatted text" : "Переформатуватований текст",
    "The reformatted text with paragraphs separated by topic" : "Переформатований текст з темами, виділеними в окремі параграфи",
