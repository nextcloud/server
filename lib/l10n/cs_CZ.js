OC.L10N.register(
    ...
    "Nextcloud %s or higher is required." : "Je vyžadován Nextcloud %s nebo vyšší.",
    "Nextcloud %s or lower is required." : "Je vyžadován Nextcloud %s nebo nižší.",
    "Help" : "Nápověda",
    "Personal" : "Osobní",
    "Users" : "Uživatelé",
    "Admin" : "Administrace",
    "Recommended" : "Doporučené",
    "App \"%s\" cannot be installed because it is not compatible with this version of Nextcloud." : "Aplikace \"%s\" nemůže být nainstalována, protože není kompatibilní s touto verzí Nextcloud.",
    ...
    "App can't be installed because it is not compatible with this version of Nextcloud" : "Aplikace nemůže být nainstalována, protože není kompatibilní s touto verzí Nextcloud",
    ...
    "Adjusting this setting in php.ini will make Nextcloud run again" : "Úprava tohoto nastavení v php.ini opět rozběhne Nextcloud",
