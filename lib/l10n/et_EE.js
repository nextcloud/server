OC.L10N.register(
    ...
    "Sample configuration detected" : "Tuvastasin näidisseadistused",
    "It has been detected that the sample configuration has been copied. This can break your installation and is unsupported. Please read the documentation before performing changes on config.php" : "Tuvastasin, et seadistuse faili on kopeeritud näidisseadistusi. See võib lõhkuda sinu saidi ja see pole toetatud. Palun loe enne faili config.php muutmist dokumentatsiooni",
    ...
    "Confirm your email" : "Kinnita oma e-posti aadress",
    ...
    "Groupware bundle" : "Rühmatööks sobilik rakenduste komplekt",
    ...
    "Server version %s or lower is required." : "Nõutav on serveri versioon %s või madalam.",
    ...
    "Your current IP address doesn't allow you to perform admin actions" : "Sinu praeguselt IP-posti aadressilt ei saa teha haldustoiminguid",
    ...
    "Avatar image is not square" : "Tunnuspilt (avatar) pole ruut",
    "Files" : "Failid",
    ...
    "Enter the database name for %s" : "Sisesta nimi „%s“ andmebaasi jaoks",
    "You cannot use dots in the database name %s" : "Sa ei tohi kasutada „%s“ andmebaasi nimes punkte",
    "The database option \"%1$s\" for %2$s has to be a list of values" : "Andmebaasiseadistus „%1$s“ „%2$s“ väärtuse jaos peab olema väärtuste loend.",
    "The database option \"%1$s\" is not supported by %2$s" : "%2$s ei toeta andmebaasivalikut „%1$s“",
    "The database options \"dbsslcert\" and \"dbsslkey\" have to be provided together" : "Andmebaasiseadistused „dbsslcert“ ja „dbsslkey“ peavad olema paaris",
    ...
    "macOS is not supported and %s will not work properly on this platform." : "Mac OS X ei ole toetatud ja %s ei pruugi korralikult toimida sellel platvormil.",
    "For the best results, please consider using a GNU/Linux server instead." : "Parema tulemuse nimel palun kaalu serveris GNU/Linuxi kasutamist.",
    ...
    "Cannot enable sending the password by Talk with an empty password" : "Kui salasõna on tühi, siis selle edastamist kõnerakenduse abil pole võimalik sisse lülitada",
    "Cannot enable sending the password by Talk without setting a new password" : "Kui uus salasõna on sisestamata, siis selle edastamist kõnerakenduse abil pole võimalik sisse lülitada",
    "Cannot disable sending the password by Talk without setting a new password" : "Kui uus salasõna on sisestamata, siis selle edastamist kõnerakenduse abil pole võimalik välja lülitada",
    "Share provider does not support accepting" : "Jaosmeedia teenuspakkuja ei paku nõustumise võimalust",
    ...
    "Unknown share recipient" : "Tundmatu jaosmeedia vastuvõtja",
    "Group \"%s\" does not exist" : "„%s“ gruppi pole olemas",
    "The requested share does not exist anymore" : "Soovitud jagamist pole enam olemas",
    "The share already contains the source." : "Selles jagamises juba on lähtesisu olemas.",
    "The share already contains the recipient." : "Selles jagamises juba on saaja olemas.",
    "Cannot set user status for the owner of the share." : "Jaosmeedia omaniku kasutajaoleku määramine ei õnnestu.",
    "The source does not exist." : "Andmeallikat pole olemas.",
    "The recipient does not exist." : "Adressaati pole olemas.",
    "The value must be alphanumeric, 1 to 32 characters long and may contain dashes." : "Väärtus peab koosnema numbritest ja tähtedest, olema 1 kuni 32 tähemärki pikk ja võib sisaldada sidekriipse.",
    "You need to add at least one source to make the share available." : "Jagamine oleks saadaval, palun vali tema jaoks vähemalt üks andmeallikas.",
    "You need to add at least one recipient to make the share available." : "Jagamine oleks saadaval, palun vali tema jaoks vähemalt üks adressaat.",
    "You need to allow at least one permission to make the share available." : "Jagamine oleks saadaval, palun vali tema jaoks vähemalt üks õigus.",
    "You need to set a value for the %s" : "Sa pead „%s“ jaoks sisestama väärtuse",
    ...
    "No database drivers (sqlite, mysql, or postgresql) installed." : "Ühegi andmebaasi (sqlite, mysql või postgresql) draiverit pole paigaldatud.",
    ...
    "Or, if you prefer to keep config.php file read only, set the option \"config_is_read_only\" to true in it. See %s" : "Aga kui soovid, et config.php seadistuste fail ei peaks olema veebiserveri poolt muudetav, siis palun määra seadistusvõtme „config_is_read_only“ väärtuseks true. Lisateavet leiad: %s",
    ...
    "Your data directory is not readable." : "Sinu serveri andmekaust pole loetav..",
    ...
    "This is probably caused by a cache/accelerator such as Zend OPcache or eAccelerator." : "See on tõenäoliselt põhjustatud puhvrist või kiirendist nagu Zend OPcache või eAccelerator.",
    "PHP modules have been installed, but they are still listed as missing?" : "PHP moodulid on paigaldatud, kuid neid näidatakse endiselt puuduolevatena?",
    ...
    "To allow this check to run you have to make sure that your Web server can connect to itself. Therefore it must be able to resolve and connect to at least one of its `trusted_domains` or the `overwrite.cli.url`. This failure may be the result of a server-side DNS mismatch or outbound firewall rule." : "Selle kontrolli toimimiseks pead veenduma, et sinu veebiserver suudab iseendaga ühendust luua. Seetõttu peab server suutma tuvastada ja ühenduda vähemalt ühega oma „trusted_domains“ „overwrite.cli.url“ loendi väärtustega. See viga võib olla tingitud serveripoolse nimelahenduse mittevastavusest või väljamineva liikluse tulemüüri reeglist.",
    ...
    "Translates the speech of an audio file or recording and outputs an audio file in the desired language." : "Tõlgib helifailis või salvestises leiduva kõne ja vormistab selle soovitud keeles uue helifailina.",
    "Input audio" : "Sisendhääl",
    "The audio file or recording to translate" : "Tõlgitav helifail või salvestis",
    ...
    "Generate subtitles" : "Koosta subtiitrid",
    "Subtitle the things said in an audio or video" : "Koosta subtiitrid selle alusel, mida heli- või videofailis räägitakse",
    "Input file" : "Sisendfail",
    "The file to subtitle" : "Subtitreeritav fail",
    "Subtitles" : "Subtiitrid",
    "The subtitles file" : "Subtiitrite fail",
    ...
    "Whether to confirm previously requested actions: 0 for denial and 1 for confirmation." : "Kas peaksime eelmised tegevused kinnitama: keeldumist märgib 0 ja nõustumist 1.",
    ...
    "Writes text in a given style based on the provided source material." : "Kirjutab etteantud lähtematerjali alusel teksti üles.",
    ...
    "Optical character recognition" : "Optiline märgituvastus",
    "Extract text from files like images or PDFs" : "Tuvasta tekst erinevatest failidest, sh pildid ja PDF-failid",
    "Input files" : "Sisendfailid",
    "The files to extract text from" : "Failid, millest tahad tuvastada teksti",
    "Output texts" : "Väljundtekstid",
    "The texts that were extracted from the files" : "Tekstid, mis on etteantud failidest tuvastatud",
    "Chat with tools using attachments" : "Vestle tarvikutega manuste abil",
    "Chat with the language model with tool calling support and attachments." : "Vestle tehiaru mudeliga kasutades tagasipäringuid tarvikutele ja manuseid.",
    "Describe a task that you want the assistant to do or ask a question" : "Kirjelda seda, mida soovid Abilisele ülesandeks teha või lihtsalt küsi midagi.",
    "Input attachments" : "Sisendmanused",
    "Files to send along with the chat message." : "Failid, mida tahad tehisaru vestlusele saata.",
    "Tool message" : "Sõnum tarvikult",
    "The result of tool calls in the last interaction" : "Viimase interaktsiooni käigus tehtud tarvikupäringu tulemus.",
    "The history of chat messages before the current message, starting with a message by the user" : "Kasutaja sõnumiga algav vestluse ajalugu enne praegust sõnumit",
    "Available tools" : "Saadaval tarvikud",
    "The available tools in JSON format" : "Saadaval tarvikud JSON-vormingus",
    "The response from the chat model" : "Vastus vestluse mudelilt",
    "Output attachments" : "Väljundmanused",
    "Files generated by the model." : "Mudeli loodud failid.",
    "Tool calls" : "Tarvikute päringud",
    "Tools call instructions from the model in JSON format" : "Tarvikud küsivad mudelist juhiseid JSON-vormingus",
    "Chat with an agent using attachments" : "Suhtle tehisaru agendiga failide abil",
    "Memories" : "Mälestused",
    "Memories to send to the agent." : "Tehisaru agendile saadetavad mälestused.",
    "Files generated by the agent." : "Tehisaru agendi loodud failid.",
    "Sources" : "Allikad",
    "Sources of the generated response." : "Koostatud vastuse allikad.",
    ...
    "Free text to text prompt" : "Vabas vormis tekstiküsimus",
    "Runs an arbitrary prompt through a language model that returns a reply" : "Sisestab suvalise käsu keelemudelisse, mis annab vastuse",
    ...
    "Chat with tools" : "Vestlus tarviku ja keelemudeli vahel",
    "Chat with the language model with tool calling support." : "Vestle keelemudeliga, mis toetab tarvikule tagasi esitatavate päringute võimalust..",
    ...
    "Improve text" : "Teksti täiustamine",
    "Takes a text and improves it based on instructions" : "Etteantud tekst saab parandatud ja kohendatud juhtnööride alusel",
    "Write a text that you want the assistant to improve" : "Koosta tekst, mida tahad lasta Abilisel parandada",
    "Instructions" : "Juhend",
    "Describe how the assistant should improve the text" : "Kirjelda mil viisil peaks Abiline teksti parandama",
    "Improved text" : "Täiustatud tekst",
    "The improved text" : "Täiustatud tekst",
    ...
    "Reformat paragraphs" : "Vorminda lõigud",
    "Reformats a text into multiple paragraphs separated by topic" : "Vormindab teksti mitmeks lõiguks, mida eraldab teemapealkiri",
    "The text to reformat" : "Vormindatav tekst",
    "Reformatted text" : "Vormindatud tekst",
    "The reformatted text with paragraphs separated by topic" : "Vormindatud tekst mitme lõiguna, mida eraldab teemapealkiri",
    ...
    "The original text to summarize" : "Algne tekst, millest peaks tegema kokkuvõtte",
    "Summary" : "Kokkuvõte",
    ...
    "Free prompt" : "Vabas vormis käsuviip",
    "Runs an arbitrary prompt through the language model." : "Võimalus sisestada keelemudelisse suvalise käsu/sisendi.",
    "Generate headline" : "Alapealkirja loomine",
    "Summarizes text by reducing its length without losing key information." : "Võimaldab tekstist teha lühikokkuvõtte ilma olulise teabekaota.",
    "Extracts topics from a text and outputs them separated by commas." : "Sisendina antud tekstist leitakse teemad, mis väljastatakse komadega eraldatud loendina.",
    "Share not found." : "Jagamist ei leidu.",
    "You are not allowed to edit this share." : "Sul pole lubatud seda jagamist muuta.",
    "Only true and false are valid values: %s" : "Kehtivad väärtused on vaid tõene ja väär (true and false): %s",
    "Invalid ISO8601 date: %s" : "Vigane ISO8601 kuupäev: %s",
    "Date needs to be after %s" : "Kuupäev peab olema hilisem, kui %s",
    "Date needs to be before %s" : "Kuupäev peab olema varasem, kui %s",
    "Only %1$s are valid values: %2$s" : "Vaid „%1$s“ on kehtivad väärtused: %2$s",
    "Need at least %1$s characters: %2$s" : "Vajad vähemalt %1$s tähemärki: %2$s",
    "Provide %1$s characters at most: %2$s" : "Sisesta kuni %1$s tähemärki: %2$s",
    ...
    "Sharing backend %s must implement the interface OCP\\Share_Backend" : "Jagamise taustateenus %s peab kasutusele võtma OCP\\Share_Backend liidese",
    "Sharing backend %s not found" : "Jagamise taustateenust %s ei leidu",
    "Sharing backend for %s not found" : "Jagamise taustateenust ei leidu %s jaoks",
    ...
    "Application is not enabled" : "Rakendus pole kasutusel",
    "Authentication error" : "Viga autentimisel",
    "Token expired. Please reload page." : "Tunnusluba aegus. Palun laadi leht uuesti."
},
