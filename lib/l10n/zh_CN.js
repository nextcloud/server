OC.L10N.register(
    ...
    "Share recipient is not a valid user" : "分享接收者不是有效用户",
    "Share recipient is not a valid group" : "分享接收者不是有效的群组",
    "Share recipient should be empty" : "分享接收者应为空",
    "Share recipient should not be empty" : "分享接收者不能为空",
    ...
    "Unknown share recipient" : "未知分享接收者",
    ...
    "Input text" : "输入文本",
    "The input text" : "输入文本",
    "Cannot generate more than 12 images" : "最多只能生成 12 张图片",
    ...
    "Your data directory is not readable." : "无法读取你的数据目录。",
