OC.L10N.register(
    ...
    "Enter the database username and name for %s" : "Introduz el nome d'usuariu y el nome de la base de datos pa: %s",
    "Enter the database username for %s" : "Introduz el nome d'usuariu de la base de datos pa: %s",
