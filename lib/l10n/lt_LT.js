OC.L10N.register(
    ...
    "Moving a share (%s) into a shared folder is not allowed" : "Neleidžiama perkelti viešinį (%s) į bendrinamą aplanką",
    "Moving a storage (%s) into a shared folder is not allowed" : "Neleidžiama perkelti saugyklą (%s) į bendrinamą aplanką",
    "Moving a share (%s) into another share (%s) is not allowed" : "Neleidžiama perkelti viešinį (%s) į kitą viešinį (%s)",
    "Moving a share (%s) into another storage (%s) is not allowed" : "Neleidžiama perkelti viešinį (%s) į kitą saugyklą (%s)",
    "Moving a storage (%s) into a share (%s) is not allowed" : "Neleidžiama perkelti saugyklą (%s) į viešinį (%s)",
    ...
    "Cannot change share type" : "Negalima keisti viešinio tipo",
    ...
    "Invalid share recipient" : "Neteisingas viešinio gavėjas",
