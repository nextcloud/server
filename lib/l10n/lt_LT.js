OC.L10N.register(
    ...
    "This can usually be fixed by giving the web server write access to the config directory." : "Tai, įprastai, gali būti pataisyta suteikiant saityno serveriui rašymo prieigą prie konfigūracijos katalogo.",
    "But, if you prefer to keep config.php file read only, set the option \"config_is_read_only\" to true in it." : "Tačiau, jei pageidaujate palikti „config.php“ failą tik skaitymui, nustatykite jame parametrą „config_is_read_only“ į „true“.",
    "See %s" : "Žiūrėkite %s",
    ...
    "Click the following button to confirm your email." : "Spustelėkite šį mygtuką norėdami patvirtinti el. paštą.",
    "Click the following link to confirm your email." : "Spustelėkite šią nuorodą norėdami patvirtinti el. paštą.",
    ...
    "Your current IP address doesn't allow you to perform admin actions" : "Jūsų dabartinis IP adresas neleidžia jums atlikti administravimo veiksmų",
    ...
    "_%nh_::_%nh_" : ["%n val.","%n val.","%n val.","%n val."],
    "_%nm_::_%nm_" : ["%n min.","%n min.","%n min.","%n min."],
    ...
    "Invalid parent path" : "Neteisingas viršesnis kelias",
    ...
    "Templates" : "Šablonai",
    "Storage %s cannot be moved" : "Saugykla %s negali būti perkelta",
    "Moving a share (%s) into a shared folder is not allowed" : "Neleidžiama perkelti bendrinimą (%s) į bendrinamą aplanką",
    "Moving a storage (%s) into a shared folder is not allowed" : "Neleidžiama perkelti saugyklą (%s) į bendrinamą aplanką",
    "Moving a share (%s) into another share (%s) is not allowed" : "Neleidžiama perkelti bendrinimą (%s) į kitą bendrinimą (%s)",
    "Moving a share (%s) into another storage (%s) is not allowed" : "Neleidžiama perkelti bendrinimą (%s) į kitą saugyklą (%s)",
    "Moving a storage (%s) into a share (%s) is not allowed" : "Neleidžiama perkelti saugyklą (%s) į bendrinimą (%s)",
    "Moving a storage (%s) into another storage (%s) is not allowed" : "Neleidžiama perkelti saugyklą (%s) į kitą saugyklą (%s)",
    "Path contains invalid segments" : "Kelyje yra netinkamų segmentų",
    "Filename is a reserved word" : "Failo pavadinimas yra rezervuotas žodis",
    "Filename contains at least one invalid character" : "Failo pavadinime yra bent vienas netinkamas simbolis",
    ...
    "This is an automatically sent email, please do not reply." : "Tai yra automatiškai išsiųstas el. laiškas, prašome neatsakyti.",
    "Bluesky" : "\"Bluesky\"",
    ...
    "The database option \"%1$s\" for %2$s has to be a list of values" : "Duomenų bazės parinktis „%1$s“ skirta %2$s turi būti reikšmių sąrašas",
    "The database option \"%1$s\" is not supported by %2$s" : "%2$s nepalaiko duomenų bazės parinkties „%1$s“",
    "The database options \"dbsslcert\" and \"dbsslkey\" have to be provided together" : "Duomenų bazės parinktys „dbsslcert“ ir „dbsslkey“ turi būti nurodytos kartu",
    ...
    "Share recipient is not a valid user" : "Viešinio gavėjas nėra tinkamas vartotojas",
    "Share recipient is not a valid group" : "Bendrinimo gavėjas nėra tinkama grupė",
    ...
    "Unknown share type" : "Nežinomas bendrinimo tipas",
    "Share initiator must be set" : "Turi būti nustatytas bendrinimo iniciatorius",
    "Cannot share with yourself" : "Negalima bendrinti su savimi",
    ...
    "You cannot share a folder that contains other shares" : "Jūs negalite bendrinti aplanko, kuriame yra kitų viešinių",
    "Cannot share with the share owner" : "Negalima bendrinti su viešinio savininku",
    "Share does not have a full ID" : "Bendrinimas neturi viso ID",
    "Cannot change share type" : "Negalima keisti bendrinimo tipo",
    "Can only update recipient on user shares" : "Gali atnaujinti gavėją tik vartotojo bendrinimuose",
    "Cannot enable sending the password by Talk with an empty password" : "Jei slaptažodis tuščias, neįmanoma įjungti slaptažodžio siuntimo per „Pokalbiai“",
    "Cannot enable sending the password by Talk without setting a new password" : "Negalima įjungti slaptažodžio siuntimo per „Pokalbiai“ nenustatant naujo slaptažodžio",
    "Cannot disable sending the password by Talk without setting a new password" : "Negalima išjungti slaptažodžio siuntimo per „Pokalbiai“ nenustatant naujo slaptažodžio",
    ...
    "Unknown share recipient" : "Nežinomas bendrinimo gavėjas",
    ...
    "The source does not exist." : "Šaltinis neegzistuoja.",
    "The recipient does not exist." : "Gavėjas neegzistuoja.",
    "The value must be alphanumeric, 1 to 32 characters long and may contain dashes." : "Reikšmė turi būti sudaryta iš raidžių ir skaitmenų, būti nuo 1 iki 32 simbolių ilgio ir gali turėti brūkšnelių.",
    "You need to add at least one source to make the share available." : "Norėdami, kad bendrinimas būtų galimas, turite pridėti bent vieną šaltinį.",
    "You need to add at least one recipient to make the share available." : "Norėdami, kad bendrinimas taptų prieinamas, turite pridėti bent vieną gavėją.",
    "You need to allow at least one permission to make the share available." : "Norėdami, kad bendrinimas būtų galimas, turite suteikti bent vieną leidimą.",
    "You need to set a value for the %s" : "Turite nustatyti %s reikšmę.",
    ...
    "Username is too long" : "Vartotojo vardas per ilgas",
    "Login is invalid because files already exist for this user" : "Prisijungimo įvardijimas negalimas, nes šiam vartotojui jau yra sukurti failai",
    ...
    "Your data directory is not readable." : "Jūsų duomenų katalogas neskaitomas.",
    "Your data directory is not writable." : "Jūsų duomenų katalogas nėra įrašomas.",
    "Setting locale to %s failed." : "Nepavyko %s lokalės konfogūracija.",
    "Please install one of these locales on your system and restart your web server." : "Įdiekite vieną iš šių lokalių savo sistemoje ir perkraukite žiniatinklio serverį.",
    ...
    "This is probably caused by a cache/accelerator such as Zend OPcache or eAccelerator." : "Tai greičiausiai lemia tokia tarpinės atminties ar spartinimo programa kaip „Zend OPcache“ ar „eAccelerator“.",
    ...
    "Action \"%s\" not supported or implemented." : "Veiksmas „%s“ nepalaikomas arba neįgyvendintas.",
    "Authentication failed, wrong token or provider ID given" : "Tapatybės nustatymas nepavyko, nurodytas neteisingas žymuo arba teikėjo ID",
    ...
    "Storage connection error. %s" : "Saugyklos ryšio klaida. %s",
    ...
    "Translate audio" : "Išversti garso įrašą",
    "Translates the speech of an audio file or recording and outputs an audio file in the desired language." : "Išverčia garso failo arba įrašo kalbą ir pateikia garso failą norima kalba.",
    "Input audio" : "Įvesties garsas",
    "The audio file or recording to translate" : "Garso failas arba įrašas, kurį reikia išversti",
    "Origin language" : "Originalo kalba",
    "The language of the origin audio" : "Originali garso įrašo kalba",
    "Target language" : "Tikslinė kalba",
    "The desired language to translate the origin audio in" : "Norima kalba, į kurią norite išversti originalų garso įrašą",
    "Audio output" : "Garso išvestis",
    "The audio translation" : "Garso vertimas",
    "Transcribe audio" : "Garso įrašą paversti tekstu",
    ...
    "Generate subtitles" : "Generuoti subtitrus",
    "Subtitle the things said in an audio or video" : "Subtitruokite garso ar vaizdo įraše pasakytą turinį",
    "Input file" : "Įvesties failas",
    "The file to subtitle" : "Failas subtitravimui",
    "Subtitles" : "Subtitrai",
    "The subtitles file" : "Subtitrų failas",
    ...
    "Conversation token" : "Pokalbio žymuo",
    ...
    "Chat with tools using attachments" : "Pokalbis su įrankiais naudojant priedus",
    "Chat with the language model with tool calling support and attachments." : "Bendraukite su kalbos modeliu naudodami įrankį, palaikantį skambučių funkciją ir priedus.",
    "Describe a task that you want the assistant to do or ask a question" : "Aprašykite užduotį, kurią norite, kad asistentas atliktų, arba užduokite klausimą",
    "Input attachments" : "Įvesties priedai",
    "Files to send along with the chat message." : "Failai, siunčiami kartu su pokalbio žinute.",
    ...
    "The response from the chat model" : "Pokalbių modelio atsakymas",
    "Output attachments" : "Išvesties priedai",
    "Files generated by the model." : "Modelio sugeneruoti failai.",
    ...
    "Chat with an agent using attachments" : "Bendraukite su agentu naudodami priedus",
    "Memories" : "„Prisiminimai“",
    "Memories to send to the agent." : "Agentui siunčiami atsiminimai",
    "Files generated by the agent." : "Agento sugeneruoti failai.",
    "Sources" : "Šaltiniai",
    "Sources of the generated response." : "Sugeneruoto atsakymo šaltiniai.",
    ...
    "Improve text" : "Patobilinti tekstą",
    "Takes a text and improves it based on instructions" : "Paima tekstą ir jį patobulina pagal nurodymus.",
    "Write a text that you want the assistant to improve" : "Parašykite tekstą, kurį norite, kad asistentas patobulintų.",
    "Instructions" : "Instrukcijos",
    "Describe how the assistant should improve the text" : "Apibūdinkite, kaip asistentas turėtų patobulinti tekstą.",
    "Improved text" : "Patobilintas tekstas",
    "The improved text" : "Patobilintas tekstas",
    "Proofread" : "Korektūra",
    ...
    "Reformat paragraphs" : "Performatuoti pastraipas",
    "Reformats a text into multiple paragraphs separated by topic" : "Performatuoti tekstą į kelias pastraipas, atskirtas pagal temą",
    "The text to reformat" : "Tekstas, kurį reikia performatuoti",
    "Reformatted text" : "Performatuotas tekstas",
    "The reformatted text with paragraphs separated by topic" : "Performatuotas tekstas su pastraipomis, atskirtomis pagal temas",
    ...
    "Summary" : "Santrauka",
    "The generated summary" : "Sugeneruota santrauka",
    ...
    "You are not allowed to edit this share." : "Jums neleidžiama redaguoti šio bendrinimo.",
    "Only true and false are valid values: %s" : "Tik „true“ ir „false“ yra galiojančios reikšmės: %s",
    "Invalid ISO8601 date: %s" : "Netinkama ISO8601 data: %s",
    "Date needs to be after %s" : "Data turi būti vėlesnė nei %s",
    "Date needs to be before %s" : "Data turi būti ankstesnė už %s",
    "Only %1$s are valid values: %2$s" : "Tik %1$s yra galiojančios reikšmės: %2$s",
    "Need at least %1$s characters: %2$s" : "Reikia bent %1$s simbolių: %2$s",
    "Provide %1$s characters at most: %2$s" : "Pateikite ne daugiau kaip %1$s simbolių: %2$s",
    ...
    "You cannot share your root folder" : "Jūs negalite bendrinti šakninio aplanko",
    ...
    "Sharing is only allowed with group members" : "Bendrinimas leidžiama tik su grupės nariais",
    "Group sharing is now allowed" : "Dabar leidžiama bendrinti grupėje",
    "Sharing is only allowed within your own groups" : "Bendrinti leidžiama tik savo grupėse",
    "Link sharing is not allowed" : "Nuorodų bendrinimas draudžiamas",
    ...
    "Token expired. Please reload page." : "Žymuo nebegalioja. Įkelkite puslapį iš naujo."
},
