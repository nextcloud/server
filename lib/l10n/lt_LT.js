OC.L10N.register(
    ...
    "Invalid ISO date: %s" : "Netinkama ISO data: %s",
    "Date needs to be after %1$s: %2$s" : "Data turi būti vėlesnė nei %1$s: %2$s",
    "Date needs to be before %1$s: %2$s" : "Data turi būti ankstesnė už %1$s: %2$s",
