OC.L10N.register(
    ...
    "The database option \"%1$s\" for %2$s has to be a list of values" : "Caithfidh an rogha bunachar sonraí \"%1$s\" do %2$s a bheith ina liosta luachanna",
    "The database option \"%1$s\" is not supported by %2$s" : "Ní thacaíonn %2$s leis an rogha bunachar sonraí \"%1$s\"",
    "The database options \"dbsslcert\" and \"dbsslkey\" have to be provided together" : "Caithfear na roghanna bunachar sonraí \"dbsslcert\" agus \"dbsslkey\" a sholáthar le chéile.",
    ...
    "macOS is not supported and %s will not work properly on this platform." : "Ní thacaítear le macOS agus ní oibreoidh %s i gceart ar an ardán seo.",
    ...
    "Unknown share recipient" : "Faighteoir comhroinnte anaithnid",
    ...
    "Cannot set user status for the owner of the share." : "Ní féidir stádas úsáideora a shocrú d'úinéir an chomhroinnte.",
    "The source does not exist." : "Níl an fhoinse ann.",
    "The recipient does not exist." : "Níl an faighteoir ann.",
    "The value must be alphanumeric, 1 to 32 characters long and may contain dashes." : "Ní mór don luach a bheith alfa-uimhriúil, idir 1 agus 32 carachtar ar fhad agus féadfaidh fleascáin a bheith ann.",
    "You need to add at least one source to make the share available." : "Ní mór duit foinse amháin ar a laghad a chur leis chun an chomhroinnt a chur ar fáil.",
    "You need to add at least one recipient to make the share available." : "Ní mór duit faighteoir amháin ar a laghad a chur leis chun an chomhroinnt a chur ar fáil.",
    "You need to allow at least one permission to make the share available." : "Ní mór duit cead amháin ar a laghad a cheadú chun an chomhroinnt a chur ar fáil.",
    "You need to set a value for the %s" : "Ní mór duit luach a shocrú don %s",
    ...
    "Your data directory is not readable." : "Ní féidir d'eolaire sonraí a léamh.",
    ...
    "Translates the speech of an audio file or recording and outputs an audio file in the desired language." : "Aistríonn sé urlabhra comhaid fuaime nó taifeadta agus cuireann sé comhad fuaime ar fáil sa teanga atá ag teastáil.",
    "Input audio" : "Ionchur fuaime",
    "The audio file or recording to translate" : "An comhad fuaime nó an taifeadadh atá le haistriú",
    ...
    "Generate subtitles" : "Gin fotheidil",
    "Subtitle the things said in an audio or video" : "Cuir fotheidil ar na rudaí a deirtear i bhfíseán nó i gceol fuaime",
    "Input file" : "Comhad ionchuir",
    "The file to subtitle" : "An comhad le fotheidealúAn comhad le fotheidealú",
    "Subtitles" : "Fotheidil",
    "The subtitles file" : "An comhad fotheideal",
    ...
    "Chat with tools using attachments" : "Comhráigh le huirlisí ag baint úsáide as ceangaltáin",
    "Chat with the language model with tool calling support and attachments." : "Comhráigh leis an tsamhail teanga le tacaíocht glaonna uirlisí agus ceangaltáin.",
    ...
    "Input attachments" : "Ceangaltáin ionchuir",
    "Files to send along with the chat message." : "Comhaid le seoladh in éineacht leis an teachtaireacht comhrá.",
    ...
    "The response from the chat model" : "An freagra ón múnla comhrá",
    "Output attachments" : "Ceangaltáin aschuir",
    "Files generated by the model." : "Comhaid a ghintear ag an tsamhail.",
    ...
    "Chat with an agent using attachments" : "Comhráigh le gníomhaire ag baint úsáide as ceangaltáin",
    "Memories" : "Cuimhní cinn",
    "Memories to send to the agent." : "Cuimhní cinn le seoladh chuig an ngníomhaire.",
    "Files generated by the agent." : "Comhaid a ghineann an gníomhaire.",
    "Sources" : "Foinsí",
    "Sources of the generated response." : "Foinsí an fhreagra ginte.",
    ...
    "Improve text" : "Feabhsaigh téacs",
    "Takes a text and improves it based on instructions" : "Glacann téacs agus feabhsaíonn sé é bunaithe ar threoracha",
    "Write a text that you want the assistant to improve" : "Scríobh téacs ar mhaith leat go bhfeabhsódh an cúntóir é",
    "Instructions" : "Comhaid Nextcloud ag teastáil",
    "Describe how the assistant should improve the text" : "Déan cur síos ar an gcaoi ar cheart don chúntóir an téacs a fheabhsú",
    "Improved text" : "Téacs feabhsaithe",
    "The improved text" : "An téacs feabhsaithe",
    ...
    "Extracts topics from a text and outputs them separated by commas." : "Sliocht topaicí as téacs agus aschuir iad scartha le camóga.",
    "Share not found." : "Níor aimsíodh an comhroinn.",
    "You are not allowed to edit this share." : "Níl cead agat an comhroinnt seo a chur in eagar.",
    "Only true and false are valid values: %s" : "Níl ach fíor agus bréagach bailí mar luachanna: %s",
    "Invalid ISO8601 date: %s" : "Dáta neamhbhailí ISO8601: %s",
    "Date needs to be after %s" : "Caithfidh an dáta a bheith i ndiaidh %s",
    "Date needs to be before %s" : "Caithfidh an dáta a bheith roimh %s",
    "Only %1$s are valid values: %2$s" : "Níl ach %1$s ina luachanna bailí: %2$s",
    "Need at least %1$s characters: %2$s" : "Teastaíonn %1$s carachtar ar a laghad: %2$s",
    "Provide %1$s characters at most: %2$s" : "Cuir %1$s carachtar ar fáil ar a mhéad: %2$s",
