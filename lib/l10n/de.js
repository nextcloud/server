OC.L10N.register(
    ...
    "Click the following button to confirm your email." : "Auf die folgende Schaltfläche klicken, um deine E-Mail-Adresse zu bestätigen.",
    "Click the following link to confirm your email." : "Auf den nachfolgenden Link klicken, um deine E-Mail-Adresse zu bestätigen",
    ...
    "Logged in account must be an admin, a sub admin or gotten special right to access this setting" : "Das angemeldete Konto muss ein Administrationskonto sein, ein Unteradministrationskontor sein, oder ein Sonderrecht haben, um auf diese Einstellung zuzugreifen",
    ...
    "Logged in account must be an admin or sub admin" : "Das angemeldete Konto muss ein (Unter-)Administrationskonto sein",
    "Logged in account must be an admin" : "Das angemeldete Konto muss ein Administrationskonto sein",
    ...
    "You need to add at least one source to make the share available." : "Du musst mindestens eine Quelle hinzufügen, um die Freigabe verfügbar zu machen.",
    "You need to add at least one recipient to make the share available." : "Du musst mindestens einen Empfänger hinzufügen, um den Anteil verfügbar zu machen.",
    "You need to allow at least one permission to make the share available." : "Du musst mindestens eine Berechtigung zulassen, um die Freigabe verfügbar zu machen.",
    "You need to set a value for the %s" : "Du musst einen Wert für %s festlegen",
    ...
    "Please install one of these locales on your system and restart your web server." : "Bitte eine dieser Sprachen (locales) auf dem System installieren und den Webserver neu starten.",
    ...
    "Please ask your server administrator to restart the web server." : "Bitte deine Serveradministration, den Webserver neu zu starten.",
    ...
    "Chat with tools using attachments" : "Chatte mit Tools, die Anhänge verwenden",
    "Chat with the language model with tool calling support and attachments." : "Chatte mit dem Sprachmodell mit Tool-Aufrufunterstützung und Anhängen.",
    ...
    "Memories" : "Memories",
    "Memories to send to the agent." : "Erinnerungen, die an den Agenten gesendet werden sollen.",
    "Files generated by the agent." : "Vom Agenten erstellte Dateien.",
    "Sources" : "Quellen",
    ...
    "Write a text that you want the assistant to improve" : "Schreibe einen Text, den der Assistent verbessern soll",
    "Instructions" : "Anweisungen",
    "Describe how the assistant should improve the text" : "Beschreibe, wie der Assistent den Text verbessern soll",
    ...
    "You are not allowed to edit this share." : "Du darfst diese Freigabe nicht bearbeiten.",
