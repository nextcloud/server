OC.L10N.register(
    ...
    "Nextcloud %s or higher is required." : "Nextcloud با نسخه‎ی %s یا بالاتر نیاز است.",
    "Nextcloud %s or lower is required." : "Nextcloud با نسخه‎ی %s یا پایین‌تر نیاز است.",
    "Help" : "راه‌نما",
    "Personal" : "شخصی",
    "Users" : "کاربران",
    "Admin" : "مدیر",
    "Recommended" : "پیشنهاد شده",
    "App \"%s\" cannot be installed because it is not compatible with this version of Nextcloud." : "امکان نصب برنامه‌ی  \"%s\" به علت عدم سازگاری با این نسخه از Nextcloud وجود ندارد.",
