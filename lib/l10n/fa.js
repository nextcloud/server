OC.L10N.register(
    ...
    "Unknown share recipient" : "گیرنده اشتراک‌گذاری ناشناخته",
    ...
    "Question" : "پرسش",
    "What to ask about the images." : "چه چیزی درباره تصاویر پرسیده شود.",
    "Generated response" : "پاسخ تولید شده",
    "The answer to the question" : "پاسخ به پرسش",
    "Audio chat" : "گفتگوی صوتی",
    ...
    "Describe a task that you want the assistant to do or ask a question." : "وظیفه‌ای را که می‌خواهید دستیار انجام دهد توصیف کنید یا پرسشی مطرح کنید.",
    "Chat history" : "تاریخچه چت",
    "The history of chat messages before the current message, starting with a message by the user." : "تاریخچه پیام‌های گفتگو پیش از پیام کنونی، که با پیامی از سوی کاربر آغاز می‌شود.",
    ...
    "Chat by voice with an agent" : "گفتگوی صوتی با یک عامل",
    "Describe a task that you want the agent to do or ask a question." : "وظیفه‌ای را که می‌خواهید عامل انجام دهد توصیف کنید یا پرسشی مطرح کنید.",
    "Confirmation" : "تأیید",
    ...
    "Optical character recognition" : "تشخیص نوری نویسه",
    "Extract text from files like images or PDFs" : "استخراج متن از فایل‌هایی مانند تصاویر یا PDF",
    ...
    "Reformat paragraphs" : "قالب‌بندی مجدد پاراگراف‌ها",
    "Reformats a text into multiple paragraphs separated by topic" : "یک متن را به چند پاراگراف جداشده بر اساس موضوع قالب‌بندی مجدد می‌کند",
    "The text to reformat" : "متنی که باید قالب‌بندی مجدد شود",
    "Reformatted text" : "متن قالب‌بندی‌شده مجدد",
    "The reformatted text with paragraphs separated by topic" : "متن قالب‌بندی‌شده مجدد با پاراگراف‌های جداشده بر اساس موضوع",
