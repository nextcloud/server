OC.L10N.register(
    ...
    "Nextcloud %s or higher is required." : "É necessário Nextcloud %s ou superior.",
    "Nextcloud %s or lower is required." : "É necessário Nextcloud %s ou inferior.",
    "Help" : "Ajuda",
    "Personal" : "Pessoal",
    "Users" : "Utilizadores",
    "Admin" : "Admin",
    "Recommended" : "Recomendado",
    "App \"%s\" cannot be installed because it is not compatible with this version of Nextcloud." : "A aplicação \"%s\" não pode ser instalada por não ser compatível com esta versão da Nextcloud.",
    ...
    "App can't be installed because it is not compatible with this version of Nextcloud" : "A aplicação não pode ser instalada por não ser compatível com esta versão do Nextcloud",
    ...
    "Adjusting this setting in php.ini will make Nextcloud run again" : "Ajustar esta configuração no php.ini fará com que o Nextcloud funcione de novo",
