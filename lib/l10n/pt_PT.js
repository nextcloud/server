OC.L10N.register(
    ...
    "Filenames must not end with \"%1$s\"." : "Os nomes de arquivos não podem terminar com \"%1$s\".",
    ...
    "Sharing %s failed, because this item is already shared with the account %s" : "Falha ao compartilhar %s porque este item já está compartilhado com a conta %s",
    ...
    "Unknown share recipient" : "Destinatário de compartilhamento desconhecido",
    ...
    "Translates the speech of an audio file or recording and outputs an audio file in the desired language." : "Traduz o conteúdo de um arquivo de áudio ou gravação e gera um arquivo de áudio no idioma desejado.",
    ...
    "Subtitle the things said in an audio or video" : "Adicionar legendas às conversas em um arquivo de áudio ou vídeo",
    ...
    "Describe how the assistant should improve the text" : "Descreva como o assistente deve melhorar o texto",
    "Proofread" : "Revisar",
    "Text" : "Texto",
