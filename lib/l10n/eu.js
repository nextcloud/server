OC.L10N.register(
    ...
    "Your current IP address doesn't allow you to perform admin actions" : "Zure oraingo IP helbideak ez dizu administrazio ekintzarik egiteko aukerarik ematen",
    ...
    "macOS is not supported and %s will not work properly on this platform." : "macOS ez da onartzen eta %s ez da behar bezala funtzionatuko plataforma honetan.",
    ...
    "You cannot share a folder that contains other shares" : "Ezin duzu partekatu barnean beste partekatzeak dituen karpeta bat.",
    ...
    "The share already contains the source." : "Partekatzeak iturria dauka dagoeneko.",
    "The share already contains the recipient." : "Partekatzeak hartzailea dauka dagoeneko.",
    ...
    "Chat by voice with an agent" : "Ahots txata agente batekin",
    "Describe a task that you want the agent to do or ask a question." : "Deskribatu agenteak egitea nahi duzun zeregina edo galdera bat egin.",
