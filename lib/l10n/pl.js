OC.L10N.register(
    ...
    "The source does not exist." : "Źródło nie istnieje.",
    "The recipient does not exist." : "Odbiorca nie istnieje.",
    "The value must be alphanumeric, 1 to 32 characters long and may contain dashes." : "Wartość musi być alfanumeryczna, mieć od 1 do 32 znaków i może zawierać myślniki.",
    "You need to add at least one source to make the share available." : "Musisz dodać co najmniej jedno źródło, aby udostępnienie było dostępne.",
    "You need to add at least one recipient to make the share available." : "Musisz dodać co najmniej jednego odbiorcę, aby udostępnienie było dostępne.",
    "You need to allow at least one permission to make the share available." : "Musisz przyznać co najmniej jedno uprawnienie, aby udostępnienie było dostępne.",
    "You need to set a value for the %s" : "Musisz podać wartość dla %s",
    ...
    "Your data directory is not readable." : "Twój katalog danych nie jest dostępny do odczytu.",
    ...
    "You are not allowed to edit this share." : "Nie masz uprawnień do edycji tego udostępnienia.",
    "Only true and false are valid values: %s" : "Dopuszczalne wartości dla %s to wyłącznie: true i false.",
    "Invalid ISO date: %s" : "Nieprawidłowa data ISO: %s",
    "Date needs to be after %1$s: %2$s" : "Data musi być późniejsza niż %1$s:%2$s",
    "Date needs to be before %1$s: %2$s" : "Data musi być wcześniejsza niż %1$s: %2$s",
    "Only %1$s are valid values: %2$s" : "Dopuszczalne wartości dla %1$s: %2$s",
    "Need at least %1$s characters: %2$s" : "Wymagana liczba znaków dla %1$s: co najmniej %2$s",
    "Provide %1$s characters at most: %2$s" : "Maksymalna liczba znaków dla %1$s: %2$s",
    ...
    "Translate audio" : "Przetłumacz dźwięk",
    "Translates the speech of an audio file or recording and outputs an audio file in the desired language." : "Tłumaczy mowę z pliku audio lub nagrania i tworzy plik audio w wybranym języku.",
    "Input audio" : "Wejściowy plik audio",
    "The audio file or recording to translate" : "Plik audio lub nagranie do przetłumaczenia",
    "Origin language" : "Język źródłowy",
    "The language of the origin audio" : "Język oryginalnego nagrania",
    "Target language" : "Język docelowy",
    "The desired language to translate the origin audio in" : "Docelowy język tłumaczenia nagrania",
    "Audio output" : "Wyjście audio",
    "The audio translation" : "Przetłumaczone nagranie audio",
    ...
    "Subtitle the things said in an audio or video" : "Utwórz napisy do treści mówionych w pliku audio lub wideo",
    "Input file" : "Plik wejściowy",
    "The file to subtitle" : "Plik, do którego mają zostać wygenerowane napisy",
    "Subtitles" : "Napisy",
    "The subtitles file" : "Plik z napisami",
    ...
    "Chat with tools using attachments" : "Czat z narzędziami i załącznikami",
    "Chat with the language model with tool calling support and attachments." : "Czat z modelem językowym obsługującym wywoływanie narzędzi i załączniki.",
    ...
    "Input attachments" : "Załączniki wejściowe",
    "Files to send along with the chat message." : "Pliki do dołączenia do wiadomości na czacie",
    ...
    "The response from the chat model" : "Odpowiedź z modelu czatu",
    "Output attachments" : "Załączniki wyjściowe",
    "Files generated by the model." : "Pliki wygenerowane przez model.",
    ...
    "Chat with an agent using attachments" : "Czat z agentem z użyciem załączników",
    "Memories" : "Wspomnienia",
    "Memories to send to the agent." : "Wspomnienia do przekazania agentowi",
    "Files generated by the agent." : "Pliki wygenerowane przez agenta",
    "Sources" : "Źródła",
    "Sources of the generated response." : "Źródła wygenerowanej odpowiedzi",
    ...
    "Improve text" : "Ulepsz tekst",
    "Takes a text and improves it based on instructions" : "Pobiera tekst i ulepsza go zgodnie z instrukcjami",
    "Write a text that you want the assistant to improve" : "Wpisz tekst, który asystent ma ulepszyć",
    "Instructions" : "Instrukcje:",
    "Describe how the assistant should improve the text" : "Opisz, w jaki sposób asystent powinien ulepszyć tekst",
    "Improved text" : "Ulepszony tekst",
    "The improved text" : "Ulepszony tekst",
    "Proofread" : "Korekta",
