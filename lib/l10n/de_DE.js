OC.L10N.register(
    ...
    "Invalid ISO date: %s" : "Ungültiges ISO-Datum: %s",
    "Date needs to be after %1$s: %2$s" : "Das Datum muss nach %1$s sein: %2$s",
    "Date needs to be before %1$s: %2$s" : "Das Datum muss vor %1$s sein: %2$s",
