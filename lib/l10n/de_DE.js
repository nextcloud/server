OC.L10N.register(
    ...
    "Click the following button to confirm your email." : "Auf die folgende Schaltfläche klicken, um Ihre E-Mail-Adresse zu bestätigen.",
    ...
    "The database option \"%1$s\" for %2$s has to be a list of values" : "Die Datenbankoption \"%1$s\" für %2$s muss eine Liste von Werten sein",
    "The database option \"%1$s\" is not supported by %2$s" : "Die Datenbankoption \"%1$s\" wird von %2$s nicht unterstützt",
    "The database options \"dbsslcert\" and \"dbsslkey\" have to be provided together" : "Die Datenbankoptionen \"dbsslcert\" und \"dbsslkey\" müssen zusammen bereitgestellt werden",
    ...
    "macOS is not supported and %s will not work properly on this platform." : "MacOS wird nicht unterstützt und %s wird auf dieser Plattform nicht richtig funktionieren.",
    ...
    "Share provider does not support accepting" : "Der Teilen-Anbieter unterstützt das Annehmen nicht",
    ...
    "Unknown share recipient" : "Unbekannter Freigabeempfänger",
    ...
    "Cannot set user status for the owner of the share." : "Der Benutzerstatus für den Eigentümer der Freigabe kann nicht festgelegt werden.",
    "The source does not exist." : "Quelle existiert nicht.",
    "The recipient does not exist." : "Empfänger existiert nicht.",
    "The value must be alphanumeric, 1 to 32 characters long and may contain dashes." : "Der Wert muss alphanumerisch sein, 1 bis 32 Zeichen lang sein und kann Bindestriche enthalten.",
    "You need to add at least one source to make the share available." : "Sie müssen mindestens eine Quelle hinzufügen, um die Freigabe verfügbar zu machen.",
    "You need to add at least one recipient to make the share available." : "Sie müssen mindestens einen Empfänger hinzufügen, um die Freigabe verfügbar zu machen.",
    "You need to allow at least one permission to make the share available." : "Sie müssen mindestens eine Berechtigung zulassen, um die Freigabe verfügbar zu machen.",
    "You need to set a value for the %s" : "Sie müssen einen Wert für %s festlegen",
    ...
    "Your data directory is not readable." : "Das Datenverzeichnis ist schreibgeschützt.",
    ...
    "Please ask your server administrator to restart the web server." : "Bitten Sie Ihre Serveradministration, den Webserver neu zu starten.",
    ...
    "Translates the speech of an audio file or recording and outputs an audio file in the desired language." : "Übersetzt die Sprache einer Audiodatei oder -aufnahme und gibt eine Audiodatei in der gewünschten Sprache aus.",
    "Input audio" : "Eingangsaudio",
    "The audio file or recording to translate" : "Die zu übersetzende Audiodatei oder Aufnahme",
    ...
    "Generate subtitles" : "Untertitel erzeugen",
    "Subtitle the things said in an audio or video" : "Die in einer Audio- oder Videodatei gesagten Inhalte mit Untertiteln versehen",
    "Input file" : "Eingabedatei",
    "The file to subtitle" : "Die Datei, die untertitelt werden soll",
    "Subtitles" : "Untertitel",
    "The subtitles file" : "Die Untertiteldatei",
    ...
    "Chat with tools using attachments" : "Chatten Sie mit Tools mithilfe von Anhängen",
    "Chat with the language model with tool calling support and attachments." : "Chatten Sie mit dem Sprachmodell mit Tool-Aufrufunterstützung und Anhängen.",
    ...
    "Input attachments" : "Eingabeanhänge",
    "Files to send along with the chat message." : "Dateien, die zusammen mit der Chat-Nachricht gesendet werden sollen",
    ...
    "Output attachments" : "Ausgabeanhänge",
    "Files generated by the model." : "Die vom Modell erstellten Dateien",
    ...
    "Chat with an agent using attachments" : "Mit einem Agenten mithilfe von Anhängen chatten",
    "Memories" : "Memories",
    "Memories to send to the agent." : "Erinnerungen, die an den Agenten gesendet werden.",
    "Files generated by the agent." : "Vom Agenten generierte Dateien.",
    "Sources" : "Quellen",
    "Sources of the generated response." : "Quellen der erstellten Antwort.",
    ...
    "Improve text" : "Text verbessern",
    "Takes a text and improves it based on instructions" : "Nimmt einen Text und verbessert ihn anhand von Anweisungen",
    "Write a text that you want the assistant to improve" : "Schreiben Sie einen Text, den der Assistent verbessern soll",
    "Instructions" : "Anweisungen",
    "Describe how the assistant should improve the text" : "Beschreiben Sie, wie der Assistent den Text verbessern soll",
    "Improved text" : "Verbesserter Text",
    "The improved text" : "Der verbesserte Text",
    ...
    "You are not allowed to edit this share." : "Sie dürfen diese Freigabe nicht bearbeiten.",
    "Only true and false are valid values: %s" : "Nur wahr und falsch sind gültige Werte: %s",
    "Invalid ISO8601 date: %s" : "Ungültiges ISO8601-Datum: %s",
    "Date needs to be after %s" : "Das Datum muss nach dem %s sein",
    "Date needs to be before %s" : "Das Datum muss vor dem %s sein",
    "Only %1$s are valid values: %2$s" : "Nur %1$s sind gültige Werte: %2$s",
    "Need at least %1$s characters: %2$s" : "Mindestens %1$s Zeichen erforderlich: %2$s",
    "Provide %1$s characters at most: %2$s" : "Maximal %1$s Zeichen eingeben: %2$s",
