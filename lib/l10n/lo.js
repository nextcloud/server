OC.L10N.register(
    ...
    "%1$s shared %2$s with you" : "%1$s ໄດ້ແບ່ງປັນ %2$s ໃຫ້ທ່ານ",
    "Open %s" : "ເປີດ %s",
    ...
    "_Cannot set expiration date more than %n day in the future_::_Cannot set expiration date more than %n days in the future_" : ["Cannot set expiration date more than %n days in the future"],
