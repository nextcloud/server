OC.L10N.register(
    ...
    "Nextcloud %s or higher is required." : "Nextcloud %s ou supérieur est requis.",
    "Nextcloud %s or lower is required." : "Nextcloud %s ou inférieur est requis.",
    "Help" : "Aide",
    "Personal" : "Personnel",
    "Users" : "Utilisateurs",
    "Admin" : "Administration",
    "Recommended" : "Recommandée",
    "App \"%s\" cannot be installed because it is not compatible with this version of Nextcloud." : "L'application \"%s\" ne peut pas être installée car elle n'est pas compatible avec cette version de Nextcloud.",
