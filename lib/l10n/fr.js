OC.L10N.register(
    ...
    "A chat message to send to the agent." : "Un message de discussion à envoyer à l’agent.",
    ...
    "Chat with tools using attachments" : "Discuter avec des outils à l’aide de pièces jointes",
    "Chat with the language model with tool calling support and attachments." : "Discuter avec le modèle de langage prenant en charge les appels de fonctions et les pièces jointes.",
    ...
    "Files to send along with the chat message." : "Fichiers à envoyer avec le message de discussion.",
    ...
    "Tools call instructions from the model in JSON format" : "Instructions fournies par le modèle pour les appels de fonction, au format JSON",
    ...
    "Write a text that you want the assistant to improve" : "Saisissez le texte que vous souhaitez faire améliorer par l'assistant",
    ...
    "Reformats a text into multiple paragraphs separated by topic" : "Reformater le texte en paragraphes multiples séparés par sujet",
    "The text to reformat" : "Le texte à reformater",
    "Reformatted text" : "Texte reformaté",
    "The reformatted text with paragraphs separated by topic" : "Le texte reformaté avec des paragraphes séparés par sujet",
    ...
    "Only true and false are valid values: %s" : "Seules les valeurs true et false sont valides : %s",
    ...
    "Only %1$s are valid values: %2$s" : "Seules les valeurs %1$s sont valides : %2$s",
    "Need at least %1$s characters: %2$s" : "Au moins %1$s caractères sont requis : %2$s",
    "Provide %1$s characters at most: %2$s" : "Indiquez au maximum %1$s caractères : %2$s",
