OC.L10N.register(
    ...
    "Invalid ISO date: %s" : "Date ISO non valide : %s",
    "Date needs to be after %1$s: %2$s" : "La date doit être postérieure à %1$s : %2$s",
    "Date needs to be before %1$s: %2$s" : "La date doit être antérieure à %1$s : %2$s",
