OC.L10N.register(
    ...
    "But, if you prefer to keep config.php file read only, set the option \"config_is_read_only\" to true in it." : "Mais si vous préférez conserver le fichier config.php en lecture seule, définissez-y l’option « config_is_read_only » à true.",
    "See %s" : "Voir %s",
    ...
    "Education bundle" : "Pack pour l’éducation",
    "Enterprise bundle" : "Pack pour entreprise",
    "Groupware bundle" : "Pack Groupware",
    "Hub bundle" : "Pack Nextcloud Hub",
    "Public sector bundle" : "Pack pour le secteur public",
    "Social sharing bundle" : "Pack de partage social",
    ...
    "%sbit or higher PHP required." : "PHP doit prendre en charge les entiers sur au moins %s bits.",
    ...
    "Wiping of device %s has started" : "L’effacement de l’appareil %s a démarré",
    "Wiping of device »%s« has started" : "L’effacement de l’appareil « %s » a démarré",
    "»%s« started remote wipe" : "« %s » a démarré l’effacement distant",
    "Device or application »%s« has started the remote wipe process. You will receive another email once the process has finished" : "L'appareil ou l'application « %s » a démarré le processus d’effacement distant. Vous recevrez un autre e-mail une fois le processus terminé",
    "Wiping of device %s has finished" : "L’effacement de l’appareil %s est terminé",
    "Wiping of device »%s« has finished" : "L’effacement de l’appareil « %s » est terminé",
    "»%s« finished remote wipe" : "« %s » a terminé l’effacement distant",
    "Device or application »%s« has finished the remote wipe process." : "L'appareil ou l'application « %s » a terminé le processus d’effacement distant.",
    "Remote wipe started" : "Effacement distant lancé",
    "A remote wipe was started on device %s" : "Un effacement distant a été lancé sur l’appareil %s",
    "Remote wipe finished" : "Effacement distant terminé",
    "The remote wipe on %s has finished" : "L’effacement distant de %s est terminé",
    ...
    "Module with ID: %s does not exist. Please enable it in your apps settings or contact your administrator." : "Le module avec l’ID %s n’existe pas. Merci de l’activer dans les paramètres des applications ou de contacter votre administrateur.",
    ...
    "Destination does not match conversion extension" : "L’extension du fichier de destination ne correspond pas à l’extension attendue pour la conversion",
    "Could not convert file" : "Impossible de convertir le fichier",
    "Destination does not exist" : "La destination n'existe pas",
    "Destination is not creatable" : "Impossible de créer un fichier à l’emplacement de destination",
    "Dot files are not allowed" : "Les noms « . » et « .. » ne sont pas autorisés",
    ...
    "Moving a share (%s) into another storage (%s) is not allowed" : "Déplacer un partage (%s) dans un autre emplacement de stockage (%s) n'est pas autorisé",
    ...
    "Empty filename is not allowed" : "Un nom de fichier vide n'est pas autorisé",
    ...
    "The database option \"%1$s\" for %2$s has to be a list of values" : "L’option de base de données « %1$s » pour %2$s doit être une liste de valeurs",
    "The database option \"%1$s\" is not supported by %2$s" : "L'option de base de données « %1$s » n'est pas prise en charge par %2$s",
    "The database options \"dbsslcert\" and \"dbsslkey\" have to be provided together" : "Les options de base de données « dbsslcert » et « dbsslkey » doivent être fournies ensemble",
    ...
    "Oracle connection could not be established" : "La connexion Oracle n’a pas pu être établie",
    ...
    "macOS is not supported and %s will not work properly on this platform." : "macOS n'est pas pris en charge et %s ne fonctionnera pas correctement sur cette plateforme.",
    ...
    "Please remove the open_basedir setting within your php.ini or switch to 64-bit PHP." : "Veuillez supprimer le paramètre open_basedir de votre php.ini ou passer à PHP 64 bits.",
    ...
    "Cannot create or write into the data directory %s" : "Impossible de créer ou d’écrire dans le répertoire de données %s",
    ...
    "Passwords are enforced for link and mail shares" : "Les mots de passe sont obligatoires pour les partages par lien et par e-mail",
    ...
    "Share recipient is not a valid circle" : "Le destinataire du partage n’est pas une équipe valide",
    ...
    "Expiration date is enforced" : "Une date d’expiration est obligatoire",
    "_Cannot set expiration date more than %n day in the future_::_Cannot set expiration date more than %n days in the future_" : ["Impossible de définir la date d’expiration à plus de %n jour dans le futur","Impossible de définir la date d’expiration à plus de %n jours dans le futur","Impossible de définir la date d’expiration à plus de %n jours dans le futur"],
    ...
    "Cannot share with the share owner" : "Impossible de partager avec le propriétaire du partage",
    ...
    "Can only update recipient on user shares" : "Le destinataire ne peut être modifié que pour les partages avec un utilisateur",
    ...
    "Cannot change target of link share" : "Impossible de modifier la cible du partage par lien",
    "Invalid share recipient" : "Destinataire du partage non valide",
    "Unknown share recipient" : "Destinataire du partage inconnu",
    ...
    "Cannot set user status for the owner of the share." : "Impossible de définir un statut utilisateur pour le propriétaire du partage.",
    "The source does not exist." : "La source n’existe pas.",
    "The recipient does not exist." : "Le destinataire n’existe pas.",
    "The value must be alphanumeric, 1 to 32 characters long and may contain dashes." : "La valeur doit être alphanumérique, comporter entre 1 et 32 caractères et peut contenir des tirets.",
    "You need to add at least one source to make the share available." : "Vous devez ajouter au moins une source pour rendre le partage disponible.",
    "You need to add at least one recipient to make the share available." : "Vous devez ajouter au moins un destinataire pour rendre le partage disponible.",
    "You need to allow at least one permission to make the share available." : "Vous devez accorder au moins une autorisation pour rendre le partage disponible.",
    "You need to set a value for the %s" : "Vous devez définir une valeur pour %s",
    ...
    "Username is too long" : "L’identifiant est trop long",
    ...
    "Login canceled by app" : "Connexion annulée par l’application",
    ...
    "Or, if you prefer to keep config.php file read only, set the option \"config_is_read_only\" to true in it. See %s" : "Ou, si vous préférez conserver le fichier config.php en lecture seule, définissez-y l’option « config_is_read_only » sur true. Voir %s",
    "Cannot create \"data\" directory." : "Impossible de créer le répertoire « data ».",
    ...
    "Your data directory is not readable." : "Votre répertoire de données est illisible.",
    "Your data directory is not writable." : "Votre répertoire de données n’est pas accessible en écriture.",
    ...
    "PHP setting \"%s\" is not set to \"%s\"." : "Le paramètre PHP « %s » n’est pas défini sur « %s ».",
    "Adjusting this setting in php.ini will make Nextcloud run again" : "Ajuster ce paramètre dans php.ini permettra à Nextcloud de fonctionner à nouveau",
    ...
    "Please ask your server administrator to restart the web server." : "Veuillez demander à l’administrateur de votre serveur de redémarrer le serveur web.",
    "The required %s config variable is not configured in the config.php file." : "La variable de configuration requise %s n’est pas définie dans le fichier config.php.",
    "Please ask your server administrator to check the Nextcloud configuration." : "Veuillez demander à l’administrateur de votre serveur de vérifier la configuration de Nextcloud.",
    ...
    "Your data directory must be an absolute path." : "Le chemin de votre répertoire de données doit être absolu.",
    "Check the value of \"datadirectory\" in your configuration." : "Vérifiez la valeur de « datadirectory » dans votre configuration.",
    "Your data directory is invalid." : "Votre répertoire de données n’est pas valide.",
    ...
    "Action \"%s\" not supported or implemented." : "L’action « %s » n’est pas prise en charge ou n’est pas implémentée.",
    "Authentication failed, wrong token or provider ID given" : "Échec de l’authentification : un jeton ou un identifiant de fournisseur incorrect a été fourni",
    ...
    "Storage unauthorized. %s" : "Accès non autorisé à l’espace de stockage. %s",
    "Storage incomplete configuration. %s" : "Configuration de l'espace de stockage incomplète. %s",
    "Storage connection error. %s" : "Erreur de connexion à l’espace de stockage. %s",
    "Storage is temporarily not available" : "L’espace de stockage est temporairement indisponible",
    "Storage connection timeout. %s" : "Le délai d'attente pour la connexion à l'espace de stockage a été dépassé. %s",
    "To allow this check to run you have to make sure that your Web server can connect to itself. Therefore it must be able to resolve and connect to at least one of its `trusted_domains` or the `overwrite.cli.url`. This failure may be the result of a server-side DNS mismatch or outbound firewall rule." : "Pour autoriser cette vérification, vous devez vous assurer que votre serveur web peut se connecter à lui-même. Il doit donc être capable de résoudre et de se connecter à au moins un de ses `trusted_domains` ou à l'URL `overwrite.cli.url`. Cet échec peut résulter d’une incohérence DNS côté serveur ou d’une règle de pare-feu sortante.",
    ...
    "Voice chat with the assistant" : "Chat vocal avec l’assistant",
    ...
    "The history of chat messages before the current message, starting with a message by the user." : "Historique des messages de chat avant le message actuel, en commençant par un message de l’utilisateur",
    ...
    "Translate audio" : "Traduire un fichier audio",
    "Translates the speech of an audio file or recording and outputs an audio file in the desired language." : "Traduit la parole d'un fichier audio ou d'un enregistrement et produit un fichier audio dans la langue souhaitée.",
    "Input audio" : "Audio d'entrée",
    "The audio file or recording to translate" : "Le fichier audio ou l'enregistrement à traduire",
    "Origin language" : "Langue d'origine",
    "The language of the origin audio" : "La langue du fichier audio d'origine",
    "Target language" : "Langue cible",
    "The desired language to translate the origin audio in" : "La langue dans laquelle traduire le fichier audio d'origine",
    "Audio output" : "Sortie audio",
    "The audio translation" : "La traduction audio",
    ...
    "Subtitle the things said in an audio or video" : "Sous-titrer les propos tenus dans un fichier audio ou vidéo.",
    "Input file" : "Fichier d’entrée",
    "The file to subtitle" : "Le fichier à sous-titrer",
    "Subtitles" : "Sous-titres",
    "The subtitles file" : "Le fichier de sous-titres",
    ...
    "A chat message to send to the agent." : "Un message de chat à envoyer à l’agent.",
    "The response from the chat model." : "La réponse du modèle conversationnel.",
    "Context write" : "Rédiger à partir d’un contexte",
    "Writes text in a given style based on the provided source material." : "Rédige un texte dans un style donné à partir du contenu source fourni.",
    ...
    "Source material" : "Contenu source",
    ...
    "The generated text with content from the source material in the given style" : "Le texte généré reprend le contenu source dans le style donné",
    ...
    "Extract text from files like images or PDFs" : "Extraire du texte à partir de fichiers tels que des images ou des PDF",
    "Input files" : "Fichiers d'entrée",
    "The files to extract text from" : "Les fichiers dont le texte doit être extrait",
    "Output texts" : "Textes de sortie",
    "The texts that were extracted from the files" : "Les textes qui ont été extraits des fichiers",
    "Chat with tools using attachments" : "Chat avec outils et pièces jointes",
    "Chat with the language model with tool calling support and attachments." : "Chat avec un modèle de langage capable d’appeler des outils et d’utiliser des pièces jointes.",
    ...
    "Input attachments" : "Pièces jointes en entrée",
    "Files to send along with the chat message." : "Fichiers à envoyer avec le message de chat.",
    "Tool message" : "Message d'outil",
    "The result of tool calls in the last interaction" : "Le résultat des appels d’outils lors de la dernière interaction",
    "The history of chat messages before the current message, starting with a message by the user" : "Historique des messages de chat avant le message actuel, en commençant par un message de l’utilisateur",
    "Available tools" : "Outils disponibles",
    "The available tools in JSON format" : "Les outils disponibles au format JSON",
    "The response from the chat model" : "La réponse du modèle conversationnel",
    "Output attachments" : "Pièces jointes en sortie",
    "Files generated by the model." : "Fichiers générés par le modèle.",
    "Tool calls" : "Appels d’outils",
    "Tools call instructions from the model in JSON format" : "Instructions d’appel d’outils fournies par le modèle au format JSON",
    "Chat with an agent using attachments" : "Discuter avec un agent à l’aide de pièces jointes",
    "Memories" : "Souvenirs",
    "Memories to send to the agent." : "Mémoires à envoyer à l’agent.",
    "Files generated by the agent." : "Fichiers générés par l’agent.",
    "Sources" : "Sources",
    "Sources of the generated response." : "Sources de la réponse générée.",
    "Generate image" : "Générer une image",
    "Generate an image from a text prompt" : "Générer une image à partir d’une invite textuelle",
    ...
    "Write transcript that you want the assistant to generate speech from" : "Saisissez la transcription à partir de laquelle vous souhaitez que l’assistant génère la synthèse vocale",
    ...
    "Runs an arbitrary prompt through a language model that returns a reply" : "Exécute une invite libre à l’aide d’un modèle de langage qui génère une réponse",
    ...
    "Change the tone of a piece of text." : "Changer le ton d’un texte.",
    ...
    "The rewritten text in the desired tone, written by the assistant:" : "Le texte réécrit par l’assistant dans le ton souhaité :",
    "Chat" : "Chat",
    "Chat with the assistant" : "Discuter avec l'assistant",
    "Response message" : "Message de réponse",
    "The generated response as part of the conversation" : "Réponse générée dans le cadre de la conversation",
    "Chat with tools" : "Chat avec outils",
    "Chat with the language model with tool calling support." : "Chat avec un modèle de langage capable d’appeler des outils.",
    ...
    "Improve text" : "Améliorer un texte",
    "Takes a text and improves it based on instructions" : "Améliore un texte en suivant les instructions fournies",
    "Write a text that you want the assistant to improve" : "Saisissez le texte que vous souhaitez que l’assistant améliore",
    "Instructions" : "Instructions",
    "Describe how the assistant should improve the text" : "Décrivez comment l'assistant doit améliorer le texte",
    "Improved text" : "Texte amélioré",
    "The improved text" : "Le texte amélioré",
    "Proofread" : "Relire",
    ...
    "Reformat paragraphs" : "Reformater les paragraphes",
    "Reformats a text into multiple paragraphs separated by topic" : "Reformate un texte en plusieurs paragraphes organisés par sujet",
    "The text to reformat" : "Le texte à reformater",
    "Reformatted text" : "Texte reformaté",
    "The reformatted text with paragraphs separated by topic" : "Le texte reformaté en paragraphes organisés par sujet",
    ...
    "Summarize" : "Résumer",
    "Summarizes a text" : "Résume un texte",
    ...
    "The original text to extract topics from" : "Texte original à partir duquel extraire les sujets",
    "Topics" : "Sujets",
    ...
    "Free prompt" : "Invite libre",
    "Runs an arbitrary prompt through the language model." : "Exécute une invite libre via le modèle de langage.",
    ...
    "Extracts topics from a text and outputs them separated by commas." : "Extrait les sujets d’un texte et les restitue séparés par des virgules.",
    "Share not found." : "Partage introuvable.",
    "You are not allowed to edit this share." : "Vous n’êtes pas autorisé à modifier ce partage.",
    "Only true and false are valid values: %s" : "Seules les valeurs true et false sont valides. Valeur fournie : %s",
    "Invalid ISO8601 date: %s" : "Date ISO 8601 invalide : %s",
    "Date needs to be after %s" : "La date doit être postérieure à %s",
    "Date needs to be before %s" : "La date doit être antérieure à %s",
    "Only %1$s are valid values: %2$s" : "Seules les valeurs %1$s sont valides. Valeur fournie : %2$s",
    "Need at least %1$s characters: %2$s" : "Au moins %1$s caractères sont requis. Valeur fournie : %2$s",
    "Provide %1$s characters at most: %2$s" : "Indiquez au maximum %1$s caractères. Valeur fournie : %2$s",
    ...
    "File shares cannot have create or delete permissions" : "Les partages de fichiers ne peuvent pas avoir de permissions de création ou de suppression",
    ...
    "Sharing is only allowed with group members" : "Le partage n’est possible qu’avec les membres du groupe",
    ...
    "Link sharing is not allowed" : "Le partage par lien n’est pas autorisé",
    ...
    "Token expired. Please reload page." : "Le jeton de sécurité a expiré. Veuillez recharger la page."
},
