OC.L10N.register(
    ...
    "Nextcloud %s or higher is required." : "Требуется Nextcloud %s или выше.",
    "Nextcloud %s or lower is required." : "Требуется Nextcloud версии %s или ниже.",
    "Help" : "Помощь",
    "Personal" : "Личное",
    "Users" : "Пользователи",
    "Admin" : "Администрирование",
    "Recommended" : "Рекомендовано",
    "App \"%s\" cannot be installed because it is not compatible with this version of Nextcloud." : "Приложение \"%s\" не может быть установлено, так как оно не совместимо с этой версией Nextcloud.",
    ...
    "App can't be installed because it is not compatible with this version of Nextcloud" : "Приложение невозможно установить. Не совместимо с текущей версией Nextcloud.",
    ...
    "Adjusting this setting in php.ini will make Nextcloud run again" : "Установка этого параметра в php.ini позволит запуститься Nextcloud снова.",
