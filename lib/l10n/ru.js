OC.L10N.register(
    ...
    "Sharing %s failed, could not find %s, maybe the server is currently unreachable." : "Открытие доступа к %s провалено, не удалось найти %s, возможно, сервер не доступен.",
