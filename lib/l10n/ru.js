OC.L10N.register(
    ...
    "macOS is not supported and %s will not work properly on this platform." : "macOS не поддерживается и %s не будет работать должным образом на этой платформе.",
    ...
    "Unknown share recipient" : "Неизвестный получатель доли",
    ...
    "The share already contains the source." : "В ресурсе общего доступа уже указан источник.",
    "The share already contains the recipient." : "В ресурсе общего доступа уже указан получатель.",
    "The source does not exist." : "Источник не существует.",
    "The recipient does not exist." : "Получатель не существует.",
    "The value must be alphanumeric, 1 to 32 characters long and may contain dashes." : "Значение должно быть буквенно-цифровым, длиной от 1 до 32 символов и может содержать тире.",
    "You need to add at least one source to make the share available." : "Вам необходимо добавить хотя бы один источник, чтобы открыть общий доступ.",
    "You need to add at least one recipient to make the share available." : "Вам необходимо добавить хотя бы одного получателя, чтобы открыть общий доступ.",
    "You need to allow at least one permission to make the share available." : "Вам необходимо добавить хотя бы одно разрешение, чтобы открыть общий доступ.",
    "You need to set a value for the %s" : "Вам нужно задать значение для %s",
    ...
    "Your data directory is not readable." : "Ваша директория данных не читается.",
    ...
    "Translates the speech of an audio file or recording and outputs an audio file in the desired language." : "Переводит речь из аудиофайла или записи и выводит аудиофайл на нужном языке.",
    "Input audio" : "Исходное аудио",
    "The audio file or recording to translate" : "Аудиофайл или запись для перевода",
    "Origin language" : "Исходный язык",
    "The language of the origin audio" : "Язык исходного аудио",
    "Target language" : "Целевой язык",
    "The desired language to translate the origin audio in" : "Желаемый язык для перевода исходного аудио",
    "Audio output" : "Аудиовыход",
    "The audio translation" : "Перевод аудио",
    ...
    "Generate subtitles" : "Сгенерировать субтитры",
    "Subtitle the things said in an audio or video" : "Добавляет субтитры к тому, что говорится в аудио- или видеозаписи",
    "Input file" : "Исходный файл",
    "The file to subtitle" : "Файл для создания субтитров",
    "Subtitles" : "Субтитры",
    "The subtitles file" : "Файл субтитров",
    ...
    "Extract text from files like images or PDFs" : "Извлечение текста из файлов, таких как изображения или PDF-файлы",
    "Input files" : "Входные файлы",
    "The files to extract text from" : "Файлы, из которых нужно извлечь текст",
    "Output texts" : "Вывод текста",
    "The texts that were extracted from the files" : "Тексты, извлеченные из файлов",
    "Chat with tools using attachments" : "Общение с помощью инструментов с использованием вложений",
    "Chat with the language model with tool calling support and attachments." : "Общайтесь с языковой моделью с помощью инструмента, поддерживающего вызов функций и вложение файлов.",
    ...
    "Input attachments" : "Вложенные файлы",
    "Files to send along with the chat message." : "Файлы, которые нужно отправить вместе с сообщением в чате.",
    ...
    "Output attachments" : "Вложения вывода",
    "Files generated by the model." : "Файлы, сгенерированные моделью.",
    ...
    "Chat with an agent using attachments" : "Общайтесь с агентом, используя вложения",
    "Memories" : "Воспоминания",
    "Memories to send to the agent." : "Воспоминания, которые нужно отправить агенту.",
    "Files generated by the agent." : "Файлы, сгенерированные агентом.",
    "Sources" : "Источники",
    "Sources of the generated response." : "Источники, используемые при генерировации ответа.",
    ...
    "Takes a text and improves it based on instructions" : "Принимает текст и улучшает его в соответствии с инструкциями",
    "Write a text that you want the assistant to improve" : "Напишите текст, который вы хотите, чтобы ассистент улучшил",
    "Instructions" : "Инструкции",
    "Describe how the assistant should improve the text" : "Опишите, как ассистент должен улучшить текст",
    "Improved text" : "Улучшенный текст",
    "The improved text" : "Текст после улучшения",
    ...
    "You are not allowed to edit this share." : "Вам запрещено редактировать этот материал.",
    "Only true and false are valid values: %s" : "Только true и false допустимы в качестве значения: %s",
    "Invalid ISO8601 date: %s" : "Неверная дата формата ISO8601: %s",
    "Date needs to be after %s" : "Дата должна быть указана после %s",
    "Date needs to be before %s" : "Дата должна быть указана до %s",
    "Only %1$s are valid values: %2$s" : "Только %1$s являются допустимыми значениями: %2$s",
    "Need at least %1$s characters: %2$s" : "Необходимо как минимум%1$s символов: %2$s",
    "Provide %1$s characters at most: %2$s" : "Укажите не более %1$s символов: %2$s",
