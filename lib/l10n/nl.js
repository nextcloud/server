OC.L10N.register(
    ...
    "Filename is a reserved word" : "Bestandsnaam is een gereserveerd woord",
    "Filename contains at least one invalid character" : "De bestandsnaam bevat ten minste één ongeldig teken",
    "Filename is too long" : "Bestandsnaam is te lang",
    ...
    "macOS is not supported and %s will not work properly on this platform." : "macOS wordt niet ondersteunt en %s zal niet goed werken op dit platform.",
    ...
    "Input files" : "Bron bestanden",
    "The files to extract text from" : "De bestanden om tekst uit te halen",
    "Output texts" : "Uitvoer teksten",
    "The texts that were extracted from the files" : "De teksten die uit het bestand werden gehaald",
    ...
    "Formalized text" : "Geformaliseerde tekst",
    "The formalized text" : "De geformaliseerde tekst",
    "Generate a headline" : "Genereer een kop",
    "Generates a possible headline for a text." : "Genereer een mogelijk kop voor een tekst.",
    "Original text" : "Originele tekst",
    "The original text to generate a headline for" : "De originele tekst om een kop voor te genereren",
    "The generated headline" : "De gegenereerde kop",
    "Text" : "Tekst",
    "Corrections" : "Correcties",
    "The corrections that should be made in your text" : "De correcties die je zou moeten maken in je tekst",
    "Reformulate text" : "Herformuleer tekst",
    "Takes a text and reformulates it" : "Neem een tekst en herformuleer deze",
    "Write a text that you want the assistant to reformulate" : "Schrijf een tekst waarvan je wil dat de assistant deze herformuleert",
    "Reformulated text" : "Geherformuleerde tekst",
    "The reformulated text, written by the assistant" : "De geherformuleerde tekst, geschreven door de assistant",
    "Simplify text" : "Versimpel tekst",
    "Summary" : "Samenvatting",
    "Translate" : "Vertaal",
    "Origin language" : "Oorspronkelijke taal",
    "The language of the origin text" : "De taal van de oorspronkelijke tekst",
    "Target language" : "Doel taal",
    "The desired language to translate the origin text in" : "De gewenste taal om de oorspronkelijke tekst naar te vertalen",
    "Result" : "Resultaat",
