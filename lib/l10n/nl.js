OC.L10N.register(
    ...
    "Nextcloud %s or higher is required." : "Nextcloud %s of hoger vereist.",
    "Nextcloud %s or lower is required." : "Nextcloud %s of lager vereist.",
    "Help" : "Help",
    ...
    "App can't be installed because it is not compatible with this version of Nextcloud" : "De app kan niet worden geïnstalleerd omdat die niet compatible is met deze versie van Nextcloud",
    ...
    "Adjusting this setting in php.ini will make Nextcloud run again" : "Het in php.ini bijstellen hiervan laat Nextcloud weer werken",
