OC.L10N.register(
    ...
    "Nextcloud %s or higher is required." : "จำเป็นต้องมี Nextcloud รุ่น %s หรือรุ่นที่สูงกว่า",
    "Nextcloud %s or lower is required." : "ต้องการ Nextcloud %s หรือรุ่นที่ต่ำกว่า",
    "Help" : "ช่วยเหลือ",
    "Personal" : "ส่วนตัว",
    "Users" : "ผู้ใช้งาน",
    "Admin" : "ผู้ดูแล",
    "Recommended" : "แนะนำ",
    "App \"%s\" cannot be installed because it is not compatible with this version of Nextcloud." : "แอพฯ \"%s\" ไม่สามารถติดตั้งได้เพราะเข้ากันไม่ได้กับรุ่นของ Nextcloud นี้",
    ...
    "App can't be installed because it is not compatible with this version of Nextcloud" : "ไม่สามารถติดตั้งแอพพลิเคชันเพราะมันเข้ากันไม่ได้กับรุ่นของ Nextcloud นี้",
    ...
    "Adjusting this setting in php.ini will make Nextcloud run again" : "การปรับตั้งค่าใน php.ini นี้ Nextcloud จะทำงานอีกครั้ง",
