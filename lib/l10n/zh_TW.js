OC.L10N.register(
    ...
    "The database option \"%1$s\" for %2$s has to be a list of values" : "%2$s 的資料庫選項「%1$s」必須為一組值的清單",
    "The database option \"%1$s\" is not supported by %2$s" : "%2$s 不支援資料庫選項「%1$s」",
    "The database options \"dbsslcert\" and \"dbsslkey\" have to be provided together" : "資料庫選項「dbsslcert」與「dbsslkey」必須一起提供",
    ...
    "macOS is not supported and %s will not work properly on this platform." : "不支援 macOS，%s 在此平台上無法正常運作。",
    ...
    "Unknown share recipient" : "未知的分享接收者",
    ...
    "Cannot set user status for the owner of the share." : "無法設定分享擁有者的使用者狀態。",
    "The source does not exist." : "來源不存在。",
    "The recipient does not exist." : "收件者不存在。",
    "The value must be alphanumeric, 1 to 32 characters long and may contain dashes." : "該值必須為 1 到 32 個字元的英數字，並可包含連字號。",
    "You need to add at least one source to make the share available." : "您必須新增至少一個來源，才能讓分享可用。",
    "You need to add at least one recipient to make the share available." : "您必須新增至少一個收件者，才能讓分享可用。",
    "You need to allow at least one permission to make the share available." : "您必須至少允許一項權限，才能讓分享可用。",
    "You need to set a value for the %s" : "您必須為 %s 設定一個值",
    ...
    "Your data directory is not readable." : "無法讀取您的資料目錄。",
    ...
    "Translates the speech of an audio file or recording and outputs an audio file in the desired language." : "將音訊檔案或錄音中的語音進行翻譯，並輸出目標語言的音訊檔案。",
    "Input audio" : "輸入音訊",
    "The audio file or recording to translate" : "待翻譯的音訊檔或錄音",
    ...
    "Subtitle the things said in an audio or video" : "為音訊或影片中的對話加上字幕",
    "Input file" : "輸入檔案",
    "The file to subtitle" : "要上字幕的檔案",
    "Subtitles" : "字幕",
    "The subtitles file" : "字幕檔",
    ...
    "Chat with tools using attachments" : "使用附件與工具進行聊天",
    "Chat with the language model with tool calling support and attachments." : "透過支援工具呼叫與附件功能的語言模型進行聊天。",
    "Describe a task that you want the assistant to do or ask a question" : "描述您希望助理執行的任務或提出問題",
    "Input attachments" : "輸入附件",
    "Files to send along with the chat message." : "隨同聊天訊息一併傳送的檔案。",
    "Tool message" : "工具訊息",
    ...
    "The response from the chat model" : "來自聊天模型的回應",
    "Output attachments" : "輸出附件",
    "Files generated by the model." : "由模型產生的檔案。",
    "Tool calls" : "工具呼叫",
    "Tools call instructions from the model in JSON format" : "來自模型的工具呼叫，以 JSON 格式表示",
    "Chat with an agent using attachments" : "透過附件與代理聊天",
    "Memories" : "回憶",
    "Memories to send to the agent." : "要傳送給代理的記憶。",
    "Files generated by the agent." : "由代理產生的檔案。",
    "Sources" : "來源",
    "Sources of the generated response." : "產生回應的來源。",
    "Generate image" : "產生影像",
    ...
    "Improve text" : "改善文字",
    "Takes a text and improves it based on instructions" : "根據指示，對一段文字進行改寫以使其更臻完善",
    "Write a text that you want the assistant to improve" : "請撰寫一段文字，並請小幫手對其進行修改",
    "Instructions" : "說明",
    "Describe how the assistant should improve the text" : "請說明小幫手應如何改進這段文字",
    "Improved text" : "改進文字",
    "The improved text" : "改進後的文字",
    "Proofread" : "校對",
    ...
    "Reformat paragraphs" : "重新排版段落",
    "Reformats a text into multiple paragraphs separated by topic" : "將文字重新排版為多個段落，並按主題分隔",
    "The text to reformat" : "要重新排版的文字",
    "Reformatted text" : "已重新排版的文字",
    "The reformatted text with paragraphs separated by topic" : "經重新排版、按主題分段的文本",
    ...
    "You are not allowed to edit this share." : "您不被允許編輯此分享。",
    "Only true and false are valid values: %s" : "僅 true 與 false 為有效值：%s",
    "Invalid ISO8601 date: %s" : "無效的 ISO8601 日期：%s",
    "Date needs to be after %s" : "日期必須晚於 %s",
    "Date needs to be before %s" : "日期必須早於 %s",
    "Only %1$s are valid values: %2$s" : "僅 %1$s 為有效值：%2$s",
    "Need at least %1$s characters: %2$s" : "需要至少 %1$s 個字元：%2$s",
    "Provide %1$s characters at most: %2$s" : "提供最多 %1$s 個字元：%2$s",
    "Help & privacy" : "說明與隱私",
