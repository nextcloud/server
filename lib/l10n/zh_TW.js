OC.L10N.register(
    ...
    "Nextcloud %s or higher is required." : "需要Nextcloud %s 或更高版本",
    "Nextcloud %s or lower is required." : "需要Nextcloud %s 或更低版本",
    "Help" : "說明",
    "Personal" : "個人",
    "Users" : "使用者",
    "Admin" : "管理",
    "Recommended" : "建議",
    "App \"%s\" cannot be installed because it is not compatible with this version of Nextcloud." : "無法安裝應用程式 %s 因為它和此版本的 Nextcloud 不相容。",
    ...
    "App can't be installed because it is not compatible with this version of Nextcloud" : "無法安裝應用程式因為它和此版本的 Nextcloud 不相容。",
    ...
    "Adjusting this setting in php.ini will make Nextcloud run again" : "調整php.ini裡的這項設定會讓Nextcloud再次運行",
