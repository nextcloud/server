OC.L10N.register(
    ...
    "Unknown share recipient" : "分享收件人不詳",
    ...
    "Cannot set user status for the owner of the share." : "無法為分享擁有者設置用戶狀態。",
    "The source does not exist." : "來源不存在。",
    "The recipient does not exist." : "收件人不存在。",
    "The value must be alphanumeric, 1 to 32 characters long and may contain dashes." : "該值必須為 1 至 32 個字元的英數字，並可包含連字號。",
    "You need to add at least one source to make the share available." : "你必須至少新增一個來源，才能使分享可用。",
    "You need to add at least one recipient to make the share available." : "你必須至少新增一位收件人，才能使分享可用。",
    "You need to allow at least one permission to make the share available." : "你必須至少允許一項權限，才能使分享可用。",
    "You need to set a value for the %s" : "你必須為 %s 設定一個值。",
    ...
    "ID \"%1$s\" already used by cloud federation provider \"%2$s\"" : "ID「%1$s」已經被另一個雲端聯邦提供者「%2$s」所使用",
    ...
    "The desired language to translate the origin audio in" : "用於翻譯原始音訊的目標語言",
    "Audio output" : "音頻輸出",
    ...
    "Subtitle the things said in an audio or video" : "為音訊或影片中的語音產生字幕",
    "Input file" : "輸入檔案",
    "The file to subtitle" : "要產生字幕的檔案",
    "Subtitles" : "字幕",
    "The subtitles file" : "字幕檔案",
    ...
    "Chat with tools using attachments" : "透過附件與工具聊天",
    "Chat with the language model with tool calling support and attachments." : "與支持工具調用和附件功能的語言模型聊天。",
    ...
    "Improve text" : "改善文字",
    "Takes a text and improves it based on instructions" : "根據指示改善文字內容",
    "Write a text that you want the assistant to improve" : "輸入你希望助理改善的文字",
    "Instructions" : "烹飪方法",
    "Describe how the assistant should improve the text" : "描述助理應如何改善文字",
    "Improved text" : "已改善的文字",
    "The improved text" : "改善後的文字",
    "Proofread" : "校對",
    ...
    "You are not allowed to edit this share." : "你沒有權限編輯此分享。",
    "Only true and false are valid values: %s" : "只有 true 與 false 為有效值：%s",
