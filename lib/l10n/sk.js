OC.L10N.register(
    ...
    "Bluesky" : "Bluesky",
    "View %s on Bluesky" : "Zobraziť %s na Bluesky",
    "Email" : "E-mail",
    "Mail %s" : "Pošta pre %s",
    "Fediverse" : "Fediverse",
    ...
    "The database option \"%1$s\" for %2$s has to be a list of values" : "Možnosť databázy „%1$s“ pre %2$s musí byť zoznam hodnôt",
    "The database option \"%1$s\" is not supported by %2$s" : "Možnosť databázy „%1$s“ nie je podporovaná databázou %2$s",
    "The database options \"dbsslcert\" and \"dbsslkey\" have to be provided together" : "Možnosti databázy „dbsslcert“ a „dbsslkey“ musia byť zadané spolu",
    ...
    "macOS is not supported and %s will not work properly on this platform." : "macOS nie je podporovaný a %s nebude správne fungovať na tejto platforme.",
    ...
    "You cannot share a folder that contains other shares" : "Nemôžete zdieľať priečinok, ktorý obsahuje iné zdieľania",
    ...
    "Unknown share recipient" : "Neznámy príjemca zdieľania",
    "Group \"%s\" does not exist" : "Skupina \"%s\" neexistuje",
    "The requested share does not exist anymore" : "Požadované zdieľanie už neexistuje",
    "The share already contains the source." : "Zdieľanie už obsahuje zdroj.",
    "The share already contains the recipient." : "Zdieľanie už obsahuje príjemcu.",
    "Cannot set user status for the owner of the share." : "Nie je možné nastaviť stav používateľa pre vlastníka zdieľania.",
    "The source does not exist." : "Zdroj neexistuje.",
    "The recipient does not exist." : "Príjemca neexistuje.",
    "The value must be alphanumeric, 1 to 32 characters long and may contain dashes." : "Hodnota musí byť alfanumerická, 1 až 32 znakov dlhá a môže obsahovať pomlčky.",
    "You need to add at least one source to make the share available." : "Ak chcete sprístupniť zdieľanie, musíte pridať aspoň jeden zdroj.",
    "You need to add at least one recipient to make the share available." : "Ak chcete sprístupniť zdieľanie, musíte pridať aspoň jedného príjemcu.",
    "You need to allow at least one permission to make the share available." : "Ak chcete sprístupniť zdieľanie, musíte povoliť aspoň jedno oprávnenie.",
    "You need to set a value for the %s" : "Musíte nastaviť hodnotu pre %s",
    ...
    "Your data directory is not readable." : "Váš adresár údajov nie je čitateľný.",
    ...
    "Storage unauthorized. %s" : "Úložisko neoprávnené. %s",
    ...
    "Question" : "Otázka",
    "What to ask about the images." : "Čo sa pýtať o obrázkoch.",
    ...
    "Describe a task that you want the assistant to do or ask a question." : "Popíšte úlohu, ktorú chcete, aby asistent vykonal, alebo sa spýtajte otázku.",
    "Chat history" : "História chatu",
    "The history of chat messages before the current message, starting with a message by the user." : "História chatových správ pred touto správou, začínajúc správou používateľa.",
    ...
    "Translate audio" : "Preložiť zvukovú nahrávku",
    "Translates the speech of an audio file or recording and outputs an audio file in the desired language." : "Preloží reč zvukového súboru alebo nahrávky a vytvorí zvukový súbor v požadovanom jazyku.",
    "Input audio" : "Vstupný zvuk",
    "The audio file or recording to translate" : "Zvukový súbor alebo záznam na preklad",
    "Origin language" : "Pôvodný jazyk",
    "The language of the origin audio" : "Jazyk pôvodného zvuku",
    "Target language" : "Cieľový jazyk",
    "The desired language to translate the origin audio in" : "Požadovaný jazyk, do ktorého sa má pôvodný zvuk preložiť",
    "Audio output" : "Zvukový výstup",
    "The audio translation" : "Preklad zvuku",
    ...
    "Generate subtitles" : "Generovať titulky",
    "Subtitle the things said in an audio or video" : "Vytvorí titulky k hovorenému obsahu v zvukovom alebo obrazovom súbore.",
    "Input file" : "Vstupný súbor",
    "The file to subtitle" : "Súbor, ku ktorému sa majú vytvoriť titulky",
    "Subtitles" : "Titulky",
    "The subtitles file" : "Súbor titulkov",
    "Chat by voice with an agent" : "Chatovať hlasom s agentom",
    "Describe a task that you want the agent to do or ask a question." : "Popíšte úlohu, ktorú chcete, aby agent vykonal, alebo sa opýtajte otázku.",
    ...
    "Extract text from files like images or PDFs" : "Extrahujte text z dokumentov, ako sú obrázky alebo PDF súbory",
    "Input files" : "Vstupné súbory",
    "The files to extract text from" : "Súbory na extrahovanie textu z",
    "Output texts" : "Výstupné texty",
    "The texts that were extracted from the files" : "Texty, ktoré boli extrahované z dokumentov",
    "Chat with tools using attachments" : "Chat s nástrojmi pomocou príloh",
    "Chat with the language model with tool calling support and attachments." : "Chat s jazykovým modelom s podporou volania nástrojov a práce s prílohami.",
    ...
    "Input attachments" : "Vstupné prílohy",
    "Files to send along with the chat message." : "Súbory, ktoré sa majú odoslať spolu s chatovou správou.",
    ...
    "The response from the chat model" : "Odpoveď z modelu četu",
    "Output attachments" : "Výstupné prílohy",
    "Files generated by the model." : "Súbory generované modelom.",
    ...
    "Chat with an agent using attachments" : "Chat s agentom pomocou príloh",
    "Memories" : "Spomienky",
    "Memories to send to the agent." : "Spomienky na odoslanie agentovi",
    "Files generated by the agent." : "Súbory generované agentom.",
    "Sources" : "Zdroje",
    "Sources of the generated response." : "Zdroje vygenerovanej odpovede.",
    ...
    "Improve text" : "Zlepšiť text",
    "Takes a text and improves it based on instructions" : "Prevezme text a vylepší ho podľa pokynov",
    "Write a text that you want the assistant to improve" : "Napíšte text, ktorý má asistent vylepšiť",
    "Instructions" : "Postup",
    "Describe how the assistant should improve the text" : "Popíšte, ako má asistent vylepšiť text",
    "Improved text" : "Vylepšený text",
    "The improved text" : "Vylepšený text",
    "Proofread" : "Korektúra",
    ...
    "Reformat paragraphs" : "Preformátovať odseky",
    "Reformats a text into multiple paragraphs separated by topic" : "Preformátuje text do viacerých odsekov oddelených podľa témy",
    "The text to reformat" : "Text na preformátovanie",
    "Reformatted text" : "Preformátovaný text",
    "The reformatted text with paragraphs separated by topic" : "Preformátovaný text s odsekmi oddelenými podľa témy",
    ...
    "You are not allowed to edit this share." : "Nemáte povolenie upravovať toto zdieľanie.",
    "Only true and false are valid values: %s" : "Platné hodnoty sú iba true a false: %s",
    "Invalid ISO8601 date: %s" : "Neplatný dátum ISO8601: %s",
    "Date needs to be after %s" : "Dátum musí byť po %s",
    "Date needs to be before %s" : "Dátum musí byť pred %s",
    "Only %1$s are valid values: %2$s" : "Platné sú iba hodnoty %1$s: %2$s",
    "Need at least %1$s characters: %2$s" : "Je potrebných aspoň %1$s znakov: %2$s",
    "Provide %1$s characters at most: %2$s" : "Zadajte najviac %1$s znakov: %2$s",
