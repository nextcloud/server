OC.L10N.register(
    ...
    "Nextcloud %s or higher is required." : "Nextcloud %s 以上が必要です。",
    "Nextcloud %s or lower is required." : "Nextcloud %s 以下が必要です。",
    "Help" : "ヘルプ",
    "Personal" : "個人",
    "Users" : "ユーザー",
    "Admin" : "管理",
    "Recommended" : "おすすめ",
    "App \"%s\" cannot be installed because it is not compatible with this version of Nextcloud." : " \"%s\" アプリは、このバージョンのNextcloudと互換性がない為、インストールできません。",
    ...
    "App can't be installed because it is not compatible with this version of Nextcloud" : "アプリは、このバージョンのNextcloudと互換性がないためインストールできません。",
    ...
    "Adjusting this setting in php.ini will make Nextcloud run again" : "php.ini 中の設定を調整するとNextcloudはもう一度動作するでしょう。 ",
