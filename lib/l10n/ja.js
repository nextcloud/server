OC.L10N.register(
    ...
    "The database option \"%1$s\" for %2$s has to be a list of values" : "%2$s に対するデータベースオプション\"%1$s\"は、値のリストでなければなりません",
    "The database option \"%1$s\" is not supported by %2$s" : "データベースオプション\"%1$s\"は、%2$s ではサポートされていません",
    "The database options \"dbsslcert\" and \"dbsslkey\" have to be provided together" : "データベースオプション\"dbsslcert\"と\"dbsslkey\"は、必ず一緒に指定する必要があります",
    ...
    "The share already contains the source." : "その共有にはすでにソースが含まれています。",
    "The share already contains the recipient." : "その共有にはすでに受信者が含まれています。",
    "Cannot set user status for the owner of the share." : "共有の所有者に対して、ユーザーのステータスを設定できません。",
    "The source does not exist." : "そのソースは存在しません。",
    "The recipient does not exist." : "受取人が存在していません",
    "The value must be alphanumeric, 1 to 32 characters long and may contain dashes." : "値はアルファベットおよびダッシュ記号を含む1〜32文字である必要があります。",
    "You need to add at least one source to make the share available." : "共有を有効にするには、少なくとも1つのソースを追加する必要があります。",
    "You need to add at least one recipient to make the share available." : "共有を利用可能にするには受取人を少なくとも一人設定する必要があります。",
    "You need to allow at least one permission to make the share available." : "共有を利用可能にするには少なくとも一つの権限を許可する必要があります。",
    "You need to set a value for the %s" : "値を %s に設定する必要があります。",
    ...
    "Your data directory is not readable." : "データディレクトリが読み取り不可です。",
    ...
    "Translate audio" : "音声を翻訳する",
    "Translates the speech of an audio file or recording and outputs an audio file in the desired language." : "音声ファイルや録音の音声を翻訳し、希望の言語の音声ファイルを出力します。",
    "Input audio" : "音声入力",
    "The audio file or recording to translate" : "翻訳対象の音声ファイルまたは録音データ",
    "Origin language" : "元の言語",
    "The language of the origin audio" : "元の音声の言語",
    "Target language" : "訳文の言語",
    "The desired language to translate the origin audio in" : "元の音声を翻訳する際に使用する言語",
    "Audio output" : "音声の出力",
    "The audio translation" : "音声の翻訳",
    ...
    "Generate subtitles" : "字幕を生成する",
    "Subtitle the things said in an audio or video" : "音声や動画の中で話されている内容に字幕をつける",
    "Input file" : "入力ファイル",
    "The file to subtitle" : "字幕を付けるファイル",
    "Subtitles" : "字幕",
    "The subtitles file" : "字幕ファイル",
    ...
    "Edit image" : "画像を編集する",
    "Edit an image based on a text description of the changes" : "変更内容のテキストによる説明に基づいて画像を編集する",
    "Input images" : "入力画像",
    "The images to edit" : "編集する画像",
    "Prompt" : "プロンプト",
    "Describe the changes you want to make to the image" : "画像にどのような変更を加えたいか説明してください",
    "Output image" : "出力画像",
    "The edited image" : "編集済みの画像",
    ...
    "Chat with tools using attachments" : "添付ファイルを使ってツールとチャットする",
    "Chat with the language model with tool calling support and attachments." : "ツール呼び出し機能や添付ファイルに対応した言語モデルとチャットできます。",
    "Describe a task that you want the assistant to do or ask a question" : "アシスタントに実行してほしいタスクまたは質問を記述します",
    "Input attachments" : "添付ファイルを追加する",
    "Files to send along with the chat message." : "チャットメッセージと一緒に送信するファイル。",
    ...
    "The response from the chat model" : "チャットモデルからの応答",
    "Output attachments" : "添付ファイルの出力",
    "Files generated by the model." : "モデルによって生成されたファイル。",
    "Tool calls" : "ツールコール",
    "Tools call instructions from the model in JSON format" : "JSON形式のモデルからのツール呼び出し命令",
    "Chat with an agent using attachments" : "添付ファイルを使って担当者とチャットする",
    "Memories" : "メモリー",
    "Memories to send to the agent." : "エージェントに送信するメモリー",
    "Files generated by the agent." : "エージェントによって生成されたファイル",
    "Sources" : "ソース",
    "Sources of the generated response." : "生成された応答の出典。",
    "Generate image" : "画像生成",
    ...
    "Improve text" : "テキストを修正する",
    "Takes a text and improves it based on instructions" : "テキストを受け取り、指示に基づいてそれを修正します",
    "Write a text that you want the assistant to improve" : "アシスタントに修正してもらいたい文章を書いてください",
    "Instructions" : "手順",
    "Describe how the assistant should improve the text" : "アシスタントがどのようにその文章を改善すべきか、説明してください",
    "Improved text" : "修正後のテキスト",
    "The improved text" : "修正後のテキスト",
    "Proofread" : "校正",
    ...
    "You are not allowed to edit this share." : "この共有コンテンツの編集は許可されていません。",
    "Only true and false are valid values: %s" : "有効な値は true と false のみです：%s",
    "Invalid ISO8601 date: %s" : "無効な ISO8601 日付: %s",
    "Date needs to be after %s" : "日付は%sより後である必要があります",
    "Date needs to be before %s" : "日付は%sより前である必要があります",
    "Only %1$s are valid values: %2$s" : "有効な値は %1$s のみです：%2$s",
    "Need at least %1$s characters: %2$s" : "少なくとも%1$s文字が必要です：%2$s",
    "Provide %1$s characters at most: %2$s" : "%1$s文字以内で入力してください：%2$s",
