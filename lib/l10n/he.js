OC.L10N.register(
    ...
    "Nextcloud %s or higher is required." : "נדרש Nextcloud %s ומעלה.",
    "Nextcloud %s or lower is required." : "נדרש Nextcloud %s ומטה.",
    "Help" : "עזרה",
    "Personal" : "אישי",
    "Users" : "משתמשים",
    "Admin" : "מנהל",
    "Recommended" : "מומלץ",
    "App \"%s\" cannot be installed because it is not compatible with this version of Nextcloud." : "היישום \"%s\" לא ניתן להתקנה כיוון שאינו תואם לגרסה זו של Nextcloud.",
