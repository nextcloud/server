OC.L10N.register(
    ...
    "Nextcloud %s or higher is required." : "Požadovaná verzia Nextcloudu %s alebo vyššia.",
    "Nextcloud %s or lower is required." : "Požadovaná verzia Nextcloudu %s alebo nižšia.",
    "Help" : "Pomoc",
    "Personal" : "Osobné",
    "Users" : "Používatelia",
    "Admin" : "Administrátor",
    "Recommended" : "Odporúčané",
    "App \"%s\" cannot be installed because it is not compatible with this version of Nextcloud." : "Aplikáciu \"%s\" nie je možné inštalovať, pretože nie je kompatibilná s touto verziou Nextcloudu.",
    ...
    "App can't be installed because it is not compatible with this version of Nextcloud" : "Aplikácia nemôže byť nainštalovaná pre nekompatibilitu z touto verziou Nextcloudu",
    ...
    "Adjusting this setting in php.ini will make Nextcloud run again" : "Zmenou tejto voľby v php.ini znovu uvediete váš Nextcloud do prevádzky",
