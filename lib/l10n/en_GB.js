OC.L10N.register(
    ...
    "App can't be installed because it is not compatible with this version of the server" : "App cannot be installed. It is not compatible with this version of the server",
    ...
    "Running Nextcloud Server on the Microsoft Windows platform is not supported. We suggest you use a Linux server in a virtual machine if you have no option for migrating the server itself." : "Running Nextcloud Server on the Microsoft Windows platform is not supported. If you have no option for migrating the server itself, we suggest you use a Linux server in a virtual machine.",
    "Cannot write into \"config\" directory" : "Cannot write into \"config\" directory",
