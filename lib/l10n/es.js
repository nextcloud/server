OC.L10N.register(
    ...
    "Nextcloud %s or higher is required." : "Se requiere Nextcloud %s o superior.",
    "Nextcloud %s or lower is required." : "Se requiere Nextcloud %s o una versión inferior.",
    "Help" : "Ayuda",
    "Personal" : "Personal",
    "Users" : "Usuarios",
    "Admin" : "Administración",
    "Recommended" : "Recomendado",
    "App \"%s\" cannot be installed because it is not compatible with this version of Nextcloud." : "La App \"%s\" no puede ser instalada porque no es compatible con esta versión de Nextcloud.",
    ...
    "Adjusting this setting in php.ini will make Nextcloud run again" : "Ajustando esta opción en php.ini permitirá que Nextcloud vuelva a funcionar",
