OC.L10N.register(
    ...
    "Module with ID: %s does not exist. Please enable it in your apps settings or contact your administrator." : "El módulo con ID %s no existe. Por favor, habilite el mismo en la configuración de apps o contacte a su administrador.",
    "No file conversion providers available" : "No hay proveedores de conversión de archivos disponibles",
    "File is too large to convert" : "El archivo es demasiado grande para ser convertido",
    ...
    "Dot files are not allowed" : "Los archivos cuyo nombre comienza por \".\" no están permitidos",
    ...
    "The original text to generate a headline for" : "El texto original para el cual generar un título",
    "The generated headline" : "El título generado",
    "Proofread" : "Corregir",
