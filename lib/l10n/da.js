OC.L10N.register(
    ...
    "Nextcloud %s or higher is required." : "Der kræves Nextcloud %s eller højere.",
    "Nextcloud %s or lower is required." : "Nextcloud %s eller lavere er påkrævet.",
    "Help" : "Hjælp",
    "Personal" : "Personligt",
    "Users" : "Brugere",
    "Admin" : "Admin",
    "Recommended" : "Anbefalet",
    "App \"%s\" cannot be installed because it is not compatible with this version of Nextcloud." : "App'en \"%s\" kan ikke installeres, da den er ikke er kompatibel med denne version af Nextcloud.",
    ...
    "App can't be installed because it is not compatible with this version of Nextcloud" : "Appen kan ikke installeres, da den ikke er kompatibel med denne version af Nextcloud.",
    ...
    "Adjusting this setting in php.ini will make Nextcloud run again" : "Justeres denne indstilling i php.ini, så vil Nextcloud kunne køre igen",
