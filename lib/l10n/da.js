OC.L10N.register(
    ...
    "Logged in account must be an admin, a sub admin or gotten special right to access this setting" : "En konto, der er logget ind, skal være en administrator, en underadministrator eller have en særlig rettighed for at få adgang til denne indstilling",
    "Your current IP address doesn’t allow you to perform admin actions" : "Din nuværende IP adresse tillader dig ikke at udføre admin handlinger",
    "Logged in account must be an admin or sub admin" : "Kontoen, der er logget ind, skal være en administrator eller underadministrator",
    "Logged in account must be an admin" : "Kontoen, der er logget ind, skal være en admin",
    ...
    "\"%1$s\" is not allowed inside a file or folder name." : "\" %1$s\" er ikke tilladt inde i en fil eller mappenavn.",
    "\"%1$s\" is a forbidden file type." : "\" %1$s\" er en forbudt filtype.",
    "Filenames must not end with \"%1$s\"." : "Filnavne må ikke ende med \"%1$s\".",
    "Invalid parent path" : "Ugyldig mål sti",
    ...
    "Storage %s cannot be moved" : "Opbevaring %s kan ikke flyttes",
    "Moving a share (%s) into a shared folder is not allowed" : "Flytning af en deling (%s) til en delt mappe er ikke tilladt",
    "Moving a storage (%s) into a shared folder is not allowed" : "Flytning af en lagerplads (%s) til en delt mappe er ikke tilladt",
    "Moving a share (%s) into another share (%s) is not allowed" : "Flytning af en deling (%s) til en anden deling (%s) er ikke tilladt",
    "Moving a share (%s) into another storage (%s) is not allowed" : "Flytning af en deling (%s) til en anden lagerplads (%s) er ikke tilladt",
    "Moving a storage (%s) into a share (%s) is not allowed" : "Flytning af en lagerplads (%s) til en deling (%s) er ikke tilladt",
    "Moving a storage (%s) into another storage (%s) is not allowed" : "Flytning af en lagerplads (%s) til en anden lagerplads (%s) er ikke tilladt",
    "Path contains invalid segments" : "Sti indeholder ugyldige segmenter",
    "Filename is a reserved word" : "Filnavn er et reserveret ord",
    "Filename contains at least one invalid character" : "Filnavnet indeholder mindst ét ugyldigt tegn",
    "Filename is too long" : "Filnavn er for længe",
    ...
    "MySQL Login and/or password not valid" : "MySQL Login og/eller password ikke ikke gyldigt",
    ...
    "Set an admin Login." : "Sæt en admin Login.",
    ...
    "Passwords are enforced for link and mail shares" : "Passwords håndhæves for link og mail delinger",
    "Share recipient is not a valid user" : "Delings modtager er ikke en gyldig bruger",
    "Share recipient is not a valid group" : "Delings modtager er ikke en gyldig gruppe",
    "Share recipient should be empty" : "Delings modtager skal være tom",
    "Share recipient should not be empty" : "Delings modtager bør ikke være tom",
    "Share recipient is not a valid circle" : "Delings modtager er ikke en gyldig cirkel",
    "Unknown share type" : "Ukendt deletype",
    "Share initiator must be set" : "Delings starteren skal indstilles",
    "Cannot share with yourself" : "Kan ikke dele med dig selv",
    "Shared path must be set" : "Fælles sti skal indstilles",
    "Shared path must be either a file or a folder" : "Delte sti skal enten være en fil eller en mappe",
    ...
    "Expiration date is enforced" : "Udløbsdato:",
    ...
    "Cannot share with the share owner" : "Kan ikke dele med delings ejeren",
    "Share does not have a full ID" : "Deling har ikke et fuldt ID",
    "Cannot change share type" : "Kan ikke ændre delingtype",
    ...
    "Share provider does not support accepting" : "Delings udbyder understøtter ikke accept",
    ...
    "The Login is already being used" : "Login er allerede ved at blive brugt",
    "Could not create account" : "Kunne ikke oprette konto",
    "Only the following characters are allowed in an Login: \"a-z\", \"A-Z\", \"0-9\", spaces and \"_.@-'\"" : "Kun følgende tegn er tilladt i en login: \"a-z\", \"A-Z\", \"0-9\", mellemrum og \"_. @ -\"",
    "A valid Login must be provided" : "En gyldig login skal bruges",
    ...
    "Login is invalid because files already exist for this user" : "Login er ugyldig, fordi filer allerede eksisterer for denne bruger",
    ...
    "Please change the permissions to 0770 so that the directory cannot be listed by other people." : "Ændr rettighederne til 0770, så mappen ikke kan opføres af andre personer.",
    ...
    "Ensure there is a file called \"%1$s\" in the root of the data directory. It should have the content: \"%2$s\"" : "Sørg for at der er en fil kaldet \" %1$s\" i roden af datafilen. Det bør have indholdet: \" %2$s\"",
    ...
    "Transcribe the things said in an audio" : "Transskriber de ting, der siges i en lyd",
    "Audio input" : "Lydindgang",
    "The audio to transcribe" : "Lyden til at transskribere",
    "Transcription" : "Transskription",
    "The transcribed text" : "Den oversatte tekst",
    ...
    "Whether to confirm previously requested actions: 0 for denial and 1 for confirmation." : "Om der skal bekræftes tidligere ønskede handlinger: 0 for benægtelse og 1 for bekræftelse.",
    "Conversation token" : "Samtaletoken",
    "A token representing the conversation." : "Et symbol, der repræsenterer samtalen.",
    "Generated response" : "Genereret respons",
    "The response from the chat model." : "Svaret fra chatmodellen.",
    "The new conversation token" : "Den nye samtale",
    ...
    "The content that would like to be rewritten in the new writing style" : "Det indhold, der gerne vil omskrives i den nye skrivestil",
    ...
    "The text to generate an emoji for" : "Teksten til at generere en emoji for",
    ...
    "Generate an image from a text prompt" : "Generér et billede fra en tekstprompt",
    "Prompt" : "Prompt",
    "Describe the image you want to generate" : "Beskriv det billede du vil generere",
    "Number of images" : "Antal billeder",
    "How many images to generate" : "Hvor mange billeder at generere",
    ...
    "Describe a task that you want the assistant to do or ask a question" : "Beskriv en opgave, som du ønsker assistenten til at gøre eller stille et spørgsmål",
    ...
    "The history of chat messages before the current message, starting with a message by the user" : "Historien om chatbeskeder før den aktuelle meddelelse, startende med en besked fra brugeren",
    ...
    "Chat with tools" : "Chat med værktøj",
    "Chat with the language model with tool calling support." : "Chat med sprogmodellen med værktøj calling support.",
    "Tool message" : "Værktøjsmeddelelse",
    "The result of tool calls in the last interaction" : "Resultatet af værktøjskald i den sidste interaktion",
    "Available tools" : "Tilgængelige værktøjer",
    "The available tools in JSON format" : "De tilgængelige værktøjer i JSON format",
    "The response from the chat model" : "Svaret fra chatmodellen",
    "Tool calls" : "Værktøjskald",
    "Tools call instructions from the model in JSON format" : "Værktøjskald instruktioner fra modellen i JSON format",
    "Formalize text" : "Formaliser tekst",
    "Takes a text and makes it sound more formal" : "Kræver en tekst og får det til at lyde mere formelt",
    "Write a text that you want the assistant to formalize" : "Skriv en tekst som du vil have assistenten skal formalisere",
    "Formalized text" : "Formaliseret tekst",
    "The formalized text" : "Den formaliserede tekst",
    "Generate a headline" : "Generér en overskrift",
    ...
    "Takes a text and simplifies it" : "Tager en tekst og forenkler den",
    ...
    "The original text to summarize" : "Den oprindelige tekst at sammenfatte",
    "Summary" : "Oversigt",
    "The generated summary" : "Det genererede resumé",
    ...
    "Origin text" : "Oprindelse",
    "The text to translate" : "Teksten til oversættelse",
    ...
    "The desired language to translate the origin text in" : "Det ønskede sprog til at oversætte oprindelsen tekst i",
    "Result" : "Resultat",
