OC.L10N.register(
    ...
    "Bluesky" : "Bluesky",
    "View %s on Bluesky" : "Skoða %s á Bluesky",
    "Email" : "Tölvupóstur",
    "Mail %s" : "Póstur %s",
    ...
    "Username is too long" : "Notandanafn er of langt",
    ...
    "Your data directory is not readable." : "Gagnamappn þín er ekki lesanleg.",
    ...
    "Generate subtitles" : "Útbúa skjátexta",
    "Input file" : "Inntaksskrá",
    "The file to subtitle" : "Skráin sem á að gera skjátexta við",
    "Subtitles" : "Skjátextar",
    "The subtitles file" : "Skjátextaskráin",
    "Confirmation" : "Staðfesting",
    "Chat message" : "Spjallskilaboð",
    "Generated emoji" : "Framleitt tákn",
    "Optical character recognition" : "Ljóslestur (OCR)",
    "Input files" : "Inntaksskrár",
    "Output texts" : "Úttakstextar",
    "Available tools" : "Tiltæk verkfæri",
    "Memories" : "Minningar",
    "Sources" : "Uppruni",
    ...
    "Invalid ISO8601 date: %s" : "Ógild ISO8601 dagsetning: %s",
    "Date needs to be after %s" : "Dagsetning þarf að vera eftir %s",
    "Date needs to be before %s" : "Dagsetning þarf að vera fyrir %s",
    "Only %1$s are valid values: %2$s" : "Aðeins %1$s eru leyfileg gildi: %2$s",
    "Need at least %1$s characters: %2$s" : "Þarf að minnsta kosti %1$s stafi: %2$s",
    "Provide %1$s characters at most: %2$s" : "Gefðu upp í mesta lagi %1$s stafi: %2$s",
    ...
    "You cannot share your root folder" : "Þú getur ekki deilt rótarmöppunni þinni",
    "You are not allowed to share %s" : "Þú hefur ekki heimild til að deila %s",
    "File shares cannot have create or delete permissions" : "Skráasameignir geta ekki haft útbúa- eða eyða-heimildir",
    "Cannot increase permissions of %s" : "Get ekki aukið aðgangsheimildir %s",
    "Shares need at least read permissions" : "Sameignir krefjast að minnsta kosti lesheimilda",
    ...
    "Group sharing is now allowed" : "Hópdeiling er ekki leyfð",
    "Sharing is only allowed within your own groups" : "Deiling er aðeins leyfð innan þinna eigin hópa",
    "Link sharing is not allowed" : "Deiling tengla er ekki leyfð",
    "Public upload is not allowed" : "Opinberar innsendingar eru ekki leyfðar",
    "Sharing is disabled" : "Deiling er óvirk",
    "Sharing is disabled for you" : "Deiling er óvirk fyrir þig",
