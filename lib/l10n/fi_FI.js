OC.L10N.register(
    ...
    "Nextcloud %s or higher is required." : "Nextcloud %s tai uudempi vaaditaan.",
    "Nextcloud %s or lower is required." : "Nextcloud %s tai aiempi vaaditaan.",
    "Help" : "Ohje",
    "Personal" : "Henkilökohtainen",
    "Users" : "Käyttäjät",
    "Admin" : "Ylläpito",
    "Recommended" : "Suositeltu",
    "App \"%s\" cannot be installed because it is not compatible with this version of Nextcloud." : "Sovelluksen \"%s\" asennus ei onnistu, koska se ei ole yhteensopiva tämän Nextcloud-version kanssa.",
    ...
    "App can't be installed because it is not compatible with this version of Nextcloud" : "Sovellusta ei voi asentaa, koska se ei ole yhteensopiva käytössä olevan Nextcloud-version kanssa",
    ...
    "Adjusting this setting in php.ini will make Nextcloud run again" : "Tämän asetuksen muuttaminen php.ini-tiedostossa saattaa Nextcloudin jälleen toimintakykyiseksi",
