OC.L10N.register(
    ...
    "Nextcloud %s or higher is required." : "Nextcloud %s veya daha üstü gerekli.",
    "Nextcloud %s or lower is required." : "Nextcloud %s veya daha düşük sürüm gerekli.",
    "Help" : "Yardım",
    "Personal" : "Kişisel",
    "Users" : "Kullanıcılar",
    "Admin" : "Yönetici",
    "Recommended" : "Önerilen",
    "App \"%s\" cannot be installed because it is not compatible with this version of Nextcloud." : "Nextcloud yazılımının bu sürümü ile uyumlu olmadığı için \"%s\" uygulaması kurulamaz.",
    ...
    "App can't be installed because it is not compatible with this version of Nextcloud" : "Nextcloud sürümünüz ile uyumsuz olduğu için uygulama kurulamıyor",
    ...
    "Adjusting this setting in php.ini will make Nextcloud run again" : "Bu ayarı php.ini içerisinde ayarlamak Nextcloud'ı tekrar çalıştıracak.",
