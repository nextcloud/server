OC.L10N.register(
    ...
    "%sbit or higher PHP required." : "%sbit veya daha üzeri PHP sürümü gereklidir.",
    ...
    "Server version %s or higher is required." : "Sunucu sürümü %s veya daha üzeri olmalıdır.",
    "Server version %s or lower is required." : "Sunucu sürümü %s veya daha altı olmalıdır.",
    ...
    "App \"%s\" cannot be installed because appinfo file cannot be read." : "\"%s\" uygulaması yüklenemiyor çünkü appinfo dosyası okunamıyor.",
    "App \"%s\" cannot be installed because it is not compatible with this version of the server." : "Sunucu sürümüyle uyumlu olmadığından \"%s\" uygulaması yüklenemez.",
    ...
    "a safe home for all your data" : "tüm verileriniz için güvenli bir yer",
    ...
    "Adjusting this setting in php.ini will make Nextcloud run again" : "Bu ayarı php.ini dosyasında yapmak Nextcloud'u yeniden çalıştıracaktır",
