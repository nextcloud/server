OC.L10N.register(
    ...
    "Nextcloud %s or higher is required." : "оунКлауд %s или новији је потребан.",
    "Nextcloud %s or lower is required." : "оунКлауд %s или старији је потребан.",
    "Help" : "Помоћ",
    "Personal" : "Лично",
    "Users" : "Корисници",
    "Admin" : "Администрација",
    "Recommended" : "Препоручено",
    "App \"%s\" cannot be installed because it is not compatible with this version of Nextcloud." : "Апликација „%s“ не може бити инсталирана јер није компатибилна са овим издањем oунKлауда.",
    ...
    "App can't be installed because it is not compatible with this version of Nextcloud" : "Апликације не може бити инсталирана јер није компатибилна са овом верзијом оунКлауда",
    ...
    "Adjusting this setting in php.ini will make Nextcloud run again" : "Подешавање ове поставке у php.ini фајлу ће омогућити да оунКлауд поново ради",
