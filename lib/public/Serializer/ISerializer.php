 ...
 * controlled with {@see \OCP\Serializer\Attribute\SerializationIgnore},
 * {@see \OCP\Serializer\Attribute\SerializationGroups}, {@see \OCP\Serializer\Attribute\SerializedName}
...
interface ISerializer {
	 ...
	 *
	 * @param object|list<object> $data the data to serialize, e.g. an object, or an array of objects
	 * @param Format $format the output format
	 * @param array<string, array{groups?: non-empty-list<non-empty-string>, ...<string, mixed>}> $context context options, e.g. `['groups' => ['group1']]`
	 ...
	 * @param array<string, array{groups?: non-empty-list<non-empty-string>}> $context context options, e.g. `['groups' => ['group1']]`
