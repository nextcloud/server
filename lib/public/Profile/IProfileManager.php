...
interface IProfileManager {
	...
	public const DEFAULT_PROPERTY_VISIBILITY = [
		...
		IAccountManager::PROPERTY_AVATAR => self::VISIBILITY_SHOW_USERS_ONLY,
		IAccountManager::PROPERTY_BIOGRAPHY => self::VISIBILITY_SHOW_USERS_ONLY,
		IAccountManager::PROPERTY_DISPLAYNAME => self::VISIBILITY_SHOW_USERS_ONLY,
		IAccountManager::PROPERTY_HEADLINE => self::VISIBILITY_SHOW_USERS_ONLY,
		IAccountManager::PROPERTY_ORGANISATION => self::VISIBILITY_SHOW_USERS_ONLY,
		IAccountManager::PROPERTY_ROLE => self::VISIBILITY_SHOW_USERS_ONLY,
		...
		IAccountManager::PROPERTY_TWITTER => self::VISIBILITY_SHOW_USERS_ONLY,
		IAccountManager::PROPERTY_WEBSITE => self::VISIBILITY_SHOW_USERS_ONLY,
	];
