...
final class ShareReviewQuery {
	 ...
	 * @param int|null $modifiedBeforeTimestamp Unix timestamp; exclusive upper
	 *                                          bound on lastModifiedTimestamp.
	 *                                          Together with the lower bound
	 *                                          this forms the half-open range
	 *                                          `since < lastModified < before`,
	 *                                          e.g. one bucket of a trend.
	 ...
	 *                                           $objectSearch). Objects have no
	 *                                           stable cross-source id, so this
	 *                                           pattern list stands in for the
	 *                                           exact id lists of the identity
	 *                                           fields; alongside $objectSearch
	 *                                           it lets one user term be
	 *                                           combined with a fixed set of
	 *                                           name patterns. An empty list
	 *                                           matches nothing.
