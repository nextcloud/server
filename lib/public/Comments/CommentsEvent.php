...
class CommentsEvent extends Event {
	/**
	 * @since 11.0.0
	 * @deprecated 22.0.0 Use \OCP\Comments\Events\CommentAddedEvent instead.
	 */
	public const EVENT_ADD = 'OCP\Comments\ICommentsManager::addComment';

	/**
	 * @since 11.0.0
	 * @deprecated 22.0.0 Use \OCP\Comments\Events\BeforeCommentUpdatedEvent instead.
	 */
	public const EVENT_PRE_UPDATE = 'OCP\Comments\ICommentsManager::preUpdateComment';

	/**
	 * @since 11.0.0
	 * @deprecated 22.0.0 Use \OCP\Comments\Events\CommentUpdatedEvent instead.
	 */
	public const EVENT_UPDATE = 'OCP\Comments\ICommentsManager::updateComment';

	/**
	 * @since 11.0.0
	 * @deprecated 22.0.0 Use \OCP\Comments\Events\CommentDeletedEvent instead.
	 */
