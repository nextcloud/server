...
/**
 * An upper bound: whichever provider allows least wins.
 *
 * Declares one whole-number parameter, named by {@see getValueParameterName()}.
 *
 * @experimental 35.0.0
 */
#[Implementable(since: '35.0.0')]
abstract class ACeilingCapabilityType extends ACapabilityType {
	/**
	 * The name of the parameter representing the ceiling value.
	 *
	 * @experimental 35.0.0
	 */
