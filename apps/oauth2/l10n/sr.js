OC.L10N.register(
    ...
    "Name" : "Име",
    "_headerName_::_col_" : ["headerName","col","col"],
    "Redirection URI" : "Адреса за преусмеравање",
    "_headerRedirectUri_::_col_" : ["headerRedirectUri","col","col"],
    "Client Identifier" : "Идентификација клијента",
    "_headerClientIdentifier_::_col_" : ["headerClientIdentifier","col","col"],
    "Secret" : "Тајна",
    "_headerSecret_::_col_" : ["headerSecret","col","col"],
    "Add client" : "Додај клијента",
    "Add" : "Додај",
    "_button_::_submit_" : ["button","submit","submit"],
    "_section_::_oauth2_" : ["section","oauth2","oauth2"],
    "Show client secret" : "Прикажи клијентске лозинке",
    "Delete" : "Избриши",
    "OAuth 2.0" : "OAuth 2.0",
