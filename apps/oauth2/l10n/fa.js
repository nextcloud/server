OC.L10N.register(
    ...
    "OAuth 2.0 allows external services to request access to {instanceName}." : "OAuth 2.0 به سرویس‌های خارجی اجازه می‌دهد درخواست دسترسی به {instanceName} را ثبت کنند.instanceName.",
    "Name" : "نام",
    "Redirection URI" : "تغییر مسیر URI",
    "Client identifier" : "شناسه کلاینت",
    "Delete client" : "حذف کلاینت",
    "Make sure you store the secret key, it cannot be recovered." : "مطمئن شوید کلید مخفی را ذخیره می‌کنید؛ این کلید قابل بازیابی نیست.",
    "Add client" : "افزودن مشتری",
    "Add" : "افزودن",
    "Client Identifier" : "شناسه مشتری",
    "Show client secret" : "راز مشتری را نشان دهید",
    "Hide client secret" : "پنهان‌کردن secret کلاینت"
},
