			...
			if (str_contains($versionlc, 'mariadb')) {
				if (version_compare($versionConcern, '10.6', '=')) {
					return SetupResult::info(
						$this->l10n->t(
							'MariaDB version 10.6 detected, this version is end-of-life and only supported as part of an enterprise subscription. MariaDB >=%1$s and <=%2$s is suggested for best performance, stability and functionality with this version of Nextcloud.',
							[
								self::MIN_MARIADB,
								self::MAX_MARIADB,
							]
