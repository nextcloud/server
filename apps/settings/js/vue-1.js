 ...
 */
/* harmony default export */ __webpack_exports__["default"] = (['contacts', 'calendar', 'mail']);
...
/* harmony import */ var _AppList_AppItem__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./AppList/AppItem */ "./apps/settings/src/components/AppList/AppItem.vue");
...
/* harmony import */ var _recommendedApps__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../recommendedApps */ "./apps/settings/src/recommendedApps.js");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  name: 'AppList',
  components: {
    AppItem: _AppList_AppItem__WEBPACK_IMPORTED_MODULE_1__["default"]
  },
  ...
  computed: {
    ...
    apps: function apps() {
      ...
      switch (this.category) {
        ...
        case 'recommended':
          return apps.filter(function (app) {
            return _recommendedApps__WEBPACK_IMPORTED_MODULE_3__["default"].includes(app.id);
          });
  ...
  mounted: function mounted() {
    ...
    if (this.category === 'recommended' && 'download' in this.$route.query) {
      var limit = p_limit__WEBPACK_IMPORTED_MODULE_0___default()(1);
      var installing = this.apps.filter(function (app) {
        return !app.active && app.canInstall;
      }).map(function (app) {
        return limit(function () {
          return _this4.$store.dispatch('enableApp', {
            appId: app.id,
            groups: []
          });
        });
      });
      console.debug("installing ".concat(installing.length, " recommended apps"));
      Promise.all(installing).then(function () {
        console.info('recommended apps installed');

        if ('returnTo' in _this4.$route.query) {
          window.location = _this4.$route.query.returnTo;
        }
      }).catch(function (e) {
        return console.error('could not install recommended apps', e);
      });
    }
  },
  methods: {
    ...
    updateAll: function updateAll() {
      ...
      this.apps.filter(function (app) {
        ...
        return limit(function () {
          return _this5.$store.dispatch('updateApp', {
            appId: app.id
          });
        });
      });
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    showAppDetails: function showAppDetails(event) {
      return regeneratorRuntime.async(function showAppDetails$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              _context.prev = 2;
              _context.next = 5;
              return regeneratorRuntime.awrap(this.$router.push({
                name: 'apps-details',
                params: {
...
//# sourceMappingURL=vue-1.js.map?v=9fa6976cf5169742e859