OC.L10N.register(
    ...
    "You deleted app password \"{token}\" and cancelled its pending remote wipe" : "Ви вилучили пароль на застосунок \"{token}\" та скасували заплановане віддалене стирання.",
    ...
    "Recently active" : "Нещодавно активні",
    "Disabled accounts" : "Вимкнені",
    ...
    "Configuration key \"%1$s\" contains invalid IP range(s): \"%2$s\"" : "Ключ конфігурації \"%1$s\" містить недійсний діапазон IP-адрес: \"%2$s\"",
    ...
    "Server identifier isn’t configured. It is recommended if your Nextcloud instance is running on several PHP servers. Add a server ID in your configuration." : "Ідентифікатор сервера не налаштовано. Рекомендується додати ідентифікатор сервера у конфігурації, якщо ваш примірник хмари Nextcloud розгорнуто на кількох серверах PHP.",
    "\"%d\" is not a valid server identifier. It must be between 0 and 511." : "\"%d\" не є дійсним ідентифікаторм сервера. Значення має бути між 0 та 511.",
    ...
    "Revoke and cancel pending wipe?" : "Відкликати та скасувати запланове стирання?",
    "Only continue if you no longer need the device to be wiped." : "Продовжуйте, якщо зникла потреба стирання даних із пристроя.",
    "Revoke and cancel wipe" : "Відкликати та скасувати стирання",
    "Revoke app password?" : "Відкликати пароль застосунку?",
    "The app or device will lose access on its next sync. This cannot be undone." : "Застосунок або пристрій втратять доступ під час наступної синхронізації. Це неможливо буде повернути.",
    "Remote wipe has not started yet." : "Віддалене стирання ще не запущено.",
    "Revoking now cancels the wipe. The device keeps its synced data." : "Відкликання призведе до скасування стирання. Пристрій зберігатиме синхронізовані дані.",
    "Device" : "Пристрій",
    ...
    "You are about to delete the group \"{group}\". The accounts will NOT be deleted." : "Ви збираєтеся видалити групу \"{group}\". Облікові записи НЕ буде вилучено.",
    "Confirm" : "Підтвердити",
    "Submit" : "Продовжити",
    ...
    "Show first login" : "Показувати перший вхід",
    ...
    "Sorting only applies to the currently loaded groups for performance reasons. Groups will be loaded as you navigate or search through the list." : "З міркувань продуктивності буде впорядковано лише поточно завантажені групи. Групи показуватимуться під час перегляду або пошуку в списку.",
    "By member count" : "За числом учасників",
    "By name" : "Зі ім'ям",
    ...
    "Search accounts and groups…" : "Шукати серед облікових записів та груп...",
    ...
    "Discover" : "Знайти",
    "Your apps" : "Встановлені застосунки",
    ...
    "Mounts" : "Кріплення",
    "Define host folder mounts to bind to the ExApp container" : "Визначте точки під'єднання каталогу хоста для з'єднання з контейнером ExApp",
    ...
    "Enter path to host folder" : "Зазначте шлях до каталогу хоста",
    "Enter path to container folder" : "Введіть шлях до каталогу контейнера",
    ...
    "Add mount" : "Додати точку під'єднання",
    ...
    "Rate the app" : "Оцініть цей застосунок",
    "Rate" : "Рейтинг",
    "Changelog" : "Зміни",
    ...
    "If you continue you will still be able to install the app. Note that the app might not work as expected." : "Якщо ви продовжите, ви все одно зможете встановити цей застосунок. Зверніть увагу, що застосунок може працювати не так, як очікувалося.",
    "The app has been enabled but needs to be updated." : "Застосунок увімкнено, але його потрібно оновити.",
