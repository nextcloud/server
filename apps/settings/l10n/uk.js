OC.L10N.register(
    ...
    "The app will be downloaded from the App Store" : "Додаток буде завантажено з App Store",
    ...
    "Version" : "Версія",
    "You need to enable the File sharing App." : "Потрібно ввімкнути додаток для обміну файлами.",
