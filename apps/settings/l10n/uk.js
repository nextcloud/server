OC.L10N.register(
    ...
    "Verifying" : "Перевірка",
    "Checking for old user imported certificate" : "Перевірка застарілих сертифікатів, які було імпортовано користувачами",
    ...
    "Checking for default phone region" : "Перевірка типового регіону телефонних номерів",
    ...
    "Checking for old server-side-encryption being disabled" : "Перевірку застарілого шифрування на стороні сервера вимкнено",
    ...
    "Checking for PHP default charset" : "Перевірка типового набору символів PHP",
    ...
    "This instance is missing some required PHP modules. It is required to install them: %s" : "У цьому примірнику відсутні такі обов'язкові модулі PHP, які потрібно встановити: %s",
    "This instance is missing some recommended PHP modules. For improved performance and better compatibility it is highly recommended to install them: %s" : "У цьому примірнику відсутні такі необов'язкові модулі PHP. Рекомендується встановити такі модулі для кращої продуктивності та сумісності: %s",
    "Checking for PHP version" : "Перевірка версії PHP",
    ...
    "Checking for PHP output_buffering option" : "Перевірка параметру PHP output_buffering option",
    "PHP configuration option output_buffering must be disabled" : "Параметр PHP output_buffering потрібно вимкнути",
    "Checking for configuration file access rights" : "Перевірка налаштувань дозволів доступу до файлів",
    ...
    "Checking for database version" : "Перевірка версії бази даних",
