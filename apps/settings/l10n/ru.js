OC.L10N.register(
    ...
    "PHP configuration option default_charset should be UTF-8" : "Параметр конфигурации PHP default_charset должен быть UTF-8.",
    ...
    "Unknown database plaform" : "Неизвестная платформа базы данных",
