OC.L10N.register(
    ...
    "Sanitize and merge duplicate system tags available" : "Очистите и объедините доступные дубликаты системных тегов",
    "One or more system tags need to be sanitized or merged. This can take a long time on larger instances so this is not done automatically during upgrades. Use the command `occ maintenance:repair --include-expensive` to perform the migrations." : "Необходимо очистить или объединить один или несколько системных тегов. В больших экземплярах это может занять много времени, поэтому при обновлении это не выполняется автоматически. Для выполнения миграции используйте команду `occ maintenance:repair --include-expensive`.",
    ...
    "MariaDB version 10.6 detected, this version is end-of-life and only supported as part of Ubuntu 22.04. MariaDB >=%1$s and <=%2$s is suggested for best performance, stability and functionality with this version of Nextcloud." : "Обнаружена версия MariaDB 10.6. Эта версия является устаревшей и поддерживается только как часть Ubuntu 22.04. Версия MariaDB >=%1$s и <=%2$s рекомендована для лучшей производительности, стабильности и функциональности с этой версией Nextcloud.",
    ...
    "_No scheduled tasks in the last %n day._::_No scheduled tasks in the last %n days._" : ["Нет запланированных задач за последний %n день.","Нет запланированных задач за последние %n дня.","Нет запланированных задач за последние %n дней.","Нет запланированных задач за последние %n дней."],
    "_Most tasks were successful in the last %n day._::_Most tasks were successful in the last %n days._" : ["Большинство задач были успешны в последний %n день.","Большинство задач были успешны в последние %n дня.","Большинство задач были успешны в последние %n дней.","Большинство задач были успешны в последние %n дней."],
    ...
    "Hide legacy provider settings" : "Скрыть устаревшие настройки провайдера",
    "Show legacy provider settings" : "Показать устаревшие настройки провайдера",
    "Machine translation (Legacy)" : "Машинный перевод (Устаревшее)",
    ...
    "This API is deprecated. Install apps that provide Unified task processing to get the best experience." : "Этот API устарел. Установите приложения, которые обеспечивают единую обработку задач, чтобы получить наилучший опыт.",
    "Learn more about AI providers" : "Узнать больше о поставщиках AI",
    "Image generation (Legacy)" : "Генерация изображений (Устаревшее)",
    ...
    "Text processing (Legacy)" : "Обработка текста (Устаревшее)",
