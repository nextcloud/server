OC.L10N.register(
    ...
    "Allow account name autocompletion to users within the same groups and limit system address books to users in the same groups" : "Разрешить автодополнения имени учётной записи пользователям из одних и тех же групп и ограничить доступ к системным адресным книгам пользователями из одних и тех же групп",
    "Allow account name autocompletion to users based on phone number integration" : "Разрешить пользователям автодополнение имени учётной записи на основе номера телефона",
    ...
    "_{userCount} account_::_{userCount} accounts_" : ["{userCount} учётная запись","{userCount} учётныt записи","{userCount} учётных записей","{userCount} учётные записи"],
    "Avatar" : "Аватар",
    ...
    "SMTP Login" : "Ипя пользователя SMTP",
