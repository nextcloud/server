OC.L10N.register(
    ...
    "Please make sure to set the \"overwrite.cli.url\" option in your config.php file to the URL that your users mainly use to access this Nextcloud. Suggestion: \"%s\". Otherwise there might be problems with the URL generation via cron. (It is possible though that the suggested URL is not the URL that your users mainly use to access this Nextcloud. Best is to double check this in any case.)" : "Bitte stelle sicher, dass du die Option \"overwrite.cli.url\" in deiner config.php-Datei auf die URL setzt, die deine Benutzenden hauptsächlich verwenden, um auf diese Nextcloud zuzugreifen. Vorschlag: \"%s\". Andernfalls kann es Probleme bei der URL-Generierung über Cron geben. (Es ist jedoch möglich, dass die vorgeschlagene URL nicht die URL ist, die deine Benutzer hauptsächlich verwenden, um auf diese Nextcloud zuzugreifen. Am besten überprüfst du dies in jedem Fall.)",
    "PHP APCu configuration" : "PHP APCu-Konfiguration",
    "Your APCu cache has been running full, consider increasing the apc.shm_size php setting." : "Dein APCu-Cache ist voll. Erwäge, die PHP-Einstellung apc.shm_size zu erhöhen.",
    "Your APCu cache is almost full at %s%%, consider increasing the apc.shm_size php setting." : " Dein APCu-Cache ist mit %s%% fast voll. Ziehe in Erwägung, die PHP-Einstellung apc.shm_size zu erhöhen.",
    ...
    "Allow users to set custom share link tokens" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "Shares with custom tokens will continue to be accessible after this setting has been disabled" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "Shares with guessable tokens may be accessed easily" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    ...
    "Advanced deploy options" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "Edit ExApp deploy options before installation" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "Configured ExApp deploy options. Can be set only during installation" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "Learn more" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "Environment variables" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "ExApp container environment variables" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "No environment variables defined" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "Mounts" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "Define host folder mounts to bind to the ExApp container" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "Must exist on the Deploy daemon host prior to installing the ExApp" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "Host path" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "Container path" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "Read-only" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "Remove mount" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "New mount" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "Enter path to host folder" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "Enter path to container folder" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "Toggle read-only mode" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "Confirm adding new mount" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "Confirm" : "Bestätigen",
    "Cancel adding mount" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "Cancel" : "Abbrechen",
    "Add mount" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "ExApp container mounts" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "No mounts defined" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    ...
    "Deploy options" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    ...
    "Cancel encryption" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "Enable encryption" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "Confirm enabling encryption" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    ...
    "Unable to update federation scope of the primary {property}" : "Der Föderations-Bereich des primären  {property} kann nicht aktualisiert werden.",
    "Unable to update federation scope of additional {property}" : "Der Föderations-Bereich des zusätzlichen {property} kann nicht aktualisiert werden.",
    ...
    "First login" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    ...
    "Show first login" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    ...
    "For performance reasons, when you enable encryption on a Nextcloud server only new and changed files are encrypted." : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
    "Location" : "Ort",
    ...
    "Not available as federation has been disabled for your account, contact your system administration if you have any questions" : "Nicht verfügbar, da Föderation für dein Konto deaktiviert ist. Wende dich an deinen Administrator, wenn du Fragen hast.",
    ...
    "Hide" : "Ausblenden",
    "Manually installed apps cannot be updated" : "Benötigt keine Übersetzung. Hier wird nur die formelle Übersetzung verwendet (de_DE).",
