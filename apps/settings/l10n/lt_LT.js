OC.L10N.register(
    ...
    "You added {user} to group {group}" : "Jūs pridėjote {user} į grupę {group}",
    "{actor} added {user} to group {group}" : "{actor} pridėjo {user} į grupę {group}",
    "An administrator added you to group {group}" : "Administratorius pridėjo jus į grupę {group}",
    "An administrator added {user} to group {group}" : "Administratorius pridėjo {user} į grupę {group}",
    "{actor} removed you from group {group}" : "{actor} pašalino jus iš grupės {group}",
    "You removed {user} from group {group}" : "Jūs pašalinote {user} iš grupės {group}",
    "{actor} removed {user} from group {group}" : "{actor} pašalino {user} iš grupės {group}",
    "An administrator removed you from group {group}" : "Administratorius pašalino jus iš grupės {group}",
    "An administrator removed {user} from group {group}" : "Administratorius pašalino {user} iš grupės {group}",
    ...
    "In order to verify your Website, store the following content in your web-root at '.well-known/CloudIdVerificationCode.txt' (please make sure that the complete text is in one line):" : "Norėdami patvirtinti savo interneto svetainę, išsaugokite turinį web-root aplanke: „.well-know/CloudIdVerificationCode.txt“ (Prašome įsitikinkite, kad visas tekstas yra vienoje eilutėje):",
    ...
    "Password for %1$s changed on %2$s" : "%1$s slaptažodis, buvo pakeistas %2$s",
    ...
    "Your email address on %s was changed." : "Buvo pakeistas Jūsų el. pašto adress %s.",
    "Your email address on %s was changed by an administrator." : "Administratorius pakeitė Jūsų el. pašto adresą %s.",
    "Email address for %1$s changed on %2$s" : "%1$s el. pašto adresas buvo pakeistas %2$s. ",
    ...
    "Language & locale" : "Kalba ir lokalė",
    "Profile & contact" : "Profilis ir kontaktas",
    ...
    "Verifying …" : "Tikrinama...",
    "Verify" : "Patikrinti",
    "Allowed admin IP ranges" : "Leidžiami administratorių IP adresų rėžiai",
    "Admin IP filtering isn't applied." : "Administratoriaus IP adresų filtravimas netaikomas.",
    "Configuration key \"%1$s\" expects an array (%2$s found). Admin IP range validation will not be applied." : "Konfigūracijos raktas „%1$s“ turi būti masyvas (rastas %2$s). Administratoriaus IP adresų rėžio patikrinimas nebus taikomas.",
    "Configuration key \"%1$s\" contains invalid IP range(s): \"%2$s\"" : "Konfigūracijos raktas „%1$s“ turi neteisingą (-us) IP adresų rėžį (-ius): „%2$s“",
    ...
    "Your \"trusted_proxies\" setting is not correctly set, it should be an array of IP addresses - optionally with range in CIDR notation." : "Jūsų nustatymas „trusted_proxies“ nustatytas neteisingai, tai turėtų būti IP adresų masyvas – pasirinktinai su ribomis CIDR notacijoje.",
    ...
    "Failed to write and read a value from local cache." : "Nepavyko įrašyti ir išskaityti reikšmės iš vietinės tarpinės atminties.",
    "Failed to write and read a value from distributed cache." : "Nepavyko įrašyti ir perskaityti reikšmės iš paskirstytos tarpinės atminties.",
    ...
    "for Argon2 for password hashing and Ed25519 signature verification for RFC 9421 http message signatures" : "„Argon2“ slaptažodžių maišymui ir „Ed25519“ parašo tikrinimui RFC 9421 http pranešimų parašams",
    ...
    "Valid enterprise license" : "Galiojanti licencija Įmonėms",
    ...
    "Sanitize and merge duplicate system tags available" : "Išvalyti ir sujungti pasiekiamas dubliuojamas sistemos žymas.",
    "One or more system tags need to be sanitized or merged. This can take a long time on larger instances so this is not done automatically during upgrades. Use the command `occ maintenance:repair --include-expensive` to perform the migrations." : "Vieną ar kelias sistemos žymas reikia išvalyti arba sujungti. Didelėse sistemose šis procesas gali užtrukti ilgai, todėl atnaujinimo metu jis neatliekamas automatiškai. Norėdami atlikti šiuos perkėlimo veiksmus, naudokite komandą `occ maintenance:repair --include-expensive`.",
    ...
    "\"%d\" is not a valid server identifier. It must be between 0 and 511." : "„%d“ nėra galiojantis serverio identifikatorius. Jis turi būti nuo 0 iki 511.",
    ...
    "MariaDB version 10.6 detected, this version is end-of-life and only supported as part of Ubuntu 22.04. MariaDB >=%1$s and <=%2$s is suggested for best performance, stability and functionality with this version of Nextcloud." : "Aptikta „MariaDB“ 10.6 versija, ši versija yra nebenaudojama ir palaikoma tik kaip „Ubuntu 22.04“ dalis. Siekiant geriausio našumo, stabilumo ir funkcionalumo su šia „Nextcloud“ versija, rekomenduojama naudoti MariaDB >=%1$s ir <=%2$s",
    ...
    "64-bit" : "64 bitų",
    "It seems like you are running a 32-bit PHP version. Nextcloud needs 64-bit to run well. Please upgrade your OS and PHP to 64-bit! We will no longer block improvements to performance, security and scalability that are incompatible with 32bit support going forward and we expect that Nextcloud Hub 27 Winter (Nextcloud 36) will no longer work on 32bit systems." : "Atrodo, kad naudojate 32 bitų PHP versiją. Kad „Nextcloud“ veiktų tinkamai, reikalinga 64 bitų versija. Prašome atnaujinti operacinę sistemą ir PHP į 64 bitų versijas! Ateityje nebetrukdysime diegti našumo, saugumo ir mastomumo patobulinimų, kurie nėra suderinami su 32 bitų sistemomis, ir tikimės, kad „Nextcloud Hub 27 Winter“ („Nextcloud 36“) 32 bitų sistemose nebeveiks.",
    ...
    "Task Processing success rate" : "Užduočių apdorojimo sėkmės rodiklis",
    "_No scheduled tasks in the last %n day._::_No scheduled tasks in the last %n days._" : ["Per pastarąją %n d. nebuvo suplanuota užduočių.","Per pastarąsias %n d. nebuvo suplanuota užduočių.","Per pastarąsias %n d. nebuvo suplanuota užduočių.","Per pastarąsias %n d. nebuvo suplanuota užduočių."],
    "_Most tasks were successful in the last %n day._::_Most tasks were successful in the last %n days._" : ["Dauguma užduočių per pastarąją %n d. buvo sėkmingai atliktos.","Dauguma užduočių per pastarąsias %n d. buvo sėkmingai atliktos.","Dauguma užduočių per pastarąsias %n d. buvo sėkmingai atliktos.","Dauguma užduočių per pastarąsias %n d. buvo sėkmingai atliktos."],
    ...
    "_The Task Processing worker has run in the last %n minute._::_The Task Processing worker has run in the last %n minutes._" : ["Užduočių apdorojimo darbuotojas veikė %n pastarąją minutę.","Užduočių apdorojimo darbuotojas veikė %n pastarąsias minutes.","Užduočių apdorojimo darbuotojas veikė %n pastarųjų minučių.","Užduočių apdorojimo darbuotojas veikė %n pastarųjų minučių."],
    ...
    "Generate text" : "Generuoti tekstą",
    ...
    "Hide legacy provider settings" : "Slėpti senojo teikėjo nustatymus",
    "Show legacy provider settings" : "Rodyti senojo teikėjo nustatymus",
    "Machine translation (Legacy)" : "Mašininis vertimas (senasis)",
    ...
    "This API is deprecated. Install apps that provide Unified task processing to get the best experience." : "Ši API nebenaudojama. Įdiekite programėles, kurios teikia vieningą užduočių apdorojimą, kad gautumėte geriausią patirtį.",
    "Learn more about AI providers" : "Sužinokite daugiau apie dirbtinio intelekto teikėjus",
    "Image generation (Legacy)" : "Vaizdo generavimas (palikimas)",
    ...
    "Text processing (Legacy)" : "Teksto apdorojimas (senasis)",
    ...
    "Restrict users to only share with users in their groups" : "Apriboti vartotojus ir leisti jiems bendrinti tik su vartotojais savo grupėse",
    ...
    "Allow users to set custom share link tokens" : "Leisti vartotojams nustatyti pasirinktinus bendrinimo nuorodų žymenis",
    "Shares with custom tokens will continue to be accessible after this setting has been disabled" : "Bendrinimai su pasirinktiniais žymenimis ir toliau bus pasiekiami išjungus šį nustatymą.",
    "Shares with guessable tokens may be accessed easily" : "Prie bendrinamų išteklių su atspėjamaisiais žymenimis galima lengvai prisijungti",
    ...
    "Default share permissions" : "Numatytieji bendrinimų leidimai",
    ...
    "{productName} Talk for iOS" : "{productName} „Pokalbiai“ skirtas iOS",
    "{productName} Talk for Android" : "{productName} „Pokalbiai“ skirtas Android",
    ...
    "Error while creating device token" : "Klaida, kuriant įrenginio žymenį",
    ...
    "Enable or disable the profile picker in the Smart Picker and the profile link previews." : "Įjunkite arba išjunkite profilio pasirinkimo funkciją „Išmanusis rinkiklis“ ir profilio nuorodų peržiūrose.",
    ...
    "Choose from Nextcloud Files" : "Pasirinkite iš „Nextcloud Failai“",
    ...
    "Additional address" : "Papildomas adresas",
    ...
    "Primary email address" : "Pirminis elektroninio pašto adresas",
    "Additional email address {index}" : "Papildomas el. pašto adresas {index}",
    "{label} (confirmation sent)" : "{label} (patvirtinimas išsiųstas)",
    ...
    "Derived from your locale ({weekDayName})" : "Pagal jūsų lokalę ({weekDayName})",
    ...
    "Locale" : "Lokalė",
    "No locale set" : "Nenustatyta lokalė",
    "Unable to update locale" : "Nepavyko atnaujinti lokalę",
    ...
    "Nextcloud profile" : "„Nextcloud“ profilis",
    "View full profile" : "Peržiūrėti pilną profilį",
    "she/her" : "ji/jos",
    "he/him" : "jis/jo",
    "they/them" : "jie/jiems",
    ...
    "Change visibility and scope of {property}" : "Keisti {property} matomumą ir aprėptį",
    "Unable to update visibility of {property}" : "Nepavyko atnaujinti {property} matomumo",
    "Unable to update scope of {property}" : "Nepavyko atnaujinti {property} aprėpties",
    "Visibility & Scope" : "Matomumas ir aprėptis",
    ...
    "Failed to update account" : "Nepavyko atnaujinti paskyros",
    ...
    "Adding new account …" : "Pridedama nauja paskyra …",
    ...
    "Manager" : "Vadovas",
    "Search for a manager…" : "Ieškoti vadovo…",
    ...
    "Wipe {userid}'s devices" : "Ištrinti duomenis vartotojo {userid} įrenginiuose",
    ...
    "Delete {userid}'s account" : "Ištrinti vartotojo {userid} paskyrą",
    ...
    "Search" : "Paieška",
    "Focus search" : "Fokusuota paieška",
    "Help" : "Pagalba",
    ...
    "Failed to run setup checks" : "Nepavyko paleisti sąrankos patikrinimų",
    ...
    "Contact" : "Kontaktas",
    "Notifications and password reset requests will be sent to your primary email" : "Pranešimai ir slaptažodžio atkūrimo užklausos bus siunčiami į jūsų pagrindinį el. pašto adresą",
    "Failed to save selected preset." : "Nepavyko išsaugoti pasirinkto išankstinio nustatymo.",
    "Select a configuration preset for easy setup." : "Pasirinkite konfigūracijos nustatymą, kad galėtumėte lengvai atlikti sąranką.",
    "Apply" : "Taikyti",
    ...
    "Search accounts and groups…" : "Ieškoti paskyrų ir grupių...",
    ...
    "Private" : "Privatus",
    "Only visible to people matched via phone number integration through Talk on mobile" : "Matoma tik žmonėms, su kuriais „Pokalbiai“ programėlėje mobiliajame įrenginyje buvo rasta atitiktis per telefono numerio integraciją",
    ...
    "Could not delete the app token" : "Nepavyko ištrinti programėlės žymens",
    "Error while wiping the device with the token" : "Įvyko klaida valant įrenginį panaudojant žymenį",
    "Error while updating device token name" : "Įvyko klaida atnaujinant įrenginio žymens pavadinimą",
    "Error while updating device token scope" : "Įvyko klaida atnaujinant įrenginio žymens taikymą",
    ...
    "Choose Deploy Daemon for {appName}" : "Pasirinkite diegimo tarnybą {appName}",
    "Registered Deploy daemons list" : "Registruotų diegimo tarnybų sąrašas",
    "No Deploy daemons configured" : "Nėra sukonfigūruotų diegimo tarnybų",
    ...
    "Manage Deploy daemons" : "Tvarkyti diegimo tarnybas",
    ...
    "Must exist on the Deploy daemon host prior to installing the ExApp" : "Prieš diegiant „ExApp“, tai jau turi būti diegimo tarnybos serveryje.",
    ...
    "Details" : "Išsamiau",
    "All" : "Visos",
    "Limit app usage to groups" : "Programėlės panaudojimas ribojamas grupėms",
    "No results" : "Nieko nerasta",
    "Update to {version}" : "Atnaujinti į versiją {version}",
    "Deploy options" : "Įdiegti parinktis",
    "Default Deploy daemon is not accessible" : "Numatytoji diegimo tarnyba nepasiekiama",
    ...
    "Choose profile picture from Files" : "Pasirinkite profilio paveikslėlį iš „Failai“",
