OC.L10N.register(
    ...
    "Maintenance window to execute heavy background jobs is between {start}:00 UTC and {end}:00 UTC" : "Atzeko planoko lan astunak exekutatzeko mantentze-leihoa {hasiera}:00 UTC eta {amaiera}:00 UTC artean dago",
    "Memcache" : "Memcache",
    ...
    "Allow account name autocompletion to users within the same groups and limit system address books to users in the same groups" : "Baimendu kontuaren izena automatikoki osatzea talde bereko erabiltzaileei eta mugatu sistemako helbide-liburuak atzitzea talde bereko erabiltzaileei",
    "Allow account name autocompletion to users based on phone number integration" : "Baimendu erabiltzaileei kontu-izena automatikoki osatzea telefono-zenbakien integrazioan oinarrituta",
