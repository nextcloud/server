OC.L10N.register(
    ...
    "_No scheduled tasks in the last day._::_No scheduled tasks in the last %n days._" : ["Viimase päeva jooksul pole käivitatud ühtegi ajastatud käsku.","Viimase %n päeva jooksul pole käivitatud ühtegi ajastatud käsku."],
    "_The task pickup speed has been ok in the last day._::_The task pickup speed has been ok in the last %n days._" : ["Käskude käivitamise kiirus on olnud viimase päeva jooksul mõistlik.","Käskude käivitamise kiirus on olnud viimase %n päeva jooksul mõistlik."],
    "_The task pickup speed has been slow in the last day. Many tasks took longer than 4 minutes to be picked up. Consider setting up a worker to process tasks in the background._::_The task pickup speed has been slow in the last %n days. Many tasks took longer than 4 minutes to be picked up. Consider setting up a worker to process tasks in the background._" : ["Käskude käivitamise kiirus on olnud viimase päeva jooksul aeglane. Mitmete käskude puhul kulus selleks enam kui 4 minutit. Kaalu selleks eraldi protsessi seadistamist, mis toimiks taustal.","Käskude käivitamise kiirus on olnud viimase %n päeva jooksul aeglane. Mitmete käskude puhul kulus selleks enam kui 4 minutit. Kaalu selleks eraldi protsessi seadistamist, mis toimiks taustal."],
