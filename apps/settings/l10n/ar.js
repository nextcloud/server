OC.L10N.register(
    ...
    "Could not check for {extension} loading support. Please check manually if your webserver serves `.{extension}` files." : "تعذّر التحقُّق من دعم الرفع لـ{extension}. يرجى التحقُّق يدويّاً من أن خادوم الوب يمكنه خدمة ملفات `.{extension}`.",
