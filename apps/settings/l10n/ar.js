OC.L10N.register(
    ...
    "Private" : "خاص بك",
    "Local" : "المحلي",
    "Only visible to people on this instance and guests" : "ظاهر فقط للمستخدمين والضيوف",
    "Federated" : "المتحدة",
    "Only synchronize to trusted servers" : "قم فقط بالمزامنة مع الخوادم الموثوقة",
    "Published" : "نشرت",
    "Synchronize to trusted servers and the global and public address book" : "قم بالمزامنة مع الخوادم الموثوقة ودفتر العناوين العالمية والعامة",
    "Verify" : "تحقق",
    ...
    "You need to set your user email before being able to send test emails." : "يجب أولا أن يتم تجهيز إعدادات البريد الإلكتروني قبل أن يمكنك إرسال أي بريد",
