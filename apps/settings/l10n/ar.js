OC.L10N.register(
    ...
    "Please provide an admin recovery password; otherwise, all account data will be lost." : "قم رجاءً بإعطاء كلمة مرور لاستعادة بيانات المشرف؛ و إلاّ فإن جميع بيانات الحساب ستُفقد.",
    ...
    "Logged in account must be a subadmin" : "يجب أن يكون الحساب الذي تم تسجيل الدخول إليه مشرفاً فرعياً",
    "Apps" : "التطبيقات",
    "Personal" : "شخصي",
    ...
    "Admin IP filtering isn’t applied." : "غربلة عناوين IP الخاصة بالمشرفين غير مُطبَّقة.",
    "Configuration key \"%1$s\" expects an array (%2$s found). Admin IP range validation will not be applied." : "مفتاح التهيئة \"%1$s\" يتوقع مصفوفة (%2$s موجودة). غربلة عناوين IP الخاصة بالمشرفين غير مُطبَّقة.",
    "Configuration key \"%1$s\" contains invalid IP range(s): \"%2$s\"" : "مفتاح التهيئة \"%1$s\" يحتوي على نطاق (أو نطاقات) IP غير صحيحة: \"%2$s\"",
    "Admin IP filtering is correctly configured." : "غربلة عناوين IP الخاصة بالمشرفين مُهيَّأةٌ بالشكل الصحيح.",
    ...
    "Unable to run check for JavaScript support. Please remedy or confirm manually if your webserver serves `.mjs` files using the JavaScript MIME type." : "غير قادر على تشغيل التحقق من دعم JavaScript. يرجى المعالجة أو التأكُّد يدوياً مما إذا كان خادوم الوب عندك يقدم ملفات `.mjs` باستخدام نوع JavaScript MIME.",
    ...
    "Some headers are not set correctly on your instance" : "بعض الترويسات لم يتم تعيينها بالشكل الصحيح على خادومك",
    "Could not check that your web server serves security headers correctly. Please check manually." : "تعذّر التحقُّق من أن خادوم الوب عندك يخدم الترويسات الآمنة security headers بالشكل الصحيح. قم رجاءً بالتحقُّق من ذلك يدوياً.",
    "Could not check that your web server serves security headers correctly, unable to query `%s`" : "تعذّر التحقُّق من أن خادوم الوب عندك يخدم الترويسات الآمنة security headers بالشكل الصحيح. و تعذّر تنفيذ الاستعلام عن: `%s`",
    ...
    "Choose slide to display" : "إختَر شريحة للعرض",
    ...
    "AJAX" : "AJAX",
    "Execute one task with each page loaded. Use case: Single account instance." : "نفِّذ مهمة واحدة لكل صفحة يتم تحميلها. حالة الاستخدام: خادوم حساب وحيد ",
    "Webcron" : "Webcron",
    "cron.php is registered at a webcron service to call cron.php every 5 minutes over HTTP. Use case: Very small instance (1–5 accounts depending on the usage)." : "يتم تسجيل cron.php في خدمة webcron للاتصال بـ cron.php كل 5 دقائق عبر HTTP. حالة الاستخدام: خادوم صغير جدًا (من 1 إلى 5 حسابات حسب الاستخدام).",
    ...
    "Derived from your locale ({weekDayName})" : "مُشتقَّة من إعدادات بلدك ({weekDayName})",
    ...
    "Not available as publishing account specific data to the lookup server is not allowed, contact your system administration if you have any questions" : "غير متاح بسبب أنه غير مسموح بنشر بيانات خاصة بالحساب على خادوم البحث. اتصل بإدارة النظام لأي استفسار",
    "Discover" : "إستكشِف",
    "Your apps" : "تطبيقاتك",
