OC.L10N.register(
    ...
    "Could not check for {extension} loading support. Please check manually if your webserver serves `.{extension}` files." : "تعذّر التحقُّق من دعم الرفع لـ{extension}. يرجى التحقُّق يدويّاً من أن خادم الويب يمكنه خدمة ملفات `.{extension}`.",
    ...
    "Profile picture, full name, email, phone number, address, website, Twitter, organisation, role, headline, biography, and whether your profile is enabled" : "صورة الملف الشخصي، و الاسم الكامل، و الإيميل، و رقم الهاتف، و صفحة الويب، و حساب تويتر، و المؤسسة، و الوظيفة، و الترويسة، و السيرة الذاتية، و هل أن ملفك الشخصي مُفعّل",
    ...
    "Two-Factor Authentication" : "التحقق ثنائي العوامل",
    ...
    "Could not check for JavaScript support. Please check manually if your webserver serves `.mjs` files using the JavaScript MIME type." : "لا يمكن التحقق من دعم JavaScript. يرجى التحقق يدوياً مما إذا كان خادم الويب عندك يتعامل مع ملفات `.mjs` باستعمال نوع JavaScript MIME.",
    ...
    "Could not check for JavaScript support via any of your `trusted_domains` nor `overwrite.cli.url`. This may be the result of a server-side DNS mismatch or outbound firewall rule. Please check manually if your webserver serves `.mjs` files using the JavaScript MIME type." : "تعذر التحقُّق من دعم JavaScript عبر أيٍّ من \"النطاقات_الموثوقة\" أو \"overwrite.cli.url\". قد يكون هذا نتيجة عدم تطابق DNS من جانب الخادم أو بسبب إحدى سياسات إدارة الحركة الصادرة في جدار الحماية. يرجى التحقق يدويًا مما إذا كان خادم الويب عندك يقدم ملفات `.mjs` باستخدام نوع JavaScript MIME.",
