OC.L10N.register(
    ...
    "Not available as publishing user specific data to the lookup server is not allowed, contact your system administrator if you have any questions" : "غير مُتاحٍ لأن نشر البيانات الخاصة بالمستخدم إلى خادم البحث غير مسموح به. إتّصل بمدير النظام إذا كان لديك أي أسئلة",
    ...
    "Users's email account" : "حساب البريد الإلكتروني للمستخدِم",
