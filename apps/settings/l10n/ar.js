OC.L10N.register(
    ...
    "Two-factor authentication can be enforced for all accounts and specific groups. If they do not have a two-factor provider configured, they will be unable to log into the system." : "يمكن فرض المصادقة ثنائية العوامل على جميع الحسابات أو على مجموعات محددة. لكم إذا لم يسبق تهيئة مزود للتحقق والمصادقة ثنائية العوامل لهم، فلن يتمكنوا من تسجيل الدخول إلى النظام.",
