OC.L10N.register(
    ...
    "Could not check that your web server serves security headers correctly. Please check manually." : "تعذّر التحقُّق من أن خادوم الويب عندك يخدم الترويسات الآمنة security headers بالشكل الصحيح. قم رجاءً بالتحقُّق من ذلك يدوياً.",
    "Could not check that your web server serves security headers correctly, unable to query `%s`" : "تعذّر التحقُّق من أن خادوم الويب عندك يخدم الترويسات الآمنة security headers بالشكل الصحيح. و تعذّر تنفيذ الاستعلام عن: `%s`",
