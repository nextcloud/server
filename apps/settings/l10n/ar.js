OC.L10N.register(
    ...
    "Your remote address was identified as \"%s\" and is bruteforce throttled at the moment slowing down the performance of various requests. If the remote address is not your address this can be an indication that a proxy is not configured correctly." : "تمّ التعرُّف على عنوانك البعيد على أنه \"%sو يتم في الوقت الحالي تقييده ضمن الإجراءات المضادة لهجوم القوة الكاسحة مما يؤدي إلى إبطاء أداء الطلبات المختلفة. إذا لم يكن هذا العنوان البعيد هو عنوانك، فقد يكون ذلك إشارة إلى أنه لم يتم تكوين الوكيل بشكل صحيح.",
    ...
    "PHP output_buffering option" : "خيار  PHP output_buffering",
    ...
    "Unknown database plaform" : "منصة قاعدة البيانات غير معروفة",
    "Architecture" : "معمار",
    "64-bit" : "64-بِت",
    ...
    "You created app password \"{token}\"" : "أنت أنشأت كلمة مرور للتطبيق \"{token}\"",
    "An administrator created app password \"{token}\"" : "أنشأ المشرف كلمة مرور للتطبيق \"{token}\"",
