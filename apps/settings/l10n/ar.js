OC.L10N.register(
    ...
    "Please provide an admin recovery password; otherwise, all user data will be lost." : "يرجى تقديم كلمة مرور لاسترداد المدير admin recovery password؛ وإلا ستفقد كافة بيانات المستخدم.",
    ...
    "Logged in user must be a subadmin" : "يجب أن يكون المستخدم المسجل دخوله مديراً فَرعياً",
    ...
    "Set user as admin for" : "تعيين المستخدم كمدير لـ",
    ...
    "Not available as federation has been disabled for your account, contact your system administrator if you have any questions" : "غير متاح حيث تم تعطيل الاتحاد بالنسبة لحسابك، إتصل بمدير النظام إذا كان لديك أي أسئلة",
    "Not available as publishing user specific data to the lookup server is not allowed, contact your system administrator if you have any questions" : "غير مُتاحٍ لأن نشر البيانات الخاصة بالمستخدم إلى خادم البحث غير مسموح به. إتّصل بمدير النظام إذا كان لديك أيّة أسئلة",
