OC.L10N.register(
    ...
    "The database is used for transactional file locking. To enhance performance, please configure memcache, if available." : "データベースはトランザクション・ファイル・ロックに使用されます。パフォーマンスを向上させるには、メモリキャッシュが利用可能であれば設定してください。",
    ...
    "Unknown database plaform" : "不明なデータベース・プラフォーム",
