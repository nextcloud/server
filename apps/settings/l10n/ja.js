OC.L10N.register(
    ...
    "Memcache" : "Memcache",
    "Memcached is configured as distributed cache, but the wrong PHP module \"memcache\" is installed. \\OC\\Memcache\\Memcached only supports \"memcached\" and not \"memcache\"." : "Memcached は分散キャッシュとして設定されていますが、誤ったPHPモジュール \"memcache\" がインストールされています。 \\OC\\Memcache\\Memcached は \"memcached\" のみをサポートしており、\"memcache\" はサポートされていません。",
