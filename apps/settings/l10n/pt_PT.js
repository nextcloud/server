OC.L10N.register(
    ...
    "Mail delivery is disabled by instance config \"%s\"." : "A entrega de e-mails está desativada pela configuração da instância \"%s\".",
    ...
    "_No scheduled tasks in the last %n day._::_No scheduled tasks in the last %n days._" : ["Não há tarefas agendadas no último %n dia.","Não há tarefas agendadas nos últimos %n de dias.","Não há tarefas agendadas nos últimos %n dias."],
    "_Most tasks were successful in the last %n day._::_Most tasks were successful in the last %n days._" : ["A maioria das tarefas foi concluída com sucesso no último %n dia.","A maioria das tarefas foi concluída com sucesso nos últimos %n de dias.","A maioria das tarefas foi concluída com sucesso nos últimos %n dias."],
    ...
    "_The Task Processing worker has run in the last %n minute._::_The Task Processing worker has run in the last %n minutes._" : ["O processador de tarefas foi executado no último %n minuto.","O processador de tarefas foi executado nos últimos %n de minutos.","O processador de tarefas foi executado nos últimos %n minutos."],
    ...
    "This API is deprecated. Install apps that provide Unified task processing to get the best experience." : "Esta API está obsoleta. Instale aplicativos que ofereçam o processamento unificado de tarefas para obter a melhor experiência.",
    ...
    "Language" : "Idioma",
    "Manager" : "Gerente",
    "Search for a manager…" : "Pesquisar gerenciador…",
    "Quota" : "Quota",
    ...
    "Cancel adding mount" : "Cancelar a adição da montagem",
    ...
    "Please use the AIO interface to switch between office suites." : "Por favor, utilize a interface AIO para alternar entre as suítes de escritório.",
    "Select your preferred office suite. Please note that installing requires manual server setup." : "Selecione a sua suíte de escritório preferida. Observe que a instalação requer configuração manual do servidor.",
    "installed" : "instalado",
