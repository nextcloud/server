OC.L10N.register(
    "settings",
    {
    "{actor} added you to group {group}" : "{actor} pievienoja Tevi kopai {group}",
    "You added {user} to group {group}" : "Tu pievienoji {user} kopai {group}",
    "An administrator added you to group {group}" : "Pārvaldītājs pievienoja Tevi kopai {group}",
    ...
    "You created an app password for a session named \"{token}\"" : "Tu izveidoji lietotnes paroli sesijai ar nosaukumu \"{token}\"",
    "You deleted app password \"{token}\"" : "Tu izdzēsi lietotnes paroli \"{token}\"",
    "You deleted app password \"{token}\" and cancelled its pending remote wipe" : "Tu izdzēsi lietotnes paroli “{token}” un atcēli tās ierindoto attālo izdzēšanu",
    ...
    "Your %s account was created" : "Tavs %s konts tika izveidots",
    "Personal" : "Personīgi",
    ...
    "Verify" : "Verificēt",
    "App directories owner" : "Lietotņu mapju īpašnieks",
    ...
    "You are about to delete the group \"{group}\". The accounts will NOT be deleted." : "Tu grasies izdzēst kopu “{group}”. Konti NETIKS izdzēsti.",
    "Confirm" : "Apstiprināt",
    "Submit" : "Iesniegt",
    ...
    "Private" : "Privāts",
    "Local" : "Vietējs",
    "Only visible to people on this instance and guests" : "Redzams tikai šī servera cilvēkiem un viesiem",
    "Federated" : "Federated",
    "Discover" : "Atklāt",
    "Your apps" : "Manas lietotnes",
    ...
    "Hide" : "Paslēpt",
    "There were too many requests from your network. Retry later or contact your administrator if this is an error." : "No tīkla tika veikti pārāk daudz pieprasījumu. Vēlāk jāmēģina atkārtoti vai jāsazinās pārvaldītāju, ja tā ir kļūda.",
    "Error" : "Kļūda",
