OC.L10N.register(
    ...
    "Mail provider enables sending emails directly through the user's personal email account. At present, this functionality is limited to calendar invitations. It requires Nextcloud Mail 4.1 and an email account in Nextcloud Mail that matches the user's email address in Nextcloud." : "Poštni ponudnik omogoča pošiljanje sporočil neposredno z uporabnikovega osebnega elektronskega poštnega računa. Trenutno je ta funkcionalnost omejena na vabila v koledarju. Za njeno delovanje sta zahtevana Nextcloud Mail 4.1 in poštni račun v Nextcloud Mail, ki ustreza uporabnikovemu poštnemu naslovu v oblaku Nextcloud.",
    "Send emails using" : "Pošlji elektronska sporočila z uporabo",
    "User's email account" : "Račun elektronske pošte",
    "System email account" : "Sistemski račun elektronske pošte",
    "Security & setup checks" : "Varnost in preverjanje namestitve",
    "Settings presets" : "Izbirne nastavitve",
    ...
    "Detected some missing optional indices. Occasionally new indices are added (by Nextcloud or installed applications) to improve database performance. Adding indices can sometimes take awhile and temporarily hurt performance so this is not done automatically during upgrades. Once the indices are added, queries to those tables should be faster. Use the command `occ db:add-missing-indices` to add them." : "V podatkovni zbirki je zaznanih nekaj manjkajočih izbirnih določil. Ta se v okolju Nextcloud dodajo (sistemsko ali med posodabljanjem programov) za izboljšanje zmogljivosti zbirke podatkov. Indeksiranje je lahko dolgotrajen postopek in začasno zmanjša zmogljivost delovanje, zato se to med vsakokratnimi nadgradnjami ne izvede samodejno. Urejena določila pohitrijo izvajanje poizvedb. Zbirko je mogoče ročno posodobiti z ukazom `occ db:add-missing-indices`.",
    ...
    "Mail delivery is disabled by instance config \"%s\"." : "Dostava elektronske pošte je onemogočena v nastavitvah okolja »%s«.",
    ...
    "Transactional File Locking" : "Zaklepanje transakcijske datoteke",
    "Transactional File Locking is disabled. This is not a a supported configuraton. It may lead to difficult to isolate problems including file corruption. Please remove the `'filelocking.enabled' => false` configuration entry from your `config.php` to avoid these problems." : "Zaklepanje datotek med transakcijami je onemogočeno. To ni podprta nastavitev. Zaradi te zmožnosti se lahko pojavijo težave pri odkrivanju napak, vključno s poškodovanimi datotekami. Priporočljivo je iz datoteke `config.php` odstraniti nastavitveni vnos `'filelocking.enabled' => false`.",
    ...
    "You are accessing your instance over a secure connection, and your instance is generating secure URLs." : "Okolje se izvaja na varni povezavi, prav tako ustvarja varne naslove URL.",
    ...
    "JavaScript source map support" : "Podpora za vire JavaScript",
    ...
    "The %1$s configuration option must be a valid integer value." : "Možnost nastavitve %1$s zahteva veljavno celoštevilsko vrednost.",
    "Logging level configured correctly." : "Raven beleženja je nastavljena pravilno.",
    "Maintenance window start" : "Zagon vzdrževanja",
    "Maintenance window to execute heavy background jobs is between {start}:00 UTC and {end}:00 UTC" : "Časovno okno za izvajanje zahtevnih opravil v ozadju je med {start}:00 in {end}:00 UTC.",
    "Memcache" : "Memcache",
    ...
    "Your APCu cache has been running full, consider increasing the apc.shm_size php setting." : "Predpomnilnik APCu je poln; razmislite o povečanju nastavitve php apc.shm_size.",
    "Your APCu cache is almost full at %s%%, consider increasing the apc.shm_size php setting." : "Predpomnilnik APCu je poln pri %s%%; razmislite o povečanju nastavitve php apc.shm_size.",
    ...
    "The OPcache buffer is nearly full. To assure that all scripts can be hold in cache, it is recommended to apply \"opcache.memory_consumption\" to your PHP configuration with a value higher than \"%s\"." : "Medpomnilnik OPcache je skoraj poln. Za zagotavljanje shranjevanja vseh skript v medpomnilniku, je priporočljivo med nastavitvami PHP uporabiti »opcache.memory_consumption« z vrednostjo, višjo od »%s«.",
    "The OPcache interned strings buffer is nearly full. To assure that repeating strings can be effectively cached, it is recommended to apply \"opcache.interned_strings_buffer\" to your PHP configuration with a value higher than \"%s\"." : "Notranji medpomnilnik OPcache je skoraj poln. Da bi zagotovili predpomnjenje ponavljajočih se nizov, je priporočljivo med nastavitvami PHP uporabiti »opcache.interned_strings_buffer« z vrednostjo, višjo od »%s«.",
    "OPcache is configured to remove code comments. With OPcache enabled, \"opcache.save_comments=1\" must be set for Nextcloud to function." : "Predpomnilnik OPcache je nastavljen tako, da odstrani komentarje h kodi. Če je možnost OPcache omogočena, mora biti za delovanje storitve Nextcloud nastavljena vrednost »opcache.save_comments=1«.",
    "Nextcloud is not allowed to use the OPcache API. With OPcache enabled, it is highly recommended to include all Nextcloud directories with \"opcache.restrict_api\" or unset this setting to disable OPcache API restrictions, to prevent errors during Nextcloud core or app upgrades." : "Uporaba vmesnika API za OPcache ni dovoljena. Če je omogočen, je priporočljivo vključiti vse mape v oblaku z »opcache.restrict_api«, ali pa možnost odklopiti, da onemogočite omejitve vmesnika API. S tem preprečite napake med nadgradnjo oblaka oziroma programov Nextcloud.",
    "Checking from CLI, OPcache checks have been skipped." : "Po preverjanju v ukazni vrstici so bili pregledi OPcache preskočeni.",
    "The PHP OPcache module is not properly configured. %s." : "Modul PHO OPcache ni ustrezno nastavljen. %s",
    ...
    "This is the unsupported community build of Nextcloud. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications are limited to avoid overloading our free service. Learn more about the benefits of Nextcloud Enterprise at {link}." : "Uporabljate nepodprto različica oblaka Nextclouda, ki jo razvija skupnost. Glede na velikost okolja ni mogoče zagotoviti zmogljivosti, zanesljivosti in prilagodljivosti. Potisna obvestila so omejena, da se prepreči preobremenitev ponujene brezplačne storitve. Več o prednostih poslovne različice Nextcloud Enterprise si preberite na {link}.",
    "Random generator" : "Ustvarjalnik naključnih vrednosti",
    "No suitable source for randomness found by PHP which is highly discouraged for security reasons." : "Iz varnostnih razlogov je priporočljivo nastaviti ustrezen vir za naključno ustvarjanje podatkov, ki ga uporablja PHP.",
    "Secure" : "Varno",
    ...
    "Configuration server ID" : "Določilo ID nastavitvenega strežnika",
    "Server identifier is configured and valid." : "Določilo strežnika je nastavljeno in je veljavno.",
    ...
    "Task Processing pickup speed" : "Hitrost prevzema obdelave nalog",
    "_No scheduled tasks in the last day._::_No scheduled tasks in the last %n days._" : ["Ni načrtovanih nalog v zadnjem %n dnevu.","Ni načrtovanih nalog v zadnjih %n dneh.","Ni načrtovanih nalog v zadnjih %n dneh.","Ni načrtovanih nalog v zadnjih %n dneh."],
    "Task Processing success rate" : "Stopnja uspešnosti obdelave nalog",
    ...
    "Exclude some groups" : "Izloči nekatere skupine",
    "Allow some groups" : "Dovoli izbranim skupinam",
    "Groups allowed to share" : "Skupine z dovoljenjem za omogočanje souporabe",
    ...
    "Mail delivery is disabled by instance config \"{config}\"." : "Dostava elektronske pošte je onemogočena v nastavitvah okolja »{config}«.",
    ...
    "Limit sharing to some groups" : "Omeji souporabo na nekatere skupine",
    ...
    "Type" : "Vrsta",
    "Display Name" : "Prikazno ime",
    "GPUs support" : "Podpora GPE",
    "Learn more" : "Prikaži več",
    "Environment variables" : "Okoljske spremenljivke",
    "No environment variables defined" : "Ni določenih okoljskih spremenljivk",
    "Mounts" : "Priklopne točke",
    "Host path" : "Gostiteljeva pot",
    "Container path" : "Pot vsebnika",
    "Read-only" : "Le za branje",
    "Remove mount" : "Odstrani priklopno točko",
    "New mount" : "Nova priklopna točka",
    "Enter path to host folder" : "Vpis poti za gostiteljevo mapo",
    "Enter path to container folder" : "Vpis poti za mapo vsebnika",
    "Toggle read-only mode" : "Preklopi način le za branje",
    "Confirm adding new mount" : "Potrdi dodajanje nove priklopne točke",
    "Cancel adding mount" : "Prekliči dodajanje priklopne točke",
    "Add mount" : "Dodaj priklopno točko",
    "ExApp container mounts" : "Priklopne točke vmesnika ExApp",
    "No mounts defined" : "Ni določenih priklopnih točk",
    "Description" : "Opis",
    ...
    "Deploy options" : "Možnosti namestitve",
    "Delete data on remove" : "Izbriši podatke med ostranjevanjem",
    ...
    "Password can't be empty" : "Gesla ne sme biti prazna vrednost",
    "Password was successfully changed" : "Geslo je uspešno spremenjeno",
    "Email can't be empty" : "Polje elektronskega naslova ne sme biti prazno",
    ...
    "Manually installed apps cannot be updated" : "Ročno nameščenih programov ni mogoče posodobiti",
    "Deploy and Enable" : "Namesti in omogoči",
    ...
    "installed" : "nameščeno",
    "Disable office suites" : "Onemogoči pisarniške pakete",
    "All office suites disabled" : "Pisarniški paketi so onemogočeni",
