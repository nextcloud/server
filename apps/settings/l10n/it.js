OC.L10N.register(
    ...
    "Disable to require your login or email during login." : "Disattiva per richiedere login o email durante l'accesso.",
    "Login or email not required for login, device PIN only." : "Login o email non necessari per l'accesso, solo il PIN del dispositivo.",
    "Add device" : "Aggiungi dispositivo",
    "Server error while trying to complete device registration" : "Errore del server durante il completamento della registrazione del dispositivo",
    "Please authorize your device." : "Autorizza il dispositivo."
},
