OC.L10N.register(
    ...
    "_You revoked %n other session_::_You revoked %n other sessions_" : ["您已撤銷 %n 個其他的工作階段"],
    ...
    "\"%d\" is not a valid server identifier. It must be between 0 and 511." : "「%d」不是有效的伺服器識別字串。其必須在 0 至 511 間。",
    ...
    "Exclude some groups (block list)" : "排除部份群組（封鎖清單）",
    "Allow some groups only (allow list)" : "僅允許部份群組（允許清單）",
    "Groups allowed to share" : "允許分享的群組",
    "Groups excluded from sharing" : "被排除而不能分享的群組",
    "Only members of at least one of these groups will be able to initiate shares." : "只有同時屬於上述至少一個群組的成員，才能發起分享。",
    "Others will be blocked, but are still able to receive shares." : "其他使用者將被封鎖，但仍可接收分享。",
    "A member of at least one of these groups will not be able to initiate new shares, but will still be able to receive shares." : "上述群組中至少有一個群組的成員將無法發起新分享，但仍可接收分享。",
    ...
    "Actions" : "動作",
    "Revoke all others" : "撤銷所有工作階段",
    "Revoke all other sessions?" : "撤銷所有其他工作階段",
    "Sync clients and connected services have to sign in again. This cannot be undone." : "同步客戶端及已連線的服務必須重新登入。此操作無法撤銷。",
    "Devices & sessions" : "裝置和工作階段",
    "Web, desktop and mobile clients currently logged in to your account." : "目前登入您的帳號的網頁、桌面和行動裝置客戶端。",
    "Revoke all other sessions" : "撤銷所有其他工作階段",
    "Signs out every device and app except this one." : "除了目前這個以外，登出所有裝置與應用程式。",
    ...
    "Unable to update visibility of {property}" : "無法更新 {property} 的能見度",
    ...
    "Failed to update account" : "更新帳號失敗",
    "Edit account" : "編輯帳號",
    "Saving …" : "正在儲存 …",
    "Save" : "儲存",
    ...
    "Only letters, numbers, spaces, and _.@-' are allowed" : "僅允許使用字母、數字、空格以及 _.@-'",
    "Display name" : "顯示名稱",
    ...
    "_Revoked %n other session_::_Revoked %n other sessions_" : ["已撤銷 %n 個其他工作階段"],
