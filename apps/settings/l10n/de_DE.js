OC.L10N.register(
    ...
    "_You revoked %n other session_::_You revoked %n other sessions_" : ["Sie haben %n andere Sitzung widerrufen","Sie haben %n andere Sitzungen widerrufen"],
    ...
    "Profile & contact" : "Profil und Kontakt",
    ...
    "64-bit" : "64-bit",
    "It seems like you are running a 32-bit PHP version. Nextcloud needs 64-bit to run well. Please upgrade your OS and PHP to 64-bit! We will no longer block improvements to performance, security and scalability that are incompatible with 32bit support going forward and we expect that Nextcloud Hub 27 Winter (Nextcloud 36) will no longer work on 32bit systems." : "Es scheint, als würde eine 32-Bit-PHP-Version ausgeführt werden. Nextcloud benötigt 64-Bit, um gut zu laufen. Bitte das Betriebssystem und PHP auf 64-Bit aktualisieren! Wir werden künftig keine Leistungs-, Sicherheits- und Skalierbarkeitsverbesserungen mehr blockieren, die mit der 32-Bit-Unterstützung nicht kompatibel sind, und wir gehen davon aus, dass Nextcloud Hub 27 Winter (Nextcloud 36) auf 32-Bit-Systemen nicht mehr funktionieren wird.",
    ...
    "Exclude some groups (block list)" : "Einige Gruppen ausschließen (Blockierliste)",
    "Allow some groups only (allow list)" : "Nur einige Gruppen zulassen (Zulassungsliste)",
    ...
    "Only members of at least one of these groups will be able to initiate shares." : "Nur Mitglieder mindestens einer dieser Gruppen können Freigaben initiieren.",
    "Others will be blocked, but are still able to receive shares." : "Andere werden gesperrt, können aber weiterhin Freigaben erhalten.",
    "A member of at least one of these groups will not be able to initiate new shares, but will still be able to receive shares." : "Ein Mitglied mindestens einer dieser Gruppen kann keine neuen Freigaben initiieren, aber dennoch Freigaben erhalten.",
    ...
    "Actions" : "Aktionen",
    "Revoke all others" : "Alle anderen widerrufen",
    "Revoke all other sessions?" : "Alle anderen Sitzungen widerrufen?",
    "Sync clients and connected services have to sign in again. This cannot be undone." : "Synchronisierungsclients und verbundene Dienste müssen sich erneut anmelden. Dies kann nicht rückgängig gemacht werden.",
    ...
    "Revoke all other sessions" : "Alle anderen Sitzungen widerrufen",
    "Signs out every device and app except this one." : "Meldet alle Geräte und Apps außer diesem ab.",
    ...
    "Error setting profile picture" : "Fehler beim Einstellen des Profilbildes",
    "Error cropping profile picture" : "Fehler beim Zuschneiden des Profilbildes",
    "Error saving profile picture" : "Fehler beim Speichern des Profilbildes",
    "Error removing profile picture" : "Fehler beim Entfernen des Profilbildes",
    ...
    "{label} (confirmation sent)" : "{label} (Bestätigung gesendet)",
    ...
    "Nextcloud profile" : "Nextcloud-Profil",
    ...
    "Change visibility and scope of {property}" : "Sichtbarkeit und Umfang von {property} ändern",
    "Unable to update visibility of {property}" : "Sichtbarkeit von {property} kann nicht aktualisiert werden",
    "Unable to update scope of {property}" : "Umfang von {property} kann nicht aktualisiert werden",
    "Visibility & Scope" : "Sichtbarkeit und Umfang",
    ...
    "Adding new account …" : "Füge neues Konto hinzu …",
    "Add new account" : "Neues Konto hinzufügen",
    "Only letters, numbers, spaces, and _.@-' are allowed" : "Nur Buchstaben, Zahlen, Leerzeichen und _.@-' sind erlaubt",
    ...
    "Manager" : "Manager",
    "Search for a manager…" : "Suche nach einem Manager …",
    "Quota" : "Kontingent",
    ...
    "Contact" : "Kontakt",
    "Notifications and password reset requests will be sent to your primary email" : "Benachrichtigungen und Anfragen zum Zurücksetzen des Passworts werden an Ihre primäre E-Mail-Adresse gesendet",
    ...
    "_Revoked %n other session_::_Revoked %n other sessions_" : [" %n andere Sitzung widerrufen","%n andere Sitzungen widerrufen"],
    "Could not revoke the other sessions" : "Die anderen Sitzungen konnten nicht widerrufen werden",
