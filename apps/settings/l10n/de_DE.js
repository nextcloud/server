OC.L10N.register(
    ...
    "Your Login is: %s" : "Ihre Anmeldename lautet: %s",
    "Set your password" : "Setzen Sie Ihr Passwort",
    "Go to %s" : "%s aufrufen",
    "Install Client" : "Installiere den Client",
    "Logged in account must be a subadmin" : "Das angemeldete Konto muss ein Subadministrator sein.",
    "Apps" : "Apps",
    "Personal" : "Persönlich",
    ...
    "Your \"trusted_proxies\" setting is not correctly set, it should be an array of IP addresses - optionally with range in CIDR notation." : "Ihre „trusted_proxies“-Einstellung ist nicht richtig eingestellt, es sollte ein Array von IP-Adressen sein – optional mit Bereich in CIDR-Notation.",
    ...
    "AJAX" : "AJAX",
    "Execute one task with each page loaded. Use case: Single account instance." : "Mit jeder geladenen Seite wird eine Aufgabe ausgeführt. Anwendungsfall: Einzelbenutzer-Installation.",
    "Webcron" : "Webcron",
    ...
    "You do not have permissions to see the details of this account" : "Sie haben nicht die Berechtigung, die Details dieses Kontos anzusehen.",
