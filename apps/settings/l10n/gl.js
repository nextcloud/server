OC.L10N.register(
    ...
    "Welcome to your %s account, you can add, protect, and share your data." : "Dámoslle a benvida á súa conta %s, pode engadir, protexer e compartir os seus datos.",
    ...
    "_The Task Processing worker has run in the last %n minute._::_The Task Processing worker has run in the last %n minutes._" : ["O traballador do servizo de procesamento de tarefas executouse no último minuto.","O traballador do servizo de procesamento de tarefas executouse nos últimos %n minutos."],
