OC.L10N.register(
    ...
    "Register a custom one or setup from available templates" : "یک مورد سفارشی ثبت کنید یا از قالب‌های موجود پیکربندی کنید",
    "Manage Deploy daemons" : "مدیریت دیمن‌های استقرار",
    ...
    "Download and enable all" : "بارگیری و فعال کردن همه",
    ...
    "Could not load app discover section" : "بارگذاری بخش کاوش کاره‌ها ممکن نشد",
    ...
    "Loading" : "Loading",
    "Fetching the latest news…" : "در حال دریافت تازه‌ترین اخبار…",
    "Carousel" : "نمایش چرخشی",
    "Previous slide" : "اسلاید قبلی",
    "Next slide" : "اسلاید بعدی",
    "Choose slide to display" : "اسلاید موردنظر برای نمایش را انتخاب کنید",
    "{index} of {total}" : "{index} از {total}",
    "Daemon" : "فرایندهای پس زمینه",
    "Deploy Daemon" : "دیمن استقرار",
    "Type" : "نوع",
    "Display Name" : "نام نمایشی",
    "GPUs support" : "پشتیبانی از پردازنده‌های گرافیکی (GPU)",
    ...
    "Configured ExApp deploy options. Can be set only during installation" : "گزینه‌های استقرار پیکربندی‌شده‌ی ExApp. تنها در هنگام نصب قابل تنظیم است",
    ...
    "Must exist on the Deploy daemon host prior to installing the ExApp" : "باید پیش از نصب ExApp روی میزبان دیمن استقرار وجود داشته باشد",
    "Host path" : "مسیر میزبان",
    "Container path" : "مسیر کانتینر",
    "Read-only" : "فقط‌خواندنی",
    "Remove mount" : "حذف نقطه نصب",
    "New mount" : "نقطه نصب جدید",
    ...
    "Confirm adding new mount" : "تأیید افزودن نقطه نصب جدید",
    "Cancel adding mount" : "لغو افزودن نقطه نصب",
    "Add mount" : "افزودن نقطه نصب",
    "ExApp container mounts" : "نقطه‌های نصب کانتینر ExApp",
    "No mounts defined" : "هیچ نقطه نصبی تعریف نشده است",
    "Description" : "شرح",
    "View in store" : "نمایش در فروشگاه",
    "Visit website" : "سر زدن به پایگاه وب",
    "Usage documentation" : "مستندات کاربری",
    ...
    "Version {version}, {license}-licensed" : "نسخه {version}، با مجوز {license}",
    ...
    "Office suite switching is managed through the Nextcloud All-in-One interface." : "جابجایی مجموعه‌ی اداری از طریق رابط Nextcloud All-in-One مدیریت می‌شود.",
    "Please use the AIO interface to switch between office suites." : "لطفاً برای جابجایی میان مجموعه‌های اداری از رابط AIO استفاده کنید.",
    ...
    "Best Microsoft compatibility" : "بهترین سازگاری با Microsoft",
    "{progress}% Deploying …" : "{progress}% Deploying …",
    "{progress}% Initializing …" : "{progress}% Initializing …"
},
