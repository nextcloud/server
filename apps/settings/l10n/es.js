OC.L10N.register(
    ...
    "Restrict account name autocompletion to users based on phone number integration" : "Restringir el auto-completado del nombre de cuenta a los usuarios basándose en la integración del número de teléfono",
    "Allow autocompletion when entering the full name or email address (ignoring missing phonebook match and being in the same group)" : "Permitir el auto-completado cuando se introduce el nombre completo o la dirección del correo electrónico (ignorando la falta de coincidencia en la agenda de teléfonos y la membresía del mismo grupo)",
