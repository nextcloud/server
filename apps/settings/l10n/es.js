OC.L10N.register(
    ...
    "_You revoked %n other session_::_You revoked %n other sessions_" : ["Has cerrado %n sesión","Has cerrado otras %n sesiones","Has cerrado otras %n sesiones"],
    ...
    "Calendar" : "Calendario",
    "Language & locale" : "Idioma y lugar",
    "Profile & contact" : "Perfil y contacto",
    ...
    "Sanitize and merge duplicate system tags available" : "Se puede sanear y combinar las etiquetas duplicadas del sistema",
    "One or more system tags need to be sanitized or merged. This can take a long time on larger instances so this is not done automatically during upgrades. Use the command `occ maintenance:repair --include-expensive` to perform the migrations." : "Es necesario sanear o combianr una o más etiquetas del sistema. Esto puede llevar mucho tiempo en instancias grandes, por lo que no se realiza automáticamente durante las actualizaciones. Utilice el comando `occ maintenance:repair --include-expensive` para realizar las migraciones.",
    ...
    "\"%d\" is not a valid server identifier. It must be between 0 and 511." : "\"%d\" no es un identificador de servidor válido. Debe estar comprendido entre 0 y 511.",
    ...
    "MariaDB version 10.6 detected, this version is end-of-life and only supported as part of Ubuntu 22.04. MariaDB >=%1$s and <=%2$s is suggested for best performance, stability and functionality with this version of Nextcloud." : "Se detectó la versión 10.6 de MariaDB, esta versión ya está en fase \"fin de vida\" y sólo está soportada por  Ubuntu 20.04. Se sugiere utilizar MariaDB >=%1$s y <=%2$s para un mejor rendimiento, estabilidad y funcionalidad con esta versión de Nextcloud.",
    ...
    "64-bit" : "64-bits",
    "It seems like you are running a 32-bit PHP version. Nextcloud needs 64-bit to run well. Please upgrade your OS and PHP to 64-bit! We will no longer block improvements to performance, security and scalability that are incompatible with 32bit support going forward and we expect that Nextcloud Hub 27 Winter (Nextcloud 36) will no longer work on 32bit systems." : "Parece que estás ejecutando una versión PHP de 32 bits. Nextcloud requiere de 64 bits para funcionar bien. ¡Actualice su sistema operativo y PHP a 64 bits! Ya no bloquearemos las mejoras de rendimiento, seguridad y escalabilidad que sean incompatibles con el soporte de 32 bits en el futuro y creemos que Nextcloud Hub 27 Winter (Nextcloud 36) ya no será compatible con sistemas de 32 bits.",
    ...
    "_No scheduled tasks in the last %n day._::_No scheduled tasks in the last %n days._" : ["No hay tareas programadas en el último %n día.","No hay tareas programadas en los últimos %n días.","No hay tareas programadas en los últimos %n días."],
    "_Most tasks were successful in the last %n day._::_Most tasks were successful in the last %n days._" : ["La mayoría de las tareas se realizaron con éxito en el último %n día.","La mayoría de las tareas se realizaron con éxito en los últimos %n días.","La mayoría de las tareas se realizaron con éxito en los últimos %n días."],
    ...
    "Hide legacy provider settings" : "Ocultar la configuración del proveedor anterior",
    "Show legacy provider settings" : "Mostrar configuración del proveedor antiguo",
    "Machine translation (Legacy)" : "Traducción automática (antiguo)",
    ...
    "This API is deprecated. Install apps that provide Unified task processing to get the best experience." : "Esta API está obsoleta. Instale aplicaciones que ofrezcan procesamiento unificado de tareas para obtener la mejor experiencia.",
    "Learn more about AI providers" : "Obtenga más información sobre proveedores de IA.",
    "Image generation (Legacy)" : "Generación de imágenes (antiguo)",
    ...
    "Text processing (Legacy)" : "Procesamiento de texto (antiguo)",
    ...
    "Exclude some groups (block list)" : "Excluir algunos grupos (lista de bloqueados)",
    "Allow some groups only (allow list)" : "Permitir solo a determinados grupos (lista de autorizados)",
    ...
    "Only members of at least one of these groups will be able to initiate shares." : "Solo los miembros de al menos uno de estos grupos podrán iniciar enlaces compartidos.",
    "Others will be blocked, but are still able to receive shares." : "A los otros se les bloqueará, pero podrán seguir recibiendo enlaces compartidos.",
    "A member of at least one of these groups will not be able to initiate new shares, but will still be able to receive shares." : "Un miembro de al menos uno de estos grupos no podrá crear nuevos enlaces compartidos, pero sí podrá recibirlos.",
    ...
    "Actions" : "Acciones",
    "Revoke all others" : "Revocar todas las otras",
    "Revoke all other sessions?" : "¿Revocar todas las otras sesiones?",
    "Sync clients and connected services have to sign in again. This cannot be undone." : "Los clientes sincronizados y los servicios conectados tendrán que volver a iniciar sesión. Esta acción no se puede deshacer.",
    ...
    "Revoke all other sessions" : "Revocar todas las otras sesiones",
    "Signs out every device and app except this one." : "Cerrar la sesión de todos los dispositivos y aplicaciones, excepto esta.",
    ...
    "Unable to update profile picker setting" : "No se puede actualizar la configuración del selector de perfiles",
    "Profile" : "Perfil",
    ...
    "Enable the profile picker" : "Activar el selector de perfiles",
    "Enable or disable the profile picker in the Smart Picker and the profile link previews." : "Activa o desactiva el selector de perfiles en el Smart Picker y en las vistas previas de los enlaces de perfiles.",
    ...
    "Primary email address" : "Dirección email principal",
    "Additional email address {index}" : "Direcciones de correo electrónico adicionales {index}",
    "{label} (confirmation sent)" : "{label} (confirmación enviada)",
    ...
    "Nextcloud profile" : "Perfil de Nextcloud",
    ...
    "Change visibility and scope of {property}" : "Cambiar la visibilidad y alcance de {property}",
    "Unable to update visibility of {property}" : "No se puede cambiar la visibilidad de {property}",
    "Unable to update scope of {property}" : "No se puede cambiar el alcance de {property}",
    "Visibility & Scope" : "Visibilidad y Alcance",
    ...
    "Failed to update account" : "Fallo al actualizar la cuenta",
    ...
    "Only letters, numbers, spaces, and _.@-' are allowed" : "Solo se permiten letras, números, espacios y los caracteres _.@-'",
    ...
    "Search" : "Buscar",
    "Focus search" : "Búsqueda avanzada",
    "Help" : "Ayuda",
    ...
    "Transport encryption" : "Cifrado del transporte",
    ...
    "Contact" : "Contacto",
    "Notifications and password reset requests will be sent to your primary email" : "Las notificaciones y solicitudes de restablecer la contraseña se enviarán a su correo electrónico principal",
    ...
    "Search accounts and groups…" : "Buscar cuentas y grupos…",
    ...
    "_Revoked %n other session_::_Revoked %n other sessions_" : ["Se han cerrado otra %n sesión","Se han cerrado otras %n sesiones","Se han cerrado otras %n sesiones"],
    "Could not revoke the other sessions" : "No se han podido revocar las demás sesiones",
    ...
    "Select your preferred office suite. Please note that installing requires manual server setup." : "Selecciona tu paquete ofimático preferido. Ten en cuenta que la instalación requiere una configuración manual del servidor.",
    "installed" : "Instalado",
    "Disable office suites" : "Desactivar las suites ofimáticas",
    "All office suites disabled" : "Todas las suites ofimáticas desactivadas",
