OC.L10N.register(
    ...
    "Please provide an admin recovery password; otherwise, all account data will be lost." : "Forneça uma senha de recuperação de administrador; caso contrário, todos os dados da conta serão perdidos.",
    ...
    "Backend does not support password change, but the encryption of the account key was updated." : "O backend não suporta alteração de senha, mas a criptografia da chave da conta foi atualizada.",
    ...
    "Debug mode" : "Adicione a data de upload ao caminho da pasta",
    ...
    "Your \"trusted_proxies\" setting is not correctly set, it should be an array of IP addresses - optionally with range in CIDR notation." : "Sua configuração \"trusted_proxies\" não está definida corretamente; deve ser uma matriz de endereços IP - opcionalmente com intervalo na notação CIDR.",
    ...
    "- The `%1$s` HTTP header is not set to `%2$s`. Some features might not work correctly, as it is recommended to adjust this setting accordingly." : "- O cabeçalho HTTP `%1$s` não está definido como `%2$s`. Alguns recursos podem não funcionar corretamente, pois é recomendado ajustar essa configuração adequadamente.",
    "- The `%1$s` HTTP header is not set to `%2$s`. This is a potential security or privacy risk, as it is recommended to adjust this setting accordingly." : "- O cabeçalho HTTP `%1$s` não está definido como `%2$s`. Este é um risco potencial de segurança ou privacidade, pois é recomendado ajustar esta configuração de acordo.",
    "- The `%1$s` HTTP header does not contain `%2$s`. This is a potential security or privacy risk, as it is recommended to adjust this setting accordingly." : "- O cabeçalho HTTP `%1$s` não contém `%2$s`. Este é um risco potencial de segurança ou privacidade, pois é recomendado ajustar esta configuração de acordo.",
    ...
    "- The `Strict-Transport-Security` HTTP header is malformed: `%s`. For enhanced security, it is recommended to enable HSTS." : "- O cabeçalho HTTP `Strict-Transport-Security` está malformado: `%s`. Para maior segurança, é recomendado ativar o HSTS.",
    "- The `Strict-Transport-Security` HTTP header is not set (should be at least `%d` seconds). For enhanced security, it is recommended to enable HSTS." : "- O cabeçalho HTTP `Strict-Transport-Security` não está definido (deve ter pelo menos `%d` segundos). Para maior segurança, é recomendado ativar o HSTS.",
    ...
    "Font file loading" : "Carregando arquivo de fonte",
    "Could not check for {extension} loading support. Please check manually if your webserver serves `.{extension}` files." : "Não foi possível verificar o suporte de carregamento de {extension}. Verifique manualmente se seu servidor web atende arquivos `.{extension}`.",
    ...
    "Ignore the following groups when checking group membership" : "Ignore os seguintes grupos ao verificar a associação ao grupo",
    ...
    "Restrict account name autocompletion and system address book access to users within the same groups" : "Restringir o preenchimento automático de nome de conta e o acesso ao catálogo de endereços do sistema para usuários dentro dos mesmos grupos",
    "Restrict account name autocompletion to users based on phone number integration" : "Restringir o preenchimento automático do nome da conta para usuários com base na integração do número de telefone",
    ...
    "Show disclaimer text on the public link upload page (only shown when the file list is hidden)" : "Exibir o texto de aviso na página de upload do link público (somente mostrado quando a lista de arquivos está oculta).",
    ...
    "List of groups. This list is not fully populated for performance reasons. The groups will be loaded as you navigate or search through the list." : "Lista de grupos. Essa lista não está totalmente preenchida por motivos de desempenho. Os grupos serão carregados à medida que você navegar ou pesquisar na lista.",
    ...
    "Choose slide to display" : "Escolha o slide a ser exibido",
    ...
    "AJAX" : "AJAX",
    "Execute one task with each page loaded. Use case: Single account instance." : "Execute uma tarefa com cada página carregada. Caso de uso: instância de conta única.",
    "Webcron" : "Webcron",
    ...
    "Profile" : "Perfil",
    "Enable or disable profile by default for new accounts." : "Habilite ou desabilite o perfil por padrão para novas contas.",
    ...
    "Failed to update line manager" : "Falha ao atualizar o gerente de linha",
    ...
    "Sorting only applies to the currently loaded groups for performance reasons. Groups will be loaded as you navigate or search through the list." : "Por motivos de desempenho, a classificação só se aplica aos grupos carregados no momento. Os grupos serão carregados à medida que você navegar ou pesquisar na lista.",
    ...
    "Forum" : "Fórum",
    "Nextcloud help & privacy resources" : "Ajuda do Nextcloud & recursos de privacidade",
    ...
    "Logged in account must be a subadmin" : "A conta conectada deve ser um subadmin.",
    ...
    "for WebAuthn passwordless login" : "para login sem senha do WebAuthn",
    "for WebAuthn passwordless login, and SFTP storage" : "para login sem senha WebAuthn e armazenamento SFTP",
