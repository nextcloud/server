OC.L10N.register(
    ...
    "_You revoked %n other session_::_You revoked %n other sessions_" : ["Você revogou %n outra sessão","Você revogou %n de outras sessões","Você revogou %n outras sessões"],
    ...
    "Calendar" : "Calendário",
    "Language & locale" : "Idioma e locale",
    "Profile & contact" : "Perfil e contato",
    ...
    "Sanitize and merge duplicate system tags available" : "Limpar e mesclar as etiquetas duplicadas do sistema disponíveis",
    "One or more system tags need to be sanitized or merged. This can take a long time on larger instances so this is not done automatically during upgrades. Use the command `occ maintenance:repair --include-expensive` to perform the migrations." : "É necessário sanitizar ou mesclar uma ou mais etiquetas do sistema. Como isso pode demorar bastante em instâncias maiores, essa operação não é realizada automaticamente durante as atualizações. Use o comando `occ maintenance:repair --include-expensive` para realizar as migrações.",
    ...
    "\"%d\" is not a valid server identifier. It must be between 0 and 511." : "\"%d\" não é um identificador do servidor válido. Ele deve ser entre 0 e 511.",
    ...
    "MariaDB version 10.6 detected, this version is end-of-life and only supported as part of Ubuntu 22.04. MariaDB >=%1$s and <=%2$s is suggested for best performance, stability and functionality with this version of Nextcloud." : "Foi detectada a versão 10.6 do MariaDB. Essa versão está no fim do ciclo de vida e só é suportada como parte do Ubuntu 22.04. Recomenda-se usar versões do MariaDB >=%1$s e <=%2$s para obter melhor desempenho, estabilidade e funcionalidade com esta versão do Nextcloud.",
    ...
    "64-bit" : "64-bit",
    "It seems like you are running a 32-bit PHP version. Nextcloud needs 64-bit to run well. Please upgrade your OS and PHP to 64-bit! We will no longer block improvements to performance, security and scalability that are incompatible with 32bit support going forward and we expect that Nextcloud Hub 27 Winter (Nextcloud 36) will no longer work on 32bit systems." : "Parece que você está executando uma versão de 32 bits do PHP. O Nextcloud precisa da versão de 64 bits para funcionar corretamente. Atualize seu sistema operacional e o PHP para a versão de 64 bits! Daqui em diante, não bloquearemos mais melhorias de desempenho, segurança e escalabilidade que sejam incompatíveis com o suporte a 32 bits, e esperamos que o Nextcloud Hub 27 Winter (Nextcloud 36) não funcione mais em sistemas de 32 bits.",
    ...
    "Task Processing success rate" : "Taxa de sucesso no processamento de tarefas",
    ...
    "Allow AI usage for guest users" : "Permitir o uso de IA para usuários visitantes",
    ...
    "Exclude some groups (block list)" : "Excluir alguns grupos (lista de bloqueio)",
    "Allow some groups only (allow list)" : "Permitir apenas alguns grupos (lista de permissões)",
    ...
    "Only members of at least one of these groups will be able to initiate shares." : "Somente membros de pelo menos um desses grupos poderão iniciar compartilhamentos.",
    "Others will be blocked, but are still able to receive shares." : "Outros serão bloqueados, mas ainda poderão receber compartilhamentos.",
    "A member of at least one of these groups will not be able to initiate new shares, but will still be able to receive shares." : "Um membro de pelo menos um desses grupos não poderá criar novos compartilhamentos, mas ainda poderá recebê-los.",
    ...
    "Actions" : "Ações",
    "Revoke all others" : "Revogar todas as outras",
    "Revoke all other sessions?" : "Revogar todas as outras sessões?",
    "Sync clients and connected services have to sign in again. This cannot be undone." : "Os clientes de sincronização e os serviços conectados precisam fazer login novamente. Essa ação não pode ser revertida.",
    ...
    "Revoke all other sessions" : "Revogar todas as outras sessões",
    "Signs out every device and app except this one." : "Desconecta todos os dispositivos e aplicativos, exceto este.",
    ...
    "{label} (confirmation sent)" : "{label} (confirmação enviada)",
    ...
    "Nextcloud profile" : "Perfil do Nextcloud",
    "View full profile" : "Exibir perfil completo",
    "she/her" : "ela/dela",
    "he/him" : "ele/dele",
    ...
    "Change visibility and scope of {property}" : "Alterar visibilidade e escopo de {property}",
    "Unable to update visibility of {property}" : "Não é possível atualizar a visibilidade de {property}",
    "Unable to update scope of {property}" : "Não é possível atualizar o escopo de {property}",
    "Visibility & Scope" : "Visibilidade e escopo",
    ...
    "Contact" : "Contato",
    "Notifications and password reset requests will be sent to your primary email" : "As notificações e os pedidos de redefinição de senha serão enviados para o seu e-mail principal",
    ...
    "Local" : "Local",
    "Only visible to people on this instance and guests" : "Visível apenas por pessoas desta instância ou visitantes",
    "Federated" : "Federado",
    ...
    "_Revoked %n other session_::_Revoked %n other sessions_" : ["%n outra sessão revogada","%n de outras sessões revogadas","%n outras sessões revogadas"],
    "Could not revoke the other sessions" : "Não foi possível revogar as outras sessões",
    ...
    "All office suites disabled" : "Todas as suítes de escritório desativadas",
