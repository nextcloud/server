OC.L10N.register(
    ...
    "You are accessing your instance over a secure connection, however your instance is generating insecure URLs. This most likely means that you are behind a reverse proxy and the overwrite config variables are not set correctly." : "Você está acessando sua instância por meio de uma conexão segura, mas sua instância está gerando URLs inseguros. Isso provavelmente significa que você está atrás de um proxy reverso e as variáveis ​​de configuração de substituição não estão definidas corretamente.",
    ...
    "Memcache" : "Memcache",
    "Memcached is configured as distributed cache, but the wrong PHP module \"memcache\" is installed. \\OC\\Memcache\\Memcached only supports \"memcached\" and not \"memcache\"." : "O Memcached está configurado como cache distribuído, mas o módulo PHP \"memcache\" errado está instalado. \\OC\\Memcache\\Memcached suporta apenas \"memcached\" e não \"memcache\".",
    "Memcached is configured as distributed cache, but the PHP module \"memcached\" is not installed." : "O Memcached está configurado como cache distribuído, mas o módulo PHP \"memcached\" não está instalado.",
