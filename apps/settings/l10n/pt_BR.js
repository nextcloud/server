OC.L10N.register(
    ...
    "Disable to require your login or email during login." : "Desative para exigir login ou e-mail durante o acesso.",
    "Login or email not required for login, device PIN only." : "Login ou e-mail não são necessários para entrar, apenas o PIN do dispositivo.",
    "Add device" : "Adicionar dispositivo",
    "Server error while trying to complete device registration" : "Erro do servidor ao tentar concluir o registro do dispositivo",
    "Please authorize your device." : "Autorize seu dispositivo."
},
