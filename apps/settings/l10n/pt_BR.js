OC.L10N.register(
    ...
    "Others will be blocked, but are still able to receive shares." : "Outros serão bloqueados, mas ainda poderão receber ações.",
    "A member of at least one of these groups will not be able to initiate new shares, but will still be able to receive shares." : "Um membro de pelo menos um desses grupos não poderá criar novas ações, mas ainda poderá recebê-las.",
