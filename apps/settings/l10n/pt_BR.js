OC.L10N.register(
    ...
    "- The `%1$s` HTTP header is not set to `%2$s`, `%3$s`, `%4$s`, `%5$s` or `%6$s`. This can leak referer information. See the {w3c-recommendation}." : "- O cabeçalho HTTP `%1$s` não está definido como `%2$s`, `%3$s`, `%4$s`, `%5$s` ou `%6$s`. Isso pode vazar informações do referenciador. Consulte a {recomendação w3c}.",
    ...
    "he/him" : "ele/ele",
    "they/them" : "eles/eles",
    "Your pronouns. E.g. ${pronounsExample}" : "Seus pronomes. Por exemplo ${pronounsExample}",
    "Your role" : "Seu papel",
