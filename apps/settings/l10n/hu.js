OC.L10N.register(
    ...
    "Allow username autocompletion in share dialog (if this is disabled the full username or email address needs to be entered)" : "Felhasználónevek automatikus kiegészítésének engedélyezése a megosztási párbeszédablakban (ha ki van kapcsolva, akkor teljes felhasználóneveket vagy e-mail-címeket kell begépelni)",
    "Restrict username autocompletion to users within the same groups" : "A felhasználónevek automata kiegészítésének letiltása az ugyanazon csoportokba tartozó felhasználóknál",
