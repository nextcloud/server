OC.L10N.register(
    ...
    "JavaScript source map support" : "JavaScript forrástérkép támogatás",
    ...
    "Mimetype migrations available" : "A Mimetype migráció elérhető",
    ...
    "Quota" : "Kvóta",
    "Set account quota" : "Válassza ki a felhasználói kvótát",
    "Language" : "Nyelv",
    ...
    "Disable account" : "Felhasználó tiltása",
    "Enable account" : "Felhasználó engedélyezése",
    ...
    "Show account backend" : "Fiók háttérrendszerének mutatása",
    ...
    "Send welcome email to new accounts" : "Üdvözlő email küldése az új felhasználóknak",
    ...
    "App Store" : "Alkalmazás bolt",
    "Loading app list" : "Alkalmazáslista betöltése",
    "Loading categories" : "Kategóriák betöltése",
    "Developer documentation ↗" : "Fejlesztői dokumentáció",
    "Version {version}, {license}-licensed" : "Verzió {version},{license} - licenszelt",
    "All accounts" : "Összes felhasználó",
    "Admins" : "Rendszergazdák",
    "Account group: {group}" : "Felhasználó csoport: {group}",
    "Failed to create group" : "A csoport létrehozása sikertelen",
    "Account management" : "Felhasználó kezelés",
    "Creating group…" : "Csoport készítése...",
