OC.L10N.register(
    ...
    "A login attempt using two-factor authentication failed (%1$s)" : "Un intento de inicio de sesión usando autenticación de dos factores falló (%1$s)",
    ...
    "The database is missing some optional columns. Due to the fact that adding columns on big tables could take some time they were not added automatically when they can be optional. By running \"occ db:add-missing-columns\" those missing columns could be added manually while the instance keeps running. Once the columns are added some features might improve responsiveness or usability." : "A la base de datos le faltan algunas columnas opcionales. Dado que añadir columnas en tablas grandes puede llevar bastante tiempo, no se agregaron automáticamente. Ejecutando manualmente \"occ db:add-missing-columns\" se pueden agregar las columnas faltantes mientras la instancia sigue corriendo. Una vez agregadas las columnas, algunas características podrían mejorar su capacidad de respuesta o la usabilidad.",
    ...
    "The database is missing some primary keys. Due to the fact that adding primary keys on big tables could take some time they were not added automatically. By running \"occ db:add-missing-primary-keys\" those missing primary keys could be added manually while the instance keeps running." : "A la base de datos le faltan algunas claves primarias. Dado que añadir claves primarias en tablas grandes puede llevar bastante tiempo, no se agregaron automáticamente. Ejecutando manualmente \"occ db:add-missing-primary-keys\" esas claves primarias faltantes se pueden agregar mientras la instancia sigue funcionando.",
