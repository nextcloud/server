OC.L10N.register(
    ...
    "Disable to require your login or email during login." : "Schakel uit om bij het aanmelden gebruikersnaam of e-mail te vereisen.",
    "Login or email not required for login, device PIN only." : "Gebruikersnaam of e-mail is niet nodig om aan te melden, alleen de pincode van het apparaat.",
    "Add device" : "Apparaat toevoegen",
    "Server error while trying to complete device registration" : "Serverfout bij het voltooien van de apparaatregistratie",
    "Please authorize your device." : "Autoriseer uw apparaat."
},
