OC.L10N.register(
    ...
    "Your email address on %s was changed." : "Je e-mailadres op %s is gewijzigd.",
    ...
    "Your \"trusted_proxies\" setting is not correctly set, it should be an array." : "Je instelling voor “trusted_proxies” is niet correct ingesteld; het moet een array zijn.",
    "Your \"trusted_proxies\" setting is not correctly set, it should be an array of IP addresses - optionally with range in CIDR notation." : "Je instelling voor \"trusted_proxies\" is niet correct ingesteld; dit moet een array zijn met IP-adressen, eventueel aangevuld met een bereik in CIDR-notatie.",
    "The reverse proxy header configuration is incorrect. This is a security issue and can allow an attacker to spoof their IP address as visible to the Nextcloud." : "De reverse proxy header-configuratie is incorrect. Dit is een beveiligingsrisico en geeft aanvallers de mogelijkheid hun ip-adres te spoofen zoals deze zichtbaar is voor Nextcloud.",
    ...
    "Old server-side-encryption" : "Oude server-side-encryptie",
    ...
    "Configured ExApp deploy options. Can be set only during installation" : "ExApp-implementatieopties geconfigureerd. Kan alleen tijdens de installatie worden ingesteld",
    ...
    "Cancel adding mount" : "Het toevoegen van een koppeling annuleren",
