OC.L10N.register(
    ...
    "Only applies when authentication is required" : "Примењује се само када је потребна аутентификација",
    ...
    "An administrator created app password \"{token}\"" : "Администратор је креирао лозинку апликације „{token}",
    ...
    "Could not determine if TLS version of cURL is outdated or not because an error happened during the HTTPS request against https://nextcloud.com. Please check the nextcloud log file for more details." : "Не може да се одреди да ли је TLS верзија програма cURL застарела јер је дошло до грешке током HTTPS захтева серверу https://nextcloud.com. За више детаља, молимо вас погледајте  nextcloud фајл дневника.",
    "The maximum number of OPcache keys is nearly exceeded. To assure that all scripts can be hold in cache, it is recommended to apply <code>opcache.max_accelerated_files</code> to your PHP configuration with a value higher than <code>%s</code>." : "Максимални број OPcache кључева је скоро прекорачен. Да би се обезбедило да се све скрипте држе у кешу, препоручује се да у вашој PHP конфигурацији поставите <code>opcache.max_accelerated_files</code> на вредност већу од <code>%s</code>.",
    "Admin privileges" : "Админ привилегије",
    "Unable to update biography" : "Биографија није могла да се ажурира",
    "Unable to update full name" : "Пуно име није могло да се ажурира",
    "No full name set" : "Није постављено пуно име",
    "Unable to update headline" : "Насловна линија није могла да се ажурира",
    "Unable to update organisation" : "Организација није могла да се ажурира",
    "Unable to update role" : "Улога није могла да се ажурира",
    "Change scope level of {accountProperty}" : "Измена нивоа опсега важења за {accountProperty}",
    "Unable to update federation scope of the primary {accountProperty}" : "Није успело ажурирање опсега важења федерације примарног {accountProperty}",
    "Unable to update federation scope of additional {accountProperty}" : "Није успело ажурирање опсега важења федерације додатног {accountProperty}",
    ...
    "For the server to work properly, it's important to configure background jobs correctly. \"Cron\" is the recommended setting. Please see the documentation for more information." : "Да би сервер радио исправно, важно је да се позадински послови исправно подесе. „Cron” је препоручено подешавање. За више информација, молимо вас да погледате документацију.",
    ...
    "Please note that it can take up to 24 hours for the avatar to get updated everywhere." : "Молимо вас да имате на уму да може проћи до 24 часа пре него што се аватар ажурира на свим местима.",
    ...
    "Change privacy level of phone number" : "Измена нивоа приватности телефонског броја",
    "Change privacy level of address" : "Измена нивоа приватности адресе",
    "Your postal address" : "Ваша адреса становања",
    "Change privacy level of website" : "Измена нивоа приватности веб сајта",
