OC.L10N.register(
    ...
    "for Argon2 for password hashing and Ed25519 signature verification for RFC 9421 http message signatures" : "dla Argon2 do hashowania hasła oraz weryfikacji podpisu Ed25519 dla sygnatur wiadomości RFC 9421",
    ...
    "Sanitize and merge duplicate system tags available" : "Wydziel i połącz dostępne zduplikowane tagi systemowe",
    "One or more system tags need to be sanitized or merged. This can take a long time on larger instances so this is not done automatically during upgrades. Use the command `occ maintenance:repair --include-expensive` to perform the migrations." : "Co najmniej jeden z tagów systemowych powinien zostaw wydzielony lub połączony. To może potrwać dłuższej w większych instancjach i dlatego nie jest robione automatycznie przy aktualizacjach. Użyj `occ maintenance:repair --include-expensive` aby przeprowadzić migrację.",
    ...
    "MariaDB version 10.6 detected, this version is end-of-life and only supported as part of Ubuntu 22.04. MariaDB >=%1$s and <=%2$s is suggested for best performance, stability and functionality with this version of Nextcloud." : "Wykryto MariaDB w wersji 10.3, ta wersja jest nieobsługiwana i wspierana jedynie w ramach Ubuntu 20.04. Zalecana jest MariaDB >=%1$s i <= %2$s dla najlepszej wydajności, stabilności i kompatybilności z tą wersją Nextcloud.",
    ...
    "_No scheduled tasks in the last %n day._::_No scheduled tasks in the last %n days._" : ["Brak zaplanowanych zadań w ciągu ostatniego dnia.","Brak zaplanowanych zadań w ostatnich %n dniach.","Brak zaplanowanych zadań w ostatnich %n dniach.","Brak zaplanowanych zadań w ciągu ostatnich %n dni."],
    "_Most tasks were successful in the last %n day._::_Most tasks were successful in the last %n days._" : ["Większość zadań zakończyła się sukcesem w ciągu ostatniego dnia.","Większość zadań zakończyła się sukcesem w ciągu ostatnich %n dni.","Większość zadań zakończyła się sukcesem w ciągu ostatnich %n dni.","Większość zadań zakończyła się sukcesem w ciągu ostatnich %n dni."],
    ...
    "_The Task Processing worker has run in the last %n minute._::_The Task Processing worker has run in the last %n minutes._" : ["Wątek przetwarzania zadań był aktywny w ciągu ostatniej minuty.","Wątek przetwarzania zadań był aktywny w ciągu ostatnich %n minut.","Wątek przetwarzania zadań był aktywny w ciągu ostatnich %n minut.","Wątek przetwarzania zadań był aktywny w ciągu ostatnich %n minut."],
    ...
    "Hide legacy provider settings" : "Ukryj ustawienia starszego dostawcy",
    "Show legacy provider settings" : "Pokaż ustawienia starszego dostawcy",
    "Machine translation (Legacy)" : "Tłumaczenie maszynowe (starsze)",
    ...
    "This API is deprecated. Install apps that provide Unified task processing to get the best experience." : "To API jest przestarzałe. Instaluj aplikacje, które wspierają przetwarzanie zadań typu Unified w celu osiągnięcia najlepszego doświadczenia.",
    "Learn more about AI providers" : "Dowiedz się więcej o dostawcach usług AI",
    "Image generation (Legacy)" : "Generowanie obrazu (starsze)",
    ...
    "Text processing (Legacy)" : "Przetwarzanie tekstu (starsze)",
    ...
    "Adding new account …" : "Dodawanie nowego konta …",
