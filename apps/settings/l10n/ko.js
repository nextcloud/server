OC.L10N.register(
    ...
    "Logged in account must be a sub admin" : "로그인한 계정은 부관리자여야 합니다.",
    "Personal" : "개인",
    "Administration" : "관리",
    "Users" : "사용자",
    ...
    "Database missing indices" : "데이터베이스 색인 누락",
    ...
    "Missing primary key on table \"%s\"." : "표 \"%s\"의 기본 키가 사라졌습니다",
    ...
    "It is important for the security and performance of your instance that everything is configured correctly. To help you with that we are doing some automatic checks. Please see the linked documentation for more information." : "인스턴스를 올바르게 설정하면 보안 및 성능을 향상시킬 수 있습니다. 설정을 돕기 위해 일부 항목을 자동으로 확인합니다. 더 자세한 정보는 링크된 문서를 참조하십시오.",
    "Try again" : "다시 시도",
