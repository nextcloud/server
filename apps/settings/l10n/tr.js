OC.L10N.register(
    ...
    "_You revoked %n other session_::_You revoked %n other sessions_" : ["%n diğer oturumu kapattınız","%n diğer oturumu kapattınız"],
    ...
    "Calendar" : "Takvim",
    "Language & locale" : "Dil ve yerel ayar",
    "Profile & contact" : "Profil ve iletişim",
    ...
    "Sanitize and merge duplicate system tags available" : "Kullanılabilen çift sistem etiketlerini yalıt ve birleştir",
    "One or more system tags need to be sanitized or merged. This can take a long time on larger instances so this is not done automatically during upgrades. Use the command `occ maintenance:repair --include-expensive` to perform the migrations." : "Bir ya da birkaç sistem etiketinin temizlenmesi veya birleştirilmesi gerekiyor. Bu işlem, büyük kopyalarda uzun zaman alabilir. Bu nedenle yükseltme işlemleri sırasında otomatik olarak yapılmaz. Aktarımları yapmak için `occ maintenance:repair --include-expensive` komutunu kullanın.",
    ...
    "\"%d\" is not a valid server identifier. It must be between 0 and 511." : "\"%d\" geçerli bir sunucu kimliği değil. 0 ile 511 arasında bir değer olmalıdır.",
    "Server identifier is configured and valid." : "Sunucu kimliği yapılandırıldı ve geçerli.",
    "Database version" : "Veri tabanı sürümü",
    "MariaDB version 10.6 detected, this version is end-of-life and only supported as part of Ubuntu 22.04. MariaDB >=%1$s and <=%2$s is suggested for best performance, stability and functionality with this version of Nextcloud." : "MariaDB 10.6 sürümü bulundu. Bu sürüm ömrünün sonuna geldi ve yalnızca Ubuntu 22.04 sürümünün bir parçası. Bu Nextcloud sürümüyle en iyi başarım, kararlılık ve işlevsellik sağlamak için MariaDB sürümünün %1$s ile %2$s arasında olması önerilir.",
    ...
    "Architecture" : "Mimari",
    "64-bit" : "64-bit",
    "It seems like you are running a 32-bit PHP version. Nextcloud needs 64-bit to run well. Please upgrade your OS and PHP to 64-bit! We will no longer block improvements to performance, security and scalability that are incompatible with 32bit support going forward and we expect that Nextcloud Hub 27 Winter (Nextcloud 36) will no longer work on 32bit systems." : "32 bitlik bir PHP sürümü kullanıyorsunuz gibi görünüyor. Nextcloud uygulamasının iyi çalışması için 64 bit PHP gerekir. Lütfen işletim sisteminizi ve PHP sürümünüzü 64 bit sürümlerine yükseltin! İleriye dönük olarak 32bit desteğiyle uyumlu olmayan başarım, güvenlik ve ölçeklenebilirlik iyileştirmelerini engellemeyeceğiz ve Nextcloud Hub 27 Winter sürümünün (Nextcloud 36) 32bit sistemlerde artık çalışmamasını bekliyoruz.",
    ...
    "Task Processing success rate" : "Görev işleme başarı oranı",
    "_No scheduled tasks in the last %n day._::_No scheduled tasks in the last %n days._" : ["Son %n günde zamanlanmış bir görev yok.","Son %n günde zamanlanmış bir görev yok."],
    "_Most tasks were successful in the last %n day._::_Most tasks were successful in the last %n days._" : ["Son %n gündeki çoğu zamanlanmış görev tamamlandı.","Son %n gündeki çoğu zamanlanmış görev tamamlandı."],
    ...
    "_The Task Processing worker has run in the last %n minute._::_The Task Processing worker has run in the last %n minutes._" : ["Görev işleme işlemi %n dakika önce çalıştı.","Görev işleme işlemi %n dakika önce çalıştı."],
    ...
    "Hide legacy provider settings" : "Eski hizmet sağlayıcı ayarlarını gizle",
    "Show legacy provider settings" : "Eski hizmet sağlayıcı ayarlarını görüntüle",
    "Machine translation (Legacy)" : "Makine çevirisi (eski)",
    ...
    "This API is deprecated. Install apps that provide Unified task processing to get the best experience." : "Bu API kullanımdan kaldırılmış. En iyi deneyimi elde etmek için birleşik görev işleme sağlayan uygulamaları kurun.",
    "Learn more about AI providers" : "Yapay zeka hizmeti sağlayıcıları ile ilgili ayrıntılı bilgi alın",
    "Image generation (Legacy)" : "Görsel oluşturma (eski)",
    ...
    "Text processing (Legacy)" : "Yazı işleme (eski)",
    ...
    "Exclude some groups (block list)" : "Bazı gruplar katılmasın (engellenenler listesi)",
    "Allow some groups only (allow list)" : "Bazı gruplar katılsın (izin verilenler listesi)",
    "Groups allowed to share" : "Paylaşım yapılabilecek gruplar",
    "Groups excluded from sharing" : "Paylaşıma katılmayacak gruplar",
    "Only members of at least one of these groups will be able to initiate shares." : "Yalnızca bu gruplardan en az birinin üyesi olanlar paylaşım başlatabilir.",
    "Others will be blocked, but are still able to receive shares." : "Diğerleri engellenir, ancak yine de paylaşımları alabilirler.",
    "A member of at least one of these groups will not be able to initiate new shares, but will still be able to receive shares." : "Bu gruplardan en az birinin bir üyesi yeni paylaşımlar başlatamaz, ancak yine de paylaşımları alabilir.",
    ...
    "Actions" : "İşlemler",
    "Revoke all others" : "Tüm diğer oturumları kapat",
    "Revoke all other sessions?" : "Tüm diğer oturumlar kapatılsın mı?",
    "Sync clients and connected services have to sign in again. This cannot be undone." : "Eşitlenmiş istemciler ve bağlı hizmetlerin yeniden oturum açması gerekir. Bu işlem geri alınamaz.",
    ...
    "Revoke all other sessions" : "Tüm diğer oturumları kapat",
    "Signs out every device and app except this one." : "Bu aygıt dışında tüm aygıtlardaki ve uygulamadaki oturumları kapatır.",
    ...
    "Primary email address" : "Birincil e-posta adresi",
    "Additional email address {index}" : "{index}. ek e-posta adresi",
    "{label} (confirmation sent)" : "{label} (onay gönderildi)",
    ...
    "Nextcloud profile" : "Nextcloud profili",
    ...
    "Change visibility and scope of {property}" : "{property} görünürlüğünü ve kapsamını değiştir",
    "Unable to update visibility of {property}" : "{property} görünürlüğü güncellenemedi",
    "Unable to update scope of {property}" : "{property} kapsamı güncellenemedi",
    "Visibility & Scope" : "Görünürlük ve kapsam",
    ...
    "Manager" : "Sorumlu",
    "Search for a manager…" : "Bir yönetici ara...",
    "Quota" : "Kota",
    ...
    "Contact" : "Kişi",
    "Notifications and password reset requests will be sent to your primary email" : "Bildirimler ve parola sıfırlama istekleri birincil e-postanıza gönderilir",
    ...
    "Search accounts and groups…" : "Hesap ve grup ara...",
    ...
    "_Revoked %n other session_::_Revoked %n other sessions_" : ["%n diğer oturum kapatıldı","%n diğer oturum kapatıldı"],
    "Could not revoke the other sessions" : "Diğer oturumlar kapatılamadı",
