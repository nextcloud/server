OC.L10N.register(
    ...
    "Unlimited" : "Sınırsız",
    "Verifying" : "Doğrulanıyor",
    "Checking for old user imported certificate" : "Kullanıcının içe aktardığı eski sertifika denetleniyor",
    ...
    "Checking for default phone region" : "Varsayılan telefon bölgesi denetleniyor",
    ...
    "Checking for old server-side-encryption being disabled" : "Eski sunucu tarafı şifrelemesinin devre dışı olduğu denetleniyor",
    ...
    "Checking for PHP default charset" : "PHP varsayılan karakter kümesi denetleniyor",
    "PHP configuration option default_charset should be UTF-8" : "default_charset PHP yapılandırma seçeneği UTF-8 olmalı",
    ...
    "Checking for PHP version" : "PHP sürümü denetleniyor",
    ...
    "Checking for PHP output_buffering option" : "PHP output_buffering seçeneği denetleniyor",
    "PHP configuration option output_buffering must be disabled" : "option output_buffering PHP yapılandırma seçeneği devre dışı bırakılmalıdır",
    "Checking for configuration file access rights" : "Yapılandırma dosyasının erişim izinleri denetleniyor",
    ...
    "Checking for database version" : "Veri tabanı sürümü denetleniyor",
