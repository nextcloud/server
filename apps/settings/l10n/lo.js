OC.L10N.register(
    ...
    "_No scheduled tasks in the last day._::_No scheduled tasks in the last %n days._" : ["No scheduled tasks in the last %n days."],
    "_The task pickup speed has been ok in the last day._::_The task pickup speed has been ok in the last %n days._" : ["The task pickup speed has been ok in the last %n days."],
    "_The task pickup speed has been slow in the last day. Many tasks took longer than 4 minutes to be picked up. Consider setting up a worker to process tasks in the background._::_The task pickup speed has been slow in the last %n days. Many tasks took longer than 4 minutes to be picked up. Consider setting up a worker to process tasks in the background._" : ["The task pickup speed has been slow in the last %n days. Many tasks took longer than 4 minutes to be picked up. Consider setting up a worker to process tasks in the background."],
    "_Most tasks were successful in the last day._::_Most tasks were successful in the last %n days._" : ["Most tasks were successful in the last %n days."],
    "_A lot of tasks failed in the last day. Consider checking the nextcloud log for errors and investigating whether the AI provider apps have been set up correctly._::_A lot of tasks failed in the last %n days. Consider checking the nextcloud log for errors and investigating whether the AI provider apps have been set up correctly._" : ["A lot of tasks failed in the last %n days. Consider checking the nextcloud log for errors and investigating whether the AI provider apps have been set up correctly."],
    ...
    "The PHP function \"disk_free_space\" is disabled, which prevents the check for enough space in the temporary directories." : "The PHP function \"disk_free_space\" is disabled, which prevents the check for enough space in the temporary directories.",
    ...
    "Enforce password protection" : "ໃຊ້ລະຫັດປ້ອງກັນ",
    ...
    "_%n app has an update available_::_%n apps have an update available_" : ["%n apps have an update available"],
    "_Update_::_Update all_" : ["Update all"],
    ...
    "{productName} Android app" : " ແອັບລະບົບ Android {productName}",
    ...
    "Big organization" : "Big organization",
    ...
    "_{userCount} account …_::_{userCount} accounts …_" : ["{userCount} accounts …"],
    "_{userCount} account_::_{userCount} accounts_" : ["{userCount} accounts"],
    ...
    "_No scheduled tasks in the last %n hour._::_No scheduled tasks in the last %n hours._" : ["No scheduled tasks in the last %n hours."],
    "_The task pickup speed has been ok in the last %n hour._::_The task pickup speed has been ok in the last %n hours._" : ["The task pickup speed has been ok in the last %n hours."],
    "_The task pickup speed has been slow in the last %n hour. Many tasks took longer than 4 minutes to be picked up. Consider setting up a worker to process tasks in the background._::_The task pickup speed has been slow in the last %n hours. Many tasks took longer than 4 minutes to be picked up. Consider setting up a worker to process tasks in the background._" : ["The task pickup speed has been slow in the last %n hours. Many tasks took longer than 4 minutes to be picked up. Consider setting up a worker to process tasks in the background."],
    "Also allow autocompletion on full match of the user id" : "Also allow autocompletion on full match of the user id",
