OC.L10N.register(
    ...
    "If autocompletion \"same group\" and \"phone number integration\" are enabled a match in either is enough to show the user." : "如果启用了“同组”和“电话号码集成”的自动补全，则其中一个匹配即会向用户显示。",
    "Restrict account name autocompletion to users based on phone number integration" : "根据电话号码集成限制用户的账号名称自动补全功能",
    "Allow autocompletion when entering the full name or email address (ignoring missing phonebook match and being in the same group)" : "允许在输入全名或电子邮件地址时自动补全（忽略通讯录匹配缺失和属于同组等限制）",
