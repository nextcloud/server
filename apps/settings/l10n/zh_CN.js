OC.L10N.register(
    ...
    "You deleted app password \"{token}\" and cancelled its pending remote wipe" : "你删除了应用密码 \"{token}\" 并取消待进行的远程抹除",
    ...
    "for Argon2 for password hashing and Ed25519 signature verification for RFC 9421 http message signatures" : "对于密码哈希使用Argon2，以及用于RFC 9421 HTTP消息签名验证的Ed25519签名验证",
    ...
    "_The Task Processing worker has run in the last %n minute._::_The Task Processing worker has run in the last %n minutes._" : ["任务处理工作进程已经在最近%n几分钟内运行过。"],
    ...
    "Revoke and cancel pending wipe?" : "撤销并取消待处理的抹除？",
    "Only continue if you no longer need the device to be wiped." : "如果你不再需要抹除设备，请继续。",
    "Revoke and cancel wipe" : "撤销并取消抹除",
    "Revoke app password?" : "撤销应用密码？",
    "The app or device will lose access on its next sync. This cannot be undone." : "应用或设备将要在下一次同步中失去访问权限。该操作无法恢复。",
    "Remote wipe has not started yet." : "远程抹除暂未开始。",
    "Revoking now cancels the wipe. The device keeps its synced data." : "如果现在撤销，将不会执行抹除，设备上已同步的数据会得以保留。",
    "Device" : "设备",
    "Last activity" : "最后活跃",
    "Actions" : "操作",
