OC.L10N.register(
    ...
    "Unlimited" : "无限",
    "Verifying" : "正在验证",
    "Checking for old user imported certificate" : "正在检查老用户导入的证书",
    ...
    "Checking for default phone region" : "正在检查默认电话区域",
    ...
    "Checking for PHP output_buffering option" : "正在检查 PHP output_buffering 设置",
    "PHP configuration option output_buffering must be disabled" : "PHP 设置选项 output_buffering 必须被禁用",
    "Checking for configuration file access rights" : "正在检查配置文件访问权限",
    ...
    "Checking for database version" : "正在检查数据库版本",
