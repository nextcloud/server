OC.L10N.register(
    ...
    "Logged in account must be a sub admin" : "Inloggat konto måste vara en underadministratör",
    "Personal" : "Privat",
    ...
    "Old administration imported certificates" : "Gamla admin-importerade certifikat",
    ...
    "\"%d\" is not a valid server identifier. It must be between 0 and 511." : "\"%d\" är inte en giltigt serveridentifierare. Den måste vara mellan 0 och 511.",
    ...
    "This instance has no second factor provider available." : "Den här instansen har ingen leverantör för andra faktor tillgänglig.",
    "Second factor providers are available but two-factor authentication is not enforced." : "Leverantörer för andra faktor är tillgängliga men tvåfaktorsautentisering är inte påtvingad.",
    "Second factor providers are available and enforced: %s." : "Leverantörer för andra faktor är tillgängliga och påtvingade: %s.",
    ...
    "Big organization" : "Mellanstor organisation",
    "Small organization" : "Liten organisation",
    "Hosting company" : "Hostingleverantör",
    ...
    "Failed to update account" : "Kunde inte uppdatera kontot",
    ...
    "Not available as publishing account specific data to the lookup server is not allowed, contact your system administration if you have any questions" : "Inte tillgängligt eftersom publicering av kontospecifik data till lookup-servern inte är tillåten, kontakta din systemadministration om du har några frågor",
    "Discover" : "Upptäck",
