OC.L10N.register(
    ...
    "You deleted app password \"{token}\" and cancelled its pending remote wipe" : "You deleted app password \"{token}\" and cancelled its pending remote wipe",
    "_You revoked %n other session_::_You revoked %n other sessions_" : ["You revoked %n other session","You revoked %n other sessions"],
    ...
    "for Argon2 for password hashing and Ed25519 signature verification for RFC 9421 http message signatures" : "for Argon2 for password hashing and Ed25519 signature verification for RFC 9421 HTTP message signatures",
    ...
    "Sanitize and merge duplicate system tags available" : "Sanitise and merge duplicate system tags available",
    "One or more system tags need to be sanitized or merged. This can take a long time on larger instances so this is not done automatically during upgrades. Use the command `occ maintenance:repair --include-expensive` to perform the migrations." : "One or more system tags need to be sanitized or merged. This can take a long time on larger instances so this is not done automatically during upgrades. Use the command `occ maintenance:repair --include-expensive` to perform the migrations.",
    ...
    "\"%d\" is not a valid server identifier. It must be between 0 and 511." : "\"%d\" is not a valid server identifier. It must be between 0 and 511.",
    "Server identifier is configured and valid." : "Server identifier is configured and valid.",
    "Database version" : "Database version",
    "MariaDB version 10.6 detected, this version is end-of-life and only supported as part of Ubuntu 22.04. MariaDB >=%1$s and <=%2$s is suggested for best performance, stability and functionality with this version of Nextcloud." : "MariaDB version 10.6 detected, this version is end-of-life and only supported as part of Ubuntu 22.04. MariaDB >=%1$s and <=%2$s is suggested for best performance, stability and functionality with this version of Nextcloud.",
    ...
    "Task Processing success rate" : "Task Processing success rate",
    "_No scheduled tasks in the last %n day._::_No scheduled tasks in the last %n days._" : ["No scheduled tasks in the last %n day.","No scheduled tasks in the last %n days."],
    "_Most tasks were successful in the last %n day._::_Most tasks were successful in the last %n days._" : ["Most tasks were successful in the last %n day.","Most tasks were successful in the last %n days."],
    ...
    "Task Processing worker status" : "Task Processing worker status",
    ...
    "The Task Processing worker does not seem to be running. The last run was at %s." : "The Task Processing worker does not seem to be running. The last run was at %s.",
    "The Task Processing worker does not seem to be running. It seems it has never run so far." : "The Task Processing worker does not seem to be running. It seems it has never run so far.",
    ...
    "Hide legacy provider settings" : "Hide legacy provider settings",
    "Show legacy provider settings" : "Show legacy provider settings",
    "Machine translation (Legacy)" : "Machine translation (Legacy)",
    ...
    "This API is deprecated. Install apps that provide Unified task processing to get the best experience." : "This API is deprecated. Install apps that provide Unified task processing to get the best experience.",
    "Learn more about AI providers" : "Learn more about AI providers",
    "Image generation (Legacy)" : "Image generation (Legacy)",
    ...
    "Text processing (Legacy)" : "Text processing (Legacy)",
    ...
    "Exclude some groups (block list)" : "Exclude some groups (block list)",
    "Allow some groups only (allow list)" : "Allow some groups only (allow list)",
    "Groups allowed to share" : "Groups allowed to share",
    "Groups excluded from sharing" : "Groups excluded from sharing",
    "Only members of at least one of these groups will be able to initiate shares." : "Only members of at least one of these groups will be able to initiate shares.",
    "Others will be blocked, but are still able to receive shares." : "Others will be blocked, but are still able to receive shares.",
    "A member of at least one of these groups will not be able to initiate new shares, but will still be able to receive shares." : "A member of at least one of these groups will not be able to initiate new shares, but will still be able to receive shares.",
    ...
    "Revoke and cancel pending wipe?" : "Revoke and cancel pending wipe?",
    "Only continue if you no longer need the device to be wiped." : "Only continue if you no longer need the device to be wiped.",
    "Revoke and cancel wipe" : "Revoke and cancel wipe",
    "Revoke app password?" : "Revoke app password?",
    "The app or device will lose access on its next sync. This cannot be undone." : "The app or device will lose access on its next sync. This cannot be undone.",
    "Remote wipe has not started yet." : "Remote wipe has not started yet.",
    "Revoking now cancels the wipe. The device keeps its synced data." : "Revoking now cancels the wipe. The device keeps its synced data.",
    "Device" : "Device",
    "Last activity" : "Last activity",
    "Actions" : "Actions",
    "Revoke all others" : "Revoke all others",
    "Revoke all other sessions?" : "Revoke all other sessions?",
    "Sync clients and connected services have to sign in again. This cannot be undone." : "Sync clients and connected services have to sign in again. This cannot be undone.",
    ...
    "Revoke all other sessions" : "Revoke all other sessions",
    "Signs out every device and app except this one." : "Signs out every device and app except this one.",
    ...
    "{label} (confirmation sent)" : "{label} (confirmation sent)",
    ...
    "Nextcloud profile" : "Nextcloud profile",
    ...
    "Change visibility and scope of {property}" : "Change visibility and scope of {property}",
    "Unable to update visibility of {property}" : "Unable to update visibility of {property}",
    "Unable to update scope of {property}" : "Unable to update scope of {property}",
    ...
    "Only letters, numbers, spaces, and _.@-' are allowed" : "Only letters, numbers, spaces, and _.@-' are allowed",
    ...
    "Manager" : "Manager",
    "Search for a manager…" : "Search for a manager…",
    "Quota" : "Quota",
    ...
    "Contact" : "Contact",
    "Notifications and password reset requests will be sent to your primary email" : "Notifications and password reset requests will be sent to your primary email",
    ...
    "Search accounts and groups…" : "Search accounts and groups…",
    ...
    "_Revoked %n other session_::_Revoked %n other sessions_" : ["Revoked %n other session","Revoked %n other sessions"],
    "Could not revoke the other sessions" : "Could not revoke the other sessions",
