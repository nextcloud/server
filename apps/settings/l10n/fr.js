OC.L10N.register(
    ...
    "You need to migrate your encryption keys from the old encryption (ownCloud <= 8.0) to the new one. Please enable the \"Default encryption module\" and run {command}" : "Vous devez migrer vos clés de cryptage de l’ancien cryptage (ownCloud <= 8.0) vers le nouveau. Veuillez activer le \"module de cryptage par défaut\" et exécuter {command}",
    ...
    "Edit your Profile visibility" : "Modifier la visibilité du profil",
