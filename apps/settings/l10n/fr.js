OC.L10N.register(
    ...
    "Last background job execution ran %s." : "Dernière tâche d'arrière-plan exécutée %s",
    ...
    "You are accessing your instance over a secure connection, however your instance is generating insecure URLs. This most likely means that you are behind a reverse proxy and the overwrite config variables are not set correctly." : "Vous accédez à votre instance via une connexion sécurisée, pourtant celle-ci génère des URLs non sécurisées. Cela signifie probablement que vous êtes derrière un reverse proxy et que les variables de réécriture ne sont pas paramétrées correctement.",
    ...
    "Overwrite CLI URL" : "remplacer CLI URL",
    ...
    "Could not load section content from app store." : "Impossible de charger le contenu de la section du magasin d’applications.",
    "Loading" : "Chargement",
    ...
    "Done" : "Terminé",
    "Edit" : "Editer",
    "Account management settings" : "Paramètres de la gestion des comptes",
