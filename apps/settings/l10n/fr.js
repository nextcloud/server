OC.L10N.register(
    ...
    "Disable to require your login or email during login." : "Désactivez pour exiger votre identifiant ou e-mail lors de la connexion.",
    "Login or email not required for login, device PIN only." : "Identifiant ou e-mail non requis pour la connexion, uniquement le PIN de l’appareil.",
    "Add device" : "Ajouter un appareil",
    "Server error while trying to complete device registration" : "Erreur du serveur lors de la finalisation de l’enregistrement de l’appareil",
    "Please authorize your device." : "Veuillez autoriser votre appareil."
},
