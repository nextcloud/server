OC.L10N.register(
    ...
    "You deleted app password \"{token}\" and cancelled its pending remote wipe" : "Vous avez supprimé le mot de passe d'application \"{token}\" et annulé son effacement à distance en attenrte",
    ...
    "Sanitize and merge duplicate system tags available" : "Nettoyage et fusion des étiquettes systèmes en double disponible",
    "One or more system tags need to be sanitized or merged. This can take a long time on larger instances so this is not done automatically during upgrades. Use the command `occ maintenance:repair --include-expensive` to perform the migrations." : "Une ou plusieurs étiquettes systèmes doivent être nettoyées ou fusionnées. Comme cela peut prendre beaucoup de temps sur des instances volumineuses, ce n'est pas fait automatiquement lors des mises à niveau. Utilisez la commande `occ maintenance:repair --include-expensive` pour effectuer les migrations.",
    ...
    "64-bit" : "64 bits",
    "It seems like you are running a 32-bit PHP version. Nextcloud needs 64-bit to run well. Please upgrade your OS and PHP to 64-bit! We will no longer block improvements to performance, security and scalability that are incompatible with 32bit support going forward and we expect that Nextcloud Hub 27 Winter (Nextcloud 36) will no longer work on 32bit systems." : "Il semblerait que vous exécutiez une version 32 bits de PHP. Nextcloud nécessite 64 bits pour fonctionner correctement. Veuillez mettre votre système d'exploitation et PHP à niveau vers du 64 bits ! Nous ne bloquerons plus les améliorations de performances, sécurité et mise à l'échelle qui sont désormais incompatibles avec la prise en charge du 32 bits et nous prévoyons que Nextcloud Hub 27 Winter (Nextcloud 36) ne fonctionnera plus sur les systèmes 32 bits.",
    ...
    "_No scheduled tasks in the last %n day._::_No scheduled tasks in the last %n days._" : ["Aucune tâche planifiée au cours du %n dernier jour.","Aucune tâche planifiée au cours des %n derniers jours.","Aucune tâche planifiée au cours des %n derniers jours."],
    "_Most tasks were successful in the last %n day._::_Most tasks were successful in the last %n days._" : ["La plupart des tâches ont été accomplies avec succès au cours du %n dernier jour.","La plupart des tâches ont été accomplies avec succès au cours des %n derniers jours.","La plupart des tâches ont été accomplies avec succès au cours des %n derniers jours."],
    ...
    "The Task Processing worker does not seem to be running. It seems it has never run so far." : "Le processus de traitement de tâches ne semble pas s'exécuter. Il semble qu'il n'ait jamais été exécuté jusqu'à maintenant.",
    ...
    "Revoking now cancels the wipe. The device keeps its synced data." : "Révoquer annule maintenant l'effacement. L'appareil conserve les données synchronisées.",
    "Device" : "Appareil",
    "Last activity" : "Dernière activité",
    "Actions" : "Actions",
    "Revoke all others" : "Révoquer toutes les autres",
    "Revoke all other sessions?" : "Révoquer toutes les autres sessions ?",
    "Sync clients and connected services have to sign in again. This cannot be undone." : "Les clients synchronisés et les services connectés auront besoin de se reconnecter. Cela ne peut pas être annulé.",
    ...
    "Revoke all other sessions" : "Révoquer toutes les autres sessions",
    "Signs out every device and app except this one." : "Se déconnecte de tout appareil et toute application sauf d'ici.",
    ...
    "Manager" : "Supérieur",
    "Search for a manager…" : "Rechercher un responsable...",
    "Quota" : "Quota",
    ...
    "_The Task Processing worker has run in the last minute._::_The Task Processing worker has run in the last %n minutes._" : ["Le processus de traitement de tâches a été exécuté il y a moins de %n minutes","Le processus de traitement de tâches a été exécuté dans les %n dernières minutes","Le processus de traitement de tâches a été exécuté dans les %n dernières minutes"],
