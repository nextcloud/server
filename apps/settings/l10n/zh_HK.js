OC.L10N.register(
    ...
    "Allow account name autocompletion to users within the same groups and limit system address books to users in the same groups" : "允許同一個群組內的用戶自動補齊帳戶名稱，並將系統通訊錄限制為同一個群組內的用戶",
    "Allow account name autocompletion to users based on phone number integration" : "允許基於電話號碼整合的用戶自動完成帳戶名稱",
