OC.L10N.register(
    ...
    "_You revoked %n other session_::_You revoked %n other sessions_" : ["你已撤銷另外 %n 個工作階段"],
    ...
    "Availability" : "空閒時間",
    "Calendar" : "日曆",
    "Language & locale" : "語言與地區設定",
    "Profile & contact" : "個人檔案與聯絡人",
    ...
    "Sanitize and merge duplicate system tags available" : "可對系統標籤進行清理並合併重複項目",
    "One or more system tags need to be sanitized or merged. This can take a long time on larger instances so this is not done automatically during upgrades. Use the command `occ maintenance:repair --include-expensive` to perform the migrations." : "需要對一個或多個系統標籤進行清理或合併。在較大的站台上，此流程可能耗時甚久，因此升級過程中不會自動執行此操作。請使用指令 `occ maintenance:repair --include-expensive` 來執行遷移作業。",
    ...
    "MariaDB version 10.6 detected, this version is end-of-life and only supported as part of Ubuntu 22.04. MariaDB >=%1$s and <=%2$s is suggested for best performance, stability and functionality with this version of Nextcloud." : "偵測到 MariaDB 版本 10.6，此版本已達生命週期終止階段，僅在 Ubuntu 22.04 系統中提供支援。為確保在此版本的 Nextcloud 上獲得最佳效能、穩定性與功能，建議使用 MariaDB >=%1$s 及 <=%2$s 版本。",
    ...
    "Hide legacy provider settings" : "隱藏舊版提供者設定",
    "Show legacy provider settings" : "顯示舊版提供者設定",
    "Machine translation (Legacy)" : "機器翻譯（舊版）",
    ...
    "This API is deprecated. Install apps that provide Unified task processing to get the best experience." : "此 API 已棄用。請安裝提供「統一任務處理」功能的應用程式，以獲得最佳使用體驗。",
    "Learn more about AI providers" : "進一步了解人工智慧服務供應商",
    "Image generation (Legacy)" : "影像產生（舊版）",
    ...
    "Text processing (Legacy)" : "文字處理（舊版）",
    ...
    "Exclude some groups (block list)" : "排除部分群組（封鎖清單）",
    "Allow some groups only (allow list)" : "只允許部分群組（允許清單）",
    "Groups allowed to share" : "允許分享的群組",
    "Groups excluded from sharing" : "排除分享的群組",
    "Only members of at least one of these groups will be able to initiate shares." : "只有至少屬於其中一個群組的成員才能發起共享。",
    "Others will be blocked, but are still able to receive shares." : "其他人將被封鎖，但仍可接收共享。",
    "A member of at least one of these groups will not be able to initiate new shares, but will still be able to receive shares." : "至少屬於其中一個群組的成員將無法發起新的共享，但仍可接收共享。",
    ...
    "Revoke and cancel wipe" : "撤銷並取消遠端抹除",
    ...
    "Last activity" : "上次活動",
    "Actions" : "操作",
    "Revoke all others" : "撤銷所有其他工作階段",
    "Revoke all other sessions?" : "撤銷所有其他工作階段？",
    "Sync clients and connected services have to sign in again. This cannot be undone." : "同步用戶端及已連接的服務必須重新登入。此操作無法復原。",
    "Devices & sessions" : "裝置和時段",
    "Web, desktop and mobile clients currently logged in to your account." : "目前登入您帳戶的網絡、桌面和流動裝置客戶端。",
    "Revoke all other sessions" : "撤銷所有其他工作階段",
    "Signs out every device and app except this one." : "登出除此裝置外的所有裝置及應用程式。",
    ...
    "Unable to update profile picker setting" : "無法更新個人檔案選擇器設定。",
    "Profile" : "個人設定",
    "Enable or disable profile by default for new accounts." : "預設情況下為新帳戶啟用或停用個人檔案。",
    "Enable the profile picker" : "啟用個人檔案選擇器",
    "Enable or disable the profile picker in the Smart Picker and the profile link previews." : "在智能選擇器與個人檔案連結預覽中啟用或停用個人檔案選擇器。",
    ...
    "Choose from Nextcloud Files" : "從 Nextcloud 檔案中選擇",
    "Delete picture" : "刪除圖片",
    ...
    "Primary email address" : "主要電子郵件地址",
    "Additional email address {index}" : "附加電郵地址 {index}",
    "{label} (confirmation sent)" : "{label}（確認已傳送）",
    ...
    "Nextcloud profile" : "Nextcloud 個人檔案",
    "View full profile" : "檢視完整個人檔案",
    "she/her" : "她",
    "he/him" : "他",
    "they/them" : "他們",
    ...
    "Change visibility and scope of {property}" : "變更 {property} 的能見度與範圍",
    "Unable to update visibility of {property}" : "無法更新 {property} 的可見性",
    "Unable to update scope of {property}" : "無法更新 {property} 的範圍",
    "Visibility & Scope" : "能見度與範圍",
    ...
    "Delete" : "刪除",
    "Reshare" : "重新分享",
    "Default config values" : "配置默認值",
    "Applications config" : "應用程式配置",
    "User config" : "用戶配置",
    "Bundled applications" : "已捆綁的應用程式",
    "Enabled applications" : "已啟用的應用程式",
    "Disabled applications" : "已停用的應用程式",
    "Large organization" : "大型組織",
    ...
    "Scroll to load more rows" : "向下捲動以載入更多資料列",
    "Avatar" : "虛擬化身大頭照",
    ...
    "Organization" : "生產力",
    "Contact" : "聯絡",
    "Notifications and password reset requests will be sent to your primary email" : "通知及密碼重設請求將寄送至您的主要電子郵件地址",
    ...
    "Search accounts and groups…" : "搜尋帳號與群組…",
    "For performance reasons, when you enable encryption on a {productName} server only new and changed files are encrypted." : "出於性能考慮，當您在 {productName} 伺服器上啟用加密時，僅會加密新檔案和已更改的檔案。",
    "Location" : "位置",
    ...
    "Not available as federation has been disabled for your account, contact your system administration if you have any questions" : "您帳戶的聯邦功能已被停用，因此不可用。如有疑問，請聯絡系統管理員",
    "Published" : "已發佈",
    ...
    "_Revoked %n other session_::_Revoked %n other sessions_" : ["已撤銷另外 %n 個工作階段"],
    "Could not revoke the other sessions" : "無法撤銷其他工作階段",
