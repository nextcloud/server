OC.L10N.register(
    ...
    "Saved" : "已儲存",
    "No Login supplied" : "未提供賬戶",
    "Unable to change password. Password too long." : "密碼太長，無法更改。",
    "Authentication error" : "認證錯誤",
    "Please provide an admin recovery password; otherwise, all account data will be lost." : "請提供管理員還原密碼；否則所有賬戶資料將會遺失。",
    "Wrong admin recovery password. Please check the password and try again." : "錯誤的管理員還原密碼。請檢查密碼並再試一次。",
    "Backend does not support password change, but the encryption of the account key was updated." : "後端系統不支援密碼更新，但賬戶的加密密鑰已更新。",
    ...
    "You need to set your account email before being able to send test emails. Go to %s for that." : "您必須先設定您的賬戶電郵地址，然後才能傳送測試電郵。前往 %s 進行設置。",
    "Invalid account" : "無效的賬戶",
    ...
    "Your Login is: %s" : "您的賬戶為：%s",
    "Set your password" : "設定您的密碼",
    "Go to %s" : "前往 %s",
    "Install Client" : "安裝客戶端程式",
    "Logged in account must be a subadmin" : "登入的賬戶必須為子管理員",
    "Apps" : "應用程式",
    "Personal" : "個人",
    "Administration" : "管理",
    "Users" : "用戶",
    ...
    "You are accessing your instance over a secure connection, however your instance is generating insecure URLs. This most likely means that you are behind a reverse proxy and the overwrite config variables are not set correctly." : "您正在透過安全連線存取您的站台，但您的實例卻產生了不安全的 URL。這很有可能是因為您使用了反向代理伺服器，但其覆寫設定變數並未正確設定。",
    ...
    "Memcache" : "Memcache",
    "Memcached is configured as distributed cache, but the wrong PHP module \"memcache\" is installed. \\OC\\Memcache\\Memcached only supports \"memcached\" and not \"memcache\"." : "Memcached 配置為分布式緩存，但是安裝了錯誤的PHP模塊 “memcache”。\\OC\\Memcache\\Memcached 僅支持 “memcached”，不支持 “memcache”。",
    ...
    "Two-factor authentication can be enforced for all accounts and specific groups. If they do not have a two-factor provider configured, they will be unable to log into the system." : "可對所有賬戶與特定群組實施雙重認證。如果他們沒有設定雙重認證提供者，那麼他們就會無法登入系統。",
    ...
    "Webcron" : "Webcron",
    "cron.php is registered at a webcron service to call cron.php every 5 minutes over HTTP. Use case: Very small instance (1–5 accounts depending on the usage)." : "cron.php 註冊了一個 webcron 服務，該服務將通過 HTTP 每 5 分鐘執行一次 cron.php。 用例：非常小的實例（1-5 個賬戶，具體取決於使用情況）。",
    "Cron (Recommended)" : "Cron（推薦）",
    "Use system cron service to call the cron.php file every 5 minutes." : "使用系統 cron 每5分鐘執行 cron.php。",
    "The cron.php needs to be executed by the system account \"{user}\"." : "cron.php 必須由系統賬戶「{user}」執行。",
    ...
    "You are about to remove the group \"{group}\". The accounts will NOT be deleted." : "您將要移除群組「{group}」。賬戶將不會被刪除。",
    "Cancel" : "取消",
    "Confirm" : "確認",
    "Submit" : "遞交",
    "Rename group" : "重新命名群組",
    ...
    "Reshare" : "重新分享",
    "No accounts" : "沒有賬戶",
    "Loading accounts …" : "正在加载賬戶 ...",
    "List of accounts. This list is not fully rendered for performance reasons. The accounts will be rendered as you navigate through the list." : "賬戶清單。出於性能考量，此清單未完全呈現。賬戶將在您瀏覽清單時呈現。",
    ...
    "Loading account …" : "正在加载賬戶 ...",
    "Change display name" : "更改顯示名稱",
    "Set new password" : "設置新密碼",
    "You do not have permissions to see the details of this account" : "您沒有檢視此賬戶詳細資料的權限",
    "Set new email address" : "設置新電郵地址",
    "Add user to group" : "在群組中新增用戶",
    "Add account to group" : "在群組中新增賬戶",
    "Set account as admin for" : "將賬戶設定為管理員",
    "Select account quota" : "選擇賬戶容量限制",
    "Set the language" : "設置語言",
    "Set line manager" : "設定行管理員",
    "{size} used" : "已使用 {size}",
    "Delete account" : "刪除賬戶",
    "Disconnect all devices and delete local data" : "中斷所有裝置並刪除近端數據",
    "Disable account" : "停用賬戶",
    "Enable account" : "啟用賬戶",
    ...
    "Toggle account actions menu" : "切換賬戶操作選單",
    "Done" : "完成",
    "Edit" : "編輯",
    "Account management settings" : "賬戶管理設定",
    "Visibility" : "可見性",
    "Show language" : "顯示語言",
    "Show account backend" : "顯示賬戶後端系統",
    "Show storage path" : "顯示儲存路徑",
    "Show last login" : "顯示上次登入時間",
    "Send email" : "傳送測試電郵",
    "Send welcome email to new accounts" : "向新賬戶發送歡迎電子郵件",
    "Defaults" : "默認",
    ...
    "by {author}\n{license}" : "作者為 {author}\n{license}",
    "Active accounts" : "活躍賬戶",
    "Admins" : "管理員",
    "Disabled accounts" : "已停用賬戶",
    "Account group: {group}" : "賬戶群組：{group}",
    ...
    "Show to logged in accounts only" : "僅顯示給已登錄的賬戶",
    "Hide" : "隱藏",
