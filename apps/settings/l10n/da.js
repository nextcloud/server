OC.L10N.register(
    ...
    "Logged in account must be a sub admin" : "Den påloggede konto skal være en subadmin",
    "Apps" : "Apps",
    "Personal" : "Personligt",
    ...
    "The logging level is set to debug level. Use debug level only when you have a problem to diagnose, and then reset your log level to a less-verbose level as it outputs a lot of information, and can affect your server performance." : "Logningsniveauet er indstillet til fejlretningsniveau. Brug kun fejlretningsniveau, når du har et problem der skal diagnosticeres, og nulstil derefter dit lognings niveau til et mindre-gennemgribende niveau, da det udskriver en masse information, og kan påvirke din servers ydeevne.",
    ...
    "Please make sure to set the \"overwrite.cli.url\" option in your config.php file to the URL that your users mainly use to access this Nextcloud. Suggestion: \"%s\". Otherwise there might be problems with the URL generation via cron. (It is possible though that the suggested URL is not the URL that your users mainly use to access this Nextcloud. Best is to double check this in any case.)" : "Sørg for at sætte indstillingen \"overwrite.cli.url\" i din config. php fil til URL'en, som dine brugere primært bruger til at få adgang til denne Nextcloud. Forslag: \"%s\". Ellers kan der være problemer med URL generering via cron. (Det er dog muligt, selvom den foreslåede URL ikke er den URL, som dine brugere primært bruger til at få adgang til denne Nextcloud. Det er bedst at dobbelttjekke dette under alle omstændigheder.)",
    ...
    "Your APCu cache is almost full at %s%%, consider increasing the apc.shm_size php setting." : "Din APCu cache er næsten fuld ved %s%%, overvej at øge apc.shm_size php indstilling.",
    ...
    "- The `%1$s` HTTP header is not set to `%2$s`. Some features might not work correctly, as it is recommended to adjust this setting accordingly." : "- ' %1$s' HTTP- headeren er ikke indstillet til ' %2$s'. Nogle funktioner virker måske ikke korrekt, da det anbefales at justere denne indstilling i overensstemmelse hermed.",
    "- The `%1$s` HTTP header is not set to `%2$s`. This is a potential security or privacy risk, as it is recommended to adjust this setting accordingly." : "- ' %1$s' HTTP- headeren er ikke indstillet til ' %2$s'. Dette er en potentiel sikkerheds- eller fortrolighedsrisiko, da det anbefales at justere denne indstilling i overensstemmelse hermed.",
    "- The `%1$s` HTTP header is not set to `%2$s`, `%3$s`, `%4$s`, `%5$s` or `%6$s`. This can leak referer information. See the {w3c-recommendation}." : "- `%1$s` HTTP headeren er ikke indstillet til `%2$s`, `%3$s`, `%4$s`, `%5$s` eller `%6$s`. Dette kan lække referenceinformation. Se mere i {w3c-recommendation}.",
    "- The `Strict-Transport-Security` HTTP header is not set to at least `%d` seconds (current value: `%d`). For enhanced security, it is recommended to use a long HSTS policy." : "- 'Strict-Transport-Security' HTTP- headeren er ikke indstillet til mindst '%d' sekunder (aktuel værdi: '%d'). For øget sikkerhed, anbefales det at bruge en lang HSTS politik.",
    "- The `Strict-Transport-Security` HTTP header is malformed: `%s`. For enhanced security, it is recommended to enable HSTS." : "- 'Strict-Transport-Security' HTTP- headeren er fejlformateret: '%s'. For øget sikkerhed anbefales det at aktivere HSTS.",
    "- The `Strict-Transport-Security` HTTP header is not set (should be at least `%d` seconds). For enhanced security, it is recommended to enable HSTS." : "- 'Strict-Transport-Security' HTTP- headeren er ikke indstillet (bør være mindst '%d' sekunder). For øget sikkerhed anbefales det at aktivere HSTS.",
    ...
    "Was not able to get transaction isolation level: %s" : "Var ikke i stand til at hente transaktion isolationsniveau: %s",
    ...
    "Provider for Task types" : "Udbyder for opgavetyper",
    "Enable" : "Aktiver",
    ...
    "Sharing autocompletion restrictions" : "Begrænsninger for deling autofuldførsel",
    "If autocompletion restrictions for both \"same group\" and \"phonebook integration\" are enabled, a match in either is enough to show the user." : "Hvis begrænsninger for autofuldførsel for både \"samme gruppe\" og \"telefonbogsintegration\" er aktiveret, så er et match i én af disse nok til at vide brugeren.",
    ...
    "List of groups. This list is not fully populated for performance reasons. The groups will be loaded as you navigate or search through the list." : "Liste over grupper. Denne liste er ikke fuldt udfyldt af performance grunde. Grupperne vil blive indlæst efterhånden som du navigere eller søger gennem listen.",
    ...
    "Error while creating device token" : "Fejl ved oprettelse af enhedstoken",
    "App name" : "App navn",
    ...
    "Error setting profile picture" : "Kunne ikke sætte profilbillede",
    "Error cropping profile picture" : "Fejl, kunne ikke beskære profil billede",
    "Error saving profile picture" : "Kunne ikke gemme profilbillede",
    "Error removing profile picture" : "Kunne ikke slette profilbillede",
    ...
    "Please note that it can take up to 24 hours for your profile picture to be updated everywhere." : "Bemærk at det kan tage op til 24 timer før dit profilbillede er opdateret alle steder.",
    ...
    "Unable to update {property}" : "Kunne ikke opdatere {property}",
    ...
    "Unable to update federation scope of the primary {property}" : "Kan ikke opdatere føderationsomfang for den primære {property}",
    "Unable to update federation scope of additional {property}" : "Kan ikke opdatere føderationsomfang for yderligere {property}",
    ...
    "Delete" : "Slet",
    "Reshare" : "Videredel",
    "Default config values" : "Standard konfigurationsværdier",
    "Applications config" : "Applikations konfiguration",
    "User config" : "Bruger konfiguration",
    "Bundled applications" : "Bundtede applikationer",
    "Enabled applications" : "Aktiverede applikationer",
    "Disabled applications" : "Deaktiverede applikationer",
    "Large organization" : "Mellem organisation",
    "Big organization" : "Stor organisation",
    "Small organization" : "Lille organisation",
    "Hosting company" : "Hosting firma",
    "University" : "Universitet",
    "School" : "Skole",
    "Club or association" : "Klub eller forening",
    "Family" : "Familie",
    "Personal use" : "Personlig brug",
    "Setup errors" : "Opsætningsfejl",
    "Setup warnings" : "Opsætningsadvarsler",
    "Setup recommendations" : "Opsætningsanbefalinger",
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the {productName} data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "I tilfælde af et mistet apparat eller en der forlader organisationen, så kan dette fjern-slette {productName} data fra alle apparater der er associeret med {userid}. Virker kun hvis apparaterne er forbundet til internettet.",
    ...
    "Failed to update line manager" : "Kunne ikke opdatere linje administrator",
    ...
    "Password can't be empty" : "Adgangskode må ikke være tom",
    ...
    "Add account to group" : "Føj konto til gruppe",
    "Set account as admin for" : "Sæt konto som administrator for ...",
    ...
    "Sorting only applies to the currently loaded groups for performance reasons. Groups will be loaded as you navigate or search through the list." : "Sortering gælder kun for de aktuelt indlæste grupper af hensyn til ydeevne. Grupper vil blive indlæst efterhånden som du navigerer eller søger gennem listen.",
    ...
    "Failed to save selected preset." : "Kunne ikke gemme valgte forudindstilling.",
    "Select a configuration preset for easy setup." : "Vælger en forudindstillet konfiguration for let opsætning.",
    "Apply" : "Anvend",
    ...
    "This app is not marked as compatible with your {productName} version." : "Denne app er ikke markeret som kompatibel med din {productName} version.",
    "If you continue you will still be able to install the app. Note that the app might not work as expected." : "Hvis du fortsætter så vil du stadig kunne installere denne app. Bemærk dog at app'en måske ikke virker som forventet.",
    "Unknown" : "Ukendt",
    "Never" : "Aldrig",
    ...
    "You are using <strong>{usage}</strong>" : "Du anvender: <strong>{usage}</strong>",
    "You are using <strong>{usage}</strong> of <strong>{totalSpace}</strong> (<strong>{usageRelative}%</strong>)" : "Du anvender: <strong>{usage}</strong> af <strong>{totalSpace}</strong> (<strong>{usageRelative}%</strong>)",
