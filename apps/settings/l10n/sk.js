OC.L10N.register(
    ...
    "You deleted app password \"{token}\" and cancelled its pending remote wipe" : "Odstránili ste heslo aplikácie „{token}“ a zrušili ste čakajúce vzdialené vymazanie.",
    "_You revoked %n other session_::_You revoked %n other sessions_" : ["Zrušili ste %n inú reláciu","Zrušili ste %n ďalšie relácie","Zrušili ste %n ďalšie relácie","Zrušili ste %n ďalšie relácie"],
    ...
    "Calendar" : "Kalendár",
    "Language & locale" : "Jazyk a miestne nastavenie",
    "Profile & contact" : "Profil a kontakt",
    ...
    "App directories have the correct owner \"%s\"" : "Adresáre aplikácií majú správneho vlastníka \"%s\"",
    ...
    "Your APCu cache is almost full at %s%%, consider increasing the apc.shm_size php setting." : "Vaša vyrovnávacia pamäť APCu je takmer plná na %s %%. Zvážte zvýšenie nastavenia apc.shm_size v PHP.",
    ...
    "for Argon2 for password hashing and Ed25519 signature verification for RFC 9421 http message signatures" : "pre Argon2 na hashovanie hesiel a overovanie podpisov HTTP správ podľa RFC 9421",
    ...
    "Sanitize and merge duplicate system tags available" : "K dispozícii je čistenie a zlúčenie duplicitných systémových štítkov",
    "One or more system tags need to be sanitized or merged. This can take a long time on larger instances so this is not done automatically during upgrades. Use the command `occ maintenance:repair --include-expensive` to perform the migrations." : "Jeden alebo viac systémových štítkov sa musí vyčistiť alebo zlúčiť. Pri väčších inštanciách to môže trvať dlho, preto sa to počas aktualizácií nevykonáva automaticky. Na vykonanie migrácií použite príkaz `occ maintenance:repair --include-expensive`.",
    "Scheduling objects table size" : "Veľkosť tabuľky plánovania objektov",
    "You have more than %s rows in the scheduling objects table. Please run the expensive repair jobs via occ maintenance:repair --include-expensive." : "V tabuľke objektov plánovania máte viac ako %s riadkov. Spustite dlhotrvajúce opravy cez occ maintenance:repair --include-expensive.",
    ...
    "Could not check that your web server serves security headers correctly, unable to query `%s`" : "Nepodarilo sa skontrolovať, či váš webový server správne poskytuje bezpečnostné hlavičky, nepodarilo sa odoslať požiadavku na `%s`",
    ...
    "\"%d\" is not a valid server identifier. It must be between 0 and 511." : "„%d“ nie je platný identifikátor servera. Musí byť v rozsahu od 0 do 511.",
    ...
    "MariaDB version 10.6 detected, this version is end-of-life and only supported as part of Ubuntu 22.04. MariaDB >=%1$s and <=%2$s is suggested for best performance, stability and functionality with this version of Nextcloud." : "Bola zistená verzia MariaDB 10.6; táto verzia je po skončení životnosti a podporovaná je iba v rámci Ubuntu 22.04. Pre najlepší výkon, stabilitu a funkčnosť s touto verziou Nextcloudu sa odporúča MariaDB >=%1$s a <=%2$s.",
    ...
    "64-bit" : "64-bit",
    "It seems like you are running a 32-bit PHP version. Nextcloud needs 64-bit to run well. Please upgrade your OS and PHP to 64-bit! We will no longer block improvements to performance, security and scalability that are incompatible with 32bit support going forward and we expect that Nextcloud Hub 27 Winter (Nextcloud 36) will no longer work on 32bit systems." : "Zdá sa, že používate 32-bitovú verziu PHP. Nextcloud potrebuje 64-bitovú verziu, aby fungoval dobre. Aktualizujte svoj operačný systém a PHP na 64-bitovú verziu! V budúcnosti už nebudeme blokovať zlepšenia výkonu, bezpečnosti a škálovateľnosti, ktoré nie sú kompatibilné s 32bitovou podporou, a očakávame, že Nextcloud Hub 27 Winter (Nextcloud 36) už nebude fungovať na 32bitových systémoch.",
    ...
    "_The task pickup speed has been ok in the last day._::_The task pickup speed has been ok in the last %n days._" : ["Rýchlosť prevzatia úloh bola v posledný deň v poriadku.","Rýchlosť prevzatia úloh bola v posledných %n dňoch v poriadku.","Rýchlosť prevzatia úloh bola v posledných %n dňoch v poriadku.","Rýchlosť prevzatia úloh bola v posledných %n dňoch v poriadku."],
    "_The task pickup speed has been slow in the last day. Many tasks took longer than 4 minutes to be picked up. Consider setting up a worker to process tasks in the background._::_The task pickup speed has been slow in the last %n days. Many tasks took longer than 4 minutes to be picked up. Consider setting up a worker to process tasks in the background._" : ["Rýchlosť preberania úloh bola v poslednom dni pomalá. Mnohé úlohy trvali dlhšie ako 4 minúty, kým boli prebraté. Zvážte nastavenie pracovníka na spracovanie úloh na pozadí.","Rýchlosť preberania úloh bola v posledných %n dňoch pomalá. Mnohé úlohy trvali dlhšie ako 4 minúty, kým boli prebraté. Zvážte nastavenie pracovníka na spracovanie úloh na pozadí.","Rýchlosť preberania úloh bola v posledných %n dňoch pomalá. Mnohé úlohy trvali dlhšie ako 4 minúty, kým boli prebraté. Zvážte nastavenie pracovníka na spracovanie úloh na pozadí.","Rýchlosť preberania úloh bola v posledných %n dňoch pomalá. Mnohé úlohy trvali dlhšie ako 4 minúty, kým boli prebraté. Zvážte nastavenie pracovníka na spracovanie úloh na pozadí."],
    "Task Processing success rate" : "Miera úspešnosti spracovania úloh",
    "_No scheduled tasks in the last %n day._::_No scheduled tasks in the last %n days._" : ["Za posledný %n deň neboli naplánované žiadne úlohy.","Za posledných %n dní neboli naplánované žiadne úlohy.","Za posledných %n dní neboli naplánované žiadne úlohy.","Za posledných %n dní neboli naplánované žiadne úlohy."],
    "_Most tasks were successful in the last %n day._::_Most tasks were successful in the last %n days._" : ["Väčšina úloh bola úspešne dokončená za posledný %n deň.","Väčšina úloh bola úspešne dokončená za posledných %n dní.","Väčšina úloh bola úspešne dokončená za posledných %n dní.","Väčšina úloh bola úspešne dokončená za posledných %n dní."],
    "_A lot of tasks failed in the last day. Consider checking the nextcloud log for errors and investigating whether the AI provider apps have been set up correctly._::_A lot of tasks failed in the last %n days. Consider checking the nextcloud log for errors and investigating whether the AI provider apps have been set up correctly._" : ["Mnoho úloh zlyhalo v posledný deň. Zvážte skontrolovanie logu Nextcloud pre chyby a overenie, či boli aplikácie poskytovateľa AI správne nastavené.","V posledných %n dňoch zlyhalo mnoho úloh. Zvážte skontrolovanie logu Nextcloud pre chyby a overenie, či boli aplikácie poskytovateľa AI správne nastavené.","V posledných %n dňoch zlyhalo mnoho úloh. Zvážte skontrolovanie logu Nextcloud pre chyby a overenie, či boli aplikácie poskytovateľa AI správne nastavené.","V posledných %n dňoch zlyhalo mnoho úloh. Zvážte skontrolovanie logu Nextcloud pre chyby a overenie, či boli aplikácie poskytovateľa AI správne nastavené."],
    "Task Processing worker status" : "Stav pracovného procesu spracovania úloh",
    "_The Task Processing worker has run in the last %n minute._::_The Task Processing worker has run in the last %n minutes._" : ["Pracovný proces spracovania úloh sa spustil za poslednú %n minútu.","Pracovný proces spracovania úloh sa spustil za posledných %n minút.","Pracovný proces spracovania úloh sa spustil za posledných %n minút.","Pracovný proces spracovania úloh sa spustil za posledných %n minút."],
    "The Task Processing worker does not seem to be running. The last run was at %s." : "Zdá sa, že pracovný proces spracovania úloh nie je spustený. Naposledy sa spustil o %s.",
    "The Task Processing worker does not seem to be running. It seems it has never run so far." : "Zdá sa, že pracovný proces spracovania úloh nie je spustený. Zdá sa, že sa doteraz nikdy nespustil.",
    ...
    "Error while checking the available disk space of temporary PHP path or no free disk space returned. Temporary path: %s" : "Chyba pri kontrole dostupného miesta na disku pre cestu k dočasným súborom PHP alebo žiadne voľné miesto na disku. Cesta pre dočasné súbory: %s",
    ...
    "Second factor providers are available and enforced: %s." : "Poskytovatelia druhého faktora sú k dispozícii a vynucovaní: %s.",
    ...
    "Hide legacy provider settings" : "Skryť nastavenia staršieho poskytovateľa",
    "Show legacy provider settings" : "Zobraziť nastavenia staršieho poskytovateľa",
    "Machine translation (Legacy)" : "Strojový preklad (starší)",
    ...
    "This API is deprecated. Install apps that provide Unified task processing to get the best experience." : "Toto rozhranie API je zastarané. Ak chcete najlepšie skúsenosti, nainštalujte aplikácie, ktoré poskytujú jednotné spracovanie úloh.",
    "Learn more about AI providers" : "Viac informácií o poskytovateľoch umelej inteligencie",
    "Image generation (Legacy)" : "Generovanie obrázkov (staršie)",
    ...
    "Text processing (Legacy)" : "Spracovanie textu (staršie)",
    ...
    "Exclude some groups (block list)" : "Vylúčiť niektoré skupiny (zoznam blokovaných)",
    "Allow some groups only (allow list)" : "Povoliť iba niektoré skupiny (zoznam povolených)",
    ...
    "Only members of at least one of these groups will be able to initiate shares." : "Iba členovia aspoň jednej z týchto skupín budú môcť vytvárať zdieľania.",
    "Others will be blocked, but are still able to receive shares." : "Ostatní budú zablokovaní, ale stále budú môcť prijímať zdieľania.",
    "A member of at least one of these groups will not be able to initiate new shares, but will still be able to receive shares." : "Člen aspoň jednej z týchto skupín nebude môcť iniciovať nové zdieľania, ale stále ich bude môcť prijímať.",
    ...
    "Revoke and cancel pending wipe?" : "Odvolať a zrušiť čakajúce vymazanie?",
    "Only continue if you no longer need the device to be wiped." : "Pokračujte iba vtedy, ak už nepotrebujete vymazať zariadenie.",
    "Revoke and cancel wipe" : "Odvolať a zrušiť vymazanie",
    "Revoke app password?" : "Odvolať heslo aplikácie?",
    "The app or device will lose access on its next sync. This cannot be undone." : "Aplikácia alebo zariadenie stratí pri ďalšej synchronizácii prístup. Toto nie je možné vrátiť späť.",
    "Remote wipe has not started yet." : "Vzdialené vymazanie sa ešte nezačalo.",
    "Revoking now cancels the wipe. The device keeps its synced data." : "Odvolanie teraz zruší vymazanie. Zariadenie si ponechá synchronizované údaje.",
    "Device" : "Zariadenie",
    "Last activity" : "Posledná aktivita",
    "Actions" : "Akcie",
    "Revoke all others" : "Odvolať všetky ostatné relácie",
    "Revoke all other sessions?" : "Odvolať všetky ostatné relácie?",
    "Sync clients and connected services have to sign in again. This cannot be undone." : "Klienti synchronizácie a pripojené služby sa budú musieť znova prihlásiť. Toto nie je možné vrátiť späť.",
    ...
    "Revoke all other sessions" : "Odvolať všetky ostatné relácie",
    "Signs out every device and app except this one." : "Odhlási všetky zariadenia a aplikácie okrem tohto.",
    ...
    "Choose from Nextcloud Files" : "Vybrať zo Súborov Nextcloud",
    ...
    "Additional address" : "Ďalšia adresa",
    ...
    "{label} (confirmation sent)" : "{label} (potvrdenie odoslané)",
    ...
    "Nextcloud profile" : "Profil Nextcloud",
    "View full profile" : "Zobraziť celý profil",
    "she/her" : "ona/jej",
    "he/him" : "on/jeho",
    "they/them" : "oni/ich",
    ...
    "Change visibility and scope of {property}" : "Zmeniť viditeľnosť a rozsah {property}",
    "Unable to update visibility of {property}" : "Nepodarilo sa aktualizovať viditeľnosť {property}",
    "Unable to update scope of {property}" : "Nepodarilo sa aktualizovať rozsah {property}",
    "Visibility & Scope" : "Viditeľnosť a rozsah",
    ...
    "Failed to update account" : "Účet sa nepodarilo aktualizovať",
    ...
    "Manager" : "Manažér",
    "Search for a manager…" : "Hľadať manažéra…",
    "Quota" : "Kvóta",
    ...
    "Search" : "Hľadať",
    "Focus search" : "Zamerať vyhľadávanie",
    "Help" : "Pomoc",
    ...
    "Transport encryption" : "Šifrovanie prenosu",
    ...
    "Contact" : "Kontakt",
    "Notifications and password reset requests will be sent to your primary email" : "Oznámenia a žiadosti o obnovenie hesla budú odoslané na váš primárny e-mail",
    ...
    "Search accounts and groups…" : "Hľadať v účtoch a skupinách…",
    ...
    "_Revoked %n other session_::_Revoked %n other sessions_" : ["Bola odvolaná %n iná relácia","Boli odvolané %n ďalšie relácie","Boli odvolané %n ďalšie relácie","Boli odvolané %n ďalšie relácie"],
    "Could not revoke the other sessions" : "Nepodarilo sa zrušiť ostatné relácie",
    ...
    "_Most tasks were successful in the last day._::_Most tasks were successful in the last %n days._" : ["Väčšina úloh bola úspešná v poslednom dni.","Väčšina úloh bola úspešná v posledných %n dňoch.","Väčšina úloh bola úspešná v posledných %n dňoch.","Väčšina úloh bola úspešná v posledných %n dňoch."],
    "_The Task Processing worker has run in the last minute._::_The Task Processing worker has run in the last %n minutes._" : ["Pracovný proces spracovania úloh sa spustil za poslednú minútu.","Pracovný proces spracovania úloh sa spustil za posledných %n minút.","Pracovný proces spracovania úloh sa spustil za posledných %n minút.","Pracovný proces spracovania úloh sa spustil za posledných %n minút."],
