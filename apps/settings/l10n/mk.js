OC.L10N.register(
    ...
    "File locking" : "Заклучување на датотека",
    "The PHP memory limit is below the recommended value of %s." : "Меморијата за PHP е под препорачаната вредност од %s.",
    "for WebAuthn passwordless login" : "за WebAuthn најава без лозинкаpasswordless login",
    "for WebAuthn passwordless login, and SFTP storage" : "за WebAuthn најава без лозинка, и SFTP складиште",
