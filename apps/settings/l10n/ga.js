OC.L10N.register(
    ...
    "You deleted app password \"{token}\" and cancelled its pending remote wipe" : "Scrios tú pasfhocal an aip \"{token}\" agus chealaigh tú an scriosadh iargúlta atá ar feitheamh",
    "_You revoked %n other session_::_You revoked %n other sessions_" : ["Chuir tú %n seisiún eile ar ceal","Chuir tú %n seisiún eile ar ceal","Chuir tú %n seisiún eile ar ceal","Chuir tú %n seisiún eile ar ceal","Chuir tú %n seisiún eile ar ceal"],
    ...
    "Calendar" : "Féilire",
    "Language & locale" : "Teanga agus suíomh",
    "Profile & contact" : "Próifíl & teagmháil",
    ...
    "for Argon2 for password hashing and Ed25519 signature verification for RFC 9421 http message signatures" : "le haghaidh Argon2 le haghaidh hasháil pasfhocal agus fíorú sínithe Ed25519 le haghaidh sínithe teachtaireachta http RFC 9421",
    ...
    "Sanitize and merge duplicate system tags available" : "Tá clibeanna córais dhúblacha glantacháin agus cumasc ar fáil",
    "One or more system tags need to be sanitized or merged. This can take a long time on larger instances so this is not done automatically during upgrades. Use the command `occ maintenance:repair --include-expensive` to perform the migrations." : "Caithfear clib chórais amháin nó níos mó a shláintiú nó a chumasc. Féadfaidh sé seo tamall fada a thógáil ar chásanna níos mó agus mar sin ní dhéantar é seo go huathoibríoch le linn uasghráduithe. Bain úsáid as an ordú `occ maintenance:repair --include-expensive` chun na himirce a dhéanamh.",
    ...
    "MariaDB version 10.6 detected, this version is end-of-life and only supported as part of Ubuntu 22.04. MariaDB >=%1$s and <=%2$s is suggested for best performance, stability and functionality with this version of Nextcloud." : "Braitheadh ​​leagan 10.6 de MariaDB, tá an leagan seo ag deireadh a shaoil ​​agus ní thacaítear leis ach mar chuid de Ubuntu 22.04. Moltar MariaDB >=%1$s agus <=%2$s le haghaidh an fheidhmíochta, an chobhsaíochta agus an fheidhmiúlachta is fearr leis an leagan seo de Nextcloud.",
    ...
    "64-bit" : "64-giotán",
    "It seems like you are running a 32-bit PHP version. Nextcloud needs 64-bit to run well. Please upgrade your OS and PHP to 64-bit! We will no longer block improvements to performance, security and scalability that are incompatible with 32bit support going forward and we expect that Nextcloud Hub 27 Winter (Nextcloud 36) will no longer work on 32bit systems." : "Is cosúil go bhfuil leagan 32-giotán de PHP á rith agat. Teastaíonn leagan 64-giotán ó Nextcloud le go n-oibreoidh sé i gceart. Uasghrádaigh do chóras oibriúcháin agus PHP go 64-giotán! Ní chuirfimid bac ar fheabhsuithe ar fheidhmíocht, slándáil agus inscálaitheacht nach bhfuil comhoiriúnach le tacaíocht 32-giotán feasta agus táimid ag súil nach n-oibreoidh Nextcloud Hub 27 Winter (Nextcloud 36) ar chórais 32-giotán a thuilleadh.",
    ...
    "Task Processing success rate" : "Ráta rathúlachta Próiseála Tascanna",
    "_No scheduled tasks in the last %n day._::_No scheduled tasks in the last %n days._" : ["Gan aon tascanna sceidealaithe le %n lá anuas.","Gan aon tascanna sceidealaithe sna %n lá seo caite.","Gan aon tascanna sceidealaithe sna %n lá seo caite.","Gan aon tascanna sceidealaithe sna %n lá seo caite.","Gan aon tascanna sceidealaithe sna %n lá seo caite."],
    "_Most tasks were successful in the last %n day._::_Most tasks were successful in the last %n days._" : ["D'éirigh leis an gcuid is mó de na tascanna sa %n lá seo caite.","D'éirigh leis an gcuid is mó de na tascanna sna %n lá seo caite.","D'éirigh leis an gcuid is mó de na tascanna sna %n lá seo caite.","D'éirigh leis an gcuid is mó de na tascanna sna %n lá seo caite.","D'éirigh leis an gcuid is mó de na tascanna sna %n lá seo caite."],
    ...
    "_The Task Processing worker has run in the last %n minute._::_The Task Processing worker has run in the last %n minutes._" : ["Tá an t-oibrí Próiseála Tascanna ag rith le %n nóiméad anuas.","Tá an t-oibrí Próiseála Tascanna ag rith le %n nóiméad anuas.","Tá an t-oibrí Próiseála Tascanna ag rith le %n nóiméad anuas.","Tá an t-oibrí Próiseála Tascanna ag rith le %n nóiméad anuas.","Tá an t-oibrí Próiseála Tascanna ag rith le %n nóiméad anuas."],
    ...
    "Hide legacy provider settings" : "Folaigh socruithe an tsoláthraí oidhreachta",
    "Show legacy provider settings" : "Taispeáin socruithe an tsoláthraí oidhreachta",
    "Machine translation (Legacy)" : "Aistriúchán meaisín (Oidhreacht)",
    ...
    "This API is deprecated. Install apps that provide Unified task processing to get the best experience." : "Tá an API seo imithe i léig. Suiteáil aipeanna a sholáthraíonn próiseáil tascanna Aontaithe chun an taithí is fearr a fháil.",
    "Learn more about AI providers" : "Foghlaim tuilleadh faoi sholáthraithe AI",
    "Image generation (Legacy)" : "Giniúint íomhá (Oidhreacht)",
    ...
    "Text processing (Legacy)" : "Próiseáil téacs (Oidhreacht)",
    ...
    "Exclude some groups (block list)" : "Eisiamh roinnt grúpaí (liosta blocála)",
    "Allow some groups only (allow list)" : "Ceadaigh roinnt grúpaí amháin (liosta ceadaithe)",
    "Groups allowed to share" : "Ceadaítear do ghrúpaí a roinnt",
    "Groups excluded from sharing" : "Grúpaí eisiata ó chomhroinnt",
    "Only members of at least one of these groups will be able to initiate shares." : "Ní bheidh ach baill de cheann amháin ar a laghad de na grúpaí seo in ann scaireanna a thionscnamh.",
    "Others will be blocked, but are still able to receive shares." : "Beidh bac ar dhaoine eile, ach beidh siad fós in ann scaireanna a fháil.",
    "A member of at least one of these groups will not be able to initiate new shares, but will still be able to receive shares." : "Ní bheidh ball de cheann amháin ar a laghad de na grúpaí seo in ann scaireanna nua a thionscnamh, ach beidh sé/sí in ann scaireanna a fháil fós.",
    ...
    "Revoke and cancel pending wipe?" : "An scriosadh atá ar feitheamh a chealú agus a chúlghairm?",
    "Only continue if you no longer need the device to be wiped." : "Ná lean ar aghaidh ach amháin mura bhfuil gá agat an gléas a scriosadh a thuilleadh.",
    "Revoke and cancel wipe" : "Aisghairm agus cealaigh scriosadh",
    "Revoke app password?" : "An bhfuil tú ag iarraidh pasfhocal an aip a chúlghairm?",
    "The app or device will lose access on its next sync. This cannot be undone." : "Caillfidh an aip nó an gléas rochtain ar an gcéad sioncrónú eile. Ní féidir é seo a chealú.",
    "Remote wipe has not started yet." : "Níl tús curtha leis an scriosadh iargúlta fós.",
    "Revoking now cancels the wipe. The device keeps its synced data." : "Má chealaítear an scriosadh anois, cuirtear ar ceal é. Coinníonn an gléas a shonraí sioncronaithe.",
    "Device" : "Gléas",
    "Last activity" : "An ghníomhaíocht dheireanach",
    "Actions" : "Gníomhartha",
    "Revoke all others" : "Cúlghairm gach ceann eile",
    "Revoke all other sessions?" : "Gach seisiún eile a chealú?",
    "Sync clients and connected services have to sign in again. This cannot be undone." : "Caithfidh cliaint sioncrónaithe agus seirbhísí nasctha síniú isteach arís. Ní féidir é seo a chealú.",
    ...
    "Revoke all other sessions" : "Cúlghairm gach seisiún eile",
    "Signs out every device and app except this one." : "Síníonn sé amach gach gléas agus aip seachas an ceann seo.",
    ...
    "Your teams" : "Do fhoirne",
    "Your groups" : "Do ghrúpaí",
    ...
    "Additional address" : "Seoladh breise",
    ...
    "Primary email address" : "Príomhsheoladh ríomhphoist",
    "Additional email address {index}" : "Seoladh ríomhphoist breise {index}",
    "{label} (confirmation sent)" : "{label} (deimhniú seolta)",
    ...
    "Nextcloud profile" : "Próifíl Nextcloud",
    "View full profile" : "Féach ar an bpróifíl iomlán",
    "she/her" : "sí/léi",
    "he/him" : "sé/dó",
    "they/them" : "siad/siad",
    ...
    "Change visibility and scope of {property}" : "Athraigh infheictheacht agus raon feidhme {property}",
    "Unable to update visibility of {property}" : "Ní féidir infheictheacht {property} a nuashonrú",
    "Unable to update scope of {property}" : "Ní féidir raon feidhme {property} a nuashonrú",
    "Visibility & Scope" : "Infheictheacht & Raon Feidhme",
    ...
    "Delete" : "Scrios",
    "Reshare" : "Roinn arís",
    "Default config values" : "Luachanna cumraíochta réamhshocraithe",
    "Applications config" : "Cumraíocht na n-iarratas",
    "User config" : "Cumraíocht úsáideora",
    "Bundled applications" : "Feidhmchláir phacáilte",
    "Enabled applications" : "Feidhmchláir chumasaithe",
    "Disabled applications" : "Feidhmchláir dhíchumasaithe",
    "Large organization" : "Eagraíocht mhór",
    "Big organization" : "Eagraíocht mhór",
    "Small organization" : "Eagraíocht bheag",
    "Hosting company" : "Cuideachta óstála",
    "University" : "Ollscoil",
    "School" : "Scoil",
    "Club or association" : "Club nó comhlachas",
    "Family" : "Teaghlach",
    "Personal use" : "Úsáid phearsanta",
    "Default" : "Réamhshocrú",
    ...
    "Failed to update account" : "Theip ar an gcuntas a nuashonrú",
    "Edit account" : "Cuir cuntas in eagar",
    "Saving …" : "Shábháil …",
    "Save" : "Sábháil",
    ...
    "Manager" : "Bainisteoir",
    "Search for a manager…" : "Cuardaigh bainisteoir…",
    "Quota" : "Cuóta",
    "Set account quota" : "Socraigh cuóta cuntais",
    "_{userCount} account …_::_{userCount} accounts …_" : ["{userCount} cuntas …","{userCount} cuntais …","{userCount} cuntais …","{userCount} cuntais …","{userCount} cuntais …"],
    ...
    "In case of lost device or exiting the organization, this can remotely wipe the {productName} data from all devices associated with {userid}. Only works if the devices are connected to the internet." : "I gcás gléas a chailleadh nó imeacht ón eagraíocht, is féidir leis seo sonraí {productName}a scriosadh go cianda ó gach gléas a bhaineann le {userid}. Ní oibríonn sé ach amháin má tá na gléasanna ceangailte leis an idirlíon.",
    ...
    "Loading account …" : "Ag lódáil an chuntais …",
    ...
    "Add" : "Cuir",
    "Adding your device …" : "Do ghléas á chur leis …",
    ...
    "Transport encryption" : "Criptiú iompair",
    ...
    "Contact" : "Teagmháil",
    "Notifications and password reset requests will be sent to your primary email" : "Seolfar fógraí agus iarratais ar athshocrú pasfhocail chuig do phríomh-ríomhphost",
    ...
    "Search accounts and groups…" : "Cuardaigh cuntais agus grúpaí…",
    ...
    "_Revoked %n other session_::_Revoked %n other sessions_" : ["%n seisiún eile curtha ar ceal","%n seisiún eile curtha ar ceal","%n seisiún eile curtha ar ceal","%n seisiún eile curtha ar ceal","%n seisiún eile curtha ar ceal"],
    "Could not revoke the other sessions" : "Níorbh fhéidir na seisiúin eile a chúlghairm",
