OC.L10N.register(
    ...
    "MariaDB version \"%s\" detected. MariaDB >=10.3 and <=10.11 is suggested for best performance, stability and functionality with this version of Nextcloud." : "Braitheadh ​​leagan MariaDB \"%s\". Moltar MariaDB >=10.3 agus <=10.11 don fheidhmíocht is fearr, don chobhsaíocht agus don fheidhmiúlacht leis an leagan seo de Nextcloud.",
    "MySQL version \"%s\" detected. MySQL >=8.0 and <=8.3 is suggested for best performance, stability and functionality with this version of Nextcloud." : "Braitheadh ​​leagan MySQL \"%s\". Moltar MySQL >=8.0 agus <=8.3 don fheidhmíocht is fearr, don chobhsaíocht agus don fheidhmiúlacht leis an leagan seo de Nextcloud.",
