OC.L10N.register(
    ...
    "_No scheduled tasks in the last %n hour._::_No scheduled tasks in the last %n hours._" : ["Δεν υπήρχαν προγραμματισμένες εργασίες την τελευταία %n ώρα.","Δεν υπήρχαν προγραμματισμένες εργασίες τις τελευταίες %n ώρες."],
    "_The task pickup speed has been ok in the last %n hour._::_The task pickup speed has been ok in the last %n hours._" : ["Η ταχύτητα παραλαβής εργασιών ήταν εντάξει την τελευταία %n ώρα.","Η ταχύτητα παραλαβής εργασιών ήταν εντάξει τις τελευταίες %n ώρες."],
    "_The task pickup speed has been slow in the last %n hour. Many tasks took longer than 4 minutes to be picked up. Consider setting up a worker to process tasks in the background._::_The task pickup speed has been slow in the last %n hours. Many tasks took longer than 4 minutes to be picked up. Consider setting up a worker to process tasks in the background._" : ["Η ταχύτητα παραλαβής εργασιών ήταν αργή την τελευταία %n ώρα. Πολλές εργασίες χρειάστηκαν περισσότερο από 4 λεπτά για να παραληφθούν. Σκεφτείτε να ρυθμίσετε έναν εργαζόμενο για επεξεργασία εργασιών στο παρασκήνιο.","Η ταχύτητα παραλαβής εργασιών ήταν αργή τις τελευταίες %n ώρες. Πολλές εργασίες χρειάστηκαν περισσότερο από 4 λεπτά για να παραληφθούν. Σκεφτείτε να ρυθμίσετε έναν εργαζόμενο για επεξεργασία εργασιών στο παρασκήνιο."],
