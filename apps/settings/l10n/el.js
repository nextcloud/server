OC.L10N.register(
    ...
    "Server identifier isn’t configured. It is recommended if your Nextcloud instance is running on several PHP servers. Add a server ID in your configuration." : "Το αναγνωριστικό διακομιστή δεν έχει ρυθμιστεί. Συνιστάται εάν η εγκατάσταση του Nextcloud εκτελείται σε αρκετούς διακομιστές PHP. Προσθέστε ένα αναγνωριστικό διακομιστή (server ID) στις ρυθμίσεις σας.",
    "\"%d\" is not a valid server identifier. It must be between 0 and 1023." : "Το \"%d\" δεν είναι έγκυρο αναγνωριστικό διακομιστή. Πρέπει να είναι μεταξύ 0 και 1023.",
    "Server identifier is configured and valid." : "Το αναγνωριστικό διακομιστή είναι ρυθμισμένο και έγκυρο.",
    ...
    "Oracle version \"%1$s\" detected. Oracle >=%2$s and <=%3$s is suggested for best performance, stability and functionality with this version of Nextcloud." : "Ανιχνεύθηκε η έκδοση Oracle \"%1$s\". Συνιστάται η χρήση Oracle >=%2$s και <=%3$s για βέλτιστη απόδοση, σταθερότητα και λειτουργικότητα με αυτήν την έκδοση του Nextcloud.",
    ...
    "Task Processing pickup speed" : "Ταχύτητα παραλαβής Επεξεργασίας Εργασιών",
    ...
    "Second factor providers are available but two-factor authentication is not enforced." : "Υπάρχουν διαθέσιμοι πάροχοι δεύτερου παράγοντα, αλλά ο έλεγχος ταυτότητας δύο παραγόντων δεν είναι επιβεβλημένος.",
    "Second factor providers are available and enforced: %s." : "Οι πάροχοι δεύτερου παράγοντα είναι διαθέσιμοι και επιβεβλημένοι: %s.",
    ...
    "Allow AI usage for guest users" : "Να επιτρέπεται η χρήση ΤΝ για επισκέπτες",
    ...
    "Users will still be able to screenshot or record the screen. This does not provide any definitive protection." : "Οι χρήστες θα μπορούν ακόμα να τραβήξουν στιγμιότυπο οθόνης ή να εγγράψουν την οθόνη. Αυτό δεν παρέχει καμία οριστική προστασία.",
    ...
    "Allow public shares to be added to other clouds by federation." : "Να επιτρέπεται η προσθήκη δημόσιων κοινόχρηστων σε άλλα σύννεφα μέσω federation.",
    "This will add share permissions to all newly created link shares." : "Αυτό θα προσθέσει δικαιώματα κοινής χρήσης σε όλες τις νέες κοινόχρηστες συνδέσμους.",
    ...
    "Enforce expiration date for link or mail shares" : "Εφαρμογή ημερομηνίας λήξης για συνδέσμους ή κοινόχρηστα μηνύματα ηλεκτρονικού ταχυδρομείου",
    ...
    "Sharing autocompletion restrictions" : "Κοινή χρήση περιορισμών αυτόματης συμπλήρωσης",
    "If autocompletion restrictions for both \"same group\" and \"phonebook integration\" are enabled, a match in either is enough to show the user." : "Εάν είναι ενεργοποιημένοι οι περιορισμοί αυτόματης συμπλήρωσης τόσο για την \"ίδια ομάδα\" όσο και για την \"ενσωμάτωση τηλεφωνικού καταλόγου\", αρκεί μια αντιστοίχιση για να εμφανιστεί ο χρήστης.",
    ...
    "Restrict account name autocompletion to users based on their phonebook" : "Περιορισμός αυτόματης συμπλήρωσης ονόματος λογαριασμού σε χρήστες βάσει του ευρετηρίου τους",
    "Allow autocompletion to full match when entering the full name (ignoring restrictions like group membership or missing phonebook match)" : "Να επιτρέπεται η αυτόματη συμπλήρωση σε πλήρη αντιστοίχιση κατά την εισαγωγή του πλήρους ονόματος (παράβλεψη περιορισμών όπως η συμμετοχή σε ομάδες ή η έλλειψη αντιστοίχισης στο ευρετήριο)",
    ...
    "Also allow autocompletion on full match of the display name" : "Να επιτρέπεται επίσης η αυτόματη συμπλήρωση σε πλήρη αντιστοίχιση του εμφανιζόμενου ονόματος",
    "Also allow autocompletion on full match of the user email" : "Να επιτρέπεται επίσης η αυτόματη συμπλήρωση σε πλήρη αντιστοίχιση του email χρήστη",
    ...
    "Select your preferred office suite. Please note that installing requires manual server setup." : "Επιλέξτε τη σουίτα γραφείου που προτιμάτε. Σημειώστε ότι η εγκατάσταση απαιτεί χειροκίνητη ρύθμιση του διακομιστή.",
    ...
    "List of groups. This list is not fully populated for performance reasons. The groups will be loaded as you navigate or search through the list." : "Κατάλογος ομάδων. Αυτός ο κατάλογος δεν είναι πλήρως γεμισμένος για λόγους απόδοσης. Οι ομάδες θα φορτώνονται καθώς πλοηγείστε ή αναζητάτε στον κατάλογο.",
    ...
    "This app has no minimum {productName} version assigned. This will be an error in the future." : "Αυτή η εφαρμογή δεν έχει εκχωρημένη ελάχιστη έκδοση {productName}. Αυτό θα είναι σφάλμα στο μέλλον.",
    "This app has no maximum {productName} version assigned. This will be an error in the future." : "Αυτή η εφαρμογή δεν έχει εκχωρημένη μέγιστη έκδοση {productName}. Αυτό θα είναι σφάλμα στο μέλλον.",
    ...
    "By default a master key for the whole instance will be generated. Please check if that level of access is compliant with your needs." : "Από προεπιλογή, θα δημιουργηθεί ένα κύριο κλειδί για ολόκληρη την παρουσία. Ελέγξτε αν αυτό το επίπεδο πρόσβασης ανταποκρίνεται στις ανάγκες σας.",
    ...
    "Your pronouns. E.g. {pronounsExample}" : "Η προφώνησή σας. Π.χ. {pronounsExample}",
    ...
    "Default config values" : "Προεπιλεγμένες τιμές ρύθμισης",
    "Applications config" : "Ρύθμιση εφαρμογών",
    "User config" : "Ρύθμιση χρήστη",
    "Bundled applications" : "Προσαρτημένες εφαρμογές",
    ...
    "Hosting company" : "Εταιρεία hosting",
    "University" : "Πανεπιστήμιο",
    "School" : "Σχολείο",
    "Club or association" : "Λέσχη ή ένωση",
    "Family" : "Οικογένεια",
    "Personal use" : "Προσωπική χρήση",
    "Setup errors" : "Σφάλματα ρύθμισης",
    "Setup warnings" : "Προειδοποιήσεις ρύθμισης",
    "Setup recommendations" : "Συστάσεις ρύθμισης",
    ...
    "Sorting only applies to the currently loaded groups for performance reasons. Groups will be loaded as you navigate or search through the list." : "Η ταξινόμηση ισχύει μόνο για τις τρέχοντα φορτωμένες ομάδες για λόγους απόδοσης. Οι ομάδες θα φορτώνονται καθώς πλοηγείστε ή αναζητάτε στον κατάλογο.",
    ...
    "It is important to set up this server to be able to send emails, like for password reset and notifications." : "Είναι σημαντικό να ρυθμίσετε αυτόν τον διακομιστή ώστε να μπορεί να στέλνει email, όπως για την επαναφορά κωδικού πρόσβασης και ειδοποιήσεις.",
    "The server configuration is read-only so the mail settings cannot be changed using the web interface." : "Οι ρυθμίσεις του διακομιστή είναι μόνο για ανάγνωση, επομένως οι ρυθμίσεις αλληλογραφίας δεν μπορούν να αλλάξουν μέσω της διεπαφής ιστού.",
    ...
    "Sending test email…" : "Γίνεται αποστολή δοκιμαστικού email…",
    ...
    "Failed to save selected preset." : "Αποτυχία αποθήκευσης επιλεγμένου προκαθορισμένου.",
    "Select a configuration preset for easy setup." : "Επιλέξτε ένα προκαθορισμένο ρύθμισης για εύκολη εγκατάσταση.",
    "Apply" : "Εφαρμογή",
    ...
    "{progress}% Deploying …" : "{progress}% Γίνεται ανάπτυξη …",
    "{progress}% Initializing …" : "{progress}% Γίνεται προετοιμασία …",
