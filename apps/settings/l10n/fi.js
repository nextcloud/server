OC.L10N.register(
    ...
    "Calendar" : "Kalenteri",
    "Language & locale" : "Kieli ja maa-asetusto",
    "Mobile & desktop" : "Mobiili ja työpöytä",
    "Artificial Intelligence" : "Tekoäly",
    "Email server" : "Sähköpostipalvelin",
    "Send emails using" : "Käytä sähköpostien lähettämiseen",
    "User's email account" : "Käyttäjän sähköpostitiliä",
    "System email account" : "Järjestelmän sähköpostitiliä",
    ...
    "Primary email address" : "Ensisijainen sähköpostiosoite",
    ...
    "Nextcloud profile" : "Nextcloud-profiili",
    ...
    "Failed to update account" : "Tilin päivittäminen epäonnistui",
    ...
    "Adding new account …" : "Lisätään uusi tili …",
    ...
    "Email sent successfully" : "Sähköpostiviesti lähetetty onnistuneesti",
    ...
    "Checking your server …" : "Tarkistetaan palvelinta …",
    ...
    "Search accounts and groups…" : "Etsi käyttäjiä ja ryhmiä…",
    "Location" : "Sijainti",
    ...
    "Follow us on Bluesky" : "Seuraa meitä Blueskyssa",
    ...
    "{name} enabled" : "{name} käytössä",
    "Best Nextcloud integration" : "Paras Nextcloud-integraatio",
    "Open source" : "Avoin lähdekoodi",
    "Good performance" : "Hyvä suorituskyky",
    "Best security: documents never leave your server" : "Paras turvallisuus: asiakirjat eivät koskaan lähde palvelimelta",
    "Best ODF compatibility" : "Paras ODF-yhteensopivuus",
    "Best support for legacy files" : "Paras tuki vanhahtaville tiedostoille",
    "Good Nextcloud integration" : "Hyvä Nextcloud-integraatio",
    "Open core" : "Avoin ydin",
    "Best performance" : "Paras suorituskyky",
    "Limited ODF compatibility" : "Rajoitettu ODF-yhteensopivuus",
    "Best Microsoft compatibility" : "Paras Microsoft-yhteensopivuus"
},
