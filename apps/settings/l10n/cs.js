OC.L10N.register(
    ...
    "for Argon2 for password hashing and Ed25519 signature verification for RFC 9421 http message signatures" : "pro Argon2 k hashování hesel a ověřování podpisů Ed25519 u podpisů HTTP zpráv podle RFC 9421",
    ...
    "\"%d\" is not a valid server identifier. It must be between 0 and 511." : "„%d“ není platný identifikátor serveru. Musí být v rozsahu 0 až 511.",
    ...
    "_Most tasks were successful in the last %n day._::_Most tasks were successful in the last %n days._" : ["Většina úloh byla v posledním %n dni úspěšná.","Většina úloh byla v posledních %n dnech úspěšná.","Většina úloh byla v posledních %n dnech úspěšná.","Většina úloh byla v posledních %n dnech úspěšná."],
    ...
    "Task Processing worker status" : "Stav spouštěče zpracování úloh",
    "_The Task Processing worker has run in the last %n minute._::_The Task Processing worker has run in the last %n minutes._" : ["Zpracovávací pracovník úloh běžel v poslední %n minutě.","Zpracovávací pracovník úloh běžel v posledních %n minutách.","Zpracovávací pracovník úloh běžel v posledních %n minutách.","Zpracovávací pracovník úloh běžel v posledních %n minutách."],
    "The Task Processing worker does not seem to be running. The last run was at %s." : "Zpracovávací pracovník úloh zřejmě neběží. Poslední spuštění bylo v %s.",
    "The Task Processing worker does not seem to be running. It seems it has never run so far." : "Zpracovávací pracovník úloh zřejmě neběží. Zdá se, že dosud nikdy neběžel.",
    ...
    "Hide legacy provider settings" : "Skrýt nastavení starého poskytovatele",
    "Show legacy provider settings" : "Zobrazit nastavení starého poskytovatele",
    ...
    "This API is deprecated. Install apps that provide Unified task processing to get the best experience." : "Toto API je zastaralé. Pro nejlepší zkušenost nainstalujte aplikace, které poskytují sjednocené zpracování úloh.",
    ...
    "Revoking now cancels the wipe. The device keeps its synced data." : "Okamžité odvolání vymazání zruší. Zařízení si zachová synchronizovaná data.",
    "Device" : "Zařízení",
    ...
    "_The Task Processing worker has run in the last minute._::_The Task Processing worker has run in the last %n minutes._" : ["Zpracovávací pracovník úloh běžel v poslední %n minutě.","Zpracovávací pracovník úloh běžel v posledních %n minutách.","Zpracovávací pracovník úloh běžel v posledních %n minutách.","Zpracovávací pracovník úloh běžel v posledních %n minutách."],
