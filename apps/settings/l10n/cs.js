OC.L10N.register(
    ...
    "You deleted app password \"{token}\" and cancelled its pending remote wipe" : "Smazali jste heslo aplikace „{token}“ a zrušili jeho čekající vzdálené vymazání",
    ...
    "for Argon2 for password hashing and Ed25519 signature verification for RFC 9421 http message signatures" : "pro Argon2 pro vytváření otisků z hesel a ověřování podpisů Ed25519 u podpisů HTTP zpráv podle normy RFC 9421",
    ...
    "Sanitize and merge duplicate system tags available" : "Poklidit a spojit dostupné duplikované štítky v systému",
    ...
    "\"%d\" is not a valid server identifier. It must be between 0 and 511." : "„%d“ není platný identifikátor serveru. Je třeba, aby byl z rozsahu 0 až 511.",
    "Server identifier is configured and valid." : "Identifikátor serveru je nastaven a platný.",
    "Database version" : "Verze databáze",
    "MariaDB version 10.6 detected, this version is end-of-life and only supported as part of Ubuntu 22.04. MariaDB >=%1$s and <=%2$s is suggested for best performance, stability and functionality with this version of Nextcloud." : "Zjištěna MariaDB verze 10.6. Tato verze je na konci životnosti a je podporována pouze jako součást Ubuntu 22.04. Pro nejlepší výkon, stabilitu a funkčnost s touto verzí Nextcloudu je doporučena MariaDB >=%1$s a <=%2$s.",
    ...
    "Task Processing success rate" : "Úspěšnost zpracování úloh",
    "_No scheduled tasks in the last %n day._::_No scheduled tasks in the last %n days._" : ["Žádný naplánovaný úkol v uplynulém %n dni.","Žádné naplánované úkoly v uplynulých %n dnech.","Žádné naplánované úkoly v uplynulých %n dnech.","Žádné naplánované úkoly v uplynulých %n dnech."],
    "_Most tasks were successful in the last %n day._::_Most tasks were successful in the last %n days._" : ["Většina úloh byla v uplynulém %n dni úspěšná.","Většina úloh byla v uplynulých %n dnech úspěšná.","Většina úloh byla v uplynulých %n dnech úspěšná.","Většina úloh byla v uplynulých %n dnech úspěšná."],
    ...
    "Task Processing worker status" : "Stav vlákna zpracovávání úloh",
    "_The Task Processing worker has run in the last %n minute._::_The Task Processing worker has run in the last %n minutes._" : ["Vlákno pro zpracovávání úloh běželo v uplynulé %n minutě.","Vlákno pro zpracovávání úloh běželo v uplynulých %n minutách.","Vlákno pro zpracovávání úloh běželo v uplynulých %n minutách.","Vlákno pro zpracovávání úloh běželo v uplynulých %n minutách."],
    "The Task Processing worker does not seem to be running. The last run was at %s." : "Vlákno pro zpracovávání úloh zřejmě není spuštěné. Poslední spuštění bylo v %s.",
    "The Task Processing worker does not seem to be running. It seems it has never run so far." : "Vlákno pro zpracovávání úloh zřejmě není spuštěné. Zdá se, že dosud nikdy nebylo.",
    ...
    "Hide legacy provider settings" : "Skrýt stará nastavení poskytovatele",
    "Show legacy provider settings" : "Zobrazit stará nastavení poskytovatele",
    "Machine translation (Legacy)" : "Strojový překlad (starší verze)",
    ...
    "This API is deprecated. Install apps that provide Unified task processing to get the best experience." : "Toto API je zastaralé. Pro nejlepší dojem z používání nainstalujte aplikace, které poskytují sjednocené zpracování úloh.",
    "Learn more about AI providers" : "Další informace o poskytovatelích AI",
    "Image generation (Legacy)" : "Generování obrázků (starší verze)",
    ...
    "Text processing (Legacy)" : "Zpracování textu (starší verze)",
    ...
    "Revoke and cancel pending wipe?" : "Odvolat a zrušit čekající vzdálené vymazání?",
    "Only continue if you no longer need the device to be wiped." : "Pokračujte jen pokud už nepotřebujete, aby bylo zařízení vymazáno.",
    "Revoke and cancel wipe" : "Odvolat a zrušit vymazání",
    "Revoke app password?" : "Odvolat heslo aplikace?",
    "The app or device will lose access on its next sync. This cannot be undone." : "Aplikace nebo zařízení ztratí přístup při příští synchronizaci. Tuto akci nelze vrátit zpět.",
    "Remote wipe has not started yet." : "Vzdálené vymazání ještě nebylo zahájeno.",
    "Revoking now cancels the wipe. The device keeps its synced data." : "Odvolání nyní zruší vymazání. Zařízení si zachová synchronizovaná data.",
    "Device" : "Zařízení",
    ...
    "Bluesky handle" : "Bluesky identifikátor",
    ...
    "Failed to update account" : "Nepodařilo se aktualizovat účet",
    ...
    "Adding new account …" : "Přidávání nového účtu …",
    ...
    "Search for a manager…" : "Hledat správce…",
    "Quota" : "Kvóta",
    ...
    "Search accounts and groups…" : "Hledat účty a skupiny…",
    ...
    "_The Task Processing worker has run in the last minute._::_The Task Processing worker has run in the last %n minutes._" : ["Vlákno zpracovávající úlohu běželo v uplynulé minutě.","Vlákno zpracovávající úlohu běželo v uplynulých %n minutách.","Vlákno zpracovávající úlohu běželo v uplynulých %n minutách.","Vlákno zpracovávající úlohu běželo v uplynulých %n minutách."],
