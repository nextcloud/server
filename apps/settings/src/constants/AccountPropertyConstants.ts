...
export const NAME_READABLE_ENUM = Object.freeze({
	...
	[ACCOUNT_PROPERTY_ENUM.BSKY]: ACCOUNT_PROPERTY_READABLE_ENUM.BSKY,
...
export const PROPERTY_READABLE_KEYS_ENUM = Object.freeze({
	...
	[ACCOUNT_PROPERTY_READABLE_ENUM.BSKY]: ACCOUNT_PROPERTY_ENUM.BSKY,
...
export const PROPERTY_READABLE_SUPPORTED_SCOPES_ENUM = Object.freeze({
	...
	[ACCOUNT_PROPERTY_READABLE_ENUM.BSKY]: [SCOPE_ENUM.LOCAL, SCOPE_ENUM.PRIVATE],
