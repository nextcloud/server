...
export const ACCOUNT_PROPERTY_ENUM = Object.freeze({
	...
	PHONE_COLLECTION: 'additional_phone',
	PHONE: 'phone',
...
export const ACCOUNT_PROPERTY_READABLE_ENUM = Object.freeze({
	...
	PHONE_COLLECTION: t('settings', 'Additional phone number'),
...
export const NAME_READABLE_ENUM = Object.freeze({
	...
	[ACCOUNT_PROPERTY_ENUM.PHONE_COLLECTION]: ACCOUNT_PROPERTY_READABLE_ENUM.PHONE_COLLECTION,
...
export const PROPERTY_READABLE_KEYS_ENUM = Object.freeze({
	...
	[ACCOUNT_PROPERTY_READABLE_ENUM.PHONE_COLLECTION]: ACCOUNT_PROPERTY_ENUM.PHONE_COLLECTION,
...
export const PROPERTY_READABLE_SUPPORTED_SCOPES_ENUM = Object.freeze({
	...
	[ACCOUNT_PROPERTY_READABLE_ENUM.PHONE_COLLECTION]: [SCOPE_ENUM.LOCAL],
...
/** Default additional phone scope */
export const DEFAULT_ADDITIONAL_PHONE_SCOPE = SCOPE_ENUM.LOCAL
