...
import { NcAppContent, NcAppNavigation, NcAppNavigationCounter, NcAppNavigationItem, NcAppNavigationSpacer, NcAppSidebar, NcAppSidebarTab, NcContent } from '@nextcloud/vue'
