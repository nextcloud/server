...
class BackendTest extends TestCase {
	...
	public function testGetParents() {
		...
		$this->assertTrue(\OC\Share\Share::shareItem('folder', $fileinfo1['fileid'], \OC\Share\Share::SHARE_TYPE_USER,
				self::TEST_FILES_SHARING_API_USER2, 31));
		$this->assertTrue(\OC\Share\Share::shareItem('folder', $fileinfo2['fileid'], \OC\Share\Share::SHARE_TYPE_USER,
