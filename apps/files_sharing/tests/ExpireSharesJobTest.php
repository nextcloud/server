...
class ExpireSharesJobTest extends \Test\TestCase {
	...
	public function testExpireLinkShare($addExpiration, $interval, $addInterval, $shouldExpire) {
		...
		$this->assertNotNull(
			\OC\Share\Share::shareItem('folder', $fileInfo->getId(), \OC\Share\Share::SHARE_TYPE_LINK, null, \OCP\Constants::PERMISSION_READ),
	...
	public function testDoNotExpireOtherShares() {
		...
		$this->assertNotNull(
			\OC\Share\Share::shareItem('folder', $fileInfo->getId(), \OC\Share\Share::SHARE_TYPE_USER, $this->user2, \OCP\Constants::PERMISSION_READ),
