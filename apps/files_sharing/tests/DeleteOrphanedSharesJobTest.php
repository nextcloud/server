...
class DeleteOrphanedSharesJobTest extends \Test\TestCase {
	...
	public function testClearShares() {
		...
		$this->assertTrue(
			\OC\Share\Share::shareItem('folder', $fileId, \OC\Share\Share::SHARE_TYPE_USER, $this->user2, \OCP\Constants::PERMISSION_READ),
	...
	public function testKeepNonFileShares() {
		...
		$this->assertTrue(
			\OC\Share\Share::shareItem('test', 'test.txt', \OC\Share\Share::SHARE_TYPE_USER, $this->user2, \OCP\Constants::PERMISSION_READ),
