...
class ApiTest extends TestCase {
	...
	function testCreateShareUserFile() {
		...
		$result = $ocs->createShare($this->filename, \OCP\Constants::PERMISSION_ALL, \OC\Share\Share::SHARE_TYPE_USER, self::TEST_FILES_SHARING_API_USER2);
		$ocs->cleanup();
	...
	function testCreateShareUserFolder() {
		$ocs = $this->createOCS(self::TEST_FILES_SHARING_API_USER1);
		$result = $ocs->createShare($this->folder, \OCP\Constants::PERMISSION_ALL, \OC\Share\Share::SHARE_TYPE_USER, self::TEST_FILES_SHARING_API_USER2);
		$ocs->cleanup();
	...
	function testCreateShareGroupFile() {
		$ocs = $this->createOCS(self::TEST_FILES_SHARING_API_USER1);
		$result = $ocs->createShare($this->filename, \OCP\Constants::PERMISSION_ALL, \OC\Share\Share::SHARE_TYPE_GROUP, self::TEST_FILES_SHARING_API_GROUP1);
		$ocs->cleanup();
	...
	function testCreateShareGroupFolder() {
		$ocs = $this->createOCS(self::TEST_FILES_SHARING_API_USER1);
		$result = $ocs->createShare($this->folder, \OCP\Constants::PERMISSION_ALL, \OC\Share\Share::SHARE_TYPE_GROUP, self::TEST_FILES_SHARING_API_GROUP1);
		$ocs->cleanup();
	...
	public function testCreateShareLink() {
		$ocs = $this->createOCS(self::TEST_FILES_SHARING_API_USER1);
		$result = $ocs->createShare($this->folder, \OCP\Constants::PERMISSION_ALL, \OC\Share\Share::SHARE_TYPE_LINK);
		$ocs->cleanup();
	...
	public function testCreateShareLinkPublicUpload() {
		$ocs = $this->createOCS(self::TEST_FILES_SHARING_API_USER1);
		$result = $ocs->createShare($this->folder, \OCP\Constants::PERMISSION_ALL, \OC\Share\Share::SHARE_TYPE_LINK, null, 'true');
		$ocs->cleanup();
	...
	function testEnfoceLinkPassword() {
		...
		$ocs = $this->createOCS(self::TEST_FILES_SHARING_API_USER1);
		try {
			$ocs->createShare($this->folder, \OCP\Constants::PERMISSION_ALL, \OC\Share\Share::SHARE_TYPE_LINK);
			$this->fail();
		...
		$ocs = $this->createOCS(self::TEST_FILES_SHARING_API_USER1);
		try {
			$ocs->createShare($this->folder, \OCP\Constants::PERMISSION_ALL, \OC\Share\Share::SHARE_TYPE_LINK, null, 'false', '');
			$this->fail();
		} catch (OCSForbiddenException $e) {
		...
		$ocs = $this->createOCS(self::TEST_FILES_SHARING_API_USER1);
		$result = $ocs->createShare($this->folder, \OCP\Constants::PERMISSION_ALL, \OC\Share\Share::SHARE_TYPE_LINK, null, 'false', $password);
		$ocs->cleanup();
	...
	*/
	function testSharePermissions() {
		...
		$ocs = $this->createOCS(self::TEST_FILES_SHARING_API_USER1);
		$ocs->createShare($this->filename, \OCP\Constants::PERMISSION_ALL, \OC\Share\Share::SHARE_TYPE_USER, self::TEST_FILES_SHARING_API_USER2);
		$ocs->cleanup();
	...
	function testGetAllShares() {
		...
		$share->setNode($node)
			...
			->setShareType(\OC\Share\Share::SHARE_TYPE_USER)
			->setPermissions(19);
	...
	function testGetShareFromSource() {
		...
		$share->setNode($node)
			->setSharedBy(self::TEST_FILES_SHARING_API_USER1)
			->setShareType(\OC\Share\Share::SHARE_TYPE_LINK)
			->setPermissions(1);
	...
	function testDeleteShare() {
		...
		$this->assertEmpty($this->shareManager->getSharesBy(self::TEST_FILES_SHARING_API_USER2, \OC\Share\Share::SHARE_TYPE_USER));
		$this->assertEmpty($this->shareManager->getSharesBy(self::TEST_FILES_SHARING_API_USER2, \OC\Share\Share::SHARE_TYPE_LINK));
	}
	...
	public function XtestShareNonExisting() {
		...
		$id = PHP_INT_MAX - 1;
		\OC\Share\Share::shareItem('file', $id, \OC\Share\Share::SHARE_TYPE_LINK, self::TEST_FILES_SHARING_API_USER2, 31);
	}
	...
	public function testShareNotOwner() {
		...
		\OC\Share\Share::shareItem('file', $info->getId(), \OC\Share\Share::SHARE_TYPE_LINK, self::TEST_FILES_SHARING_API_USER2, 31);
	}
	...
	public function testDefaultExpireDate() {
		...
		$result = \OC\Share\Share::shareItem('file', $info->getId(), \OC\Share\Share::SHARE_TYPE_LINK, null, \OCP\Constants::PERMISSION_READ);
		$this->assertTrue(is_string($result));

		$result = \OC\Share\Share::shareItem('file', $info->getId(), \OC\Share\Share::SHARE_TYPE_USER, self::TEST_FILES_SHARING_API_USER2, 31);
		$this->assertTrue($result);

		$result = \OC\Share\Share::setExpirationDate('file', $info->getId() , $expireDate, $now);
		$this->assertTrue($result);
		...
		$result = $query->execute(array($shareCreated, \OC\Share\Share::SHARE_TYPE_LINK));
		$this->assertSame(1, $result);
		$query = \OCP\DB::prepare($statement);
		$result = $query->execute(array($shareCreated, \OC\Share\Share::SHARE_TYPE_USER));
		$this->assertSame(1, $result);

		// now the link share should expire because of enforced default expire date
		// the user share should still exist
		$result = \OC\Share\Share::getItemShared('file', $info->getId());
		$this->assertTrue(is_array($result));
		$this->assertSame(1, count($result));
		$share = reset($result);
		$this->assertSame(\OC\Share\Share::SHARE_TYPE_USER, $share['share_type']);

		//cleanup
		$result = \OC\Share\Share::unshare('file', $info->getId(), \OC\Share\Share::SHARE_TYPE_USER, self::TEST_FILES_SHARING_API_USER2);
		$this->assertTrue($result);
		$config->setAppValue('core', 'shareapi_default_expire_date', 'no');
		$config->setAppValue('core', 'shareapi_enforce_expire_date', 'no');
	...
	public function testPublicLinkExpireDate($date, $valid) {
		...
		try {
			$result = $ocs->createShare($this->folder, \OCP\Constants::PERMISSION_ALL, \OC\Share\Share::SHARE_TYPE_LINK, null, 'false', '', $date);
	...
	public function testCreatePublicLinkExpireDateValid() {
		...
		$ocs = $this->createOCS(self::TEST_FILES_SHARING_API_USER1);
		$result = $ocs->createShare($this->filename, \OCP\Constants::PERMISSION_ALL, \OC\Share\Share::SHARE_TYPE_LINK, null, 'false', '', $date->format('Y-m-d'));
		$ocs->cleanup();
	...
	public function testCreatePublicLinkExpireDateInvalidFuture() {
		...
		try {
			$ocs->createShare($this->filename, \OCP\Constants::PERMISSION_ALL, \OC\Share\Share::SHARE_TYPE_LINK, null, 'false', '', $date->format('Y-m-d'));
			$this->fail();
