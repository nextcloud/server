OC.L10N.register(
    ...
    "Please specify a valid federated account ID" : "請指定有效的聯邦帳戶 ID",
    "Please specify a valid federated group ID" : "請指定一個有效的聯邦群組 ID",
    ...
    "Direct link" : "直接連結",
    "You are not allowed to share \"%s\"." : "您無權分享「%s」。",
    "You cannot share your home folder." : "您無法分享您的家資料夾。",
    "File cannot be shared with delete permission." : "無法分享具有刪除權限的檔案。",
    "File cannot be shared with create permission." : "無法分享具有新建權限的檔案。",
    ...
    "Name, email, or Federated Cloud ID …" : "名字、電郵地址或聯邦雲端 ID …",
    "Searching …" : "搜尋中 …",
    ...
    "Share files with others outside your organization via public links and email addresses. You can also share to {productName} accounts on other instances using their federated cloud ID." : "透過公開連結與電郵地址與組織外的其他人分享檔案。您也可以使用其他站台上的聯邦雲端 ID 將檔案分享至 {productName} 帳戶。",
    ...
    "Do you want to accept this share?" : "你要接受此分享嗎？",
