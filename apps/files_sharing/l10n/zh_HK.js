OC.L10N.register(
    ...
    "Please specify a valid account to share with" : "請指定要分享的有效賬戶",
    ...
    "Please specify a valid federated account ID" : "請指定有效的聯盟賬戶 ID",
    ...
    "Sharing" : "分享",
    "Accept shares from other accounts and groups by default" : "預設接受其他賬戶與群組的分享",
    ...
    "No other accounts with access found" : "找不到其他擁有存取權限的賬戶",
