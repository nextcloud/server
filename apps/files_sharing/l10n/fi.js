OC.L10N.register(
    ...
    "You are not allowed to edit incoming shares" : "Sinulla ei ole oikeutta muokata saapuvia jakoja",
    ...
    "You are not allowed to share \"%s\"." : "Sinulla ei ole oikeutta jakaa \"%s\".",
    "You cannot share your home folder." : "Et voi jakaa kotikansiotasi.",
    ...
    "Your administrator has enforced a {count} days expiration policy." : "Ylläpitäjä on pakottanut {count} päivän vanhenemiskäytännön.",
    ...
    "_{count} email address already added_::_{count} email addresses already added_" : ["{count} sähköpostiosoite on jo lisätty","{count} sähköpostiosoitetta on jo lisätty"],
    "_{count} email address added_::_{count} email addresses added_" : ["{count} sähköpostiosoite lisätty","{count} sähköpostiosoitetta lisätty"],
    ...
    "Error sending emails: {errorMessage}" : "Virhe sähköposteja lähettäessä: {errorMessage}",
    "Error sending emails" : "Virhe sähköposteja lähettäessä",
    "Create a file request" : "Luo tiedostopyyntö",
    "File request" : "Tiedostopyyntö",
    "Previous step" : "Edellinen vaihe",
    "Cancel" : "Peruuta",
    "Cancel the file request creation" : "Peru tiedostopyynnön luominen",
    "Close without sending emails" : "Sulje lähettämättä sähköposteja",
    "Continue" : "Jatka",
    ...
    "Share expiration: {date}" : "Jaon vanheneminen: {date}",
    "Share Expiration" : "Jaon vanheneminen",
    "group" : "ryhmä",
    ...
    "Copy public link of \"{title}\"" : "Kopioi kohteen \"{title}\" julkinen linkki",
    ...
    "Enable link expiration (enforced)" : "Ota käyttöön linkin vanheneminen (pakotettu)",
    "Enable link expiration" : "Ota käyttöön linkin vanheneminen",
    "Enter expiration date (enforced)" : "Syötä vanhenemispäivä (pakotettu)",
    "Enter expiration date" : "Syötä vanhenemispäivä",
    ...
    "People" : "Ihmiset",
    "Create file request" : "Luo tiedostopyyntö",
    "Upload files to {foldername}" : "Lähetä tiedostot kansioon {foldername}",
    ...
    "Publicly shared files." : "Julkisesti jaetut tiedostot.",
    ...
    "\"{char}\" is not allowed inside a name." : "\"{char}\" ei ole sallittu nimessä.",
    "\"{extension}\" is not an allowed name." : "\"{extension}\" ei ole sallittu nimi.",
    ...
    "Do you want to accept this share?" : "Hyväksytkö tämän jaon?",
