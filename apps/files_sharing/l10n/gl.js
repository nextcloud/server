OC.L10N.register(
    ...
    "No Nextcloud installation (7 or higher) found at {remote}" : "Non se atopa unha instalación de Nextcloud (7 ou superior) en {remote}",
    "Invalid Nextcloud url" : "URL incorrecto do Nextcloud",
