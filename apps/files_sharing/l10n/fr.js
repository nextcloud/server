OC.L10N.register(
    ...
    "{actor} removed themselves" : "{actor} a quitté le partage",
    ...
    "{actor} removed themselves from {file}" : "{actor} a quitté le partage de {file}",
    ...
    "Please specify a file or folder path" : "Veuillez indiquer le chemin d’un fichier ou d’un dossier",
    "Wrong path, file/folder does not exist" : "Chemin incorrect, le fichier ou le dossier n’existe pas",
    ...
    "Sharing %s sending the password by Nextcloud Talk failed because Nextcloud Talk is not enabled" : "Le partage de %s avec envoi du mot de passe par Nextcloud Talk a échoué, car Nextcloud Talk n’est pas activé.",
    "Please specify a valid federated account ID" : "Veuillez indiquer un ID de compte fédéré valide",
    "Please specify a valid federated group ID" : "Veuillez indiquer un ID de groupe fédéré valide",
    "You cannot share to a Team if the app is not enabled" : "Vous ne pouvez pas partager avec une équipe si l’application n’est pas activée",
    "Please specify a valid team" : "Veuillez indiquer une équipe valide",
    "Sharing %s failed because the back end does not support room shares" : "Le partage de %s dans une conversation Talk a échoué, car ce type de partage n’est pas pris en charge.",
    ...
    "Public upload is only possible for publicly shared folders" : "Le téléversement public n’est possible que pour les dossiers partagés publiquement",
    "Share must at least have READ or CREATE permissions" : "Le partage doit disposer au minimum des permissions LECTURE ou CRÉATION",
    "Share must have READ permission if UPDATE or DELETE permission is set" : "Le partage doit disposer de la permission LECTURE si la permission MISE À JOUR ou SUPPRESSION est définie",
    ...
    "Wrong or no update parameter given" : "Paramètre de mise à jour incorrect ou absent",
    "\"Sending the password by Nextcloud Talk\" for sharing a file or folder failed because Nextcloud Talk is not enabled." : "« L’envoi du mot de passe par Nextcloud Talk » lors du partage d’un fichier ou d’un dossier a échoué, car Nextcloud Talk n’est pas activé.",
    ...
    "Tokens must be between 1 and %s characters long and may only contain letters, numbers, or a hyphen" : "Les jetons doivent comporter entre 1 et %s caractères et ne peuvent contenir que des lettres, des chiffres ou un trait d’union.",
    ...
    "You cannot share your home folder." : "Vous ne pouvez pas partager votre dossier personnel.",
    "File cannot be shared with delete permission." : "Impossible de partager un fichier avec l'autorisation de suppression.",
    "File cannot be shared with create permission." : "Impossible de partager un fichier avec l'autorisation de création.",
    "File share needs at least read permission." : "Le partage du fichier doit au minimum inclure l'autorisation de lecture.",
    "Public upload is not allowed." : "Le téléversement public n'est pas autorisé.",
    "You cannot share \"%s\" with more permission than you have yourself." : "Vous ne pouvez pas partager « %s » avec des autorisations supérieures à celles dont vous disposez.",
    ...
    "Open \"%s\"" : "Ouvrir \"%s\"",
    "This application enables people to share files within Nextcloud. If enabled, the admin can choose which groups can share files. The applicable people can then share files and folders with other accounts and groups within Nextcloud. In addition, if the admin enables the share link feature, an external link can be used to share files with other people outside of Nextcloud. Admins can also enforce passwords, expirations dates, and enable server to server sharing via share links, as well as sharing from mobile devices.\nTurning the feature off removes shared files and folders on the server for all share recipients, and also on the sync clients and mobile apps. More information is available in the Nextcloud Documentation." : "Cette application permet de partager des fichiers dans Nextcloud. Lorsqu’elle est activée, l’administration peut choisir les groupes autorisés à partager des fichiers. Les utilisateurs concernés peuvent ensuite partager des fichiers et des dossiers avec d’autres comptes et groupes dans Nextcloud. Si l’administration active la fonctionnalité de lien de partage, un lien externe peut également servir à partager des fichiers avec des personnes extérieures à Nextcloud. L’administration peut aussi imposer une protection par mot de passe et des dates d’expiration, activer le partage entre serveurs via des liens de partage, ainsi que le partage depuis des appareils mobiles.\n\nLa désactivation de cette fonctionnalité supprime les fichiers et dossiers partagés du serveur pour tous les destinataires, ainsi que des clients de synchronisation et des applications mobiles. Plus d’informations sont disponibles dans la documentation Nextcloud.",
    ...
    "_The following email address is not valid: {emails}_::_The following email addresses are not valid: {emails}_" : ["L’adresse e-mail suivante n’est pas valide : {emails}","Les adresses e-mail suivantes ne sont pas valides : {emails}","Les adresses e-mail suivantes ne sont pas valides : {emails}"],
    ...
    "Close" : "Fermer",
    "_Send email and close_::_Send {count} emails and close_" : ["Envoyer l’e-mail et fermer","Envoyer {count} e-mails et fermer","Envoyer {count} e-mails et fermer"],
    ...
    "File request created" : "Demande de fichiers créée",
    "_File request created and email sent_::_File request created and {count} emails sent_" : ["Demande de fichiers créée et e-mail envoyé","Demande de fichiers créée et {count} e-mails envoyés","Demande de fichiers créée et {count} e-mails envoyés"],
    "Error creating the share: {errorMessage}" : "Erreur lors de la création du partage : {errorMessage}",
    "Error creating the share" : "Erreur lors de la création du partage",
    "Error sending emails: {errorMessage}" : "Erreur lors de l’envoi des e-mails : {errorMessage}",
    "Error sending emails" : "Erreur lors de l’envoi des e-mails",
    "Create a file request" : "Créer une demande de fichiers",
    ...
    "File request" : "Demande de fichiers",
    "Previous step" : "Étape précédente",
    "Cancel" : "Annuler",
    "Cancel the file request creation" : "Annuler la création de la demande de fichiers",
    "Close without sending emails" : "Fermer sans envoyer d’e-mails",
    "Continue" : "Continuer",
    "Error while toggling options" : "Erreur lors de l’activation ou de la désactivation des options",
    ...
    "Choose a default folder for accepted shares" : "Choisir un dossier par défaut pour les partages acceptés",
    ...
    "Reset" : "Réinitialiser",
    "Reset folder to system default" : "Rétablir le dossier par défaut du système",
    ...
    "Unshare \"{folder}\"" : "Ne plus partager « {folder} »",
    ...
    "Shared via link by {initiator}" : "Partagé via un lien par {initiator}",
    "File request ({label})" : "Demande de fichiers ({label})",
    "Mail share ({label})" : "Partage par e-mail ({label})",
    "Share link ({label})" : "Lien de partage ({label})",
    "Mail share" : "Partage par e-mail",
    ...
    "Error, please enter proper password and/or expiration date" : "Erreur. Veuillez saisir un mot de passe valide, une date d’expiration valide ou les deux",
    ...
    "Remove recipient" : "Retirer le destinataire",
    "Note from" : "Note de",
    "Note:" : "Note :",
    "File drop" : "Dépôt de fichier",
    "Upload files to {foldername}." : "Téléverser les fichiers dans {foldername}.",
    ...
    "Share with email {email}" : "Partager via l’adresse e-mail {email}",
    ...
    "No other accounts with access found" : "Aucun autre compte ayant accès n’a été trouvé",
    "Toggle list of others with access to this directory" : "Afficher ou masquer la liste des autres personnes ayant accès à ce dossier",
    "Toggle list of others with access to this file" : "Afficher ou masquer la liste des autres personnes ayant accès à ce fichier",
    ...
    "People" : "Personnes",
    "Create file request" : "Créer une demande de fichiers",
    "Upload files to {foldername}" : "Téléverser des fichiers dans {foldername}",
    "Public file share" : "Partage public de fichiers",
    "Publicly shared file." : "Fichier partagé publiquement.",
    "No file" : "Aucun fichier",
    "The file shared with you will show up here" : "Le fichier partagé avec vous apparaîtra ici",
    "Public share" : "Partage public",
    "Publicly shared files." : "Fichiers partagés publiquement.",
    "No files" : "Aucun fichier",
    "Files and folders shared with you will show up here" : "Les fichiers et dossiers partagés avec vous apparaîtront ici",
    "Overview of shared files." : "Vue d'ensemble des fichiers partagés.",
    "No shares" : "Aucun partage",
    "Files and folders you shared or have been shared with you will show up here" : "Les fichiers et dossiers que vous avez partagés ou que d’autres ont partagés avec vous apparaîtront ici",
    ...
    "No file requests" : "Aucune demande de fichiers",
    ...
    "Shares you have received but not approved will show up here" : "Les partages que vous avez reçus mais pas encore acceptés apparaîtront ici",
    ", " : ", ",
    "_Reshared with %n person_::_Reshared with %n people_" : ["Repartagé avec %n personne","Repartagé avec %n personnes","Repartagé avec %n personnes"],
    ...
    "Share label saved" : "Libellé du partage enregistré",
    ...
    "Share permissions saved" : "Permissions de partage enregistrées",
    ...
    "Do you want to accept this share?" : "Voulez-vous accepter ce partage ?",
    ...
    "Public link sharing is disabled by the administrator" : "Le partage par lien public a été désactivé par l’administrateur",
    "Sharing %1$s failed because the back end does not allow shares from type %2$s" : "Le partage de %1$s a échoué, car le serveur n’autorise pas les partages de type %2$s",
    "Sharing %s failed because the back end does not support ScienceMesh shares" : "Le partage de %s a échoué, car le serveur ne prend pas en charge les partages ScienceMesh",
