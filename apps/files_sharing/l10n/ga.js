OC.L10N.register(
    ...
    "You cannot share your home folder." : "Ní féidir leat d’fhillteán baile a roinnt.",
    "File cannot be shared with delete permission." : "Ní féidir comhad a roinnt le cead scriosta.",
    "File cannot be shared with create permission." : "Ní féidir comhad a roinnt le cead cruthaithe.",
    "File share needs at least read permission." : "Teastaíonn cead léite ar a laghad le haghaidh comhroinnt comhad.",
    "Public upload is not allowed." : "Ní cheadaítear uaslódáil phoiblí.",
    "You cannot share \"%s\" with more permission than you have yourself." : "Ní féidir leat \"%s\" a roinnt le níos mó ceadanna ná mar atá agat féin.",
    ...
    "Unshare \"{folder}\"" : "Cealaigh comhroinnt \"{folder}\"",
    "Unshare" : "Díroinnte",
    ...
    "For people who already have access" : "Do dhaoine a bhfuil rochtain acu cheana féin",
    ...
    "Copy public link of \"{title}\"" : "Cóipeáil nasc poiblí \"{title}\"",
    ...
    "Delete" : "Scrios",
    "Are you sure you want to delete this share? This operation cannot be undone." : "An bhfuil tú cinnte gur mhaith leat an scair seo a scriosadh? Ní féidir an oibríocht seo a chealú.",
    "Edit share" : "Cuir in eagar agus roinn",
    "Toggle recipients" : "Scoránaigh na faighteoirí",
    "Remove recipient" : "Bain an faighteoir",
    "Note from" : "Nóta ó",
    "Note:" : "Nóta:",
    ...
    "Type names, teams, federated cloud IDs" : "Ainmneacha clóscríofa, foirne, aitheantóirí scamall cónaidhme",
    "Type names or teams" : "Clóscríobh ainmneacha nó foirne",
    "Type a federated cloud ID" : "Clóscríobh ID scamall cónaidhme",
    "Type an email" : "Clóscríobh ríomhphost",
    "Type an email or federated cloud ID" : "Clóscríobh ríomhphost nó aitheantóir scamall cónaidhme",
    ...
    ", " : ", ",
    "_Reshared with %n person_::_Reshared with %n people_" : ["Athroinnte le %n duine","Athroinnte le %n duine","Athroinnte le %n duine","Athroinnte le %n duine","Athroinnte le %n duine"],
    ...
    "Do you want to accept this share?" : "Ar mhaith leat glacadh leis an sciar seo?",
