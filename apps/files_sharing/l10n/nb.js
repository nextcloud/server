OC.L10N.register(
    ...
    "Your administrator has enforced a default expiration date with a maximum {days} days." : "Systemansvarlig har fremtvunget en standard utløpsdato med maksimum {days} dager.",
    "When should the request expire?" : "Når skal forespørselen utløpe?",
    "Set a submission expirationDate" : "Angi en utløpsdato for en sending",
    ...
    "Once created, you can share the link below to allow people to upload files to your directory." : "Når den er opprettet, kan du dele lenken nedenfor for å tillate folk å laste opp filer til katalogen din.",
    ...
    "File request created and emails sent" : "Filforespørsel opprettet og e-poster sendt",
    ...
    "_Close and send email_::_Close and send {count} emails_" : ["Lukk og send e-post","Lukk og send {count} e-poster"],
    "Sharing" : "Deling",
    ...
    "Create new file request" : "Opprett ny filforespørsel",
    "Shared by" : "Delt av",
