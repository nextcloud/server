OC.L10N.register(
    ...
    "Your administrator has enforced a default expiration date with a maximum {days} days." : "Din administratör har tillämpat ett standardutgångsdatum med ett maximum av {days} dagar.",
    "When should the request expire?" : "När ska begäran löpa ut?",
    "Set a submission expirationDate" : "Ställ in utgångsdatum för inlämning",
    ...
    "Once created, you can share the link below to allow people to upload files to your directory." : "När du har skapat den kan du dela länken nedan för att tillåta andra att ladda upp filer till din mapp.",
    ...
    "File request created and emails sent" : "Filförfrågan skapad och e-postmeddelanden skickade",
    ...
    "_Close and send email_::_Close and send {count} emails_" : ["Stäng och skicka e-post","Stäng och skicka {count} e-postmeddelanden"],
    "Sharing" : "Delning",
    ...
    "Create new file request" : "Skapa ny filbegäran",
    "Shared by" : "Delad av",
