OC.L10N.register(
    ...
    "{user} accepted the remote share" : "{user} priėmė nuotolinį bendrinimą",
    "{user} declined the remote share" : "{user} atmetė nuotolinį bendrinimą",
    "You received a new remote share {file} from {user}" : "Jūs iš {user} gavote naują nuotolinį bendrinimą „{file}“",
    "{user} accepted the remote share of {file}" : "{user} priėmė nuotolinį bendrinimą „{file}“",
    "{user} declined the remote share of {file}" : "{user} atmetė nuotolinį bendrinimą „{file}“",
    "{user} unshared {file} from you" : "{user} nustojo bendrinti su jumis {file}",
    "Shared with {user}" : "Pradėta bendrinti su {user}",
    "Removed share for {user}" : "Pašalintas bendrinimas su {user}",
    ...
    "{actor} removed share for {user}" : "{actor} pašalino bendrinimą su {user}",
    "Shared by {actor}" : "Bendrina {actor}",
    "{actor} removed share" : "{actor} pašalino bendrinimą",
    "Share for {user} expired" : "Pasibaigė bendrinimo su  {user} galiojimo laikas",
    "Share expired" : "Bendrinimas nebegalioja",
    ...
    "Share for file {file} expired" : "Failo {file} bendrinimas nebegalioja",
    ...
    "Sharing" : "Bendrinimas",
    "A file or folder has been <strong>shared</strong>" : "Failas ar aplankas <strong>bendrintas</strong>",
    "Shared link" : "Bendrinama nuoroda",
    "Wrong share ID, share does not exist" : "Neteisingas bendrinimo ID, bendrinimo nėra",
    "Could not delete share" : "Nepavyko ištrinti bendrinimo",
    ...
    "Sharing %s sending the password by Nextcloud Talk failed because Nextcloud Talk is not enabled" : "Nepavyko išsiųsti slaptažodžio bendrinimui %s panaudojant „Nextcloud Pokalbiai“, kadangi „Nextcloud Pokalbiai“ neįjungtas ",
    ...
    "\"Sending the password by Nextcloud Talk\" for sharing a file or folder failed because Nextcloud Talk is not enabled." : "„Siųsti slaptažodį per „Nextcloud Pokalbiai““, norint pasidalinti failu ar aplanku, nepavyko, nes „Nextcloud Pokalbiai“ nėra įjungta.",
    ...
    "Tokens must be between 1 and %s characters long and may only contain letters, numbers, or a hyphen" : "Žymenys turi būti nuo 1 iki %s simbolių ilgio ir gali būti sudaryti tik iš raidžių, skaičių arba brūkšnelio.",
    ...
    "You cannot share your home folder." : "Jūs negalite bendrinti savo namų aplanko.",
    "File cannot be shared with delete permission." : "Failo negalima bendrinti suteikiant teisę jį ištrinti.",
    "File cannot be shared with create permission." : "Failo negalima bendrinti suteikiant leidimą kurti.",
    "File share needs at least read permission." : "Norint naudotis bendrai naudojamu failu, reikia turėti bent jau skaitymo teises.",
    "Public upload is not allowed." : "Viešas įkėlimas nėra leidžiamas.",
    "You cannot share \"%s\" with more permission than you have yourself." : "Jūs negalite bendrinti „%s“ suteikdami daugiau teisių, nei turite patys.",
    ...
    "We would like to kindly remind you that you have not yet uploaded any files to the shared folder." : "Norėtume maloniai priminti, kad į bendrinamą aplanką dar nesate išsiuntę jokių failų.",
    "Open \"%s\"" : "Atverti „%s“",
    ...
    "You can now share the link below to allow people to upload files to your directory." : "Dabar galite pasidalinti žemiau pateikta nuoroda, kad leistumėte kitiems išsiųsti failus į jūsų katalogą.",
    ...
    "Upload destination" : "Išsiuntimo vieta",
    "Revert to default" : "Sugrąžinti į numatytąjį",
    "The uploaded files are visible only to you unless you choose to share them." : "Išsiųsti failai yra matomi tik jums, nebent nuspręsite juos bendrinti.",
    ...
    "File request created" : "Failo užklausa sukurta",
    ...
    "Error creating the share: {errorMessage}" : "Klaida kuriant bendrinimą: {errorMessage}",
    ...
    "File request" : "Failo užklausa",
    "Previous step" : "Ankstesnis žingsnis",
    "Cancel" : "Atsisakyti",
    "Cancel the file request creation" : "Atšaukti failo užklausos sukūrimą",
    "Close without sending emails" : "Užverti nesiunčiant el. laiškų",
    "Continue" : "Tęsti",
    "Error while toggling options" : "Klaida perjungiant parinktis",
    "Accept shares from other accounts and groups by default" : "Pagal numatymą priimti bendrinimus iš kitų paskyrų ir grupių",
    "Choose a default folder for accepted shares" : "Pasirinkite numatytąjį aplanką priimtiems bendrinimams",
    "Invalid path selected" : "Pasirinktas netinkamas kelias",
    "Unknown error" : "Nežinoma klaida",
    "Set default folder for accepted shares" : "Nustatykite numatytąjį priimtų bendrinimų aplanką",
    "Reset" : "Atstatyti",
    ...
    "Mail share ({label})" : "Bendrinimas paštu ({label})",
    "Share link ({label})" : "Bendrinimo nuoroda ({label})",
    "Mail share" : "Bendrinimas paštu",
    ...
    "Error while creating the share" : "Klaida kuriant bendrinimą",
    ...
    "Name, email, or Federated Cloud ID …" : "Vardas, el. paštas arba federacinės debesijos ID  …",
    "Searching …" : "Ieškoma…",
    ...
    "Share with {user}" : "Bendrinti su {user}",
    ...
    "Unable to fetch inherited shares" : "Nepavyko gauti paveldėtų bendrinimų",
    ...
    "Type names, teams, federated cloud IDs" : "Tipų pavadinimai, komandos, federaciniės debesijos identifikatoriai",
    "Type names or teams" : "Įveskite vardus arba komandas",
    "Type a federated cloud ID" : "Įveskite federacinės debesijos ID",
    "Type an email" : "Įveskite el. pašto adresą",
    "Type an email or federated cloud ID" : "Įveskite el. pašto adresą arba federacinės debesijos ID",
    "Unable to load the shares list" : "Nepavyko įkelti bendrinimų sąrašo",
    "Expires {relativetime}" : "Galioja iki {relativetime}",
    "this share just expired." : "šis bendrinimas ką tik nustojo galioti.",
    "Shared with you by {owner}" : "{owner} pasidalino su jumis",
    "Internal shares" : "Vidiniai bendrinimai",
    "Internal shares explanation" : "Vidinių bendrinimų paaiškinimas",
    ...
    "Additional shares explanation" : "Papildomų bendrinimų paaiškinimas",
    ...
    "You do not have enough permissions to share this file." : "Jūs neturite pakankamų teisių bendrinti šį failą.",
    "People" : "Žmonės",
    "Create file request" : "Sukurti failo užklausą",
    "Upload files to {foldername}" : "Įkelti failus į {foldername}",
    "Public file share" : "Viešas failų bendrinimas",
    "Publicly shared file." : "Viešai bendrinamas failas.",
    "No file" : "Failo nėra",
    "The file shared with you will show up here" : "Čia bus rodomas su jumis bendrinamas failas",
    "Public share" : "Viešasis bendrinimas",
    "Publicly shared files." : "Viešai pasidalintas failas.",
    "No files" : "Failų nėra",
    "Files and folders shared with you will show up here" : "Čia bus rodomi su jumis bendrinami failai ir aplankai",
    ...
    "List of files that you shared with others." : "Failų, kuriuos bendrinote su kitais, sąrašas.",
    ...
    "Error updating the share" : "Klaida atnaujinant bendrinimą",
    "File \"{path}\" has been unshared" : "Failas „{path}“ nustotas bendrinti",
    "Folder \"{path}\" has been unshared" : "Aplankas „{path}“ nustotas bendrinti",
    "Could not update share" : "Nepavyko atnaujinti bendrinimo",
    "Share saved" : "Bendrinimas įrašytas",
    ...
    "Share label saved" : "Bendrinimo etiketė įrašyta",
    "Share note for recipient saved" : "Gavėjo bendrinimo pastaba išsaugota",
    "Share password saved" : "Bendrinimo slaptažodis įrašytas",
    "Share permissions saved" : "Bendrinimo leidimai įrašyti",
