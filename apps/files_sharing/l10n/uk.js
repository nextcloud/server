OC.L10N.register(
    ...
    "Tokens must be between 1 and %s characters long and may only contain letters, numbers, or a hyphen" : "Токени мають мати довжину від 1 до %s символів та містити лише літери, цифри або дефіс.",
    ...
    "You are not allowed to share \"%s\"." : "Відсутні права на надання у спільний доступ \"%s\".",
    "You cannot share your home folder." : "Неможливо надати у спільний доступ весь каталог користувача",
    "You cannot share \"%s\" with more permission than you have yourself." : "Неможливо надати у спільний доступ \"%s\" із більшими дозволами, ніж ви маєте",
    "File cannot be shared with delete permission." : "Неможливо поділитися файлом із дозволом на вилучення",
    "File cannot be shared with create permission." : "Неможливо поділитися файлом із дозволом на створення",
    "File share needs at least read permission." : "Щод поділитися файлом, потрібно мати щонайменше дозвіл на читання",
    "Public upload is not allowed." : "Публічні завантаження не дозволені",
    ...
    "Copy public link of \"{title}\"" : "Копіювати публічне посилання на «{title}»",
