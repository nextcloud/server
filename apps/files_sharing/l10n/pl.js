OC.L10N.register(
    ...
    "Tokens must be between 1 and %s characters long and may only contain letters, numbers, or a hyphen" : "Tokeny muszą mieć od 1 do %s znaków i mogą zawierać wyłącznie litery, cyfry oraz myślnik.",
    ...
    "You are not allowed to share \"%s\"." : "Nie masz uprawnień do udostępniania \"%s\".",
    "You cannot share your home folder." : "Nie możesz udostępnić swojego folderu głównego.",
    "File cannot be shared with delete permission." : "Pliku nie można udostępnić z uprawnieniem do usuwania.",
    "File cannot be shared with create permission." : "Pliku nie można udostępnić z uprawnieniem do tworzenia.",
    "File share needs at least read permission." : "Udostępnienie pliku wymaga co najmniej uprawnienia do odczytu.",
    "Public upload is not allowed." : "Publiczne przesyłanie plików nie jest dozwolone.",
    "You cannot share \"%s\" with more permission than you have yourself." : "Nie możesz udostępnić \"%s\" z większymi uprawnieniami, niż sam posiadasz.",
    ...
    "Your browser does not support copying, please copy the link manually:" : "Twoja przeglądarka nie obsługuje kopiowania, proszę skopiuj link ręcznie:",
    "Successfully copied public link" : "Pomyślnie skopiowano publiczny link",
