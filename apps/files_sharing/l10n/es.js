OC.L10N.register(
    ...
    "Tokens must be between 1 and %s characters long and may only contain letters, numbers, or a hyphen" : "Los tokens deben tener entre 1 y %s caracteres de longitud y solo pueden contener letras, números o un guion.",
    ...
    "You are not allowed to share \"%s\"." : "No tienes permiso para compartir \"%s\".",
    "You cannot share your home folder." : "No puedes compartir tu carpeta raíz",
    "File cannot be shared with delete permission." : "El archivo no se puede compartir con permiso de borrado.",
    "File cannot be shared with create permission." : "El archivo no se puede compartir con permiso de crear.",
    "File share needs at least read permission." : "El archivo necesita al menos el permiso de lectura.",
    "Public upload is not allowed." : "No está permitida la subida pública.",
    "You cannot share \"%s\" with more permission than you have yourself." : "No puedes compartir \"%s\" con más permisos de los que tienes.",
    ...
    "Your browser does not support copying, please copy the link manually:" : "Su navegador no soporta copiar, por favor, copie el enlace manualmente:",
    "Successfully copied public link" : "Se copió el enlace público exitosamente",
    ...
    "Name, email, or Federated Cloud ID …" : "Nombre, correo o ID de nube federada...",
    "Searching …" : "Buscando …",
    ...
    "You do not have enough permissions to share this file." : "No tiene suficientes permisos para compartir este archivo.",
    "People" : "Personas",
