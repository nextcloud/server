OC.L10N.register(
    ...
    "Share expiration: {date}" : "Delings udløb: {date}",
    ...
    "Successfully copied public link" : "Kopierede offentligt linkcopied public link",
    ...
    "Successfully uploaded files" : "Uploadede fileruploaded files",
    ...
    "Share files with others outside your organization via public links and email addresses. You can also share to Nextcloud accounts on other instances using their federated cloud ID." : "Del filer med andre udenfor din organisation via offentlige links og e-mailadresser. Du kan også dele til Nextcloud konti på andre instanser ved at anvende deres fødererede cloud ID.",
    ...
    "Error deleting the share: {errorMessage}" : "Fejl under sletning af delingen: {errorMessage}",
