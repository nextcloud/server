OC.L10N.register(
    ...
    "Share files with others outside your organization via public links and email addresses. You can also share to Nextcloud accounts on other instances using their federated cloud ID." : "Делитесь файлами с другими пользователями за пределами вашей организации, используя общедоступные ссылки и адреса электронной почты. Вы также можете делиться файлами с учётными записями Nextcloud на других устройствах, используя их идентификаторы федеративного облака.",
