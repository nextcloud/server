OC.L10N.register(
    ...
    "Tokens must be between 1 and %s characters long and may only contain letters, numbers, or a hyphen" : "Токены должны иметь длину от 1 до %s символов и могут содержать только буквы, цифры или дефис",
    ...
    "You cannot share your home folder." : "Вы не можете поделиться своей домашней папкой.",
    "File cannot be shared with delete permission." : "Для файла не может быть открыт общий доступ с правами на удаление.",
    "File cannot be shared with create permission." : "Для файла не может быть открыт общий доступ с правами на создание.",
    "File share needs at least read permission." : "Для общего доступа к файлу требуется как минимум разрешение на чтение.",
    "Public upload is not allowed." : "Публичная загрузка данных запрещена.",
    "You cannot share \"%s\" with more permission than you have yourself." : "Вы не можете предоставлять доступ к \"%s\" с более широкими правами, чем те, которыми обладаете сами.",
    ...
    "For people who already have access" : "Для тех, у кого уже есть доступ",
    ...
    "Copy public link of \"{title}\"" : "Скопируйте общедоступную ссылку к \"{title}\"",
    ...
    "Type names, teams, federated cloud IDs" : "Имена типов, команды, идентификаторы федеративного облака",
    "Type names or teams" : "Введите имена или команды",
    "Type a federated cloud ID" : "Введите идентификатор объединенного облака",
    "Type an email" : "Введите адрес эл. почты",
    "Type an email or federated cloud ID" : "Введите адрес эл. почты или идентификатор федеративного облака",
