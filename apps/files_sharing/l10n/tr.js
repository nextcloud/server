OC.L10N.register(
    ...
    "Unshare \"{folder}\"" : "\"{folder}\" klasörünü paylaşımdan kaldır",
    "Unshare" : "Paylaşımı kaldır",
    "Added by {initiator}" : "{initiator} tarafından eklendi",
    "Via \"{folder}\"" : "\"{folder}\" üzerinden",
    ...
    "Copy public link of \"{title}\"" : "Herkese açık \"{title}\" bağlantısını kopyala",
    ...
    "Share with {user}" : "{user} ile paylaş",
    ...
    "Set the public share link token to something easy to remember or generate a new token. Tokens can be up to {maxLength} characters long and may only contain letters, numbers, and hyphens. It is not recommended to use a guessable token for shares which contain sensitive information." : "kodHerkese açık paylaşım bağlantısı kodunu kolay hatırlanacak bir şey olarak ayarlayın veya yeni bir kod oluşturun. Kodlar en fazla {maxLength} karakter uzunluğunda olabilir ve yalnızca harf, rakam ve tire karakterlerini içerebilir. Önemli bilgiler içeren paylaşımlar için öngörülebilir bir kod kullanılması önerilmez.",
    ...
    "Type names, teams, federated cloud IDs" : "Adlar, takımlar, birleşik bulut kimlikleri yazın",
    "Type names or teams" : "Adlar ya da takımlar yazın",
    "Type a federated cloud ID" : "Bir birleşik bulut kimliği yazın",
    "Type an email" : "Bir e-posta adresi yazın",
    "Type an email or federated cloud ID" : "Bir e-posta adresi ya da birleşik bulut kimliği yazın",
    ...
    ", " : ",",
    "_Reshared with %n person_::_Reshared with %n people_" : ["%n kişiyle yeniden paylaşıldı","%n kişiyle yeniden paylaşıldı"],
    ...
    "Do you want to accept this share?" : "Bu paylaşımı kabul etmek istiyor musunuz?",
