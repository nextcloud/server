OC.L10N.register(
    ...
    "Downloaded by {email}" : "{email} laadis selle alla",
    "{file} downloaded via public link" : "„{file}“ fail laaditi alla avaliku lingi abil",
    "{email} downloaded {file}" : "{email} laadis „{file}“ faili alla",
    ...
    "You shared {file} with group {group}" : "Sa jagasid „{file}“ faili grupiga {group}",
    "You removed group {group} from {file}" : "Sa eemaldasid {group} grupi  „{file}“ faili jagamisest",
    "{actor} shared {file} with group {group}" : "{actor} jagas „{file}“ faili grupiga {group}",
    "{actor} removed group {group} from {file}" : "{actor} eemaldas {group} grupi „{file}“ faili jagamisest",
    "Share for file {file} with group {group} expired" : "Grupile „{group}“ mõeldud jagatud fail „{file}“ aegus",
    "Shared as public link" : "Jagatud avaliku lingina",
    ...
    "{user} accepted the remote share" : "{user} nõustus kaugjagamisega",
    ...
    "{user} accepted the remote share of {file}" : "{user} nõustus „{file}“ faili kaugjagamisega",
    ...
    "You shared {file} with {user}" : "Sa jagasid „{file}“ faili kasutajaga {user}",
    "You removed {user} from {file}" : "Sa eemaldasid „{file}“ faili jagamise kasutajaga {user} ",
    ...
    "{actor} shared {file} with {user}" : "{actor} jagas „{file}“ faili kasutajaga {user}",
    "{actor} removed {user} from {file}" : "{actor} eemaldas {user} jagamise faililt „{file}“",
    "{actor} shared {file} with you" : "{actor} jagas sinuga „{file}“ faili",
    "{actor} removed you from the share named {file}" : "{actor} lõpetas sinuga „{file}“ faili jagamise",
    ...
    "Sharing %s sending the password by Nextcloud Talk failed because Nextcloud Talk is not enabled" : "Kuna Nextcloud Talk pole serverisse paigaldatud, siis ei saanud selle teenuse abil ka „%s“ jagamise salasõna edastada",
    ...
    "You are not allowed to edit incoming shares" : "Sul pole lubatud vastuvõetud jagamist muuta",
    ...
    "shared by %s" : " %s jagas seda",
    "Download" : "Laadi alla",
    "Add to your %s" : "Lisa oma teenusesse: %s",
    "Direct link" : "Otsene link",
    "You are not allowed to share \"%s\"." : "„%s“ jagamine pole sulle lubatud.",
    "You cannot share your home folder." : "Sa ei või oma kodukausta jagada.",
    "File cannot be shared with delete permission." : "Faili ei saa jagada kustutamisõigusega.",
    "File cannot be shared with create permission." : "Faili ei saa jagada loomisõigusega.",
    "File share needs at least read permission." : "Faili jagamine eeldab vähemalt lugemisõiguse olemasolu.",
    "Public upload is not allowed." : "Avalik üleslaadimine pole lubatud.",
    "You cannot share \"%s\" with more permission than you have yourself." : "„%s“ jagamisel sa ei või määrata enam õigusi, kui sul endal on.",
    ...
    "We would like to kindly remind you that you have not yet uploaded any files to the shared folder." : "Me lahkesti tuletame sulle meelde, et sa pole veel ühtegi faili jagatud kausta lisanud.",
    "Open \"%s\"" : "Ava „%s“",
    ...
    "What password should be used for the request?" : "Missugust salasõna peaks selle päringu puhul kasutama?",
    "Set a password" : "Lisa salasõna",
    "Password" : "Salasõna",
    "Enter a valid password" : "Sisesta korrektne salasõna",
    "Generate a new password" : "Loo uus salasõna",
    "Your administrator has enforced a password protection." : "Sinu serveri peakasutaja on kehtestanud salasõna kasutamise tingimuse.",
    ...
    "Error creating the share" : "Viga jagamise loomisel",
    ...
    "Unshare \"{folder}\"" : "Lõpeta „{folder}“ kausta jagamine",
    "Unshare" : "Lõpeta jagamine",
    "Added by {initiator}" : "Selle lisas {initiator}",
    "Via \"{folder}\"" : "Jaga „{folder}“ kausta",
    ...
    "Link share created" : "Lingiga jagamine on loodud",
    ...
    "Please enter the following required information before creating the share" : "Enne jagamise loomist palun sisesta järgmine vajalik teave",
    ...
    "Delete" : "Kustuta",
    "Are you sure you want to delete this share? This operation cannot be undone." : "Kas sa oled kindel, et soovid selle jagamise kustutada? Seda tegevust ei saa tagasi pöörata.",
    "Edit share" : "Muuda jagamist",
    "Toggle recipients" : "Lülita saajad sisse/välja",
    "Remove recipient" : "Eemalda jagamise saaja",
    ...
    "Update share" : "Uuenda jagamist",
    "Save share" : "Salvesta jagamine",
    "Read" : "Lugemine",
    "Create" : "Lisa",
    "Edit" : "Muuda",
    "Share" : "Jaga",
    ...
    "Set the public share link token to something easy to remember or generate a new token. Tokens can be up to {maxLength} characters long and may only contain letters, numbers, and hyphens. It is not recommended to use a guessable token for shares which contain sensitive information." : "Sisesta avaliku jagamislingi tunnusloa jaoks midagi lihtsalt meeldejäetavat või genereeri uus tunnusluba. Tunnusload võivad olla kuni {maxLength} tähemärki pikad ja seal võib leiduda vaid tähti, numbreid ja sidekriipse. Kui link viitab delikaatsetele jagatud andmetele, siis palun ära kasuta kergesti aimatavaid tunnuslube.",
    "Generating…" : "Loomisel…",
    ...
    "Unable to fetch inherited shares" : "Päritud jagamiste laadimine ei õnnestu",
    "Link shares" : "Lingiga jagamised",
    "Shares" : "Jagamised",
    ...
    "Unable to load the shares list" : "Jagamiste loendi laadimine ei õnnestu",
    ...
    "Internal shares" : "Sisemine jagamine",
    "Internal shares explanation" : "Sisemiste jagamiste selgitus",
    "External shares" : "Väline jagamine",
    "External shares explanation" : "Väliste jagamiste selgitus",
    "Additional shares" : "Täiendav jagamine",
    "Additional shares explanation" : "Täiendavate jagamiste selgitus",
    "Link to a file" : "Link failile",
    "_Accept share_::_Accept shares_" : ["Võta jagamine vastu","Võta jagamised vastu"],
    "Open in Files" : "Ava failirakenduses",
    "_Reject share_::_Reject shares_" : ["Keeldu jagamisest","Keeldu jagamistest"],
    ...
    "List of shares you left." : "Jagamiste loend, kust sa oled lahkunud.",
    "No deleted shares" : "Kustutatud jagamisi pole",
    "Shares you have left will show up here" : "Jagamiste loend, kust sa oled lahkunud, saab olema nähtav siin",
    "Pending shares" : "Ootel jagamised",
    "List of unapproved shares." : "Vastuvõtmata jagamiste loend.",
    ...
    ", " : ", ",
    "_Reshared with %n person_::_Reshared with %n people_" : ["Jagatud uuesti %n inimesega","Jagatud uuesti %n inimesega"],
    ...
    "Names must not be empty." : "Nimed ei tohi olla tühjad.",
    ...
    "Do you want to accept this share?" : "Kas soovid seda jagamist kasutada?",
