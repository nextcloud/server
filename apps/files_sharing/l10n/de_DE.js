OC.L10N.register(
    ...
    "{user} accepted the remote share" : "{user} hat die externe Freigabe angenommen",
    ...
    "{user} accepted the remote share of {file}" : "{user} hat die externe Freigabe von {file} angenommen",
    ...
    "Tokens must be between 1 and %s characters long and may only contain letters, numbers, or a hyphen" : "Token müssen zwischen 1 und %s Zeichen lang sein und dürfen nur Buchstaben, Zahlen oder einen Bindestrich enthalten.",
    ...
    "You cannot share your home folder." : "Sie können Ihren Stammordner nicht freigeben",
    "File cannot be shared with delete permission." : "Datei kann nicht mit Lösch-Berechtigung geteilt werden.",
    "File cannot be shared with create permission." : "Datei kann nicht mit Erstell-Berechtigung geteilt werden.",
    "File share needs at least read permission." : "Dateifreigabe benötigt mindestens Leseberechtigung.",
    "Public upload is not allowed." : "Öffentliches Hochladen ist nicht erlaubt",
    "You cannot share \"%s\" with more permission than you have yourself." : "Sie können \"%s\" nicht mit mehr Berechtigungen freigeben, als Sie selbst haben.",
    ...
    "Choose a default folder for accepted shares" : "Einen Standardordner für angenommene Freigaben wählen",
    ...
    "Unshare \"{folder}\"" : "Teilen für \"{folder}\" aufheben",
    ...
    "Link share created" : "Linkfreigabe erstellt",
    ...
    "Delete" : "Löschen",
    "Are you sure you want to delete this share? This operation cannot be undone." : "Soll diese Freigabe wirklich gelöscht werden? Dieser Vorgang kann nicht rückgängig gemacht werden.",
    "Edit share" : "Freigabe bearbeiten",
    "Toggle recipients" : "Empfänger umschalten",
    ...
    "_Accept share_::_Accept shares_" : ["Freigabe annehmen","Freigaben annehmen"],
    ...
    ", " : ", ",
    "_Reshared with %n person_::_Reshared with %n people_" : ["Weitergeteilt mit %n Person","Weitergeteilt mit %n Personen"],
