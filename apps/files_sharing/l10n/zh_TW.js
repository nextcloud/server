OC.L10N.register(
    ...
    "Your administrator has enforced a default expiration date with a maximum {days} days." : "您的管理員已強制設定預設到期日，最多為{days}天。",
    "When should the request expire?" : "請求應在何時過期？",
    "Set a submission expirationDate" : "設定遞交到期日",
    "Expiration date" : "到期日",
    "Select a date" : "選取日期",
    ...
    "Once created, you can share the link below to allow people to upload files to your directory." : "建立後，您可以分享下方的連結，以讓其他人上傳檔案到您的目錄中。",
    "Share link" : "分享連結",
    ...
    "File request created and emails sent" : "已建立檔案請求並寄送電子郵件",
    ...
    "_Close and send email_::_Close and send {count} emails_" : ["關閉並寄送 {count} 封電子郵件"],
    "Sharing" : "分享",
    ...
    "Create new file request" : "建立新檔案請求",
    "Shared by" : "分享自",
    "Shared with" : "分享給",
