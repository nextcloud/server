OC.L10N.register(
    ...
    "You cannot share your home folder." : "您無法分享您的家資料夾。",
    "File cannot be shared with delete permission." : "無法用包含「刪除」權限的方式分享此檔案。",
    "File cannot be shared with create permission." : "無法用包含「建立」權限的方式分享此檔案。",
    "File share needs at least read permission." : "檔案分享至少需要讀取權限。",
    "Public upload is not allowed." : "不允許公開上傳。",
    "You cannot share \"%s\" with more permission than you have yourself." : "您無法以高於自身權限的權限分享「%s」。",
    ...
    "Edit share" : "編輯分享",
    "Toggle recipients" : "切換收件者",
    "Remove recipient" : "移除收件者",
    "Note from" : "備註來自",
    "Note:" : "備註：",
    "File drop" : "檔案投遞",
    ...
    ", " : "、",
    "_Reshared with %n person_::_Reshared with %n people_" : ["與 %n 人重新分享"],
    ...
    "Do you want to accept this share?" : "您想要接受此分享嗎？",
