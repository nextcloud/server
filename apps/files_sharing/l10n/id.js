OC.L10N.register(
    ...
    "No Nextcloud installation (7 or higher) found at {remote}" : "Tidak ditemukan instalasi Nextcloud (7 atau lebih tinggi) pada {remote}",
    "Invalid Nextcloud url" : "URL Nextcloud tidak sah",
    "You received \"/%2$s\" as a remote share from %1$s" : "Anda menerima \"/%2$s\" sebagai berbagi remote dari %1$s",
    "Accept" : "Terima",
    "Decline" : "Tolak",
    "Share with me through my #Nextcloud Federated Cloud ID, see %s" : "Bagikan pada saya melalui #Nextcloud Federated Cloud ID saya, lihat %s",
    "Share with me through my #Nextcloud Federated Cloud ID" : "Bagikan pada saya melalui #Nextcloud Federated Cloud ID saya",
