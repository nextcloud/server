OC.L10N.register(
    ...
    "No Nextcloud installation (7 or higher) found at {remote}" : "Не е открита Nextcloud ( 7 или по-висока ) инсталация на {remote}.",
    "Invalid Nextcloud url" : "Невалиден Nextcloud интернет адрес.",
