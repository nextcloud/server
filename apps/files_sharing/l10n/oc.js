OC.L10N.register(
    ...
    "No Nextcloud installation (7 or higher) found at {remote}" : "Cap d'installacion Nextcloud (7 o superior) pas trobada sus {remote}",
    "Invalid Nextcloud url" : "URL Nextcloud invalida",
