OC.L10N.register(
    ...
    "Copy public link of \"{title}\"" : "Nakili kiungo cha umma cha \"{title}\"",
    ...
    "Your browser does not support copying, please copy the link manually:" : "Kivinjari chako hakiungi mkono kunakili, tafadhali nakili kiungo kikawaida:",
    "Successfully copied public link" : "Kiungo cha umma kimenakiliwa kwa mafanikio",
    ...
    "Name, email, or Federated Cloud ID …" : "Jina, barua pepe au Kitambulisho cha Cloud iliyoshirikishwa  …",
    "Searching …" : "Inatafuta …",
    ...
    "Share with {user}" : "Shiriki na {user}",
    ...
    "Shares" : "Shiriki",
    "Share files within your organization. Recipients who can already view the file can also use this link for easy access." : "Shiriki faili ndani ya shirika lako. Wapokeaji ambao tayari wanaweza kutazama faili wanaweza pia kutumia kiungo hiki kwa ufikiaji rahisi.",
    "Share files with others outside your organization via public links and email addresses. You can also share to {productName} accounts on other instances using their federated cloud ID." : "Shiriki faili na wengine nje ya shirika lako kupitia viungo vya umma na anwani za barua pepe. Unaweza pia kushiriki kwenye akaunti za {productName} katika matukio mengine kwa kutumia kitambulisho chao cha wingu kilichoshirikishwa.",
    "Shares from apps or other sources which are not included in internal or external shares." : "Shiriki kutoka kwa programu au vyanzo vingine ambavyo hazijajumuishwa katika ushiriki wa ndani au nje.",
    "Type names, teams, federated cloud IDs" : "Andika majina, timu, vitambulisho vya cloud vilivyoshirikishwa",
    "Type names or teams" : "Andika majina au timu",
    "Type a federated cloud ID" : "Andika kitambulisho cha cloud kilichoshirikishwa",
    "Type an email" : "Andika barua pepe",
    "Type an email or federated cloud ID" : "Andika barua pepe au kitambulisho cha cloud kilichoshirikishwa",
    ...
    "Sharing options" : "Kushiriki chaguzi",
    "Shared with others" : "Imeshirikiwa na wengine",
    "You do not have enough permissions to share this file." : "Huna vibali vya kutosha kushiriki faili hii.",
