OC.L10N.register(
    ...
    "Please specify a valid account to share with" : "رجاءً، حدِّد حساباً صحيحاً للمشاركة معه",
    ...
    "Please specify a valid federated account ID" : "رجاءً، حدِّد مُعرِّفاً صحيحاً لحساب اتحادي federated account ID",
    "Please specify a valid federated group ID" : "رجاءً عيّن مُعرِّفاً صحيحاً لمجموعة اتحادية federated group ID",
    ...
    "No mail notification configured for this share type" : "لا توجد إشعارات إيميل مُهيَّأةً لهذا النوع من المشاركات ",
    ...
    "Set a submission expirationDate" : "عيِّن تاريخ انتهاء صلاحية للإرسالية",
    ...
    "Collect files from others even if they do not have an account." : "جمِّع الملفات من الآخرين حتى لو لم يكونوا يملكون حساباتٍ",
    ...
    "Pending shares" : "مشاركات مُعلَّقة",
    ...
    "Shares you have received but not approved will show up here" : "المشاركات التي تلقَّيْتَ دعواتها لكنك لم توافق بعدُ عليها ستظهر هنا",
