OC.L10N.register(
    ...
    "Share for file {file} with {user} expired" : "اشتراک‌گذاری برای فایل {file} با {user} منقضی شده",
    "Share for file {file} expired" : "اشتراک‌گذاری برای فایل {file} منقضی شده است",
    ...
    "Wrong share ID, share does not exist" : "شناسهٔ اشتراک‌گذاری نادرست است؛ این اشتراک وجود ندارد",
    "Could not delete share" : "اشتراک گذاری حذف نشد",
    "Please specify a file or folder path" : "لطفاً مسیر فایل یا پوشه را مشخص کنید",
    "Wrong path, file/folder does not exist" : "مسیر نادرست است؛ فایل/پوشه وجود ندارد",
    ...
    "Please specify a valid federated group ID" : "لطفاً یک شناسهٔ گروه فدرات‌شده معتبر مشخص کنید",
    ...
    "Share must at least have READ or CREATE permissions" : "اشتراک‌گذاری باید دست‌کم دسترسی خواندن (READ) یا ایجاد (CREATE) داشته باشد",
    "Share must have READ permission if UPDATE or DELETE permission is set" : "اگر دسترسی به‌روزرسانی (UPDATE) یا حذف (DELETE) تنظیم شده باشد، اشتراک‌گذاری باید دسترسی خواندن (READ) نیز داشته باشد",
    ...
    "\"Sending the password by Nextcloud Talk\" for sharing a file or folder failed because Nextcloud Talk is not enabled." : "«ارسال گذرواژه از طریق Nextcloud Talk» برای اشتراک‌گذاری یک فایل یا پوشه ناموفق بود، زیرا Nextcloud Talk فعال نیست.",
    ...
    "Automatically copying failed, please copy the share link manually" : "کپی خودکار ناموفق بود، لطفاً لینک اشتراک‌گذاری را به صورت دستی کپی کنید",
    ...
    "Enter an email address or paste a list" : "یک آدرس ایمیل وارد کنید یا یک لیست را جای‌گذاری کنید",
    "Remove email" : "حذف ایمیل",
    "Select a destination" : "یک مقصد انتخاب کنید",
    "Select" : "گزینش<br>",
    "What are you requesting?" : "چه درخواستی دارید؟",
    "Request subject" : "موضوع درخواست",
    "Birthday party photos, History assignment…" : "عکس‌های جشن تولد، تکلیف تاریخ…",
    ...
    "The uploaded files are visible only to you unless you choose to share them." : "فایل‌های آپلود شده فقط برای شما قابل مشاهده هستند، مگر اینکه تصمیم به اشتراک‌گذاری آنها بگیرید.",
    ...
    "You can add links, date or any other information that will help the recipient understand what you are requesting." : "می‌توانید لینک، تاریخ یا هر اطلاعات دیگری که به گیرنده کمک می‌کند تا منظور شما را بفهمد، اضافه کنید.",
    "Close" : "بسته",
    "_Send email and close_::_Send {count} emails and close_" : ["ارسال  ایمیل و بستن","ارسال {count} ایمیل و بستن"],
    "Please select a folder, you cannot share the root directory." : "لطفاً یک پوشه انتخاب کنید، شما نمی‌توانید پوشه ریشه را به اشتراک بگذارید.",
    ...
    "Collect files from others even if they do not have an account." : "حتی اگر دیگران حساب کاربری نداشته باشند، فایل‌ها را از آنها جمع‌آوری کنید.",
    "To ensure you can receive files, verify you have enough storage available." : "برای اطمینان از اینکه می‌توانید فایل‌ها را دریافت کنید، بررسی کنید که فضای ذخیره‌سازی کافی در دسترس دارید.",
    ...
    "Continue" : "ادامه",
    "Error while toggling options" : "خطا هنگام تغییر وضعیت گزینه‌ها",
    "Accept shares from other accounts and groups by default" : "به صورت پیش‌فرض اشتراک‌گذاری‌ها را از حساب‌ها و گروه‌های دیگر بپذیرید",
    ...
    "Mail share ({label})" : "اشتراک‌گذاری ایمیل ({label})",
    "Share link ({label})" : "اشتراک‌گذاری لینک ({label})",
    "Mail share" : "اشتراک گذاری ایمیل",
    "Share link ({index})" : "اشتراک‌گذاری لینک ({index})",
    "Create public link" : "ایجاد لینک عمومی",
    "Actions for \"{title}\"" : "کنش‌های «{title}»",
    ...
    "Link share created" : "اشتراک‌گذاری لینک ایجاد شد",
    "Error while creating the share" : "خطا هنگام ایجاد اشتراک",
    "Your browser does not support copying, please copy the link manually:" : "مرورگر شما از کپی کردن پشتیبانی نمی‌کند، لطفاً لینک را به صورت دستی کپی کنید:",
    ...
    "Quick share options, the current selected is \"{selectedOption}\"" : "گزینه‌های اشتراک‌گذاری سریع، گزینه‌ی فعلی \"{selectedOption}\" است.",
    ...
    "Share" : "هم‌رسانی",
    "Delete" : "حذف",
    "Password field cannot be empty" : "فیلد گذرواژه نمی‌تواند خالی باشد",
    ...
    "Password expires {passwordExpirationTime}" : "گذرواژه در {passwordExpirationTime} منقضی می‌شود",
    "Password expired" : "گذرواژه منقضی شده است",
    ...
    "Show files in grid view" : "نمایش فایل‌ ها در نمای شبکه‌ای",
    ...
    "Link shares" : "اشتراک‌گذاری‌های لینک",
    ...
    "Sharing options" : "گزینه‌های اشتراک",
    ...
    "No files" : "بدون فایل",
    "Files and folders shared with you will show up here" : "فایل‌ها و پوشه‌هایی که با شما به اشتراک گذاشته شده‌اند، در اینجا نمایش داده می‌شوند.",
    ...
    "Files and folders you shared by link will show up here" : "فایل‌ها و پوشه‌هایی که از طریق لینک به اشتراک گذاشته‌اید، در اینجا نمایش داده می‌شوند.",
    "File requests" : "درخواست پرونده",
    "List of file requests." : "فهرست درخواست‌های فایل",
    "No file requests" : "بدون درخواست فایل",
    "File requests you have created will show up here" : "درخواست‌های فایلی که ایجاد کرده‌اید در اینجا نمایش داده می‌شوند",
    ...
    "Sharing %s failed because the back end does not support ScienceMesh shares" : "اشتراک‌گذاری %s انجام نشد زیرا بک‌اند از اشتراک‌گذاری‌های ScienceMesh پشتیبانی نمی‌کند",
    "Name or email …" : "نام یا ایمیل",
    "Name, email, or Federated Cloud ID …" : "نام یا ایمیل یا شناسه‌ی فدرال ابری",
    "Searching …" : "جستجوکردن …"
},
