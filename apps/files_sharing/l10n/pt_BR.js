OC.L10N.register(
    ...
    "Could not lock path" : "Não foi possível trancar o caminho",
    ...
    "You cannot share your home folder." : "Não é possível compartilhar sua pasta pessoal.",
    "File cannot be shared with delete permission." : "Não é possível compartilhar o arquivo com permissão de exclusão.",
    "File cannot be shared with create permission." : "Não é possível compartilhar o arquivo com permissão de criação.",
    "File share needs at least read permission." : "O compartilhamento de arquivos requer, no mínimo, permissão de leitura.",
    "Public upload is not allowed." : "Não é permitido fazer uploads públicos.",
    "You cannot share \"%s\" with more permission than you have yourself." : "Você não pode compartilhar “%s” com mais permissões do que as que você mesmo possui.",
    ...
    "Unshare \"{folder}\"" : "Descompartilhar “{folder}”",
    ...
    "Share with guest" : "Compartilhar com visitante",
    ...
    ", " : ", ",
    "_Reshared with %n person_::_Reshared with %n people_" : ["Recompartilhado com %n pessoa","Recompartilhado com %n de pessoas","Recompartilhado com %n pessoas"],
