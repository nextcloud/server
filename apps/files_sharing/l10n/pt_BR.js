OC.L10N.register(
    ...
    "Please specify a valid email address" : "Especifique um endereço de e-mail válido",
    ...
    "no sharing rights on this item" : "sem direitos de compartilhamento sobre este item",
    ...
    "Your administrator has enforced a default expiration date with a maximum {days} days." : "Seu administrador impôs uma data de expiração padrão com no máximo {days} dias.",
    "When should the request expire?" : "Quando a solicitação deve expirar?",
    "Set a submission expirationDate" : "Defina uma data de expiração para envio",
    ...
    "Once created, you can share the link below to allow people to upload files to your directory." : "Depois de criado, você pode compartilhar o link abaixo para permitir que as pessoas carreguem arquivos em seu diretório.",
    ...
    "File request created and emails sent" : "Solicitação de arquivo criada e e-mails enviados",
    ...
    "_Close and send email_::_Close and send {count} emails_" : ["Fechar e enviar {count} e-mails","Fechar e enviar {count} e-mails","Fechar e enviar {count} e-mails"],
    ...
    "Create new file request" : "Criar nova solicitação de arquivo",
