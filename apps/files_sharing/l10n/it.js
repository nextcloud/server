OC.L10N.register(
    ...
    "Copy public link of \"{title}\"" : "Copia il collegamento pubblico di \"{title}\"",
    ...
    "Your browser does not support copying, please copy the link manually:" : "Il tuo browser non supporta la copia, copia il collegamento manualmente:",
    "Successfully copied public link" : "Collegamento pubblico copiato correttamente",
    ...
    "Enable link expiration (enforced)" : "Abilita scadenza collegamento (imposta)",
    "Enable link expiration" : "Abilita scadenza collegamento",
    ...
    "Shares" : "Condivisioni",
    "Share files within your organization. Recipients who can already view the file can also use this link for easy access." : "Condividi i file all'interno della tua organizzazione. Anche i destinatari che possono già visualizzare il file possono utilizzare questo collegamento per accedervi facilmente.",
    "Share files with others outside your organization via public links and email addresses. You can also share to {productName} accounts on other instances using their federated cloud ID." : "Condividi file con altri utenti esterni alla tua organizzazione tramite collegamenti pubblici e indirizzi email. Puoi anche condividere con account {productName} o su altre istanze utilizzando il loro ID cloud federato.",
    ...
    "Please confirm your name to upload files to {folder}" : "Conferma il nome per caricare i file su {folder}",
