OC.L10N.register(
    ...
    "Your administrator has enforced a default expiration date with a maximum {days} days." : "Ваш администратор је поставио обавезни подразумевани датум истека са максимумом од {days} дана.",
    "When should the request expire?" : "Када би захтев требало да истекне?",
    "Set a submission expirationDate" : "Постави expirationDate за поднесак",
    ...
    "Once created, you can share the link below to allow people to upload files to your directory." : "Када се креира, линк приказан испод можете да поделите и тако омогућите људима да отпремају фајлове у ваш директоријум.",
    ...
    "File request created and emails sent" : "Креиран је захтев за фајл и послате су и-мејл поруке",
    ...
    "_Close and send email_::_Close and send {count} emails_" : ["Затвори и пошаљи и-мејл поруку","Затвори и пошаљи {count} и-мејл поруке","Затвори и пошаљи {count} и-мејл порука"],
    "Sharing" : "Дељење",
    ...
    "Create new file request" : "Креирај нови захтев за фајл",
    "Shared by" : "Поделио",
