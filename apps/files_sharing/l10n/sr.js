OC.L10N.register(
    ...
    "Copy public link of \"{title}\"" : "Копирај јавни линк за „{title}”",
    ...
    "Your browser does not support copying, please copy the link manually:" : "Ваш прегледач не подржава копирање, молимо вас да линк копирате ручно:",
    "Successfully copied public link" : "Успешно је копиран јавни линк",
    ...
    "Share with {user}" : "Подели са {user}",
    ...
    "Shares" : "Дељења",
    "Share files within your organization. Recipients who can already view the file can also use this link for easy access." : "Делите фајлове унутар ваше организације. Примаоци који већ могу да виде фајл, овај линк такође могу да употребе за лакши приступ.",
    "Share files with others outside your organization via public links and email addresses. You can also share to {productName} accounts on other instances using their federated cloud ID." : "Делите фајлове са осталима своје организације путем јавних линкова дељења и и-мејл адреса. Такође можете да делите осталим {productName} налозима који се хостују на другим инстанцама користећи њихов ID здруженог облака.",
    "Shares from apps or other sources which are not included in internal or external shares." : "Дељења из осталих апликација и осталих извора који нису укључени у интерна или спољна дељења.",
    "Type names, teams, federated cloud IDs" : "Куцајте имена, тимове, ID здружених облака",
    "Type names or teams" : "Куцајте имена или тимове",
    "Type a federated cloud ID" : "Куцајте ID здруженог облака",
    "Type an email" : "Куцајте и-мејл",
    "Type an email or federated cloud ID" : "Куцајте и-мејл или ID здруженог облака",
