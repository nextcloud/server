OC.L10N.register(
    ...
    "Tokens must be between 1 and %s characters long and may only contain letters, numbers, or a hyphen" : "Tokens must be between 1 and %s characters long and may only contain letters, numbers, or a hyphen",
    ...
    "You cannot share your home folder." : "You cannot share your home folder.",
    "File cannot be shared with delete permission." : "File cannot be shared with delete permission.",
    "File cannot be shared with create permission." : "File cannot be shared with create permission.",
    "File share needs at least read permission." : "File share needs at least read permission.",
    "Public upload is not allowed." : "Public upload is not allowed.",
    "You cannot share \"%s\" with more permission than you have yourself." : "You cannot share \"%s\" with more permission than you have yourself.",
    ...
    ", " : ", ",
    "_Reshared with %n person_::_Reshared with %n people_" : ["Reshared with %n person","Reshared with %n people"],
    ...
    "Do you want to accept this share?" : "Do you want to accept this share?",
