OC.L10N.register(
    ...
    "Public upload is only possible for publicly shared folders" : "公开上传仅适用于公开共享文件夹",
    ...
    "Tokens must be between 1 and %s characters long and may only contain letters, numbers, or a hyphen" : "令牌长度必须在 1 到 %s 个字符之间，且只能包含字母、数字或连字符",
    ...
    "Direct link" : "直接链接",
    "You are not allowed to share \"%s\"." : "不允许您分享“%s”。",
    "You cannot share your home folder." : "您无法分享主文件夹。",
    "File cannot be shared with delete permission." : "无法分享具有删除权限的文件。",
    "File cannot be shared with create permission." : "无法分享具有创建权限的文件。",
    "File share needs at least read permission." : "文件共享至少需要读取权限。",
    "Public upload is not allowed." : "不允许公开上传。",
    "You cannot share \"%s\" with more permission than you have yourself." : "您无法以高于您自身所拥有的权限来共享“%s”。",
    ...
    "Your browser does not support copying, please copy the link manually:" : "您的浏览器不支持复制，请手动复制链接：",
    "Successfully copied public link" : "已成功复制公开链接",
    ...
    "Share files with others outside your organization via public links and email addresses. You can also share to {productName} accounts on other instances using their federated cloud ID." : "通过公开链接和电子邮件地址与组织外部的其他人共享文件。您还可以使用他们的联合云 ID 将文件共享至其他实例上的 {productName} 账号。",
    ...
    "Public link sharing is disabled by the administrator" : "管理员已禁用公开链接共享",
