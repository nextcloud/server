OC.L10N.register(
    ...
    "Tokens must be between 1 and %s characters long and may only contain letters, numbers, or a hyphen" : "トークンの長さは1文字以上%s文字以下でなければならず、文字、数字、またはハイフンのみを含めることができます。",
    ...
    "Unshare \"{folder}\"" : "\"{folder}\"の共有を解除する",
    "Unshare" : "共有を解除",
    ...
    "For people who already have access" : "すでにアクセス権を持っている人向け",
    "Internal link" : "内部リンク",
    ...
    "Copy public link of \"{title}\"" : "\"{title}\"の公開リンクをコピー",
    ...
    "Your browser does not support copying, please copy the link manually:" : "お使いのブラウザーはコピーをサポートしていません。リンクを手動でコピーしてください:",
    "Successfully copied public link" : "公開リンクが正常にコピーされました",
    ...
    "Delete share" : "共有を解除",
    "Delete" : "削除",
    "Are you sure you want to delete this share? This operation cannot be undone." : "この共有を削除してもよろしいですか？この操作は元に戻せません。",
    "Edit share" : "共有を編集",
    "Toggle recipients" : "受信者を切り替える",
    "Remove recipient" : "受信者を削除する",
    "Note from" : "注釈",
    "Note:" : "注意：",
    "File drop" : "ファイルを転送",
    ...
    "Type a federated cloud ID" : "連携クラウトIDを入力",
    "Type an email" : "メールアドレスを入力",
    "Type an email or federated cloud ID" : "メールアドレスまたは連携クラウドIDを入力",
    ...
    ", " : "、",
    "_Reshared with %n person_::_Reshared with %n people_" : ["%n人に再共有されました"],
