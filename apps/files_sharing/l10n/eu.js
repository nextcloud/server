OC.L10N.register(
    ...
    "Tokens must be between 1 and %s characters long and may only contain letters, numbers, or a hyphen" : "Tokenek 1 eta %s karaktere arteko luzera izan behar dute eta letrak, zenbakiak edo marratxoa soilik izan ditzakete",
    ...
    "Share expiration: {date}" : "Partekatzearen iraungitze-data: {date}",
    ...
    "Copy public link of \"{title}\"" : "Kopiatu \"{title}\"-ren esteka publikoa",
    ...
    "Your browser does not support copying, please copy the link manually:" : "Zure nabigatzaileak ez du onartzen kopiatzea, beraz, kopiatu esteka eskuz:",
    "Successfully copied public link" : "Esteka publikoa behar bezala kopiatu da",
    ...
    "Share with {user}" : "Partekatu {user}-ekin",
    ...
    "Type a federated cloud ID" : "Idatzi federatutako hodei baten IDa",
    "Type an email" : "Idatzi posta elektroniko bat",
    "Type an email or federated cloud ID" : "Idatzi posta elektroniko edo federatutako hodei baten IDa",
    ...
    "To upload files to {folder}, you need to provide your name first." : "{folder}karpetara fitxategiak igotzeko, aurretik izena eman behar duzu.",
    "Upload files to {folder}" : "Igo fitxategiak {folder}(e)ra",
    "Please confirm your name to upload files to {folder}" : "Berretsi zure izena fitxategiak {folder} karpetara igotzeko",
    "{ownerDisplayName} shared a folder with you." : "{ownerDisplayName}-k zurekin karpeta bat partekatu du.",
    "Names must not be empty." : "Izenak ez dira hutsik egon behar.",
    "Names must not start with a dot." : "Izenek ezin dute hasi puntu batez.",
    "\"{char}\" is not allowed inside a name." : "\"{char}\" karakterea ezin da egon izenean",
    "\"{segment}\" is a reserved name and not allowed." : "\"{segment}\" erreserbatutako izena da eta ezin da erabili",
    "\"{extension}\" is not an allowed name." : "\"{extension}\" ez da onartzen izen gisa.",
    "Names must not end with \"{extension}\"." : "Izenek ezin dute bukatu \"{extension}\" batez",
