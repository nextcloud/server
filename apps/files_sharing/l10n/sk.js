OC.L10N.register(
    ...
    "Tokens must be between 1 and %s characters long and may only contain letters, numbers, or a hyphen" : "Tokeny musia mať dĺžku od 1 do %s znakov a môžu obsahovať iba písmená, číslice alebo spojovník",
    ...
    "You are not allowed to share \"%s\"." : "Nemáte povolenie zdieľať „%s“.",
    "You cannot share your home folder." : "Svoj domovský priečinok nemôžete zdieľať.",
    "File cannot be shared with delete permission." : "Súbor nemožno zdieľať s oprávnením na mazanie.",
    "File cannot be shared with create permission." : "Súbor nemožno zdieľať s oprávnením na vytváranie.",
    "File share needs at least read permission." : "Zdieľanie súboru vyžaduje aspoň oprávnenie na čítanie.",
    "Public upload is not allowed." : "Verejné nahrávanie nie je povolené.",
    "You cannot share \"%s\" with more permission than you have yourself." : "„%s“ nemôžete zdieľať s väčším rozsahom oprávnení, než aký máte sami.",
    ...
    "_The following email address is not valid: {emails}_::_The following email addresses are not valid: {emails}_" : ["Nasledujúca e-mailová adresa nie je platná: {emails}","Nasledujúce e-mailové adresy nie sú platné: {emails}","Nasledujúce e-mailové adresy nie sú platné: {emails}","Nasledujúce e-mailové adresy nie sú platné: {emails}"],
    ...
    "Share expiration: {date}" : "Platnosť zdieľania: {date}",
    ...
    "Unshare \"{folder}\"" : "Zrušiť zdieľanie „{folder}“",
    "Unshare" : "Zneprístupniť",
    "Added by {initiator}" : "Pridal(a) {initiator}",
    "Via \"{folder}\"" : "Cez „{folder}“",
    ...
    "Copy public link of \"{title}\"" : "Skopírujte verejný odkaz na \"{title}\"",
    ...
    "Delete" : "Zmazať",
    "Are you sure you want to delete this share? This operation cannot be undone." : "Naozaj chcete odstrániť toto zdieľanie? Túto operáciu nie je možné vrátiť späť.",
    "Edit share" : "Upraviť zdieľanie",
    "Toggle recipients" : "Prepnúť príjemcov",
    ...
    "Set the public share link token to something easy to remember or generate a new token. Tokens can be up to {maxLength} characters long and may only contain letters, numbers, and hyphens. It is not recommended to use a guessable token for shares which contain sensitive information." : "Nastavte token verejného odkazu na niečo ľahko zapamätateľné alebo vygenerujte nový token. Tokeny môžu mať až {maxLength} znakov a môžu obsahovať iba písmená, čísla a pomlčky. Neodporúča sa používať uhádnuteľný token pre zdieľania obsahujúce citlivé informácie.",
    ...
    "Share files within your organization. Recipients who can already view the file can also use this link for easy access." : "Zdieľajte súbory v rámci vašej organizácie. Príjemcovia, ktorí už môžu súbor zobraziť, môžu tento odkaz využiť na jednoduchý prístup.",
    "Share files with others outside your organization via public links and email addresses. You can also share to {productName} accounts on other instances using their federated cloud ID." : "Zdieľajte súbory s ostatnými mimo vašej organizácie prostredníctvom verejných odkazov a emailových adries. Súbory môžete tiež zdieľať s účtami {productName} na iných inštanciách pomocou ich ID združeného cloudu",
    "Shares from apps or other sources which are not included in internal or external shares." : "Akcie z aplikácií alebo iných zdrojov, ktoré nie sú zahrnuté v interných alebo externých akciách.",
    "Type names, teams, federated cloud IDs" : "Zadajte názvy, tímy, federované ID cloudu",
    "Type names or teams" : "Zadajte mená alebo tímy",
    "Type a federated cloud ID" : "Zadajte ID združeného cloudu",
    "Type an email" : "Zadajte email",
    "Type an email or federated cloud ID" : "Zadajte e-mail alebo ID združeného cloudu",
    ...
    ", " : ", ",
    "_Reshared with %n person_::_Reshared with %n people_" : ["Zdieľané ďalej s %n osobou","Zdieľané ďalej s %n osobami","Zdieľané ďalej s %n osobami","Zdieľané ďalej s %n osobami"],
    ...
    "To upload files to {folder}, you need to provide your name first." : "Ak chcete nahrať súbory do {folder}, musíte najprv zadať svoje meno.",
    "Upload files to {folder}" : "Nahrať súbory do {folder}",
    "Please confirm your name to upload files to {folder}" : "Prosím, potvrďte svoje meno na nahratie súborov do {folder}.",
