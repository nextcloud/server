OC.L10N.register(
    ...
    "Files" : "ھۆججەتلەر",
    "Please specify a valid user" : "ئىناۋەتلىك ئىشلەتكۈچىنى بەلگىلىۈڭ",
    "Please specify a valid federated user ID" : "ئىناۋەتلىك فېدېراتسىيە ئىشلەتكۈچى كىملىكىنى بەلگىلىۈڭ",
    "You cannot share to a Circle if the app is not enabled" : "ئەگەر بۇ دېتال قوزغىتىلمىغان بولسا چەمبىرەككە ئورتاقلىشالمايسىز",
    "Please specify a valid circle" : "ئىناۋەتلىك چەمبىرەك بەلگىلەڭ",
    ...
    "Accept user and group shares by default" : "سۈكۈتتىكى ئىشلەتكۈچى ۋە گۇرۇپپا ئۈلۈشىنى قوبۇل قىلىڭ",
    "Read only" : "پەقەت ئوقۇڭ",
    "File drop (upload only)" : "ھۆججەت چۈشۈرۈش (پەقەت يوللاش)",
    "Upload" : "يۈكلە",
    ...
    "Name" : "ئاتى",
    "Share time" : "ئورتاقلىشىش ۋاقتى",
    "Sorry, this link does not seem to work anymore." : "كەچۈرۈڭ ، بۇ ئۇلىنىش ئەمدى ئىشلىمەيدىغاندەك قىلىدۇ.",
    "Reasons might be:" : "سەۋەبى بولۇشى مۇمكىن:",
    "the item was removed" : "نەرسە ئۆچۈرۈلدى",
