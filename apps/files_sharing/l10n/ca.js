OC.L10N.register(
    ...
    "You cannot share to a Team if the app is not enabled" : "No podeu compartir amb un Equip si l'aplicació no està activada",
    ...
    "no sharing rights on this item" : "no hi ha drets per compartir aquest article",
    "You are not allowed to edit incoming shares" : "No teniu permís per editar els recursos compartits entrants",
    ...
    "Custom share link tokens have been disabled by the administrator" : "L'administrador ha desactivat els testimonis d'enllaços compartits personalitzats",
    ...
    "You are not allowed to send mail notifications" : "No teniu permís per enviar notificacions per correu",
    ...
    "People" : "Persones",
    "Filter accounts" : "Filtrar comptes",
    ...
    "Automatically copying failed, please copy the share link manually" : "S'ha produït un error en copiar automàticament; copieu l'enllaç per compartir manualment",
    ...
    "You can now share the link below to allow people to upload files to your directory." : "Ara podeu compartir l'enllaç següent per permetre que la gent carregui fitxers al vostre directori.",
    ...
    "Birthday party photos, History assignment…" : "Fotos de la festa d'aniversari, tasca d'història…",
    "Where should these files go?" : "On haurien d'anar aquests fitxers?",
    "Upload destination" : "Destinació de pujada",
    "Revert to default" : "Torna al valor predeterminat",
    ...
    "Create a file request" : "Creeu una sol·licitud de fitxer",
    ...
    "Enable link expiration (enforced)" : "Activa la caducitat de l'enllaç (forzada)",
    "Enable link expiration" : "Activa la caducitat de l'enllaç",
    ...
    "Upload files to {foldername}." : "Puja fitxers a {foldername}.",
    "By uploading files, you agree to the terms of service." : "En pujant fitxers, accepteu les condicions del servei.",
    "View terms of service" : "Consulta les condicions del servei",
    "Terms of service" : "Condicions del servei",
    "Upload files to {folder}" : "Puja fitxers a {folder}",
    "Submit name" : "Envia el nom",
    "{ownerDisplayName} shared a folder with you." : "{ownerDisplayName} ha compartit una carpeta amb tu.",
    "To upload files, you need to provide your name first." : "Per carregar fitxers, primer heu de proporcionar el vostre nom.",
    "Nickname" : "Sobrenom",
    ...
    "Use this method to share files with individuals or teams within your organization. If the recipient already has access to the share but cannot locate it, you can send them the internal share link for easy access." : "Utilitzeu aquest mètode per compartir fitxers amb persones o equips de la vostra organització. Si el destinatari ja té accés a la compartició però no la pot localitzar, podeu enviar-li l'enllaç de compartició intern per accedir-hi fàcilment.",
    ...
    "Pending shares" : "Elements compartits pendents",
    ...
    "Share hide-download state saved" : "S'ha desat l'estat de descàrrega oculta compartida",
    ...
    "Share permissions saved" : "S’han desat els permisos per compartir",
    ...
    "You are not allowed to edit link shares that you don't own" : "No teniu permís per editar els elements compartits d'enllaços que no sigueu propietaris",
