OC.L10N.register(
    ...
    "You cannot share your home folder." : "Не можете да ја споделите коренската папка.",
    "File cannot be shared with delete permission." : "Датотеки неможат да бидат споделени со дозвола за бришење.",
    "File cannot be shared with create permission." : "Датотеки неможат да бидат споделени со дозвола за создавање.",
    ...
    "Type names, teams, federated cloud IDs" : "Внеси имиња, тимови или федерален cloud ID-а",
    "Type names or teams" : "Внеси имиња или тимови",
    "Type a federated cloud ID" : "Внеси федерален cloud ID",
