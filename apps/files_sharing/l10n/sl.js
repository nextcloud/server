OC.L10N.register(
    ...
    "Share for file {file} with group {group} expired" : "Poteče souporaba datoteke {file} s skupino {group}",
    ...
    "Public link of {actor} expired" : "Javna povezava, ki jo je {actor} objavil, poteče",
    ...
    "Public link expired for {file}" : "Poteče javna povezava do datoteke {file}",
