OC.L10N.register(
    ...
    "Profile picker" : "Pemilih profil",
    "Profile" : "Profil",
    "This application provides the profile" : "Aplikasi ini menyediakan profil",
    "Provides a customizable user profile interface." : "Menyediakan antarmuka profil pengguna yang dapat disesuaikan.",
    "Searching …" : "Mencari …",
    "Not found" : "Tidak ditemukan",
    "Search for a user profile" : "Cari profil pengguna",
    "Search for a user profile. Start typing" : "Cari profil pengguna. Mulai mengetik",
    "Insert selected user profile link" : "Sisipkan tautan profil pengguna yang dipilih",
    "Insert" : "Sisipkan",
    "You & {user}" : "Anda dan {user}",
    ...
    "The profile does not exist or is unavailable." : "Profil tidak ada atau tidak tersedia.",
