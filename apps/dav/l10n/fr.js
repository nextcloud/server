OC.L10N.register(
    ...
    "Delegate:" : "Délégué :",
    "%1$s created \"%2$s\" on your behalf" : "%1$s a créé \"%2$s\" en votre nom",
    "%1$s created \"%2$s\" on your calendar \"%3$s\"" : "%1$s a créé \"%2$s\" dans votre calendrier \"%3$s\"",
    "%1$s updated \"%2$s\" on your behalf" : "%1$s a mis à jour \"%2$s\" en votre nom",
    "%1$s updated \"%2$s\" on your calendar \"%3$s\"" : "%1$s a mis à jour \"%2$s\" dans votre calendrier \"%3$s\"",
    "%1$s deleted \"%2$s\" on your behalf" : "%1$s a supprimé \"%2$s\" en votre nom",
    "%1$s permanently deleted \"%2$s\" from your calendar \"%3$s\"" : "%1$s a supprimé définitivement \"%2$s\" de votre calendrier \"%3$s\"",
    "%1$s moved \"%2$s\" to the trash on your behalf" : "%1$s a déplacé \"%2$s\" dans la corbeille en votre nom",
    "%1$s moved \"%2$s\" to the trash on your calendar \"%3$s\"" : "%1$s a déplacé \"%2$s\" dans la corbeille de votre calendrier \"%3$s\"",
    "%1$s restored \"%2$s\" on your behalf" : "%1$s a restauré \"%2$s\" en votre nom",
    "%1$s restored \"%2$s\" on your calendar \"%3$s\"" : "%1$s a restauré \"%2$s\" dans votre calendrier \"%3$s\"",
    ...
    "The system address book contains contact information for all users in your instance. The system address book is required for the searching and auto-completion of users." : "Le carnet d'adresses du système contient les informations de contact de tous les utilisateurs de votre instance. Il est nécessaire pour la recherche et l'autocomplétion des utilisateurs.",
    "Enable System Address Book in DAV clients" : "Activer le carnet d'adresses du système dans les clients DAV",
