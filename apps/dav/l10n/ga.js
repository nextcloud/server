OC.L10N.register(
    ...
    "Delegate:" : "Toscaire:",
    "%1$s created \"%2$s\" on your behalf" : "Chruthaigh %1$s \"%2$s\" ar do shon",
    "%1$s created \"%2$s\" on your calendar \"%3$s\"" : "Chruthaigh %1$s \"%2$s\" ar do fhéilire \"%3$s\"",
    "%1$s updated \"%2$s\" on your behalf" : "Nuashonraigh %1$s \"%2$s\" ar do shon",
    "%1$s updated \"%2$s\" on your calendar \"%3$s\"" : "Nuashonraíodh \"%2$s\" ar do fhéilire \"%3$s\" le %1$s",
    "%1$s deleted \"%2$s\" on your behalf" : "Scrios %1$s \"%2$s\" ar do shon",
    "%1$s permanently deleted \"%2$s\" from your calendar \"%3$s\"" : "Scrios %1$s \"%2$s\" go buan ó do fhéilire \"%3$s\"",
    "%1$s moved \"%2$s\" to the trash on your behalf" : "Bhog %1$s \"%2$s\" chuig an mbruscar ar do shon",
    "%1$s moved \"%2$s\" to the trash on your calendar \"%3$s\"" : "Bhog %1$s \"%2$s\" go dtí an bruscar ar do fhéilire \"%3$s\"",
    "%1$s restored \"%2$s\" on your behalf" : "D'athchóirigh %1$s \"%2$s\" ar do shon",
    "%1$s restored \"%2$s\" on your calendar \"%3$s\"" : "D'athchóirigh %1$s \"%2$s\" ar do fhéilire \"%3$s\"",
    ...
    "The system address book contains contact information for all users in your instance. The system address book is required for the searching and auto-completion of users." : "Tá eolas teagmhála do gach úsáideoir i do chás féin sa leabhar seoltaí córais. Tá gá leis an leabhar seoltaí córais chun úsáideoirí a chuardach agus chun a n-ainmneacha a chomhlánú go huathoibríoch.",
    "Enable System Address Book in DAV clients" : "Cumasaigh Leabhar Seoltaí an Chórais i gcliaint DAV",
