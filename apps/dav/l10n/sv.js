OC.L10N.register(
    ...
    "Could not open file: %1$s (%2$d), file does seem to exist" : "Kunde inte öppna filen: %1$s (%2$d), filen verkar finnas",
    "Could not open file: %1$s (%2$d), file doesn't seem to exist" : "Kunde inte öppna filen: %1$s (%2$d), filen verkar inte finnas",
    "Failed to get size for : %1$s" : "Kunde inte hämta storlek för: %1$s",
