OC.L10N.register(
    ...
    "Delegate:" : "Delegieren:",
    "%1$s created \"%2$s\" on your behalf" : "%1$s hat \"%2$s\" in deinem Namen erstellt",
    "%1$s created \"%2$s\" on your calendar \"%3$s\"" : "%1$s hat \"%2$s\" in deinem Kalender \"%3$s\" erstellt",
    "%1$s updated \"%2$s\" on your behalf" : "%1$s hat \"%2$s\" in deinem Namen aktualisiert",
    "%1$s updated \"%2$s\" on your calendar \"%3$s\"" : "%1$s hat \"%2$s\" in deinem Kalender \"%3$s\" aktualisiert",
    "%1$s deleted \"%2$s\" on your behalf" : "%1$s hat \"%2$s\" in deinem Namen gelöscht",
    "%1$s permanently deleted \"%2$s\" from your calendar \"%3$s\"" : "%1$s hat \"%2$s\" aus deinem Kalender \"%3$s\" gelöscht",
    "%1$s moved \"%2$s\" to the trash on your behalf" : "%1$s hat \"%2$s\" in deinem Namen in den Papierkorb verschoben",
    "%1$s moved \"%2$s\" to the trash on your calendar \"%3$s\"" : "%1$s hat \"%2$s\" in deinem Namen in den Papierkorb deines Kalenders \"%3$s\" verschoben",
    "%1$s restored \"%2$s\" on your behalf" : "%1$s hat \"%2$s\" in deinem Namen wiederhergestellt",
    "%1$s restored \"%2$s\" on your calendar \"%3$s\"" : "%1$s hat \"%2$s\" in deinem Kalender \"%3$s\" wiederhergestellt",
    ...
    "The system address book contains contact information for all users in your instance. The system address book is required for the searching and auto-completion of users." : "Das Systemadressbuch enthält Kontaktinformationen für alle Benutzer auf diesem Server. Das Systemadressbuch wird für die Suche und automatische Vervollständigung von Benutzernamen benötigt.",
    "Enable System Address Book in DAV clients" : "Systemadressbuch in DAV-Clients aktivieren",
