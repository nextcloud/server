OC.L10N.register(
    ...
    "Death of %s" : "%s 逝世",
    "Calendar federation" : "日曆聯盟",
    "{user} has shared the calendar {calendar} with you" : "{user} 已與您分享日曆 {calendar}",
    "Accept" : "接受",
    "Decline" : "拒絕",
    ...
    "%1$s created \"%2$s\" on your calendar \"%3$s\"" : "%1$s 在您的行事曆「%3$s」建立了「%2$s」",
    "%1$s updated \"%2$s\" on your behalf" : "%1$s 代表您更新了「%2$s」",
    "%1$s updated \"%2$s\" on your calendar \"%3$s\"" : "%1$s 在您的行事曆「%3$s」更新了「%2$s」",
    "%1$s deleted \"%2$s\" on your behalf" : "%1$s 代表您刪除了「%2$s」",
    "%1$s permanently deleted \"%2$s\" from your calendar \"%3$s\"" : "%1$s 從您的行事曆「%3$s」永久刪除了「%2$s」",
    "%1$s moved \"%2$s\" to the trash on your behalf" : "%1$s 代表您將「%2$s」移動到回收桶",
    "%1$s moved \"%2$s\" to the trash on your calendar \"%3$s\"" : "%1$s 在您的行事曆「%3$s」上將「%2$s」移動到回收桶",
    "%1$s restored \"%2$s\" on your behalf" : "%1$s 代表您還原了「%2$s」",
    "%1$s restored \"%2$s\" on your calendar \"%3$s\"" : "%1$s 在您的行事曆「%3$s」還原了「%2$s」",
    ...
    "The system address book contains contact information for all users in your instance. The system address book is required for the searching and auto-completion of users." : "系統通訊錄包含您站台中的所有聯絡人資訊。系統通訊錄是進行使用者搜尋與自動完成功能所必需的。",
