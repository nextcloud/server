OC.L10N.register(
    ...
    "Death of %s" : "%s halála",
    "Calendar federation" : "Naptárföderáció",
    "{user} has shared the calendar {calendar} with you" : "{user} megosztotta Önnel a(z) {calendar} naptárat",
    "Accept" : "Elfogadás",
    "Decline" : "Elutasítás",
    ...
    "Insufficient space" : "Nincs elegendő tárhely",
    ...
    "Delegate:" : "Delegált:",
    "%1$s created \"%2$s\" on your behalf" : "%1$s létrehozta az Ön nevében: „%2$s”",
    "%1$s created \"%2$s\" on your calendar \"%3$s\"" : "%1$s létrehozta a(z) „%2$s” bejegyzést az Ön „%3$s” naptárában",
    "%1$s updated \"%2$s\" on your behalf" : "%1$s frissítette az Ön nevében: „%2$s”",
    "%1$s updated \"%2$s\" on your calendar \"%3$s\"" : "%1$s frissítette a(z) „%2$s” bejegyzést az Ön „%3$s” naptárában",
    "%1$s deleted \"%2$s\" on your behalf" : "%1$s törölte az Ön nevében: „%2$s”",
    "%1$s permanently deleted \"%2$s\" from your calendar \"%3$s\"" : "%1$s véglegesen törölte a(z) „%2$s” bejegyzést az Ön „%3$s” naptárában",
    "%1$s moved \"%2$s\" to the trash on your behalf" : "%1$s áthelyezte a kukába az Ön nevében: „%2$s”",
    "%1$s moved \"%2$s\" to the trash on your calendar \"%3$s\"" : "%1$s áthelyezte a(z) „%2$s” bejegyzést a kukába az Ön „%3$s” naptárában",
    "%1$s restored \"%2$s\" on your behalf" : "%1$s helyreállította az Ön nevében: „%2$s”",
    "%1$s restored \"%2$s\" on your calendar \"%3$s\"" : "%1$s helyreállította a(z) „%2$s” bejegyzést az Ön „%3$s” naptárában",
    ...
    "The system address book contains contact information for all users in your instance. The system address book is required for the searching and auto-completion of users." : "A rendszercímjegyzék névjegy-információkat tartalmaz a példánya összes felhasználójáról. A rendszercímjegyzék szükséges a felhasználók kereséséhez és automatikus kitöltéséhez.",
    "Enable System Address Book in DAV clients" : "Rendszercímjegyzék engedélyezése a DAV-kliensekben",
