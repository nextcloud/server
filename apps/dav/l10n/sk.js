OC.L10N.register(
    ...
    "Calendar federation" : "Federácia kalendárov",
    "{user} has shared the calendar {calendar} with you" : "Používateľ {user} s vami zdieľal kalendár {calendar}",
    "Accept" : "Schváliť",
    "Decline" : "Odmietnuť",
    ...
    "_In %n minute on %1$s between %2$s - %3$s_::_In %n minutes on %1$s between %2$s - %3$s_" : ["O %n minútu dňa %1$s medzi %2$s - %3$s","O %n minúty dňa %1$s medzi %2$s - %3$s","O %n minút dňa %1$s medzi %2$s - %3$s","O %n minút dňa %1$s medzi %2$s - %3$s"],
    ...
    "You unshared address book {addressbook} from {user}" : "Zrušili ste zdieľanie adresára {addressbook} s používateľom {user}",
    ...
    "Insufficient space" : "Nedostatok miesta",
    ...
    "Delegate:" : "Delegát:",
    "%1$s created \"%2$s\" on your behalf" : "%1$s vytvoril(a) „%2$s“ vo vašom mene",
    "%1$s created \"%2$s\" on your calendar \"%3$s\"" : "%1$s vytvoril(a) „%2$s“ vo vašom kalendári „%3$s“",
    "%1$s updated \"%2$s\" on your behalf" : "%1$s aktualizoval(a) „%2$s“ vo vašom mene",
    "%1$s updated \"%2$s\" on your calendar \"%3$s\"" : "%1$s aktualizoval(a) „%2$s“ vo vašom kalendári „%3$s“",
    "%1$s deleted \"%2$s\" on your behalf" : "%1$s odstránil(a) „%2$s“ vo vašom mene",
    "%1$s permanently deleted \"%2$s\" from your calendar \"%3$s\"" : "%1$s natrvalo odstránil(a) „%2$s“ z vášho kalendára „%3$s“",
    "%1$s moved \"%2$s\" to the trash on your behalf" : "%1$s presunul(a) „%2$s“ do koša vo vašom mene",
    "%1$s moved \"%2$s\" to the trash on your calendar \"%3$s\"" : "%1$s presunul(a) „%2$s“ do koša vo vašom kalendári „%3$s“",
    "%1$s restored \"%2$s\" on your behalf" : "%1$s obnovil(a) „%2$s“ vo vašom mene",
    "%1$s restored \"%2$s\" on your calendar \"%3$s\"" : "%1$s obnovil(a) „%2$s“ vo vašom kalendári „%3$s“",
    ...
    "The system address book contains contact information for all users in your instance. The system address book is required for the searching and auto-completion of users." : "Systémový adresár obsahuje kontaktné informácie všetkých používateľov vašej inštancie. Systémový adresár je potrebný na vyhľadávanie a automatické dopĺňanie používateľov.",
    "Enable System Address Book in DAV clients" : "Povoliť systémový adresár v klientoch DAV",
