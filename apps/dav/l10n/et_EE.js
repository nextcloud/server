OC.L10N.register(
    ...
    "Death of %s" : "%s surm",
    "Calendar federation" : "Kalendri kasutamine liitpilves (födereerimine)",
    "{user} has shared the calendar {calendar} with you" : "{user} on sinuga jaganud „{calendar}“ kalendrit",
    "Accept" : "Nõustu",
    "Decline" : "Keeldu",
    ...
    "In the past on %1$s for the entire day" : "Minevikus kogu päeva kestel: %1$s",
    ...
    "Delegate:" : "Volitatu:",
    "%1$s created \"%2$s\" on your behalf" : "%1$s lisas sinu nimel „%2$s“ kirje",
    "%1$s created \"%2$s\" on your calendar \"%3$s\"" : "%1$s lisas sinu „%3$s“ kalendrisse „%2$s“ kirje",
    "%1$s updated \"%2$s\" on your behalf" : "%1$s muutis sinu nimel „%2$s“ kirjet",
    "%1$s updated \"%2$s\" on your calendar \"%3$s\"" : "%1$s muutis sinu „%3$s“ kalendris „%2$s“ kirjet",
    "%1$s deleted \"%2$s\" on your behalf" : "%1$s kustutas sinu nimel „%2$s“ kirje",
    "%1$s permanently deleted \"%2$s\" from your calendar \"%3$s\"" : "%1$s kustutas sinu „%3$s“ kalendrist lõplikult „%2$s“ kirje",
    "%1$s moved \"%2$s\" to the trash on your behalf" : "%1$s viskas sinu nimel „%2$s“ kirje prügikasti",
    "%1$s moved \"%2$s\" to the trash on your calendar \"%3$s\"" : "%1$s viskas sinu „%3$s“ kalendrist „%2$s“ kirje prügikasti",
    "%1$s restored \"%2$s\" on your behalf" : "%1$s taastas sinu nimel „%2$s“ kirje",
    "%1$s restored \"%2$s\" on your calendar \"%3$s\"" : "%1$s taastas sinu „%3$s“ kalendris „%2$s“ kirje",
    ...
    "The system address book contains contact information for all users in your instance. The system address book is required for the searching and auto-completion of users." : "Süsteemiüleses aadressiraamatus leiduvad kõikide selle serveri kasutajate kontaktandmed. See on vajalik kasutajate otsimiseks ja automaattäiteks.",
    "Enable System Address Book in DAV clients" : "Kasuta DAV-klientide puhul süsteemiülest aadressiraamatut",
    ...
    "Example content serves to showcase the features of Nextcloud. Default content is shipped with Nextcloud, and can be replaced by custom content." : "Sisunäidis annab ülevaate Nexctcloudi võimalustest. Vaikimisi sisu tuleb Nexctcloudi paigaldusega kaasa ja seda saad alati oma sisuga asendada.",
