OC.L10N.register(
    ...
    "Upgrade needed" : "需要升級",
    "Delegate:" : "代表：",
    "%1$s created \"%2$s\" on your behalf" : "%1$s 代表您建立了「%2$s」",
    "%1$s created \"%2$s\" on your calendar \"%3$s\"" : "%1$s 在您的日曆「%3$s」建立了「%2$s」",
    "%1$s updated \"%2$s\" on your behalf" : "%1$s 代表您更新了「%2$s」",
    "%1$s updated \"%2$s\" on your calendar \"%3$s\"" : "%1$s 在您的日曆「%3$s」更新了「%2$s」",
    "%1$s deleted \"%2$s\" on your behalf" : "%1$s 代表您刪除了「%2$s」",
    "%1$s permanently deleted \"%2$s\" from your calendar \"%3$s\"" : "%1$s 從您的日曆「%3$s」永久刪除了「%2$s」",
    "%1$s moved \"%2$s\" to the trash on your behalf" : "%1$s 代表您將「%2$s」移動到回收桶",
    "%1$s moved \"%2$s\" to the trash on your calendar \"%3$s\"" : "%1$s 在您的日曆「%3$s」上將「%2$s」移動到回收桶",
    "%1$s restored \"%2$s\" on your behalf" : "%1$s 代表您還原了「%2$s」",
    "%1$s restored \"%2$s\" on your calendar \"%3$s\"" : "%1$s 在您的日曆「%3$s」還原了「%2$s」",
    ...
    "The system address book contains contact information for all users in your instance. The system address book is required for the searching and auto-completion of users." : "系統通訊錄包含此執行個體中所有用戶的聯絡資料。搜尋用戶及自動完成功能均需要使用系統通訊錄。",
    "Enable System Address Book in DAV clients" : "在 DAV 客戶端啟用系統通訊錄",
