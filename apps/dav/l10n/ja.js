OC.L10N.register(
    ...
    "Delegate:" : "委任者：",
    "%1$s created \"%2$s\" on your behalf" : "%1$sがあなたに代わって\"%2$s\"を作成しました",
    "%1$s created \"%2$s\" on your calendar \"%3$s\"" : "%1$sがカレンダー\"%3$s\"に\"%2$s\"を作成しました",
    "%1$s updated \"%2$s\" on your behalf" : "%1$sがあなたに代わって\"%2$s\"を更新しました",
    "%1$s updated \"%2$s\" on your calendar \"%3$s\"" : "%1$sがカレンダー\"%3$s\"の\"%2$s\"を更新しました",
    "%1$s deleted \"%2$s\" on your behalf" : "%1$sにより\"%2$s\"が削除されました",
    "%1$s permanently deleted \"%2$s\" from your calendar \"%3$s\"" : "%1$sは\"%2$s\"をカレンダー\"%3$s\"から完全に削除しました",
    "%1$s moved \"%2$s\" to the trash on your behalf" : "%1$sは\"%2$s\"をごみ箱に移動しました",
    "%1$s moved \"%2$s\" to the trash on your calendar \"%3$s\"" : "%1$sは\"%2$s\"をカレンダー\"%3$s\"のごみ箱に移動しました",
    "%1$s restored \"%2$s\" on your behalf" : "%1$sが、あなたに代わって\"%2$s\"を復元しました",
    "%1$s restored \"%2$s\" on your calendar \"%3$s\"" : "%1$sがカレンダー\"%3$s\"の\"%2$s\"を復元しました",
    ...
    "The system address book contains contact information for all users in your instance. The system address book is required for the searching and auto-completion of users." : "システムアドレス帳には、インスタンス内のすべてのユーザーの連絡先情報が含まれています。ユーザーの検索やオートコンプリート機能を利用するには、システムアドレス帳が必要です。",
    "Enable System Address Book in DAV clients" : "DAVクライアントでシステムアドレス帳を有効にする",
