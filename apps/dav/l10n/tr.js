OC.L10N.register(
    ...
    "Tasks" : "Görevler",
    "Personal" : "Kişisel",
    "{actor} created calendar {calendar}" : "{actor}, {calendar} takvimini oluşturdu",
    "You created calendar {calendar}" : "{calendar} takvimini oluşturdunuz",
    ...
    "{actor} created event {event} in calendar {calendar}" : "{actor}, {calendar} takviminde {event} etkinliğini oluşturdu",
    "You created event {event} in calendar {calendar}" : "{calendar} takviminde {event} etkinliğini oluşturdunuz",
    ...
    "Busy" : "Meşgul",
    "{actor} created to-do {todo} in list {calendar}" : "{actor}, {calendar} takvimi listesinde {todo} yapılacak işini oluşturdu",
    "You created to-do {todo} in list {calendar}" : "{calendar} takvimi listesinde {todo} yapılacak işini oluşturdunuz",
    ...
    "Contacts" : "Kişiler",
    "{actor} created address book {addressbook}" : "{actor}, {addressbook} adres defterini oluşturdu",
    "You created address book {addressbook}" : "{addressbook} adres defterini oluşturdunuz",
    ...
    "{actor} created contact {card} in address book {addressbook}" : "{actor}, {addressbook} adres defterinde {card} kişi kartını oluşturdu",
    "You created contact {card} in address book {addressbook}" : "{addressbook} adres defterinde {card} kişi kartını oluşturdu",
    ...
    "Delegate:" : "Yetkiyi devret:",
    "%1$s created \"%2$s\" on your behalf" : "%1$s, sizin adınıza \"%2$s\" oluşturdu",
    "%1$s created \"%2$s\" on your calendar \"%3$s\"" : "%1$s, \"%3$s\" takviminizde \"%2$s\" oluşturdu",
    "%1$s updated \"%2$s\" on your behalf" : "%1$s, sizin adınıza \"%2$s\" güncelledi",
    "%1$s updated \"%2$s\" on your calendar \"%3$s\"" : "%1$s, \"%3$s\" takviminizde \"%2$s\" güncelledi",
    "%1$s deleted \"%2$s\" on your behalf" : "%1$s, sizin adınıza \"%2$s\" sildi",
    "%1$s permanently deleted \"%2$s\" from your calendar \"%3$s\"" : "%1$s, \"%3$s\" takviminizden \"%2$s\" sildi",
    "%1$s moved \"%2$s\" to the trash on your behalf" : "%1$s, sizin adınıza \"%2$s\" ögesini çöpe attı",
    "%1$s moved \"%2$s\" to the trash on your calendar \"%3$s\"" : "%1$s, \"%3$s\" takviminizde \"%2$s\" ögesini çöpe attı",
    "%1$s restored \"%2$s\" on your behalf" : "%1$s, sizin adınıza \"%2$s\" geri yükledi",
    "%1$s restored \"%2$s\" on your calendar \"%3$s\"" : "%1$s, \"%3$s\" takviminizde \"%2$s\" geri yükledi",
    ...
    "The system address book contains contact information for all users in your instance. The system address book is required for the searching and auto-completion of users." : "Sistem adres defterinde, kopyanızdaki tüm kullanıcıların iletişim bilgileri bulunur. Kullanıcıların aranabilmesi ve otomatik olarak tamamlanabilmesi için sistem adres defteri gereklidir.",
    "Enable System Address Book in DAV clients" : "DAV istemcilerinde sistem adres defteri kullanılsın",
    ...
    "Automatically set user status to \"Do not disturb\" outside of availability to mute all notifications." : "Tüm bildirimleri kapatmak için, uygunluk durumu dışında kullanıcı durumu otomatik olarak \"Rahatsız etmeyin\" olarak ayarlanır.",
    "Cancel" : "İptal",
    "Import" : "İçe aktar",
