OC.L10N.register(
    ...
    "_In %n minute on %1$s for the entire day_::_In %n minutes on %1$s for the entire day_" : ["Za %n minutu v %1$s po celý den","Za %n minuty v %1$s po celý den","Za %n minut v %1$s po celý den","Za %n minuty v %1$s po celý den"],
    ...
    "_In %n month on %1$s for the entire day_::_In %n months on %1$s for the entire day_" : ["Za %n měsíc v %1$s po celý den","Za %n měsíce v %1$s po celý den","Za %n měsíců v %1$s po celý den","Za %n měsíce v %1$s po celý den"],
    ...
    "Insufficient space" : "Nedostatečný prostor",
