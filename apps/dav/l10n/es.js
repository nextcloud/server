OC.L10N.register(
    ...
    "In %1$s %2$s on %3$s then on %4$s" : "En %1$s %2$s el %3$s y luego el %4$s",
    "In %1$s %2$s on %3$s then on %4$s and %5$s" : "En %1$s %2$s el %3$s y luego el %4$s y %5$s"
},
