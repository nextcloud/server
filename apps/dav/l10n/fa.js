OC.L10N.register(
    ...
    "Could not open file: %1$s (%2$d), file does seem to exist" : "باز کردن پرونده ممکن نشد: %1$s (%2$d)، به نظر می‌رسد پرونده وجود دارد",
    "Could not open file: %1$s (%2$d), file doesn't seem to exist" : "باز کردن پرونده ممکن نشد: %1$s (%2$d)، به نظر می‌رسد پرونده وجود ندارد",
    ...
    "%1$s deleted \"%2$s\" on your behalf" : "%1$s \"%2$s\" را از طرف شما حذف کرد",
    "%1$s permanently deleted \"%2$s\" from your calendar \"%3$s\"" : "%1$s \"%2$s\" را برای همیشه از تقویم \"%3$s\" شما حذف کرد",
    "%1$s moved \"%2$s\" to the trash on your behalf" : "%1$s \"%2$s\" را از طرف شما به سطل زباله منتقل کرد",
    "%1$s moved \"%2$s\" to the trash on your calendar \"%3$s\"" : "%1$s \"%2$s\" را در تقویم \"%3$s\" شما به سطل زباله منتقل کرد",
    "%1$s restored \"%2$s\" on your behalf" : "%1$s \"%2$s\" را از طرف شما بازیابی کرد",
