OC.L10N.register(
    ...
    "Saturday" : "토요일",
    "Sunday" : "일요일",
    "Automatically set user status to \"Do not distrub\" outside of availability to mute all notifications." : "대응 가능한 시간이 아닐 때 모든 알림을 끄기 위해, 자동으로 사용자 상태를 \"방해 금지\"로 설정합니다.",
    "Save" : "저장",
