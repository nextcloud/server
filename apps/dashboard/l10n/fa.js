OC.L10N.register(
    ...
    "For your privacy, the weather data is requested by your {productName} server on your behalf so the weather service receives no personal information." : "برای حفظ حریم خصوصی شما، سرور {productName} داده‌های آب‌وهوا را از طرف شما درخواست می‌کند تا سرویس آب‌وهوا هیچ اطلاعات شخصی‌ای دریافت نکند.",
