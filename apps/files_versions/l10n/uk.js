OC.L10N.register(
    "files_versions",
    {
    "Block file versioning" : "Блокувати версійність файлів",
    "Automatic tag based blocking of file version creation." : "Автоматичне встановлення мітки блокуваня створення версії файлу.",
    "No rule given" : "Відсутнє правило",
    "A new version is created" : "Створено нову версію",
    "Versions" : "Версії",
