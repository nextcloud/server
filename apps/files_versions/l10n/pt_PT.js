OC.L10N.register(
    "files_versions",
    {
    "Automatic tag based blocking of file version creation." : "Bloqueio automático da criação de versões de arquivos com base em etiquetas.",
    "No rule given" : "Nenhuma regra definida",
    "A new version is created" : "É criada uma nova versão",
    "Versions" : "Versões",
