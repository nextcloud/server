OC.L10N.register(
    "files_versions",
    {
    "Block file versioning" : "Блокировать управление версиями файлов",
    "Automatic tag based blocking of file version creation." : "Автоматическая блокировка создания версии файла на основе тегов.",
    "No rule given" : "Правило не задано",
    "A new version is created" : "Создана новая версия",
    "Versions" : "Версии",
