...
class Expiration {
	...
	private string $retentionObligation;
	private int $minAge;
	private int $maxAge;
	private bool $canPurgeToSaveSpace;
	...
	public function __construct(
		...
		$this->retentionObligation = $config->getSystemValueString('versions_retention_obligation', 'auto');
