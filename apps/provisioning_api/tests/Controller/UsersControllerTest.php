...
class UsersControllerTest extends TestCase {
	...
	public function testGetUserDataAsAdmin(): void {
		...
		$this->mockAccount($targetUser, [
			...
			IAccountManager::PROPERTY_BSKY => ['value' => 'bsky'],
	...
	public static function selfEditChangePropertyProvider(): array {
		return [
			...
			[IAccountManager::PROPERTY_BSKY, 'old.bsky', 'new.bsky'],
	...
	public function selfEditChangePropertyScopeProvider() {
		return [
			...
			[IAccountManager::PROPERTY_BSKY, IAccountManager::SCOPE_LOCAL, IAccountManager::SCOPE_FEDERATED],
