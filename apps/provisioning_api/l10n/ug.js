OC.L10N.register(
    ...
    "Logged in user must be an administrator or have authorization to edit this setting." : "تىزىمغا كىرگەن ئىشلەتكۈچى چوقۇم باشقۇرغۇچى بولۇشى ياكى بۇ تەڭشەكنى تەھرىرلەش ھوقۇقى بولۇشى كېرەك.",
    "This application enables a set of APIs that external systems can use to manage users, groups and apps." : "بۇ پروگرامما سىرتقى سىستېمىلار ئىشلەتكۈچىلەر ، گۇرۇپپىلار ۋە ئەپلەرنى باشقۇرۇشتا ئىشلىتىدىغان بىر يۈرۈش API لارنى قوزغىتىدۇ.",
    "This application enables a set of APIs that external systems can use to create, edit, delete and query user\n\t\tattributes, query, set and remove groups, set quota and query total storage used in Nextcloud. Group admin users\n\t\tcan also query Nextcloud and perform the same functions as an admin for groups they manage. The API also enables\n\t\tan admin to query for active Nextcloud applications, application info, and to enable or disable an app remotely.\n\t\tOnce the app is enabled, HTTP requests can be used via a Basic Auth header to perform any of the functions\n\t\tlisted above. More information is available in the Provisioning API documentation, including example calls\n\t\tand server responses." : "بۇ پروگرامما سىرتقى سىستېمىلار ئىشلەتكۈچىنى قۇرۇش ، تەھرىرلەش ، ئۆچۈرۈش ۋە سۈرۈشتۈرۈش ئۈچۈن ئىشلىتىدىغان بىر يۈرۈش API لارنى قوزغىتىدۇ\n\t\tخاسلىق ، سۈرۈشتۈرۈش ، گۇرۇپپىلارنى تەڭشەش ۋە ئۆچۈرۈش ، Nextcloud دا ئىشلىتىلىدىغان نورما ۋە سوئال ئومۇمىي ساقلاش. گۇرۇپپا باشقۇرغۇچى ئىشلەتكۈچىلەر\n\t\tNextcloud دىن سوئال سوراپ ، ئۇلار باشقۇرىدىغان گۇرۇپپىلارنىڭ باشقۇرغۇچىسى بىلەن ئوخشاش ئىقتىدارلارنى ئىشلىتەلەيدۇ. API يەنە قوزغىتىدۇ\n\t\tئاكتىپ Nextcloud قوللىنىشچان پروگراممىلىرى ، قوللىنىشچان ئۇچۇرلار ۋە ئەپنى يىراقتىن قوزغىتىش ياكى چەكلەش ئۈچۈن باشقۇرغۇچى.\n\t\tبۇ دېتال قوزغىتىلغاندىن كېيىن ، HTTP تەلەپلىرىنى Basic Auth ماۋزۇسى ئارقىلىق ھەر قانداق ئىقتىدارنى ئورۇندىغىلى بولىدۇ\n\t\tيۇقىرىدا كۆرسىتىلگەن. تەمىنلىگۈچى API ھۆججىتىدە تېخىمۇ كۆپ ئۇچۇرلار بار ، مەسىلەن تېلېفون چاقىرىش\n\t\tۋە مۇلازىمېتىرنىڭ ئىنكاسى."
},
