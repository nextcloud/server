OC.L10N.register(
    ...
    "Cannot change display name for this user" : "Cannot change display name for this user",
    "Invalid email address" : "Invalid email address",
    "Language change is not allowed on this instance" : "Language change is not allowed on this instance",
    "Invalid language" : "Invalid language",
    "Insufficient permissions to change quota" : "Insufficient permissions to change quota",
    "Insufficient permissions to change groups" : "Insufficient permissions to change groups",
    "Group %s does not exist" : "Group %s does not exist",
    "Insufficient permissions to change sub-admin groups" : "Insufficient permissions to change sub-admin groups",
    "Insufficient permissions to change manager" : "Insufficient permissions to change manager",
