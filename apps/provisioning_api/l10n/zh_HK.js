OC.L10N.register(
    ...
    "Cannot change display name for this user" : "無法變更此用戶的顯示名稱",
    "Invalid email address" : "電郵地址無效",
    "Language change is not allowed on this instance" : "此站台不允許變更語言",
    "Invalid language" : "無效的語言",
    "Insufficient permissions to change quota" : "權限不足，無法變更配額",
    "Insufficient permissions to change groups" : "權限不足，無法變更群組",
    "Group %s does not exist" : "群組 %s 不存在",
    "Insufficient permissions to change sub-admin groups" : "權限不足，無法變更子管理員群組",
    "Insufficient permissions to change manager" : "權限不足，無法變更管理者",
