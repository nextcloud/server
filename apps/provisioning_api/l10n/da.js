OC.L10N.register(
    ...
    "To send a password link to the user an email address is required." : "For at sende et link til nulstilling af adgangskode til brugeren kræves en e-mailadresse.",
    ...
    "Logged in user must be an administrator or have authorization to edit this setting." : "Den indloggede bruger skal være en administrator eller have autorisation til at redigere denne indstilling.",
    "This application enables a set of APIs that external systems can use to manage users, groups and apps." : "Denne applikation muliggør et sæt af API'er, som eksterne systemer kan bruge til at administrere brugere, grupper og apps.",
