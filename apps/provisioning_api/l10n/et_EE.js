OC.L10N.register(
    ...
    "Could not create non-existing user ID" : "Mitteolemasoleva kasutaja tunnuse loomine ei õnnestunud",
    ...
    "Cannot change display name for this user" : "Selle kasutaja kuvatava nime muutmine ei õnnestu",
    "Invalid email address" : "Vigane e-posti aadress",
    "Language change is not allowed on this instance" : "Keele muutmine pole selles serveris lubatud",
    "Invalid language" : "Vigane keel",
    "Insufficient permissions to change quota" : "Pole piisavalt õigusi kvoodi muutmiseks",
    "Insufficient permissions to change groups" : "Pole piisavalt õigusi gruppide muutmiseks",
    "Group %s does not exist" : "„%s“ gruppi pole olemas",
    "Insufficient permissions to change sub-admin groups" : "Pole piisavalt õigusi peakasutajate alamgruppide muutmiseks",
    "Insufficient permissions to change manager" : "Pole piisavalt õigusi haldaja muutmiseks",
    ...
    "Invalid timezone" : "Vigane ajavöönd",
    ...
    "Provisioning API" : "API kasutajate valmenduse jaoks",
