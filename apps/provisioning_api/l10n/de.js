OC.L10N.register(
    ...
    "Cannot change display name for this user" : "Der Anzeigename dieses Benutzers kann nicht geändert werden",
    "Invalid email address" : "Ungültige E-Mail-Adresse",
    "Language change is not allowed on this instance" : "Ein Sprachwechsel ist in dieser Instanz nicht möglich",
    "Invalid language" : "Ungültige Sprache",
    "Insufficient permissions to change quota" : "Unzureichende Berechtigungen zum Ändern des Kontingents",
    "Insufficient permissions to change groups" : "Unzureichende Berechtigungen zum Ändern von Gruppen",
    "Group %s does not exist" : "Gruppe %s existiert nicht",
    "Insufficient permissions to change sub-admin groups" : "Unzureichende Berechtigungen zum Ändern von Unteradministrationsgruppen",
    "Insufficient permissions to change manager" : "Unzureichende Berechtigungen zum des Managers",
    ...
    "Could not verify mail because the token is expired." : "Die E-Mail-Adresse konnte nicht verifiziert werden, da das Token abgelaufen ist.",
    "Could not verify mail because the token is invalid." : "Die E-Mail-Adresse konnte nicht verifiziert werden, da der Token ungültig ist.",
