OC.L10N.register(
    ...
    "Cannot change display name for this user" : "Bu kullanıcının görüntülenecek adı değiştirilemedi",
    "Invalid email address" : "E-posta adresi geçersiz",
    "Language change is not allowed on this instance" : "Bu kopya için dil değişimine izin verilmiyor",
    "Invalid language" : "Dil geçersiz",
    "Insufficient permissions to change quota" : "Kotayı değiştirme izniniz yok",
    "Insufficient permissions to change groups" : "Grupları değiştirme izniniz yok",
    "Group %s does not exist" : "%s grubu bulunamadı",
    "Insufficient permissions to change sub-admin groups" : "Alt yönetici gruplarını değiştirme izniniz yok",
    "Insufficient permissions to change manager" : "Yöneticiyi değiştirme izniniz yok",
