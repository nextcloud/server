...
class IntegrationTestUserAvatar extends AbstractIntegrationTest {
	...
	public function init() {
		...
		$userBackend  = new User_LDAP($this->access, \OC::$server->getConfig(), \OC::$server->getNotificationManager(), \OC::$server->getUserSession(), \OC::$server->get(UserPluginManager::class));
