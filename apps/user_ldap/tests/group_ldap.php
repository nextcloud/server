...
class Test_Group_Ldap extends \Test\TestCase {
	...
	public function setUp() {
		...
		$this->ldapWrapperMock = $this->getMock('\OCA\user_ldap\lib\ILDAPWrapper');

		$this->connectionMock = $this->getMockBuilder('\OCA\user_ldap\lib\Connection')
			->setConstructorArgs([$this->ldapWrapperMock, null, null])
			->getMock();

		$this->ldapUserManagerMock = $this->getMockBuilder('\OCA\user_ldap\lib\user\Manager')
			->disableOriginalConstructor()
			->getMock();

		$this->accessMock = $this->getMockBuilder('\OCA\user_ldap\lib\Access')
			->setConstructorArgs([$this->connectionMock, $this->ldapWrapperMock, $this->ldapUserManagerMock])
			->getMock();
