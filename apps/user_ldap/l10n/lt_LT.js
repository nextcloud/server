OC.L10N.register(
    ...
    "LDAP User backend" : "LDAP vartotojo posistemė",
    ...
    "Could not detect user display name attribute. Please specify it yourself in advanced LDAP settings." : "Nepavyko aptikti vartotojo rodomo vardo požymio. Nurodykite jį patys išplėstiniuose LDAP nustatymuose.",
    "Could not find the desired feature" : "Nepavyko rasti pageidaujamos ypatybės",
    "Invalid Host" : "Neteisingas serveris",
    "LDAP user and group backend" : "LDAP vartotojo ir grupės posistemė",
    ...
    "Cache Time-To-Live" : "Tarpinės atminties gyvavimo laikas",
    "in seconds. A change empties the cache." : "per kelias sekundes. Pakeitimas ištuština tarpinę atmintį.",
    "Directory Settings" : "Katalogo nustatymai",
    "User Display Name Field" : "Vartotojo rodomo vardo laukas",
    "The LDAP attribute to use to generate the user's display name." : "LDAP požymis, kuris bus naudojamas generuoti vartotojo rodomą vardą.",
    "2nd User Display Name Field" : "2-ojo vartotojo rodomo vardo laukas",
    "Optional. An LDAP attribute to be added to the display name in brackets. Results in e.g. »John Doe (john.doe@example.org)«." : "Neprivaloma. LDAP atributas, kuris bus įterptas į rodomąjį vardą skliaustuose. Pavyzdžiui, rezultatas bus „John Doe (john.doe@example.org)“.",
    "One User Base DN per line" : "Vienas vartotojo bazinis DN vienoje eilutėje",
    "Base User Tree" : "Bazinis vartotojo medis",
    "Optional; one attribute per line" : "Nebūtina; po vieną požymį kiekvienoje eilutėje",
    "User Search Attributes" : "Vartotojo paieškos požymiai",
    ...
    "Group Display Name Field" : "Grupės rodomo pavadinimo laukas",
    ...
    "Nested Groups" : "Įterptosios grupės",
    ...
    "Set the user's email from their LDAP attribute. Leave it empty for default behaviour." : "Nustatyti vartotojų el. paštą pagal jų LDAP požymį. Numatytąjai elgsenai, palikite tuščią.",
    "User Home Folder Naming Rule" : "Vartotojo namų aplanko pavadinimo taisyklė",
    ...
    "Internal Username" : "Vidinis vartotojo vardas",
    ...
    "Internal Username Attribute:" : "Vidinis vartotojo vardo požymis:",
    "Override UUID detection" : "Perrašyti UUID aptikimą",
    "By default, the UUID attribute is automatically detected. The UUID attribute is used to doubtlessly identify LDAP users and groups. Also, the internal username will be created based on the UUID, if not specified otherwise above. You can override the setting and pass an attribute of your choice. You must make sure that the attribute of your choice can be fetched for both users and groups and it is unique. Leave it empty for default behavior. Changes will have effect only on newly mapped (added) LDAP users and groups." : "Pagal numatymą, UUID požymis yra aptinkamas automatiškai. UUID požymis yra naudojamas neabejotinai identifikuoti LDAP vartotojus ir grupes. Be to, vidinis vartotojo vardas bus sukurtas remiantis UUID, jei nenurodyta kitaip. Jūs galite nustelbti nustatymą ir perduoti savo pasirinktą požymį. Turite įsitikinti, kad jūsų pasirinktą požymį gali gauti tiek vartotojai, tiek grupės ir, kad jis yra unikalus. Numatytajai elgsenai, palikite tuščią. Pakeitimai turės įtakos tik naujai susiejamiems (pridedamiems) LDAP vartotojams ir grupėms.",
    ...
    "User found and settings verified." : "Vartotojas surastas, nustatymai patikrinti.",
    "Consider narrowing your search, as it encompassed many users, only the first one of whom will be able to log in." : "Apsvarstykite galimybę susiaurinti paiešką, nes ji apima daug vartotojų, ir tik pirmasis iš jų galės prisijungti.",
    ...
    "LDAP/AD Username:" : "LDAP/AD vartotojo vardas:",
    ...
    "Listing and searching for users is constrained by these criteria:" : "Vartotojų paieška ir sąrašo pateikimas yra sukonstruota remiantis šiais kriterijais:",
    ...
    "Verify settings and count users" : "Patikrinkite nustatymus ir suskaičiuokite vartotojus",
    ...
    "Anonymous bind is not allowed. Please provide a User DN and Password." : "Anoniminis prisijungimas neleidžiamas. Pateikite vartotojo DN ir slaptažodį.",
    ...
    "User not found. Please check your login attributes and username. Effective filter (to copy-and-paste for command-line validation): <br/>" : "Vartotojas nerastas. Patikrinkite savo prisijungimo požymius ir vartotojo vardą. Veiksmingas filtras (skirtas nukopijuoti ir įdėti komandinų eilutės patvirtinimui): <br/>",
    ...
    "When logging in, %s will find the user based on the following attributes:" : "Prisijungiant, %s suras vartotoją, remiantis šiais požymiais:",
    "Allows login against the LDAP/AD username, which is either \"uid\" or \"sAMAccountName\" and will be detected." : "Leidžia prisijungti naudojant LDAP/AD vartotojo vardą, kuris yra „uid“ arba „sAMAccountName“, ir bus aptiktas.",
    "Allows login against an email attribute. \"mail\" and \"mailPrimaryAddress\" allowed." : "Leidžia prisijungti naudojant el. pašto atributą. Leidžiami „mail“ ir „mailPrimaryAddress“.",
    "Defines the filter to apply, when login is attempted. \"%%uid\" replaces the username in the login action. Example: \"uid=%%uid\"" : "Apibrėžia filtrą, kuris taikomas bandant prisijungti. \"%%uid\" pakeičia vartotojo vardą prisijungimo metu. Pavyzdys: \"uid=%%uid\"",
    ...
    "The DN of the client user with which the bind shall be done, e.g. uid=agent,dc=example,dc=com. For anonymous access, leave DN and Password empty." : "Kliento vartotojo DN, kuris turi būti naudojamas prisijungimui, pvz.: uid=agent,dc=example,dc=com. Anonimiškam prisijungimui palikite DN ir slaptažodį tuščius.",
    "Save Credentials" : "Įrašyti prisijungimo duomenis",
    ...
    "The filter specifies which LDAP users shall have access to the %s instance." : "Filtras nurodo, kurie LDAP vartotojai turi turėti prieigą prie %s.",
    "Saving" : "Įrašoma",
    "Back" : "Atgal",
    "Continue" : "Tęsti",
    "Please renew your password." : "Prašome atnaujinkite savo slaptažodį.",
    ...
    "UUID Attribute for Users:" : "UUID požymis vartotojams:",
