OC.L10N.register(
    ...
    "_Your password will expire within %n day._::_Your password will expire within %n days._" : ["Ditt lösenord kommer gå ut inom %n dag.","Your password will expire within %n days."],
    ...
    "Could not detect user display name attribute. Please specify it yourself in advanced LDAP settings." : "Kunde inte upptäcka ditt visningsnamnattribut. Vänligen specificera det själv i avancerade inställningar för LDAP.",
    ...
    "Allows login against an email attribute. \"mail\" and \"mailPrimaryAddress\" allowed." : "Tillåter inloggning mot ett epost-attribut. \"mail\" och \"mailPrimaryAddress\" tillåtna.",
    ...
    "Allow LDAP users to change their password and allow Super Administrators and Group Administrators to change the password of their LDAP users. Only works when access control policies are configured accordingly on the LDAP server. As passwords are sent in plaintext to the LDAP server, transport encryption must be used and password hashing should be configured on the LDAP server." : "Tillåt LDAP användare att ändra deras lösenord och tillåt Superadministratörer och Gruppadministratörer att ändra lösenordet för deras LDAP-användare. Fungerar bara när policy för åtkomstkontroll är konfigurerat därefter på LDAP-servernt. Eftersom lösenord är skickade i ren text till LDAP-servern, transportkryptering måste användas och lösenordshashning ska vara konfigurerat på LDAP-servern.",
