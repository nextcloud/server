OC.L10N.register(
    ...
    "Checking for invalid LDAP UUIDs" : "فحص المُعرِّفات غير الصحيحة في دليل المستخدِمين LDAP UUIDs",
    ...
    "Override default quota for LDAP users who do not have a quota set in the Quota Field." : "تخطِّي الحصة الافتراضية لمستخدمي خادوم LDAP الذين ليس لديهم حصة محددة في حقل الحصة.",
    "Email Field" : "خانة البريد الإلكتروني",
    "Set the user's email from their LDAP attribute. Leave it empty for default behaviour." : "قُم بتعيين البريد الإلكتروني للمستخدمين من خاصّية خادوم LDAP الخاصة بهم. اتركه فارغًا للتصرُّف الافتراضي.",
