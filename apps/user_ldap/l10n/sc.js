OC.L10N.register(
    ...
    "User found and settings verified." : "Utente agatadu e cunfiguratzione averiguada.",
    ...
    "An unspecified error occurred. Please check log and settings." : "B'at àpidu un'errore no ispetzificadu. Càstia su registru e sa cunfiguratzione.",
    ...
    "Verify settings and count the groups" : "Averìgua sa cunfiguratzione e conta is grupos",
    ...
    "Verify settings and count users" : "Averìgua sa cunfiguratzione e conta is utentes",
    "Saving" : "Sarvende",
    "Back" : "In segus",
    "Continue" : "Sighi",
    ...
    "Connection Settings" : "Cunfiguratzione de connessione",
    ...
    "Directory Settings" : "Cunfiguratzione de sa cartella",
    ...
    "Chunksize used for paged LDAP searches that may return bulky results like user or group enumeration. (Setting it 0 disables paged LDAP searches in those situations.)" : "Mannària de framentos impreada pro chircas LDAP paginadas chi diant pòdere torrare resurtados graes comente s'enumeratzione de utentes o grupos. (Sa cunfiguratzione a 0 disativat is chircas LDAP paginadas in custas situatziones.)",
