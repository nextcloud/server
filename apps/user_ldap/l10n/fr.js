OC.L10N.register(
    ...
    "The DN of the client user with which the bind shall be done. For anonymous access, leave DN and Password empty." : "Le DN de l’utilisateur client avec lequel la liaison doit être effectuée. Pour un accès anonyme, laissez les champs DN et mot de passe vides.",
    ...
    "Are you sure you want to permanently clear the LDAP mapping? This cannot be undone." : "Voulez-vous vraiment effacer définitivement le mappage LDAP ? Cette action est irréversible.",
    "Mapping cleared" : "Mappage effacé",
    "Failed to clear mapping" : "Impossible d'effacer le mappage",
