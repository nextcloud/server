OC.L10N.register(
    ...
    "Allows login against the LDAP/AD username, which is either 'uid' or 'sAMAccountName' and will be detected." : "Разрешает вход в систему с использованием имени пользователя LDAP/AD, которое имеет вид «uid» или «sAMAccountName», и будет обнаружено.",
    "LDAP/AD Username:" : "LDAP/AD Имя пользователя:",
    "Allows login against an email attribute. 'mail' and 'mailPrimaryAddress' allowed." : "Разрешает вход в систему по атрибуту электронной почты. «mail» и «mailPrimaryAddress» разрешены.",
    ...
    "The DN of the client user with which the bind shall be done. For anonymous access, leave DN and Password empty." : "DN пользователя клиента, с которым должна быть выполнена привязка. Для анонимного доступа оставьте DN и Пароль пустыми.",
    ...
    "Please renew your password" : "Пожалуйста, обновите свой пароль",
    ...
    "Are you sure you want to permanently delete this LDAP configuration? This cannot be undone." : "Вы уверены, что хотите окончательно удалить эту конфигурацию LDAP? Это действие нельзя отменить.",
    "Failed to delete config" : "Не удалось удалить конфигурацию",
    "Are you sure you want to permanently clear the LDAP mapping? This cannot be undone." : "Вы уверены, что хотите окончательно удалить эти соответствия LDAP? Это действие нельзя отменить.",
    "Mapping cleared" : "Соответствия удалены",
    "Failed to clear mapping" : "Не удалось очистить соответствия",
