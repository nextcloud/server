OC.L10N.register(
    ...
    "_Your password will expire within %n day._::_Your password will expire within %n days._" : ["پارولىڭىز %n كۈندە ۋاقتى ئۆتىدۇ.","پارولىڭىز %n كۈندە ۋاقتى ئۆتىدۇ."],
    "LDAP/AD integration" : "LDAP / AD بىرلەشتۈرۈش",
    "LDAP Connection" : "LDAP ئۇلىنىشى",
    "_Binding failed for this LDAP configuration: %s_::_Binding failed for %n LDAP configurations: %s_" : ["بۇ LDAP سەپلىمىسىگە ئۇلاش مەغلۇپ بولدى: %s","%nLDAP سەپلىمىسىگە ئۇلاش مەغلۇپ بولدى: %s"],
    "_Searching failed for this LDAP configuration: %s_::_Searching failed for %n LDAP configurations: %s_" : ["بۇ LDAP سەپلىمىسىنى ئىزدەش مەغلۇپ بولدى: %s","%nLDAP سەپلىمىسىنى ئىزدەش مەغلۇپ بولدى: %s"],
    "_There is an inactive LDAP configuration: %s_::_There are %n inactive LDAP configurations: %s_" : ["ئىشلىتىلمىگەن بىر LDAP سەپلىمىسى مەۋجۇت: %s","ئىشلىتىلمىگەن %n LDAP سەپلىمىسى مەۋجۇت: %s"],
    "_Binding and searching works on the configured LDAP connection (%s)_::_Binding and searching works on all of the %n configured LDAP connections (%s)_" : ["تەڭشىگەن LDAP ئۇلىنىشى (%s) دا باغلاش ۋە ئىزدەش خىزمىتى ئىشلەيدۇ.","%n تەڭشەلگەن LDAP ئۇلىنىشلىرىنىڭ ھەممىسىدە باغلاش ۋە ئىزدەش ئىشلەيدۇ (%s)"],
    ...
    "_%n group found_::_%n groups found_" : ["%n گۇرۇپپا تېپىلدى","%n گۇرۇپپا تېپىلدى"],
    "> 1000 groups found" : "> 1000 گۇرۇپپا تېپىلدى",
    "> 1000 users found" : "> 1000 ئىشلەتكۈچى تېپىلدى",
    "_%n user found_::_%n users found_" : ["%n ئىشلەتكۈچى تېپىلمىدى","%n ئىشلەتكۈچى تېپىلمىدى"],
    ...
    "Paging chunksize" : "بەتلەش پارچە چوڭلۇقى",
    ...
    "`$home` Placeholder Field" : "\"$home\" ئورۇن ئىسمى",
    ...
    "UUID Attribute for Users" : "ئىشلەتكۈچىلەرنىڭ UUID خاسلىقى:",
    "UUID Attribute for Groups" : "گۇرۇپپىلارنىڭ UUID خاسلىقى:",
    "Groups meeting these criteria are available in {instanceName}:" : "بۇ ئۆلچەمگە توشىدىغان گۇرۇپپىلار {instanceName} دا بار:",
    ...
    "The filter specifies which LDAP groups shall have access to the {instanceName} instance." : "بۇ سۈزگۈچ قايسى LDAP گۇرۇپپىسىنىڭ {instanceName} مىسالىغا كىرەلەيدىغانلىقىنى بەلگىلەيدۇ.",
    "LDAP Filter:" : "LDAP سۈزگۈچ:",
    "Verify settings and count the groups" : "تەڭشەكلەرنى تەكشۈرۈپ گۇرۇپپىلارنى ساناپ بېقىڭ",
    "User not found. Please check your login attributes and username. Effective filter (to copy-and-paste for command-line validation): {filter}" : "ئىشلەتكۈچى تېپىلمىدى. كىرىش خۇسۇسىيەتلىرىڭىز ۋە ئىشلەتكۈچى ئىسمىڭىزنى تەكشۈرۈڭ. ئۈنۈملۈك سۈزگۈچ (بۇيرۇق قۇرىدا تەكشۈرۈش ئۈچۈن كۆچۈرۈش ۋە چاپلاش): {filter}",
    ...
    "_{ldapTestBase} entry available within the provided Base DN_::_{ldapTestBase} entries available within the provided Base DN_" : ["بېرىلگەن ئاساسىي DN دا {ldapTestBase} تارماق مەۋجۇت","بېرىلگەن ئاساسىي DN دا {ldapTestBase} تارماق مەۋجۇت"],
    ...
    "Copy configuration" : "سەپلىمە كۆچۈر",
    ...
    "The filter specifies which LDAP users shall have access to the {instanceName} instance." : "بۇ سۈزگۈچ قايسى LDAP ئىشلەتكۈچىلەرنىڭ {instanceName} مىسالىغا كىرەلەيدىغانلىقىنى بەلگىلەيدۇ.",
    "Verify settings and count users" : "تەڭشەكلەرنى تەكشۈرۈپ ، ئىشلەتكۈچىنى ساناپ بېقىڭ",
    "User count: {usersCount}" : "ئىشلەتكۈچى سانى: {usersCount}",
    ...
    "Advanced" : "ئالىي",
    "Expert" : "مۇتەخەسسىس",
    "The PHP LDAP module is not installed, the backend will not work. Please ask your system administrator to install it." : "PHP LDAP مودۇلى ئورنىتىلمىغان، ئارقا ئۇچى ئىشلىمەيدۇ. سىستېما باشقۇرغۇچىڭىزدىن ئۇنى ئورنىتىشنى سوراڭ.",
    "Select LDAP Config" : "LDAP سەپلىمىسىنى تاللا",
    "Create New Config" : "يېڭى سەپلىمە قۇر",
    "Create configuration" : "سەپلىمە قۇر",
    ...
    "Confirm action" : "ھەركەتنى جەزىملە",
    "Are you sure you want to permanently delete this LDAP configuration? This cannot be undone." : "بۇ LDAP سەپلىمىسىنى ھەقىقەتەن مەڭگۈلۈك ئۆچۈرمەكچىمۇ؟ بۇنى ئەسلىگە كەلتۈرگىلى بولمايدۇ.",
    "Failed to delete config" : "سەپلىمىنى ئۆچۈرۈش مەغلۇپ بولدى",
    "Are you sure you want to permanently clear the LDAP mapping? This cannot be undone." : "LDAP خەرىتىسىنى مەڭگۈلۈك تازىلاشنى راستلا خالامسىز؟ بۇنى ئەسلىگە كەلتۈرگىلى بولمايدۇ.",
    "Mapping cleared" : "خەرىتىلەش تازىلاندى",
    "Failed to clear mapping" : "خەرىتىلەشنى تازىلاش مەغلۇپ بولدى",
