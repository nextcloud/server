OC.L10N.register(
    ...
    "Backup (Replica) Host" : "Hospedeiro de backup (réplica)",
    ...
    "`$home` Placeholder Field" : "Campo de Espaço Reservado `$home`",
    ...
    "UUID Attribute for Users" : "Atributo UUID para Usuários",
    "UUID Attribute for Groups" : "Atributo UUID para Grupos",
    "Groups meeting these criteria are available in {instanceName}:" : "Os grupos que atendem a estes critérios estão disponíveis em {instanceName}:",
    ...
    "The filter specifies which LDAP groups shall have access to the {instanceName} instance." : "O filtro especifica quais grupos LDAP devem ter acesso à instância {instanceName}.",
    "LDAP Filter:" : "Filtro LDAP:",
    "Verify settings and count the groups" : "Verificar configurações e contar grupos",
    "User not found. Please check your login attributes and username. Effective filter (to copy-and-paste for command-line validation): {filter}" : "Usuário não encontrado. Verifique seus atributos de login e nome de usuário. Filtro eficaz (para copiar e colar para validação na linha de comando): {filter}",
    ...
    "A connection error to LDAP/AD occurred. Please check host, port and credentials." : "Ocorreu um erro de conexão com o LDAP/AD. Verifique o hospedeiro, a porta e as credenciais.",
    ...
    "Advanced" : "Avançado",
    "Expert" : "Especialista",
    "The PHP LDAP module is not installed, the backend will not work. Please ask your system administrator to install it." : "O módulo PHP LDAP não está instalado, o back-end não funcionará. Solicite à administração do seu sistema que o instale.",
    "Select LDAP Config" : "Selecione a Configuração LDAP",
    "Create New Config" : "Criar Nova Configuração",
    ...
    "Please renew your password" : "Por favor, renove sua senha",
    ...
    "Base DN could not be auto-detected, please revise credentials, host and port." : "A Base DN não pôde ser detectada automaticamente, revise as credenciais, hospedeiro e a porta.",
