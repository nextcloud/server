...
(function() {
	 ...
	 * in the LDAP wizard.
	 */
	const WizardTabExpert = OCA.LDAP.Wizard.WizardTabGeneric.subClass({
		/**
		 ...
		 */
		setUsernameAttribute(attribute) {
		 ...
		 * @param {string} attribute
		 */
		setUserUUIDAttribute(attribute) {
		 ...
		 * @param {string} attribute
		 */
		setGroupUUIDAttribute(attribute) {
