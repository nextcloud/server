...
(function() {
	const Wizard = function() {
		const detectorQueue = new OCA.LDAP.Wizard.WizardDetectorQueue()
		detectorQueue.init()
		...
		const model = new OCA.LDAP.Wizard.ConfigModel()
		...
		const filterOnTypeFactory = new OCA.LDAP.Wizard.FilterOnTypeFactory()
		...
		const view = new OCA.LDAP.Wizard.WizardView(model)
		view.init()
		view.setModel(model)
		...
		const controller = new OCA.LDAP.Wizard.Controller()
		controller.init()
