	...
	<fieldset id="ldapSettings-1">
		<div id="ldapAdvancedAccordion">
			...
			<div>
				...
				<p><label for="ldap_paging_size"><?php p($l->t('Paging chunksize'));?></label><input type="number" id="ldap_paging_size" name="ldap_paging_size" title="<?php p($l->t('Chunksize for using paged LDAP searches. (Setting it 0 disables paged LDAP searches.)'));?>" data-default="<?php p($_['ldap_paging_size']); ?>" /></p>
			</div>
