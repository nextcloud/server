OC.L10N.register(
    ...
    "Could not add trusted server. Please try again later." : "Не удалось добавить доверенный сервер. Пожалуйста, попробуйте позже.",
    "Add trusted server" : "Добавить доверенный сервер",
    "Server url" : "URL сервера",
    "Add" : "Добавить",
    "Server ok" : "Сервер в порядке",
    "User list was exchanged at least once successfully with the remote server." : "Как минимум один раз список пользователей был успешно обменен с удаленным сервером.",
    "Server pending" : "Сервер ожидает",
    "Waiting for shared secret or initial user list exchange." : "Ожидание обмена общим секретным ключом или первоначальным списком пользователей.",
    "Server access revoked" : "Доступ к серверу отозван.",
    "Server failure" : "Сбой сервера",
    "Connection to the remote server failed or the remote server is misconfigured." : "Сбой подключения к удалённому серверу или неправильная конфигурация удалённого сервера.",
    "Failed to delete trusted server. Please try again later." : "Не удалось удалить доверенный сервер. Пожалуйста, попробуйте позже.",
    "Delete" : "Удалить",
