OC.L10N.register(
    ...
    "Could not add trusted server. Please try again later." : "无法添加受信任的服务器。请稍后重试。",
    "Add trusted server" : "添加受信任的服务器",
    "Server url" : "服务器 URL",
    "Add" : "添加",
    "Server ok" : "服务器正常",
    "User list was exchanged at least once successfully with the remote server." : "用户列表已与远程服务器成功交换至少一次。",
    "Server pending" : "服务器待处理",
    "Waiting for shared secret or initial user list exchange." : "正在等待共享密钥或初始用户列表交换。",
    "Server access revoked" : "服务器访问已撤销",
    "Server failure" : "服务器故障",
    "Connection to the remote server failed or the remote server is misconfigured." : "连接到远程服务器失败或远程服务器配置错误。",
    "Failed to delete trusted server. Please try again later." : "无法受信任的服务器。请稍后重试。",
    "Delete" : "删除",
