OC.L10N.register(
    ...
    "Federation" : "聯邦",
    "Federation allows you to connect with other trusted servers to exchange the account directory." : "聯邦功能允許您與信任的伺服器連結，交換帳戶目錄。",
    "Federation allows you to connect with other trusted servers to exchange the account directory. For example this will be used to auto-complete external accounts for federated sharing." : "聯邦功能允許您與信任的伺服器連結，交換帳戶目錄。舉例來說，與其他雲端聯邦的帳戶分享檔案時，有了這一份列表，就可以在輸入框搜尋他們的帳戶名稱。",
    ...
    "Delete" : "刪除",
    "Federation allows you to connect with other trusted servers to exchange the account directory. For example this will be used to auto-complete external accounts for federated sharing. It is not necessary to add a server as trusted server in order to create a federated share." : "聯邦功能允許您與信任的伺服器連結，交換帳戶目錄。舉例來說，與其他雲端聯邦的用戶分享檔案時，有了這一份目錄，就可以在輸入框搜尋他們的帳戶名稱。不必將伺服器新增為受信任的伺服器就可以建立聯邦分享。",
