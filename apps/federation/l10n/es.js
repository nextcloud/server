OC.L10N.register(
    ...
    "Could not add trusted server. Please try again later." : "No se ha podido añadir un servidor de confianza. Por favor, inténtalo de nuevo más tarde.",
    "Add trusted server" : "Añadir servidor de confianza",
    "Server url" : "URL del servidor",
    "Add" : "Añadir",
    "Server ok" : "Servidor OK",
    "User list was exchanged at least once successfully with the remote server." : "La lista de usuarios se ha intercambiado de manera exitosa al menos una vez con el servidor remoto.",
    "Server pending" : "Servidor pendiente",
    "Waiting for shared secret or initial user list exchange." : "Esperando el secreto compartido o el intercambio inicial de lista de usuarios",
    "Server access revoked" : "Acceso al servidor revocado",
    "Server failure" : "Fallo del servidor",
    "Connection to the remote server failed or the remote server is misconfigured." : "La conexión con el servidor remoto ha fallado o el servidor remoto está desconfigurado.",
    "Failed to delete trusted server. Please try again later." : "Fallo al eliminar el servidor compartido. Por favor, inténtalo de nuevo más tarde.",
    "Delete" : "Eliminar",
