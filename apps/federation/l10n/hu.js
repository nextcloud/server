OC.L10N.register(
    ...
    "Could not add trusted server. Please try again later." : "Nem sikerült a megbízható kiszolgáló hozzáadása. Próbálja újra később.",
    "Add trusted server" : "Megbízható kiszolgáló hozzáadása",
    "Server url" : "Kiszolgáló webcíme",
    "Add" : "Hozzáadás",
    "Server ok" : "Kiszolgáló rendben",
    "User list was exchanged at least once successfully with the remote server." : "A felhasználólista legalább egyszer sikeresen ki lett cserélve a távoli kiszolgálóval.",
    "Server pending" : "Kiszolgáló függőben",
    "Waiting for shared secret or initial user list exchange." : "Várakozás a közös titokra vagy a kezdeti felhasználólista-cserére.",
    "Server access revoked" : "Kiszolgáló-hozzáférés visszavonva",
    "Server failure" : "Kiszolgálóhiba",
    "Connection to the remote server failed or the remote server is misconfigured." : "Nem sikerült a kapcsolódás a távoli kiszolgálóhoz, vagy a távoli kiszolgáló hibásan van beállítva.",
    "Failed to delete trusted server. Please try again later." : "Nem sikerült a megbízható kiszolgáló törlése. Próbálja újra később.",
    "Delete" : "Törlés",
