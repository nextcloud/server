OC.L10N.register(
    ...
    "Add" : "Lägg till",
    "Server ok" : "Server ok",
    "User list was exchanged at least once successfully with the remote server." : "Användarlistan har överförts minst en gång utan problem till fjärrservern.",
    "Server pending" : "Servern väntar",
    "Waiting for shared secret or initial user list exchange." : "Väntar på delad hemlig nyckel eller utbyte av den första användarlistan.",
