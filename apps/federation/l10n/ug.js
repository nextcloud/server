OC.L10N.register(
    ...
    "Add" : "قوش",
    "Federation allows you to connect with other trusted servers to exchange the user directory." : "فېدېراتسىيە باشقا ئىشەنچلىك مۇلازىمېتىرلار بىلەن ئۇلىنىپ ، ئىشلەتكۈچى مۇندەرىجىسىنى ئالماشتۇرالايسىز.",
