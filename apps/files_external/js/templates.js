...
templates['mountOptionsDropDown'] = template({"compiler":[8,">= 4.3.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<div class=\"popovermenu open\">\n	<ul>\n		<li class=\"optionRow\">\n			<span class=\"menuitem\">\n				<input id=\"mountOptionsEncrypt\" class=\"checkbox\" name=\"encrypt\" type=\"checkbox\" value=\"true\" checked=\"checked\"/>\n				<label for=\"mountOptionsEncrypt\">"
    ...
    + "</label>\n			</span>\n		</li>\n		<li class=\"optionRow\">\n			<span class=\"menuitem\">\n				<input id=\"mountOptionsNoTrashbin\" class=\"checkbox\" name=\"no_trashbin\" type=\"checkbox\" value=\"true\"/>\n				<label for=\"mountOptionsNoTrashbin\">"
    + alias4(((helper = (helper = lookupProperty(helpers,"mountOptionsNoTrashbinLabel") || (depth0 != null ? lookupProperty(depth0,"mountOptionsNoTrashbinLabel") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"mountOptionsNoTrashbinLabel","hash":{},"data":data,"loc":{"start":{"line":45,"column":40},"end":{"line":45,"column":71}}}) : helper)))
    + "</label>\n			</span>\n		</li><li class=\"optionRow persistent\">\n			<a href=\"#\" class=\"menuitem remove icon-delete\">\n				<span>"
    + alias4(((helper = (helper = lookupProperty(helpers,"deleteLabel") || (depth0 != null ? lookupProperty(depth0,"deleteLabel") : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"deleteLabel","hash":{},"data":data,"loc":{"start":{"line":49,"column":10},"end":{"line":49,"column":25}}}) : helper)))
    + "</span>\n			</a>\n		</li>\n	</ul>\n</div>\n";
},"useData":true});
})();