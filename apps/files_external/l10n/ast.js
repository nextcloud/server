OC.L10N.register(
    ...
    "external-storage" : "almacenamientu-esternu",
    "Couldn't fetch list of Windows network drive mount points: Empty response from server" : "Nun se pudo dir en cada de la llista de puntos de montaxe d'unidaes en rede de Windows: recibióse una rempuesta balera del sirvidor",
    "Please enter the credentials for the {mount} mount" : "Introduz les credenciales pal montaxe «{mount}»",
    "Username" : "Nome d'usuariu",
    "Credentials saved" : "Guardáronse les credenciales",
    "Credentials saving failed" : "El guardáu de les credenciales falló",
    "Credentials required" : "Les credenciales son obligatories",
    ...
    "Disabling it will allow to use a case insentive file system, but comes with a performance penalty" : "Al desactivar la opción, va permitise l'usu d'un sistema de ficheros que nun ye sensible a mayúscules, más va amenorgar el rindimientu",
