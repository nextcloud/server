OC.L10N.register(
    ...
    "Timeout" : "逾時",
    "SMB/CIFS using Nextcloud login" : "SMB/CIFS 使用 Nextcloud 登入",
    ...
    "Add storage" : "新增儲存空間",
    "Folder name" : "資料夾名稱",
    "Without a restriction this storage is available to every account on this server." : "若無任何限制，此儲存空間將開放給本伺服器上的每個帳號使用。",
    "Authentication" : "認證",
    "Cancel" : "取消",
    "Edit" : "編輯",
    "Create" : "建立",
