OC.L10N.register(
    ...
    "%s" : "%s",
    "Storage with ID \"%d\" is not editable by non-admins" : "Os non administradores non poden editar o almacenamento co identificador \"%d\".",
    ...
    "Login and password" : "Inicio de sesión e contrasinal",
    ...
    "Manually entered, store in database" : "Introdúcese manualmente, almacénase na base de datos",
