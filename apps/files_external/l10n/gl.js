OC.L10N.register(
    ...
    "Access key ID" : "ID da chave de acceso",
    "Secret access key" : "Chave de acceso secreta",
    "Builtin" : "Integrado",
    "None" : "Ningún",
    ...
    "S3-Compatible Object Storage" : "Almacenamento de obxetos compatible con S3",
    "Bucket" : "Bucket",
    ...
    "Use HTTPS" : "Usa HTTPS",
    "Use Path Style (https://example.com/bucket)" : "Usa estilo de ruta (https://example.com/bucket)",
    "Use Legacy S3 signing (v2)" : "Usa asinatura S3 heredada (v2)",
    "Enable multipart copy" : "Activar a copia de múltiples partes",
    "Enable Direct Downloads (presigned URLs)" : "Activar descargas directas (URLs asinadas previamente)",
    ...
    "Local (server storage)" : "Local (almacenamento do servidor)",
    "Location" : "Localización",
    "Nextcloud (WebDAV)" : "Nextcloud (WebDAV)",
    "SFTP (SSH file transfer)" : "SFTP (transferencia de ficheiros por SSH)",
    "Root" : "Root (raíz)",
    "SFTP with public key authentication" : "SFTP con autenticación por chave pública",
    "SMB/CIFS (Windows network share)" : "SMB/CIFS (recurso compartido de rede de Windows)",
    "Share" : "Compartir",
    ...
    "SMB/CIFS using Nextcloud login" : "SMB/CIFS usando o inicio de sesión de Nextcloud",
    "Login as share" : "Acceder como compartición",
    "OpenStack Swift Object Storage" : "Almacenamento de obxetos OpenStack Swift",
