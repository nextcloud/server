OC.L10N.register(
    ...
    "S3-Compatible Object Storage" : "S3-objektu biltegiratze bateragarria",
    "Bucket" : "Ontzia",
    ...
    "Use Path Style (https://example.com/bucket)" : "Erabili bide-estiloa (https://example.com/bucket)",
    "Use Legacy S3 signing (v2)" : "Erabili S3 sinadura zaharra (v2)",
    "Enable multipart copy" : "Gaitu multizati kopia",
    "Enable Direct Downloads (presigned URLs)" : "Gaitu deskarga zuzenak (aurrez sinatutako URLak)",
    ...
    "Local (server storage)" : "Lokala (zerbitzariaren biltegiratzea)",
    "Location" : "Kokapena",
    "Nextcloud (WebDAV)" : "Nextcloud (WebDAV)",
    "SFTP (SSH file transfer)" : "SFTP (SSH fitxategien transferentzia)",
    "Root" : "Erroa",
    "SFTP with public key authentication" : "SFTP gako publikoaren autentifikazioarekin",
    "SMB/CIFS (Windows network share)" : "SMB/CIFS (Windows sareko partekatzea)",
    "Share" : "Partekatu",
    ...
    "SMB/CIFS using Nextcloud login" : "SMB/CIFS Nextcloud saioa erabiliz",
    ...
    "Edit storage" : "Aldatu biltegiratzea",
