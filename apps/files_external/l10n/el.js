OC.L10N.register(
    ...
    "S3 Storage" : "Αποθηκευτικός χώρος S3",
    "Bucket" : "Κάδος",
    ...
    "Edit storage" : "Επεξεργασία αποθηκευτικού χώρου",
    ...
    "Storage configuration" : "Ρύθμιση αποθηκευτικού χώρου",
    "Never" : "Ποτέ",
    "Once every direct access" : "Μία φορά σε κάθε απευθείας πρόσβαση",
    "Always" : "Πάντα",
    "Mount options" : "Επιλογές προσάρτησης",
    "Check filesystem changes" : "Έλεγχος αλλαγών συστήματος αρχείων",
    ...
    "Saved allowed backends" : "Οι επιτρεπόμενες υπηρεσίες αποθήκευσης αποθηκεύτηκαν",
    "Failed to save allowed backends" : "Αποτυχία αποθήκευσης των επιτρεπόμενων υπηρεσιών αποθήκευσης",
    "Advanced options for external storage mounts" : "Επιλογές για προχωρημένους για προσαρτήσεις εξωτερικής αποθήκευσης",
    "Allow people to mount external storage" : "Να επιτρέπεται στους χρήστες η προσάρτηση εξωτερικής αποθήκευσης",
    "External storage backends people are allowed to mount" : "Εξωτερικές υπηρεσίες αποθήκευσης που επιτρέπεται να προσαρτούν οι χρήστες",
    ...
    "External storage enables you to mount external storage services and devices as secondary Nextcloud storage devices." : "Η εξωτερική αποθήκευση σάς επιτρέπει να προσαρτάτε εξωτερικές υπηρεσίες και συσκευές αποθήκευσης ως δευτερεύουσες συσκευές αποθήκευσης του Nextcloud.",
    "You may also allow people to mount their own external storage services." : "Μπορείτε επίσης να επιτρέψετε στους χρήστες να προσαρτούν τις δικές τους εξωτερικές υπηρεσίες αποθήκευσης.",
    "The cURL support in PHP is not enabled or installed." : "Η υποστήριξη cURL στην PHP δεν είναι ενεργοποιημένη ή εγκατεστημένη.",
    "The FTP support in PHP is not enabled or installed." : "Η υποστήριξη FTP στην PHP δεν είναι ενεργοποιημένη ή εγκατεστημένη.",
    "{module} is not installed." : "Το πρόσθετο {module} δεν είναι εγκατεστημένο.",
    "Dependant backends" : "Εξαρτώμενες υπηρεσίες αποθήκευσης",
    "No external storage configured or you do not have the permission to configure them" : "Δεν έχει ρυθμιστεί εξωτερική αποθήκευση ή δεν έχετε το δικαίωμα να τη ρυθμίσετε",
    "Add external storage" : "Προσθήκη εξωτερικής αποθήκευσης",
    "Global credentials saved" : "Τα καθολικά διαπιστευτήρια αποθηκεύτηκαν",
    "Could not save global credentials" : "Αδυναμία αποθήκευσης καθολικών διαπιστευτηρίων",
    ...
    "Checking storage …" : "Γίνεται έλεγχος αποθηκευτικού χώρου …",
    "There was an error with this external storage." : "Παρουσιάστηκε σφάλμα με αυτόν τον εξωτερικό αποθηκευτικό χώρο.",
    ...
    "Incomplete configuration" : "Μη ολοκληρωμένη παραμετροποίηση",
