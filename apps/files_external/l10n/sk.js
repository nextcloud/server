OC.L10N.register(
    ...
    "Static credentials" : "Statické poverenia",
    ...
    "S3-Compatible Object Storage" : "Úložisko objektov kompatibilné so S3",
    "Bucket" : "Sektor",
    "Hostname" : "Hostname",
    "Port" : "Port",
    "Proxy" : "Proxy",
    ...
    "Use Path Style (https://example.com/bucket)" : "Použiť štýl cesty (https://example.com/bucket)",
    "Use Legacy S3 signing (v2)" : "Použiť staré podpisovanie S3 (v2)",
    "Enable multipart copy" : "Povoliť kópiu mutlipart správy",
    "Enable Direct Downloads (presigned URLs)" : "Povoliť priame sťahovanie (predpodpísané URL)",
    ...
    "Local (server storage)" : "Lokálne (úložisko servera)",
    "Location" : "Umiestnenie",
    "Nextcloud (WebDAV)" : "Nextcloud (WebDAV)",
    "SFTP (SSH file transfer)" : "SFTP (prenos súborov cez SSH)",
    "Root" : "Root",
    "SFTP with public key authentication" : "SFTP s overením pomocou verejného kľúča",
    "SMB/CIFS (Windows network share)" : "SMB/CIFS (sieťové zdieľanie Windows)",
    ...
    "SMB/CIFS using Nextcloud login" : "SMB/CIFS s prihlásením do Nextcloudu",
    "Login as share" : "Prihlásiť sa ako zdieľanie.",
    "OpenStack Swift Object Storage" : "Úložisko objektov OpenStack Swift",
    ...
    "Edit" : "Upraviť",
    "Create" : "Vytvoriť",
    "Restrict to" : "Obmedziť na",
    "Storage configuration" : "Konfigurácia úložiska",
    "Never" : "Nikdy",
    "Once every direct access" : "S každým priamym prístupom",
    "Always" : "Vždy",
    "Mount options" : "Možnosti pripojenia",
    "Check filesystem changes" : "Skontrolujte zmeny v súborovom systéme",
    ...
    "Status" : "Stav",
    "Restricted to" : "Obmedzené na",
    "Actions" : "Akcie",
    "Checking …" : "Kontrolujem …",
    "Recheck status" : "Prekontrolovať stav",
    "Delete" : "Vymazať",
    "System provided storage" : "Skladovanie poskytované systémom",
    "Saved" : "Uložené",
    "Error while saving" : "Chyba pri ukladaní",
    "Saved allowed backends" : "Uložené povolené back-endy",
    "Failed to save allowed backends" : "Nepodarilo sa uložiť povolené backendy",
    "Advanced options for external storage mounts" : "Rozšírené možnosti pre pripojenie externého úložiska",
    "Allow people to mount external storage" : "Povoliť užívateľom pripojiť externé úložiská",
    "External storage backends people are allowed to mount" : "Externé úložiská, ktoré môžu ľudia pripojiť",
    ...
    "External storage enables you to mount external storage services and devices as secondary Nextcloud storage devices." : "Externé úložisko vám umožňuje pripojiť externé úložné služby a zariadenia ako sekundárne úložiská Nextcloud.",
    "You may also allow people to mount their own external storage services." : "Môžete tiež umožniť ľuďom pripojiť ich vlastné externé úložné služby.",
    "The cURL support in PHP is not enabled or installed." : "Podpora cURL v PHP nie je povolená ani nainštalovaná.",
    "The FTP support in PHP is not enabled or installed." : "Podpora FTP v PHP nie je povolená alebo nainštalovaná.",
    "{module} is not installed." : "{module} nie je nainštalované.",
    "Dependant backends" : "Závislé backendy",
    "No external storage configured or you do not have the permission to configure them" : "Žiadne externé úložisko nie je nakonfigurované alebo nemáte povolenie na jeho konfiguráciu",
    ...
    "Incomplete configuration" : "Nedokončená konfigurácia",
    ...
    "Use presigned S3 url" : "Použiť predpísanú S3 URL"
},
