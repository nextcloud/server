OC.L10N.register(
    ...
    "Invalid mount point" : "نقطة امتطاء Mount point غير صالحة",
    ...
    "%s" : "%s",
    "Storage with ID \"%d\" is not editable by non-admins" : "وحدة التخزين ذات المُعرِّف \"%d\" لا يمكن الكتابة فيها لغير المشرفين",
    ...
    "Couldn't access. Please log out and in again to activate this mount point" : "تعذّر الوصول. يُرجى تسجيل الخروج ثم الدخول مرة أخرى لتفعيل نقطة الامتطاء mount point هذه",
    "Couldn't get the information from the remote server: {code} {type}" : "تعذّر الحصول على المعلومات من remote server الخادوم القصِي: {code} {type}",
    "Couldn't get the list of external mount points: {type}" : "تعذّر الحصول على قائمة external mount points نقاط الامتطاء الخارجية: {type}",
    "There was an error with message: " : "حدث خطأ في الرسالة: ",
    "external-storage" : "تخزين خارجي external-storage",
    "Couldn't fetch list of Windows network drive mount points: Empty response from server" : "تعذر جلب قائمة \"نقاط امتطاء محرك أقراص شبكة وندوز\"  Windows network drive mount points: استجابة فارغة من الخادوم",
    "Please enter the credentials for the {mount} mount" : "يُرجى إدخال حيثيات الدخول لنقطة الامتطاء {mount} ",
    "Username" : "إسم المستخدم",
    "Credentials saved" : "تم حفظ بيانات الدخول",
    "Credentials saving failed" : "فشل حفظ حيثيات الدخول",
    "Credentials required" : "حيثيات الدخول لازمة",
