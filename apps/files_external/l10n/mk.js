OC.L10N.register(
    ...
    "%s" : "%s",
    "Storage with ID \"%d\" is not user editable" : "Складиштето со ID \"%d\" неможе да се измени од корисник",
    ...
    "Global credentials, user entered" : "Глобални акредитиви, внесени од корисник",
    "User entered, store in database" : "Внесени од корисник, зачувани во базата со податоци",
