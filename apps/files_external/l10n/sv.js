OC.L10N.register(
    ...
    "Disabling it will allow to use a case insentive file system, but comes with a performance penalty" : "Inaktivering gör det möjligt att använda ett skiftlägesokänsligt filsystem, men det kommer att påverka prestandan",
