OC.L10N.register(
    ...
    "Username and password" : "Ім'я користувача та пароль",
    ...
    "Disabling it will allow to use a case insentive file system, but comes with a performance penalty" : "Вимкнення цього параметра дозволить використовувати файлову систему, нечутливу до регістру, але це також призведе до зниження продуктивності",
