OC.L10N.register(
    ...
    "Use HTTPS" : "Use HTTPS",
    "Use Path Style (https://example.com/bucket)" : "Use Path Style (https://example.com/bucket)",
    "Use Legacy S3 signing (v2)" : "Use Legacy S3 signing (v2)",
    "Enable multipart copy" : "Enable multipart copy",
    "Enable Direct Downloads (presigned URLs)" : "Enable Direct Downloads (presigned URLs)",
    ...
    "Local (server storage)" : "Local (server storage)",
    "Location" : "Location",
    "Nextcloud (WebDAV)" : "Nextcloud (WebDAV)",
    "SFTP (SSH file transfer)" : "SFTP (SSH file transfer)",
    "Root" : "Root",
    "SFTP with public key authentication" : "SFTP with public key authentication",
    "SMB/CIFS (Windows network share)" : "SMB/CIFS (Windows network share)",
    "Share" : "Share",
    ...
    "Timeout" : "Timeout",
    "SMB/CIFS using Nextcloud login" : "SMB/CIFS using Nextcloud login",
    ...
    "Without a restriction this storage is available to every account on this server." : "Without a restriction this storage is available to every account on this server.",
