OC.L10N.register(
    ...
    "Fetching request tokens failed. Verify that your app key and secret are correct." : "获取请求令牌失败。检查你的应用 key 和 secret 是否正确。",
    "Fetching access tokens failed. Verify that your app key and secret are correct." : "获取访问令牌失败。检查你的应用 key 和 secret 是否正确。",
