OC.L10N.register(
    ...
    "Storage Class" : "存储类型",
    "Enable SSL" : "启用 SSL",
    "Enable Path Style" : "启用路径样式",
    "Legacy (v2) authentication" : "旧版本（v2）身份验证",
    "Enable multipart copy" : "启用多部分副本",
    "Use presigned S3 url" : "使用预签名的 S3 URL",
    ...
    "Always" : "始终",
    "Mount options" : "挂载选项",
    "Check filesystem changes" : "检查文件系统更改",
    "Read only" : "只读",
    ...
    "Saved allowed backends" : "已保存允许的后端",
    "Failed to save allowed backends" : "无法保存允许的后端",
    "Advanced options for external storage mounts" : "外部存储挂载的高级选项",
    "Allow people to mount external storage" : "允许用户挂载外部存储",
    "External storage backends people are allowed to mount" : "允许用户挂载的外部存储后端",
    ...
    "External storage enables you to mount external storage services and devices as secondary Nextcloud storage devices." : "外部存储使您能够将外部存储服务和设备作为辅助 Nextcloud 存储设备进行挂载。",
    "You may also allow people to mount their own external storage services." : "您还可以允许用户挂载自己的外部存储服务。",
    "The cURL support in PHP is not enabled or installed." : "PHP 中的 cURL 支持未启用或安装。",
    "The FTP support in PHP is not enabled or installed." : "PHP 中的 FTP 支持未启用或安装。",
    "{module} is not installed." : "{module} 未安装。",
    "Dependant backends" : "依赖后端",
    "No external storage configured or you do not have the permission to configure them" : "未配置外部存储，或者您没有权限进行配置",
    "Add external storage" : "添加外部存储",
    "Global credentials saved" : "已保存全局凭据",
    "Could not save global credentials" : "无法保存全局凭据",
