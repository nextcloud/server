OC.L10N.register(
    ...
    "S3-Compatible Object Storage" : "Stockage d’objets compatible avec S3",
    "Bucket" : "Bucket",
    ...
    "Use Path Style (https://example.com/bucket)" : "Utiliser le format de chemin (https://example.com/bucket)",
    "Use Legacy S3 signing (v2)" : "Utiliser l’ancienne méthode de signature S3 (v2)",
    "Enable multipart copy" : "Activer la copie multiple",
    "Enable Direct Downloads (presigned URLs)" : "Activer les téléchargements directs (URL présignées)",
    ...
    "Local (server storage)" : "Local (stockage sur le serveur)",
    "Location" : "Emplacement",
    "Nextcloud (WebDAV)" : "Nextcloud (WebDAV)",
    "SFTP (SSH file transfer)" : "SFTP (transfert de fichiers via SSH)",
    "Root" : "Racine",
    "SFTP with public key authentication" : "SFTP avec authentification par clé publique",
    "SMB/CIFS (Windows network share)" : "SMB/CIFS (partage réseau Windows)",
    "Share" : "Partage",
    ...
    "SMB/CIFS using Nextcloud login" : "SMB/CIFS en utilisant les identifiants de connexion Nextcloud",
    "Login as share" : "Se connecter en tant que partage",
    "OpenStack Swift Object Storage" : "Stockage d’objets OpenStack Swift",
    ...
    "Without a restriction this storage is available to every account on this server." : "Sans une restriction, ce stockage est disponible pour chaque compte de ce serveur.",
    ...
    "Delete" : "Supprimer",
    "System provided storage" : "Stockage fourni par le système",
    "Saved" : "Enregistré",
