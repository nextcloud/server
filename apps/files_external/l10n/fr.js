OC.L10N.register(
    ...
    "Global credentials, manually entered" : "Identifiants globaux, manuellement saisi",
    "Manually entered, store in database" : "Manuellement saisi, stocké dans la base de données",
    ...
    "Login as share" : "Connectez-vous en tant que share.",
    ...
    "Enter the storage login" : "Entrez le login du stockage",
    ...
    "Unknown backend: {backendName}" : "Backend inconnu: {backendName}",
