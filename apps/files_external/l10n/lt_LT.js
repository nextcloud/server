OC.L10N.register(
    ...
    "S3-Compatible Object Storage" : "Su S3 suderinama objektų saugykla",
    ...
    "Use Path Style (https://example.com/bucket)" : "Naudokite kelio stilių (https://example.com/bucket)",
    "Use Legacy S3 signing (v2)" : "Naudoti senąjį S3 pasirašymo būdą (v2)",
    "Enable multipart copy" : "Įgalinti kelių dalių kopijavimą",
    "Enable Direct Downloads (presigned URLs)" : "Įjungti tiesioginius atsisiuntimus (iš anksto pasirašytus URL)",
