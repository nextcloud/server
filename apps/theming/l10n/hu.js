OC.L10N.register(
    ...
    "Universal access is very important to us. We follow web standards and check to make everything usable also without mouse, and assistive software such as screenreaders. We aim to be compliant with the {linkstart}Web Content Accessibility Guidelines{linkend} 2.1 on AA level, with the high contrast theme even on AAA level." : "Az akadálymentesítés fontos számunkra. A webes szabványokat követjük, és ellenőrizzük, hogy minden használható egér nélkül, illetve akadálymentesítési technológiákkal, például képernyőolvasókkal. Arra törekszünk, hogy a {linkstart}Webes tartalomra vonatkozó akadálymentesítési irányelvek{linkend} 2.1-es változatának AA szinten, a magas kontrasztú témával pedig AAA szinten megfeleljünk.",
    ...
    "Unable to apply the setting." : "A beállítás alkalmazása sikertelen.",
    ...
    "Current selected app: {app}, position {position} of {total}" : "Jelenleg kiválasztott alkalmazás: {app}, pozíció: {position}/{total}",
    ...
    "Theme selection is enforced" : "A témaválasztás kényszerítve van",
    "Could not set the app order" : "Nem sikerült az alkalmazások sorrendjének beállítása",
    "Could not reset the app order" : "Nem sikerült az alkalmazások sorrendjének visszaállítása",
    "Navigation bar settings" : "Navigációs sáv beállítása",
    ...
    "The default app can not be changed because it was configured by the administrator." : "Az alapértelmezett alkalmazást nem lehet megváltoztatni, mert azt a rendszergazda állította be.",
    "The app order was changed, to see it in action you have to reload the page." : "Az alkalmazások sorrendje megváltozott, hogy élesben lássa, újra kell töltenie a lapot.",
    "Reset default app order" : "Alapértelmezett alkalmazássorrend visszaállítása",
    "Could not set primary color" : "Nem sikerült az elsődleges szín beállítása",
    ...
    "Default app priority" : "Alapértelmezett alkalmazás prioritása",
    "If an app is not enabled for a user, the next app with lower priority is used." : "Ha egy alkalmazás nincs engedélyezve egy felhasználó számára, akkor a következő alacsonyabb prioritású alkalmazás lesz használva.",
