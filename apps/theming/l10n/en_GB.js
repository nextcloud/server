OC.L10N.register(
    ...
    "Motion sickness reduction" : "Motion sickness reduction",
    "Prevents animations, such as scaling or panning large objects, that can trigger discomfort for those with vestibular motion disorders." : "Prevents animations, such as scaling or panning large objects, that can trigger discomfort for those with vestibular motion disorders.",
    ...
    "Although you can select and customize your instance, users can change their background and colors. If you want to enforce your customization, you can toggle this on." : "Although you can select and customize your instance, users can change their background and colours. If you want to enforce your customization, you can toggle this on.",
    ...
    "The background can be set to an image from the default set, a custom uploaded image, or a plain color." : "The background can be set to an image from the default set, a custom uploaded image, or a plain colour.",
    ...
    "Could not set primary color" : "Could not set primary colour",
    "Set a primary color to highlight important elements. The color used for elements such as primary buttons might differ a bit as it gets adjusted to fulfill accessibility requirements." : "Set a primary colour to highlight important elements. The colour used for elements such as primary buttons might differ a bit as it gets adjusted to fulfill accessibility requirements.",
    "Reset primary color" : "Reset primary colour",
    "Never dismiss" : "Never dismiss",
    "Default ({time} seconds)" : "Default ({time} seconds)",
    "{time} seconds" : "{time} seconds",
    "Could not update toast timeout" : "Could not update toast timeout",
    "Toast notifications" : "Toast notifications",
    "Set how long toast messages stay visible. Choose a longer duration if you need more time to read them." : "Set how long toast messages stay visible. Choose a longer duration if you need more time to read them.",
    "Toast timeout" : "Toast timeout",
    ...
    "Themes" : "Themes",
    "Supplementary themes" : "Supplementary themes",
    "Fonts" : "Fonts",
    ...
    "The primary color is used for highlighting elements like important buttons. It might get slightly adjusted depending on the current color schema." : "The primary colour is used for highlighting elements like important buttons. It might get slightly adjusted depending on the current colour schema.",
    "Header logo" : "Header logo",
    "Upload new header logo" : "Upload new header logo",
    "Upload new favicon" : "Upload new favicon",
    "User settings" : "User settings",
    "Instead of a background image you can also configure a plain background color. If you use a background image changing this color will influence the color of the app menu icons." : "Instead of a background image you can also configure a plain background colour. If you use a background image changing this colour will influence the colour of the app menu icons.",
