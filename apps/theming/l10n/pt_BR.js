OC.L10N.register(
    ...
    "Motion sickness reduction" : "Redução do enjoo de movimento",
    "Prevents animations, such as scaling or panning large objects, that can trigger discomfort for those with vestibular motion disorders." : "Evita animações, como o redimensionamento ou a panorâmica de objetos grandes, que podem causar desconforto em pessoas com distúrbios do sistema vestibular.",
    ...
    "Never dismiss" : "Nunca descartar",
    "Default ({time} seconds)" : "Padrão ({time} segundos)",
    "{time} seconds" : "{time} segundos",
    "Could not update toast timeout" : "Não foi possível atualizar o tempo limite da janela pop-up",
    "Toast notifications" : "Notificações na janela pop-up",
    "Set how long toast messages stay visible. Choose a longer duration if you need more time to read them." : "Defina por quanto tempo as mensagens de notificação na janela pop-up permanecem visíveis. Escolha um período mais longo se precisar de mais tempo para lê-las.",
    "Toast timeout" : "Tempo limite da janela pop-up",
    ...
    "Themes" : "Temas",
    "Supplementary themes" : "Temas complementares",
    "Fonts" : "Fontes",
