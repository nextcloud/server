OC.L10N.register(
    ...
    "Background and color" : "Tausta ja väri",
    "Primary color" : "Ensisijainen väri",
    "Set the default primary color, used to highlight important elements." : "Aseta ensisijainen väri, jota käytetään tärkeiden elementtien korostamiseen.",
    "Background color" : "Taustaväri",
    "When no background image is set the background color will be used." : "Kun taustakuvaa ei ole asetettu, käytetään taustaväriä.",
    ...
    "Failed to update theme." : "Teeman päivittäminen epäonnistui.",
    ...
    "Could not set primary color" : "Ensisijaista väriä ei voitu asettaa",
    "Reset primary color" : "Nollaa ensisijainen väri",
    "Default ({time} seconds)" : "Oletus ({time} sekuntia)",
    "{time} seconds" : "{time} sekuntia",
    "Reset to default" : "Palauta oletukseksi",
    "Non image file selected" : "Muu kuin kuvatiedosto valittu",
