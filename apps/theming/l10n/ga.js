OC.L10N.register(
    ...
    "Reduced motion" : "Gluaiseacht laghdaithe",
    "Motion sickness reduction" : "Laghdú ar thinneas gluaisne",
    "Prevents animations, such as scaling or panning large objects, that can trigger discomfort for those with vestibular motion disorders." : "Cuireann sé cosc ​​ar bheochana, amhail rudaí móra a scálú nó a phánáil, a d’fhéadfadh míchompord a chur faoi deara dóibh siúd a bhfuil neamhoird ghluaiseachta vestibular orthu.",
    ...
    "Move up" : "Éirí suas",
    "Move down" : "Bog síos",
    "Failed to update theme." : "Theip ar an téama a nuashonrú.",
    ...
    "Never dismiss" : "Ná cuir as riamh",
    "Default ({time} seconds)" : "Réamhshocrú ({time} soicind)",
    "{time} seconds" : "{time} soicind",
    "Could not update toast timeout" : "Níorbh fhéidir an t-am scoir tósta a nuashonrú",
    "Toast notifications" : "Fógraí tósta",
    "Set how long toast messages stay visible. Choose a longer duration if you need more time to read them." : "Socraigh cé chomh fada is a fhanann teachtaireachtaí tosaithe le feiceáil. Roghnaigh fad níos faide más gá duit níos mó ama chun iad a léamh.",
    "Toast timeout" : "Sos ama tósta",
    ...
    "Themes" : "Téamaí",
    "Supplementary themes" : "Téamaí forlíontacha",
    "Fonts" : "Clónna",
    ...
    "Disable-user-theming should be true or false" : "Díchumasaigh-úsáideoir-téamaí ba chóir a bheith fíor nó bréagach",
