OC.L10N.register(
    ...
    "Set the default primary color, used to highlight important elements." : "Ustaw domyślny kolor podstawowy, używany do wyróżniania ważnych elementów.",
    "The color used for elements such as primary buttons might differ a bit as it gets adjusted to fulfill accessibility requirements." : "Kolor używany dla elementów takich jak przyciski podstawowe może się nieco różnić, ponieważ jest dostosowywany do wymagań dostępności.",
    "Background color" : "Kolor tła",
    "When no background image is set the background color will be used." : "Gdy nie ustawiono obrazu, użyty zostanie kolor tła.",
    "Otherwise the background color is by default generated from the background image, but can be adjusted to fine tune the color of the navigation icons." : "W przeciwnym razie kolor tła jest domyślnie generowany na podstawie obrazu tła, ale można go dostosować w celu precyzyjnego dopasowania koloru ikon nawigacji.",
    "Use a plain background color instead of a background image." : "Użyj jednolitego koloru tła zamiast obrazu tła.",
    "Remove background image" : "Usuń obraz tła",
    "Background image" : "Obraz tła",
    "Favicon" : "Ikona favicon",
    "Logo" : "Logo",
    "Navigation bar logo" : "Logo paska nawigacji",
    ...
    "Navigation bar app order" : "Kolejność aplikacji na pasku nawigacji",
    ...
    "Default shipped background images" : "Domyślne obrazy tła dostarczane z aplikacją",
    ...
    "Non image file selected" : "Wybrano plik niebędący obrazem",
    "Failed to upload image" : "Nieudana próba załadowania obrazu",
