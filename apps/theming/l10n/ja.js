OC.L10N.register(
    ...
    "Reduced motion" : "動作の制限",
    "Motion sickness reduction" : "乗り物酔いの軽減",
    "Prevents animations, such as scaling or panning large objects, that can trigger discomfort for those with vestibular motion disorders." : "前庭性運動障害のある方に不快感を引き起こす可能性のある、大きなオブジェクトの拡大・縮小やパンなどのアニメーションを防止します。",
    "Legal notice" : "法的通知",
    ...
    "Move up" : "上に移動",
    "Move down" : "下に移動",
    "Failed to update theme." : "テーマの更新に失敗しました。",
    ...
    "Never dismiss" : "無視しない",
    "Default ({time} seconds)" : "デフォルト（{time} 秒）",
    "{time} seconds" : "{time} 秒",
    "Could not update toast timeout" : "トーストのタイムアウトを更新できませんでした",
    "Toast notifications" : "トースト通知",
    "Set how long toast messages stay visible. Choose a longer duration if you need more time to read them." : "トーストメッセージが表示される時間を設定します。メッセージを読むのに時間が必要な場合は、より長い表示時間を選択してください。",
    "Toast timeout" : "トーストのタイムアウト",
