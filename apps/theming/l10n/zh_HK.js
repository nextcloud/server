OC.L10N.register(
    ...
    "Motion sickness reduction" : "減少暈動症",
    ...
    "Move up" : "向上移動",
    "Move down" : "向下移動",
    "Failed to update theme." : "無法更新佈景主題。",
    ...
    "Never dismiss" : "永不自動關閉",
    "Default ({time} seconds)" : "默認（{time} 秒）",
    "{time} seconds" : "{time} 秒",
    "Could not update toast timeout" : "無法更新快顯訊息逾時設定",
    "Toast notifications" : "快顯通知",
    "Set how long toast messages stay visible. Choose a longer duration if you need more time to read them." : "設定快顯訊息保持顯示的時間。如需要更多時間閱讀，請選擇較長的顯示時間。",
    "Toast timeout" : "快顯訊息逾時時間",
    "Reset to default" : "恢復預設值",
    "Non image file selected" : "已選取非圖片檔案",
    "Failed to upload image" : "無法上傳圖像",
