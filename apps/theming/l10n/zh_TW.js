OC.L10N.register(
    ...
    "Motion sickness reduction" : "減輕動暈症",
    "Prevents animations, such as scaling or panning large objects, that can trigger discomfort for those with vestibular motion disorders." : "防止可能引發前庭平衡失調患者不適的動畫效果，例如大型物件的縮放或平移。",
    "Legal notice" : "法律聲明",
    ...
    "Move up" : "向上移動",
    "Move down" : "向下移動",
    "Failed to update theme." : "更新佈景主題失敗。",
    ...
    "Never dismiss" : "永不關閉",
    "Default ({time} seconds)" : "預設 ({time} 秒)",
    "{time} seconds" : "{time} 秒",
    "Could not update toast timeout" : "無法更新快顯通知逾時時間",
    "Toast notifications" : "快顯通知",
    "Set how long toast messages stay visible. Choose a longer duration if you need more time to read them." : "設定快顯訊息保持可見的時間。如果您需要更多時間閱讀，請選擇較長的持續時間。",
    "Toast timeout" : "快顯通知逾時",
    "Reset to default" : "重設為預設值",
    "Non image file selected" : "未選取圖片檔案",
    "Failed to upload image" : "上傳影像失敗",
    ...
    "User settings" : "使用者設定",
    "Instead of a background image you can also configure a plain background color. If you use a background image changing this color will influence the color of the app menu icons." : "除了背景影像以外，您也可以設定純色的背景顏色。若您使用背景影像，變更此顏色將會影響應用程式選單圖示的顏色。",
