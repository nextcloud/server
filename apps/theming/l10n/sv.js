OC.L10N.register(
    ...
    "Never dismiss" : "Avfärda aldrig",
    "Default ({time} seconds)" : "Standard ({time} sekunder)",
    "{time} seconds" : "{time} sekunder",
    "Could not update toast timeout" : "Det gick inte att uppdatera tidsgränsen för notisen",
    "Toast notifications" : "Popupnotiser",
    "Set how long toast messages stay visible. Choose a longer duration if you need more time to read them." : "Ange hur länge popupmeddelanden ska vara synliga. Välj längre tid om du behöver mer tid att läsa dem.",
    "Toast timeout" : "Tidsgräns för popupnotiser",
