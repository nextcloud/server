OC.L10N.register(
    ...
    "Enable the default light theme" : "Kasuta vaikimisi heledat kujundust",
    "The default light appearance." : "Vaikimisi hele kujundus.",
    "Reduced motion" : "Vähendatud liikumismüra visuaalis",
    "Motion sickness reduction" : "Merehaiguse leevendamine",
    "Prevents animations, such as scaling or panning large objects, that can trigger discomfort for those with vestibular motion disorders." : "Võimaldab vältida animatsioone, nagu suurte objektide suurendamine või nihutamine, mis võivad põhjustada ebamugavust inimestele, kellel on vestibulaarsed liikumishäired.",
    ...
    "Use a plain background color instead of a background image." : "Taustapildi asemel kasuta ühtlast taustavärvi.",
    ...
    "Failed to update theme." : "Kujunduse muutmine ei õnnestunud.",
    ...
    "The app order was changed, to see it in action you have to reload the page." : "Rakenduste järjekord on muudetud. Palun laadi lehti uuesti, kui soovid näha kuidas see välja näeb.",
    ...
    "Never dismiss" : "Ära iialgi sulge",
    "Default ({time} seconds)" : "Vaikimisi ({time} sekundit)",
    "{time} seconds" : "{time} sekundit",
    "Could not update toast timeout" : "Teate aegumise uuendamine ei õnnestunud",
    "Toast notifications" : "Teavitused",
    "Set how long toast messages stay visible. Choose a longer duration if you need more time to read them." : "Seadista kui kaua teated on nähtavad. Kui vajad nende lugemiseks rohkem aega, siis sisesta suurem kestus.",
    "Toast timeout" : "Teate aegumine",
    ...
    "Themes" : "Kujundused",
    "Supplementary themes" : "Täiendavad kujundused",
    "Fonts" : "Kirjatüübid",
    ...
    "The primary color is used for highlighting elements like important buttons. It might get slightly adjusted depending on the current color schema." : "Põhivärv on mõeldud lehe oluliste elementide rõhutamiseks. Vastavalt valitud üldkujundusele võib see värv ka natuke kohenduda.",
