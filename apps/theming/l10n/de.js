OC.L10N.register(
    ...
    "Motion sickness reduction" : "Reisekrankheitsreduzierung",
    "Prevents animations, such as scaling or panning large objects, that can trigger discomfort for those with vestibular motion disorders." : "Verhindert Animationen wie das Skalieren oder Schwenken großer Objekte, die bei Menschen mit vestibulären Bewegungsstörungen Beschwerden auslösen können.",
    ...
    "Failed to update theme." : "Design konnte nicht aktualisiert werden.",
    ...
    "Never dismiss" : "Niemals ignorieren",
    "Default ({time} seconds)" : "Standard ({time} Sekunden)",
    "{time} seconds" : "{time} Sekunden",
    "Could not update toast timeout" : "Toast-Zeitüberschreitung konnte nicht aktualisiert werden",
    "Toast notifications" : "Toast-Benachrichtigungen",
    "Set how long toast messages stay visible. Choose a longer duration if you need more time to read them." : "Festlegen, wie lange Toast-Benachrichtigungen angezeigt werden. Eine längere Anzeigedauer wählen, wenn Sie mehr Zeit zum Lesen benötigen.",
    "Toast timeout" : "Toast-Zeitüberschreitung",
    ...
    "Themes" : "Designs",
    "Supplementary themes" : "Ergänzende Designs",
    "Fonts" : "Schriftarten",
