OC.L10N.register(
    ...
    "Saved" : "Salvato",
    "Invalid app given" : "App non valida",
    ...
    "The default light appearance." : "L'aspetto predefinito del tema chiaro.",
    ...
    "Current selected app: {app}, position {position} of {total}" : "App attualmente selezionata: {app}, posizione {position} di {total}",
    "Move up" : "Sposta su",
    ...
    "You can configure the app order used for the navigation bar. The first entry will be the default app, opened after login or when clicking on the logo." : "Puoi configurare l'ordine delle app usato per la barra di navigazione. La prima voce sarà l'app predefinita, aperta dopo l'accesso o quando si clicca il logo.",
    "The default app can not be changed because it was configured by the administrator." : "L'app predefinita non può essere cambiata perché è stata configurata dall'amministratore.",
    "The app order was changed, to see it in action you have to reload the page." : "L'ordine delle app è stato cambiato, per vedere le modifiche devi ricaricare la pagina.",
    "Reset default app order" : "Ripristina ordine app predefinito",
    "Could not set the app order" : "Impossibile impostare l'ordine delle app",
    "Could not reset the app order" : "Impossibile ripristinare l'ordine delle app",
    "Default app" : "App predefinita",
    "The default app is the app that is e.g. opened after login or when the logo in the menu is clicked." : "L'app predefinita è quella che viene aperta dopo l'accesso o quando viene cliccato il logo nel menu.",
