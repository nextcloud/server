OC.L10N.register(
    ...
    "Motion sickness reduction" : "Hareket rahatsızlığı azaltma",
    "Prevents animations, such as scaling or panning large objects, that can trigger discomfort for those with vestibular motion disorders." : "Vestibüler hareket bozukluğu olanlar için rahatsızlığı tetikleyebilecek büyük nesneleri ölçeklemek veya kaydırmak gibi canlandırmaları önler.",
    ...
    "Never dismiss" : "Asla yok sayılmasın",
    "Default ({time} seconds)" : "Varsayılan ({time} saniye)",
    "{time} seconds" : "{time} saniye",
    "Could not update toast timeout" : "Tost zaman aşımı güncellenemedi",
    "Toast notifications" : "Tost bildirimleri",
    "Set how long toast messages stay visible. Choose a longer duration if you need more time to read them." : "Tost iletilerinin ne kadar süre görünür kalacağını ayarlayın. Okumak için daha fazla zaman gerekiyorsa daha uzun bir süre seçin.",
    "Toast timeout" : "Tost zaman aşımı",
    ...
    "Themes" : "Temalar",
    "Supplementary themes" : "Destek temaları",
    "Fonts" : "Yazı türleri",
    ...
    "Upload new favicon" : "Yeni site simgesi yükle",
