 ...
 * @property {Vue} component - Deprecated: **Use `webComponent` instead**
 *
 ...
 * @property {string} [webComponent] - A web component id as used in window.customElements.define()`.
 ...
 * @property {object} [options] - Deprecated: **Use `webComponent` instead**
 *
 *  A vue component to handle the rendering of options.
 *  The component should handle the v-model directive properly,
 *  so it needs a value property to receive data and emit an input
