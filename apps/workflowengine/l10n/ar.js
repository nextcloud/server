OC.L10N.register(
    ...
    "Flow" : "أتمتة الإجراءات",
    "Nextcloud workflow engine" : "محرك أتمتة الإجراءات لنكست كلاود",
    ...
    "Add new flow" : "إضافة أتمتة إجراء جديد",
    "When" : "متى",
    "and" : "و",
    ...
    "Active" : "فعال",
    "Save" : "حفظ",
    "Available flows" : "أتمتة الإجراءات المتاحة",
    "For details on how to write your own flow, check out the development documentation." : "للحصول على تفاصيل حول كيفية تطوير أتمتة الإجراءات الخاصة بك، تحقق من وثائق التطوير.",
    ...
    "More flows" : "المزيد من أتمتة الإجراءات",
    "Browse the App Store" : "إستعرض متجر التطبيقات",
    "Show less" : "عرض أقل",
    "Show more" : "عرض المزيد",
    "Configured flows" : "أتمتة الإجراءات المضافة",
    "Your flows" : "أتمتة الإجراءات الخاصة بك",
