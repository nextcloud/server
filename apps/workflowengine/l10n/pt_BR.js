OC.L10N.register(
    ...
    "The given IP range is not valid for IPv6" : "O intervalo de IP fornecido é inválido para IPv6",
    ...
    "%1$s assigned %2$s to %3$s" : "%1$s atribuiu %2$s a %3$s",
    ...
    "Invalid check provided" : "Verificação inválida fornecida",
    "The provided check value is too long" : "O valor de verificação fornecido é muito longo",
    "Check %s is invalid" : "Verificação %s é inválida",
    "Check %s does not exist" : "Verificação %s não existe",
    "Check %s is not allowed with this entity" : "Verificação %s não é permitida para esta entidade",
    "Check #%s does not exist" : "Verificação #%s não existe",
    "Check %s is invalid or does not exist" : "Verificação %s é inválida ou não existe",
    "Flow" : "Fluxo",
    ...
    "Please enter a valid time span" : "Por favor, insira um período de tempo válido",
    "Files WebDAV" : "Arquivos WebDAV",
    "Custom URL" : "URL personalizado",
    "Select a request URL" : "Selecione um URL de solicitação",
    "Android client" : "Cliente Android",
    "iOS client" : "Cliente iOS",
    "Desktop client" : "Cliente de desktop",
    "Thunderbird & Outlook addons" : "Extensões para Thunderbird e Outlook",
    "Custom user agent" : "Agente de usuário personalizado",
    ...
    "Request time" : "Tempo da solicitação",
    "between" : "entre",
