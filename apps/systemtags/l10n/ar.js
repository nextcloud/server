OC.L10N.register(
    ...
    "System tag creation" : "إنشاء وُسُوم جديدة",
    "If enabled, regular accounts will be restricted from creating new tags but will still be able to assign and remove them from their files." : "إذا تمّ تمكينها، أصحاب الحسابات العادية لن يمكنهم إنشاء وُسُوم جديدة؛ لكن يمكنهم إضافة الوُسُوم إلى ملفاتهم وإزالتها.",
    "Restrict tag creation to admins only" : "قصر إنشاء الوُسُوم على المشرفين فقط",
    ...
    "System tag creation is now ${isRestricted ? " : "إنشاء الوُسوم النظامية ${isRestricted ? "
},
