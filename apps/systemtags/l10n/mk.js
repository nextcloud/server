OC.L10N.register(
    ...
    "Reset" : "Поништи",
    "Loading …" : "Се вчитува …",
    "_{tag1} will be set and {tag2} will be removed from {count} file._::_{tag1} will be set and {tag2} will be removed from {count} files._" : ["{tag1} ќе се постави а {tag2} ќе се острани од {count} датотека.","{tag1} ќе се постави а {tag2} ќе се отстрани од {count} датотеки."],
    ...
    "_{tag} will be removed from {count} file._::_{tag} will be removed from {count} files._" : ["{tag} ќе се острани од {count} датотека.","{tag} ќе се отстрани од {count} датотеки."],
