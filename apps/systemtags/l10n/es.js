OC.L10N.register(
    ...
    "Reset" : "Restablecer",
    "Loading …" : "Cargando …",
    "_{tag1} will be set and {tag2} will be removed from {count} file._::_{tag1} will be set and {tag2} will be removed from {count} files._" : ["{tag1} se establecerá y {tag2} será eliminada de {count} archivo.","{tag1} se establecerá y {tag2} será eliminada de {count} archivos.","{tag1} se establecerá y {tag2} será eliminada de {count} archivos."],
    ...
    "_{tag} will be removed from {count} file._::_{tag} will be removed from {count} files._" : ["{tag} será eliminada de {count} archivo.","{tag}  será eliminada de {count} archivos.","{tag} será eliminada de {count} archivos."],
