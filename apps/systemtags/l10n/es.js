OC.L10N.register(
    ...
    "System tag creation" : "Creación de etiquetas de sistema",
    "If enabled, regular accounts will be restricted from creating new tags but will still be able to assign and remove them from their files." : "Si lo activas, las cuentas normales no podrán crear nuevas etiquetas, pero podrán asignarlas y quitarlasa de sus archivos.",
    "Restrict tag creation to admins only" : "Restringir creación de etiquetas a los administradores",
    ...
    "System tag creation is now ${isRestricted ? " : "La creación de etiquetas del sistema está ${isRestricted ? "
},
