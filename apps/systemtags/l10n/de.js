OC.L10N.register(
    ...
    "No tags available" : "Keine Schlagworte verfügbar",
    "Public" : "Öffentlich",
    ...
    "Reset" : "Zurücksetzen",
    "Loading …" : "Lade …",
    "_{tag1} will be set and {tag2} will be removed from {count} file._::_{tag1} will be set and {tag2} will be removed from {count} files._" : ["{tag1} wird gesetzt und {tag2} von {count} Datei entfernt.","{tag1} wird gesetzt und {tag2} von {count} Dateien entfernt."],
    ...
    "_{tag} will be removed from {count} file._::_{tag} will be removed from {count} files._" : ["{tag} wird von {count} Datei entfernt.","{tag} wird von {count} Dateien entfernt."],
