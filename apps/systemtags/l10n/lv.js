OC.L10N.register(
    ...
    "You created system tag %1$s" : "Tu izveidoji sistēmas birku  %1$s",
    ...
    "You updated system tag {oldsystemtag} to {newsystemtag}" : "Tu atjaunināji sistēmas birku {oldsystemtag} uz {newsystemtag}",
    ...
    "You removed system tag %2$s from %1$s" : "Tu noņēmi sistēmas birku %2$s no %1$s",
    "You removed system tag {systemtag} from {file}" : "Tu noņēmi sistēmas birku {systemtag} no {file}",
    ...
    "<strong>System tags</strong> for a file have been modified" : "Tika mainītas datnes <strong>sistēmas birkas</strong>",
    "Files" : "Datnes",
    "Tags" : "Birkas",
