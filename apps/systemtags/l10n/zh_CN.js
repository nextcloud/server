OC.L10N.register(
    ...
    "Reset" : "重置",
    "Loading …" : "正在加载 …",
    "_{tag1} will be set and {tag2} will be removed from {count} file._::_{tag1} will be set and {tag2} will be removed from {count} files._" : ["将设置 {tag1}，并从 {count} 个文件中移除 {tag2}。"],
    "_{tag} will be set to 1 file._::_{tag} will be set to {count} files._" : [" 将会设置 {tag} 到 {count} 个文件。"],
    "_{tag} will be removed from {count} file._::_{tag} will be removed from {count} files._" : ["将从 {count} 个文件中移除 {tag}。"],
