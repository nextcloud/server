OC.L10N.register(
    ...
    "No tags available" : "Não há etiquetas disponíveis",
    "Public" : "Público",
    "Restricted" : "Restrito",
    "Invisible" : "Invisível",
    ...
    "Reset" : "Redefinir",
    "Loading …" : "Carregando …",
    "_{tag1} will be set and {tag2} will be removed from {count} file._::_{tag1} will be set and {tag2} will be removed from {count} files._" : ["{tag1} será definido e {tag2} será removido de {count} arquivo.","{tag1} será definido e {tag2} será removido de {count} de arquivos.","{tag1} será definido e {tag2} será removido de {count} arquivos."],
