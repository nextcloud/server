OC.L10N.register(
    ...
    "Reset" : "Atstatyti",
    "Loading …" : "Įkeliama …",
    "_{tag1} will be set and {tag2} will be removed from {count} file._::_{tag1} will be set and {tag2} will be removed from {count} files._" : ["{tag1} bus nustatyta, o {tag2} – pašalinta iš {count} failo.","{tag1} bus nustatyta, o {tag2} – pašalinta iš {count} failų.","{tag1} bus nustatyta, o {tag2} – pašalinta iš {count} failų.","{tag1} bus nustatyta, o {tag2} – pašalinta iš {count} failų."],
    ...
    "_{tag} will be removed from {count} file._::_{tag} will be removed from {count} files._" : ["{tag} bus pašalintas iš {count} failo.","{tag} bus pašalintas iš {count} failų.","{tag} bus pašalintas iš {count} failų.","{tag} bus pašalintas iš {count} failų."],
    ...
    "Collaborative tags are available for all users. Restricted tags are visible to users but cannot be assigned by them. Invisible tags are for internal use, since users cannot see or assign them." : "Bendradarbiavimo žymos yra prieinamos visiems vartotojams. Apribotos žymos yra matomos vartotojams, tačiau vartotojai negali jų priskirinėti. Nematomos žymos yra vidiniam naudojimui, nes vartotojai negali jų nei matyti, nei priskirinėti.",
