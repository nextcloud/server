OC.L10N.register(
    ...
    "System tag %2$s was added to %1$s by the system" : "Etiqueta del sistema %2$s fue agregada a %1$s por el sistema",
    "System tag {systemtag} was added to {file} by the system" : "Etiqueta del sistema {systemtag} fue agregada a {file} por el sistema",
    ...
    "System tag %2$s was removed from %1$s by the system" : "Etiqueta del sistema %2$s fue eliminada de %1$s por el sistema",
    "System tag {systemtag} was removed from {file} by the system" : "Etiqueta del sistema {systemtag} fue eliminada de {file} por el sistema",
