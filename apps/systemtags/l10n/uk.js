OC.L10N.register(
    ...
    "_{tag1} will be set and {tag2} will be removed from {count} file._::_{tag1} will be set and {tag2} will be removed from {count} files._" : ["{tag1} буде встановлено та {tag2} буде вилкчено з {count} файлу.","{tag1} буде встановлено та {tag2} буде вилучено з {count} файлів.","{tag1} буде встановлено та {tag2} буде вилучено з {count} файлів.","{tag1} буде встановлено та {tag2} буде вилучено з {count} файлів."],
    ...
    "_{tag} will be removed from {count} file._::_{tag} will be removed from {count} files._" : ["{tag}буде вилучено з {count} файлу.","{tag} буде вилучено з {count} файлів.","{tag} буде вилучено з {count} файлів.","{tag} буде вилучено з {count} файлів."],
    ...
    "Only admins can create new tags" : "Тільки адміністратори можуть створювати нові мітки",
    ...
    "Choose tags for the selected files" : "Виберіть мітки для вибраних файлів",
    "Cancel" : "Скасувати",
    "Apply" : "Застосувати",
    ...
    "System admin disabled tag creation. You can only use existing ones." : "Системний адміністратор вимкнув створення міток. Ви можете використовувати тільки наявні.",
    "Loading collaborative tags …" : "Завантаження спільних міток …",
    ...
    "System tag creation is now restricted to administrators" : "Створення системних міток тепер обмежено адміністраторами",
    "System tag creation is now allowed for everybody" : "Створення системних міток тепер дозволено для всіх",
    "System tag management" : "Керування системними мітками",
    "If enabled, only administrators can create and edit tags. Accounts can still assign and remove them from files." : "Якщо цю функція увімкнути, створювати та редагувати мітки зможуть лише адміністратори. Користувачі можуть як і раніше присвоювати та вилучати мітки з файлів.",
    "Restrict tag creation and editing to administrators" : "Обмежити створення та редагування міток адміністраторами",
