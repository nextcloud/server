OC.L10N.register(
    ...
    "Reset" : "Reset",
    "Loading …" : "Loading …",
    "_{tag1} will be set and {tag2} will be removed from {count} file._::_{tag1} will be set and {tag2} will be removed from {count} files._" : ["{tag1} will be set and {tag2} will be removed from {count} file.","{tag1} will be set and {tag2} will be removed from {count} files."],
    ...
    "_{tag} will be removed from {count} file._::_{tag} will be removed from {count} files._" : ["{tag} will be removed from {count} file.","{tag} will be removed from {count} files."],
