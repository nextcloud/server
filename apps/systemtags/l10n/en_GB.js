OC.L10N.register(
    ...
    "System tag creation" : "System tag creation",
    "If enabled, regular accounts will be restricted from creating new tags but will still be able to assign and remove them from their files." : "If enabled, regular accounts will be restricted from creating new tags but will still be able to assign and remove them from their files.",
    "Restrict tag creation to admins only" : "Restrict tag creation to admins only",
