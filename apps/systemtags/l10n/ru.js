OC.L10N.register(
    ...
    "Reset" : "Сбросить",
    "Loading …" : "Загрузка …",
    "_{tag1} will be set and {tag2} will be removed from {count} file._::_{tag1} will be set and {tag2} will be removed from {count} files._" : ["{tag1} будет добавлен, а {tag2} будет удалён из {count} файла.","{tag1} будет добавлен, а {tag2} будет удалён из {count} файлов.","{tag1} будет добавлен, а {tag2} будет удалён из {count} файлов.","{tag1} будет добавлен, а {tag2} будет удалён из {count} файлов."],
    ...
    "_{tag} will be removed from {count} file._::_{tag} will be removed from {count} files._" : ["{tag} будет удалён из {count} файла.","{tag} будет удалён из {count} файлов.","{tag} будет удалён из {count} файлов.","{tag} будет удалён из {count} файлов."],
