OC.L10N.register(
    ...
    "No tags available" : "Nem érhető el címke",
    "Public" : "Nyilvános",
    ...
    "Reset" : "Visszaállítás",
    "Loading …" : "Betöltés…",
    "_{tag1} will be set and {tag2} will be removed from {count} file._::_{tag1} will be set and {tag2} will be removed from {count} files._" : ["A(z) {tag1} be lesz állítva, és a(z) {tag2} el lesz távolítva {count} fájlról.","A(z) {tag1} be lesz állítva, és a(z) {tag2} el lesz távolítva {count} fájlról."],
    ...
    "_{tag} will be removed from {count} file._::_{tag} will be removed from {count} files._" : ["A(z) {tag} el lesz távolítva {count} fájlról.","A(z) {tag} el lesz távolítva {count} fájlról."],
    ...
    "System tag creation is now restricted to administrators" : "A rendszercímkék létrehozása most már a rendszergazdákra van korlátoztva",
