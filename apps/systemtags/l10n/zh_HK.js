OC.L10N.register(
    ...
    "Reset" : "重設",
    "Loading …" : "正在載入 …",
    "_{tag1} will be set and {tag2} will be removed from {count} file._::_{tag1} will be set and {tag2} will be removed from {count} files._" : ["將會設定 {tag1}，並從 {count} 個檔案中移除 {tag2}。"],
    "_{tag} will be set to 1 file._::_{tag} will be set to {count} files._" : ["{tag}將被設定為 {count} 個檔案。"],
    "_{tag} will be removed from {count} file._::_{tag} will be removed from {count} files._" : ["將從 {count} 個檔案中刪除 {tag}。"],
