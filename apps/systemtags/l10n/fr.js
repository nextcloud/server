OC.L10N.register(
    ...
    "Reset" : "Réinitialiser",
    "Loading …" : "Chargement...",
    "_{tag1} will be set and {tag2} will be removed from {count} file._::_{tag1} will be set and {tag2} will be removed from {count} files._" : ["L'étiquette {tag1} sera ajoutée et l'étiquette {tag2} sera supprimée de {count} fichier.","L'étiquette {tag1} sera ajoutée et l'étiquette {tag2} sera supprimée de {count} fichiers.","L'étiquette {tag1} sera ajoutée et l'étiquette {tag2} sera supprimée de {count} fichiers."],
    ...
    "_{tag} will be removed from {count} file._::_{tag} will be removed from {count} files._" : ["L'étiquette {tag} sera supprimée de {count} fichier.","L'étiquette {tag} sera supprimée de {count} fichiers.","L'étiquette {tag} sera supprimée de {count} fichiers."],
