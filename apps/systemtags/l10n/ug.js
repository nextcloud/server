OC.L10N.register(
    ...
    "Only admins can create new tags" : "پەقەت باشقۇرغۇچىلا يېڭى خەتكۈچ قۇرۇلايدۇ",
    ...
    "System admin disabled tag creation. You can only use existing ones." : "سىستېما باشقۇرغۇچىسى بەلگە قۇرۇشنى چەكلىدى. سىز پەقەت مەۋجۇتلىرىنىلا ئىشلىتەلەيسىز.",
    ...
    "Unable to update setting" : "تەڭشەكنى يېڭىلىغىلى بولمىدى",
    "System tag creation is now restricted to administrators" : "سىستېما بەلگىسىنى قۇرۇش ھازىر باشقۇرغۇچىلار بىلەنلا چەكلىنىدۇ",
    "System tag creation is now allowed for everybody" : "سىستېما خەتكۈچى قۇرۇش ھازىر ھەممەيلەنگە ئوچۇق",
    "System tag management" : "سېستىما خەتكۈچى باشقۇرۇش",
    ...
    "Select tags to apply to all selected files" : "تاللانغان بارلىق ھۆججەتلەرگە قوللىنىش ئۈچۈن بەتكۈچ تاللا",
