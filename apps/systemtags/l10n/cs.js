OC.L10N.register(
    ...
    "System tag creation" : "Vytvoření systémového štítku",
    "If enabled, regular accounts will be restricted from creating new tags but will still be able to assign and remove them from their files." : "Pokud zapnuto, běžné účty nebudou moci vytvářet nové štítky, ale pořád ještě budou moci přiřazovat a odebírat je ze svých souborů.",
    "Restrict tag creation to admins only" : "Umožnit vytváření štítků pouze správcům",
    ...
    "System tag creation is now ${isRestricted ? " : "Vytváření systémových štítků je nyní ${isRestricted ? "
},
