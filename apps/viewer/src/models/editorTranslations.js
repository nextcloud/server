...
export default {
	...
	undoTitle: t('viewer', 'Undo last operation'),
	redoTitle: t('viewer', 'Redo last operation'),
	...
	textSpacings: t('viewer', 'Text spacings'),
	...
	addWatermarkTitle: t('viewer', 'Choose the watermark type'),
	...
	saveAsModalLabel: t('viewer', 'Save the image as'),
