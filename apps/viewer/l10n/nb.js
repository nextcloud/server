OC.L10N.register(
    ...
    "Show your latest holiday photos and videos like in the movies, show a glimpse of your latest novel directly from your Nextcloud, choose the best GIF of your collection thanks to the direct preview of your favorites files and many more!" : "Vis de siste feriebildene og -videoene dine som i filmene, vis et glimt av den nyeste romanen din direkte fra Nextcloud, velg den beste GIF-en i samlingen din takket være direkte forhåndsvisning av favorittfilene dine og mange flere!",
    "Your browser does not support audio." : "Nettleseren din støtter ikke lyd.",
    "Error loading {name}" : "Feil ved lasting av {name}",
    "Image saved" : "Bilde er lagret",
    "Error saving image" : "Feil under lagring av bildet",
    "Unsaved changes" : "Ulagrede endringer",
    "Drop changes" : "Slipp endringer",
    "Content of \"{fileName}\"" : "Innhold i \"{fileName}\"",
