OC.L10N.register(
    ...
    "Choose the watermark type" : "Zvolte typ vodotisku",
    ...
    "Position" : "Pozice",
    "Stroke" : "Čára",
    "Save the image as" : "Uložit obrázek jako",
    "Extension" : "Přípona",
    "Name is required." : "Jméno je povinné.",
    "Quality" : "Kvalita",
    "Saved image size (width x height)" : "Velikost uloženého obrázku (šířka x výška)",
    "Note, the selected crop area is lower than the applied resize which might cause quality decrease" : "Pozn.: označená oblast ořezu je menší než použitá změna rozlišení, což může způsobit snížení kvality",
