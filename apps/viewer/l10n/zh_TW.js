OC.L10N.register(
    ...
    "Restart" : "重新啟動",
    "Rewind {seektime}s" : "倒帶 {seektime} 秒",
    "Play" : "播放",
    "Pause" : "暫停",
    "Forward {seektime}s" : "快轉 {seektime} 秒",
    "Seek" : "跳轉",
    "{currentTime} of {duration}" : "目前 {currentTime}，共 {duration}",
    "Played" : "已播放",
    "Buffered" : "已緩衝",
    "Current time" : "目前時間",
    "Duration" : "持續時間",
    ...
    "Mute" : "靜音",
    "Unmute" : "解除靜音",
    "Enable captions" : "啟用字幕",
    "Disable captions" : "停用字幕",
    ...
    "Settings" : "設定",
    "PIP" : "畫中畫",
    "Go back to previous menu" : "回到上一個選單",
    "Speed" : "速度",
    "Normal" : "一般",
    "Loop" : "迴圈",
    "Start" : "開始",
