OC.L10N.register(
    ...
    "Restart" : "Перезапуск",
    "Rewind {seektime}s" : "Назад {seektime}с",
    "Play" : "Воспроизвести",
    "Pause" : "Пауза",
    "Forward {seektime}s" : "Вперёд {seektime}с",
    "Seek" : "Поиск",
    "{currentTime} of {duration}" : "{currentTime} из {duration}",
    "Played" : "Проигрывается",
    ...
    "Player for {title}" : "Проигрыватель {title}",
    "Captions" : "Субтитры",
    "Settings" : "Настройки",
    "PIP" : "PIP",
    "Go back to previous menu" : "Вернуться в предыдущее меню",
    "Speed" : "Скорость",
    "Normal" : "Обычный",
    "Loop" : "Зациклить",
    "Start" : "Начало",
