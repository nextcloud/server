OC.L10N.register(
    ...
    "You are about to overwrite the original file. Are you sure you want to continue?" : "Ви намагаєтеся перезаписатися оригінальний файл. Дісно продовжити?",
    "A file with this name already exists. Do you want to overwrite it?" : "Файл з таким ім'ям вже присутній. Дійсно перезаписати його поверх?",
    "Confirm overwrite" : "Підтвердити",
    "Overwrite" : "Перезаписати",
    "Cancel" : "Скасувати",
    "An error occurred while trying to confirm the file overwrite." : "Помилка під час підтвердження перезапису файлу.",
    ...
    "Failed to save file before download" : "Не вдалося зберегти файл перед звантаженням",
    "Edit" : "Редагувати",
    ...
    "Rewind {seektime}s" : "Назад на {seektime} с",
    "Play" : "Грати",
    "Pause" : "Пауза",
    "Forward {seektime}s" : "Вперед на {seektime} с",
    "Seek" : "Шукати",
    "{currentTime} of {duration}" : "{currentTime} із {duration}",
    "Played" : "Програється",
    ...
    "Enable captions" : "Увімкнути субтрити",
    "Disable captions" : "Вимкнути субтрити",
    "Enter fullscreen" : "На весь екран",
    "Exit fullscreen" : "Вийти з повноекранного режиму",
    "Player for {title}" : "Програвач для {title}",
    "Captions" : "Субтитри",
    "Settings" : "Налаштування",
    "Go back to previous menu" : "Повернутися до попереднього меню",
    "Speed" : "Швидкість",
    "Normal" : "Звичайно",
    "Loop" : "Повторювати",
    "Start" : "Початок",
