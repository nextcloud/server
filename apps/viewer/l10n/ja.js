OC.L10N.register(
    ...
    "Restart" : "再開",
    "Rewind {seektime}s" : "{seektime}秒巻き戻す",
    "Play" : "再生",
    "Pause" : "一時停止",
    "Forward {seektime}s" : "{seektime}秒先へ進む",
    "Seek" : "探す",
    "{currentTime} of {duration}" : "{duration} のうち {currentTime}",
    "Played" : "再生済",
    "Buffered" : "バッファ",
    "Current time" : "現在時刻",
    "Duration" : "期間",
    ...
    "Mute" : "ミュート",
    "Unmute" : "ミュート解除",
    "Enable captions" : "字幕を有効にする",
    "Disable captions" : "字幕をオフにする",
    "Enter fullscreen" : "全画面表示にする",
    "Exit fullscreen" : "全画面を終了",
    "Player for {title}" : "{title}のプレイヤー",
    "Captions" : "字幕",
    "Settings" : "設定",
    "PIP" : "PIP",
    "Go back to previous menu" : "前のメニューに戻る",
    "Speed" : "スピード",
    "Normal" : "ノーマル",
    "Loop" : "繰り返し",
    "Start" : "開始する",
