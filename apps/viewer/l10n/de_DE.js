OC.L10N.register(
    ...
    "Restart" : "Neustart",
    "Rewind {seektime}s" : "{seektime}s zurückspulen",
    "Play" : "Spielen",
    "Pause" : "Pausieren",
    "Forward {seektime}s" : "{seektime}s vorspulen",
    "Seek" : "Suchen",
    "{currentTime} of {duration}" : "{currentTime} von {duration}",
    "Played" : "Abgespielt",
    "Buffered" : "Gepuffert",
    ...
    "Enter fullscreen" : "Vollbild anzeigen",
    "Exit fullscreen" : "Vollbild verlassen",
    "Player for {title}" : "Wiedergabe für {title}",
    "Captions" : "Untertitel",
    "Settings" : "Einstellungen",
    "PIP" : "PIP",
    "Go back to previous menu" : "Zum vorigen Menü zurückgehen",
