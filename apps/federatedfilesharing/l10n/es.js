OC.L10N.register(
    ...
    "Couldn't establish a federated share, it looks like the server to federate with is too old (Nextcloud <= 9)." : "No se ha podido establecer un recurso compartido federado, parece ser que el servidor con le que se intenta federar es demasiado antiguo (Nextcloud <= 9).",
