OC.L10N.register(
    ...
    "Confirm data upload to lookup server" : "Staðfesta innsendingu gagna á uppflettiþjón",
    "When enabled, all account properties (e.g. email address) with scope visibility set to \"published\", will be automatically synced and transmitted to an external system and made available in a public, global address book." : "Þegar þetta er virkt, verða allir eiginleikar notandaaðgangs (t.d. tölvupóstfang) sem hafa merktan sýnileika stilltann á \"útgefið\" sjálfkrafa samstilltir og sendir á utanaðkomandi kerfi og gerðir tiltækir í opinberri, víðværri nafnaskrá.",
    "Enable data upload" : "Virkja innsendingu gagna",
    "Disable upload" : "Gera innsendingar óvirkar",
    "Confirm querying lookup server" : "Staðfesta beiðni á uppflettiþjóni",
    "When enabled, the search input when creating shares will be sent to an external system that provides a public and global address book." : "Þegar þetta er virkt, verður innsláttur í leit þegar verið er að útbúa sameignir sendur á utanaðkomandi kerfi sem býður upp á opinberar og víðværar nafnaskrár.",
    "This is used to retrieve the federated cloud ID to make federated sharing easier." : "Þetta er notað til að ná í skýjasambandsauðkenni (federated cloud ID) til að auðvelda skýjasambandsdeilingu.",
    "Moreover, email addresses of users might be sent to that system in order to verify them." : "Að auki gætu tölvupóstföng notenda verið send á það kerfi til að sannreyna þau.",
    "Enable querying" : "Virkja beiðnir",
    "Disable querying" : "Gera beiðnir óvirkar",
    ...
    "The lookup server is only available for global scale." : "Uppflettiþjónninn er aðeins tiltækur í víðara samhengi.",
    ...
    "Cloud ID copied" : "Skýjasambandsauðkenni afritað",
    "Copy" : "Afrita",
    ...
    "Share with me via {productName}" : "Deila með mér í gegnum {productName}",
    "HTML Code:" : "HTML-kóði:",
    "Cancel" : "Hætta við",
