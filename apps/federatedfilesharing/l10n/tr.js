OC.L10N.register(
    ...
    "When enabled, all account properties (e.g. email address) with scope visibility set to \"published\", will be automatically synced and transmitted to an external system and made available in a public, global address book." : "Açıldığında, kapsam görünürlüğü \"yayınlanmış\" olarak ayarlanmış tüm hesap özellikleri (e-posta adresi gibi) otomatik olarak eşitlenerek ve bir dış sisteme iletilerek, herkese açık, genel bir adres defterinde yayınlanır.",
    ...
    "When enabled, the search input when creating shares will be sent to an external system that provides a public and global address book." : "Açıldığında, paylaşım oluştururken arama kaydı, herkese açık ve genel bir adres defteri sunan bir dış sisteme gönderilir.",
    ...
    "Share with me via {productName}" : "Benimle {productName} ile paylaş",
    "HTML Code:" : "HTML kodu:",
    "Cancel" : "İptal",
