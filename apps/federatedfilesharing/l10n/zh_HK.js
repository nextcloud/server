OC.L10N.register(
    ...
    {
    "Invalid Federated Cloud ID" : "雲端聯邦 ID 不正確",
    "Server to server sharing is not enabled on this server" : "此伺服器未啟用伺服器到伺服器分享功能",
    "Couldn't establish a federated share." : "無法建立聯邦式分享",
    "Couldn't establish a federated share, maybe the password was wrong." : "無法建立聯邦式分享，可能是密碼錯誤。",
    "Federated Share request sent, you will receive an invitation. Check your notifications." : "聯邦雲分享 請求發送成功！您將收到邀請。注意您的通知提醒。",
    "Couldn't establish a federated share, it looks like the server to federate with is too old (Nextcloud <= 9)." : "無法建立聯邦雲分享 ，可能是要聯邦的伺服器版本太舊（Nextcloud <= 9）。",
    "It is not allowed to send federated group shares from this server." : "不允許從此伺服器發送聯邦式群組分享 。",
    ...
    "Federated shares require read permissions" : "聯邦分享需要讀取權限",
    ...
    "Accept" : "接受",
    "Decline" : "拒絕",
    "Federated Cloud Sharing" : "聯邦式雲端分享",
    "Sharing" : "分享 ",
    "Federated file sharing" : "聯邦式檔案分享",
    "Provide federated file sharing across servers" : "在伺服器間提供聯邦式檔案分享 ",
    ...
    "Unable to update federated files sharing config" : "無法更新聯邦檔案分享配置",
    "Adjust how people can share between servers. This includes shares between people on this server as well if they are using federated sharing." : "配置人們如何在伺服器之間共享。 這也包括此伺服器上人仕之間的共享，如果他們使用聯邦共享。",
    ...
    "Share with me through my #Nextcloud Federated Cloud ID, see {url}" : "可透過我的 #Nextcloud 聯邦雲端 ID 與我分享，請見 {url}",
    "Share with me through my #Nextcloud Federated Cloud ID" : "可透過我的 #Nextcloud 聯邦雲端 ID 與我分享",
