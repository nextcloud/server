OC.L10N.register(
    ...
    "Couldn't establish a federated share." : "Nepavyko užmegzti federacinio bendrinimo.",
    "Couldn't establish a federated share, maybe the password was wrong." : "Nepavyko užmegzti federacinio bendrinimo, galbūt, neteisingas slaptažodis.",
    "Federated Share request sent, you will receive an invitation. Check your notifications." : "Federacinio bendrinimo užklausa išsiųsta, jūs gausite pakvietimą. Tikrinkite savo pranešimus.",
    "Couldn't establish a federated share, it looks like the server to federate with is too old (Nextcloud <= 9)." : "Nepavyko užmegzti federacinio bendrinimo, atrodo, kad serveris su kuriuo ketinama jungtis į federaciją yra per senas (Nextcloud <= 9).",
    "It is not allowed to send federated group shares from this server." : "Iš šio serverio neleidžiama siųsti federacinių grupės bendrinimų.",
    ...
    "You received {share} as a remote share from {user} (on behalf of {behalf})" : "Jūs gavote {share} kaip nuotolinį bendrinimą iš {user} ({behalf} vardu)",
    "You received {share} as a remote share from {user}" : "Jūs gavote {share} kaip nuotolinį bendrinimą iš {user}",
    "Accept" : "Priimti",
    "Decline" : "Atmesti",
    ...
    "Share with me through my #Nextcloud Federated Cloud ID, see {url}" : "Pasidalinkite su manimi per mano #Nextcloud federacinės debesijos ID, žr. {url}",
    ...
    "Cancel" : "Atsisakyti",
    "Add remote share" : "Pridėti nuotolinį bendrinimą",
    "Remote share" : "Nuotolinis viešinys",
    "Do you want to add the remote share {name} from {owner}@{remote}?" : "Ar norite pridėti nuotolinį bendrinimą {name} iš {owner}@{remote}?",
    "Remote share password" : "Nuotolinio bendrinimo slaptažodis",
