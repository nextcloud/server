OC.L10N.register(
    ...
    "Allow users on this server to send shares to other servers (this option also allows WebDAV access to public shares)" : "Permet que els usuaris d'aquest servidor enviïn elements compartits a altres servidors (aquest paràmetre també permet l'accés WebDAV als elements compartits públics)",
    "Allow users on this server to receive shares from other servers" : "Permet que els usuaris d'aquest servidor rebin elements compartits d'altres servidors",
