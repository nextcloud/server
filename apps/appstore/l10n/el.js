OC.L10N.register(
    ...
    "Features" : "Προτεινόμενα",
    "Learn more" : "Μάθετε περισσότερα",
    "Daemon" : "Υπηρεσία",
    "Deploy Daemon" : "πηρεσία Ανάπτυξης",
    "Type" : "Τύπος",
    "Name" : "Όνομα",
    ...
    "Choose Deploy Daemon for {appName}" : "Επιλογή Daemon Ανάπτυξης για {appName}",
    "No Deploy daemons configured" : "Δεν έχουν ρυθμιστεί Υπηρεσία Ανάπτυξης",
    "Register a custom one or setup from available templates" : "Εγγραφή προσαρμοσμένου ή ρύθμιση από διαθέσιμα πρότυπα",
    "Manage Deploy daemons" : "Διαχείριση Daemon Ανάπτυξης",
    "Registered Deploy daemons list" : "Κατάλογος εγγεγραμμένων Daemon Ανάπτυξης",
    "Default" : "Προεπιλογή",
    "Carousel" : "Καρουσέλ",
    ...
    "Best support for legacy files" : "Καλύτερη υποστήριξη για παλαιού τύπου αρχεία",
    "Good Nextcloud integration" : "Καλή ενσωμάτωση στο Nextcloud",
    "Open core" : "Ανοικτού πυρήνα (Open core)",
