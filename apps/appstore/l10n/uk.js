OC.L10N.register(
    ...
    "Small grid size" : "Маленька сітка",
    "Medium grid size" : "Середня сітка",
    "Large grid size" : "Велика сітка",
    "Show incompatible" : "Показувати несумісні",
    ...
    "Save" : "Зберегти",
    "Update all apps" : "Оновити всі застосунки",
    "Are you sure you want to update all apps?" : "Дійсно оновити всі застосунки?",
    "Update all" : "Оновити всі",
    "Loading app list" : "Завантаження переліку застосунків",
    "No matching apps found" : "Відсутні відповідні застосунки",
    ...
    "Could not update the app. Please try again later." : "Не вдалося оновити застосунок. Спробуйте пізніше.",
