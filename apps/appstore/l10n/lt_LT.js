OC.L10N.register(
    ...
    "is loading…" : "įkeliama…",
    "Filter view" : "Filtro rodinys",
    "Grid size" : "Tinklelio dydis",
    "Small grid size" : "Mažas tinklelio dydis",
    "Medium grid size" : "Vidutinis tinklelio dydis",
    "Large grid size" : "Didelis tinklelio dydis",
    "Show incompatible" : "Rodyti nesuderinamus",
    "Grid view" : "Tinklelio rodinys",
    "Force enable {suite}?" : "Įgalinti priverstinai {suite}?",
    "Enabling {suite} requires force enabling the app. This may cause issues with your Nextcloud instance. Are you sure you want to proceed?" : "Norint įgalinti {suite}, reikia priverstinai įjungti programėlę. Tai gali sukelti problemų jūsų „Nextcloud“ egzemplioriuje. Ar tikrai norite tęsti?",
    "Force enable" : "Priverstinis įjungimas",
    "Cancel" : "Atsisakyti",
    "Office suite switching is managed through the Nextcloud All-in-One interface." : "Biuro programų paketo perjungimas valdomas per „Nextcloud All-in-One“ (viskas viename) sąsają.",
    ...
    "Select your preferred office suite." : "Pasirinkite pageidaujamą biuro paketą.",
    "Please note that installing requires manual server setup." : "Atkreipkite dėmesį, kad diegimui reikia rankinio serverio nustatymo.",
    ...
    "Resources" : "Ištekliai",
    "Documentation resources" : "Dokumentacijos ištekliai",
    ...
    "Choose Deploy Daemon for {appName}" : "Pasirinkite diegimo tarnybą skirtą {appName}",
    ...
    "Save" : "Išsaugoti",
    "Failed to update app {appName}" : "Nepavyko atnaujinti programėlės {appName}",
    "Update all apps" : "Atnaujinti visas programėles",
    "Are you sure you want to update all apps?" : "Ar tikrai norite atnaujinti visas programėles?",
    "Update done" : "Atnaujinimas atliktas",
    "View website" : "Peržiūrėti svetainę",
    ...
    "Update all applications" : "Atnaujinti visas programėles",
    "Appstore categories" : "Programėlių parduotuvės kategorijos",
    "Search apps…" : "Ieškoti programėlių…",
    "Loading categories" : "Įkeliamos kategorijos",
    "Please enter more characters to search." : "Įveskite daugiau simbolių paieškai.",
    "Search apps" : "Ieškoti programėlių",
    ...
    "Install and enable" : "Įdiegti ir įjungti",
    "Deploy and force enable" : "Įdiegti ir priverstinai įjungti",
    "Download and force enable" : "Atsisiųskti ir priverstinai įjungti",
    "Install and force enable" : "Įdiekti ir priverstinai įjungti",
    "Rate the app" : "Įvertinkite programėlę",
    "Report a bug" : "Pranešti apie klaidą",
    "Ask questions or discuss the app" : "Užduokite klausimus arba aptarkite programėlę",
    "Visit the website" : "Apsilankykite svetainėje",
    "Remove" : "Šalinti",
