OC.L10N.register(
    ...
    "Filter view" : "篩選檢視",
    "Grid size" : "網格大小",
    "Small grid size" : "小型網格",
    "Medium grid size" : "中型網格",
    "Large grid size" : "大型網格",
    "Show incompatible" : "顯示不相容項目",
    "Grid view" : "網格檢視",
    "Force enable {suite}?" : "強制啟用 {suite}？",
    "Enabling {suite} requires force enabling the app. This may cause issues with your Nextcloud instance. Are you sure you want to proceed?" : "啟用 {suite} 需要強制啟用此應用程式，這可能導致你的 Nextcloud 實例出現問題。你確定要繼續嗎？",
    "Force enable" : "強制啟用",
    "Cancel" : "取消",
    ...
    "Select your preferred office suite." : "選擇你偏好的 Office 套件。",
    ...
    "Please enter more characters to search." : "請輸入更多字元以進行搜尋。",
    "Search apps" : "搜尋應用程式",
    ...
    "Report a bug" : "舉報錯誤",
    "Ask questions or discuss the app" : "提問或討論此應用程式",
    "Visit the website" : "瀏覽網站",
    "Remove" : "移除",
    ...
    "Search results" : "搜尋結果",
    "Powered by Euro-Office" : "由 Euro-Office 提供",
    ...
    "Could not load apps list. Please try again later." : "無法載入應用程式列表。請稍後再試。",
