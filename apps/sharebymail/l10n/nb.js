OC.L10N.register(
    ...
    "Unshared from {email}" : "Opphevde deling fra {email}",
    "Unshared from {email} by {actor}" : "Opphevde deling fra {email} av {actor}",
    ...
    "Password to access %s" : "Passord for å få tilgang til %s",
