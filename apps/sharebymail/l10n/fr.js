OC.L10N.register(
    ...
    "%1$s shared %2$s with you. You should have already received a separate mail with a link to access it." : "%1$s à partagé %2$s avec vous. Vous devriez déjà avoir reçu un courrier séparé avec un lien pour y accéder.",
    "Password to access %1$s shared to you by %2$s" : "Mot de passe d'accès %1$s à partagé avec vous par %2$s",
    ...
    "Password to access %1$s shared by you with %2$s" : "Mot de passe d'accès %1$s à partagé par vous avec %2$s",
