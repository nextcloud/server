OC.L10N.register(
    ...
    "Note:" : "Nota:",
    "This share is valid until %s at midnight" : "El recurso compartido es válido hasta el %s a medianoche",
    "Expiration:" : "Caduca el:",
    "Open shared item" : "Abrir elemento compartido",
    "%1$s via %2$s" : "%1$s vía %2$s",
    "%1$s shared %2$s with you. You should have already received a separate mail with a link to access it." : "%1$s ha compartido %2$s contigo. Deberías haber recibido otro correo con un enlace para acceder.",
    "Password to access %1$s shared to you by %2$s" : "Contraseña para acceder a %1$s, compartido contigo por %2$s",
    ...
    "Password to access %1$s shared by you with %2$s" : "Contraseña para acceder a %1$s, compartido contigo por %2$s",
