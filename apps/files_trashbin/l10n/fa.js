OC.L10N.register(
    ...
    "Deleted files and folders in the trash bin (may expire during export if you are low on storage space)" : "فایل‌ها و پوشه‌های حذف‌شده در سطل زباله (در صورت کمبود فضای ذخیره‌سازی، ممکن است هنگام خروجی گرفتن منقضی شوند)",
    ...
    "Files and folders you have deleted will show up here" : "فایل‌ها و پوشه‌هایی که حذف کرده‌اید در اینجا نمایش داده می‌شوند",
