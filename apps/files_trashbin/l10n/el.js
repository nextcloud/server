OC.L10N.register(
    ...
    "Error while restoring files from trash bin" : "Σφάλμα κατά την επαναφορά αρχείων από τον κάδο",
    "Error while emptying trash bin" : "Σφάλμα κατά το άδειασμα του κάδου",
