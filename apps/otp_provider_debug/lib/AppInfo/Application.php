...
namespace OCA\OTPProviderDebug\AppInfo;

use OCA\OTPProviderDebug\Listener\GetOneTimePasswordProvidersEventListener;
use OCA\OTPProviderDebug\Listener\SendOneTimePasswordEventListener;
...
class Application extends App implements IBootstrap {
	public const APP_ID = 'otp_debug_provider';
	public const OTP_PROVIDER_ID = 'debug';
