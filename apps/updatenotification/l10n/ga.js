OC.L10N.register(
    ...
    "<strong>All</strong> apps have a compatible version for this {productName} version available." : "<strong>Tá</strong> leagan comhoiriúnach ar fáil do gach aip den chineál {productName} seo.",
    "_<strong>%n</strong> app has no compatible version for this {productName} version available._::_<strong>%n</strong> apps have no compatible version for this {productName} version available._" : ["Níl aon leagan comhoiriúnach ar fáil don leagan seo de {productName} ag an aip<strong>%n</strong>.","Níl leagan comhoiriúnach ar fáil do <strong>%n</strong> aip don leagan seo de {productName}.","Níl leagan comhoiriúnach ar fáil do <strong>%n</strong> aip don leagan seo de {productName}.","Níl leagan comhoiriúnach ar fáil do <strong>%n</strong> aip don leagan seo de {productName}.","Níl leagan comhoiriúnach ar fáil do <strong>%n</strong> aip don leagan seo de {productName}."],
    "Enterprise" : "Fiontar",
    "For enterprise use. Provides always the latest patch level, but will not update to the next major release immediately." : "Le húsáid ag fiontair. Soláthraíonn sé an leibhéal paiste is déanaí i gcónaí, ach ní dhéanfar é a nuashonrú láithreach chuig an gcéad phríomheisiúint eile.",
    "That update happens once {vendor} has done additional hardening and testing for large-scale and mission-critical deployments." : "Tarlaíonn an nuashonrú sin a luaithe a bheidh cruaite agus tástáil bhreise déanta ag {vendor} le haghaidh imscaradh mórscála agus ríthábhachtach don mhisean.",
    "This channel is only available to customers and provides the {enterprise} package." : "Níl an cainéal seo ar fáil ach do chustaiméirí agus cuireann sé an pacáiste {enterprise} ar fáil.",
    "Stable" : "Cobhsaí",
