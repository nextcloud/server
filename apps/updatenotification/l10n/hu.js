OC.L10N.register(
    ...
    "<strong>All</strong> apps have a compatible version for this {productName} version available." : "<strong>Az összes</strong> alkalmazás rendelkezik ezzel a {productName} verzióval kompatibilis verzióval.",
    "_<strong>%n</strong> app has no compatible version for this {productName} version available._::_<strong>%n</strong> apps have no compatible version for this {productName} version available._" : ["<strong>%n</strong> alkalmazás nem rendelkezik ezzel a {productName} verzióval kompatibilis verzióval.","<strong>%n</strong> alkalmazás nem rendelkezik ezzel a {productName} verzióval kompatibilis verzióval."],
    "Enterprise" : "Vállalati",
    "For enterprise use. Provides always the latest patch level, but will not update to the next major release immediately." : "Vállalati használathoz. Mindig a legfrissebb hibajavítási szint, de nem kényszeríti azonnal a következő főverziót.",
    "That update happens once {vendor} has done additional hardening and testing for large-scale and mission-critical deployments." : "A frissítés akkor történik, amikor a(z) {vendor} elvégezte a további biztonsági megerősítést és tesztelést, mely a nagy méretű és küldetéskritikus telepítésekhez szükséges.",
    "This channel is only available to customers and provides the {enterprise} package." : "Ez a csatorna csak ügyfelek számára érhető el, a {enterprise} csomag biztosítja.",
    "Stable" : "Stabil",
    ...
    "Changelog for app {app}" : "Változásnapló a(z) {app} alkalmazáshoz",
