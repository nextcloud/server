OC.L10N.register(
    ...
    "See what's new" : "Ikusi zer den berri",
    "{app} updated to version {version}" : "{app} eguneratuta dago {version} bertsioan",
    ...
    "Displays update notifications for Nextcloud, app updates, and provides the SSO for the updater." : "Nextcloud eguneratzeko jakinarazpenak eta aplikazioenak erakusten ditu, eta SSO-a eskaintzen dio eguneratzaileari.",
    "What's new in {app} {version}" : "Zer da berri {app} {version} bertsioan",
    "Give feedback" : "Eman feedback-a",
    "Get started" : "Hasi",
    "No changelog available" : "Ez dago aldaketen egunkaririk eskuragarri ",
    "Update" : "Eguneratu",
    ...
    "Please note that the web updater is not recommended with more than 100 accounts! Please use the command line updater instead!" : "Kontuan izan eguneratzailea ez dela gomendatzen 100 erabiltzaile baino gehiago daudenean! Horren ordez erabili komando-lerroko eguneratzailea!",
    "Open updater" : "Ireki eguneratzailea",
    "Download now" : "Deskargatu orain",
    "Web updater is disabled. Please use the command line updater or the appropriate update mechanism for your installation method (e.g. Docker pull) to update." : "Web eguneratzailea desgaituta dago. Eguneratzeko erabili komando-lerroko eguneratzailea edo zure instalazio motarentzat egokia den eguneratze mekanismoa (adib. Docker pull).",
    ...
    "Checked on {lastCheckedDate} - Open changelog" : "{lastCheckedDate} datan egiaztatuta - Ireki aldaketen egunkaria",
