OC.L10N.register(
    ...
    "<strong>All</strong> apps have a compatible version for this {productName} version available." : "<strong>بارلىق</strong> ئەپلەرنىڭ بۇ نەشر {productName} گە ماس كېلىدىغان نۇسخىسى بار.",
    "_<strong>%n</strong> app has no compatible version for this {productName} version available._::_<strong>%n</strong> apps have no compatible version for this {productName} version available._" : ["1%n1 ئەپنىڭ بۇ {productName} نۇسخىسىغا ماس كېلىدىغان نۇسخىسى يوق.","1%n1 ئەپنىڭ بۇ {productName} نۇسخىسىغا ماس كېلىدىغان نۇسخىسى يوق."],
    "Enterprise" : "كارخانا",
    "For enterprise use. Provides always the latest patch level, but will not update to the next major release immediately." : "كارخانا ئىشلىتىش ئۈچۈن. ھەمىشە ئەڭ يېڭى ياماق دەرىجىسىنى تەمىنلەيدۇ، ئەمما كېيىنكى چوڭ نەشرىگە دەرھال يېڭىلانمايدۇ.",
    "That update happens once {vendor} has done additional hardening and testing for large-scale and mission-critical deployments." : "بۇ يېڭىلاش {vendor} چوڭ كۆلەملىك ۋە مۇھىم ۋەزىپىلەرنى ئورۇنلاشتۇرۇش ئۈچۈن قوشۇمچە قاتتىقلاشتۇرۇش ۋە سىناق قىلغاندىن كېيىن يۈز بېرىدۇ.",
