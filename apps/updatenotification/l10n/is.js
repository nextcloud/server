OC.L10N.register(
    ...
    "App updated" : "Forrit uppfært",
    "See what's new" : "Sjáðu hvað er nýtt",
    "{app} updated to version {version}" : "{app} uppfært í útgáfu {version}",
    ...
    "Displays update notifications for Nextcloud, app updates, and provides the SSO for the updater." : "Birtir tilkynningar um uppfærslur fyrir Nextcloud, uppfærslur á forritum og sér um SSO-innskráningu fyrir uppfærslustýringuna.",
    "Give feedback" : "Gefðu umsögn",
    "Get started" : "Hefjumst handa",
    "No changelog available" : "Engin breytingaskrá tiltæk",
    "What's new in {app} {version}" : "Það sem er nýtt í {app} {version}",
    "A new version is available: <strong>{newVersionString}</strong>" : "Ný útgáfa er tiltæk: <strong>{newVersionString}</strong>",
    "Checked on {lastCheckedDate} - Open changelog" : "Athugað þann {lastCheckedDate} - Opna breytingaskrá",
    ...
    "<strong>All</strong> apps have a compatible version for this {productName} version available." : "<strong>Öll</strong> forrit eru með samhæfðar uppfærslur fyrir þessa útgáfu {productName}.",
    "_<strong>%n</strong> app has no compatible version for this {productName} version available._::_<strong>%n</strong> apps have no compatible version for this {productName} version available._" : ["<strong>%n</strong> forrit er með engar samhæfðar uppfærslur fyrir þessa útgáfu {productName}.","%n forrit eru með engar samhæfðar uppfærslur fyrir þessa útgáfu {productName}."],
    ...
    "Please note that the web updater is not recommended with more than 100 accounts! Please use the command line updater instead!" : "Athugaðu að ekki er mælt með því að nota vefuppfærsluna á fleiri en 100 aðganga! Endilega notaðu uppfærslu af skipanalínu í staðinn!",
    ...
    "Changelog for app {app}" : "Breytingaskrá fyrir forritið {app}",
    "What's new in {app} version {version}" : "Það sem er nýtt í {app} útgáfu {version}",
