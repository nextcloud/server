OC.L10N.register(
    ...
    "{app} updated to version {version}" : "{app} uuendati versioonini {version}",
    ...
    "<strong>All</strong> apps have a compatible version for this {productName} version available." : "<strong>Kõikidel</strong> rakendustel on selle {productName}i versiooniga ühilduv versioon.",
    "_<strong>%n</strong> app has no compatible version for this {productName} version available._::_<strong>%n</strong> apps have no compatible version for this {productName} version available._" : ["<strong>%n</strong> rakenduse versioon ei ühildu selle {productName}i versiooniga.","<strong>%n</strong> rakenduse versioon ei ühildu selle {productName}i versiooniga."],
    "Enterprise" : "Suurorganisatsioonide versioon",
    "For enterprise use. Provides always the latest patch level, but will not update to the next major release immediately." : "Kasutusel suurtes organisatsioonides ja ettevõtetes. Viimased täiendused on alati lisatud, kuid uuendamine järgmise põhiversioonini ei toimu kohe.",
    "That update happens once {vendor} has done additional hardening and testing for large-scale and mission-critical deployments." : "See juhtub siis, kui {vendor} on teinud suurte ja/või missioonikriitiliste paigaldusete jaoks vajalikud täiendused.",
    "This channel is only available to customers and provides the {enterprise} package." : "See kanal on kasutusel vaid klientide jaoks ning siit on saadaval vaid teenus {enterprise}.",
    ...
    "Beta" : "Beetaversioon",
    "A pre-release version only for testing new features, not for production environments." : "Eelversioon uute funktsionaalsuste testimiseks ning ei sobi kasutamiseks igapäevases tarbekeskkonnas.",
    "Update" : "Uuenda",
    "The version you are running is not maintained anymore. Please make sure to update to a supported version as soon as possible." : "Versiooni, mida kasutad, ei uuendata enam. Palun uuenda toetatud versioonini võimalikult kiiresti.",
    ...
    "You can always update to a newer version. But you can never downgrade to a more stable version." : "Sa saad alati uuendada järgmise stabiilse versioonini, kuid ei saa kasutusele võtta eelmist stabiilset versiooni.",
