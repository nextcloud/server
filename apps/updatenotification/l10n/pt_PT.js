OC.L10N.register(
    ...
    "Give feedback" : "Partilhar Feedback",
    ...
    "Please make sure your config.php does not set <samp>appstoreenabled</samp> to false." : "Por favor garanta que o seu config.php não define o <samp>appstoreenabled</samp> como falso.",
    "Update" : "Atualizar",
    ...
    "The selected update channel does not support updates of the server." : "O canal de atualizações selecionado não suporta atualizações do servidor.",
