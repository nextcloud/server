OC.L10N.register(
    ...
    "Please check the Nextcloud and server log files for errors." : "يرجى التحقق من نكست كلاود و سجل أنشطة الخادم log بحثًا عن الأخطاء.",
    ...
    "Please note that the web updater is not recommended with more than 100 accounts! Please use the command line updater instead!" : "يرجى ملاحظة أنه لا يوصى باستخدام أداة تحديث الويب مع أكثر من 100 حساب! الرجاء استخدام الأمر السطري للتحديث command line updater بدلاً من ذلك!",
