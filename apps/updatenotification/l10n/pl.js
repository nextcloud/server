OC.L10N.register(
    ...
    "<strong>All</strong> apps have a compatible version for this {productName} version available." : "<strong>Wszystkie</strong> aplikacje mają dostępną kompatybilną wersję dla tej wersji {productName}.",
    "_<strong>%n</strong> app has no compatible version for this {productName} version available._::_<strong>%n</strong> apps have no compatible version for this {productName} version available._" : ["<strong>%n</strong> aplikacja nie ma kompatybilnej wersji dla tej wersji {productName}.","1%n1 aplikacje nie mają kompatybilnej wersji dla tej wersji {productName}.","1%n1 aplikacje nie mają kompatybilnej wersji dla tej wersji {productName}.","<strong>%n</strong> aplikacje nie mają kompatybilnej wersji dla tej wersji {productName}."],
    "Enterprise" : "Komercyjna",
    "For enterprise use. Provides always the latest patch level, but will not update to the next major release immediately." : "Do użytku komercyjnego. Zawsze zapewnia najnowszy poziom poprawek, ale nie aktualizuje się natychmiast do kolejnego głównego wydania.",
    "That update happens once {vendor} has done additional hardening and testing for large-scale and mission-critical deployments." : "Ta aktualizacja następuje, gdy {vendor} przeprowadzi dodatkowe zabezpieczenia i testy dla wdrożeń na dużą skalę i o krytycznym znaczeniu.",
    "This channel is only available to customers and provides the {enterprise} package." : "Ten kanał jest dostępny wyłącznie dla klientów i zapewnia pakiet {enterprise}.",
    "Stable" : "Stabilna",
