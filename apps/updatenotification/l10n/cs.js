OC.L10N.register(
    ...
    "_<strong>%n</strong> app has no compatible version for this Nextcloud version available_::_<strong>%n</strong> apps have no compatible version for this Nextcloud version available_" : ["<strong>%n</strong> aplikace nemá kompatibilní verzi pro verzi tohoto Nextcloudu","<strong>%n</strong> aplikací nemá kompatibilní verzi pro verzi tohoto Nextcloudu","<strong>%n</strong> aplikací nemá kompatibilní verzi pro verzi tohoto Nextcloudu","<strong>%n</strong> aplikace nemají kompatibilní verzi pro verzi tohoto Nextcloudu"],
