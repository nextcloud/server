<form id="webdavauth" action="#" method="post">
	<fieldset class="personalblock">
		...
		<p><label for="webdav_url"><?php p($l->t('URL: '));?><input type="url" placeholder=<?php p($l->t('https://example.com/webdav'));?> id="webdav_url" name="webdav_url" value="<?php p($_['webdav_url']); ?>"></label>
