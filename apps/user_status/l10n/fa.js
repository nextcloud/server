OC.L10N.register(
    ...
    "Previously set" : "قبلاً تنظیم شده",
    ...
    "There was an error reverting the status" : "مشکلی در بازگرداندن وضعیت پیش آمده",
    "Online status" : "وضعیت آنلاین",
    "Status message" : "پیغام وضعیت",
    "Set absence period" : "تنظیم دوره غیبت",
    "Set absence period and replacement" : "تنظیم دوره غیبت و جایگزین",
