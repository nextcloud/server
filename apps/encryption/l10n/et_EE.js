OC.L10N.register(
    "encryption",
    {
    "Missing recovery key password" : "Taastevõtme salasõna on puudu",
    ...
    "Recovery key successfully enabled" : "Taastevõtme kasutuselevõtmine õnnestus",
    ...
    "Could not enable the recovery key, please try again or contact your administrator" : "Taastevõtme kasutuselevõtmine ei õnnestunud, palun proovi hiljem uuesti või võta ühendust serveri haldajaga",
    ...
    "Please enable server side encryption in the admin settings in order to use the encryption module." : "Krüptomooduli kasutamiseks palun lülita haldusseadistustest sisse serveripoolne krüptimine.",
    ...
    "Please login to the web interface, go to the \"Security\" section of your personal settings and update your encryption password by entering this password into the \"Old login password\" field and your current login password." : "Palun logi sisse serveri veebiliidesest, ava oma isiklike seadistuste alajaotus „Turvalisus“ ja uuenda oma krüptimise salasõna sisestades selle salasõna väljale „Sisselogimise vana salasõna“ ja sinu senise sisselogimise salasõna.",
