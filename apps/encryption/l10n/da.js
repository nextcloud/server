OC.L10N.register(
    ...
    "Please enable server side encryption in the admin settings in order to use the encryption module." : "Aktiver venligst serverkryptering under administrationen, hvis du vil anvende krypteringsmodulet.",
