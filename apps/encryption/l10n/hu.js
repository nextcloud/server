OC.L10N.register(
    ...
    "This app provides the (default) cryptography implementation for Nextcloud's Server-side Encryption (SSE) feature.\n\n\t\t\t**Encryption Details**\n\t\t\t*   **Cipher Mode:** AES-256-CTR (default)\n\t\t\t*   **Authentication:** HMAC-SHA256\n\n\t\t\t**Important Warnings**\n\t\t\t*   **DANGER:** Do not disable this application until all files have been decrypted (`occ encryption:decrypt-all`).\n\t\t\t*   **WARNING**: Reverting to non-encrypted file storage after activation requires command-line access. The action is permanent via the Web UI.\"\n\n\t\t\t**Notes for Existing Files**\n\t\t\t*   By default, enabling SSE does not encrypt existing files; only new files will be encrypted.\n\t\t\t*   To encrypt all existing files, use the command `occ encryption:encrypt-all`.\n\n\t\t\t**Before You Begin**\n\t\t\t*   **Read the Documentation:** Before you enable SSE, encrypt existing files, or disable SSE, it is critical to\n\t\t\t\tread the documentation to understand implications and the appropriate procedures to avoid data loss." : "Ez az alkalmazás biztosítja a Nextcloud kiszolgálóoldali titkosítási (SSE) funkciójának (alapértelmezett) kriptográfiai megvalósítását.\n\n\t\t\t**Titkosítás részletei**\n\t\t\t*   **Titkosítási mód:** AES-256-CTR (alapértelmezett)\n\t\t\t*   **Hitelesítés:** HMAC-SHA256\n\n\t\t\t**Fontos figyelmeztetések**\n\t\t\t*   **VESZÉLY:** Addig ne tiltsa le az alkalmazást, amíg az összes fájl titkosítását fel nem oldotta (`occ encryption:decrypt-all`).\n\t\t\t*   **FIGYELMEZTETÉS**: A titkosítatlan fájltároláshoz való visszatéréshez parancssoros hozzáférés szükséges. A webes felületről végrehajtott művelet végleges.\"\n\n\t\t\t**Megjegyzések a meglévő fájlokhoz**\n\t\t\t*   Alapértelmezés szerint az SSE nem titkosítja a meglévő fájlokat, csak az újakat.\n\t\t\t*   A meglévő fájlok titkosításához használja az `occ encryption:encrypt-all` parancsot.\n\n\t\t\t**Mielőtt hozzákezd**\n\t\t\t*   **Olvassa el a dokumentációt:** Mielőtt bekapcsolja az SSE-t, titkosítja a meglévő fájlokat, vagy letiltja az SSE-t; kulcsfontosságú,\n\t\t\t\thogy elolvassa a dokumentációt, hogy megértse a következményeket és a megfelelő eljárásokat az adatvesztés elkerülése érdekében.",
    ...
    "Passwords fields do not match" : "A jelszómezők nem egyeznek",
    "Repeat recovery key password" : "Ismételje meg a heylreállítási kulcs jelszavát",
    "An error occurred while updating the recovery key settings. Please try again." : "Hiba történt a helyreállítási kulcs beállításainak frissítésekor. Próbálja újra.",
    ...
    "An error occurred while changing the recovery key password. Please try again." : "Hiba történt a helyreállítási kulcs jelszavának módosításakor. Próbálja újra.",
    "Update private key password" : "Privát kulcs jelszavának frissítése",
    "Your private key password no longer matches your log-in password. Set your old private key password to your current log-in password." : "A privát kulcsának jelszava már nem egyezik a bejelentkezési jelszavával. Állítsa be a privát kulcsa régi jelszavát a jelenlegi bejelentkezési jelszavának.",
    ...
    "Update" : "Frissítés",
    "Updating recovery keys. This can take some time…" : "Helyreállítási kulcsok frissítése. Ez eltarthat egy ideig…",
    ...
    "Enable password recovery" : "Jelszóhelyreállítás engedélyezése",
    "Default encryption module" : "Alapértelmezett titkosítási modul",
    ...
    "Your private key password no longer matches your log-in password." : "A privát kulcsa jelszava már nem egyezik meg a bejelentkezési jelszavával.",
