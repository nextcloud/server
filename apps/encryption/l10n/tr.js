OC.L10N.register(
    ...
    "An error occurred while changing the recovery key password. Please try again." : "Kurtarma anahtarı parolası değiştirilirken bir sorun çıktı. Lütfen yeniden deneyin",
    "Update private key password" : "Kişisel anahtar parolasını güncelle",
    "Your private key password no longer matches your log-in password. Set your old private key password to your current log-in password." : "Kişisel anahtar parolanız artık oturum açma parolanızla aynı değil. Eski kişisel anahtar parolanızı geçerli oturum açma parolanız olarak ayarlayın.",
