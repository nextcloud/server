OC.L10N.register(
    ...
    "An error occurred while updating the recovery key settings. Please try again." : "Помилка під час оновлення налаштувань ключів відновлення. Спробуйте ще раз.",
    ...
    "Update" : "Оновлювати",
    "Updating recovery keys. This can take some time…" : "Оновлення ключів відновлення. Це може взяти трохи часу...",
