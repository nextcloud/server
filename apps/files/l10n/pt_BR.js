OC.L10N.register(
    ...
    "No read permission on file." : "Sem permissões de leitura do arquivo.",
    "Accept" : "Aceitar",
    "Reject" : "Rejeitar",
    ...
    "Create files" : "Criar arquivos",
    "Delete files" : "Excluir arquivos",
    "Download files" : "Baixar arquivos",
    "When disabled, the option to download will be hidden" : "Quando desativada, a opção de download ficará oculta",
    "View files" : "Exibir arquivos",
    ...
    "{displayName} (unavailable)" : "{displayName} (indisponível)",
    ...
    "Enable folder tree view" : "Ativar visualização da árvore de pastas",
    ...
    "Warn before deleting a file" : "Avisar antes de excluir um arquivo",
    ...
    "_%n file converted_::_%n files converted_" : ["%n arquivo convertido","%n de arquivos convertidos","%n arquivos convertidos"],
    ...
    "Upload cancelled, drop the files again to retry" : "O envio foi cancelado. Arraste e solte os arquivos novamente para tentar novamente",
    ...
    "Invalid name for \"{path}\"" : "Nome inválido para “{path}”",
    ...
    "\"{char}\" is not allowed inside a folder name." : "“{char}” não é permitido dentro do nome de uma pasta.",
    "\"{char}\" is not allowed inside a filename." : "\"{char}\" não é permitido dentro de um nome de arquivo.",
    "\"{segment}\" is a reserved name and not allowed for folder names." : "“{segment}” é um nome reservado e não pode ser usado em nomes de pastas.",
    ...
    "Folder names must not end with \"{extension}\"." : "Os nomes das pastas não devem terminar com “{extension}”.",
