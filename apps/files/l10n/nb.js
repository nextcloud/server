OC.L10N.register(
    ...
    "_Delete folder_::_Delete folders_" : ["Slett mappe","Slett mapper"],
    "_Disconnect storage_::_Disconnect storages_" : ["Koble fra lagring","Koble fra lagringer"],
    "_Leave this share_::_Leave these shares_" : ["Forlat denne delingen","Forlat disse delingene"],
    ...
    "Select the row for {displayName}" : "Velg raden for {displayName}",
    "Open folder {name}" : "Åpne mappe {name}",
    "Unselect all" : "Fravelg alle",
    "ascending" : "stigende",
    "descending" : "synkende",
    "Sort list by {column} ({direction})" : "Sorter liste etter {column} ({direction})",
