OC.L10N.register(
    ...
    "In folder" : "I mappen",
    "Pick folder to search in" : "Velg en mappe å søke i",
    ...
    "Folder name must not be empty." : "Mappenavnet kan ikke være tomt",
    "Filename must not be empty." : "Filnavn kan ikke være tomt.",
    "\"{char}\" is not allowed inside a folder name." : "\"{char}\" er ikke tillatt som en del av et katalognavn.",
    "\"{char}\" is not allowed inside a filename." : "\"{char}\" er ikke tillatt i et filnavn.",
    "\"{segment}\" is a reserved name and not allowed for folder names." : "\"{segment}\" er et reservert navn og ikke tillatt for katalognavn.",
    ...
    "Folder names must not end with \"{extension}\"." : "Mappenavn må ikke slutte med \"{extension}\".",
