OC.L10N.register(
    ...
    "No read permission on file." : "Nincs olvasási jogosultság a fájlon.",
    "Accept" : "Elfogadás",
    "Reject" : "Elutasítás",
    ...
    "Create files" : "Fájlok létrehozása",
    "Delete files" : "Fájlok törlése",
    "Download files" : "Fájlok letöltése",
    "When disabled, the option to download will be hidden" : "Ha le van tiltva, akkor a letöltési lehetőség el lesz rejtve",
    "View files" : "Fájlok megtekintése",
    "Edit files" : "FÁjlok szerkesztése",
    "Show files in grid view" : "Fájlok megjelenítése rácsnézetben",
    "File" : "Fájl",
    ...
    "{displayName} (unavailable)" : "{displayName} (nem érhető el)",
    ...
    "Folder name must not be empty." : "A mappanév nem lehet üres.",
    "Filename must not be empty." : "A fájlnév nem lehet üres.",
    "\"{char}\" is not allowed inside a folder name." : "A(z) „{char}” nem engedélyezett egy mappanévben.",
    "\"{char}\" is not allowed inside a filename." : "„{char}” nem szerepelhet a fájlnévben.",
    "\"{segment}\" is a reserved name and not allowed for folder names." : "A(z) „{segment}” foglalt név, és nem engedélyezett a mappanevekben.",
    ...
    "Folder names must not end with \"{extension}\"." : "A mappanevek nem végződhetnek ezzel: „{extension}”.",
