OC.L10N.register(
    ...
    "Ownership transfer denied" : "Tulajdonjog átruházása visszautasítva",
    "Your ownership transfer of {path} was denied by {user}." : "A(z) {path} tulajdonjogának átruházását {user} visszautasította.",
