OC.L10N.register(
    ...
    "Direct link was copied (only works for users who have access to this file/folder)" : "بىۋاسىتە ئۇلىنىش كۆچۈرۈلدى (پەقەت بۇ ھۆججەت / ھۆججەت قىسقۇچنى زىيارەت قىلىدىغان ئىشلەتكۈچىلەر ئۈچۈن ئىشلەيدۇ)",
    "Path" : "Path",
    "Favorited" : "ياقتۇرىدىغان",
    "Copy direct link (only works for users who have access to this file/folder)" : "بىۋاسىتە ئۇلىنىشنى كۆچۈرۈڭ (پەقەت بۇ ھۆججەت / ھۆججەت قىسقۇچنى زىيارەت قىلالايدىغان ئىشلەتكۈچىلەر ئۈچۈن ئىشلەيدۇ)",
