OC.L10N.register(
    ...
    "The file cannot be found" : "ھۆججەتنى تاپقىلى بولمىدى",
    "The destination path does not exist: %1$s" : "نىشان يول مەۋجۇت ئەمەس: %1$s",
    "You do not have permission to create a file at the specified location" : "سىزنىڭ بەلگىلەنگەن ئورۇندا ھۆججەت قۇرۇش ھوقوقىڭىز يوق",
    "The file could not be converted." : "ھۆججەتنى ئايلاندۇرغىلى بولمىدى",
    "Could not get relative path to converted file" : "ئايلاندۇرغان ھۆججەتنىڭ نىسپىي يولىغا ئېرىشكىلى بولمىدى",
    "Limit must be a positive integer." : "چەك چوقۇم مۇسبەت سان بولىشى كېرەك",
    "The replacement character may only be a single character." : "ئالماشتۇرۇش ھەرىپى چوقۇم تاق ھەرىپ بولىشى كېرەك",
    "Filename sanitization already started." : "ھۆججەت نامىنى دىزىنفىكسىيەلەش باشلاندى.",
    "No filename sanitization in progress." : "ھۆججەت نامىنى دىزىنفىكسىيەلەش داۋاملىشىۋاتىدۇ",
    "Favorite files" : "ياقتۇردىغان ھۆججەتلەر",
    "No favorites" : "ياقتۇردىغان يوق",
    "More favorites" : "كۆپ ياقتۇردىغان",
    "Accept" : "قوبۇل قىلىڭ",
    "Reject" : "رەت قىلىش",
    ...
    "Folder" : "قىسقۇچ",
    "Unknown file type" : "نامەلۇم ھۆججەت تىپى",
    "{ext} image" : "{ext} سۈرەت",
    "{ext} video" : "{ext} سىن",
    "{ext} audio" : "{ext} ئاۋاز",
    "{ext} text" : "{ext} تېكىست",
    ...
    "Show file type column" : "ھۆججەت تىپى قاتارىنى كۆرسەت",
    "Show file extensions" : "ھۆججەت كېڭەيتمىسىنى كۆرسەت",
    ...
    "Enable folder tree view" : "قىسقۇچ شاخسىمان كۆرۈنۈشىنى قوزغات",
    ...
    "Selection" : "تاللاش",
    "Select all files" : "ھەممە ھۆججەتلەرنى تاللا",
    "Deselect all" : "ھەممىنى تاللاڭ",
    "Select or deselect" : "تاللا ياكى تاللىما",
    "Select a range" : "بىر دائىرىنى تاللا",
    "Navigation" : "يول باشلاش",
    "Go to parent folder" : "باش قىسقۇچقا بار",
    "Go to file above" : "ئۈستىدىكى ھۆججەتكە بار",
    "Go to file below" : "ئاستىدىكى ھۆججەتكە بار",
    "Go left in grid" : "سولغا بار",
    ...
    "Warn before deleting a file" : "بىر ھۆججەتنى ئۆچۈرۈشتىن بۇرۇن ئاگاھلاندۇر",
    "WebDAV URL" : "WebDAV URL",
    "Create an app password" : "بىر ئەپ پارولى قۇر",
    "Required for WebDAV authentication because Two-Factor Authentication is enabled for this account." : "بۇ ھېسابات ئۈچۈن ئىككى ئامىللىق دەلىللەش قوزغىتىلغان بولغاچقا، WebDAV دەلىللەش ئۈچۈن تەلەپ قىلىنىدۇ.",
    "How to access files using WebDAV" : "WebDAV ئارقىلىق ھۆججەتلەرگە قانداق كىرىش كېرەك",
    ...
    "Name" : "ئاتى",
    "File type" : "ھۆججەت تىپى",
    "Size" : "چوڭلۇقى",
    "{displayName}: failed on some elements" : "{displayName}: بەزى ئېلېمېنتلاردا مەغلۇپ بولدى ",
    "{displayName}: done" : "{displayName}: پۈتتى",
    "{displayName}: failed" : "{displayName}: مەغلۇپ بولدى",
    "(selected)" : "(تاللانغان)",
    ...
    "Search everywhere …" : "ھەممە يەردە ئىزدە  ...",
    "Search here …" : "بۇ يەردە ئىزدە  ...",
    "Search scope options" : "ئىزدەش دائىرە تاللانمىسى",
    "Search here" : "بۇ يەردە ئىزدە",
    ...
    "Create" : "قۇر",
    "Files starting with a dot are hidden by default" : "نۇقتا بىلەن باشلانغان ھۆججەتلەر ئۆزلۈكىدىن يوشۇرۇنغان بولىدۇ",
    "Failed to start filename sanitization." : "ھۆججەت نامىنى تازىلاشنى باشلاش مەغلۇب بولدى.",
    "Failed to refresh filename sanitization status." : "ھۆججەت نامىنى تازىلاش ھالىتىنى يېڭىلاش مەغلۇب بولدى.",
    "Filename sanitization in progress." : "ھۆججەت نامىنى تازىلاش داۋاملىشىۋاتىدۇ.",
    "Currently {processedUsers} of {totalUsers} accounts are already processed." : "ھازىر {totalUsers} ھېساباتنىڭ {processedUsers} سانى بىر تەرەپ قىلىندى.",
    "Preparing …" : "تەييارلاۋاتىدۇ  ...",
    "Refresh" : "يېڭىلاش",
    "All files have been santized for Windows filename support." : "بارلىق ھۆججەتلەر Windows ھۆججەت نامىنى قوللاش ئۈچۈن تازىلىنىدۇ.",
    "Some files could not be sanitized, please check your logs." : "بەزى ھۆججەتلەرنى تازىلىغىلى بولمىدى، خاتىرىلىرىڭىزنى تەكشۈرۈپ بېقىڭ.",
    "Sanitization errors" : "تازىلاش خاتالىقى",
    "Not sanitized filenames" : "تازىلانمىغان ھۆججەت نامى قالمىدى",
    "Windows filename support has been enabled." : "Windows ھۆججەت نامىنى قوللاش ئىقتىدارى قوزغىتىلدى.",
    "While this blocks users from creating new files with unsupported filenames, existing files are not yet renamed and thus still may break sync on Windows." : "بۇ ئىشلەتكۈچىلەرنىڭ قوللىمايدىغان ھۆججەت ئىسمى بىلەن يېڭى ھۆججەتلەرنى قۇرۇشىنى توسسىمۇ، مەۋجۇت ھۆججەتلەرنىڭ ئىسمى ئۆزگەرتىلمىگەن، شۇڭا Windows سىستېمىسىدا يەنىلا ماسلىشىشنى بۇزۇلۇشى مۇمكىن.",
    "You can trigger a rename of files with invalid filenames, this will be done in the background and may take some time." : "سىز خاتا ئىسىملىق ھۆججەتلەرنىڭ ئىسمىنى ئۆزگەرتەلەيسىز، بۇ ئارقا كۆرۈنۈشتە ئېلىپ بېرىلىدۇ ھەمدە بىر ئاز ۋاقىت كېتىشى مۇمكىن.",
    "Please note that this may cause high workload on the sync clients." : "بۇنىڭ سىنخرونلاشتۇرۇش خېرىدارلىرىغا يۇقىرى يۈك ئېلىپ كېلىشى مۇمكىنلىكىنى ئۇنۇتماڭ.",
    "Limit" : "چەك",
    "This allows to configure how many users should be processed in one background job run." : "بۇ ئارقىلىق بىر قېتىم ئارقا كۆرۈنۈش خىزمىتى ئىجرا قىلىنىۋاتقاندا قانچە ئىشلەتكۈچىنىڭ بىر تەرەپ قىلىنىشى كېرەكلىكىنى تەڭشەشكە بولىدۇ.",
    "Sanitize filenames" : "ھۆججەت نامىنى تازىلا",
    "(starting)" : "(باشلىندۇ)",
    "Fill template fields" : "قېلىپ بۆلەكلىرىنى تولدۇرۇڭ",
    "Submitting fields …" : "ئورۇنلارنى تاپشۇرۋاتىدۇ  ...",
    "Submit" : "يوللاڭ",
    ...
    "Keep {old}" : "{old} ساقلا",
    "Keep without extension" : "كېڭەيتىلمىسىز ساقلا",
    "Use {new}" : "{new} نى ئىشلەت",
    "Remove extension" : "كېڭەيتىلمىنى ئۆچۈر",
    "Change file extension" : "ھۆججەت كېڭەيتىلمىسىنى ئۆزگەرت",
    "Changing the file extension from \"{old}\" to \"{new}\" may render the file unreadable." : "ھۆججەت كېڭەيتىلمىسىنى «{old}» دىن «{new}» غا ئۆزگەرتسىڭىز، ھۆججەتنى ئوقۇغىلى بولمايدىغان ھالغا كەلتۈرۈشى مۇمكىن.",
    "Removing the file extension \"{old}\" may render the file unreadable." : "«{old}» ھۆججەت كېڭەيتىلمىسىنى ئۆچۈرۈۋەتسىڭىز، ھۆججەتنى ئوقۇغىلى بولمايدىغان ھالغا كەلتۈرۈشى مۇمكىن.",
    "Adding the file extension \"{new}\" may render the file unreadable." : "«{new}» ھۆججەت كېڭەيتىلمىسىنى قوشسىڭىز، ھۆججەتنى ئوقۇغىلى بولمايدىغان ھالغا كەلتۈرۈشى مۇمكىن.",
    "Do not show this dialog again." : "بۇ دىئالوگنى قايتا كۆرسەتمە.",
    ...
    "Unable to change the favorite state of the file" : "بۇ ھۆججەتنىڭ ياقتۇردىغان ھالىنىنى ئۆزگەتكىلى بولمىدى",
    ...
    "No search results for “{query}”" : "\"{query}\" نىڭ ئىزدەش نەتىنجىسى يوق",
    "Search for files" : "ھۆججەتلەرنى ئىزدە",
    ...
    "After enabling the Windows compatible filenames, existing files cannot be modified anymore but can be renamed to valid new names by their owner." : "Windows بىلەن ماس كېلىدىغان ھۆججەت ئىسىملىرىنى قوزغىتقاندىن كېيىن، مەۋجۇت ھۆججەتلەرنى ئۆزگەرتكىلى بولمايدۇ، لېكىن ئۇلارنىڭ ئىگىسى ئۇلارنى كۈچكە ئىگە يېڭى ئىسىملار بىلەن ئۆزگەرتەلەيدۇ.",
    "Failed to toggle Windows filename support" : "Windows ھۆججەت نامىنى قوللاش ئىقتىدارىنى ئالماشتۇرۇش مەغلۇب بولدى",
    ...
    "Save as {displayName}" : "{displayName} سۈپىتىدە ساقلا",
    "Save as …" : "سۈپىتىدە ساقلا  ...",
    "Converting files …" : "ھۆججەتلەرنى ئايلاندۇرۋاتىدۇ  ...",
    "Failed to convert files: {message}" : "ھۆججەتنى ئايلاندۇرۇش مەغلۇپ بولدى: {message}",
    "All files failed to be converted" : "ھەممە ھۆججەتنى ئايلاندۇرۇش مەغلۇپ بولدى",
    "One file could not be converted: {message}" : "بىر ھۆججەتنى ئايلاندۇرغىلى بولمىدى: {message}",
    "_%n file could not be converted_::_%n files could not be converted_" : ["%n ھۆججەتنى ئايلاندۇرغىلى بولمىدى","%n ھۆججەتنى ئايلاندۇرغىلى بولمىدى"],
    "_%n file converted_::_%n files converted_" : ["%nھۆججەت ئايلاندۇرۇلدى","%n ئايلاندۇرۇلدى"],
    "Files converted" : "ھۆججەتلەر ئايلاندۇرۇلدى",
    "Failed to convert files" : "ھۆججەتلەرنى ئايلاندۇرۇش مەغلۇب بولدى",
    "Converting file …" : "ھۆججەتنى ئايلاندۇرۋاتىدۇ  ...",
    "File successfully converted" : "ھۆججەت مۇۋاپىقىيەتلىك ئايلاندۇرۇلدى",
    "Failed to convert file: {message}" : "ھۆججەتنى ئايلاندۇرۇش مەغلۇپ بولدى: {message}",
    "Failed to convert file" : "ھۆججەتنى ئايلاندۇرۇش مەغلۇپ بولدى",
    "Delete" : "ئۆچۈر",
    ...
    "Cancel" : "ۋاز كەچ",
    "Download" : "چۈشۈر",
    "The requested file is not available." : "تەلەپ قىلىنغان ھۆججەت مەۋجۇت ئەمەس.",
    "The requested files are not available." : "تەلەپ قىلىنغان ھۆججەتلەر مەۋجۇت ئەمەس.",
    "Add or remove favorite" : "ياقتۇردىغانغا قوش ياكى ئۆچۈر",
    ...
    "Destination is not a folder" : "نىشان بىر قىسقۇچ ئەمەس",
    "This file/folder is already in that directory" : "بۇ ھۆججەت/قىسقۇچ ئۇ مۇندەرىجىدە مەۋجۇت",
    ...
    "The file should now open on your device. If it doesn't, please check that you have the desktop app installed." : "ھۆججەت ھازىر ئۈسكۈنىڭىزدە ئېچىلىشى كېرەك. ئەگەر ئېچىلمىسا، ئۈستەل يۈزى ئەپىڭىزنىڭ ئورنىتىلغانلىقىنى تەكشۈرۈڭ.",
    "Retry and close" : "قايتا سىناپ بېقىڭ ۋە تاقاپ قويۇڭ",
    "Open online" : "توردا ئاچ",
    "Rename" : "ئات ئۆزگەرت",
    "Details" : "تەپسىلاتى",
    ...
    "_%n file_::_%n files_" : ["%n ھۆججەت","%n ھۆججەتلەر"],
    "_%n folder_::_%n folders_" : ["%n قىسقۇچ","%n قىسقۇچلار"],
    "_%n hidden_::_%n hidden_" : ["يۇشۇرۇن %n","يۇشۇرۇن %n"],
    ...
    "Upload (max. %s)" : "يۈكلەش (ئەڭ چوڭ %s)",
    "After enabling the windows compatible filenames, existing files cannot be modified anymore but can be renamed to valid new names by their owner." : "Windows بىلەن ماس كېلىدىغان ھۆججەت ئىسىملىرىنى قوزغىتقاندىن كېيىن، مەۋجۇت ھۆججەتلەرنى ئۆزگەرتكىلى بولمايدۇ، لېكىن ئۇلارنىڭ ئىگىسى ئۇلارنى يېڭى ئىسىملار بىلەن ئۆزگەرتەلەيدۇ.",
    "It is also possible to migrate files automatically after enabling this setting, please refer to the documentation about the occ command." : "بۇ تەڭشەكنى قوزغىتىپ بولغاندىن كېيىن ھۆججەتلەرنى ئاپتوماتىك كۆچۈرۈشكىمۇ بولىدۇ، occ بۇيرۇقى ھەققىدىكى ھۆججەتلەرگە قاراڭ.",
    "\"{displayName}\" failed on some elements" : "\"{displayName}\" بەزى تارماقلاردا مەغلۇپ بولدى",
    ...
    "Filter file names …" : "ھۆججەت ناملىرىنى سۈز ...",
    ...
    "Keyboard shortcuts" : "ھەرىپتاختا تېزلەتمىسى",
    "Speed up your Files experience with these quick shortcuts." : "بۇ تېز سۈرئەتلىك قىسقا يوللار بىلەن ھۆججەت تەجرىبىڭىزنى تېزلىتىڭ.",
    "Open the actions menu for a file" : "ھۆججەت ئۈچۈن ھەرىكەت تىزىملىكىنى ئېچىڭ",
    "Rename a file" : "بىر ھۆججەتنىڭ نامىنى ئۆزگەرت",
    "Delete a file" : "بىر ھۆججەتنى ئۆچۈر",
    "Favorite or remove a file from favorites" : "ھۆججەتنى ياقتۇرۇشلارغا قوشۇش ياكى ياقتۇرۇشلاردىن ئۆچۈرۈش",
    "Manage tags for a file" : "ھۆججەتنىڭ بەلگىلىرىنى باشقۇرۇش",
    "Deselect all files" : "ھەممە ھۆججەتنى تاللىما",
    "Select or deselect a file" : "بىر ھۆججەتنى تاللا ياكى تاللىما",
    "Select a range of files" : "بىر دائىردىكى ھۆججەتنى تاللا",
    "Navigate to the parent folder" : "باش قىسقۇچقا بار",
    "Navigate to the file above" : "ئالدىدىكى قىسقۇچقا بار",
    "Navigate to the file below" : "كىيىنكى ھۆججەتكە بار",
    "Navigate to the file on the left (in grid mode)" : "سول تەرەپتىكى ھۆججەتكە يۆتكىلىڭ (تور شەكلىدە)",
    "Navigate to the file on the right (in grid mode)" : "ئوڭ تەرەپتىكى ھۆججەتكە يۆتكىلىڭ (تور شەكلىدە)",
    "Toggle the grid view" : "تور كۆرۈنۈشىنى ئالماشتۇر",
    "Open the sidebar for a file" : "ھۆججەتنىڭ بانبالدىقىنى ئاچ",
    "Save as …" : "سۈپىتىدە ساقلا ...",
    ...
    "Cancelled move or copy of \"{filename}\"." : "«{filename}» نىڭ يۆتكىلىشى ياكى كۆپەيتىلگەن نۇسخىسى.",
