OC.L10N.register(
    ...
    "No read permission on file." : "K súboru nemáte oprávnenie na čítanie.",
    "Accept" : "Prijať",
    "Reject" : "Odmietnuť",
    ...
    "Create files" : "Vytvárať súbory",
    "Delete files" : "Zmazať súbory",
    "Download files" : "Sťahovať súbory",
    "When disabled, the option to download will be hidden" : "Po vypnutí bude možnosť sťahovania skrytá",
    "View files" : "Zobrazovať súbory",
    ...
    "Videos" : "Videá",
    "Filters" : "Filtre",
    "Back to filters" : "Späť k filtrom",
    "Appearance" : "Vzhľad",
    ...
    "Transfer \"{path}\"" : "Preniesť „{path}“",
    "Select file or folder" : "Vybrať súbor alebo priečinok",
    "Transfer" : "Prevod",
    "Transfer {path} to {userid}" : "Previesť {path} na {userid}",
    "Error while opening file picker for transfer ownership" : "Chyba pri otváraní výberu súboru na prevod vlastníctva",
    ...
    "Error while sending ownership transfer request" : "Chyba pri odosielaní žiadosti o prevod vlastníctva",
    "Transfer ownership of a file or folder" : "Prevod vlastníctva súboru alebo priečinka",
    "File or folder to transfer" : "Súbor alebo priečinok na prevod",
    "No file or folder selected" : "Nie je vybraný žiadny súbor ani priečinok",
    "New owner" : "Nový vlastník",
    "You need to select a file or folder to transfer ownership." : "Na prevod vlastníctva musíte vybrať súbor alebo priečinok.",
    "You need to select a new owner for the file or folder." : "Pre súbor alebo priečinok musíte vybrať nového vlastníka.",
    ...
    "Rename file to hidden" : "Premenovať súbor na skrytie",
    "Prefixing a filename with a dot may render the file hidden." : "Predpona názvu súboru bodkou môže spôsobiť, že súbor bude skrytý.",
    "Are you sure you want to rename the file to \"{filename}\"?" : "Ste si istí, že chcete premenovať súbor na \"{filename}\"?",
    "Cancel" : "Zrušiť",
    "Rename" : "Premenovať",
    ...
    "_Moving %n file to \"{destination}\" …_::_Moving %n files to \"{destination}\" …_" : ["Presúva sa %n súbor do „{destination}“ …","Presúvajú sa %n súbory do „{destination}“ …","Presúva sa %n súborov do „{destination}“ …","Presúva sa %n súborov do „{destination}“ …"],
    "Copying \"{source}\" to \"{destination}\" …" : "Kopírovanie \"{source}\" do \"{destination}\" …",
    "_Copying %n file to \"{destination}\" …_::_Copying %n files to \"{destination}\" …_" : ["Kopíruje sa %n súbor do „{destination}“ …","Kopírujú sa %n súbory do „{destination}“ …","Kopíruje sa %n súborov do „{destination}“ …","Kopíruje sa %n súborov do „{destination}“ …"],
    ...
    "Details" : "Podrobnosti",
    "Open the details sidebar" : "Otvoriť bočný panel s podrobnosťami",
    ...
    "Pick folder to search in" : "Vybrať priečinok na vyhľadávanie",
    ...
    "Upload cancelled, drop the files again to retry" : "Nahrávanie zrušené, skúste to znova pretiahnutím súborov",
    ...
    "Invalid name for \"{path}\"" : "Neplatný názov pre „{path}“",
    ...
    "Folder name must not be empty." : "Názov priečinka nesmie byť prázdny.",
    "Filename must not be empty." : "Názov súboru nesmie byť prázdny.",
    "\"{char}\" is not allowed inside a folder name." : "Znak „{char}“ nie je povolený v názve priečinka.",
    "\"{char}\" is not allowed inside a filename." : "Znak \"{char}\" nie je povolený v názve súboru.",
    "\"{segment}\" is a reserved name and not allowed for folder names." : "„{segment}“ je rezervovaný názov a nie je povolený v názvoch priečinkov.",
    ...
    "Folder names must not end with \"{extension}\"." : "Názvy priečinkov nesmú končiť príponou „{extension}“.",
