OC.L10N.register(
    ...
    "Size" : "Izmērs",
    "Modified" : "Mainīts",
    "_%n folder_::_%n folders_" : ["%n mape","%n mapes"],
    "_%n file_::_%n files_" : ["%n datne","%n datnes"],
    "{dirs} and {files}" : "{dirs} un {files}",
    "_including %n hidden_::_including %n hidden_" : ["ieskaitot %n paslēptos","ieskaitot %n paslēptos"],
    "You don’t have permission to upload or create files here" : "Jums nav tiesību šeit augšupielādēt vai veidot datnes",
    "_Uploading %n file_::_Uploading %n files_" : ["Augšupielāde %n failu","Augšupielādē %n datnes"],
    "New" : "Jauna",
    ...
    "Copied!" : "Nokopēts!",
    "Path" : "Ceļš",
    "_%n byte_::_%n bytes_" : ["%n baits","%n baiti"],
    "Favorited" : "Favorīti",
