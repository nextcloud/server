OC.L10N.register(
    ...
    "No read permission on file." : "Gan cead léite ar chomhad.",
    "Accept" : "Glac",
    "Reject" : "Diúltaigh",
    ...
    "Create files" : "Cruthaigh comhaid",
    "Delete files" : "Scrios comhaid",
    "Download files" : "Íoslódáil comhaid",
    "When disabled, the option to download will be hidden" : "Nuair a bheidh sé díchumasaithe, beidh an rogha chun íoslódáil i bhfolach",
    "View files" : "Féach ar chomhaid",
    "Edit files" : "Cuir comhaid in eagar",
    ...
    "{displayName} (unavailable)" : "{displayName} (níl sé ar fáil)",
    ...
    "Videos" : "Físeáin",
    "Filters" : "Scagairí",
    "Back to filters" : "Ar ais chuig na scagairí",
    "Appearance" : "Dealramh",
    ...
    "Transfer \"{path}\"" : "Aistrigh \"{path}\"",
    "Select file or folder" : "Roghnaigh comhad nó fillteán",
    "Transfer" : "Aistriú",
    "Transfer {path} to {userid}" : "Aistrigh {path} go {userid}",
    "Error while opening file picker for transfer ownership" : "Earráid agus roghnóir comhad á oscailt le haghaidh úinéireacht a aistriú",
    ...
    "Error while sending ownership transfer request" : "Earráid agus iarratas aistrithe úinéireachta á sheoladh",
    "Transfer ownership of a file or folder" : "Aistrigh úinéireacht comhaid nó fillteáin",
    "File or folder to transfer" : "Comhad nó fillteán le haistriú",
    "No file or folder selected" : "Níl aon chomhad ná fillteán roghnaithe",
    "New owner" : "Úinéir nua",
    "You need to select a file or folder to transfer ownership." : "Ní mór duit comhad nó fillteán a roghnú le húinéireacht a aistriú.",
    "You need to select a new owner for the file or folder." : "Ní mór duit úinéir nua a roghnú don chomhad nó don fhillteán.",
    ...
    "Save as …" : "Sábháil mar …",
    "Converting files …" : "Ag tiontú comhad …",
    ...
    "Upload cancelled, drop the files again to retry" : "Cuireadh an t-uaslódáil ar ceal; scaoil na comhaid arís chun triail eile a bhaint as.",
    ...
    "Invalid name for \"{path}\"" : "Ainm neamhbhailí do \"{path}\"",
    ...
    "Folder name must not be empty." : "Ní féidir ainm an fhillteáin a bheith folamh.",
    "Filename must not be empty." : "Ní ceadmhach ainm an chomhaid a bheith folamh.",
    "\"{char}\" is not allowed inside a folder name." : "Ní cheadaítear \"{char}\" laistigh d'ainm fillteáin.",
    "\"{char}\" is not allowed inside a filename." : "Ní cheadaítear \"{char}\" taobh istigh d'ainm comhaid.",
    "\"{segment}\" is a reserved name and not allowed for folder names." : "Is ainm curtha in áirithe é \"{segment}\" agus ní cheadaítear é d'ainmneacha fillteán.",
    ...
    "Folder names must not end with \"{extension}\"." : "Ní féidir ainmneacha fillteán a chríochnú le \"{extension}\".",
    "Filenames must not end with \"{extension}\"." : "Níor cheart go gcríochnaíonn comhaid chomhad le \"{extension}\".",
    "Invalid folder name." : "Ainm fillteáin neamhbhailí.",
