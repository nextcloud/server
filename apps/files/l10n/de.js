OC.L10N.register(
    ...
    "No read permission on file." : "Keine Leseberechtigung für die Datei.",
    "Accept" : "Annehmen",
    "Reject" : "Ablehnen",
    ...
    "When disabled, the option to download will be hidden" : "Wenn deaktiviert, wird die Option zum Herunterladen ausgeblendet",
    ...
    "You can trigger a rename of files with invalid filenames, this will be done in the background and may take some time." : "Du kannst eine Umbenennung von Dateien mit ungültigen Dateinamen starten. Dies geschieht im Hintergrund und kann einige Zeit dauern.",
    ...
    "Transfer \"{path}\"" : "\"{path}\" übertragen",
    "Select file or folder" : "Datei oder Ordner auswählen",
    "Transfer" : "Übertragen",
    "Transfer {path} to {userid}" : "Übertrage {path} an {userid}",
    "Error while opening file picker for transfer ownership" : "Fehler beim Öffnen der Dateiauswahl zur Übertragung der Eigentumsrechte",
    ...
    "Error while sending ownership transfer request" : "Fehler beim Senden der Eigentumsübertragungsanfrage",
    "Transfer ownership of a file or folder" : "Besitz einer Datei oder eines Ordners übertragen",
    "File or folder to transfer" : "Zu übertragende Datei oder Ordner",
    "No file or folder selected" : "Keine Datei oder Ordner ausgewählt",
    "New owner" : "Neuer Besitzer",
    "You need to select a file or folder to transfer ownership." : "Du musst eine Datei oder einen Ordner auswählen, um die Eigentumsrechte zu übertragen.",
    "You need to select a new owner for the file or folder." : "Du musst einen neuen Besitzer für die Datei oder den Ordner auswählen.",
    ...
    "Upload cancelled, drop the files again to retry" : "Hochladen abgebrochen, die Dateien erneut fallen lassen, um es erneut zu versuchen.",
    ...
    "Invalid name for \"{path}\"" : "Ungültiger Name für \"{path}\"",
    ...
    "Folder name must not be empty." : "Ordnername darf nicht leer sein",
    "Filename must not be empty." : "Dateiname darf nicht leer sein.",
    "\"{char}\" is not allowed inside a folder name." : "\"{char}“ ist innerhalb eines Ordnernamens nicht zulässig.",
    "\"{char}\" is not allowed inside a filename." : "\"{char}\" ist innerhalb eines Dateinamens nicht zulässig.",
    "\"{segment}\" is a reserved name and not allowed for folder names." : "\"{segment}\" ist ein reservierter Name und für Ordnernamen nicht zulässig.",
    ...
    "Folder names must not end with \"{extension}\"." : "Ordnernamen dürfen nicht mit \"{extension}\" enden.",
    "Filenames must not end with \"{extension}\"." : "Dateinamen dürfen nicht mit \"{extension}\" enden.",
    "Invalid folder name." : "Ungültiger Ordnernamen",
