OC.L10N.register(
    ...
    "Delete files" : "刪除檔案",
    "Download files" : "下載檔案",
    "When disabled, the option to download will be hidden" : "停用後，將會隱藏下載的選項",
    "View files" : "檢視檔案",
    "Edit files" : "編輯檔案",
    ...
    "Warn before deleting a file" : "刪除檔案前警告",
    "WebDAV URL" : "WebDAV URL",
    "Create an app password" : "建立應用程式密碼",
    "Required for WebDAV authentication because Two-Factor Authentication is enabled for this account." : "因為此帳號已啟用雙重驗證，故需進行 WebDAV 驗證。",
    ...
    "Failed to start filename sanitization." : "啟動檔案名稱消毒流程失敗。",
    ...
    "Windows filename support has been enabled." : "已啟用 Windows 檔案名稱支援。",
    "While this blocks users from creating new files with unsupported filenames, existing files are not yet renamed and thus still may break sync on Windows." : "雖然此設定可阻止使用者建立名稱不符合規範的新檔案，但若有尚未更名的既有檔案，在 Windows 系統上仍可能導致同步功能失效。",
    "You can trigger a rename of files with invalid filenames, this will be done in the background and may take some time." : "您可以觸發對名稱無效的檔案進行重新命名，此操作將在背景執行，可能需要一段時間。",
    "Please note that this may cause high workload on the sync clients." : "請注意，此操作可能會導致同步客戶端的工作負載過高。",
    "Limit" : "限制",
    "This allows to configure how many users should be processed in one background job run." : "此設定可決定單次背景工作執行中應處理多少使用者。",
    ...
    "Transfer \"{path}\"" : "轉移「{path}」",
    "Select file or folder" : "選取檔案或資料夾",
    "Transfer" : "轉移",
    "Transfer {path} to {userid}" : "轉移 {path} 給 {userid}",
    "Error while opening file picker for transfer ownership" : "開啟轉移所有權用的檔案挑選程式時發生錯誤",
    "Error while searching for users" : "搜尋使用者時發生錯誤",
    ...
    "Error while sending ownership transfer request" : "傳送所有權轉移請求時發生錯誤",
    "Transfer ownership of a file or folder" : "轉移檔案或是資料夾的所有權",
    "File or folder to transfer" : "要轉移的檔案或資料夾",
    "No file or folder selected" : "未選取檔案或資料夾",
    "New owner" : "新的擁有者",
    "You need to select a file or folder to transfer ownership." : "您必須選取要轉移所有權的檔案或資料夾。",
    "You need to select a new owner for the file or folder." : "您必須選取檔案或資料夾的新擁有者。",
    "Keep {old}" : "保留 {old}",
    ...
    "Upload cancelled, drop the files again to retry" : "已取消上傳，請再次拖放檔案以重試",
    ...
    "Invalid name for \"{path}\"" : "無效的「{path}」名稱",
    ...
    "Folder name must not be empty." : "資料夾名稱不能為空。",
    "Filename must not be empty." : "檔案名稱不能為空。",
    "\"{char}\" is not allowed inside a folder name." : "資料夾名稱不允許出現「{char}」。",
    "\"{char}\" is not allowed inside a filename." : "檔案名稱中不允許出現「{char}」",
    "\"{segment}\" is a reserved name and not allowed for folder names." : "「{segment}」是保留名稱，不允許用在資料夾名稱。",
    ...
    "Folder names must not end with \"{extension}\"." : "資料夾名稱不能以「{extension}」結尾。",
