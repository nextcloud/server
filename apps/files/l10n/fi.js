OC.L10N.register(
    ...
    "No read permission on file." : "Ei oikeutta tiedoston lukemiseen.",
    "Accept" : "Hyväksy",
    "Reject" : "Hylkää",
    ...
    "Your ownership transfer of {path} was denied by {user}." : "Omistajuussiirtosi kohteen {path} osalta estettiin käyttäjän {user} toimesta.",
    ...
    "in %s" : "polussa %s",
    "Transferred from %1$s on %2$s" : "Siirretty käyttäjältä %1$s %2$s",
    "Create files" : "Luo tiedostoja",
    "Delete files" : "Poista tiedostot",
    "Download files" : "Lataa tiedostoja",
    "When disabled, the option to download will be hidden" : "Kun pois päältä, latausvalinta piilotetaan",
    "View files" : "Katsele tiedostoja",
    "Edit files" : "Muokkaa tiedostoja",
    ...
    "{displayName} (unavailable)" : "{displayName} (ei saatavilla)",
    ...
    "Videos" : "Videot",
    "Filters" : "Suodattimet",
    "Back to filters" : "Takaisin suodattimiin",
    "Appearance" : "Ulkoasu",
    ...
    "Transfer \"{path}\"" : "Siirrä \"{path}\"",
    "Select file or folder" : "Valitse tiedosto tai kansio",
    "Transfer" : "Siirrä",
    ...
    "File or folder to transfer" : "Siirrettävä tiedosto tai kansio",
    "No file or folder selected" : "Tiedostoa tai kansiota ei ole valittu",
    "New owner" : "Uusi omistaja",
    "You need to select a new owner for the file or folder." : "Valitse uusi omistaja tiedostolle tai kansiolle.",
    "Keep {old}" : "Pidä {old}",
    ...
    "Rename file to hidden" : "Nimeä tiedosto uudelleen piilotetuksi",
    "Prefixing a filename with a dot may render the file hidden." : "Pisteen asettaminen tiedostonimen etuliitteeksi saattaa tehdä tiedostosta piilotetun. ",
    "Are you sure you want to rename the file to \"{filename}\"?" : "Haluatko varmasti antaa tiedostolle nimeksi \"{filename}\"?",
    "Cancel" : "Peruuta",
    ...
    "_Moving %n file to \"{destination}\" …_::_Moving %n files to \"{destination}\" …_" : ["Siirretään %n tiedosto kohteeseen \"{destination}\" …","Siirretään %n tiedostoa kohteeseen \"{destination}\" …"],
    "Copying \"{source}\" to \"{destination}\" …" : "Kopioidaan \"{source}\" kohteeseen \"{destination}\" …",
    "_Copying %n file to \"{destination}\" …_::_Copying %n files to \"{destination}\" …_" : ["Kopioidaan %n tiedosto kohteeseen \"{destination}\" …","Kopioidaan %n tiedostoa kohteeseen \"{destination}\" …"],
    ...
    "Details" : "Tiedot",
    "Open the details sidebar" : "Avaa yksityiskohtien sivupalkki",
    ...
    "\"{char}\" is not allowed inside a folder name." : "\"{char}\" ei ole sallittu kansion nimessä.",
    "\"{char}\" is not allowed inside a filename." : "\"{char}\" ei ole sallittu tiedoston nimessä.",
    "\"{segment}\" is a reserved name and not allowed for folder names." : "\"{segment}\" on varattu nimi, eikä se oli sallittu nimi kansioille.",
    ...
    "Folder names must not end with \"{extension}\"." : "Kansioiden nimet eivät voi päättyä \"{extension}\".",
    ...
    "Unable to change the favorite state of the file" : "Tiedoston suosikkitilan vaihtaminen epäonnistui",
