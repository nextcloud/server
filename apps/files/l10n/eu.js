OC.L10N.register(
    ...
    "No read permission on file." : "Ez dago fitxategia irakurtzeko baimenik.",
    "Accept" : "Onartu",
    "Reject" : "Ukatu",
    ...
    "Create files" : "Sortutako fitxategiak",
    "Delete files" : "Ezabatu fitxategiak",
    "Download files" : "Deskargatu fitxategiak",
    "When disabled, the option to download will be hidden" : "Desgaituta dagoenean, deskargatzeko aukera ezkutatu egingo da",
    "View files" : "Ikusi fitxategiak",
    "Edit files" : "Editatu fitxategiak",
    ...
    "{displayName} (unavailable)" : "{displayName} (ez erabilgarria)",
    ...
    "Recently created" : "Duela gutxi sortuak",
    "Folder" : "Karpeta",
    ...
    "Transfer \"{path}\"" : "Igorri \"{path}\"",
    "Select file or folder" : "Hautatu fitxategia edo karpeta",
    "Transfer" : "Transferitu",
    "Transfer {path} to {userid}" : "Transfereritu {path}  {userid} erabiltzaileari",
    "Error while opening file picker for transfer ownership" : "Errore bat gertatu da jabetza transferitzeko fitxategi-hautatzailea irekitzean",
    ...
    "Error while sending ownership transfer request" : "Errore bat gertatu da jabetza transferitzeko eskaera bidaltzean",
    "Transfer ownership of a file or folder" : "Transferitu fitxategiaren edo karpetaren jabetza",
    "File or folder to transfer" : "Transferitzeko fitxategia edo karpeta",
    "No file or folder selected" : "Ez da fitxategirik edo karpetarik hautatu",
    "New owner" : "Jabe berria",
    "You need to select a file or folder to transfer ownership." : "Fitxategi edo karpeta bat hautatu behar duzu jabetza transferitzeko.",
    "You need to select a new owner for the file or folder." : "Fitxategi edo karpetarako jabe berri bat hautatu behar duzu.",
    ...
    "Prefixing a filename with a dot may render the file hidden." : "Fitxategi-izenaren aurretik puntu bat jartzeak fitxategia ezkutatu dezake.",
    ...
    "_Moving %n file to \"{destination}\" …_::_Moving %n files to \"{destination}\" …_" : ["Fitxategi %n\"{destination}\"-ra eramaten…","%n fitxategi \"{destination}\"-ra eramaten…"],
    "Copying \"{source}\" to \"{destination}\" …" : " \"{source}\" \"{destination}\"-ra kopiatzen …",
    "_Copying %n file to \"{destination}\" …_::_Copying %n files to \"{destination}\" …_" : ["Fitxategi %n \"{destination}\"-ra kopiatzen...","%n fitxategi \"{destination}\"-ra kopiatzen..."],
    ...
    "Details" : "Xehetasunak",
    "Open the details sidebar" : "Ireki zehetasunen alboko barra",
    ...
    "In folder" : "Karpetan",
    "Pick folder to search in" : "Aukeratu bilatu nahi duzun karpeta",
    ...
    "Folder name must not be empty." : "Karpetaren izenak ez du hutsik egon behar.",
    "Filename must not be empty." : "Fitxategi-izenak ez du hutsik egon behar.",
    "\"{char}\" is not allowed inside a folder name." : "\"{char}\" ez da onartzen karpeta-izen baten barruan.",
    "\"{char}\" is not allowed inside a filename." : "\"{char}\" ez da onartzen fitxategi-izen baten barruan.",
    "\"{segment}\" is a reserved name and not allowed for folder names." : "\"{segment}\" izen erreserbatua da eta ez da onartzen karpeta-izenetan.",
    ...
    "Folder names must not end with \"{extension}\"." : "Karpeta-izenak ez dira \"{extension}\"-ekin amaitu behar.",
