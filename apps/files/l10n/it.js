OC.L10N.register(
    ...
    "{newName} already exists." : "{newName} esiste già.",
    "\"{segment}\" is not allowed inside a filename." : "\"{segment}\" non è consentito in un nome di file.",
    "\"{segment}\" is a forbidden file or folder name." : "\"{segment}\" è un nome vietato per file o cartelle.",
    "\"{segment}\" is not an allowed filetype." : "\"{segment}\" non è un tipo di file consentito.",
