OC.L10N.register(
    ...
    "Limit must be a positive integer." : "Il limite deve essere un numero intero positivo.",
    "The replacement character may only be a single character." : "Il carattere sostitutivo può essere un solo carattere.",
    "Filename sanitization already started." : "La sanificazione del nome file è già iniziata.",
    "No filename sanitization in progress." : "Nessuna sanificazione del nome file in corso.",
    ...
    "Share" : "Condividi",
    "Reload content" : "Ricarica il contenuto",
    ...
    "Create an app password" : "Crea una nuova password di applicazione",
    "Required for WebDAV authentication because Two-Factor Authentication is enabled for this account." : "Richiesto per l'autenticazione WebDAV perché l'autenticazione a due fattori è abilitata per questo account.",
    ...
    "Failed to start filename sanitization." : "Impossibile avviare la sanificazione del nome file.",
    ...
    "Sanitization errors" : "Errori di sanificazione",
    "Not sanitized filenames" : "Nomi di file non sanificati",
    "Windows filename support has been enabled." : "È stato abilitato il supporto per i nomi file di Windows.",
    "While this blocks users from creating new files with unsupported filenames, existing files are not yet renamed and thus still may break sync on Windows." : "Sebbene ciò impedisca agli utenti di creare nuovi file con nomi non supportati, i file esistenti non sono ancora stati rinominati e pertanto potrebbero comunque interrompere la sincronizzazione su Windows.",
    "You can trigger a rename of files with invalid filenames, this will be done in the background and may take some time." : "È possibile attivare la rinomina dei file con nomi non validi; questa operazione verrà eseguita in background e potrebbe richiedere del tempo.",
    "Please note that this may cause high workload on the sync clients." : "Si prega di notare che ciò potrebbe causare un carico di lavoro elevato sui client di sincronizzazione.",
    "Limit" : "Limite",
    "This allows to configure how many users should be processed in one background job run." : "Ciò consente di configurare quanti utenti devono essere elaborati in un'esecuzione di un processo in background.",
    ...
    "Save as {displayName}" : "Salva come {displayName}",
    "Save as …" : "Salva come …",
    ...
    "The file should now open on your device. If it doesn't, please check that you have the desktop app installed." : "Il file dovrebbe ora aprirsi sul tuo dispositivo. In caso contrario, controlla di aver installato l'applicazione desktop.",
    "Retry and close" : "Riprova e chiudi",
    "Open online" : "Apri online",
    "Rename" : "Rinomina",
    "Details" : "Dettagli",
    "Open the details sidebar" : "Apri la barra laterale dei dettagli",
    ...
    "Move cancelled" : "Spostamento annullato",
