OC.L10N.register(
    ...
    "You renamed {oldfile} to {newfile}" : "Jūs {oldfile} pervadinote į {newfile}",
    ...
    "You moved {oldfile} to {newfile}" : "Jūs {oldfile} perkelėte į {newfile}",
    ...
    "No read permission on file." : "Failui nesuteikta skaitymo teisė.",
    "Accept" : "Priimti",
    "Reject" : "Atmesti",
    ...
    "Your ownership transfer of {path} to {user} failed." : "Nepavyko perduoti jūsų {path} nuosavybės vartotojui {user}.",
    "The ownership transfer of {path} from {user} failed." : "{path} nuosavybės perdavimas iš vartotojo {user} nepavyko.",
    "Ownership transfer done" : "Nuosavybės perdavimas atliktas",
    "Your ownership transfer of {path} to {user} has completed." : "Jūsų {path} nuosavybės perdavimas vartotojui {user} užbaigtas.",
    "The ownership transfer of {path} from {user} has completed." : "{path} nuosavybės perdavimas iš vartotojo {user} užbaigtas.",
    "in %s" : "pо %s",
    "Transferred from %1$s on %2$s" : "Perkelta iš %1$s į %2$s",
    "Create files" : "Sukurti failus",
    "Delete files" : "Ištrinti failus",
    "Download files" : "Atsisiųsti failus",
    "When disabled, the option to download will be hidden" : "Kai ši parinktis išjungta, atsisiuntimo galimybė bus paslėpta.",
    "View files" : "Peržiūrėti failus",
    ...
    "{displayName} (unavailable)" : "{displayName} (neprieinama)",
    ...
    "Custom date range" : "Pasirinktinės datų ribos",
    ...
    "Select a range" : "Pasirinkite ribas",
    "Navigation" : "Naršymas",
    ...
    "Currently {processedUsers} of {totalUsers} accounts are already processed." : "Šiuo metu {processedUsers} vartotojų paskyros iš {totalUsers} egzistuojančių jau apdorotos.",
    "Preparing …" : "Ruošiama…",
    ...
    "Transfer \"{path}\"" : "Perkelti „{path}“",
    "Select file or folder" : "Pasirinkite failą arba aplanką",
    "Transfer" : "Perduoti",
    "Transfer {path} to {userid}" : "Perduoti {path} vartotojui {userid}",
    "Error while opening file picker for transfer ownership" : "Klaida atidarant failų pasirinkimo langą, skirtą nuosavybės teisių perdavimui",
    "Error while searching for users" : "Klaida ieškant vartotojų",
    ...
    "Error while sending ownership transfer request" : "Klaida siunčiant prašymą dėl nuosavybės teisių perdavimo",
    "Transfer ownership of a file or folder" : "Perduoti failo ar aplanko nuosavybę",
    "File or folder to transfer" : "Perkeliamas failas arba aplankas",
    "No file or folder selected" : "Nėra pasirinktas joks failas ar aplankas",
    "New owner" : "Naujasis savininkas",
    "You need to select a file or folder to transfer ownership." : "Norėdami perleisti nuosavybės teises, turite pasirinkti failą arba aplanką.",
    "You need to select a new owner for the file or folder." : "Turite pasirinkti naują failo arba aplanko savininką.",
    ...
    "Upload was cancelled by user" : "Vartotojas atsisakė failo išsiuntimo",
    ...
    "Delete" : "Ištrinti",
    "Leave this share" : "Palikti šį bendrinimą",
    ...
    "Folder name must not be empty." : "Aplanko pavadinimas negali būti tuščias.",
    "Filename must not be empty." : "Failo pavadinimas negali būti tuščias.",
    "\"{char}\" is not allowed inside a folder name." : "Aplanko pavadinime negali būti „{char}“.",
    "\"{char}\" is not allowed inside a filename." : "\"{char}\" simbolis failo pavadinime neleidžiamas",
    "\"{segment}\" is a reserved name and not allowed for folder names." : "„{segment}“ yra rezervuotas pavadinimas, kurio negalima naudoti aplankų pavadinimams.",
    ...
    "Folder names must not end with \"{extension}\"." : "Aplankų pavadinimai negali baigtis „{extension}“.",
