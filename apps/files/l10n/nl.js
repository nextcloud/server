OC.L10N.register(
    ...
    "Keep {oldextension}" : "Behoud {oldextension}",
    "Use {newextension}" : "Gebruik {newextension}",
    ...
    "Direct link was copied (only works for users who have access to this file/folder)" : "Directe link is gekopieerd (werkt alleen voor gebruikers met toegang tot map/bestand)",
    "Path" : "Pad",
    ...
    "{newName} already exists." : "{newName} bestaat al.",
    "\"{segment}\" is not allowed inside a filename." : "\"{segment}\" is niet toegestaan in een bestandsnaam.",
    "\"{segment}\" is a forbidden file or folder name." : "\"{segment}\" is een verboden bestands- of mapnaam.",
    "\"{segment}\" is not an allowed filetype." : "\"{segment}\" is geen toegestaan bestandstype.",
    "Filenames must not end with \"{segment}\"." : "Bestandsnamen mogen niet eindigen met \"{segment}\".",
    ...
    "You might not have have permissions to view it, ask the sender to share it" : "Je hebt mogelijk geen machtigingen om dit te bekijken. Vraag de verzender om het met je te delen.",
    "The files is locked" : "Het bestand is vergrendeld.",
