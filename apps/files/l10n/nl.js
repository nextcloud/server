OC.L10N.register(
    ...
    "No read permission on file." : "Geen leesrechten voor bestand.",
    "Accept" : "Accepteren",
    "Reject" : "Afwijzen",
    ...
    "Create files" : "Bestanden aanmaken",
    "Delete files" : "Verwijder bestanden",
    "Download files" : "Bestanden downloaden",
    "When disabled, the option to download will be hidden" : "Indien uitgeschakeld, dan wordt de download mogelijkheid verborgen",
    ...
    "Folder name" : "Mapnaam",
    "{displayName} (unavailable)" : "{displayName} (niet beschikbaar)",
    ...
    "Refresh" : "Verversen",
    "All files have been santized for Windows filename support." : "Alle bestanden zijn opgeschoond voor Windows bestandsnaam ondersteuning.",
    ...
    "Transfer \"{path}\"" : "Draag over \"{path}\"",
    "Select file or folder" : "Kies bestand of map",
    "Transfer" : "Overdragen",
    "Transfer {path} to {userid}" : "Draag {path} over aan {userid}",
    "Error while opening file picker for transfer ownership" : "Fout tijdens het open van de bestandskiezer voor eigendomsoverdracht",
    ...
    "Error while sending ownership transfer request" : "Fout tijdens het versturen van eigendomsoverdracht verzoek",
    "Transfer ownership of a file or folder" : "Overdragen eigendom bestand of map ",
    "File or folder to transfer" : "Bestand of map om over te dragen",
    "No file or folder selected" : "Geen bestand of map geselecteerd",
    "New owner" : "Nieuwe eigenaar",
    "You need to select a file or folder to transfer ownership." : "Je moet een bestand of map kiezen om eigenaarschap over te dragen",
    "You need to select a new owner for the file or folder." : "Je moet een nieuwe eigenaar kiezen voor het bestand of map",
    "Keep {old}" : "Bewaar {old}",
    ...
    "Delete and unshare" : "Verwijder en nietmeer delen ",
    ...
    "\"{char}\" is not allowed inside a folder name." : "\"{char}\" is niet toegestaan in een mapnaam.",
    "\"{char}\" is not allowed inside a filename." : "\"{char}\"is niet toegestaan in een bestandsnaam",
    "\"{segment}\" is a reserved name and not allowed for folder names." : "\"{segment}\" is een gereserveerde naam en niet toegestaan voor mapnamen.",
    ...
    "Folder names must not end with \"{extension}\"." : "Mapnamen mogen niet eindigen op \"{extension}\".",
