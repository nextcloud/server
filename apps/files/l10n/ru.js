OC.L10N.register(
    ...
    "No read permission on file." : "Нет прав для чтения файла.",
    "Accept" : "Принять",
    "Reject" : "Отклонить",
    ...
    "When disabled, the option to download will be hidden" : "При отключении, будет скрыта кнопка скачивания",
    ...
    "Videos" : "Видео",
    "Filters" : "Фильтры",
    "Back to filters" : "Вернуться к фильтрам",
    ...
    "Details" : "Подробно",
    "Open the details sidebar" : "Открыть боковую панель с подробными сведениями",
    ...
    "The name \"{newName}\" is already used in the folder \"{dir}\". Please choose a different name." : "Имя «{newName}» уже используется в папке «{dir}». Выберите другое имя.",
    ...
    "\"{char}\" is not allowed inside a folder name." : "Символ \"{char}\" недопустим в названии папки.",
    "\"{char}\" is not allowed inside a filename." : "не допускается внутри имени файла.",
    "\"{segment}\" is a reserved name and not allowed for folder names." : "\"{segment}\" является зарезервированным именем и не допускается для имён папок.",
    ...
    "Folder names must not end with \"{extension}\"." : "Имена папок не должны заканчиваться на \"{extension}\".",
