OC.L10N.register(
    ...
    "No filename sanitization in progress." : "Brak trwającego procesu oczyszczania nazw plików.",
    ...
    "Create files" : "Twórz pliki",
    "Delete files" : "Usuń pliki",
    "Download files" : "Pobieraj pliki",
    "When disabled, the option to download will be hidden" : "Po wyłączeniu tej opcji możliwość pobierania zostanie ukryta",
    "View files" : "Wyświetlaj pliki",
    ...
    "{displayName} (unavailable)" : "{displayName} (niedostępny)",
    ...
    "Transfer \"{path}\"" : "Przenieś \"{path}\"",
    "Select file or folder" : "Wybierz plik lub folder",
    "Transfer" : "Przenieś",
    "Transfer {path} to {userid}" : "Przenieś {path} do {userid}",
    "Error while opening file picker for transfer ownership" : "Błąd podczas otwierania wyboru pliku do przeniesienia własności",
    ...
    "Error while sending ownership transfer request" : "Błąd podczas wysyłania żądania przeniesienia własności",
    "Transfer ownership of a file or folder" : "Przenieś własność pliku lub katalogu",
    "File or folder to transfer" : "Plik lub folder do przeniesienia",
    "No file or folder selected" : "Nie wybrano pliku ani folderu",
    "New owner" : "Nowy właściciel",
    "You need to select a file or folder to transfer ownership." : "Musisz wybrać plik lub folder, aby przenieść własność.",
    "You need to select a new owner for the file or folder." : "Musisz wybrać nowego właściciela dla pliku lub folderu.",
