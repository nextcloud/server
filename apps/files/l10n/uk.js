OC.L10N.register(
    ...
    "Target folder \"{dir}\" does not exist any more" : "Каталог призначення \"{dir}\" більше не існує.",
    ...
    "Target folder does not exist any more" : "Каталогу призначення більше не існує",
    ...
    "Leave this share" : "Залишити елемент, яким поділилися",
    ...
    "Size" : "Розмір",
    "Modified" : "Змінено",
    "_%n folder_::_%n folders_" : ["%n тека ","теки : %n ","теки : %n ","каталоги: %n "],
    ...
    "Select file range" : "Виберіть файли",
    "{used}%" : "{used}%",
