OC.L10N.register(
    ...
    "No read permission on file." : "Відсутні права на читання файлу.",
    "Accept" : "Прийняти",
    "Reject" : "Відхилити",
    ...
    "Create files" : "Створювати файли",
    "Delete files" : "Вилучити файли",
    "Download files" : "Звантажувати файли",
    "When disabled, the option to download will be hidden" : "Якщо вимкнено, параметр для звантаження файлів буде приховано",
    "View files" : "Переглядати файли",
    ...
    "{displayName} (unavailable)" : "{displayName} (недоступно)",
    ...
    "Enable folder tree view" : "Увімкнути показ дерева каталогів",
    ...
    "Go to parent folder" : "Перейти до батьківського каталогу",
    ...
    "Transfer \"{path}\"" : "Передати \"{path}\"",
    "Select file or folder" : "Виберіть файл або каталог",
    "Transfer" : "Передати",
    "Transfer {path} to {userid}" : "Передати {path} користувачеві {userid}",
    "Error while opening file picker for transfer ownership" : "Помилка під час відкриття вибору файлу для передачі права власности",
    "Error while searching for users" : "Помилка під час пошуку користувачів",
    ...
    "Error while sending ownership transfer request" : "Помилка під час надсилання запиту на передачу права власности",
    "Transfer ownership of a file or folder" : "Передавання прав власника на файл або каталог",
    "File or folder to transfer" : "Файл або каталог для передачі",
    "No file or folder selected" : "Файл або каталог не вибрано",
    "New owner" : "Новий власник",
    "You need to select a file or folder to transfer ownership." : "Потрібно вибрати файл або каталог для передачі права власности",
    "You need to select a new owner for the file or folder." : "Потрібно вибрати нового власника для файлу або каталогу",
    ...
    "Details" : "Докладно",
    "Open the details sidebar" : "Відкрити бічну панель з деталями",
    ...
    "This folder is unavailable, please try again later or contact the administration" : "Цей каталог недоступний, спробуйте пізніше або зверніться до адміністратора.",
    ...
    "Folder name must not be empty." : "Ім'я каталогу не може бути порожнє",
    "Filename must not be empty." : "Імена файлів не мають бути порожні.",
    "\"{char}\" is not allowed inside a folder name." : "\"{char}\" не дозволено всередині імени каталогу.",
    "\"{char}\" is not allowed inside a filename." : "Символ \"{char}\" не дозволено у імені файлу.",
    "\"{segment}\" is a reserved name and not allowed for folder names." : "\"{segment}\" є зарезервованим ім'ям і не дозволено і імені каталогу.",
    ...
    "Folder names must not end with \"{extension}\"." : "Ім'я каталогу не може закінчуватися на \"{extension}\".",
    "Filenames must not end with \"{extension}\"." : "Імена файлів не мають закінчуватися на \"{extension}\".",
    "Invalid folder name." : "Недійсне ім'я каталогу.",
