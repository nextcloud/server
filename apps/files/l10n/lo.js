OC.L10N.register(
    ...
    "No filename sanitization in progress." : "No filename sanitization in progress.",
    ...
    "Show hidden files" : "ສະແດງຟາຍທີ່ເຊື່ອງໄວ້",
    ...
    "_%n file could not be converted_::_%n files could not be converted_" : ["%n files could not be converted"],
    "_%n file converted_::_%n files converted_" : ["%n files converted"],
    ...
    "_You are about to permanently delete {count} item_::_You are about to permanently delete {count} items_" : ["You are about to permanently delete {count} items"],
    "_You are about to delete {count} item_::_You are about to delete {count} items_" : ["You are about to delete {count} item"],
    ...
    "Some files could not be moved" : "ບາງຟາຍບໍ່ສາມາດເຄື່ອນຍ້າຍໄດ້",
    ...
    "_%n file_::_%n files_" : ["%n files"],
    "_%n folder_::_%n folders_" : ["%n folders"],
    "_%n hidden_::_%n hidden_" : ["%n hidden"],
    ...
    "No favorites yet" : "ຍັງບໍ່ມີລາຍການທີ່ມັກເທື່ຶຶອ",
