OC.L10N.register(
    ...
    "\"{segment}\" is not allowed inside a filename." : "\"{segment}\" er ikke tilladt i et filnavn.",
    "\"{segment}\" is a forbidden file or folder name." : "\"{segment}\" er et forbudt fil- eller mappenavn.",
    "\"{segment}\" is not an allowed filetype." : "\"{segment}\" er ikke en tilladt filtype.",
    "Filenames must not end with \"{segment}\"." : "Filnavne skal ende med \"{segment}\".",
