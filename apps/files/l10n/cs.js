OC.L10N.register(
    ...
    "Folder name must not be empty." : "Složku je třeba nějak nazvat.",
    "Filename must not be empty." : "Je třeba vyplnit název souboru.",
    "\"{char}\" is not allowed inside a folder name." : "„{char}“ není povolený znak v názvu složky.",
    "\"{char}\" is not allowed inside a filename." : "„{char}“ není v názvu souboru možné použít.",
    "\"{segment}\" is a reserved name and not allowed for folder names." : "„{segment}“ je vyhrazeným názvem a není povoleno k použití pro názvy složek.",
    ...
    "Folder names must not end with \"{extension}\"." : "Názvy složek nemohou končit na „{extension}“.",
