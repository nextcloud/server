OC.L10N.register(
    ...
    "You need to select a file or folder to transfer ownership." : "Pro převod vlastnictví musíte vybrat soubor nebo složku.",
    "You need to select a new owner for the file or folder." : "Musíte vybrat nového vlastníka souboru nebo složky.",
    ...
    "_Copying %n file to \"{destination}\" …_::_Copying %n files to \"{destination}\" …_" : ["Kopárování %n souboru do \"{destination}\" …","Kopírování %n souborů do \"{destination}\" …","Kopírování %n souborů do \"{destination}\" …","Kopírování %n souborů do \"{destination}\" …"],
