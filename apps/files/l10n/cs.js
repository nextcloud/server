OC.L10N.register(
    ...
    "No read permission on file." : "Chybí oprávnění číst soubor.",
    "Accept" : "Přijmout",
    "Reject" : "Odmítnout",
    ...
    "Create files" : "Vytvořit soubory",
    "Delete files" : "Smazat soubory",
    "Download files" : "Stáhnout soubory",
    "When disabled, the option to download will be hidden" : "Pokud vypnuto, bude možnost stahovat soubory skryta",
    ...
    "{displayName} (unavailable)" : "{displayName} (nedostupné)",
    ...
    "Videos" : "Videa",
    "Filters" : "Filtry",
    "Back to filters" : "Zpět na filtry",
    "Appearance" : "Vzhled",
    ...
    "Select file or folder" : "Vyberte soubor nebo složku",
    "Transfer" : "Převést",
    "Transfer {path} to {userid}" : "Převést {path} na {userid}",
    "Error while opening file picker for transfer ownership" : "Chyba při otevírání výběru souborů pro převod vlastnictví",
    ...
    "Error while sending ownership transfer request" : "Chyba při odesílání žádosti o převod vlastnictví",
    "Transfer ownership of a file or folder" : "Převést vlastnictví souboru či složky",
    "File or folder to transfer" : "Soubor nebo složka k převodu",
    "No file or folder selected" : "Nebyl vybrán žádný soubor ani složka",
    "New owner" : "Nový vlastník",
    "You need to select a file or folder to transfer ownership." : "Pro převod vlastnictví je třeba vybrat soubor nebo složku.",
    "You need to select a new owner for the file or folder." : "Je třeba vybrat nového vlastníka souboru nebo složky.",
    ...
    "File list is reloading" : "Seznam souborů je načítán",
    ...
    "_Moving %n file to \"{destination}\" …_::_Moving %n files to \"{destination}\" …_" : ["Přesouvání %n souboru do „{destination}“ …","Přesouvání %n souborů do „{destination}“ …","Přesouvání %n souborů do „{destination}“ …","Přesouvání %n souborů do „{destination}“ …"],
    "Copying \"{source}\" to \"{destination}\" …" : "Kopírování „{source}“ do „{destination}“ …",
    "_Copying %n file to \"{destination}\" …_::_Copying %n files to \"{destination}\" …_" : ["Kopírování %n souboru do „{destination}“ …","Kopírování %n souborů do „{destination}“ …","Kopírování %n souborů do „{destination}“ …","Kopírování %n souborů do \"{destination}\" …"],
    ...
    "Folder name must not be empty." : "Jméno adresáře nesmí být prázdné.",
    "Filename must not be empty." : "Je třeba vyplnit název souboru.",
    "\"{char}\" is not allowed inside a folder name." : "\"{char}\" není povolený znak v názvu adresáře.",
    "\"{char}\" is not allowed inside a filename." : "„{char}“ není v názvu souboru možné použít.",
    "\"{segment}\" is a reserved name and not allowed for folder names." : "\"{segment}\" je vyhrazeným názvem a není povoleno k použití pro názvy adresářů.",
    ...
    "Folder names must not end with \"{extension}\"." : "Názvy složek nesmí končit \"{extension}\".",
