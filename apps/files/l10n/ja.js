OC.L10N.register(
    ...
    "Enter more than two characters to search in other folders" : "他のフォルダで検索するには、3文字以上を入力してください",
    "Name" : "名前",
    "Size" : "サイズ",
    "Modified" : "更新日時",
    ...
    "Group folder \"{mountPoint}\" is full, files can not be updated or synced anymore!" : "グループフォルダ ”{mountPoint}\" がいっぱいになり、ファイルを更新または同期できなくなりました。",
