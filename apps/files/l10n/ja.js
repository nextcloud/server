OC.L10N.register(
    ...
    "When disabled, the option to download will be hidden" : "無効にすると、ダウンロードオプションは非表示になります",
    "View files" : "ファイルを表示",
    "Edit files" : "ファイルを編集",
    ...
    "Transfer \"{path}\"" : "\"{path}\"を転送",
    "Select file or folder" : "ファイルまたはフォルダーを選択してください",
    "Transfer" : "転送",
    "Transfer {path} to {userid}" : "{path} を {userid} に転送する",
    "Error while opening file picker for transfer ownership" : "所有権の譲渡のためにファイルピッカーを開こうとした際にエラーが発生しました",
    ...
    "Error while sending ownership transfer request" : "所有権移転リクエストの送信中にエラーが発生しました",
    "Transfer ownership of a file or folder" : "ファイルまたはフォルダーの所有権を譲渡する",
    "File or folder to transfer" : "転送するファイルまたはフォルダー",
    "No file or folder selected" : "ファイルまたはフォルダーが選択されていません",
    "New owner" : "新しい所有者",
    "You need to select a file or folder to transfer ownership." : "所有権を移行するには、ファイルまたはフォルダーを選択する必要があります。",
    "You need to select a new owner for the file or folder." : "ファイルまたはフォルダーの新所有者を選択する必要があります。",
    "Keep {old}" : "{old} を保持",
    ...
    "Upload cancelled, drop the files again to retry" : "アップロードがキャンセルされました。ファイルを再度ドロップして、再試行してください。",
    ...
    "Invalid name for \"{path}\"" : "\"{path}\"の名前が無効です",
