OC.L10N.register(
    ...
    "\"remote account\"" : "Tài khoản trên mạng",
    ...
    "Enforce Windows compatibility" : "Thực thi khả năng tương thích của Windows",
    ...
    "Ownership transfer denied" : "Chuyển quyền sở hữu bị từ chối",
    "Your ownership transfer of {path} was denied by {user}." : "Chuyển quyền sở hữu của bạn đối với {path} bị từ chối bởi{user}.",
    ...
    "in %s" : "trong %s",
    "Transferred from %1$s on %2$s" : "Chuyển từ %1$s trên %2$s",
    ...
    "Toggle selection for file \"{displayName}\"" : "Chuyển đổi lựa chọn cho tập tin \"{displayName}\"",
    "Toggle selection for folder \"{displayName}\"" : "Chuyển đổi lựa chọn cho thư mục \"{displayName}\"",
    "File is loading" : "Tập tin đang được tải",
    "Folder is loading" : "Thư mục đang được tải",
    ...
    "Invalid filename." : "Tên file không hợp lệ.",
    ...
    "Name" : "Tên",
    "Size" : "Kích cỡ",
    "Toggle selection for all files and folders" : "Chuyển đổi lựa chọn cho toàn bộ tập tin và thư mục",
    ...
    "{count} selected" : "{count} đã chọn",
    "List of files and folders." : "Danh sách các tập tin và thư mục.",
    "Column headers with buttons are sortable." : "Tiêu đề cột có nút có thể sắp xếp được.",
    ...
    "Storage information" : "Thông tin lưu trữ",
    ...
    "Your storage is full, files can not be updated or synced anymore!" : "Bộ nhớ của bạn đã đầy, không thể cập nhật hoặc đồng bộ hóa các tập tin nữa!",
    "Create" : "Tạo",
    "New folder" : "Tạo thư mục",
    "Create new folder" : "Tạo thư mục mới",
    "This name is already in use." : "Tên đăng nhập đã được sử dụng",
    "Fill template fields" : "Thiết lập thư mục mẫu",
    "Submit" : "Gửi đi",
    ...
    "Upload was cancelled by user" : "Tải lên bị chặn bởi người dùng",
    ...
    "Filter filenames…" : "Lọc tên file…",
    "Views" : "Lượt xem",
    "Files settings" : "Cài đặt tệp tin",
    "File cannot be accessed" : "Không thể truy cập tập tin",
    "The file could not be found or you do not have permissions to view it. Ask the sender to share it." : "Không thể tìm thấy tệp hoặc bạn không có quyền xem tệp. Yêu cầu người gửi chia sẻ nó.",
    "Your files" : "Những file của bạn",
    "Open in files" : "Mở trong files",
    ...
    "\"{segment}\" is not allowed inside a filename." : "\"{segment}\" không được phép bên trong tên tệp.",
    "\"{segment}\" is a forbidden file or folder name." : "\"{segment}\" là tên tập tin hoặc thư mục bị cấm.",
    "\"{segment}\" is not an allowed filetype." : "\"{segment}\" không phải là loại file được cho phép.",
    "Filenames must not end with \"{segment}\"." : "Tên tệp không được phép kết thúc bởi \"{segment}\".",
