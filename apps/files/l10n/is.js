OC.L10N.register(
    ...
    "No read permission on file." : "Ekki eru lesheimildir á skrá.",
    "Accept" : "Samþykkja",
    "Reject" : "Hafna",
    ...
    "Create files" : "Búa til skrár",
    "Delete files" : "Eyða skrám",
    "Download files" : "Sækja skrár",
    "When disabled, the option to download will be hidden" : "Þegar þetta er óvirkt, verður valkosturinn til að sækja falinn",
    "View files" : "Skoða skrár",
    "Edit files" : "Breyta skrám",
    ...
    "{displayName} (unavailable)" : "{displayName} (ekki tiltæk)",
    ...
    "Transfer \"{path}\"" : "Yfirfæra \"{path}\"",
    "Select file or folder" : "Veldu skrá eða möppu",
    "Transfer" : "Færa",
    "Transfer {path} to {userid}" : "Færa {path} til {userid}",
    "Error while opening file picker for transfer ownership" : "Villa við að opna skráaval til að yfirfæra eignarhald",
    "Error while searching for users" : "Villa við leit að notendum",
    ...
    "Error while sending ownership transfer request" : "Villa við að senda beiðni um yfirfærslu eignarhalds",
    "Transfer ownership of a file or folder" : "Millifæra eignarhald skráar eða möppu",
    "File or folder to transfer" : "Skrá eða mappa til að yfirfæra",
    "No file or folder selected" : "Engin skrá eða mappa valin",
    "New owner" : "Nýr eigandi",
    "You need to select a file or folder to transfer ownership." : "Þú verður að velja skrá eða möppu til að yfirfæra eignarhald.",
    "You need to select a new owner for the file or folder." : "Þú verður að velja nýjan eiganda fyrir skrána eða möppuna.",
    "Keep {old}" : "Halda {old}",
    ...
    "_Moving %n file to \"{destination}\" …_::_Moving %n files to \"{destination}\" …_" : ["Færi %n skrá í \"{destination}\" …","Færi %n skrár í \"{destination}\" …"],
    "Copying \"{source}\" to \"{destination}\" …" : "Afrita \"{source}\" í \"{destination}\" …",
    "_Copying %n file to \"{destination}\" …_::_Copying %n files to \"{destination}\" …_" : ["Afrita %n skrá í \"{destination}\" …","Afrita %n skrár í \"{destination}\" …"],
    ...
    "Folder name must not be empty." : "Heiti möppu má ekki vera autt.",
    "Filename must not be empty." : "Skráarheiti má ekki vera tómt.",
    "\"{char}\" is not allowed inside a folder name." : "\"{char}\" er er ekki leyfilegt innan í möppuheiti.",
    "\"{char}\" is not allowed inside a filename." : "\"{char}\" er er ekki leyfilegt innan í skráarheiti.",
    "\"{segment}\" is a reserved name and not allowed for folder names." : "\"{segment}\" er frátekið heiti og er ekki leyft í möppuheitum.",
    ...
    "Folder names must not end with \"{extension}\"." : "Möppuheiti mega ekki enda á \"{extension}\".",
    "Filenames must not end with \"{extension}\"." : "Skráaheiti mega ekki enda á \"{extension}\".",
    "Invalid folder name." : "Ógilt heiti möppu.",
