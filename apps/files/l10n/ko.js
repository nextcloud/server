OC.L10N.register(
    ...
    "Limit must be a positive integer." : "한도는 양의 정수여야 합니다.",
    "The replacement character may only be a single character." : "대체 문자는 단일 문자가 될 수도 있습니다.",
    "Filename sanitization already started." : "파일 이름 검증이 이미 시작되었습니다.",
    "No filename sanitization in progress." : "파일 이름 검증 작업이 진행 중이 아닙니다.",
    ...
    "Recently created" : "최근에 만듦",
    "Folder" : "폴더",
    "Unknown file type" : "알 수 없는 파일 형식",
    "{ext} image" : "{ext} 이미지",
    "{ext} video" : "{ext} 동영상",
    "{ext} audio" : "{ext} 오디오",
    "{ext} text" : "{ext} 텍스트",
    ...
    "Enable folder tree view" : "폴더 트리 보기 활성화",
    "Default view" : "기본 보기",
    "All files" : "모든 파일",
    ...
    "Warn before deleting a file" : "파일 삭제 시 경고",
    "WebDAV URL" : "WebDAV URL",
    "Create an app password" : "앱 암호 만들기",
    "Required for WebDAV authentication because Two-Factor Authentication is enabled for this account." : "이 계정에는 2단계 인증이 활성화되어 있으므로 WebDAV 인증에 필요합니다.",
    ...
    "Size" : "크기",
    "Modified" : "수정됨",
    "{displayName}: failed on some elements" : "{displayName}: 일부 요소에서 실패",
    "{displayName}: done" : "{displayName}:  완료",
    "{displayName}: failed" : "{displayName}: 실패",
    "(selected)" : "(선택됨)",
    ...
    "Create" : "생성",
    "Files starting with a dot are hidden by default" : "이름이 점으로 시작하는 파일은 기본적으로 숨겨집니다.",
    "Failed to start filename sanitization." : "파일 이름 검증을 시작하는 데 실패했습니다.",
    "Failed to refresh filename sanitization status." : "파일 이름 검증 작업의 상태를 갱신하는 데 실패했습니다.",
    "Filename sanitization in progress." : "파일 이름 검증 작업이 진행중입니다.",
    "Currently {processedUsers} of {totalUsers} accounts are already processed." : "현재 {totalUsers}개 중 {processedUsers}개 계정이 처리되었습니다.",
    "Preparing …" : "준비중 …",
    "Refresh" : "새로 고침",
    "All files have been santized for Windows filename support." : "Windows 파일 이름 지원을 위해 모든 파일을 검증했습니다.",
    "Some files could not be sanitized, please check your logs." : "일부 파일을 검증하지 못했습니다, 로그를 확인해 주세요.",
    "Sanitization errors" : "검증 오류",
    "Not sanitized filenames" : "검증되지 않은 파일 이름",
    "Windows filename support has been enabled." : "Windows 파일 이름 지원이 활성화되었습니다.",
    "While this blocks users from creating new files with unsupported filenames, existing files are not yet renamed and thus still may break sync on Windows." : "이는 지원되지 않는 이름으로 사용자가 파일을 만들지 못하도록 하지만, 기존 파일들은 아직 이름이 바뀌지 않았으므로 Windows에서 동기화가 중단될 수 있습니다.",
    "You can trigger a rename of files with invalid filenames, this will be done in the background and may take some time." : "이름이 유효하지 않은 파일의 이름이 바뀌도록 할 수 있으며, 백그라운드에서 실행되고 다소 시간이 걸릴 수 있습니다.",
    "Please note that this may cause high workload on the sync clients." : "동기화된 클라이언트에게 높은 부하를 일으킬 수 있음을 알아 두세요.",
    "Limit" : "제한",
    "This allows to configure how many users should be processed in one background job run." : "백그라운드 작업을 한 번 실행했을 때 얼마나 많은 사용자가 처리되어야 할 지 설정할 수 있습니다.",
    "Sanitize filenames" : "파일 이름 검증",
    "(starting)" : "(시작중)",
    "Fill template fields" : "양식 입력란 채우기",
    "Submitting fields …" : "입력란 제출중...",
    "Submit" : "제출",
    "Choose a file or folder to transfer" : "이전할 파일이나 폴더 고르기",
    "Transfer \"{path}\"" : "\"{path}\" 전달",
    "Select file or folder" : "파일 또는 폴더 선택",
    "Transfer" : "이전",
    "Transfer {path} to {userid}" : "{path}을(를) {userid}에게 이전하기",
    "Error while opening file picker for transfer ownership" : "소유권을 이전하기 위해 파일 선택기를 여는 중 오류 발생",
    ...
    "Error while sending ownership transfer request" : "소유권 이전 요청을 보내는 중 오류 발생",
    "Transfer ownership of a file or folder" : "파일이나 폴더의 소유권 이전",
    "File or folder to transfer" : "이전할 파일 및 폴더",
    "No file or folder selected" : "파일이나 폴더가 선택되지 않음",
    "New owner" : "새 소유자",
    "You need to select a file or folder to transfer ownership." : "소유권을 이전하려면 파일이나 폴더를 선택해야 합니다.",
    "You need to select a new owner for the file or folder." : "파일 및 폴더의 새 주인을 선택해야 합니다.",
    "Keep {old}" : "{old} 보관",
    ...
    "Rename file to hidden" : "파일이 숨겨지도록 이름 변경",
    "Prefixing a filename with a dot may render the file hidden." : "파일 이름 앞에 점을 붙이면 파일이 숨겨질 수 있습니다.",
    "Are you sure you want to rename the file to \"{filename}\"?" : "파일 이름을 \"{filename}\"(으)로 변경하시겠습니까?",
    "Cancel" : "취소",
    "Rename" : "이름 바꾸기",
    ...
    "No search results for “{query}”" : "\"{query}\"에 대한 검색 결과 없음",
    "Search for files" : "파일 검색",
    ...
    "After enabling the Windows compatible filenames, existing files cannot be modified anymore but can be renamed to valid new names by their owner." : "Windows 호환 파일 이름 기능을 활성화하면 기존 파일은 더 이상 수정할 수 없지만, 파일 소유자는 유효한 새 이름으로 파일 이름을 변경할 수 있습니다.",
    "Failed to toggle Windows filename support" : "Windows 파일 이름 지원 상태를 변경하는 데 실패",
    ...
    "Save as …" : "… (으)로 저장",
    "Converting files …" : "파일 변환중 …",
    "Failed to convert files: {message}" : "파일 변환에 실패함:{message}",
    "All files failed to be converted" : "모든 파일이 변환에 실패했습니다.",
    "One file could not be converted: {message}" : "한 파일을 변환할 수 없습니다: {message}",
    "_%n file could not be converted_::_%n files could not be converted_" : ["%n개 파일을 변환할 수 없습니다."],
    "_%n file converted_::_%n files converted_" : ["%n개 파일 변환됨"],
    "Files converted" : "변환된 파일",
    "Failed to convert files" : "파일 변환에 실패했습니다",
    "Converting file …" : "파일 변환중 …",
    "File successfully converted" : "파일이 성공적으로 변환됨",
    "Failed to convert file: {message}" : "파일 변환 실패: {message}",
    "Failed to convert file" : "파일 변환 실패",
    "Delete" : "삭제",
    ...
    "Download" : "다운로드",
    "The requested file is not available." : "요청한 파일은 사용할 수 없습니다.",
    "The requested files are not available." : "요청한 파일은 사용할 수 없습니다.",
    ...
    "Open online" : "온라인으로 열기",
    "Details" : "자세한 정보",
    "Open the details sidebar" : "세부 사이드바 열기",
    "Unfavorite" : "즐겨찾기 해제",
    ...
    "In folder" : "폴더에서",
    "Pick folder to search in" : "검색할 폴더 선택",
    "Search in all files" : "모든 파일에서 검색",
    ...
    "This folder is unavailable, please try again later or contact the administration" : "이 폴더는 사용할 수 없습니다. 나중에 다시 시도하거나 관리자에게 연락하세요.",
    ...
    "Unable to change the favorite state of the file" : "파일의 즐겨찾기 상태를 변경할 수 없음",
