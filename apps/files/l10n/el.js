OC.L10N.register(
    ...
    "Warn before deleting a file" : "Προειδοποίηση πριν τη διαγραφή αρχείου",
    "WebDAV URL" : "WebDAV URL",
    "Create an app password" : "Δημιουργία κωδικού πρόσβασης εφαρμογής",
    "Required for WebDAV authentication because Two-Factor Authentication is enabled for this account." : "Απαιτείται για την ταυτοποίηση WebDAV επειδή έχει ενεργοποιηθεί ο έλεγχος ταυτότητας δύο παραγόντων για αυτόν τον λογαριασμό.",
