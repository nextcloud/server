OC.L10N.register(
    ...
    "Delete files" : "刪除檔案",
    "Download files" : "下載檔案",
    "When disabled, the option to download will be hidden" : "停用時，下載選項將被隱藏。",
    "View files" : "檢視檔案",
    "Edit files" : "編輯檔案",
    ...
    "Show file type column" : "顯示檔案類型直欄",
    ...
    "Failed to start filename sanitization." : "無法啟動檔案名稱消毒流程。",
    ...
    "Are you sure you want to rename the file to \"{filename}\"?" : "您確定要重新命名檔案為「{filename}」嗎？",
    "Cancel" : "取消",
    "Rename" : "重新命名",
    ...
    "_Moving %n file to \"{destination}\" …_::_Moving %n files to \"{destination}\" …_" : ["正在將 %n 個檔案移動到「{destination}」 …"],
    "Copying \"{source}\" to \"{destination}\" …" : "正在複製「{source}」至「{destination}」 ……",
    "_Copying %n file to \"{destination}\" …_::_Copying %n files to \"{destination}\" …_" : ["正在將 %n 個檔案複製到「{destination}」 …"],
    ...
    "Upload cancelled, drop the files again to retry" : "上傳已取消，請再次拖放檔案以重試",
    ...
    "Invalid name for \"{path}\"" : "「{path}」的名稱無效",
