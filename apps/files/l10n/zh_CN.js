OC.L10N.register(
    ...
    "No favorites" : "无收藏",
    "More favorites" : "更多收藏",
    "No read permission on file." : "文件没有读取权限。",
    "Accept" : "接受",
    "Reject" : "拒绝",
    ...
    "Your ownership transfer of {path} was denied by {user}." : "您 {path} 的所有权转移已被 {user} 拒绝。",
    ...
    "Delete files" : "删除文件",
    "Download files" : "下载文件",
    "When disabled, the option to download will be hidden" : "禁用时，下载选项将隐藏",
    "View files" : "查看文件",
    "Edit files" : "编辑文件",
    ...
    "Transfer \"{path}\"" : "转移“{path}”",
    "Select file or folder" : "选择文件或文件夹",
    "Transfer" : "转移",
    "Transfer {path} to {userid}" : "将 {path} 转移给 {userid}",
    "Error while opening file picker for transfer ownership" : "打开文件选择器进行所有权转移时出错",
    "Error while searching for users" : "搜索用户时出错",
    "Ownership transfer request sent" : "所有权转移请求已发送",
    "Cannot transfer ownership of a file or folder you do not own" : "无法转移您不拥有的文件或文件夹的所有权",
    "Error while sending ownership transfer request" : "发送所有权转移请求时出错",
    "Transfer ownership of a file or folder" : "转移文件或文件夹的所有权",
    "File or folder to transfer" : "要转移的文件或文件夹",
    "No file or folder selected" : "未选择文件或文件夹",
    "New owner" : "新的所有者",
    "You need to select a file or folder to transfer ownership." : "您需要选择要转移所有权的文件或文件夹。",
    "You need to select a new owner for the file or folder." : "您需要为文件或文件夹选择新的所有者。",
    "Keep {old}" : "保留 {old}",
    ...
    "File list is reloading" : "文件列表正在重新加载",
    ...
    "Open online" : "在线打开",
    "Details" : "详细信息",
    "Open the details sidebar" : "打开详情侧边栏",
    "Unfavorite" : "取消收藏",
    ...
    "Folder name must not be empty." : "文件夹名称不能为空。",
    "Filename must not be empty." : "文件名不能为空。",
    "\"{char}\" is not allowed inside a folder name." : "文件夹名称中不允许使用“{char}”。",
    "\"{char}\" is not allowed inside a filename." : "文件名中不允许出现 “{char}”",
    "\"{segment}\" is a reserved name and not allowed for folder names." : "“{segment}”是一个保留名称，不允许用于文件夹名称。",
    ...
    "Folder names must not end with \"{extension}\"." : "文件夹名称不得以“{extension}”结尾。",
