OC.L10N.register(
    ...
    "You renamed {oldfile} (hidden) to {newfile} (hidden)" : "Vous avez renommé {oldfile} (masqué) en {newfile} (masqué)",
    "You renamed {oldfile} (hidden) to {newfile}" : "Vous avez renommé {oldfile} (masqué) en {newfile}",
    "You renamed {oldfile} to {newfile} (hidden)" : "Vous avez renommé {oldfile} en {newfile} (masqué)",
    "You renamed {oldfile} to {newfile}" : "Vous avez renommé {oldfile} en {newfile}",
    "{user} renamed {oldfile} (hidden) to {newfile} (hidden)" : "{user} a renommé {oldfile} (masqué) en {newfile} (masqué)",
    "{user} renamed {oldfile} (hidden) to {newfile}" : "{user} a renommé {oldfile} (masqué) en {newfile}",
    "{user} renamed {oldfile} to {newfile} (hidden)" : "{user} a renommé {oldfile} en {newfile} (masqué)",
    ...
    "No filename sanitization in progress." : "Aucun nettoyage des noms de fichiers en cours.",
    "Favorite files" : "Fichiers favoris",
    "No favorites" : "Aucun favori",
    "More favorites" : "Plus de favoris",
    "No read permission on file." : "Aucune autorisation de lecture sur le fichier.",
    "Accept" : "Accepter",
    "Reject" : "Refuser",
    ...
    "Ownership transfer failed" : "Le transfert de propriété a échoué",
    ...
    "Ownership transfer done" : "Transfert de propriété terminé",
    ...
    "in %s" : "dans %s",
    "Transferred from %1$s on %2$s" : "Transféré depuis %1$s le %2$s",
    "Create files" : "Créer des fichiers",
    "Delete files" : "Supprimer les fichiers",
    "Download files" : "Télécharger des fichiers",
    "When disabled, the option to download will be hidden" : "Lorsque cette option est désactivée, l'option de téléchargement est masquée.",
    ...
    "{displayName} (unavailable)" : "{displayName} (indisponible)",
    ...
    "Crop image previews" : "Recadrer les aperçus d’images",
    "General" : "Général",
    ...
    "View" : "Voir",
    "Toggle grid view" : "Activer/désactiver la vue en grille",
    ...
    "Column headers with buttons are sortable." : "Les en-têtes de colonnes comportant des boutons sont triables.",
    ...
    "Files starting with a dot are hidden by default" : "Les fichiers commençant par un point sont masqués par défaut",
    "Failed to start filename sanitization." : "Impossible de lancer le nettoyage des noms de fichiers.",
    "Failed to refresh filename sanitization status." : "Impossible d’actualiser l’état du nettoyage des noms de fichiers.",
    "Filename sanitization in progress." : "Nettoyage des noms de fichiers en cours.",
    ...
    "(starting)" : "(démarrage)",
    "Fill template fields" : "Remplir les champs du modèle",
    ...
    "Transfer \"{path}\"" : "Transfert \"{path}\"",
    "Select file or folder" : "Sélectionnez un fichier ou un dossier",
    "Transfer" : "Transférer",
    "Transfer {path} to {userid}" : "Transférer {path} à {userid}",
    "Error while opening file picker for transfer ownership" : "Erreur lors de l’ouverture du sélecteur de fichiers pour le transfert de propriété",
    ...
    "Error while sending ownership transfer request" : "Erreur lors de l’envoi de la demande de transfert de propriété.",
    "Transfer ownership of a file or folder" : "Transférer la propriété d'un fichier ou d'un dossier",
    "File or folder to transfer" : "Fichier ou dossier à transférer",
    "No file or folder selected" : "Aucun fichier ou dossier sélectionné",
    "New owner" : "Nouveau propriétaire",
    "You need to select a file or folder to transfer ownership." : "Vous devez sélectionner un fichier ou un dossier pour transférer sa propriété.",
    "You need to select a new owner for the file or folder." : "Vous devez sélectionner un nouveau propriétaire pour le fichier ou le dossier.",
    "Keep {old}" : "Garder {old}",
    ...
    "Do not show this dialog again." : "Ne plus afficher cette boîte de dialogue.",
    "Rename file to hidden" : "Renommer le fichier pour le masquer",
    "Prefixing a filename with a dot may render the file hidden." : "Ajouter un point au début d’un nom de fichier peut masquer le fichier.",
    ...
    "Upload some content or sync with your devices!" : "Téléversez du contenu ou synchronisez-le avec vos appareils !",
    ...
    "Allow to restrict filenames to ensure files can be synced with all clients. By default all filenames valid on POSIX (e.g. Linux or macOS) are allowed." : "Permet de restreindre les noms de fichiers afin de garantir leur synchronisation avec tous les clients. Par défaut, tous les noms de fichiers valides sous POSIX (par exemple Linux ou macOS) sont autorisés.",
    ...
    "This will block filenames not valid on Windows systems, like using reserved names or special characters. But this will not enforce compatibility of case sensitivity." : "Cela bloquera les noms de fichiers non valides sous Windows, par exemple ceux qui utilisent des noms réservés ou des caractères spéciaux. Cela ne garantira toutefois pas la compatibilité liée à la sensibilité à la casse.",
    "Blank" : "Vide",
    ...
    "One file could not be converted: {message}" : "Un fichier n’a pas pu être converti : {message}",
    "_%n file could not be converted_::_%n files could not be converted_" : ["%n fichier n’a pas pu être converti","%n fichiers n’ont pas pu être convertis","%n fichiers n’ont pas pu être convertis"],
    ...
    "Disconnect storages" : "Déconnecter les stockages",
    ...
    "Add or remove favorite" : "Ajouter ou retirer un favori",
    "Move" : "Déplacer",
    "Copy" : "Copier",
    ...
    "_Moving %n file to \"{destination}\" …_::_Moving %n files to \"{destination}\" …_" : ["Déplacement de %n fichier vers \"{destination}\" …","Déplacement de %n fichiers vers \"{destination}\" …","Déplacement de %n fichiers vers \"{destination}\" …"],
    "Copying \"{source}\" to \"{destination}\" …" : "Copie de \"{source}\" vers \"{destination}\" …",
    "_Copying %n file to \"{destination}\" …_::_Copying %n files to \"{destination}\" …_" : ["Copie de %n fichier vers \"{destination}\" …","Copie de %n fichiers vers \"{destination}\" …","Copie de %n fichiers vers \"{destination}\" …"],
    ...
    "Details" : "Détails",
    "Open the details sidebar" : "Ouvrir le panneau latérale des détails",
    ...
    "Upload cancelled, drop the files again to retry" : "Téléversement annulé, déposez de nouveau les fichiers pour réessayer",
    ...
    "Invalid name for \"{path}\"" : "Nom invalide pour « {path} »",
    ...
    "_%n hidden_::_%n hidden_" : ["%n masqué","%n masqués","%n masqués"],
    "Folder name must not be empty." : "Le nom du dossier ne peut pas être vide.",
    "Filename must not be empty." : "Le nom du fichier ne doit pas être vide.",
    "\"{char}\" is not allowed inside a folder name." : "\"{char}\" n'est pas autorisé dans un nom de dossier.",
    "\"{char}\" is not allowed inside a filename." : "\"{char}\" n'est pas autorisé dans un nom de fichier.",
    "\"{segment}\" is a reserved name and not allowed for folder names." : "\"{segment}\" est un nom réservé et ne peut pas être utilisé comme nom de dossier.",
    ...
    "Folder names must not end with \"{extension}\"." : "Les noms de dossier ne doivent pas se terminer par \"{extension}\".",
    ...
    "No recently modified files" : "Aucun fichier récemment modifié",
    ...
    "The files you are trying to upload exceed the maximum size for file uploads on this server." : "Les fichiers que vous essayez de téléverser dépassent la taille maximale autorisée pour les téléversements sur ce serveur.",
    "Search everywhere …" : "Rechercher partout …",
    "Search here …" : "Rechercher ici …"
},
