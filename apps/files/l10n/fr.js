OC.L10N.register(
    ...
    "No filename sanitization inprogress." : "Aucun nettoyage de nom de fichier en cours.",
    ...
    "Failed to start filename sanitization." : "Échec du démarrage du nettoyage de nom de fichier.",
    "Failed to refresh filename sanitization status." : "Échec de l'actualisation du statut du nettoyage de nom de fichier.",
    "Filename sanitization in progress." : "Nettoyage de nom de fichier en cours",
    "Currently {processedUsers} of {totalUsers} accounts are already processed." : "Actuellement, {processedUsers} des {totalUsers} comptes ont déjà été traités.",
    ...
    "Some files could not be sanitized, please check your logs." : "Certains fichiers n'ont pas pu être nettoyés, veuillez vérifier le journal de serveur.",
    "Sanitization errors" : "Erreurs de nettoyage",
    "Not sanitized filenames" : "Noms de fichiers non nettoyés",
    "Windows filename support has been enabled." : "La prise en charge des noms de fichiers Windows a été activée.",
