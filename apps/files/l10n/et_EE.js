OC.L10N.register(
    ...
    "You added {file} to your favorites" : "Märkisid „{file}“ faili lemmikuks",
    "You removed {file} from your favorites" : "Eemaldasid „{file}“ faili lemmikutest",
    "Favorites" : "Lemmikud",
    ...
    "Moved by {user}" : "Teisaldatud „{user}“ kasutaja poolt",
    "\"remote account\"" : "„kaugkonto“",
    "You created {file}" : "Sa lõid faili: {file}",
    "You created an encrypted file in {file}" : "Sa lõid krüptitud faili: {file}",
    ...
    "You changed {file}" : "Sa muutsid „{file}“ faili",
    "You changed an encrypted file in {file}" : "Sa muutsid krüptitud faili „{file}“",
    "{user} changed {file}" : "Kasutaja {user} muutis „{file}“ faili",
    "{user} changed an encrypted file in {file}" : "Kasutaja {user} muutis krüptitud faili „{file}“",
    "You deleted {file}" : "Sa kustutasid „{file}“ faili",
    "You deleted an encrypted file in {file}" : "Sa kustutasid krüptitud faili „{file}“",
    "{user} deleted {file}" : "Kasutaja {user} kustutas „{file}“ faili",
    ...
    "No read permission on file." : "Puuduvad faili lugemisõigused",
    "Accept" : "Nõustu",
    "Reject" : "Keeldu",
    ...
    "in %s" : "kaustas %s",
    "Transferred from %1$s on %2$s" : "%2$s üleantud kasutajalt %1$s",
    "Create files" : "Loo faile",
    "Delete files" : "Kustuta failid",
    "Download files" : "Laadi failid alla",
    "When disabled, the option to download will be hidden" : "Kui see valik pole kasutusel, siis allalaadimise võimalus pole näha",
    "View files" : "Vaata faile",
    "Edit files" : "Muuda faile",
    ...
    "{displayName} (unavailable)" : "{displayName} (pole saadaval)",
    ...
    "Videos" : "Videod",
    "Filters" : "Filtrid",
    "Back to filters" : "Tagasi filtrite juurde",
    "Appearance" : "Välimus",
    ...
    "This list is not fully rendered for performance reasons. The files will be rendered as you navigate through the list." : "Jõudluse mõttes ei ole kogu loend esimesel hetkel tervikuna nähtav. Uued failid lisanduvad sedamööda, kuidas sa loendis edasi liigud.",
    ...
    "Failed to start filename sanitization." : "Failinime normaliseerimise alustamine ei õnnestunud.",
    ...
    "Sanitization errors" : "Normaliseerimise vead",
    "Not sanitized filenames" : "Normaliseerimata failinimed",
    ...
    "Transfer \"{path}\"" : "Anna „{path}“ üle",
    "Select file or folder" : "Vali fail või kaust",
    "Transfer" : "Anna üle teisele kasutajale",
    "Transfer {path} to {userid}" : "Anna „{path}“ üle kasutajale {userid}",
    "Error while opening file picker for transfer ownership" : "Viga failivalija avamisel omandi üleandmiseks",
    "Error while searching for users" : "Viga kasutajate otsimisel",
    ...
    "Error while sending ownership transfer request" : "Viga omandi üleandmispäringu saatmisel",
    "Transfer ownership of a file or folder" : "Kaustade või failide omandi üleandmine teisele kasutajale",
    "File or folder to transfer" : "Üleantav fail või kaust",
    "No file or folder selected" : "Ühtegi faili ega kausta pole valitud",
    "New owner" : "Uus omanik",
    "You need to select a file or folder to transfer ownership." : "Omandi üleandmiseks pead valima faili või kausta.",
    "You need to select a new owner for the file or folder." : "Sa pead failile või kaustale valima uue omaniku.",
    ...
    "Details" : "Üksikasjad",
    "Open the details sidebar" : "Ava üksikasjade külgpaan",
    ...
    "In folder" : "Kaustas",
    "Pick folder to search in" : "Vali kaust, kus soovid otsida",
    ...
    "Upload cancelled, drop the files again to retry" : "Üleslaadimine on katkestatud. Uuesti proovimiseks lohista failid uuesti sihtkausta",
    ...
    "Invalid name for \"{path}\"" : "Vigane nimi „{path}“ asukoha jaoiks",
    ...
    "Folder name must not be empty." : "Kaustanimi ei saa olla tühi.",
    "Filename must not be empty." : "Failinimi ei saa olla tühi.",
    "\"{char}\" is not allowed inside a folder name." : "„{char}“ pole kaustanimedes lubatud.",
    "\"{char}\" is not allowed inside a filename." : "„{char}“ pole failinimedes lubatud.",
    "\"{segment}\" is a reserved name and not allowed for folder names." : "„{segment}“ on reserveeritud nimi ja seda kaustanimedes ei saa kasutada.",
    ...
    "Folder names must not end with \"{extension}\"." : "Kaustanimede lõpus ei tohi olla „{extension}“.",
    "Filenames must not end with \"{extension}\"." : "Failinimede lõpus ei tohi olla „{extension}“.",
    "Invalid folder name." : "Vigane või vale kaustanimi.",
    ...
    "No personal files found" : "Isiklikke faile ei leidu",
