OC.L10N.register(
    ...
    "Select file or folder" : "Selecione arquivo ou pasta",
    "Transfer" : "Transfere",
    "Transfer {path} to {userid}" : "Transfere {path} para {userid}",
    "Error while opening file picker for transfer ownership" : "Erro ao abrir o seletor de arquivos para transferência de propriedade",
    ...
    "Error while sending ownership transfer request" : "Erro ao enviar a solicitação de transferência de propriedade",
    "Transfer ownership of a file or folder" : "Transferir a propriedade de um ficheiro ou pasta",
    "File or folder to transfer" : "Arquivo ou pasta a ser transferido",
    "No file or folder selected" : "Nenhum arquivo ou pasta selecionado",
    "New owner" : "Novo proprietário",
    "You need to select a file or folder to transfer ownership." : "Você precisa selecionar um arquivo ou pasta para transferir a propriedade.",
    "You need to select a new owner for the file or folder." : "Você precisa selecionar um novo proprietário para o arquivo ou pasta.",
    "Keep {old}" : "Manter {old}",
    ...
    "_%n file could not be converted_::_%n files could not be converted_" : ["%n file could not be converted","%n files could not be converted","%n files could not be converted"],
    "_%n file converted_::_%n files converted_" : ["%n file converted","%n files converted","%n files converted"],
    "Files converted" : "Arquivos convertidos",
    ...
    "_You are about to permanently delete {count} item_::_You are about to permanently delete {count} items_" : ["You are about to permanently delete {count} item","You are about to permanently delete {count} items","You are about to permanently delete {count} items"],
    ...
    "_Moving %n file to \"{destination}\" …_::_Moving %n files to \"{destination}\" …_" : ["Movendo %n arquivo para \"{destination}\" …","Movendo %n de arquivos para \"{destination}\" …","Movendo %n arquivos para \"{destination}\" …"],
    "Copying \"{source}\" to \"{destination}\" …" : "Copiando \"{source}\" para \"{destination}\" …",
    "_Copying %n file to \"{destination}\" …_::_Copying %n files to \"{destination}\" …_" : ["Copiando %n arquivo para \"{destination}\" …","Copiando %n de arquivos para \"{destination}\" …","Copiando %n arquivos para \"{destination}\" …"],
    ...
    "List of favorite files and folders." : "Lista de ficheiros e pastas favoritos.",
    ...
    "No personal files found" : "Nenhum ficheiro pessoal encontrado",
