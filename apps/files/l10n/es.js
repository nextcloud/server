OC.L10N.register(
    ...
    "No filename sanitization in progress." : "No hay saneamiento de nombres de archivo en progreso.",
    "Favorite files" : "Archivos favoritos",
    "No favorites" : "No hay favoritos",
    "More favorites" : "Más favoritos",
    "No read permission on file." : "No hay permiso de lectura en el archivo.",
    "Accept" : "Aceptar",
    "Reject" : "Rechazar",
    ...
    "When disabled, the option to download will be hidden" : "Cuando esté desactivado, se ocultará la opción de descargar.",
    "View files" : "Ver archivos",
    "Edit files" : "Editar archivoa",
    ...
    "{displayName} (unavailable)" : "{displayName} (no disponible)",
    ...
    "Error while sending ownership transfer request" : "Se ha producido un error al enviar la solicitud de transferencia de propiedad",
    "Transfer ownership of a file or folder" : "Transferir la propiedad de un archivo o carpeta",
    "File or folder to transfer" : "Archivo o carpeta que se va a transferir",
    "No file or folder selected" : "No se ha seleccionado ningún archivo ni carpeta",
    "New owner" : "Nuevo propietario",
    "You need to select a file or folder to transfer ownership." : "Debes seleccionar un archivo o una carpeta para transferir la propiedad.",
    "You need to select a new owner for the file or folder." : "Debes seleccionar un nuevo propietario para el archivo o la carpeta.",
    ...
    "_Moving %n file to \"{destination}\" …_::_Moving %n files to \"{destination}\" …_" : ["Moviendo %n archivo a \"{destination}\" …","Moviendo %n archivos a \"{destination}\" …","Moviendo %n archivos a \"{destination}\" …"],
    "Copying \"{source}\" to \"{destination}\" …" : "Copiando \"{source}\" a \"{destination}\" …",
    "_Copying %n file to \"{destination}\" …_::_Copying %n files to \"{destination}\" …_" : ["Copiando %n archivo a \"{destination}\" …","Copiando %n archivos a \"{destination}}\" …","Copiando %n archivos a \"{destination}\" …"],
    ...
    "Folder name must not be empty." : "El nombre de la carpeta no debe estar vacía.",
    "Filename must not be empty." : "El nombre de archivo no debe estar vacío.",
    "\"{char}\" is not allowed inside a folder name." : "\"{char}\" no está permitido dentro del nombre de una carpeta.",
    "\"{char}\" is not allowed inside a filename." : "\"{char}\" no está permitido en el nombre de archivo.",
    "\"{segment}\" is a reserved name and not allowed for folder names." : "\"{segment}\" es un nombre reservado y no está permitido para nombres de carpetas.",
    ...
    "Folder names must not end with \"{extension}\"." : "Los nombres de las carpetas no deben terminar con \"{extension}\".",
