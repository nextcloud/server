OC.L10N.register(
    ...
    "No read permission on file." : "Нямате право за четене на файл",
    "Accept" : "Приемане",
    "Reject" : "Откажи",
    ...
    "Recently created" : "Наскорто създадени",
    "Folder" : "Папка",
    ...
    "Videos" : "Видеа",
    "Filters" : "Филтри",
    "Back to filters" : "Назад към филтрите",
    "Appearance" : "Изглед",
    ...
    "Transfer \"{path}\"" : "Прехвърли \"{path}\"",
    "Select file or folder" : "Избери файл или папка",
    "Transfer" : "Прехвърли",
    ...
    "File or folder to transfer" : "Файл или папка за прехвърляне",
    "No file or folder selected" : "Не е избран файл или папка",
    ...
    "Details" : "Подробности",
    "Open the details sidebar" : "Отваряне страничната лента с детайли",
