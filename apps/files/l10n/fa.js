OC.L10N.register(
    ...
    "in %s" : "در %s",
    "Transferred from %1$s on %2$s" : "منتقل‌شده از %1$s در %2$s",
    ...
    "Error while opening file picker for transfer ownership" : "خطا هنگام باز کردن انتخابگر فایل برای انتقال مالکیت",
    ...
    "New owner" : "مالک جدید",
    "You need to select a file or folder to transfer ownership." : "برای انتقال مالکیت باید یک فایل یا پوشه انتخاب کنید.",
    "You need to select a new owner for the file or folder." : "باید مالک جدیدی برای فایل یا پوشه انتخاب کنید.",
    "Keep {old}" : "نگه‌داری {old}",
    ...
    "Rename file to hidden" : "تغییر نام فایل به حالت مخفی",
    ...
    "In folder" : "در پوشه",
    "Pick folder to search in" : "انتخاب پوشه‌ای برای جستجو در آن",
    ...
    "Converting files …" : "تبدیل فایل‌ها…",
    "Converting file …" : "تبدیل فایل …",
    "Moving {count} files to \"{destination}\" …" : "در حال انتقال {count} پرونده به \"{destination}\" …",
    "Copying {count} files to \"{destination}\" …" : "در حال رونوشت‌برداری از {count} پرونده در \"{destination}\" …"
},
