OC.L10N.register(
    ...
    "You do not have permission to upload or create files here." : "Buraya dosya yükleme ya da oluşturma izniniz yok.",
    ...
    "Transfer \"{path}\"" : "\"{path}\" aktar",
    "Select file or folder" : "Dosya ya da klasör seçin",
    "Transfer" : "Sahipliği aktar",
    "Transfer {path} to {userid}" : "{path} yolunun sahipliğini {userid} kullanıcısına aktar",
    "Error while opening file picker for transfer ownership" : "Sahipliğin aktarılması için dosya seçici açılırken sorun çıktı",
    ...
    "Error while sending ownership transfer request" : "Sahiplik aktarımı isteği gönderilirken sorun çıktı",
    "Transfer ownership of a file or folder" : "Bir dosya ya da klasörün sahipliğini aktarabilirsiniz",
    "File or folder to transfer" : "Aktarılacak dosya ya da klasör",
    "No file or folder selected" : "Herhangi bir dosya ya da klasör seçilmemiş",
    "New owner" : "Yeni sahip",
    "You need to select a file or folder to transfer ownership." : "Sahipliği aktarmak için bir dosya veya klasör seçmelisiniz.",
    "You need to select a new owner for the file or folder." : "Dosya ya da klasör için yeni bir sahip seçmelisiniz.",
    "Keep {old}" : "{old} kalsın",
    ...
    "Blank" : "Boş",
    "Unable to create new file from template" : "Kalıptan yeni dosya oluşturulamadı",
    "Pick a template for {name}" : "{name} için bir kalıp seçin",
    "Create a new file with the selected template" : "Seçilmiş kalıp ile yeni bir dosya oluştur",
    ...
    "_Moving %n file to \"{destination}\" …_::_Moving %n files to \"{destination}\" …_" : ["%n dosya \"{destination}\" hedefine taşınıyor…","%n dosya \"{destination}\" hedefine taşınıyor…"],
    "Copying \"{source}\" to \"{destination}\" …" : "\"{source}\", \"{destination}\" üzerine kopyalanıyor…",
    "_Copying %n file to \"{destination}\" …_::_Copying %n files to \"{destination}\" …_" : ["%n dosya \"{destination}\" hedefine kopyalanıyor…","%n dosya \"{destination}\" hedefine kopyalanıyor…"],
    ...
    "Upload cancelled, drop the files again to retry" : "Yükleme iptal edildi. Yeniden denemek için dosyaları yeniden sürükleyip bırakın",
    ...
    "Invalid name for \"{path}\"" : "\"{path}\" için ad geçersiz",
