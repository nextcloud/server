...
class DeleteOrphanedFilesTest extends TestCase {
	 ...
	 */
	protected function expectOutput(OutputInterface&\PHPUnit\Framework\MockObject\MockObject $output, array $calls): void {
		$output
	...
	public function testClearEntriesWithoutFileCacheEntry(): void {
		...
		$input = $this->createMock(InputInterface::class);
		$this->command->execute($input, $this->createMock(OutputInterface::class));
