...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  ...
  setup(__props) {
    ...
    const appStoreLabel = (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('settings', 'App Store');
    const viewLabel = (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(() => _constants_AppsConstants__WEBPACK_IMPORTED_MODULE_4__.APPS_SECTION_ENUM[currentCategory.value] ?? store.getCategoryById(currentCategory.value)?.displayName ?? appStoreLabel);
...
//# sourceMappingURL=settings-apps-view-settings-apps-view.js.map?v=5d55e8b7cb009965db98