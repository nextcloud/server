"use strict";
(globalThis["webpackChunknextcloud_ui_legacy"] = globalThis["webpackChunknextcloud_ui_legacy"] || []).push([["apps_updatenotification_src_components_AppChangelogDialog_vue"],{
 ...
 */
function useMarkdown(text, minHeadingLevel) {
  ...
  const html = (0,vue__WEBPACK_IMPORTED_MODULE_2__.computed)(() => dompurify__WEBPACK_IMPORTED_MODULE_0__["default"].sanitize((0,marked__WEBPACK_IMPORTED_MODULE_1__.marked)((text.value ?? '').trim(), {
    renderer,
    gfm: false,
    breaks: false,
    pedantic: false
...
/***/ "./apps/updatenotification/src/logger.ts"
/*!***********************************************!*\
  !*** ./apps/updatenotification/src/logger.ts ***!
  \***********************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
const logger = (0,_nextcloud_logger__WEBPACK_IMPORTED_MODULE_0__.getLoggerBuilder)().detectLogLevel().setApp('updatenotification').build();

/***/ },

/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-6.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/updatenotification/src/components/AppChangelogDialog.vue?vue&type=script&setup=true&lang=ts"
/*!************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-6.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/updatenotification/src/components/AppChangelogDialog.vue?vue&type=script&setup=true&lang=ts ***!
  \************************************************************************************************************************************************************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _Markdown_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Markdown.vue */ "./apps/updatenotification/src/components/Markdown.vue");
/* harmony import */ var _logger_ts__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../logger.ts */ "./apps/updatenotification/src/logger.ts");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  ...
  setup(__props, {
    ...
    const props = __props;
    const dialogButtons = [{
      label: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translate)('updatenotification', 'Give feedback'),
      callback: () => {
        window.open(`https://apps.nextcloud.com/apps/${props.appId}#comments`, '_blank', 'noreferrer noopener');
      }
    }, {
      label: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translate)('updatenotification', 'Get started'),
      variant: 'primary',
      callback: () => {
        emit('dismiss');
    ...
    const appName = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)(props.appId);
    const appVersion = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)(props.version ?? '');
    const markdown = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)('');
    (0,vue__WEBPACK_IMPORTED_MODULE_0__.watchEffect)(() => {
      const url = props.version ? (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_3__.generateOcsUrl)('/apps/updatenotification/api/v1/changelog/{app}?version={version}', {
        version: props.version,
        app: props.appId
      }) : (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_3__.generateOcsUrl)('/apps/updatenotification/api/v1/changelog/{app}', {
        version: props.version,
        app: props.appId
      });
      _nextcloud_axios__WEBPACK_IMPORTED_MODULE_1__["default"].get(url).then(({
        data
      }) => {
        ...
        if (error?.response?.status === 404) {
          ...
          markdown.value = (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translate)('updatenotification', 'No changelog available');
        } else {
          _logger_ts__WEBPACK_IMPORTED_MODULE_6__.logger.error('Failed to load changelog entry', error);
          emit('update:open', false);
        }
      });
    });
    return {
      ...
      Markdown: _Markdown_vue__WEBPACK_IMPORTED_MODULE_5__["default"]
    };
  }
}));
...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-6.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/updatenotification/src/components/Markdown.vue?vue&type=script&setup=true&lang=ts"
/*!**************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-6.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/updatenotification/src/components/Markdown.vue?vue&type=script&setup=true&lang=ts ***!
  \**************************************************************************************************************************************************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */ });
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue */ "./node_modules/vue/dist/vue.runtime.esm.js");
/* harmony import */ var _composables_useMarkdown_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../composables/useMarkdown.ts */ "./apps/updatenotification/src/composables/useMarkdown.ts");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  ...
  setup(__props) {
    ...
    const {
      html
    } = (0,_composables_useMarkdown_ts__WEBPACK_IMPORTED_MODULE_1__.useMarkdown)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toRef)(props, 'markdown'), (0,vue__WEBPACK_IMPORTED_MODULE_0__.toRef)(props, 'minHeadingLevel'));
    return {
      __sfc: true,
      props,
      html
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_node_modules_ts_loader_index_js_clonedRuleSet_6_use_1_node_modules_vue_loader_lib_index_js_vue_loader_options_AppChangelogDialog_vue_vue_type_script_setup_true_lang_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js!../../../../node_modules/ts-loader/index.js??clonedRuleSet-6.use[1]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./AppChangelogDialog.vue?vue&type=script&setup=true&lang=ts */ "./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-6.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/updatenotification/src/components/AppChangelogDialog.vue?vue&type=script&setup=true&lang=ts");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_node_modules_ts_loader_index_js_clonedRuleSet_6_use_1_node_modules_vue_loader_lib_index_js_vue_loader_options_AppChangelogDialog_vue_vue_type_script_setup_true_lang_ts__WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_node_modules_ts_loader_index_js_clonedRuleSet_6_use_1_node_modules_vue_loader_lib_index_js_vue_loader_options_Markdown_vue_vue_type_script_setup_true_lang_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js!../../../../node_modules/ts-loader/index.js??clonedRuleSet-6.use[1]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./Markdown.vue?vue&type=script&setup=true&lang=ts */ "./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-6.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/updatenotification/src/components/Markdown.vue?vue&type=script&setup=true&lang=ts");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_node_modules_ts_loader_index_js_clonedRuleSet_6_use_1_node_modules_vue_loader_lib_index_js_vue_loader_options_Markdown_vue_vue_type_script_setup_true_lang_ts__WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
//# sourceMappingURL=apps_updatenotification_src_components_AppChangelogDialog_vue-apps_updatenotification_src_components_AppChangelogDialog_vue.js.map?v=9716ae358a383e3e39e6