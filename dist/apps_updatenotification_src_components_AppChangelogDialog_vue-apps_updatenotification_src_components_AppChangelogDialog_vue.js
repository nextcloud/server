...
const useMarkdown = (text, minHeadingLevel) => {
  const minHeading = (0,vue__WEBPACK_IMPORTED_MODULE_1__.computed)(() => Math.min(Math.max(minHeadingLevel.value ?? 1, 1), 6));
  ...
  const html = (0,vue__WEBPACK_IMPORTED_MODULE_1__.computed)(() => dompurify__WEBPACK_IMPORTED_MODULE_2__["default"].sanitize((0,marked__WEBPACK_IMPORTED_MODULE_0__.marked)((text.value ?? '').trim(), {
    renderer,
    gfm: false,
    breaks: false,
    pedantic: false
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  ...
  setup(__props, _ref) {
    ...
    const props = __props;
    const dialogButtons = [{
      label: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('updatenotification', 'Give feedback'),
      callback: () => {
        window.open(`https://apps.nextcloud.com/apps/${props.appId}#comments`, '_blank', 'noreferrer noopener');
      }
    }, {
      label: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('updatenotification', 'Get started'),
      type: 'primary',
      callback: () => {
        emit('dismiss');
    ...
    (0,vue__WEBPACK_IMPORTED_MODULE_0__.watchEffect)(() => {
      const url = props.version ? (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_2__.generateOcsUrl)('/apps/updatenotification/api/v1/changelog/{app}?version={version}', {
        version: props.version,
        app: props.appId
      }) : (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_2__.generateOcsUrl)('/apps/updatenotification/api/v1/changelog/{app}', {
        version: props.version,
        app: props.appId
      });
      _nextcloud_axios__WEBPACK_IMPORTED_MODULE_3__["default"].get(url).then(_ref2 => {
        let {
          data
        } = _ref2;
        ...
        if (error?.response?.status === 404) {
          ...
          markdown.value = (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.translate)('updatenotification', 'No changelog available');
        } else {
...
/* harmony export */ });
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! vue */ "./node_modules/vue/dist/vue.runtime.esm.js");
/* harmony import */ var _composables_useMarkdown__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../composables/useMarkdown */ "./apps/updatenotification/src/composables/useMarkdown.ts");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  ...
  setup(__props) {
    ...
    const {
      html
    } = (0,_composables_useMarkdown__WEBPACK_IMPORTED_MODULE_1__.useMarkdown)((0,vue__WEBPACK_IMPORTED_MODULE_0__.toRef)(props, 'markdown'), (0,vue__WEBPACK_IMPORTED_MODULE_0__.toRef)(props, 'minHeadingLevel'));
    return {
      __sfc: true,
      props,
      html
...
//# sourceMappingURL=apps_updatenotification_src_components_AppChangelogDialog_vue-apps_updatenotification_src_components_AppChangelogDialog_vue.js.map?v=77e1695f0677aa6ad4be