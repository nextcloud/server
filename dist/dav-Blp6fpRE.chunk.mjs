import{a as m,f as E,o as q,d as D}from"./public-DUDgMnHe.chunk.mjs";import{l as y}from"./_plugin-vue_export-helper-CqVUm19z.chunk.mjs";import{z as P,L as T}from"./index-CXaRMtvG.chunk.mjs";import{s as d,l as u,N as x,a as _,b as R,P as o}from"./externalStorageUtils-59-zbcvF.chunk.mjs";import{g as S}from"./index-CWUMrdUf.chunk.mjs";function f(){return y("files_sharing","isPublic",null)??document.querySelector('input#isPublic[type="hidden"][name="isPublic"][value="1"]')!==null}function A(){return y("files_sharing","sharingToken",null)??document.querySelector('input#sharingToken[type="hidden"]')?.value??null}function k(e=""){let r=o.NONE;return e&&(e.includes("G")&&(r|=o.READ),e.includes("W")&&(r|=o.WRITE),e.includes("CK")&&(r|=o.CREATE),e.includes("NV")&&(r|=o.UPDATE),e.includes("D")&&(r|=o.DELETE),e.includes("R")&&(r|=o.SHARE)),r}const $=["d:getcontentlength","d:getcontenttype","d:getetag","d:getlastmodified","d:creationdate","d:displayname","d:quota-available-bytes","d:resourcetype","nc:has-preview","nc:is-encrypted","nc:mount-type","oc:comments-unread","oc:favorite","oc:fileid","oc:owner-display-name","oc:owner-id","oc:permissions","oc:size","nc:upload_time"],w={d:"DAV:",nc:"http://nextcloud.org/ns",oc:"http://owncloud.org/ns",ocs:"http://open-collaboration-services.org/ns"};function U(e,r={nc:"http://nextcloud.org/ns"}){d.davNamespaces??={...w},d.davProperties??=[...$];const i={...d.davNamespaces,...r};if(d.davProperties.find(t=>t===e))return u.warn(`${e} already registered`,{prop:e}),!1;if(e.startsWith("<")||e.split(":").length!==2)return u.error(`${e} is not valid. See example: 'oc:fileid'`,{prop:e}),!1;const s=e.split(":")[0];return i[s]?(d.davProperties.push(e),d.davNamespaces=i,!0):(u.error(`${e} namespace unknown`,{prop:e,namespaces:i}),!1)}function h(){return d.davProperties??=[...$],d.davProperties.map(e=>`<${e} />`).join(" ")}function g(){return d.davNamespaces??={...w},Object.keys(d.davNamespaces).map(e=>`xmlns:${e}="${d.davNamespaces?.[e]}"`).join(" ")}function X(){return`<?xml version="1.0"?>
		<d:propfind ${g()}>
			<d:prop>
				${h()}
			</d:prop>
...
//# sourceMappingURL=dav-Blp6fpRE.chunk.mjs.map
