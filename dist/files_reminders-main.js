...
var handleOpen = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(payload) {
    var fileId, menuEl, linkEl, dueDate, error;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          fileId = payload.context.fileInfoModel.attributes.id;
          menuEl = payload.context.$file[0].querySelector('.fileactions .action-menu');
          linkEl = payload.el.querySelector('.action-setreminder-container .action-setreminder');
          dueDate = null;
          error = null;
          _context.prev = 5;
          _context.next = 8;
          return (0,_services_reminderService_js__WEBPACK_IMPORTED_MODULE_4__.getReminder)(fileId);
        case 8:
          dueDate = _context.sent.dueDate;
          _context.next = 15;
          break;
        case 11:
          _context.prev = 11;
        ...
        case 15:
          linkEl.addEventListener('click', function (_event) {
            if (error) {
            ...
            var SetReminderActions = vue__WEBPACK_IMPORTED_MODULE_6__["default"].extend(_components_SetReminderActions_vue__WEBPACK_IMPORTED_MODULE_3__["default"]);
            var origDisplay = menuEl.style.display;
            ...
            var actions = new SetReminderActions({
              propsData: propsData
            }).$mount(mountPoint);
            ...
            actions.$once('back', function () {
              cleanUp();
              menuEl.click(); // reopen original actions menu
            });

            actions.$once('close', function () {
              cleanUp();
            });
          }, {
            once: true
...
/* harmony export */   clearReminder: function() { return /* binding */ clearReminder; },
/* harmony export */   getReminder: function() { return /* binding */ getReminder; },
/* harmony export */   setReminder: function() { return /* binding */ setReminder; }
/* harmony export */ });
...
var getReminder = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(fileId) {
    var url, response, dueDate;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          url = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.generateOcsUrl)('/apps/files_reminders/api/v1/{fileId}', {
            fileId: fileId
          });
          _context.next = 3;
        ...
        case 3:
          ...
          dueDate = response.data.ocs.data.dueDate ? new Date(response.data.ocs.data.dueDate) : null;
  ...
  return function getReminder(_x) {
    return _ref.apply(this, arguments);
  };
}();
var setReminder = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(fileId, dueDate) {
    var url, response;
  ...
  return function setReminder(_x2, _x3) {
    return _ref2.apply(this, arguments);
  };
}();
var clearReminder = /*#__PURE__*/function () {
  ...
  return function clearReminder(_x4) {
...
var logger = (0,_nextcloud_logger__WEBPACK_IMPORTED_MODULE_0__.getLoggerBuilder)().setApp('files_reminders').detectUser().build();
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   DateTimePreset: function() { return /* binding */ DateTimePreset; },
/* harmony export */   getDateString: function() { return /* binding */ getDateString; },
/* harmony export */   getDateTime: function() { return /* binding */ getDateTime; },
/* harmony export */   getInitialCustomDueDate: function() { return /* binding */ getInitialCustomDueDate; },
/* harmony export */   getVerboseDateString: function() { return /* binding */ getVerboseDateString; }
/* harmony export */ });
...
var getDateTime = function getDateTime(dateTime) {
  var _matchPreset;
  var matchPreset = (_matchPreset = {}, _defineProperty(_matchPreset, DateTimePreset.LaterToday, function () {
    var now = _nextcloud_moment__WEBPACK_IMPORTED_MODULE_0___default()();
    var evening = _nextcloud_moment__WEBPACK_IMPORTED_MODULE_0___default()().startOf('day').add(18, 'hour');
    var cutoff = evening.clone().subtract(1, 'hour');
    if (now.isSameOrAfter(cutoff)) {
      return null;
    }
    return evening.toDate();
  }), _defineProperty(_matchPreset, DateTimePreset.Tomorrow, function () {
    var day = _nextcloud_moment__WEBPACK_IMPORTED_MODULE_0___default()().add(1, 'day').startOf('day').add(8, 'hour');
    return day.toDate();
  }), _defineProperty(_matchPreset, DateTimePreset.ThisWeekend, function () {
    var today = _nextcloud_moment__WEBPACK_IMPORTED_MODULE_0___default()();
    if ([5, 6, 7 // Sunday
    ].includes(today.isoWeekday())) {
      return null;
    }
    var saturday = _nextcloud_moment__WEBPACK_IMPORTED_MODULE_0___default()().startOf('isoWeek').add(5, 'day').add(8, 'hour');
    return saturday.toDate();
  }), _defineProperty(_matchPreset, DateTimePreset.NextWeek, function () {
    var today = _nextcloud_moment__WEBPACK_IMPORTED_MODULE_0___default()();
    if (today.isoWeekday() === 7) {
      // Sunday
      return null;
    }
    var workday = _nextcloud_moment__WEBPACK_IMPORTED_MODULE_0___default()().startOf('isoWeek').add(1, 'week').add(8, 'hour');
    return workday.toDate();
  }), _matchPreset);
  return matchPreset[dateTime]();
};
var getInitialCustomDueDate = function getInitialCustomDueDate() {
  var hour = _nextcloud_moment__WEBPACK_IMPORTED_MODULE_0___default()().get('hour');
  var dueDate = _nextcloud_moment__WEBPACK_IMPORTED_MODULE_0___default()().startOf('day').add(hour + 2, 'hour');
  return dueDate.toDate();
};
var getDateString = function getDateString(dueDate) {
  var formatOptions = {
    hour: 'numeric',
    minute: '2-digit'
  };
  var dueDateMoment = _nextcloud_moment__WEBPACK_IMPORTED_MODULE_0___default()(dueDate);
  var today = _nextcloud_moment__WEBPACK_IMPORTED_MODULE_0___default()();
  if (!dueDateMoment.isSame(today, 'date')) {
    formatOptions = _objectSpread(_objectSpread({}, formatOptions), {}, {
      weekday: 'short'
    });
  }
...
var getVerboseDateString = function getVerboseDateString(dueDate) {
  var formatOptions = {
    weekday: 'long',
    hour: 'numeric',
    minute: '2-digit',
...
/* harmony default export */ __webpack_exports__["default"] = (vue__WEBPACK_IMPORTED_MODULE_13__["default"].extend({
  ...
  computed: {
    ...
    clearAriaLabel: function clearAriaLabel() {
    ...
    customAriaLabel: function customAriaLabel() {
    ...
    options: function options() {
      var _this = this;
      var computeOption = function computeOption(option) {
        var dateTime = (0,_shared_utils_ts__WEBPACK_IMPORTED_MODULE_11__.getDateTime)(option.dateTimePreset);
        if (!dateTime) {
          return null;
        }
        return _objectSpread(_objectSpread({}, option), {}, {
          ...
          action: function action() {
            return _this.set(dateTime);
          }
        });
      };
      var options = [laterToday, tomorrow, thisWeekend, nextWeek];
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return (0,_services_reminderService_ts__WEBPACK_IMPORTED_MODULE_10__.setReminder)(_this2.fileId, dueDate);
            case 3:
        ...
        return _regeneratorRuntime().wrap(function _callee2$(_context2) {
          while (1) switch (_context2.prev = _context2.next) {
            ...
            case 3:
              _context2.prev = 3;
              _context2.next = 6;
              return (0,_services_reminderService_ts__WEBPACK_IMPORTED_MODULE_10__.setReminder)(_this3.fileId, _this3.customDueDate);
            case 6:
              (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_1__.showSuccess)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_0__.translate)('files_reminders', 'Reminder set for "{fileName}"', {
        ...
        return _regeneratorRuntime().wrap(function _callee3$(_context3) {
          while (1) switch (_context3.prev = _context3.next) {
            case 0:
              _context3.prev = 0;
              _context3.next = 3;
              return (0,_services_reminderService_ts__WEBPACK_IMPORTED_MODULE_10__.clearReminder)(_this4.fileId);
            case 3:
...
/***/ "./node_modules/vue-material-design-icons/CalendarClock.vue":
/*!******************************************************************!*\
  !*** ./node_modules/vue-material-design-icons/CalendarClock.vue ***!
  \******************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _CalendarClock_vue_vue_type_template_id_7fe8b4f4___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./CalendarClock.vue?vue&type=template&id=7fe8b4f4& */ "./node_modules/vue-material-design-icons/CalendarClock.vue?vue&type=template&id=7fe8b4f4&");
/* harmony import */ var _CalendarClock_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./CalendarClock.vue?vue&type=script&lang=js& */ "./node_modules/vue-material-design-icons/CalendarClock.vue?vue&type=script&lang=js&");
...
var component = (0,_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _CalendarClock_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _CalendarClock_vue_vue_type_template_id_7fe8b4f4___WEBPACK_IMPORTED_MODULE_0__.render,
  _CalendarClock_vue_vue_type_template_id_7fe8b4f4___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "node_modules/vue-material-design-icons/CalendarClock.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./node_modules/vue-loader/lib/index.js??vue-loader-options!./node_modules/vue-material-design-icons/CalendarClock.vue?vue&type=script&lang=js&":
/*!******************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/index.js??vue-loader-options!./node_modules/vue-material-design-icons/CalendarClock.vue?vue&type=script&lang=js& ***!
  \******************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/***/ "./node_modules/vue-material-design-icons/CloseCircleOutline.vue":
/*!***********************************************************************!*\
  !*** ./node_modules/vue-material-design-icons/CloseCircleOutline.vue ***!
  \***********************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _CloseCircleOutline_vue_vue_type_template_id_2602a466___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./CloseCircleOutline.vue?vue&type=template&id=2602a466& */ "./node_modules/vue-material-design-icons/CloseCircleOutline.vue?vue&type=template&id=2602a466&");
/* harmony import */ var _CloseCircleOutline_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./CloseCircleOutline.vue?vue&type=script&lang=js& */ "./node_modules/vue-material-design-icons/CloseCircleOutline.vue?vue&type=script&lang=js&");
/* harmony import */ var _vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! !../vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
;
var component = (0,_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_2__["default"])(
  _CloseCircleOutline_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__["default"],
  _CloseCircleOutline_vue_vue_type_template_id_2602a466___WEBPACK_IMPORTED_MODULE_0__.render,
  _CloseCircleOutline_vue_vue_type_template_id_2602a466___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns,
  false,
  null,
  null,
  null
...
/* hot reload */
if (false) { var api; }
component.options.__file = "node_modules/vue-material-design-icons/CloseCircleOutline.vue"
/* harmony default export */ __webpack_exports__["default"] = (component.exports);

/***/ }),

/***/ "./node_modules/vue-loader/lib/index.js??vue-loader-options!./node_modules/vue-material-design-icons/CloseCircleOutline.vue?vue&type=script&lang=js&":
/*!***********************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/index.js??vue-loader-options!./node_modules/vue-material-design-icons/CloseCircleOutline.vue?vue&type=script&lang=js& ***!
  \***********************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _node_modules_babel_loader_lib_index_js_node_modules_ts_loader_index_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_index_js_vue_loader_options_SetReminderActions_vue_vue_type_script_lang_ts___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js!../../../../node_modules/ts-loader/index.js??clonedRuleSet-4.use[1]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./SetReminderActions.vue?vue&type=script&lang=ts& */ "./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-4.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/files_reminders/src/components/SetReminderActions.vue?vue&type=script&lang=ts&");
 /* harmony default export */ __webpack_exports__["default"] = (_node_modules_babel_loader_lib_index_js_node_modules_ts_loader_index_js_clonedRuleSet_4_use_1_node_modules_vue_loader_lib_index_js_vue_loader_options_SetReminderActions_vue_vue_type_script_lang_ts___WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_lib_index_js_vue_loader_options_SetReminderActions_vue_vue_type_template_id_7f799cd2_scoped_true___WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _node_modules_babel_loader_lib_index_js_node_modules_vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_node_modules_vue_loader_lib_index_js_vue_loader_options_SetReminderActions_vue_vue_type_template_id_7f799cd2_scoped_true___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
...
/***/ "./node_modules/vue-material-design-icons/CalendarClock.vue?vue&type=script&lang=js&":
/*!*******************************************************************************************!*\
  !*** ./node_modules/vue-material-design-icons/CalendarClock.vue?vue&type=script&lang=js& ***!
  \*******************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _vue_loader_lib_index_js_vue_loader_options_CalendarClock_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../vue-loader/lib/index.js??vue-loader-options!./CalendarClock.vue?vue&type=script&lang=js& */ "./node_modules/vue-loader/lib/index.js??vue-loader-options!./node_modules/vue-material-design-icons/CalendarClock.vue?vue&type=script&lang=js&");
 /* harmony default export */ __webpack_exports__["default"] = (_vue_loader_lib_index_js_vue_loader_options_CalendarClock_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./node_modules/vue-material-design-icons/CloseCircleOutline.vue?vue&type=script&lang=js&":
/*!************************************************************************************************!*\
  !*** ./node_modules/vue-material-design-icons/CloseCircleOutline.vue?vue&type=script&lang=js& ***!
  \************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _vue_loader_lib_index_js_vue_loader_options_CloseCircleOutline_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../vue-loader/lib/index.js??vue-loader-options!./CloseCircleOutline.vue?vue&type=script&lang=js& */ "./node_modules/vue-loader/lib/index.js??vue-loader-options!./node_modules/vue-material-design-icons/CloseCircleOutline.vue?vue&type=script&lang=js&");
 /* harmony default export */ __webpack_exports__["default"] = (_vue_loader_lib_index_js_vue_loader_options_CloseCircleOutline_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__["default"]); 

/***/ }),

/***/ "./node_modules/vue-material-design-icons/CalendarClock.vue?vue&type=template&id=7fe8b4f4&":
/*!*************************************************************************************************!*\
  !*** ./node_modules/vue-material-design-icons/CalendarClock.vue?vue&type=template&id=7fe8b4f4& ***!
  \*************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_vue_loader_lib_index_js_vue_loader_options_CalendarClock_vue_vue_type_template_id_7fe8b4f4___WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_vue_loader_lib_index_js_vue_loader_options_CalendarClock_vue_vue_type_template_id_7fe8b4f4___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_vue_loader_lib_index_js_vue_loader_options_CalendarClock_vue_vue_type_template_id_7fe8b4f4___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!../vue-loader/lib/index.js??vue-loader-options!./CalendarClock.vue?vue&type=template&id=7fe8b4f4& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./node_modules/vue-material-design-icons/CalendarClock.vue?vue&type=template&id=7fe8b4f4&");


/***/ }),

/***/ "./node_modules/vue-material-design-icons/CloseCircleOutline.vue?vue&type=template&id=2602a466&":
/*!******************************************************************************************************!*\
  !*** ./node_modules/vue-material-design-icons/CloseCircleOutline.vue?vue&type=template&id=2602a466& ***!
  \******************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   render: function() { return /* reexport safe */ _vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_vue_loader_lib_index_js_vue_loader_options_CloseCircleOutline_vue_vue_type_template_id_2602a466___WEBPACK_IMPORTED_MODULE_0__.render; },
/* harmony export */   staticRenderFns: function() { return /* reexport safe */ _vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_vue_loader_lib_index_js_vue_loader_options_CloseCircleOutline_vue_vue_type_template_id_2602a466___WEBPACK_IMPORTED_MODULE_0__.staticRenderFns; }
/* harmony export */ });
/* harmony import */ var _vue_loader_lib_loaders_templateLoader_js_ruleSet_1_rules_3_vue_loader_lib_index_js_vue_loader_options_CloseCircleOutline_vue_vue_type_template_id_2602a466___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!../vue-loader/lib/index.js??vue-loader-options!./CloseCircleOutline.vue?vue&type=template&id=2602a466& */ "./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./node_modules/vue-material-design-icons/CloseCircleOutline.vue?vue&type=template&id=2602a466&");


/***/ }),

/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./node_modules/vue-material-design-icons/CalendarClock.vue?vue&type=template&id=7fe8b4f4&":
/*!*****************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./node_modules/vue-material-design-icons/CalendarClock.vue?vue&type=template&id=7fe8b4f4& ***!
  \*****************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function render() {
  ...
  return _c(
    ...
    _vm._b(
      {
        staticClass: "material-design-icon calendar-clock-icon",
        attrs: {
...
/***/ "./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./node_modules/vue-material-design-icons/CloseCircleOutline.vue?vue&type=template&id=2602a466&":
/*!**********************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/vue-loader/lib/loaders/templateLoader.js??ruleSet[1].rules[3]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./node_modules/vue-material-design-icons/CloseCircleOutline.vue?vue&type=template&id=2602a466& ***!
  \**********************************************************************************************************************************************************************************************************************************************/
/***/ (function(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
var render = function render() {
  ...
  return _c(
    ...
    _vm._b(
      {
        staticClass: "material-design-icon close-circle-outline-icon",
        attrs: {
          "aria-hidden": !_vm.title,
          "aria-label": _vm.title,
          role: "img",
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["core-common"], function() { return __webpack_require__("./apps/files_reminders/src/main.ts"); })
/******/ 	__webpack_exports__ = __webpack_require__.O(__webpack_exports__);
/******/ 	
/******/ })()
;
//# sourceMappingURL=files_reminders-main.js.map?v=9b27adc13e6a5337df97