...
/* harmony import */ var _services_Templates_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../services/Templates.js */ "./apps/files/src/services/Templates.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_9__.defineComponent)({
  ...
  methods: {
    ...
    async open(name, provider) {
      ...
      const templates = await (0,_services_Templates_js__WEBPACK_IMPORTED_MODULE_14__.getTemplates)();
    ...
    async createFile(templateFields = []) {
      ...
      if (this.nameWithoutExt === this.name) {
        _utils_logger_ts__WEBPACK_IMPORTED_MODULE_15__.logger.warn('Fixed invalid filename', {
          name: this.name,
      ...
      if ((0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_0__.getCurrentUser)() === null) {
        ...
        _utils_logger_ts__WEBPACK_IMPORTED_MODULE_15__.logger.debug('Created new file', {
        ...
        try {
          const fileInfo = await (0,_services_Templates_js__WEBPACK_IMPORTED_MODULE_14__.createFromTemplate)((0,path__WEBPACK_IMPORTED_MODULE_8__.normalize)(`${currentDirectory}/${this.name}`), this.selectedTemplate?.filename ?? '', this.selectedTemplate?.templateType ?? '', templateFields);
          _utils_logger_ts__WEBPACK_IMPORTED_MODULE_15__.logger.debug('Created new file', {
            fileInfo
          });
          ...
          _utils_logger_ts__WEBPACK_IMPORTED_MODULE_15__.logger.error('Error while creating the new file from template', {
            error
          });
    ...
    async onSubmit() {
      ...
      if (fileId && fileId !== this.emptyTemplate.fileid) {
        fields = await (0,_services_Templates_js__WEBPACK_IMPORTED_MODULE_14__.getTemplateFields)(fileId);
      }
      if (fields.length > 0) {
...
//# sourceMappingURL=apps_files_src_views_TemplatePicker_vue-apps_files_src_views_TemplatePicker_vue.js.map?v=769b4483c34398f99b17