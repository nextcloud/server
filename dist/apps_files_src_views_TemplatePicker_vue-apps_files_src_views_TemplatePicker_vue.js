...
/* harmony import */ var _nextcloud_vue_components_NcEmptyContent__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @nextcloud/vue/components/NcEmptyContent */ "./node_modules/@nextcloud/vue/dist/Components/NcEmptyContent.mjs");
/* harmony import */ var _nextcloud_vue_components_NcModal__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @nextcloud/vue/components/NcModal */ "./node_modules/@nextcloud/vue/dist/Components/NcModal.mjs");
/* harmony import */ var _components_TemplatePreview_vue__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ../components/TemplatePreview.vue */ "./apps/files/src/components/TemplatePreview.vue");
...
/* harmony import */ var _logger_ts__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ../logger.ts */ "./apps/files/src/logger.ts");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_7__.defineComponent)({
  name: 'TemplatePicker',
  components: {
    NcEmptyContent: _nextcloud_vue_components_NcEmptyContent__WEBPACK_IMPORTED_MODULE_9__["default"],
    NcModal: _nextcloud_vue_components_NcModal__WEBPACK_IMPORTED_MODULE_10__["default"],
    TemplatePreview: _components_TemplatePreview_vue__WEBPACK_IMPORTED_MODULE_11__["default"]
  },
  props: {
    /**
  ...
  methods: {
    ...
    async createFile() {
      ...
      if (this.nameWithoutExt === this.name) {
        _logger_ts__WEBPACK_IMPORTED_MODULE_13__["default"].warn('Fixed invalid filename', {
          name: this.name,
      ...
      try {
        const fileInfo = await (0,_services_Templates_js__WEBPACK_IMPORTED_MODULE_8__.createFromTemplate)((0,path__WEBPACK_IMPORTED_MODULE_6__.normalize)(`${currentDirectory}/${this.name}`), this.selectedTemplate?.filename ?? '', this.selectedTemplate?.templateType ?? '', templateFields);
        _logger_ts__WEBPACK_IMPORTED_MODULE_13__["default"].debug('Created new file', fileInfo);
        ...
        _logger_ts__WEBPACK_IMPORTED_MODULE_13__["default"].error('Error while creating the new file from template', {
          error
        });
    ...
    async onSubmit() {
      ...
      if (fileId && fileId !== this.emptyTemplate.fileid) {
        fields = await (0,_services_Templates_js__WEBPACK_IMPORTED_MODULE_8__.getTemplateFields)(fileId);
      }
      if (fields.length > 0) {
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_1__.spawnDialog)(_components_TemplateFiller_vue__WEBPACK_IMPORTED_MODULE_12__["default"], {
          fields,
...
//# sourceMappingURL=apps_files_src_views_TemplatePicker_vue-apps_files_src_views_TemplatePicker_vue.js.map?v=8034a0e7f970992f72fb