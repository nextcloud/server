(globalThis["webpackChunknextcloud_ui_legacy"] = globalThis["webpackChunknextcloud_ui_legacy"] || []).push([["node_modules_nextcloud_dialogs_dist_chunks_PublicAuthPrompt-7_GNN76e_mjs"],{
...
/***/ "./node_modules/@nextcloud/dialogs/dist/chunks/PublicAuthPrompt-7_GNN76e.mjs"
/*!***********************************************************************************!*\
  !*** ./node_modules/@nextcloud/dialogs/dist/chunks/PublicAuthPrompt-7_GNN76e.mjs ***!
  \***********************************************************************************/
...
/* harmony import */ var _index_C1xmmKTZ_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./index-C1xmmKTZ.mjs */ "./node_modules/@nextcloud/dialogs/dist/chunks/index-C1xmmKTZ.mjs");
...
function getGuestNameValidity(name) {
  if (name.trim() === "") {
    return (0,_index_C1xmmKTZ_mjs__WEBPACK_IMPORTED_MODULE_6__.t)("Names must not be empty.");
  }
  if (name.startsWith(".")) {
    return (0,_index_C1xmmKTZ_mjs__WEBPACK_IMPORTED_MODULE_6__.t)("Names must not start with a dot.");
  }
  if (name.length > 64) {
    return (0,_index_C1xmmKTZ_mjs__WEBPACK_IMPORTED_MODULE_6__.t)("Names may be at most 64 characters long.");
  }
  try {
    ...
    switch (error.reason) {
      case _nextcloud_files__WEBPACK_IMPORTED_MODULE_7__.InvalidFilenameErrorReason.Character:
        return (0,_index_C1xmmKTZ_mjs__WEBPACK_IMPORTED_MODULE_6__.t)('"{char}" is not allowed inside a name.', { char: error.segment });
      case _nextcloud_files__WEBPACK_IMPORTED_MODULE_7__.InvalidFilenameErrorReason.ReservedName:
        return (0,_index_C1xmmKTZ_mjs__WEBPACK_IMPORTED_MODULE_6__.t)('"{segment}" is a reserved name and not allowed.', { segment: error.segment });
      case _nextcloud_files__WEBPACK_IMPORTED_MODULE_7__.InvalidFilenameErrorReason.Extension:
        if (error.segment.match(/\.[a-z]/i)) {
          return (0,_index_C1xmmKTZ_mjs__WEBPACK_IMPORTED_MODULE_6__.t)('"{extension}" is not an allowed name.', { extension: error.segment });
        }
        return (0,_index_C1xmmKTZ_mjs__WEBPACK_IMPORTED_MODULE_6__.t)('Names must not end with "{extension}".', { extension: error.segment });
      default:
        return (0,_index_C1xmmKTZ_mjs__WEBPACK_IMPORTED_MODULE_6__.t)("Invalid name.");
    }
  }
}
const _hoisted_1 = {
...
const _sfc_main = /* @__PURE__ */ (0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  ...
  props: {
    nickname: { default: "" },
    title: { default: (0,_index_C1xmmKTZ_mjs__WEBPACK_IMPORTED_MODULE_6__.t)("Guest identification") },
    text: { default: "" },
    notice: { default: "" },
    submitLabel: { default: (0,_index_C1xmmKTZ_mjs__WEBPACK_IMPORTED_MODULE_6__.t)("Submit name") },
  ...
  setup(__props, { emit: __emit }) {
    ...
    const buttons = (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(() => {
      const cancelButton = {
        label: (0,_index_C1xmmKTZ_mjs__WEBPACK_IMPORTED_MODULE_6__.t)("Cancel"),
        variant: "tertiary",
        callback: () => emit("close")
      };
      const submitButton = {
    ...
    const defaultNotice = (0,vue__WEBPACK_IMPORTED_MODULE_0__.computed)(() => {
      ...
      if (name.value) {
        return (0,_index_C1xmmKTZ_mjs__WEBPACK_IMPORTED_MODULE_6__.t)("You are currently identified as {nickname}.", { nickname: name.value });
      }
      return (0,_index_C1xmmKTZ_mjs__WEBPACK_IMPORTED_MODULE_6__.t)("You are currently not identified.");
    });
    function onSubmit() {
      ...
      if (nickname === "") {
        setCustomValidity((0,_index_C1xmmKTZ_mjs__WEBPACK_IMPORTED_MODULE_6__.t)("You cannot leave the name empty."));
        return;
      }
      if (nickname.length < 2) {
        setCustomValidity((0,_index_C1xmmKTZ_mjs__WEBPACK_IMPORTED_MODULE_6__.t)("Please enter a name with at least 2 characters."));
        return;
      }
      try {
        (0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_1__.setGuestNickname)(nickname);
      } catch (error) {
        _index_C1xmmKTZ_mjs__WEBPACK_IMPORTED_MODULE_6__.l.error("Failed to set nickname", { error });
        (0,_index_C1xmmKTZ_mjs__WEBPACK_IMPORTED_MODULE_6__.s)((0,_index_C1xmmKTZ_mjs__WEBPACK_IMPORTED_MODULE_6__.t)("Failed to set nickname."));
      ...
      return (0,vue__WEBPACK_IMPORTED_MODULE_0__.openBlock)(), (0,vue__WEBPACK_IMPORTED_MODULE_0__.createBlock)((0,vue__WEBPACK_IMPORTED_MODULE_0__.unref)(_nextcloud_vue_components_NcDialog__WEBPACK_IMPORTED_MODULE_3__["default"]), {
        ...
        default: (0,vue__WEBPACK_IMPORTED_MODULE_0__.withCtx)(() => [
          ...
          (0,vue__WEBPACK_IMPORTED_MODULE_0__.createVNode)((0,vue__WEBPACK_IMPORTED_MODULE_0__.unref)(_nextcloud_vue_components_NcTextField__WEBPACK_IMPORTED_MODULE_5__["default"]), {
            ...
            label: (0,vue__WEBPACK_IMPORTED_MODULE_0__.unref)(_index_C1xmmKTZ_mjs__WEBPACK_IMPORTED_MODULE_6__.t)("Name"),
            placeholder: (0,vue__WEBPACK_IMPORTED_MODULE_0__.unref)(_index_C1xmmKTZ_mjs__WEBPACK_IMPORTED_MODULE_6__.t)("Enter your name"),
...
const PublicAuthPrompt = /* @__PURE__ */ (0,_plugin_vue_export_helper_1tPrXgE0_mjs__WEBPACK_IMPORTED_MODULE_8__._)(_sfc_main, [["__scopeId", "data-v-bd4b7f1b"]]);
...
//# sourceMappingURL=node_modules_nextcloud_dialogs_dist_chunks_PublicAuthPrompt-7_GNN76e_mjs-node_modules_nextcloud_dialogs_dist_chunks_PublicAuthPrompt-7_GNN76e_mjs.js.map?v=b2479474dfc9749ea9d0