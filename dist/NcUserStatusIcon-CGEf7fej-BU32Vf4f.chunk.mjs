import{c as T}from"./index-CJnHA-ay.chunk.mjs";import{a as p,l as q}from"./NcNoteCard-CVhtNL04-BVjiKsjs.chunk.mjs";import{f as l,A as g,j as h,k as w,i as s,m as f,u as x,s as o,n as m,g as y,B as b,C as D,o as B,D as I}from"./_plugin-vue_export-helper-CHk-KayZ.chunk.mjs";const S=`<!--
...
`;l(),l(g);function M(a){switch(a){case"away":return s("away");case"busy":return s("busy");case"dnd":return s("do not disturb");case"online":return s("online");case"invisible":return s("invisible");case"offline":return s("offline");default:return a}}const C=["aria-hidden","aria-label","innerHTML"],L=w({__name:"NcUserStatusIcon",props:f({user:{default:void 0},ariaHidden:{type:[Boolean,String],default:!1}},{status:{},statusModifiers:{}}),emits:["update:status"],setup(a){const e=x(a,"status"),i=a,v=o(()=>e.value&&["invisible","offline"].includes(e.value)),n=o(()=>e.value&&(!i.ariaHidden||i.ariaHidden==="false")?s("User status: {status}",{status:M(e.value)}):void 0);m(()=>i.user,async r=>{if(!e.value&&r&&p()?.user_status?.enabled)try{const{data:t}=await T.get(y("/apps/user_status/api/v1/statuses/{user}",{user:r}));e.value=t.ocs?.data?.status}catch(t){q.debug("Error while fetching user status",{error:t})}},{immediate:!0});const c={online:Z,away:S,busy:P,dnd:X,invisible:u,offline:u},d=o(()=>e.value&&c[e.value]);return(r,t)=>e.value?(B(),b("span",{key:0,class:I(["user-status-icon",{"user-status-icon--invisible":v.value}]),"aria-hidden":!n.value||void 0,"aria-label":n.value,role:"img",innerHTML:d.value},null,10,C)):D("",!0)}}),F=h(L,[["__scopeId","data-v-881a79fb"]]);export{F as N,M as g};
//# sourceMappingURL=NcUserStatusIcon-CGEf7fej-BU32Vf4f.chunk.mjs.map
