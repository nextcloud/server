...
const Dashboard = vue__WEBPACK_IMPORTED_MODULE_2__["default"].extend(_DashboardApp_vue__WEBPACK_IMPORTED_MODULE_3__["default"]);
...
const logger = (0,_nextcloud_logger__WEBPACK_IMPORTED_MODULE_0__.getLoggerBuilder)().detectLogLevel().setApp('dashboard').build();

/***/ },

/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-6.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/dashboard/src/components/ApiDashboardWidgetItem.vue?vue&type=script&setup=true&lang=ts"
/*!*******************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-6.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/dashboard/src/components/ApiDashboardWidgetItem.vue?vue&type=script&setup=true&lang=ts ***!
  \*******************************************************************************************************************************************************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _nextcloud_vue_components_NcDashboardWidgetItem__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @nextcloud/vue/components/NcDashboardWidgetItem */ "./node_modules/@nextcloud/vue/dist/Components/NcDashboardWidgetItem.mjs");
/* harmony import */ var vue_material_design_icons_File_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! vue-material-design-icons/File.vue */ "./node_modules/vue-material-design-icons/File.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  ...
  setup(__props) {
     ...
     */
    const loadingImageFailed = (0,vue__WEBPACK_IMPORTED_MODULE_0__.ref)(false);
    return {
      __sfc: true,
      imageLoaded,
      loadingImageFailed,
      NcAvatar: _nextcloud_vue_components_NcAvatar__WEBPACK_IMPORTED_MODULE_1__["default"],
      NcDashboardWidgetItem: _nextcloud_vue_components_NcDashboardWidgetItem__WEBPACK_IMPORTED_MODULE_2__["default"],
      IconFile: vue_material_design_icons_File_vue__WEBPACK_IMPORTED_MODULE_3__["default"]
    };
  }
}));
...
/* harmony import */ var _nextcloud_vue_components_NcUserStatusIcon__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! @nextcloud/vue/components/NcUserStatusIcon */ "./node_modules/@nextcloud/vue/dist/Components/NcUserStatusIcon.mjs");
...
/* harmony import */ var _logger_ts__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./logger.ts */ "./apps/dashboard/src/logger.ts");
/* harmony import */ var _mixins_isMobile_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./mixins/isMobile.js */ "./apps/dashboard/src/mixins/isMobile.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    ...
    NcUserStatusIcon: _nextcloud_vue_components_NcUserStatusIcon__WEBPACK_IMPORTED_MODULE_8__["default"]
  },
  mixins: [_mixins_isMobile_js__WEBPACK_IMPORTED_MODULE_12__["default"]],
  setup() {
    return {
  ...
  data() {
    return {
      isAdmin: (0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_0__.getCurrentUser)().isAdmin,
      timer: new Date(),
      registeredStatus: [],
      callbacks: {},
      callbacksStatus: {},
      ...
      panels,
      firstRun,
      displayName: (0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_0__.getCurrentUser)()?.displayName,
      uid: (0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_0__.getCurrentUser)()?.uid,
      layout: (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_2__.loadState)('dashboard', 'layout').filter(panelId => panels[panelId]),
      modal: false,
      appStoreUrl: (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_3__.generateUrl)('/settings/apps/dashboard'),
    ...
    callbacksStatus() {
      for (const app in this.callbacksStatus) {
        ...
        if (element) {
          ...
          vue__WEBPACK_IMPORTED_MODULE_4__["default"].set(this.statuses, app, {
            mounted: true
          });
        } else {
          _logger_ts__WEBPACK_IMPORTED_MODULE_11__.logger.error('Failed to register panel in the frontend as no backend data was provided for ' + app);
        }
      }
    }
  },
  ...
  methods: {
    ...
    register(app, callback) {
      vue__WEBPACK_IMPORTED_MODULE_4__["default"].set(this.callbacks, app, callback);
    },
    registerStatus(app, callback) {
      // always save callbacks in case user enables the status later
      vue__WEBPACK_IMPORTED_MODULE_4__["default"].set(this.allCallbacksStatus, app, callback);
      // register only if status is enabled or missing from config
      if (this.isStatusActive(app)) {
        this.registeredStatus.push(app);
        this.$nextTick(() => {
          vue__WEBPACK_IMPORTED_MODULE_4__["default"].set(this.callbacksStatus, app, callback);
        });
      }
    },
    rerenderPanels() {
      for (const app in this.callbacks) {
        ...
        if (element) {
          ...
          vue__WEBPACK_IMPORTED_MODULE_4__["default"].set(this.panels[app], 'mounted', true);
        } else {
          _logger_ts__WEBPACK_IMPORTED_MODULE_11__.logger.error('Failed to register panel in the frontend as no backend data was provided for ' + app);
        }
      }
    ...
    saveLayout() {
      _nextcloud_axios__WEBPACK_IMPORTED_MODULE_1__["default"].post((0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_3__.generateOcsUrl)('/apps/dashboard/api/v3/layout'), {
        layout: this.layout
      });
    },
    saveStatuses() {
      _nextcloud_axios__WEBPACK_IMPORTED_MODULE_1__["default"].post((0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_3__.generateOcsUrl)('/apps/dashboard/api/v3/statuses'), {
    ...
    updateCheckbox(panel, currentValue) {
      ...
      vue__WEBPACK_IMPORTED_MODULE_4__["default"].set(this.panels[panel.id], 'mounted', false);
      this.saveLayout();
    ...
    disableStatus(app) {
      ...
      if (j !== -1) {
        ...
        this.$nextTick(() => {
          vue__WEBPACK_IMPORTED_MODULE_4__["default"].delete(this.callbacksStatus, app);
        });
      }
      this.saveStatuses();
    },
    ...
    async fetchApiWidgets() {
      const {
        data
      } = await _nextcloud_axios__WEBPACK_IMPORTED_MODULE_1__["default"].get((0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_3__.generateOcsUrl)('/apps/dashboard/api/v1/widgets'));
      this.apiWidgets = data.ocs.data;
    },
    async fetchApiWidgetItems(widgetIds, merge = false) {
      try {
        const url = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_3__.generateOcsUrl)('/apps/dashboard/api/v2/widget-items');
        const params = new URLSearchParams(widgetIds.map(id => ['widgets[]', id]));
        const response = await _nextcloud_axios__WEBPACK_IMPORTED_MODULE_1__["default"].get(`${url}?${params.toString()}`);
...
var render = function render() {
  ...
  }, [_c("h2", [_vm._v(_vm._s(_vm.greeting.text))]), _vm._v(" "), _vm.sortedRegisteredStatus.length > 0 ? _c("ul", {
  ...
  }), 0) : _vm._e(), _vm._v(" "), _c("Draggable", _vm._b({
    staticClass: "panels",
    attrs: {
      handle: ".panel--header"
    },
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_node_modules_ts_loader_index_js_clonedRuleSet_6_use_1_node_modules_vue_loader_lib_index_js_vue_loader_options_ApiDashboardWidgetItem_vue_vue_type_script_setup_true_lang_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js!../../../../node_modules/ts-loader/index.js??clonedRuleSet-6.use[1]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./ApiDashboardWidgetItem.vue?vue&type=script&setup=true&lang=ts */ "./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-6.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/dashboard/src/components/ApiDashboardWidgetItem.vue?vue&type=script&setup=true&lang=ts");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_node_modules_ts_loader_index_js_clonedRuleSet_6_use_1_node_modules_vue_loader_lib_index_js_vue_loader_options_ApiDashboardWidgetItem_vue_vue_type_script_setup_true_lang_ts__WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* reexport safe */ _chunks_NcDashboardWidget_CrInkRLf_mjs__WEBPACK_IMPORTED_MODULE_0__.N)
/* harmony export */ });
/* harmony import */ var _chunks_NcDashboardWidget_CrInkRLf_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../chunks/NcDashboardWidget-CrInkRLf.mjs */ "./node_modules/@nextcloud/vue/dist/chunks/NcDashboardWidget-CrInkRLf.mjs");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* reexport safe */ _chunks_NcDashboardWidgetItem_DwvrP3Fa_mjs__WEBPACK_IMPORTED_MODULE_0__.N)
/* harmony export */ });
/* harmony import */ var _chunks_NcDashboardWidgetItem_DwvrP3Fa_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../chunks/NcDashboardWidgetItem-DwvrP3Fa.mjs */ "./node_modules/@nextcloud/vue/dist/chunks/NcDashboardWidgetItem-DwvrP3Fa.mjs");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* reexport safe */ _chunks_NcUserStatusIcon_BjrsTrss_mjs__WEBPACK_IMPORTED_MODULE_0__.N)
/* harmony export */ });
/* harmony import */ var _chunks_NcUserStatusIcon_BjrsTrss_mjs__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../chunks/NcUserStatusIcon-BjrsTrss.mjs */ "./node_modules/@nextcloud/vue/dist/chunks/NcUserStatusIcon-BjrsTrss.mjs");
...
/******/ })()
;
//# sourceMappingURL=dashboard-main.js.map?v=43dc0c4b20ffc9fc3e9e