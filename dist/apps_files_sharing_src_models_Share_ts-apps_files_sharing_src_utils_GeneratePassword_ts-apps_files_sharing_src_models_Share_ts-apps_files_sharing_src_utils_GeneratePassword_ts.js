"use strict";
(globalThis["webpackChunknextcloud_ui_legacy"] = globalThis["webpackChunknextcloud_ui_legacy"] || []).push([["apps_files_sharing_src_models_Share_ts-apps_files_sharing_src_utils_GeneratePassword_ts"],{
...
/* harmony export */ });
/* harmony import */ var _services_logger_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../services/logger.ts */ "./apps/files_sharing/src/services/logger.ts");
/* harmony import */ var _services_SharingService_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../services/SharingService.ts */ "./apps/files_sharing/src/services/SharingService.ts");
...
class Share {
  ...
  constructor(ocsData) {
    ...
    if (ocsData.attributes && typeof ocsData.attributes === 'string') {
      try {
        ...
        _services_logger_ts__WEBPACK_IMPORTED_MODULE_0__["default"].warn('Could not parse share attributes returned by server', ocsData.attributes);
      }
    }
   ...
   */
  get hideDownload() {
    return this._share.hide_download === true || this.attributes.find?.(({
      scope,
      key,
      value
    }) => scope === 'permissions' && key === 'download' && !value) !== undefined;
  }
  /**
   * Hide the download button on public page
   */
   ...
   */
  get isFileRequest() {
    return (0,_services_SharingService_ts__WEBPACK_IMPORTED_MODULE_1__.isFileRequest)(JSON.stringify(this.attributes));
  }
...
/* harmony import */ var _services_ConfigService_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/ConfigService.ts */ "./apps/files_sharing/src/services/ConfigService.ts");
/* harmony import */ var _services_logger_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../services/logger.ts */ "./apps/files_sharing/src/services/logger.ts");
/**
...
const config = new _services_ConfigService_ts__WEBPACK_IMPORTED_MODULE_3__["default"]();
  ...
  if (config.passwordPolicy.api && config.passwordPolicy.api.generate) {
    try {
      ...
      if (request.data.ocs.data.password) {
        if (verbose) {
          (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_1__.showSuccess)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.t)('files_sharing', 'Password created successfully'));
        }
        return request.data.ocs.data.password;
      }
    } catch (error) {
      _services_logger_ts__WEBPACK_IMPORTED_MODULE_4__["default"].info('Error generating password from password_policy', {
        error
      });
      if (verbose) {
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_1__.showError)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.t)('files_sharing', 'Error generating password from password policy'));
      }
    }
  }
...
//# sourceMappingURL=apps_files_sharing_src_models_Share_ts-apps_files_sharing_src_utils_GeneratePassword_ts-apps_files_sharing_src_models_Share_ts-apps_files_sharing_src_utils_GeneratePassword_ts.js.map?v=f24c78273557c39131e6