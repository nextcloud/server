...
/* harmony import */ var _components_BasicSettings_BackgroundJob_vue__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/BasicSettings/BackgroundJob.vue */ "./apps/settings/src/components/BasicSettings/BackgroundJob.vue");
...
vue__WEBPACK_IMPORTED_MODULE_3__["default"].mixin({
  props: {
    logger: _logger_ts__WEBPACK_IMPORTED_MODULE_6__["default"]
  },
  methods: {
    t: _nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.translate
  }
});
const BackgroundJobView = vue__WEBPACK_IMPORTED_MODULE_3__["default"].extend(_components_BasicSettings_BackgroundJob_vue__WEBPACK_IMPORTED_MODULE_4__["default"]);
new BackgroundJobView().$mount('#vue-admin-background-job');
if (profileEnabledGlobally) {
  const ProfileSettingsView = vue__WEBPACK_IMPORTED_MODULE_3__["default"].extend(_components_BasicSettings_ProfileSettings_vue__WEBPACK_IMPORTED_MODULE_5__["default"]);
...
/* harmony export */   saveProfilePicker: () => (/* binding */ saveProfilePicker)
/* harmony export */ });
/* harmony import */ var _nextcloud_auth__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @nextcloud/auth */ "./node_modules/@nextcloud/auth/dist/index.mjs");
 ...
 * @return {object}
 */
async function saveProfileParameterVisibility(paramId, visibility) {
  const userId = (0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_0__.getCurrentUser)().uid;
  const url = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_3__.generateOcsUrl)('/profile/{userId}', {
    userId
  });
  await (0,_nextcloud_password_confirmation__WEBPACK_IMPORTED_MODULE_2__.confirmPassword)();
  const res = await _nextcloud_axios__WEBPACK_IMPORTED_MODULE_1__["default"].put(url, {
    paramId,
    visibility
  });
  return res.data;
 ...
 * @return {object}
 */
async function saveProfileDefault(isEnabled) {
  // Convert to string for compatibility
  isEnabled = isEnabled ? '1' : '0';
  const url = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_3__.generateOcsUrl)('/apps/provisioning_api/api/v1/config/apps/{appId}/{key}', {
    appId: 'settings',
    key: 'profile_enabled_by_default'
  });
  await (0,_nextcloud_password_confirmation__WEBPACK_IMPORTED_MODULE_2__.confirmPassword)();
  const res = await _nextcloud_axios__WEBPACK_IMPORTED_MODULE_1__["default"].post(url, {
    value: isEnabled
  });
  return res.data;
}
 ...
 * @return {object}
 */
async function saveProfilePicker(isEnabled) {
  // Convert to string for compatibility
  isEnabled = isEnabled ? '1' : '0';
  const url = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_3__.generateOcsUrl)('/apps/provisioning_api/api/v1/config/apps/{appId}/{key}', {
    appId: 'settings',
...
const lastCron = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_2__.loadState)('settings', 'lastCron');
const cronMaxAge = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_2__.loadState)('settings', 'cronMaxAge', '');
const backgroundJobsMode = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_2__.loadState)('settings', 'backgroundJobsMode', 'cron');
const cliBasedCronPossible = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_2__.loadState)('settings', 'cliBasedCronPossible', true);
const cliBasedCronUser = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_2__.loadState)('settings', 'cliBasedCronUser', 'www-data');
const backgroundJobsDocUrl = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_2__.loadState)('settings', 'backgroundJobsDocUrl');
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data() {
    return {
      ...
      relativeTime: (0,_nextcloud_moment__WEBPACK_IMPORTED_MODULE_3__["default"])(lastCron * 1000).fromNow(),
      maxAgeRelativeTime: (0,_nextcloud_moment__WEBPACK_IMPORTED_MODULE_3__["default"])(cronMaxAge * 1000).fromNow()
    };
  },
  computed: {
    cronLabel() {
  ...
  methods: {
    ...
    async handleResponse({
      ...
      if (status === 'ok') {
        ...
        _logger_ts__WEBPACK_IMPORTED_MODULE_9__["default"].error(errorMessage, error);
      }
    },
    async deleteError() {
...
/* harmony import */ var _service_ProfileService_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../service/ProfileService.js */ "./apps/settings/src/service/ProfileService.js");
...
const profileEnabledByDefault = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_1__.loadState)('settings', 'profileEnabledByDefault', true);
const profilePickerEnabled = (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_1__.loadState)('settings', 'profilePickerEnabled', true);
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  methods: {
    async onProfileDefaultChange(isEnabled) {
      if ((0,_utils_validate_js__WEBPACK_IMPORTED_MODULE_6__.validateBoolean)(isEnabled)) {
        await this.updateProfileDefault(isEnabled);
      }
    },
    async updateProfileDefault(isEnabled) {
      try {
        const responseData = await (0,_service_ProfileService_js__WEBPACK_IMPORTED_MODULE_5__.saveProfileDefault)(isEnabled);
        this.handleResponse({
          isEnabled,
    ...
    async updateProfilePicker(isEnabled) {
      try {
        const responseData = await (0,_service_ProfileService_js__WEBPACK_IMPORTED_MODULE_5__.saveProfilePicker)(isEnabled);
        this.handleResponse({
          isEnabled,
...
var render = function render() {
  ...
  return _c("NcSettingsSection", {
    ...
    on: {
      "update:modelValue": _vm.onBackgroundJobModeChanged
    },
    model: {
      value: _vm.backgroundJobsMode,
      callback: function ($$v) {
        _vm.backgroundJobsMode = $$v;
      },
      expression: "backgroundJobsMode"
    }
...
var render = function render() {
  ...
  return _c("div", {
    ...
    on: {
      "update:modelValue": _vm.onProfileDefaultChange
    },
    model: {
      value: _vm.initialProfileEnabledByDefault,
      callback: function ($$v) {
        _vm.initialProfileEnabledByDefault = $$v;
      },
      expression: "initialProfileEnabledByDefault"
    }
    ...
    on: {
      "update:modelValue": _vm.onProfilePickerChange
    },
    model: {
      value: _vm.initialProfilePickerEnabled,
      callback: function ($$v) {
        _vm.initialProfilePickerEnabled = $$v;
      },
      expression: "initialProfilePickerEnabled"
    }
  }, [_vm._v("\n\t\t" + _vm._s(_vm.t("settings", "Enable the profile picker")) + "\n\t")]), _vm._v(" "), _c("NcNoteCard", {
    attrs: {
      type: "info"
    }
  }, [_vm._v("\n\t\t" + _vm._s(_vm.t("settings", "Enable or disable the profile picker in the Smart Picker and the profile link previews.")) + "\n\t")])], 1);
};
var staticRenderFns = [];
render._withStripped = true;
...
var ___CSS_LOADER_EXPORT___ = _node_modules_css_loader_dist_runtime_api_js__WEBPACK_IMPORTED_MODULE_1___default()((_node_modules_css_loader_dist_runtime_noSourceMaps_js__WEBPACK_IMPORTED_MODULE_0___default()));
// Module
___CSS_LOADER_EXPORT___.push([module.id, `#profile-settings[data-v-5d2af286] {
  max-width: 600px;
}`, ""]);
// Exports
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (___CSS_LOADER_EXPORT___);
...
/* harmony import */ var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! !../../../../../node_modules/style-loader/dist/runtime/styleTagTransform.js */ "./node_modules/style-loader/dist/runtime/styleTagTransform.js");
/* harmony import */ var _node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_node_modules_style_loader_dist_runtime_styleTagTransform_js__WEBPACK_IMPORTED_MODULE_5__);
/* harmony import */ var _node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_ProfileSettings_vue_vue_type_style_index_0_id_5d2af286_scoped_true_lang_scss__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../../../../node_modules/css-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/sass-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./ProfileSettings.vue?vue&type=style&index=0&id=5d2af286&scoped=true&lang=scss */ "./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/sass-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/BasicSettings/ProfileSettings.vue?vue&type=style&index=0&id=5d2af286&scoped=true&lang=scss");
...
var update = _node_modules_style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_ProfileSettings_vue_vue_type_style_index_0_id_5d2af286_scoped_true_lang_scss__WEBPACK_IMPORTED_MODULE_6__["default"], options);




       /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_ProfileSettings_vue_vue_type_style_index_0_id_5d2af286_scoped_true_lang_scss__WEBPACK_IMPORTED_MODULE_6__["default"] && _node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_ProfileSettings_vue_vue_type_style_index_0_id_5d2af286_scoped_true_lang_scss__WEBPACK_IMPORTED_MODULE_6__["default"].locals ? _node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_ProfileSettings_vue_vue_type_style_index_0_id_5d2af286_scoped_true_lang_scss__WEBPACK_IMPORTED_MODULE_6__["default"].locals : undefined);
...
/* harmony import */ var _ProfileSettings_vue_vue_type_style_index_0_id_5d2af286_scoped_true_lang_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ProfileSettings.vue?vue&type=style&index=0&id=5d2af286&scoped=true&lang=scss */ "./apps/settings/src/components/BasicSettings/ProfileSettings.vue?vue&type=style&index=0&id=5d2af286&scoped=true&lang=scss");
/* harmony import */ var _node_modules_vue_loader_lib_runtime_componentNormalizer_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! !../../../../../node_modules/vue-loader/lib/runtime/componentNormalizer.js */ "./node_modules/vue-loader/lib/runtime/componentNormalizer.js");
...
/***/ "./apps/settings/src/components/BasicSettings/ProfileSettings.vue?vue&type=style&index=0&id=5d2af286&scoped=true&lang=scss"
/*!*********************************************************************************************************************************!*\
  !*** ./apps/settings/src/components/BasicSettings/ProfileSettings.vue?vue&type=style&index=0&id=5d2af286&scoped=true&lang=scss ***!
  \*********************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_style_loader_dist_cjs_js_node_modules_css_loader_dist_cjs_js_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_sass_loader_dist_cjs_js_node_modules_vue_loader_lib_index_js_vue_loader_options_ProfileSettings_vue_vue_type_style_index_0_id_5d2af286_scoped_true_lang_scss__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/style-loader/dist/cjs.js!../../../../../node_modules/css-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/loaders/stylePostLoader.js!../../../../../node_modules/sass-loader/dist/cjs.js!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./ProfileSettings.vue?vue&type=style&index=0&id=5d2af286&scoped=true&lang=scss */ "./node_modules/style-loader/dist/cjs.js!./node_modules/css-loader/dist/cjs.js!./node_modules/vue-loader/lib/loaders/stylePostLoader.js!./node_modules/sass-loader/dist/cjs.js!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/settings/src/components/BasicSettings/ProfileSettings.vue?vue&type=style&index=0&id=5d2af286&scoped=true&lang=scss");
...
/******/ })()
;
//# sourceMappingURL=settings-vue-settings-admin-basic-settings.js.map?v=01baa3232c9ebe9c9d18