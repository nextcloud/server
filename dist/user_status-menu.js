...
vue__WEBPACK_IMPORTED_MODULE_4__["default"].prototype.$t = t;
var mountPoint = document.getElementById('user_status-menu-entry');
var mountMenuEntry = function mountMenuEntry() {
  var mountPoint = document.getElementById('user_status-menu-entry');
  // eslint-disable-next-line no-new
  new vue__WEBPACK_IMPORTED_MODULE_4__["default"]({
    el: mountPoint,
    render: function render(h) {
      return h(_UserStatus_vue__WEBPACK_IMPORTED_MODULE_2__["default"]);
    },
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  OCA.Dashboard.registerStatus('status', function (el) {
    var Dashboard = vue__WEBPACK_IMPORTED_MODULE_4__["default"].extend(_UserStatus_vue__WEBPACK_IMPORTED_MODULE_2__["default"]);
...
var getTimestampForClearAt = function getTimestampForClearAt(clearAt) {
  ...
  var date = (0,_dateService_js__WEBPACK_IMPORTED_MODULE_0__.dateFactory)();
...
var sendHeartbeat = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(isAway) {
    var url, response;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
...
/* harmony export */   fetchBackupStatus: function() { return /* binding */ fetchBackupStatus; },
/* harmony export */   fetchCurrentStatus: function() { return /* binding */ fetchCurrentStatus; },
/* harmony export */   revertToBackupStatus: function() { return /* binding */ revertToBackupStatus; },
 ...
 * @return {Promise<object>}
 */
var fetchBackupStatus = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(userId) {
    var url, response;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          url = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.generateOcsUrl)('apps/user_status/api/v1/statuses/{userId}', {
            userId: '_' + userId
          });
          _context2.next = 3;
          return _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].get(url);
  ...
  return function fetchBackupStatus(_x) {
...
var setStatus = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(statusType) {
    var url;
...
var setPredefinedMessage = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(messageId) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          clearAt = _args4.length > 1 && _args4[1] !== undefined ? _args4[1] : null;
  ...
  return function setPredefinedMessage(_x3) {
...
var setCustomMessage = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(message) {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        case 0:
          statusIcon = _args5.length > 1 && _args5[1] !== undefined ? _args5[1] : null;
          clearAt = _args5.length > 2 && _args5[2] !== undefined ? _args5[2] : null;
  ...
  return function setCustomMessage(_x4) {
 ...
 * @return {Promise<object>}
 */
var revertToBackupStatus = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(messageId) {
    var url, response;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          url = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.generateOcsUrl)('apps/user_status/api/v1/user_status/revert/{messageId}', {
            messageId: messageId
          });
          _context7.next = 3;
          return _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].delete(url);
  ...
  return function revertToBackupStatus(_x5) {
...
/* harmony default export */ __webpack_exports__["default"] = (new vuex__WEBPACK_IMPORTED_MODULE_4__.Store({
  modules: {
...
var mutations = {
  ...
  addPredefinedStatus: function addPredefinedStatus(state, status) {
    state.predefinedStatuses = [].concat(_toConsumableArray(state.predefinedStatuses), [status]);
  }
};
var getters = {
  statusesHaveLoaded: function statusesHaveLoaded(state) {
    ...
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 3:
            _context.next = 5;
            return (0,_services_predefinedStatusService_js__WEBPACK_IMPORTED_MODULE_0__.fetchAllPredefinedStatuses)();
          case 5:
...
var mutations = {
   ...
   */
  loadBackupStatusFromServer: function loadBackupStatusFromServer(state, _ref) {
    var status = _ref.status,
      statusIsUserDefined = _ref.statusIsUserDefined,
      message = _ref.message,
      icon = _ref.icon,
      clearAt = _ref.clearAt,
      messageIsPredefined = _ref.messageIsPredefined,
...
var actions = {
   ...
   * @return {Promise<void>}
   */
  fetchBackupFromServer: function fetchBackupFromServer(_ref2) {
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee() {
      var commit, _getCurrentUser, status;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            commit = _ref2.commit;
            _context.prev = 1;
            _context.next = 4;
            return (0,_services_statusService_js__WEBPACK_IMPORTED_MODULE_0__.fetchBackupStatus)((_getCurrentUser = (0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_1__.getCurrentUser)()) === null || _getCurrentUser === void 0 ? void 0 : _getCurrentUser.uid);
          case 4:
  ...
  revertBackupFromServer: function revertBackupFromServer(_ref3, _ref4) {
    return _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
      var commit, messageId, status, _getCurrentUser2;
      return _regeneratorRuntime().wrap(function _callee2$(_context2) {
        while (1) switch (_context2.prev = _context2.next) {
          case 0:
            commit = _ref3.commit;
            ...
            _context2.next = 4;
            return (0,_services_statusService_js__WEBPACK_IMPORTED_MODULE_0__.revertToBackupStatus)(messageId);
          case 4:
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 4;
            return (0,_services_statusService_js__WEBPACK_IMPORTED_MODULE_0__.setStatus)(statusType);
          case 4:
            commit('setStatus', {
              statusType: statusType
            });
      ...
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            resolvedClearAt = (0,_services_clearAtService_js__WEBPACK_IMPORTED_MODULE_3__.getTimestampForClearAt)(clearAt);
            _context3.next = 5;
            return (0,_services_statusService_js__WEBPACK_IMPORTED_MODULE_0__.setPredefinedMessage)(messageId, resolvedClearAt);
          case 5:
      ...
      return _regeneratorRuntime().wrap(function _callee4$(_context4) {
        while (1) switch (_context4.prev = _context4.next) {
          case 0:
            ...
            resolvedClearAt = (0,_services_clearAtService_js__WEBPACK_IMPORTED_MODULE_3__.getTimestampForClearAt)(clearAt);
            _context4.next = 5;
            return (0,_services_statusService_js__WEBPACK_IMPORTED_MODULE_0__.setCustomMessage)(message, icon, resolvedClearAt);
          case 5:
      ...
      return _regeneratorRuntime().wrap(function _callee5$(_context5) {
        while (1) switch (_context5.prev = _context5.next) {
          case 0:
            ...
            _context5.next = 3;
            return (0,_services_statusService_js__WEBPACK_IMPORTED_MODULE_0__.clearMessage)();
          case 3:
            commit('clearMessage');
            (0,_nextcloud_event_bus__WEBPACK_IMPORTED_MODULE_4__.emit)('user_status:status.updated', {
              status: state.status,
      ...
      return _regeneratorRuntime().wrap(function _callee6$(_context6) {
        while (1) switch (_context6.prev = _context6.next) {
          case 0:
            ...
            _context6.next = 3;
            return (0,_services_statusService_js__WEBPACK_IMPORTED_MODULE_0__.fetchCurrentStatus)();
          case 3:
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  components: {
    SetStatusModal: function SetStatusModal() {
      return Promise.all(/*! import() | user-status-modal */[__webpack_require__.e("core-common"), __webpack_require__.e("user-status-modal")]).then(__webpack_require__.bind(__webpack_require__, /*! ./components/SetStatusModal.vue */ "./apps/user_status/src/components/SetStatusModal.vue"));
    }
  },
        ...
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              _context.prev = 0;
              _context.next = 3;
              return (0,_services_heartbeatService_js__WEBPACK_IMPORTED_MODULE_5__.sendHeartbeat)(_this2.isAway);
            case 3:
              status = _context.sent;
...
/******/ 			return "" + chunkId + "-" + chunkId + ".js?v=" + "5996163a6cdfbcf44508" + "";
/******/ 		};
/******/ 	}();
/******/ 	
...
/******/ })()
;
//# sourceMappingURL=user_status-menu.js.map?v=fe326e5fbf45bbda330b