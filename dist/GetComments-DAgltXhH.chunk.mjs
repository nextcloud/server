...
import { h as generateRemoteUrl, e as getRequestToken, o as onRequestTokenUpdate, q as getDefaultExportFromCjs, t as process$1 } from "./index-rAufP352.chunk.mjs";
import { r as requireUtil } from "./util-BSOXDoOW.chunk.mjs";
function getRootPath() {
  return generateRemoteUrl("dav/comments");
}
const client = lr(getRootPath());
...
function requirePathPosix() {
  if (hasRequiredPathPosix) return pathPosix;
  ...
  posix.resolve = function() {
    ...
    for (var i = arguments.length - 1; i >= -1 && !resolvedAbsolute; i--) {
      var path2 = i >= 0 ? arguments[i] : process$1.cwd();
      if (!isString(path2)) {
...
const path = /* @__PURE__ */ getDefaultExportFromCjs(pathPosixExports);
/**
...
async function getComments({ resourceType, resourceId }, options) {
  ...
  const result = await Ke(responseData);
...
//# sourceMappingURL=GetComments-DAgltXhH.chunk.mjs.map
