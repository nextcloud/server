...
var View = vue__WEBPACK_IMPORTED_MODULE_4__["default"].extend(_components_setup_RecommendedApps_vue__WEBPACK_IMPORTED_MODULE_3__["default"]);
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            _logger_js__WEBPACK_IMPORTED_MODULE_6__["default"].debug("".concat(_this.recommendedApps.length, " recommended apps found"), {
  ...
  methods: {
    installApps: function installApps() {
      ...
      Promise.all(installing).then(function () {
        ...
        window.location = _this2.defaultPageUrl;
      }).catch(function (error) {
        return _logger_js__WEBPACK_IMPORTED_MODULE_6__["default"].error('could not install recommended apps', {
          error: error
        });
      });
    },
...
/******/ })()
;
//# sourceMappingURL=core-recommendedapps.js.map?v=8bf9019b0291118fe2d1