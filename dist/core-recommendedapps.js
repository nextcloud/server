...
const View = vue__WEBPACK_IMPORTED_MODULE_2__["default"].extend(_components_setup_RecommendedApps_vue__WEBPACK_IMPORTED_MODULE_3__["default"]);
new View().$mount('#recommended-apps');
_logger_js__WEBPACK_IMPORTED_MODULE_4__["default"].debug('recommended apps view rendered');
...
const recommended = {
  calendar: {
    description: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.t)('core', 'Schedule work & meetings, synced with all your devices.'),
    icon: (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_3__.imagePath)('core', 'places/calendar.svg')
  },
  contacts: {
    description: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.t)('core', 'Keep your colleagues and friends in one place without leaking their private info.'),
    icon: (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_3__.imagePath)('core', 'places/contacts.svg')
  },
  mail: {
    description: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.t)('core', 'Simple email app nicely integrated with Files, Contacts and Calendar.'),
    icon: (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_3__.imagePath)('core', 'actions/mail.svg')
  },
  spreed: {
    description: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.t)('core', 'Chatting, video calls, screen sharing, online meetings and web conferencing – in your browser and with mobile apps.'),
    icon: (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_3__.imagePath)('core', 'apps/spreed.svg')
  },
  richdocuments: {
    name: 'Nextcloud Office',
    description: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.t)('core', 'Collaborative documents, spreadsheets and presentations, built on Collabora Online.'),
    icon: (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_3__.imagePath)('core', 'apps/richdocuments.svg')
  },
  notes: {
    description: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.t)('core', 'Distraction free note taking app.'),
    icon: (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_3__.imagePath)('core', 'apps/notes.svg')
  },
  richdocumentscode: {
    hidden: true
  }
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  async mounted() {
    try {
      const {
        data
      } = await _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].get((0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_3__.generateUrl)('settings/apps/list'));
      _logger_js__WEBPACK_IMPORTED_MODULE_7__["default"].info(`${data.apps.length} apps fetched`);
      this.apps = data.apps.map(app => Object.assign(app, {
        loading: false,
        installationError: false,
        isSelected: app.isCompatible
      }));
      _logger_js__WEBPACK_IMPORTED_MODULE_7__["default"].debug(`${this.recommendedApps.length} recommended apps found`, {
        apps: this.recommendedApps
      });
      this.showInstallButton = true;
    } catch (error) {
      _logger_js__WEBPACK_IMPORTED_MODULE_7__["default"].error('could not fetch app list', {
        error
      });
  ...
  methods: {
    installApps() {
      ...
      const installing = this.recommendedApps.filter(app => !app.active && app.isCompatible && app.canInstall && app.isSelected).map(app => limit(async () => {
        _logger_js__WEBPACK_IMPORTED_MODULE_7__["default"].info(`installing ${app.id}`);
        app.loading = true;
        return _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].post((0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_3__.generateUrl)('settings/apps/enable'), {
          appIds: [app.id],
          groups: []
        }).catch(error => {
          _logger_js__WEBPACK_IMPORTED_MODULE_7__["default"].error(`could not install ${app.id}`, {
            error
          });
          app.isSelected = false;
          app.installationError = true;
        }).then(() => {
          _logger_js__WEBPACK_IMPORTED_MODULE_7__["default"].info(`installed ${app.id}`);
          app.loading = false;
          app.active = true;
        });
      }));
      _logger_js__WEBPACK_IMPORTED_MODULE_7__["default"].debug(`installing ${installing.length} recommended apps`);
      Promise.all(installing).then(() => {
        _logger_js__WEBPACK_IMPORTED_MODULE_7__["default"].info('all recommended apps installed, redirecting …');
        window.location = this.defaultPageUrl;
      }).catch(error => _logger_js__WEBPACK_IMPORTED_MODULE_7__["default"].error('could not install recommended apps', {
        error
      }));
    },
    customIcon(appId) {
      if (!(appId in recommended) || !recommended[appId].icon) {
        _logger_js__WEBPACK_IMPORTED_MODULE_7__["default"].warn(`no app icon for recommended app ${appId}`);
        return (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_3__.imagePath)('core', 'places/default-app-icon.svg');
      }
    ...
    customDescription(appId) {
      if (!(appId in recommended)) {
        _logger_js__WEBPACK_IMPORTED_MODULE_7__["default"].warn(`no app description for recommended app ${appId}`);
        return '';
      }
...
/******/ })()
;
//# sourceMappingURL=core-recommendedapps.js.map?v=8bec50410902e18c340e