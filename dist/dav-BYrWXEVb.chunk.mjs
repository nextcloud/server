import{a as m,h as N,o as E,e as D}from"./index-DgEyzq8A.chunk.mjs";import{i as f,b as x,g as R}from"./index-DU6aLNdu.chunk.mjs";import{$ as q,R as T}from"./fileSize-Yvbrc86o.chunk.mjs";import{s as o,l as u,N as P,a as _,b as A,P as i}from"./externalStorageUtils-DlAO49Rz.chunk.mjs";function S(e=""){let r=i.NONE;return e&&(e.includes("G")&&(r|=i.READ),e.includes("W")&&(r|=i.WRITE),e.includes("CK")&&(r|=i.CREATE),e.includes("NV")&&(r|=i.UPDATE),e.includes("D")&&(r|=i.DELETE),e.includes("R")&&(r|=i.SHARE)),r}const $=["d:getcontentlength","d:getcontenttype","d:getetag","d:getlastmodified","d:creationdate","d:displayname","d:quota-available-bytes","d:resourcetype","nc:has-preview","nc:is-encrypted","nc:mount-type","oc:comments-unread","oc:favorite","oc:fileid","oc:owner-display-name","oc:owner-id","oc:permissions","oc:size","nc:upload_time"],y={d:"DAV:",nc:"http://nextcloud.org/ns",oc:"http://owncloud.org/ns",ocs:"http://open-collaboration-services.org/ns"};function F(e,r={nc:"http://nextcloud.org/ns"}){o.davNamespaces??={...y},o.davProperties??=[...$];const s={...o.davNamespaces,...r};if(o.davProperties.find(t=>t===e))return u.warn(`${e} already registered`,{prop:e}),!1;if(e.startsWith("<")||e.split(":").length!==2)return u.error(`${e} is not valid. See example: 'oc:fileid'`,{prop:e}),!1;const d=e.split(":")[0];return s[d]?(o.davProperties.push(e),o.davNamespaces=s,!0):(u.error(`${e} namespace unknown`,{prop:e,namespaces:s}),!1)}function h(){return o.davProperties??=[...$],o.davProperties.map(e=>`<${e} />`).join(" ")}function g(){return o.davNamespaces??={...y},Object.keys(o.davNamespaces).map(e=>`xmlns:${e}="${o.davNamespaces?.[e]}"`).join(" ")}function O(){return`<?xml version="1.0"?>
		<d:propfind ${g()}>
			<d:prop>
				${h()}
			</d:prop>
...
//# sourceMappingURL=dav-BYrWXEVb.chunk.mjs.map
