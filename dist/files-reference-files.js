...
(0,_nextcloud_vue_components_NcRichText__WEBPACK_IMPORTED_MODULE_2__.registerWidget)('file', (el, _ref) => {
  let {
    richObjectType,
    richObject,
    accessible,
  ...
  const Widget = vue__WEBPACK_IMPORTED_MODULE_0__["default"].extend(_views_ReferenceFileWidget_vue__WEBPACK_IMPORTED_MODULE_3__["default"]);
  new Widget({
    propsData: {
      richObjectType,
      richObject,
...
(0,_nextcloud_vue_components_NcRichText__WEBPACK_IMPORTED_MODULE_2__.registerCustomPickerElement)('files', (el, _ref2) => {
  let {
    providerId,
    accessible
  } = _ref2;
  const Element = vue__WEBPACK_IMPORTED_MODULE_0__["default"].extend(_views_FileReferencePickerElement_vue__WEBPACK_IMPORTED_MODULE_4__["default"]);
...
/* harmony import */ var vue_material_design_icons_File_vue__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! vue-material-design-icons/File.vue */ "./node_modules/vue-material-design-icons/File.vue");
/* harmony import */ var vue_material_design_icons_Folder_vue__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! vue-material-design-icons/Folder.vue */ "./node_modules/vue-material-design-icons/Folder.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_0__.defineComponent)({
  ...
  components: {
    FolderIcon: vue_material_design_icons_Folder_vue__WEBPACK_IMPORTED_MODULE_6__["default"],
    FileIcon: vue_material_design_icons_File_vue__WEBPACK_IMPORTED_MODULE_5__["default"]
  },
  props: {
    richObject: {
      type: Object,
  ...
  computed: {
    ...
    viewerFile() {
      const davSource = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.generateRemoteUrl)(`dav/files/${(0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_2__.getCurrentUser)()?.uid}/${this.richObject.path}`).replace(/\/\/$/, '/');
      return {
    ...
    filePath() {
      return path__WEBPACK_IMPORTED_MODULE_7___default().dirname(this.richObject.path);
    },
    filePreviewStyle() {
      if (this.previewUrl) {
        return {
  ...
  mounted() {
    if (this.richObject['preview-available']) {
      const previewUrl = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.generateUrl)('/core/preview?fileId={fileId}&x=250&y=250', {
        fileId: this.richObject.id
      });
      const img = new Image();
      img.onload = () => {
  ...
  methods: {
    ...
    openFilePicker() {
      const picker = (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_3__.getFilePickerBuilder)(t('settings', 'Your files')).allowDirectories(true).setMultiSelect(false).addButton({
        id: 'open',
        label: this.t('settings', 'Open in files'),
        callback(nodes) {
          if (nodes[0]) {
            window.open((0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_1__.generateUrl)('/f/{fileid}', {
...
/******/ 			return "" + chunkId + "-" + chunkId + ".js?v=" + {"node_modules_nextcloud_dialogs_dist_chunks_index-BC-7VPxC_mjs":"2fcef36253529e5f48bc","node_modules_nextcloud_dialogs_dist_chunks_PublicAuthPrompt-BSFsDqYB_mjs":"f3a3966faa81f9b81fa8","node_modules_rehype-highlight_index_js":"3c5c32c691780bf457a0","node_modules_nextcloud_dialogs_dist_chunks_FilePicker-CsU6FfAP_mjs":"8bce3ebf3ef868f175e5","data_image_svg_xml_3c_21--_20-_20SPDX-FileCopyrightText_202020_20Google_20Inc_20-_20SPDX-Lice-cc29b1":"9fa10a9863e5b78deec8"}[chunkId] + "";
/******/ 		};
/******/ 	})();
/******/ 	
...
/******/ })()
;
//# sourceMappingURL=files-reference-files.js.map?v=03a095bc46a99cf4010a