...
/* harmony import */ var _views_CalDavSettings_vue__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./views/CalDavSettings.vue */ "./apps/dav/src/views/CalDavSettings.vue");
/**
...
const View = vue__WEBPACK_IMPORTED_MODULE_0__["default"].extend(_views_CalDavSettings_vue__WEBPACK_IMPORTED_MODULE_3__["default"]);
const CalDavSettingsView = new View({
  name: 'CalDavSettingsView',
  data() {
    return {
      sendInvitations: (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_1__.loadState)('dav', 'sendInvitations'),
      generateBirthdayCalendar: (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_1__.loadState)('dav', 'generateBirthdayCalendar'),
      sendEventReminders: (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_1__.loadState)('dav', 'sendEventReminders'),
      sendEventRemindersToSharedUsers: (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_1__.loadState)('dav', 'sendEventRemindersToSharedUsers'),
      sendEventRemindersPush: (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_1__.loadState)('dav', 'sendEventRemindersPush')
    };
  }
});
...
/******/ })()
;
//# sourceMappingURL=dav-settings-admin-caldav.js.map?v=9f454a76fec2b28b1b35