"use strict";
(globalThis["webpackChunknextcloud_ui_legacy"] = globalThis["webpackChunknextcloud_ui_legacy"] || []).push([["apps_files_sharing_src_components_NewFileRequestDialog_vue"],{

/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-6.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/files_sharing/src/components/NewFileRequestDialog.vue?vue&type=script&lang=ts"
/*!**********************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-6.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/files_sharing/src/components/NewFileRequestDialog.vue?vue&type=script&lang=ts ***!
  \**********************************************************************************************************************************************************************************************************************************************************/
...
/* harmony import */ var _nextcloud_sharing__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! @nextcloud/sharing */ "./node_modules/@nextcloud/sharing/dist/index.js");
...
/* harmony import */ var _nextcloud_vue_components_NcDialog__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @nextcloud/vue/components/NcDialog */ "./node_modules/@nextcloud/vue/dist/Components/NcDialog.mjs");
...
/* harmony import */ var vue_material_design_icons_Check_vue__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! vue-material-design-icons/Check.vue */ "./node_modules/vue-material-design-icons/Check.vue");
...
/* harmony import */ var _models_Share_ts__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ../models/Share.ts */ "./apps/files_sharing/src/models/Share.ts");
/* harmony import */ var _services_ConfigService_ts__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ../services/ConfigService.ts */ "./apps/files_sharing/src/services/ConfigService.ts");
/* harmony import */ var _services_logger_ts__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ../services/logger.ts */ "./apps/files_sharing/src/services/logger.ts");
...
const sharingConfig = new _services_ConfigService_ts__WEBPACK_IMPORTED_MODULE_18__["default"]();
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_7__.defineComponent)({
  ...
  components: {
    ...
    IconCheck: vue_material_design_icons_Check_vue__WEBPACK_IMPORTED_MODULE_13__["default"],
    ...
    NcDialog: _nextcloud_vue_components_NcDialog__WEBPACK_IMPORTED_MODULE_9__["default"],
  ...
  computed: {
    finishButtonLabel() {
      if (this.emails.length === 0) {
        return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_4__.t)('files_sharing', 'Close');
      }
      return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_4__.n)('files_sharing', 'Send email and close', 'Send {count} emails and close', this.emails.length, {
  ...
  methods: {
    onPageNext() {
      ...
      if (this.destination === '/' || this.destination === '') {
        ...
        destinationInput?.setCustomValidity((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_4__.t)('files_sharing', 'Please select a folder, you cannot share the root directory.'));
        form.reportValidity();
        return;
      }
    ...
    async onFinish() {
      if (this.emails.length === 0 || this.isShareByMailEnabled === false) {
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_1__.showSuccess)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_4__.t)('files_sharing', 'File request created'));
        this.$emit('close');
        return;
      }
      if (sharingConfig.isMailShareAllowed && this.emails.length > 0) {
        ...
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_1__.showSuccess)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_4__.n)('files_sharing', 'File request created and email sent', 'File request created and {count} emails sent', this.emails.length, {
          count: this.emails.length
        }));
      } else {
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_1__.showSuccess)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_4__.t)('files_sharing', 'File request created'));
    ...
    async createShare() {
      ...
      const shareUrl = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_5__.generateOcsUrl)('apps/files_sharing/api/v1/shares');
      try {
        const request = await _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].post(shareUrl, {
          ...
          shareType: sharingConfig.isMailShareAllowed ? _nextcloud_sharing__WEBPACK_IMPORTED_MODULE_6__.ShareType.Email : _nextcloud_sharing__WEBPACK_IMPORTED_MODULE_6__.ShareType.Link,
          permissions: _nextcloud_files__WEBPACK_IMPORTED_MODULE_3__.Permission.CREATE,
          label: this.label,
        ...
        const share = new _models_Share_ts__WEBPACK_IMPORTED_MODULE_17__["default"](request.data.ocs.data);
        this.share = share;
        _services_logger_ts__WEBPACK_IMPORTED_MODULE_19__["default"].info('New file request created', {
          share
        });
        ...
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_1__.showError)(errorMessage ? (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_4__.t)('files_sharing', 'Error creating the share: {errorMessage}', {
          errorMessage
        }) : (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_4__.t)('files_sharing', 'Error creating the share'));
        _services_logger_ts__WEBPACK_IMPORTED_MODULE_19__["default"].error('Error while creating share', {
          error,
          errorMessage
        });
        throw error;
    ...
    async setShareEmails() {
      ...
      const shareUrl = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_5__.generateOcsUrl)('apps/files_sharing/api/v1/shares/{id}', {
        id: this.share.id
      });
      try {
        // Convert link share to email share
        const request = await _nextcloud_axios__WEBPACK_IMPORTED_MODULE_0__["default"].put(shareUrl, {
          attributes: JSON.stringify([{
            value: this.emails,
            key: 'emails',
            scope: 'shareWith'
    ...
    async sendEmails() {
      ...
      const shareUrl = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_5__.generateOcsUrl)('apps/files_sharing/api/v1/shares/{id}/send-email', {
        id: this.share.id
      });
      try {
        // Convert link share to email share
    ...
    onEmailSendError(error) {
      const errorMessage = error.response?.data?.ocs?.meta?.message;
      (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_1__.showError)(errorMessage ? (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_4__.t)('files_sharing', 'Error sending emails: {errorMessage}', {
        errorMessage
      }) : (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_4__.t)('files_sharing', 'Error sending emails'));
      _services_logger_ts__WEBPACK_IMPORTED_MODULE_19__["default"].error('Error while sending emails', {
        error,
        errorMessage
      });
    }
...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-6.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/files_sharing/src/components/NewFileRequestDialog/NewFileRequestDialogDatePassword.vue?vue&type=script&lang=ts"
/*!*******************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-6.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/files_sharing/src/components/NewFileRequestDialog/NewFileRequestDialogDatePassword.vue?vue&type=script&lang=ts ***!
  \*******************************************************************************************************************************************************************************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _nextcloud_vue_components_NcDateTimePickerNative__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @nextcloud/vue/components/NcDateTimePickerNative */ "./node_modules/@nextcloud/vue/dist/Components/NcDateTimePickerNative.mjs");
...
/* harmony import */ var vue_material_design_icons_Information_vue__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! vue-material-design-icons/Information.vue */ "./node_modules/vue-material-design-icons/Information.vue");
...
/* harmony import */ var _utils_GeneratePassword_ts__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../utils/GeneratePassword.ts */ "./apps/files_sharing/src/utils/GeneratePassword.ts");
...
const sharingConfig = new _services_ConfigService_ts__WEBPACK_IMPORTED_MODULE_9__["default"]();
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_1__.defineComponent)({
  name: 'NewFileRequestDialogDatePassword',
  components: {
    IconInfo: vue_material_design_icons_Information_vue__WEBPACK_IMPORTED_MODULE_8__["default"],
    ...
    NcDateTimePickerNative: _nextcloud_vue_components_NcDateTimePickerNative__WEBPACK_IMPORTED_MODULE_4__["default"],
  ...
  methods: {
    ...
    async generatePassword() {
      await (0,_utils_GeneratePassword_ts__WEBPACK_IMPORTED_MODULE_10__["default"])().then(password => {
...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-6.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/files_sharing/src/components/NewFileRequestDialog/NewFileRequestDialogFinish.vue?vue&type=script&lang=ts"
/*!*************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-6.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/files_sharing/src/components/NewFileRequestDialog/NewFileRequestDialogFinish.vue?vue&type=script&lang=ts ***!
  \*************************************************************************************************************************************************************************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _nextcloud_vue_components_NcChip__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @nextcloud/vue/components/NcChip */ "./node_modules/@nextcloud/vue/dist/Components/NcChip.mjs");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_3__.defineComponent)({
  ...
  components: {
    ...
    NcChip: _nextcloud_vue_components_NcChip__WEBPACK_IMPORTED_MODULE_5__["default"]
  },
  props: {
    share: {
      type: Object,
  ...
  computed: {
    shareLink() {
      return (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_2__.generateUrl)('/s/{token}', {
        token: this.share.token
      }, {
        baseURL: (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_2__.getBaseUrl)()
      });
    }
  },
  methods: {
    async copyShareLink(event) {
      ...
      if (!navigator.clipboard) {
        ...
        window.prompt((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files_sharing', 'Automatically copying failed, please copy the share link manually'), this.shareLink);
        return;
      }
      await navigator.clipboard.writeText(this.shareLink);
      (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_0__.showSuccess)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files_sharing', 'Link copied'));
      this.isCopied = true;
      event.target?.select?.();
      setTimeout(() => {
        this.isCopied = false;
    ...
    addNewEmail(e) {
      ...
      if (e.target instanceof HTMLInputElement) {
        ...
        if (this.emails.includes(this.email.trim())) {
          e.target.setCustomValidity((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files_sharing', 'Email already added'));
          e.target.reportValidity();
          return;
        }
        // Check if the email is valid
        if (!this.isValidEmail(this.email.trim())) {
          e.target.setCustomValidity((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.t)('files_sharing', 'Invalid email address'));
          e.target.reportValidity();
          return;
        }
    ...
    onPasteEmails(e) {
      ...
      if (invalidEmails.length > 0) {
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_0__.showError)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.n)('files_sharing', 'The following email address is not valid: {emails}', 'The following email addresses are not valid: {emails}', invalidEmails.length, {
          emails: invalidEmails.join(', ')
        }));
      }
      // Warn about duplicate emails
      if (duplicateEmails.length > 0) {
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_0__.showError)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.n)('files_sharing', '{count} email address already added', '{count} email addresses already added', duplicateEmails.length, {
          count: duplicateEmails.length
        }));
      }
      if (validEmails.length > 0) {
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_0__.showSuccess)((0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_1__.n)('files_sharing', '{count} email address added', '{count} email addresses added', validEmails.length, {
...
/***/ "./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-6.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/files_sharing/src/components/NewFileRequestDialog/NewFileRequestDialogIntro.vue?vue&type=script&lang=ts"
/*!************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-6.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/files_sharing/src/components/NewFileRequestDialog/NewFileRequestDialogIntro.vue?vue&type=script&lang=ts ***!
  \************************************************************************************************************************************************************************************************************************************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _nextcloud_vue_components_NcTextArea__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @nextcloud/vue/components/NcTextArea */ "./node_modules/@nextcloud/vue/dist/Components/NcTextArea.mjs");
...
/* harmony import */ var vue_material_design_icons_Lock_vue__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! vue-material-design-icons/Lock.vue */ "./node_modules/vue-material-design-icons/Lock.vue");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_2__.defineComponent)({
  ...
  components: {
    IconFolder: vue_material_design_icons_Folder_vue__WEBPACK_IMPORTED_MODULE_5__["default"],
    IconInfo: vue_material_design_icons_InformationOutline_vue__WEBPACK_IMPORTED_MODULE_6__["default"],
    IconLock: vue_material_design_icons_Lock_vue__WEBPACK_IMPORTED_MODULE_7__["default"],
    NcTextArea: _nextcloud_vue_components_NcTextArea__WEBPACK_IMPORTED_MODULE_3__["default"],
...
var render = function render() {
  ...
  return _c("div", [_vm.passwordAndExpirationSummary ? _c("NcNoteCard", {
    ...
    attrs: {
      "model-value": _vm.isExpirationDateEnforced || _vm.expirationDate !== null,
      disabled: _vm.disabled || _vm.isExpirationDateEnforced
    },
    on: {
      "update:modelValue": _vm.onToggleDeadline
    }
    ...
    attrs: {
      ...
      "model-value": _vm.expirationDate,
      name: "expirationDate",
      type: "date"
    },
    on: {
    ...
    attrs: {
      "model-value": _vm.isPasswordEnforced || _vm.password !== null,
      disabled: _vm.disabled || _vm.isPasswordEnforced
    },
    on: {
      "update:modelValue": _vm.onTogglePassword
    }
...
var render = function render() {
  ...
  return _c("div", [_c("NcNoteCard", {
    ...
    ref: "clipboard",
    attrs: {
      "model-value": _vm.shareLink,
      label: _vm.t("files_sharing", "Share link"),
      readonly: true,
      "show-trailing-button": true,
      "trailing-button-label": _vm.t("files_sharing", "Copy"),
...
/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/@nextcloud/vue/dist/assets/NcChip-DLfUzq07.css"
/*!***********************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/@nextcloud/vue/dist/assets/NcChip-DLfUzq07.css ***!
  \***********************************************************************************************************/
...
/***/ "./node_modules/@nextcloud/vue/dist/assets/NcChip-DLfUzq07.css"
/*!*********************************************************************!*\
  !*** ./node_modules/@nextcloud/vue/dist/assets/NcChip-DLfUzq07.css ***!
  \*********************************************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _css_loader_dist_cjs_js_NcChip_DLfUzq07_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../../../css-loader/dist/cjs.js!./NcChip-DLfUzq07.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/@nextcloud/vue/dist/assets/NcChip-DLfUzq07.css");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_NcChip_DLfUzq07_css__WEBPACK_IMPORTED_MODULE_6__["default"], options);




       /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_NcChip_DLfUzq07_css__WEBPACK_IMPORTED_MODULE_6__["default"] && _css_loader_dist_cjs_js_NcChip_DLfUzq07_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals ? _css_loader_dist_cjs_js_NcChip_DLfUzq07_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals : undefined);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_node_modules_ts_loader_index_js_clonedRuleSet_6_use_1_node_modules_vue_loader_lib_index_js_vue_loader_options_NewFileRequestDialog_vue_vue_type_script_lang_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../node_modules/babel-loader/lib/index.js!../../../../node_modules/ts-loader/index.js??clonedRuleSet-6.use[1]!../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./NewFileRequestDialog.vue?vue&type=script&lang=ts */ "./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-6.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/files_sharing/src/components/NewFileRequestDialog.vue?vue&type=script&lang=ts");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_node_modules_ts_loader_index_js_clonedRuleSet_6_use_1_node_modules_vue_loader_lib_index_js_vue_loader_options_NewFileRequestDialog_vue_vue_type_script_lang_ts__WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_node_modules_ts_loader_index_js_clonedRuleSet_6_use_1_node_modules_vue_loader_lib_index_js_vue_loader_options_NewFileRequestDialogDatePassword_vue_vue_type_script_lang_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js!../../../../../node_modules/ts-loader/index.js??clonedRuleSet-6.use[1]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./NewFileRequestDialogDatePassword.vue?vue&type=script&lang=ts */ "./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-6.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/files_sharing/src/components/NewFileRequestDialog/NewFileRequestDialogDatePassword.vue?vue&type=script&lang=ts");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_node_modules_ts_loader_index_js_clonedRuleSet_6_use_1_node_modules_vue_loader_lib_index_js_vue_loader_options_NewFileRequestDialogDatePassword_vue_vue_type_script_lang_ts__WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_node_modules_ts_loader_index_js_clonedRuleSet_6_use_1_node_modules_vue_loader_lib_index_js_vue_loader_options_NewFileRequestDialogFinish_vue_vue_type_script_lang_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js!../../../../../node_modules/ts-loader/index.js??clonedRuleSet-6.use[1]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./NewFileRequestDialogFinish.vue?vue&type=script&lang=ts */ "./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-6.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/files_sharing/src/components/NewFileRequestDialog/NewFileRequestDialogFinish.vue?vue&type=script&lang=ts");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_node_modules_ts_loader_index_js_clonedRuleSet_6_use_1_node_modules_vue_loader_lib_index_js_vue_loader_options_NewFileRequestDialogFinish_vue_vue_type_script_lang_ts__WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _node_modules_babel_loader_lib_index_js_node_modules_ts_loader_index_js_clonedRuleSet_6_use_1_node_modules_vue_loader_lib_index_js_vue_loader_options_NewFileRequestDialogIntro_vue_vue_type_script_lang_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! -!../../../../../node_modules/babel-loader/lib/index.js!../../../../../node_modules/ts-loader/index.js??clonedRuleSet-6.use[1]!../../../../../node_modules/vue-loader/lib/index.js??vue-loader-options!./NewFileRequestDialogIntro.vue?vue&type=script&lang=ts */ "./node_modules/babel-loader/lib/index.js!./node_modules/ts-loader/index.js??clonedRuleSet-6.use[1]!./node_modules/vue-loader/lib/index.js??vue-loader-options!./apps/files_sharing/src/components/NewFileRequestDialog/NewFileRequestDialogIntro.vue?vue&type=script&lang=ts");
 /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_node_modules_babel_loader_lib_index_js_node_modules_ts_loader_index_js_clonedRuleSet_6_use_1_node_modules_vue_loader_lib_index_js_vue_loader_options_NewFileRequestDialogIntro_vue_vue_type_script_lang_ts__WEBPACK_IMPORTED_MODULE_0__["default"]); 
...
/* harmony export */ });
/* harmony import */ var _assets_NcChip_DLfUzq07_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../assets/NcChip-DLfUzq07.css */ "./node_modules/@nextcloud/vue/dist/assets/NcChip-DLfUzq07.css");
/* harmony import */ var _chunks_mdi_DkJglNiS_mjs__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../chunks/mdi-DkJglNiS.mjs */ "./node_modules/@nextcloud/vue/dist/chunks/mdi-DkJglNiS.mjs");
/* harmony import */ var vue__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! vue */ "./node_modules/vue/dist/vue.runtime.esm.js");
/* harmony import */ var _chunks_NcActionButton_1gSJfFUC_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../chunks/NcActionButton-1gSJfFUC.mjs */ "./node_modules/@nextcloud/vue/dist/chunks/NcActionButton-1gSJfFUC.mjs");
/* harmony import */ var _chunks_NcActions_B7LKaVy0_mjs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../chunks/NcActions-B7LKaVy0.mjs */ "./node_modules/@nextcloud/vue/dist/chunks/NcActions-B7LKaVy0.mjs");
/* harmony import */ var _chunks_NcIconSvgWrapper_Bui9PhAS_mjs__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../chunks/NcIconSvgWrapper-Bui9PhAS.mjs */ "./node_modules/@nextcloud/vue/dist/chunks/NcIconSvgWrapper-Bui9PhAS.mjs");
/* harmony import */ var _chunks_l10n_Dpecfv0B_mjs__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../chunks/_l10n-Dpecfv0B.mjs */ "./node_modules/@nextcloud/vue/dist/chunks/_l10n-Dpecfv0B.mjs");
/* harmony import */ var _chunks_plugin_vue2_normalizer_DU4iP6Vu_mjs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ../chunks/_plugin-vue2_normalizer-DU4iP6Vu.mjs */ "./node_modules/@nextcloud/vue/dist/chunks/_plugin-vue2_normalizer-DU4iP6Vu.mjs");
...
(0,_chunks_l10n_Dpecfv0B_mjs__WEBPACK_IMPORTED_MODULE_6__.r)(_chunks_l10n_Dpecfv0B_mjs__WEBPACK_IMPORTED_MODULE_6__.m);
const _sfc_main = {
  __name: "NcChip",
  props: {
    /**
    ...
    ariaLabelClose: {
      type: String,
      default: (0,_chunks_l10n_Dpecfv0B_mjs__WEBPACK_IMPORTED_MODULE_6__.a)("Close")
    },
    /**
  ...
  setup(__props, { emit }) {
    const props = __props;
    const slots = (0,vue__WEBPACK_IMPORTED_MODULE_2__.useSlots)();
    const realVariant = (0,vue__WEBPACK_IMPORTED_MODULE_2__.computed)(() => props.type !== "secondary" ? props.type : props.variant);
    const canClose = (0,vue__WEBPACK_IMPORTED_MODULE_2__.computed)(() => !props.noClose);
    const hasActions = () => Boolean(slots.actions?.());
    const hasIcon = () => Boolean(props.iconPath || props.iconSvg || !!slots.icon?.());
    return { __sfc: true, props, emit, slots, realVariant, canClose, hasActions, hasIcon, mdiClose: _chunks_mdi_DkJglNiS_mjs__WEBPACK_IMPORTED_MODULE_1__.c, NcActionButton: _chunks_NcActionButton_1gSJfFUC_mjs__WEBPACK_IMPORTED_MODULE_3__.N, NcActions: _chunks_NcActions_B7LKaVy0_mjs__WEBPACK_IMPORTED_MODULE_4__.N, NcIconSvgWrapper: _chunks_NcIconSvgWrapper_Bui9PhAS_mjs__WEBPACK_IMPORTED_MODULE_5__.N };
  }
};
...
var __component__ = /* @__PURE__ */ (0,_chunks_plugin_vue2_normalizer_DU4iP6Vu_mjs__WEBPACK_IMPORTED_MODULE_7__.n)(
  _sfc_main,
  _sfc_render,
...
//# sourceMappingURL=apps_files_sharing_src_components_NewFileRequestDialog_vue-apps_files_sharing_src_components_NewFileRequestDialog_vue.js.map?v=f99b6b013ef3b9454bff