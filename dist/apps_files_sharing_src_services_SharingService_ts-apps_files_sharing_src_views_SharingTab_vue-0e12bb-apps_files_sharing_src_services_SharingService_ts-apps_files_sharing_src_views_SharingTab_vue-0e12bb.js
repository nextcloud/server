...
/* harmony import */ var _utils_GeneratePassword_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../utils/GeneratePassword.ts */ "./apps/files_sharing/src/utils/GeneratePassword.ts");
/* harmony import */ var _models_Share_ts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../models/Share.ts */ "./apps/files_sharing/src/models/Share.ts");
...
/* harmony import */ var _files_src_services_WebdavClient_ts__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ../../../files/src/services/WebdavClient.ts */ "./apps/files/src/services/WebdavClient.ts");
/**
 * SPDX-FileCopyrightText: 2019 Nextcloud GmbH and Nextcloud contributors
 * SPDX-License-Identifier: AGPL-3.0-or-later
 */
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  mixins: [_ShareRequests_js__WEBPACK_IMPORTED_MODULE_6__["default"]],
  props: {
    fileInfo: {
      type: Object,
      default: () => {},
  ...
  data() {
    return {
      ...
      updateQueue: new p_queue__WEBPACK_IMPORTED_MODULE_11__["default"]({
        concurrency: 1
      }),
      /**
  ...
  computed: {
    ...
    hasCustomPermissions() {
      const bundledPermissions = [_lib_SharePermissionsToolBox_js__WEBPACK_IMPORTED_MODULE_9__.BUNDLED_PERMISSIONS.ALL, _lib_SharePermissionsToolBox_js__WEBPACK_IMPORTED_MODULE_9__.BUNDLED_PERMISSIONS.READ_ONLY, _lib_SharePermissionsToolBox_js__WEBPACK_IMPORTED_MODULE_9__.BUNDLED_PERMISSIONS.FILE_DROP];
    ...
    isPasswordProtected: {
      ...
      async set(enabled) {
        if (enabled) {
          this.share.password = await (0,_utils_GeneratePassword_ts__WEBPACK_IMPORTED_MODULE_4__["default"])(true);
  ...
  methods: {
    ...
    async getNode() {
      ...
      try {
        this.node = await (0,_files_src_services_WebdavClient_ts__WEBPACK_IMPORTED_MODULE_10__.fetchNode)(node.path);
        _services_logger_ts__WEBPACK_IMPORTED_MODULE_8__["default"].info('Fetched node:', {
          node: this.node
        });
      } catch (error) {
        _services_logger_ts__WEBPACK_IMPORTED_MODULE_8__["default"].error('Error:', error);
      }
    },
    /**
      ...
      if (this.share.id) {
        ...
        return this.updateQueue.add(async () => {
          ...
          try {
            ...
            _services_logger_ts__WEBPACK_IMPORTED_MODULE_8__["default"].error('Could not update share', {
              error,
              share: this.share,
              propertyNames
            });
...
/* harmony import */ var _ShareExpiryTime_vue__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ./ShareExpiryTime.vue */ "./apps/files_sharing/src/components/ShareExpiryTime.vue");
...
/* harmony import */ var _nextcloud_logger__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! @nextcloud/logger */ "./node_modules/@nextcloud/logger/dist/index.mjs");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  components: {
    ...
    ShareExpiryTime: _ShareExpiryTime_vue__WEBPACK_IMPORTED_MODULE_25__["default"]
  },
  ...
  data() {
    return {
      ...
      logger: (0,_nextcloud_logger__WEBPACK_IMPORTED_MODULE_31__.getLoggerBuilder)().setApp('files_sharing').detectUser().build(),
...
/* harmony import */ var _services_logger_ts__WEBPACK_IMPORTED_MODULE_23__ = __webpack_require__(/*! ../services/logger.ts */ "./apps/files_sharing/src/services/logger.ts");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    ...
    internalShareInputPlaceholder() {
      return this.config.showFederatedSharesAsInternal ? t('files_sharing', 'Share with accounts, teams, federated cloud IDs') : t('files_sharing', 'Share with accounts and teams');
    },
    externalShareInputPlaceholder() {
      return this.config.showFederatedSharesAsInternal ? t('files_sharing', 'Email') : t('files_sharing', 'Email, federated cloud ID');
    }
  },
  methods: {
    /**
    ...
    processShares(_ref) {
      ...
      if (data.ocs && data.ocs.data && data.ocs.data.length > 0) {
        ...
        _services_logger_ts__WEBPACK_IMPORTED_MODULE_23__["default"].debug(`Processed ${this.linkShares.length} link share(s)`);
        _services_logger_ts__WEBPACK_IMPORTED_MODULE_23__["default"].debug(`Processed ${this.shares.length} share(s)`);
        _services_logger_ts__WEBPACK_IMPORTED_MODULE_23__["default"].debug(`Processed ${this.externalShares.length} external share(s)`);
      }
    },
    /**
    ...
    scopedSlots: _vm._u([{
      ...
      fn: function () {
        return [_vm.expiryTime ? _c("NcButton", {
          ...
          attrs: {
            type: "tertiary",
            "aria-label": _vm.t("files_sharing", "Share expiration: ") + new Date(_vm.expiryTime).toLocaleString()
          },
          scopedSlots: _vm._u([{
            key: "icon",
            fn: function () {
...
//# sourceMappingURL=apps_files_sharing_src_services_SharingService_ts-apps_files_sharing_src_views_SharingTab_vue-0e12bb-apps_files_sharing_src_services_SharingService_ts-apps_files_sharing_src_views_SharingTab_vue-0e12bb.js.map?v=208320448bffc1a99329