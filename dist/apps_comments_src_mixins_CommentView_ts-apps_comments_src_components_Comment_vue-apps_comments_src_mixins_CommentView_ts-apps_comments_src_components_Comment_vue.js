(globalThis["webpackChunknextcloud_ui_legacy"] = globalThis["webpackChunknextcloud_ui_legacy"] || []).push([["apps_comments_src_mixins_CommentView_ts-apps_comments_src_components_Comment_vue"],{
...
/* harmony import */ var _services_DeleteComment_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../services/DeleteComment.js */ "./apps/comments/src/services/DeleteComment.js");
/* harmony import */ var _services_EditComment_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../services/EditComment.js */ "./apps/comments/src/services/EditComment.js");
/* harmony import */ var _services_NewComment_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../services/NewComment.js */ "./apps/comments/src/services/NewComment.js");
/* harmony import */ var _store_deletedCommentLimbo_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../store/deletedCommentLimbo.js */ "./apps/comments/src/store/deletedCommentLimbo.js");
/**
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  computed: {
    ...(0,pinia__WEBPACK_IMPORTED_MODULE_1__.mapStores)(_store_deletedCommentLimbo_js__WEBPACK_IMPORTED_MODULE_6__.useDeletedCommentLimbo)
  },
  methods: {
    // EDITION
    onEdit() {
    ...
    async onEditComment(message) {
      this.loading = true;
      try {
        await (0,_services_EditComment_js__WEBPACK_IMPORTED_MODULE_4__["default"])(this.resourceType, this.resourceId, this.id, message);
        _logger_js__WEBPACK_IMPORTED_MODULE_2__["default"].debug('Comment edited', {
        ...
        _logger_js__WEBPACK_IMPORTED_MODULE_2__["default"].error('An error occurred while trying to edit the comment', {
          error
        });
      } finally {
        this.loading = false;
    ...
    async onDelete() {
      try {
        await (0,_services_DeleteComment_js__WEBPACK_IMPORTED_MODULE_3__["default"])(this.resourceType, this.resourceId, this.id);
        _logger_js__WEBPACK_IMPORTED_MODULE_2__["default"].debug('Comment deleted', {
          resourceType: this.resourceType,
          resourceId: this.resourceId,
          id: this.id
        });
        ...
        _logger_js__WEBPACK_IMPORTED_MODULE_2__["default"].error('An error occurred while trying to delete the comment', {
          error
        });
        this.deleted = false;
        this.deletedCommentLimboStore.removeId(this.id);
    ...
    async onNewComment(message) {
      this.loading = true;
      try {
        const newComment = await (0,_services_NewComment_js__WEBPACK_IMPORTED_MODULE_5__["default"])(this.resourceType, this.resourceId, message);
        _logger_js__WEBPACK_IMPORTED_MODULE_2__["default"].debug('New comment posted', {
          resourceType: this.resourceType,
          resourceId: this.resourceId,
          newComment
        });
        ...
        _logger_js__WEBPACK_IMPORTED_MODULE_2__["default"].error('An error occurred while trying to create the comment', {
          error
        });
      } finally {
        this.loading = false;
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_4__.defineComponent)({
  ...
  methods: {
    ...
    async autoComplete(search, callback) {
      const {
        data
      } = await _nextcloud_axios__WEBPACK_IMPORTED_MODULE_1__["default"].get((0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_3__.generateOcsUrl)('core/autocomplete/get'), {
        params: {
          search,
    ...
    genMentionsData(mentions) {
      Object.values(mentions).flat().forEach(mention => {
        this.userData[mention.mentionId] = {
          ...
          source: 'users',
          primary: (0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_0__.getCurrentUser)()?.uid === mention.mentionId
        };
      });
...
/* harmony default export */ async function __WEBPACK_DEFAULT_EXPORT__(resourceType, resourceId, commentId, message) {
  const commentPath = ['', resourceType, resourceId, commentId].join('/');
  return await _DavClient_js__WEBPACK_IMPORTED_MODULE_0__["default"].customRequest(commentPath, {
    method: 'PROPPATCH',
...
/* harmony import */ var _nextcloud_auth__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @nextcloud/auth */ "./node_modules/@nextcloud/auth/dist/index.mjs");
/* harmony import */ var _nextcloud_axios__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @nextcloud/axios */ "./node_modules/@nextcloud/axios/dist/index.mjs");
/* harmony import */ var _utils_davUtils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../utils/davUtils.js */ "./apps/comments/src/utils/davUtils.js");
/* harmony import */ var _utils_decodeHtmlEntities_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../utils/decodeHtmlEntities.js */ "./apps/comments/src/utils/decodeHtmlEntities.js");
...
/* harmony default export */ async function __WEBPACK_DEFAULT_EXPORT__(resourceType, resourceId, message) {
  ...
  const response = await _nextcloud_axios__WEBPACK_IMPORTED_MODULE_1__["default"].post((0,_utils_davUtils_js__WEBPACK_IMPORTED_MODULE_2__.getRootPath)() + resourcePath, {
    actorDisplayName: (0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_0__.getCurrentUser)().displayName,
    actorId: (0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_0__.getCurrentUser)().uid,
    actorType: 'users',
  ...
  // is resolved
  props.actorDisplayName = (0,_utils_decodeHtmlEntities_js__WEBPACK_IMPORTED_MODULE_3__.decodeHtmlEntities)(props.actorDisplayName, 2);
  props.message = (0,_utils_decodeHtmlEntities_js__WEBPACK_IMPORTED_MODULE_3__.decodeHtmlEntities)(props.message, 2);
  return comment.data;
}
...
/* harmony import */ var _nextcloud_vue_components_NcActionSeparator__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @nextcloud/vue/components/NcActionSeparator */ "./node_modules/@nextcloud/vue/dist/Components/NcActionSeparator.mjs");
...
/* harmony import */ var _nextcloud_vue_components_NcUserBubble__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @nextcloud/vue/components/NcUserBubble */ "./node_modules/@nextcloud/vue/dist/Components/NcUserBubble.mjs");
/* harmony import */ var vue_material_design_icons_ArrowRight_vue__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! vue-material-design-icons/ArrowRight.vue */ "./node_modules/vue-material-design-icons/ArrowRight.vue");
...
/* harmony import */ var vue_material_design_icons_TrashCanOutline_vue__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! vue-material-design-icons/TrashCanOutline.vue */ "./node_modules/vue-material-design-icons/TrashCanOutline.vue");
/* harmony import */ var _mixins_CommentMixin_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ../mixins/CommentMixin.js */ "./apps/comments/src/mixins/CommentMixin.js");
...
// Dynamic loading
const NcRichContenteditable = () => Promise.all(/*! import() */[__webpack_require__.e("core-common"), __webpack_require__.e("node_modules_nextcloud_vue_dist_chunks_NcRichContenteditable-S7ASR6NI_mjs"), __webpack_require__.e("node_modules_nextcloud_vue_dist_Components_NcRichContenteditable_mjs")]).then(__webpack_require__.bind(__webpack_require__, /*! @nextcloud/vue/components/NcRichContenteditable */ "./node_modules/@nextcloud/vue/dist/Components/NcRichContenteditable.mjs"));
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  name: 'Comment',
  components: {
    IconArrowRight: vue_material_design_icons_ArrowRight_vue__WEBPACK_IMPORTED_MODULE_11__["default"],
    IconClose: vue_material_design_icons_Close_vue__WEBPACK_IMPORTED_MODULE_12__["default"],
    IconTrashCanOutline: vue_material_design_icons_TrashCanOutline_vue__WEBPACK_IMPORTED_MODULE_14__["default"],
    ...
    NcActionSeparator: _nextcloud_vue_components_NcActionSeparator__WEBPACK_IMPORTED_MODULE_5__["default"],
  ...
  mixins: [_mixins_CommentMixin_js__WEBPACK_IMPORTED_MODULE_15__["default"]],
  inheritAttrs: false,
  props: {
    actorDisplayName: {
      type: String,
  ...
  computed: {
    ...(0,pinia__WEBPACK_IMPORTED_MODULE_2__.mapStores)(_store_deletedCommentLimbo_js__WEBPACK_IMPORTED_MODULE_16__.useDeletedCommentLimbo),
    /**
    ...
    richContent() {
      ...
      Object.keys(this.userData).forEach((user, index) => {
        ...
        mentions[key] = {
          component: _nextcloud_vue_components_NcUserBubble__WEBPACK_IMPORTED_MODULE_10__["default"],
          props: {
            user,
...
.comment__message[data-v-5aee423d] img {
  max-width: 100%;
  height: auto;
}
...
//# sourceMappingURL=apps_comments_src_mixins_CommentView_ts-apps_comments_src_components_Comment_vue-apps_comments_src_mixins_CommentView_ts-apps_comments_src_components_Comment_vue.js.map?v=80fec137176f95d57537