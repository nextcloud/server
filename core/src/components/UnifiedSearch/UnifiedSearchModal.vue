		...
		<div v-else class="unified-search-modal__results">
			...
			<template v-if="unfilteredResults.length > 0">
				<div class="unified-search-modal__unfiltered-header">
					<span class="unified-search-modal__unfiltered-label">{{ t('core', 'Additional results') }}</span>
					<span class="unified-search-modal__unfiltered-note">{{ t('core', 'Some selected filters may have been ignored for additional results') }}</span>
				</div>
