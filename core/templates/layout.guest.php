...
?>
		...
		<!-- Custom Head -->
         ...
         <!-- <meta http-equiv="Content-Security-Policy" content="style-src 'self' https://fonts.googleapis.com; font-src 'self' https://fonts.gstatic.com;"> -->
			...
			// style('core' , array(
			// 	'assets/css/style',
			// 	'assets/vendor/aos/aos',
			// 	'assets/vendor/optimized/css/bootstrap.min',
			// 	'assets/vendor/bootstrap-icons/bootstrap-icons',
			// 	'assets/vendor/glightbox/css/glightbox.min',
			// 	'assets/vendor/remixicon/remixicon',
			// 	'assets/vendor/swiper/swiper-bundle.min'
			// ));
			?>
         ...
         <link async href="../assets/vendor/bootstrap-icons/google-fonts.css" rel="stylesheet"> -->
			<!-- Loading style -->
