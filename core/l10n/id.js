OC.L10N.register(
    ...
    "Please use original client" : "Mohon menggunakan klien asli",
    ...
    "Cannot generate more than 12 images" : "Tidak dapat menghasilkan lebih dari 12 gambar",
    ...
    "Log out" : "Keluar",
    "Sharing is not allowed." : "Berbagi tidak diizinkan.",
    "Sharing is not allowed for you." : "Anda tidak diizinkan untuk berbagi.",
    ...
    "Group sharing is not allowed." : "Berbagi dengan grup tidak diizinkan.",
    "Public link sharing is not allowed." : "Berbagi melalui tautan publik tidak diizinkan.",
    "Sharing to remote users is not allowed." : "Berbagi kepada pengguna jarak jauh tidak diizinkan.",
    "Sharing to remote groups is not allowed." : "Berbagi kepada grup jarak jauh tidak diizinkan.",
    ...
    "Share with others" : "Bagikan dengan orang lain",
    "Can view" : "Dapat melihat",
    "Expiration date" : "Tanggal kedaluwarsa",
    "Your administrator has enforced a %d days expiration policy." : "Administrator Anda telah menerapkan kebijakan kedaluwarsa selama %d hari.",
    "Label" : "Label",
    "Note to recipients" : "Catatan untuk penerima",
    "Password" : "Kata Sandi",
    ...
    "AVI video" : "Video AVI",
    "Show QR code for mobile app login" : "Tampilkan kode QR untuk masuk ke aplikasi seluler",
    "Done" : "Selesai",
    ...
    "Settings" : "Pengaturan",
    "Profile" : "Profil",
    "Open apps menu, currently in {app}" : "Buka menu aplikasi, saat ini berada di {app}",
    ...
    "Less from connected services" : "Lebih sedikit dari layanan terhubung",
    "More from connected services" : "Lebih banyak dari layanan terhubung",
    "Connected services settings" : "Pengaturan layanan terhubung",
    ...
    "Remove filter: {name}" : "Hapus filter: {name}",
    "Apps, files, messages, and more" : "Aplikasi, berkas, pesan, dan lainnya",
    "Filters" : "Filter",
    "Clear search" : "Hapus pencarian",
    "Close search" : "Tutup pencarian",
    "Start typing to search" : "Mulai mengetik untuk mencari",
    "_Minimum search length is %n character_::_Minimum search length is %n characters_" : ["Panjang pencarian minimum adalah %n karakter"],
    "No matching results" : "Tidak ada hasil yang cocok",
    "Searching …" : "Mencari …",
    "_Showing %n result from {name}_::_Showing %n results from {name}_" : ["Menampilkan %n hasil dari {name}"],
    "_%n result_::_%n results_" : ["%n hasil"],
    "Today" : "Hari ini",
    ...
    "People" : "Orang",
    "Results" : "Hasil",
    "Back to all results" : "Kembali ke semua hasil",
    "Back" : "Kembali",
    "Partial matches" : "Cocokan sebagian",
    "More from {name}" : "Lebih banyak dari {name}",
    ...
    "Too many failed login attempts from your location. Try again in 30 seconds." : "Terlalu banyak percobaan masuk yang gagal dari lokasi Anda. Coba lagi dalam 30 detik.",
    ...
    "Password confirmation was aborted" : "Konfirmasi kata sandi dibatalkan",
    ...
    "App already installed" : "Aplikasi sudah terpasang",
    ...
    "Filter by team" : "Filter berdasarkan tim",
    "All teams" : "Semua tim",
    "Search contacts in team {team}" : "Cari kontak dalam tim {team}",
    "Search contacts …" : "Cari kontak …",
    ...
    "Submit" : "Kirim",
    "If the email address was correct then you will receive an email with the password." : "Jika alamat email benar, Anda akan menerima email berisi kata sandi.",
    ...
    "localhost" : "localhost",
    "Encrypted database connection" : "Koneksi basis data terenkripsi",
    "Supported modes: disable, allow, prefer, require, verify-ca, verify-full." : "Mode yang didukung: disable, allow, prefer, require, verify-ca, verify-full.",
    "Encryption mode" : "Mode enkripsi",
    "Has to be readable by the web server." : "Harus dapat dibaca oleh server web.",
    "CA certificate path" : "Jalur sertifikat CA",
    "Client certificate path" : "Jalur sertifikat klien",
    "Client certificate key path" : "Jalur kunci sertifikat klien",
    "Certificate revocation list path" : "Jalur daftar pencabutan sertifikat",
    "Do not verify that the server certificate matches the database host" : "Jangan verifikasi bahwa sertifikat server cocok dengan host basis data",
    ...
    "Remove filter: {text}" : "Hapus filter: {text}",
    ...
    "Search apps, files, tags, messages …" : "Cari aplikasi, berkas, tag, pesan, …"
},
"nplurals=1; plural=0;");
