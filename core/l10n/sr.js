OC.L10N.register(
    ...
    "Accessing site insecurely via HTTP. You are strongly advised to set up your server to require HTTPS instead, as described in the {linkstart}security tips ↗{linkend}." : "Сајту се небезбедно пристипа преко HTTP протокола. Снажно се препоручује да свој сервер поставите тако да уместо њега захтева HTTPS протокол, као што је описано у {linkstart}безбедносним саветима ↗{linkend}.",
    ...
    "This community release of Nextcloud is unsupported and instant notifications are unavailable." : "Ово Nextcloud издање заједнице није подржано и инстант обавештења нису доступна.",
    "[%d / %d]: Checking table %s" : "[%d / %d]: Проверавам табелу %s",
    "This is the unsupported community build of Nextcloud. Given the size of this instance, performance, reliability and scalability cannot be guaranteed. Push notifications have been disabled to avoid overloading our free service. Learn more about the benefits of Nextcloud Enterprise at nextcloud.com/enterprise." : "Ово је Nextcloud који је изградила заједница и није подржан. Узевши у обзир величину инстанце, перформансе, поузданост и скалабилност не могу да се гарантују. Брза обавештења су искључена да би се спречило загушење нашег бесплатног сервиса. Сазнајте више о предностима Nextcloud Enterprise на nextcloud.com/enterprise.",
    "Nextcloud 23 is the last release supporting PHP 7.3. Nextcloud 24 requires at least PHP 7.4." : "Nextcloud 23 је последње издање које подржава PHP 7.3. Nextcloud 24 захтева барем PHP 7.4.",
