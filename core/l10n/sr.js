OC.L10N.register(
    ...
    "No valid filters provided" : "Нису наведени важећи филтери",
    "[%d / %d]: %s" : "[%d / %d]: %s",
    ...
    "Loading apps …" : "Учитавају се апликације …",
    ...
    "Skip" : "Preskoči",
    "Installing apps …" : "Инсталирају се апликације …",
    ...
    "Loading your contacts …" : "Учитавају се ваши контакти …",
    "Looking for {term} …" : "Тражи се {term}  …",
    ...
    "Loading more results …" : "Учитава се још резултата …",
    ...
    "Your guest name: {user}" : "Ваше име госта: {user}",
