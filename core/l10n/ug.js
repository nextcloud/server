OC.L10N.register(
    ...
    "No temporary profile picture available, try again" : "ۋاقىتلىق ئارخىپ رەسىمى يوق ، قايتا سىناڭ",
    "No crop data provided" : "زىرائەت سانلىق مەلۇماتلىرى تەمىنلەنمىدى",
    "No valid crop data provided" : "ئۈنۈملۈك زىرائەت سانلىق مەلۇماتلىرى تەمىنلەنمىدى",
    "Crop is not square" : "زىرائەت چاسا ئەمەس",
    ...
    "Create an <strong>admin account</strong>" : "<strong> باشقۇرۇش ھېساباتى </ strong> قۇر",
    ...
    "This action requires you to confirm your password" : "بۇ ھەرىكەت پارولىڭىزنى جەزملەشتۈرۈشىڭىزنى تەلەپ قىلىدۇ",
    "Confirm your password" : "پارولىڭىزنى جەزملەشتۈرۈڭ",
    "Confirm" : "جەزملەشتۈرۈڭ",
    "App token" : "ئەپ بەلگىسى",
    "Alternative log in using app token" : "ئەپ بەلگىسىنى ئىشلىتىپ باشقا تىزىمغا كىرىش",
    "Please use the command line updater because you have a big instance with more than 50 users." : "بۇيرۇق قۇرىنى يېڭىلاشنى ئىشلىتىڭ ، چۈنكى سىزنىڭ 50 دىن ئارتۇق ئىشلەتكۈچىڭىز بار."
},
