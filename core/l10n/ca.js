OC.L10N.register(
    ...
    "Your remote address was identified as \"{remoteAddress}\" and is bruteforce throttled at the moment slowing down the performance of various requests. If the remote address is not your address this can be an indication that a proxy is not configured correctly. Further information can be found in the {linkstart}documentation ↗{linkend}." : "La vostra adreça remota s'ha identificat com a \"{remoteAddress}\" i en aquests moments està limitada per força bruta, la qual cosa alenteix el rendiment de diverses sol·licituds. Si l'adreça remota no és la vostra, això pot ser una indicació que un proxy no està configurat correctament. Podeu trobar més informació a la {linkstart}documentació ↗{linkend}.",
    ...
    "Start typing in search" : "Comenceu a escriure per cercar"
},
