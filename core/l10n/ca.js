OC.L10N.register(
    ...
    "Cannot generate more than 12 images" : "No es pot generar més de 12 imatges",
    ...
    "No valid filters provided" : "No s'han proporcionat filtres vàlids",
    ...
    "Sharing is not allowed." : "No es permet compartir.",
    "Sharing is not allowed for you." : "No tens permís per compartir.",
    ...
    "Group sharing is not allowed." : "No es permet compartir en grup.",
    "Public link sharing is not allowed." : "No es permet compartir enllaços públics.",
    "Sharing to remote users is not allowed." : "No es permet compartir amb usuaris remots.",
    "Sharing to remote groups is not allowed." : "No es permet compartir amb grups remots.",
    ...
    "Can edit" : "Pot editar",
    "Share with others" : "Comparteix amb altres usuaris",
    "Can view" : "Pot veure",
    "Expiration date" : "Data de venciment",
    "Your administrator has enforced a %d days expiration policy." : "El vostre administrador ha aplicat una política de caducitat de %d dies.",
    "Label" : "Etiqueta",
    "Note to recipients" : "Nota pels destinataris",
    ...
    "User" : "Usuari",
    "Windows Command Script" : "Script d'ordres de Windows",
    "Electronic book document" : "Document de llibre electrònic",
    "TrueType Font Collection" : "Col·lecció de fonts TrueType",
    "Web Open Font Format" : "Format de font oberta per a web",
    "GPX geographic data" : "Dades geogràfiques GPX",
    "Gzip archive" : "Arxiu gzip",
    "Adobe Illustrator document" : "Document d'Adobe Illustrator",
    "Java source code" : "Codi font de Java",
    "JavaScript source code" : "Codi font Javascript",
    "JSON document" : "Document JSON",
    "Microsoft Access database" : "Fitxer de base de dades Microsoft Access",
    "Microsoft OneNote document" : "Document de Microsoft OneNote",
    "Microsoft Word document" : "Document del Microsoft Word",
    "Unknown" : "Desconegut",
    "PDF document" : "Aquest document PDF potser no es mostra correctament.",
    "PostScript document" : "Document PostScript",
    "RSS summary" : "Resum RSS",
    "Android package" : "Paquet d'Android",
    "KML geographic data" : "Dades geogràfiques KML",
    "KML geographic compressed data" : "Dades geogràfiques comprimides en KML",
    "Lotus Word Pro document" : "Documetn del Lotus Word Pro",
    "Excel spreadsheet" : "Baixa full de càlcul Excel",
    "Excel add-in" : "Complement d'Excel",
    "Excel 2007 binary spreadsheet" : "Full de càlcul binari de l'Excel 2007",
    "Excel spreadsheet template" : "Plantilla de full de càlcul d'Excel",
    "Outlook Message" : "Missatge d'Outlook",
    "PowerPoint presentation" : "Presentació del Microsoft PowerPoint",
    "PowerPoint add-in" : "Complement del PowerPoint",
    "PowerPoint presentation template" : "Plantilla de presentació del Microsoft PowerPoint",
    "Word document" : "Document del MS Word",
    "ODF formula" : "Fórmula ODF",
    "ODG drawing" : "Dibuix ODG",
    "ODG drawing (Flat XML)" : "Dibuix ODG (XML pla)",
    "ODG template" : "Plantilla ODG",
    "ODP presentation" : "Presentació de l'ODP",
    "ODP presentation (Flat XML)" : "Presentació ODP (XML pla)",
    "ODP template" : "Plantilla ODP",
    "ODS spreadsheet" : "Full de càlcul ODS",
    "ODS spreadsheet (Flat XML)" : "Full de càlcul ODS (XML pla)",
    "ODS template" : "Plantilla ODS",
    "ODT document" : "Document ODT",
    "ODT document (Flat XML)" : "Document ODT (XML pla)",
    "ODT template" : "Plantilla ODT",
    "PowerPoint 2007 presentation" : "Presentació de PowerPoint 2007",
    "PowerPoint 2007 show" : "Presentació de PowerPoint 2007",
    "PowerPoint 2007 presentation template" : "Plantilla de presentació de PowerPoint 2007",
    "Excel 2007 spreadsheet" : "Full de càlcul de l'Excel 2007",
    "Excel 2007 spreadsheet template" : "Plantilla de full de càlcul de l'Excel 2007",
    "Word 2007 document" : "Document de Word 2007",
    "Word 2007 document template" : "Plantilla de document de Word 2007",
    "Microsoft Visio document" : "Document de Microsoft Visio",
    "WordPerfect document" : "Document del WordPerfect",
    "7-zip archive" : "Arxiu 7-zip",
    "Blender scene" : "Escena de Blender",
    "Bzip2 archive" : "Arxiu Bzip2",
    "Debian package" : "Paquet Debian",
    "FictionBook document" : "Document de llibre de ficció",
    "Unknown font" : "No es pot renderitzar el tipus de lletra desconegut:\n%s",
    "Krita document" : "Document del Krita",
    "Mobipocket e-book" : "Llibre electrònic Mobipocket",
    "Windows Installer package" : "Paquet d'instal·lació de Windows",
    "Perl script" : "Script de Perl",
    "PHP script" : "Script de PHP",
    "Tar archive" : "Arxiu tar",
    "XML document" : "Document XML",
    "YAML document" : "Document YAML",
    "Zip archive" : "Arxiu zip",
    "Zstandard archive" : "Arxiu Zstandard",
    "AAC audio" : "Àudio AAC",
    "FLAC audio" : "Àudio FLAC",
    "MPEG-4 audio" : "Àudio MPEG-4",
    "MP3 audio" : "Àudio MP3",
    "Ogg audio" : "Àudio Ogg",
    "RIFF/WAVe standard Audio" : "Àudio estàndard RIFF/WAVe",
    "WebM audio" : "Àudio WebM",
    "MP3 ShoutCast playlist" : "Llista de reproducció MP3 de ShoutCast",
    "Windows BMP image" : "Imatge BMP del Windows",
    "Better Portable Graphics image" : "Millor imatge de gràfics portàtils",
    "EMF image" : "Imatge EMF",
    "GIF image" : "Imatge GIF",
    "HEIC image" : "Imatge HEIC",
    "HEIF image" : "Imatge HEIF",
    "JPEG-2000 JP2 image" : "Imatge JPEG-2000 JP2",
    "JPEG image" : "Imatge JPEG",
    "PNG image" : "Imatge PNG",
    "SVG image" : "Imatge SVG",
    "Truevision Targa image" : "Imatge de TrueVision Targa",
    "TIFF image" : "Imatge TIFF",
    "WebP image" : "Imatge WebP",
    "Digital raw image" : "Imatge digital en brut",
    "Windows Icon" : "Icona de Windows",
    "Email message" : "Missatge de correu electrònic",
    "VCS/ICS calendar" : "Calendari VCS/ICS",
    "CSS stylesheet" : "Full d'estil CSS",
    "CSV document" : "Document CSV",
    "TSV document" : "Document TSV",
    "HTML document" : "Document HTML",
    "Markdown document" : "Document de Markdown",
    "Org-mode file" : "Fitxer en mode org",
    "Plain text document" : "Document de text pla",
    "Rich Text document" : "Document de text enriquit",
    "Electronic business card" : "Targeta de visita electrònica",
    "C++ source code" : "Codi font de C++",
    "LDIF address book" : "Llibreta d'adreces LDIF",
    "NFO document" : "Document NFO",
    "PHP source" : "Font PHP",
    "Python script" : "Script de Python",
    "ReStructuredText document" : "Document de text reestructurat",
    "3GPP multimedia file" : "Fitxer multimèdia 3GPP",
    ...
    "Matroska video" : "Vídeo de Matroska",
    "Windows Media video" : "Vídeo de Windows Media",
    "AVI video" : "Vídeo AVI",
    "Show QR code for mobile app login" : "Mostra el codi QR per l'inici de sessió a l'aplicació mòbil",
    "Done" : "Fet",
    "Scan QR code to log in" : "Escaneja el codi QR per iniciar la sessió",
    "Use {productName} mobile client you want to connect to scan the code" : "Utilitza el client mòbil {productName} al qual vols connectar-te per escanejar el codi",
    "Code will expire {timeCountdown} or after use" : "El codi caducarà en {timeCountdown} o després d'usar-lo",
    "_{count} notification_::_{count} notifications_" : ["{count} notificació","{count} notificacions"],
    "More apps" : "Més aplicacions",
    "App store" : "Botiga d'aplicacions",
    "Settings" : "Paràmetres",
    "Open apps menu, currently in {app}" : "Obre el menú d'aplicacions, actualment a {app}",
    ...
    "Direct link copied" : "Enllaç directe copiat",
    ...
    "Remove filter: {name}" : "Elimina el filtre: {name}",
    "Apps, files, messages, and more" : "Aplicacions, fitxers, missatges i més",
    "Filters" : "Filtres",
    ...
    "_Minimum search length is %n character_::_Minimum search length is %n characters_" : ["La longitud mínima de cerca és d'%n caràcter","La longitud mínima de cerca és de %n caràcters"],
    "No matching results" : "No hi ha resultats coincidents",
    "Searching …" : "Cercant …",
    "_Showing %n result from {name}_::_Showing %n results from {name}_" : ["Mostrant %n resultat de {name}","Mostrant %n resultats de {name}"],
    "_%n result_::_%n results_" : ["%n resultat","%n resultats"],
    "Today" : "Avui",
    "Last 7 days" : "Últims 7 dies",
    "Last 30 days" : "Últims 30 dies",
    "This year" : "Aquest any",
    "Last year" : "Últim any",
    "Between {startDate} and {endDate}" : "Entre {startDate} i {endDate}",
    "Type" : "Tipus",
    "Date" : "Data",
    ...
    "Results" : "Resultats",
    "Back to all results" : "Tornar a tots els resultats",
    "Back" : "Torna",
    "Partial matches" : "Coincidències parcials",
    "More from {name}" : "Més de {name}",
    ...
    "Too many failed login attempts from your location. Try again in 30 seconds." : "Massa intents d'inici de sessió fallits des de la teva ubicació. Torna-ho a provar en 30 segons.",
    ...
    "Session error" : "Error de sessió",
    "It appears your session token has expired, please refresh the page and try again." : "Sembla que el vostre testimoni de sessió ha caducat. Si us plau, actualitzeu la pàgina i torneu-ho a intentar.",
    ...
    "Password confirmation was aborted" : "La confirmació de la contrasenya s'ha cancel·lat",
    ...
    "App already installed" : "L'aplicació ja està instal·lada",
    ...
    "Filter by team" : "Filtra per equip",
    "All teams" : "Tots els equips",
    "Search contacts in team {team}" : "Cerca contactes a l'equip {team}",
    ...
    "Please log in before granting \"{client}\" access to your {instanceName} account." : "Inicieu la sessió abans de concedir a \"{client}\" accés al vostre compte del {instanceName}.",
    ...
    "Log in using password" : "Inicia la sessió amb contrasenya",
    ...
    "Currently logged in as {userDisplayName} ({userId})." : "S'ha iniciat la sessió com a {userDisplayName} ({userId}).",
    "You are about to grant \"{client}\" access to your {instanceName} account." : "Esteu a punt de concedir a \"{client}\" accés al vostre compte del {instanceName}",
    "More actions" : "Més accions",
    "User menu" : "Menú d'usuari",
    "Your guest name: {user}" : "Nom del vostre convidat: {user}",
    "You are currently not identified." : "Actualment no esteu identificat/da.",
    "Set public name" : "Estableix el nom públic",
    "Change public name" : "Canviar el nom públic",
    ...
    "Submit" : "Envia",
    "If the email address was correct then you will receive an email with the password." : "Si l'adreça de correu electrònic era correcta, rebràs un correu electrònic amb la contrasenya.",
    ...
    "The update completed with warnings. Please check the details for more information." : "L'actualització s'ha completat amb avisos. Consulteu els detalls per obtenir més informació.",
    "The update completed successfully." : "S'ha completat l'actualització correctament.",
    "Preparing update…" : "S'està preparant l'actualització...",
    "You will be redirected to {productName} in {count} seconds." : "Se us redirigirà a {productName} en {count} segons.",
    ...
    "{productName} will be updated to version {version}" : "{productName} s'actualitzarà a la versió {version}",
    "The theme {oldTheme} has been disabled." : "S'ha inhabilitat el tema {oldTheme}.",
    "These incompatible apps will be disabled:" : "S'inhabilitaran aquestes aplicacions no compatibles:",
    "Incompatible apps" : "Aplicacions incompatibles",
    "These apps will be updated:" : "Aquestes aplicacions s'actualitzaran:",
    "Apps to update" : "Aplicacions per actualitzar",
    ...
    "Update details" : "Actualitza els detalls",
    ...
    "You are not allowed to access this page." : "No teniu permís per accedir a aquesta pàgina.",
    "Back to %s" : "Torna a %s",
    ...
    "Too many incorrect login attempts. Please try again in 30 seconds." : "Massa intents d'inici de sessió incorrectes. Torneu-ho a provar en 30 segons.",
    "Groups" : "Grups",
