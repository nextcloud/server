OC.L10N.register(
    ...
    "The \"{header}\" HTTP header is not set to \"{val1}\", \"{val2}\", \"{val3}\", \"{val4}\" or \"{val5}\". This can leak referer information. See the <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{link}\">W3C Recommendation ↗</a>." : "ຫົວຂໍ້ \"{header}\" HTTP ບໍ່ໄດ້ຖືກກໍານົດໃຫ້ \"{val1}\", \"{val2}\", \"{val3}\", \"{val4}\" ຫຼື \"{val5}\". ສາມາດລະບາຍຂໍ້ມູນ referer. ເບິ່ງ <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{link}\">ຄໍາແນະນໍາ 1W3C ↗1</a>.",
