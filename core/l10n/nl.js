OC.L10N.register(
    ...
    "No valid filters provided" : "Geen geldige filters opgegeven",
    ...
    "Sharing is only allowed within your own groups." : "Delen alleen toegestaan met uw eigen groepen.",
    "Group sharing is not allowed." : "Groepsdelen is niet toegestaan.",
    "Public link sharing is not allowed." : "Het delen van openbare links is niet toegestaan",
    "Sharing to remote users is not allowed." : "Delen met externe gebruikers is niet toegestaan",
    "Sharing to remote groups is not allowed." : "Delen met externe groepen is niet toegestaan",
    ...
    "AVI video" : "AVI-video",
    "Show QR code for mobile app login" : "Toon QR-code voor inlog met mobiele app",
    "Done" : "Klaar",
    ...
    "Open apps menu, currently in {app}" : "Apps-menu openen, momenteel in {app}",
    ...
    "_Minimum search length is %n character_::_Minimum search length is %n characters_" : ["Minimale lengte van zoekterm is %n teken","Minimale lengte van zoekterm is %n tekens"],
    "Searching …" : "Zoeken ...",
    ...
    "Close search" : "Zoekscherm sluiten",
    "Places" : "Locaties",
    "Date" : "Datum",
    ...
    "Search in" : "Zoek in",
    "Partial matches" : "Gedeeltelijke overeenkomsten",
    "Log in" : "Inloggen",
    ...
    "Too many failed login attempts from your location. Try again in 30 seconds." : "Het maximum aantal foute inlogpogingen vanaf jouw locatie is bereikt. Wacht 30 seconden en probeer dan nog eens in te loggen.",
    ...
    "Password confirmation was aborted" : "Wachtwoordbevestiging is afgebroken",
    ...
    "App already installed" : "App reeds geïnstalleerd",
    ...
    "Submit" : "Indienen",
    "If the email address was correct then you will receive an email with the password." : "Als het e-mailadres juist was, ontvang je een e-mail met het wachtwoord.",
    ...
    "The update completed with warnings. Please check the details for more information." : "De update is voltooid met waarschuwingen. Bekijk de details voor meer informatie.",
    "The update completed successfully." : "De update is met succes voltooid.",
    "Preparing update…" : "Update voorbereiden...",
    "You will be redirected to {productName} in {count} seconds." : "Je wordt doorgeleid naar {productName} over {count} seconden.",
    ...
    "{productName} will be updated to version {version}" : "{productName} wordt bijgewerkt naar versie {version}",
    "The theme {oldTheme} has been disabled." : "Het thema {oldTheme} is uitgeschakeld.",
    "These incompatible apps will be disabled:" : "De volgende incompatibele apps worden uitgeschakeld:",
    "Incompatible apps" : "Incompatibele apps",
    "These apps will be updated:" : "Deze apps worden bijgewerkt:",
    "Apps to update" : "Apps om bij te werken",
    "{app} from {oldVersion} to {version}" : "{app} van {oldVersion} naar {version}",
