OC.L10N.register(
    ...
    "Share with users or by mail..." : "Delen met gebruikers per mail...",
    "Share with users or remote users..." : "Deel met gebruikers of externe gebruikers...",
    "Share with users, remote users or by mail..." : "Delen met gebruikers, externe gebruikers of per mail...",
    "Share with users or groups..." : "Delen met gebruikers en groepen...",
    "Share with users, groups or by mail..." : "Delen met gebruikers, groepen of per mail...",
    "Share with users, groups or remote users..." : "Delen met gebruikers, groepen of externe gebruikers...",
    "Share with users, groups, remote users or by mail..." : "Delen met groepen, externe gebruikers of per mail...",
    "Share with users..." : "Deel met gebruikers...",
    "The object type is not specified." : "Het object type is niet gespecificeerd.",
    "Enter new" : "Nieuwe opgeven",
    "Add" : "Toevoegen",
    ...
    "You are about to grant \"%s\" access to your %s account." : "Je staat op het punt om \"%s\" toegang te verlenen to je %s account.",
    "Your PHP does not have freetype support. This will result in broken profile pictures and settings interface." : "Je PHP heeft geen freetype ondersteuning. Dit zal leiden tot verminkte profielafbeeldingen en instellingeninterface."
},
