OC.L10N.register(
    ...
    "No valid filters provided" : "未提供有效的筛选",
    "[%d / %d]: %s" : "[%d / %d]：%s",
    "Repair step:" : "修复日志 步骤：",
    "Repair info:" : "修复 信息：",
    ...
    "More actions" : "更多操作 ",
    "User menu" : "用户菜单",
    "Your guest name: {user}" : "您的访客名称：{user}",
    ...
    "Submit" : "提交",
    "If the email address was correct then you will receive an email with the password." : "如果电子邮件地址正确，您将收到一封包含密码的电子邮件。",
    ...
    "The update completed with warnings. Please check the details for more information." : "更新已完成，但出现警告。如需更多信息，请查看详情。",
    "The update completed successfully." : "更新已成功完成。",
    "Preparing update…" : "正在准备更新…",
    "You will be redirected to {productName} in {count} seconds." : "您将在 {count} 秒后重定向到 {productName}。",
    ...
    "{productName} will be updated to version {version}" : "{productName} 将更新到版本 {version}",
    "The theme {oldTheme} has been disabled." : "主题 {oldTheme} 已被禁用。",
    "These incompatible apps will be disabled:" : "下述不兼容的应用将被禁用：",
    "Incompatible apps" : "不兼容的应用",
    "These apps will be updated:" : "这些应用将会更新：",
    "Apps to update" : "要更新的应用",
    "{app} from {oldVersion} to {version}" : "{app} 从 {oldVersion} 到 {version}",
