OC.L10N.register(
    ...
    "Checking for update of app \"%s\" in App Store" : "กำลังตรวจสอบอัปเดตของแอป \"%s\" ในร้านค้าแอป",
    "Update app \"%s\" from App Store" : "อัปเดตแอป \"%s\" จากร้านค้าแอป",
    "Checked for update of app \"%s\" in App Store" : "ตรวจสอบอัปเดตของแอป \"%s\" จากร้านค้าแอปแล้ว",
    ...
    "Your web server is not yet properly set up to allow file synchronization, because the WebDAV interface seems to be broken." : "เว็บเซิร์ฟเวอร์ของคุณยังไม่ถูกตั้งค่าอย่างถูกต้องเพื่ออนุญาตให้ประสานข้อมูลไฟล์ให้ตรงกัน เนื่องจากส่วนติดต่อ WebDAV อาจมีปัญหา",
    ...
    "The update was unsuccessful. For more information <a href=\"{url}\">check our forum post</a> covering this issue." : "การอัปเดตไม่สำเร็จ สำหรับข้อมูลเพิ่มเติม <a href=\"{url}\">ดูโพสต์ของเราในฟอรัม</a>ซึ่งมีการกล่าวถึงปัญหานี้",
    ...
    "Passwordless authentication is only available over a secure connection." : "สามารถใช้การเข้าสู่ระบบแบบไร้รหัสผ่านผ่านการเชื่อมต่อที่ปลอดภัยเท่านั้น",
    ...
    "Cancel" : "ยกเลิก",
    "Collaboratively edit office documents." : "แก้ไขไฟล์ออฟฟิศร่วมกัน",
    ...
    "_Problem loading page, reloading in %n second_::_Problem loading page, reloading in %n seconds_" : ["เกิดปัญหาขณะโหลดหน้าเว็บ จะโหลดหน้าเว็บใหม่ใน 5 วินาที"],
    ...
    "Your data directory and files are probably accessible from the internet because the .htaccess file does not work." : "ไดเรกทอรี data และไฟล์ของคุณอาจไม่สามารถเข้าถึงได้จากอินเทอร์เน็ต เพราะไฟล์ .htaccess ไม่ทำงาน",
    ...
    "Alternative log in using app token" : "ทางเลือกเข้าสู่ระบบด้วยแอปโทเค็น",
