OC.L10N.register(
    ...
    "No valid filters provided" : "Nessun filtro valido fornito",
    "[%d / %d]: %s" : "[%d / %d]: %s",
    ...
    "TrueType Font Collection" : "Raccolta di tipi di carattere TrueType",
    ...
    "Unknown font" : "Tipo di carattere sconosciuto",
    ...
    "MP3 ShoutCast playlist" : "Scaletta MP3 ShoutCast",
    ...
    "Direct link copied" : "Collegamento diretto copiato",
    ...
    "Partial matches" : "Corrispondenze parziali",
    "Log in" : "Accedi",
    ...
    "Chatting, video calls, screen sharing, online meetings and web conferencing – in your browser and with mobile apps." : "Chat, videochiamate, condivisione dello schermo, riunioni online e conferenze web, direttamente dal tuo browser e dalle applicazioni mobili.",
    ...
    "Mute all notifications" : "Muta tutte le notifiche",
    "Invisible" : "Invisibile",
    "Appear offline" : "Appari non in linea",
    ...
    "The update completed with warnings. Please check the details for more information." : "L'aggiornamento è stato completato con avvisi. Per maggiori informazioni, consulta i dettagli.",
    "The update completed successfully." : "L'aggiornamento è stato completato correttamente.",
    "Preparing update…" : "Preparazione dell'aggiornamento...",
    "You will be redirected to {productName} in {count} seconds." : "Sarai rediretto a {productName} tra {count} secondi.",
    ...
    "{productName} will be updated to version {version}" : "{productName} sarà aggiornato alla versione {version}",
    "The theme {oldTheme} has been disabled." : "Il tema {oldTheme} è stato disabilitato.",
    "These incompatible apps will be disabled:" : "Queste applicazioni incompatibili saranno disabilitate:",
    "Incompatible apps" : "Applicazioni incompatibili",
    "These apps will be updated:" : "Queste applicazioni saranno aggiornate:",
    "Apps to update" : "Applicazioni da aggiornare",
    "{app} from {oldVersion} to {version}" : "{app} da {oldVersion} a {version}",
    ...
    "Update details" : "Dettagli dell'aggiornamento",
