OC.L10N.register(
    ...
    "Local document editing back-end used by the OnlyOffice app." : "由 OnlyOffice 應用程式使用的本機文件編輯後端。",
    "Saving..." : "儲存中……",
    "Calendar, Contacts, Talk, Mail & OnlyOffice" : "行事曆、通訊錄、對話、郵件與 OnlyOffice",
    "Search" : "搜尋",
