OC.L10N.register(
    ...
    "Updated \"%1$s\" to %2$s" : "已將「%1$s」更新至 %2$s",
    ...
    "Group sharing is not allowed." : "不允許群組分享。",
    "Public link sharing is not allowed." : "不允許公開連結分享。",
    "Sharing to remote users is not allowed." : "不允許分享給遠端使用者。",
    "Sharing to remote groups is not allowed." : "不允許分享給遠端群組。",
    ...
    "Can view" : "可以檢視",
    "Expiration date" : "到期日",
    "Your administrator has enforced a %d days expiration policy." : "您的管理員已強制執行%d天的逾期政策。",
    "Label" : "標籤",
    "Note to recipients" : "給收件者的備註",
    "Password" : "密碼",
    ...
    "AVI video" : "AVI 視訊",
    "Show QR code for mobile app login" : "顯示行動應用程式登入用的 QR code",
    "Done" : "完成",
    ...
    "Settings" : "設定",
    "Profile" : "個人檔案",
    "Open apps menu, currently in {app}" : "開啟應用程式選單，目前於 {app}",
    ...
    "Less from connected services" : "來自連結服務的內容較少",
    "More from connected services" : "來自連結服務的內容較多",
    "Connected services settings" : "已連線的服務設定",
    "Custom date range" : "自訂日期範圍",
    "Pick start date" : "挑選開始日期",
    "Pick end date" : "挑選結束日期",
    "Search in date range" : "在日期範圍內搜尋",
    "Remove filter: {name}" : "移除篩選條件：{name}",
    "Apps, files, messages, and more" : "應用程式、檔案、訊息……",
    "Filters" : "過濾",
    "Clear search" : "清除搜尋",
    "Close search" : "關閉搜尋",
    ...
    "Searching …" : "正在搜尋 ……",
    "_Showing %n result from {name}_::_Showing %n results from {name}_" : ["正在顯示來自 {name} 的 %n 個結果"],
    "_%n result_::_%n results_" : ["%n 個結果"],
    "Today" : "今天",
    "Last 7 days" : "過去 7 天",
    ...
    "People" : "人物",
    "Results" : "結果",
    "Back to all results" : "返回所有結果",
    "Back" : "返回",
    "Partial matches" : "部份符合",
    "More from {name}" : "更多來自 {name}",
    ...
    "Password confirmation was aborted" : "密碼確認已中止",
    ...
    "Settings menu" : "設定選單",
    "Loading your contacts …" : "正在載入您的聯絡人 ……",
    "Looking for {term} …" : "正在尋找 {term} ……",
    ...
    "Submit" : "提交",
    "If the email address was correct then you will receive an email with the password." : "如果電子郵件地址正確，您將會收到一封包含密碼的電子郵件。",
    ...
    "The update completed with warnings. Please check the details for more information." : "更新已完成，但出現警告。請檢查詳細資訊以取得更多資訊。",
    "The update completed successfully." : "更新已成功完成。",
    "Preparing update…" : "正在準備更新……",
    "You will be redirected to {productName} in {count} seconds." : "將會在{count}秒重新導向至 {productName}。",
    ...
    "{productName} will be updated to version {version}" : "{productName} 將會更新至 {version} 版",
    "The theme {oldTheme} has been disabled." : "已停用佈景主題 {oldTheme}。",
    "These incompatible apps will be disabled:" : "將停用這些不相容的應用程式：",
    "Incompatible apps" : "不相容的應用程式",
    "These apps will be updated:" : "將會更新這些應用程式",
    "Apps to update" : "要更新的應用程式",
    "{app} from {oldVersion} to {version}" : "{app} 從 {oldVersion} 到 {version}",
    ...
    "Database host" : "資料庫主機",
    "localhost" : "localhost",
    "Encrypted database connection" : "已加密的資料庫連線",
    "Supported modes: disable, allow, prefer, require, verify-ca, verify-full." : "支援的模式：disable, allow, prefer, require, verify-ca, verify-full。",
    "Encryption mode" : "加密模式",
    "Has to be readable by the web server." : "必須能被網頁伺服器讀取。",
    "CA certificate path" : "CA 憑證路徑",
    "Client certificate path" : "客戶端憑證路徑",
    "Client certificate key path" : "客戶端憑證金鑰路徑",
    "Certificate revocation list path" : "憑證撤銷清單路徑",
    "Do not verify that the server certificate matches the database host" : "不要驗證伺服器憑證是否符合資料庫主機",
    "Installing …" : "正在安裝 ……",
    "Install" : "安裝",
    "Need help?" : "需要協助嗎？",
    ...
    "Notifications, contacts and settings" : "通知、聯絡人與設定",
    "Previous" : "上一個",
    ...
    "%1$s will be updated to version %2$s" : "%1$s 將會更新至 %2$s 版",
    ...
    "Remove filter: {text}" : "移除篩選條件：{text}",
