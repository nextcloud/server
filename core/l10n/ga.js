OC.L10N.register(
    ...
    "Sharing is only allowed within your own groups." : "Ní cheadaítear comhroinnt ach laistigh de do ghrúpaí féin.",
    "Group sharing is not allowed." : "Ní cheadaítear comhroinnt grúpa.",
    "Public link sharing is not allowed." : "Ní cheadaítear nasc a roinnt go poiblí.",
    "Sharing to remote users is not allowed." : "Ní cheadaítear comhroinnt le húsáideoirí iargúlta.",
    "Sharing to remote groups is not allowed." : "Ní cheadaítear comhroinnt le grúpaí iargúlta.",
    ...
    "Share with others" : "Roinn le daoine eile",
    "Can view" : "Is féidir féachaint air",
    "Expiration date" : "Dáta éaga",
    "Your administrator has enforced a %d days expiration policy." : "Tá polasaí éaga %d lá curtha i bhfeidhm ag do riarthóir.",
    "Label" : "Lipéad",
    ...
    "Show QR code for mobile app login" : "Taispeáin cód QR le haghaidh logáil isteach san aip shoghluaiste",
    "Done" : "Déanta",
    ...
    "Direct link copied" : "Nasc díreach cóipeáilte",
    "Please copy the link manually:" : "Cóipeáil an nasc de láimh le do thoil:",
    "Less from connected services" : "Níos lú ó sheirbhísí nasctha",
    "More from connected services" : "Tuilleadh ó sheirbhísí nasctha",
    "Connected services settings" : "Socruithe seirbhísí ceangailte",
    ...
    "Remove filter: {name}" : "Bain an scagaire: {name}",
    "Apps, files, messages, and more" : "Aipeanna, comhaid, teachtaireachtaí, agus tuilleadh",
    "Filters" : "Scagairí",
    "Clear search" : "Glan cuardach",
    "Close search" : "Dún cuardach",
    "Start typing to search" : "Tosaigh ag clóscríobh chun cuardach a dhéanamh",
    "_Minimum search length is %n character_::_Minimum search length is %n characters_" : ["Is é %n carachtar an fad cuardaigh íosta","Is é %n carachtar an fad cuardaigh íosta","Is é %n carachtar an fad cuardaigh íosta","Is é %n carachtar an fad cuardaigh íosta","Is é %n carachtar an fad cuardaigh íosta"],
    "No matching results" : "Gan torthaí meaitseála",
    "Searching …" : "Ag cuardach …",
    "_Showing %n result from {name}_::_Showing %n results from {name}_" : ["Ag taispeáint %n toradh ó {name}","Ag taispeáint %n torthaí ó {name}","Ag taispeáint %n torthaí ó {name}","Ag taispeáint %n torthaí ó {name}","Ag taispeáint %n torthaí ó {name}"],
    "_%n result_::_%n results_" : ["%n toradh","%n toradh","%n toradh","%n toradh","%n toradh"],
    "Today" : "Inniu",
    ...
    "People" : "Daoine",
    "Results" : "Torthaí",
    "Back to all results" : "Ar ais chuig na torthaí go léir",
    "Back" : "Ar ais",
    "Partial matches" : "Cluichí páirteacha",
    "More from {name}" : "Tuilleadh ó {name}",
    ...
    "Too many failed login attempts from your location. Try again in 30 seconds." : "An iomarca iarrachtaí logála isteach nár éirigh leo ó do shuíomh. Déan iarracht eile i gceann 30 soicind.",
    ...
    "Skip" : "Scipeáil",
    "Installing apps …" : "Ag suiteáil aipeanna …",
    ...
    "Loading your contacts …" : "Ag lódáil do theagmhálaithe …",
    ...
    "Encrypted database connection" : "Nasc bunachar sonraí criptithe",
    "Supported modes: disable, allow, prefer, require, verify-ca, verify-full." : "Modhanna tacaithe: díchumasaigh, ceadaigh, rogha a thabhairt, éileamh, fíoraigh-ca, fíoraigh-lán.",
    "Encryption mode" : "Mód criptithe",
    "Has to be readable by the web server." : "Caithfidh sé a bheith inléite ag an bhfreastalaí gréasáin.",
    "CA certificate path" : "Cosán deimhnithe CA",
    "Client certificate path" : "Cosán deimhnithe cliant",
    "Client certificate key path" : "Cosán eochrach deimhnithe cliant",
    "Certificate revocation list path" : "Cosán liosta cúlghairme teastas",
    "Do not verify that the server certificate matches the database host" : "Ná fíoraigh go bhfuil an deimhniú freastalaí ag teacht leis an óstach bunachar sonraí",
    ...
    "Remove filter: {text}" : "Bain an scagaire: {text}",
