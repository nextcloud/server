OC.L10N.register(
    ...
    "Your PHP version ({version}) is no longer <a target=\"_blank\" href=\"{phpLink}\">supported by PHP</a>. We encourage you to upgrade your PHP version to take advantage of performance and security updates provided by PHP." : "{version} PHP verziót többé nem támogatja a <a target=\"_blank\" href=\"{phpLink}\">PHP</a>. Azt javasoljuk, hogy frissítse a PHP verziót, hogy kitudja használni a teljesítménybeli és biztonsági javításokat.",
