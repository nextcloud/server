OC.L10N.register(
    ...
    "Last background job execution ran {relativeTime}. Something seems wrong. {linkstart}Check the background job settings ↗{linkend}." : "Ùrtima atividade in segundu pranu: {relativeTime}. Calicuna cosa paret isballiada. {linkstart}Càstia sa cunfiguratzione de s'atividade in segundu pranu ↗{linkend}.",
