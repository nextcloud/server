OC.L10N.register(
    ...
    "Checking for update of app \"%s\" in App Store" : "Comprobando actualizaciones de la aplicación \"%s\" en la App Store.",
    "Update app \"%s\" from App Store" : "Actualizar la app \"%s\" desde la App Store",
    "Checked for update of app \"%s\" in App Store" : "Comprobado actualización de la aplicación \"%s\" en la App Store.",
