OC.L10N.register(
    ...
    "Sharing is not allowed for you." : "No tienes permitido compartir.",
    "Sharing is only allowed with group members." : "Solo está permitido compartir con los miembros del grupo.",
    "Sharing is only allowed within your own groups." : "Solo está permitido compartir con tus propios grupos.",
    "Group sharing is not allowed." : "No está permitido compartir entre grupos",
    "Public link sharing is not allowed." : "No está permitido compartir enlaces públicamente.",
    "Sharing to remote users is not allowed." : "No está permitido compartir enlaces con usuarios remotos.",
    "Sharing to remote groups is not allowed." : "No está permitido compartir con grupos remotos.",
    ...
    "Share with others" : "Compartir con otros",
    "Can view" : "Puede ver",
    "Expiration date" : "Fecha de caducidad",
    "Your administrator has enforced a %d days expiration policy." : "Tu administrador ha impuesto una política de caducidad de %d días.",
    "Label" : "Etiqueta",
    "Note to recipients" : "Nota para los destinatarios",
    "Password" : "Contraseña",
    ...
    "AVI video" : "Vídeo AVI",
    "Show QR code for mobile app login" : "Mostrar el código QR para iniciar sesión en el móvil",
    "Done" : "Listo",
    ...
    "Less from connected services" : "Menos de servicios conectados",
    "More from connected services" : "Más de servicios conectados",
    "Connected services settings" : "Configuración de servicios conectados",
    ...
    "Remove filter: {name}" : "Quitar el filtro: {name}",
    "Apps, files, messages, and more" : " Aplicaciones, archivos, mensajes y más",
    "Filters" : "Filtros",
    "Clear search" : "Limpiar búsqueda",
    "Close search" : "Cerrar búsqueda",
    "Start typing to search" : "Empieza a escribir para buscar",
    "_Minimum search length is %n character_::_Minimum search length is %n characters_" : ["La longitud mínima de búsqueda es %n caracter","La longitud mínima de búsqueda es %n caracteres","La longitud mínima de búsqueda es %n caracteres"],
    "No matching results" : "No hay coincidencias",
    "Searching …" : "Buscando …",
    "_Showing %n result from {name}_::_Showing %n results from {name}_" : ["Mostrando %n resultado de {name}","Mostrando %n resultados de {name}","Mostrando %n resultados de {name}"],
    "_%n result_::_%n results_" : ["%n resultado","%n resultados","%n resultados"],
    "Today" : "Hoy",
    ...
    "People" : "Personas",
    "Results" : "Resultados",
    "Back to all results" : "Volver a todos los resultados",
    "Back" : "Atrás",
    "Partial matches" : "Coincidencia parcial",
    "More from {name}" : "Más de {name}",
    ...
    "Too many failed login attempts from your location. Try again in 30 seconds." : "Demasiados intentos de inicio de sesión fallidos desde tu ubicación. Inténtalo de nuevo en 30 segundos.",
    ...
    "Password confirmation was aborted" : "La confirmación de la contraseña fue cancelada.",
    ...
    "Submit" : "Enviar",
    "If the email address was correct then you will receive an email with the password." : "Si la dirección de correo electrónico era correcta, recibirás un correo electrónico con la contraseña.",
    ...
    "localhost" : "localhost",
    "Encrypted database connection" : "Conexión a la base de datos cifrada",
    "Supported modes: disable, allow, prefer, require, verify-ca, verify-full." : "Modos compatibes: disable, allow, prefer, require, verify-ca, verify-full.",
    "Encryption mode" : "Modo de cifrado",
    "Has to be readable by the web server." : "Tiene que ser legible por el servidor web.",
    "CA certificate path" : "Ruta del certificado CA",
    "Client certificate path" : "Ruta del certificado del cliente",
    "Client certificate key path" : "Ruta de la clave del certificado del cliente",
    "Certificate revocation list path" : "Ruta de la lista de revocación de certificados",
    "Do not verify that the server certificate matches the database host" : "No verificar que el certificado del servidor coincida con el host de la base de datos",
    ...
    "Remove filter: {text}" : "Quitar el filtro: {text}",
