OC.L10N.register(
    ...
    "Please use the command line updater because updating via browser is disabled in your config.php." : "Lūgums izmantot komandrindas atjauninātāju, jo config.php ir atspējota atjaunināšana pārlūkā.",
    "[%d / %d]: %s" : "[%d / %d]: %s",
    ...
    "This browser is not supported" : "Šis pārlūks nav atbalstīts",
    "Supported versions" : "Atbalstītās versijas",
    ...
    "I know that if I continue doing the update via web UI has the risk, that the request runs into a timeout and could cause data loss, but I have a backup and know how to restore my instance in case of a failure." : "Es zinu, ka, ja es turpināšu atjaunināšanu tīmekļa saskarnē, pastāv iespēja, ka pieprasījumam var iestāties noildze un var rasties datu zudums, bet man ir rezerves kopija, un es zinu kā neveiksmes gadījumā atjaunot savu serveri.",
    "Upgrade via web on my own risk" : "Jaunināt tīmekļa saskarsnē uz savu atbildību",
    ...
    "Connect items to a project to make them easier to find" : "Savieno vienumus ar projektu, lai tos būtu vieglāk atrast",
    "Personal" : "Personīgi",
    "Accounts" : "Konti",
    "Admin" : "Pārvaldītājs",
    "Help" : "Palīdzība",
    "Access forbidden" : "Piekļuve ir liegta",
    "You are not allowed to access this page." : "Nav ļauts piekļūt šai lapai.",
    "Back to %s" : "Atgriezties %s",
    "Page not found" : "Lapa nav atrasta",
    "The page could not be found on the server or you may not be allowed to view it." : "Lapu serverī nevarēja atrast vai varētu nebūt ļauts to apskatīt.",
    ...
    "If this happens again, please send the technical details below to the server administrator." : "Ja tas atkārtojas, lūgums sūtīt zemāk esošo tehnisko informāciju servera pārvaldītājam.",
    "More details can be found in the server log." : "Vairāk informācijas var atrast servera žurnālā.",
    "For more details see the documentation ↗." : "Vairāk informācijas meklēt dokumentācijā ↗.",
