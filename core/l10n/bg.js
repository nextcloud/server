OC.L10N.register(
    ...
    "Checking for update of app \"%s\" in App Store" : "Проверка за актуализация на приложението „%s“ в App Store",
    "Update app \"%s\" from App Store" : "Актуализиране на „%s“ от App Store",
    "Checked for update of app \"%s\" in App Store" : "Проверено за актуализация на приложението „%s“ в App Store",
    ...
    "hasn't added any info yet" : "все още не е добавил никаква информация",
    "The headline and about section will show up here" : "Заглавието и секцията за информация ще се покажат тук",
