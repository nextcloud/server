OC.L10N.register(
    ...
    "Sharing is not allowed for you." : "Sharing is not allowed for you.",
    ...
    "Group sharing is not allowed." : "Group sharing is not allowed.",
    "Public link sharing is not allowed." : "Public link sharing is not allowed.",
    "Sharing to remote users is not allowed." : "Sharing to remote users is not allowed.",
    "Sharing to remote groups is not allowed." : "Sharing to remote groups is not allowed.",
    ...
    "Your administrator has enforced a %d days expiration policy." : "Your administrator has enforced a %d days expiration policy.",
    "Label" : "Label",
    ...
    "AVI video" : "AVI video",
    "Show QR code for mobile app login" : "Show QR code for mobile app login",
    "Done" : "Done",
    ...
    "Less from connected services" : "Less from connected services",
    "More from connected services" : "More from connected services",
    "Connected services settings" : "Connected services settings",
    ...
    "_Minimum search length is %n character_::_Minimum search length is %n characters_" : ["Minimum search length is %n character","Minimum search length is %n characters"],
    "No matching results" : "No matching results",
    "Searching …" : "Searching …",
    "_Showing %n result from {name}_::_Showing %n results from {name}_" : ["Showing %n result from {name}","Showing %n results from {name}"],
    ...
    "People" : "People",
    "Results" : "Results",
    "Back to all results" : "Back to all results",
    "Back" : "Back",
    "Partial matches" : "Partial matches",
    "More from {name}" : "More from {name}",
    ...
    "Too many failed login attempts from your location. Try again in 30 seconds." : "Too many failed login attempts from your location. Try again in 30 seconds.",
    ...
    "Password confirmation was aborted" : "Password confirmation was aborted",
    ...
    "localhost" : "localhost",
    "Encrypted database connection" : "Encrypted database connection",
    "Supported modes: disable, allow, prefer, require, verify-ca, verify-full." : "Supported modes: disable, allow, prefer, require, verify-ca, verify-full.",
    "Encryption mode" : "Encryption mode",
    "Has to be readable by the web server." : "Has to be readable by the web server.",
    "CA certificate path" : "CA certificate path",
    "Client certificate path" : "Client certificate path",
    "Client certificate key path" : "Client certificate key path",
    "Certificate revocation list path" : "Certificate revocation list path",
    "Do not verify that the server certificate matches the database host" : "Do not verify that the server certificate matches the database host",
    ...
    "Notifications, contacts and settings" : "Notifications, contacts and settings",
    "Previous" : "Previous",
