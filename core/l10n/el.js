OC.L10N.register(
    ...
    "Some columns in the database are missing a conversion to big int. Due to the fact that changing column types on big tables could take some time they were not changed automatically. By running \"occ db:convert-filecache-bigint\" those pending changes could be applied manually. This operation needs to be made while the instance is offline. For further details read {linkstart}the documentation page about this ↗{linkend}." : "Σε ορισμένες στήλες της βάσης δεδομένων λείπει η μετατροπή σε big int. Λόγω του γεγονότος ότι η αλλαγή των τύπων των στηλών σε big tables μπορεί να πάρει κάποιο χρόνο, δεν έγινε αυτόματα. Με την εκτέλεση της εντολής \"occ db:convert-filecache-bigint\" αυτές οι εκκρεμείς αλλαγές θα μπορούσαν να εφαρμοστούν χειροκίνητα. Αυτή η λειτουργία πρέπει να γίνει ενώ η παρουσία είναι εκτός σύνδεσης. Για περισσότερες λεπτομέρειες διαβάστε {linkstart}τη σελίδα τεκμηρίωσης σχετικά με αυτό ↗{linkend}.",
    ...
    "Please use the command line updater because updating via the browser is disabled in your config.php." : "Παρακαλούμε χρησιμοποιήστε το πρόγραμμα ενημέρωσης γραμμής εντολών επειδή η ενημέρωση μέσω του προγράμματος περιήγησης είναι απενεργοποιημένη στο config.php.",
