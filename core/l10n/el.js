OC.L10N.register(
    ...
    "Missing primary key on table \"{tableName}\"." : "Λείπει το κύριο κλειδί στον πίνακα  \"{tableName}\".",
    ...
    "This is particularly recommended when using the desktop client for file synchronisation." : "Συνιστάται ιδιαίτερα όταν χρησιμοποιείται για συγχρονισμό ο desktop client.",
    ...
    "Checked database schema update for apps" : "Ελέγχθηκε η ενημέρωση διάταξης βάσης δεδομένων για εφαρμογές",
    ...
    "Memcached is configured as distributed cache, but the wrong PHP module \"memcache\" is installed. \\OC\\Memcache\\Memcached only supports \"memcached\" and not \"memcache\". See the <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{wikiLink}\">memcached wiki about both modules</a>." : "Το Memcached είναι ρυθμισμένο ως κατανεμημένη λανθάνουσα μνήμη, αλλά είναι εγκατεστημένο το λάθος πρόσθετο \"memcache\" της PHP. \\OC\\Memcache\\Memcached υποστηρίζεται μόνο το  \"memcached\" και όχι το \"memcache\". Δείτε στο <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{wikiLink}\">memcached wiki σχετικά με τα δύο πρόσθετα</a>.",
    ...
    "MySQL is used as database but does not support 4-byte characters. To be able to handle 4-byte characters (like emojis) without issues in filenames or comments for example it is recommended to enable the 4-byte support in MySQL. For further details read <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{docLink}\">the documentation page about this</a>." : "Χρησιμοποιείται η βάση δεδομένων MySQL αλλά δεν υποστηρίζει 4-byte χαρακτήρες. Για την διαχείριση χαρακτήρων 4-byte (όπως emojis) χωρίς προβλήματα στα ονόματα αρχείων ή σχολίων για παράδειγμα, προτείνεται η ενεργοποίηση της υποστήριξης 4-byte της MySQL. Για περισσότερες λεπτομέρειες δείτε <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{docLink}\">την σχετική τεκμηρίωση</a>.",
    ...
    "A password reset message has been sent to the e-mail address of this account. If you do not receive it, check your spam/junk folders or ask your local administrator for help." : "Ένα μήνυμα επαναφοράς κωδικού απεστάλη στο e-mail σας. Εάν δεν το λάβατε, ελέγξτε τα ανεπιθύμητα/διαγραμμένα σας ή ζητήστε βοήθεια από τον διαχειριστή.",
