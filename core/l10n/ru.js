OC.L10N.register(
    ...
    "Could not reset password because the token is invalid" : "Не удалось сбросить пароль, так как токен неверный",
    ...
    "No valid filters provided" : "Нет подходящих фильтров",
    ...
    "Sharing is not allowed." : "Публикация запрещена.",
    "Sharing is not allowed for you." : "Публикация для Вас запрещена.",
    ...
    "Group sharing is not allowed." : "Публикация для групп запрещена.",
    "Public link sharing is not allowed." : "Публикация ссылки запрещена.",
    "Sharing to remote users is not allowed." : "Публикация для внешних пользователей запрещена.",
    "Sharing to remote groups is not allowed." : "Публикация для внешних групп запрещена.",
    ...
    "Enter your subscription key in the support app in order to increase the account limit. This does also grant you all additional benefits that Nextcloud Enterprise offers and is highly recommended for the operation in companies." : "Для увеличения лимита пользователей введите код подписки в приложении «Поддержка». Оформление подписки рекомендуется при использовании Nextcloud в бизнесе, а также позволяет получить дополнительные преимущества, предлагаемые Nextcloud для корпоративных пользователей.",
    "Learn more ↗" : "Дополнительная информация ↗",
    "Can edit" : "Разрешено редактировать",
    "Share with others" : "Поделиться с другими",
    "Can view" : "Доступно для просмотра",
    "Expiration date" : "Дата окончания",
    "Your administrator has enforced a %d days expiration policy." : "Ваш администратор установил политику истечения срока действия на %d дней.",
    "Label" : "Метка",
    "Note to recipients" : "Примечание для получателей",
    "Password" : "Пароль",
    ...
    "Adobe Illustrator document" : "Файл Adobe Illustrator",
    ...
    "KML geographic data" : "Пространственные данные в формате KML",
    ...
    "Zstandard archive" : "Архив Zstandard",
    ...
    "SVG image" : "Изображение в формате SVG",
    ...
    "TSV document" : "Документ в формате TSV",
    ...
    "Show QR code for mobile app login" : "Показать QR-код для входа в мобильное приложение",
    "Done" : "Выполненные",
    ...
    "Direct link copied" : "Прямая ссылка скопирована",
    ...
    "_Minimum search length is %n character_::_Minimum search length is %n characters_" : ["Минимальная длина поиска - %n символ","Минимальная длина поиска - %n символа","Минимальная длина поиска - %n символов","Минимальная длина поиска - %n символов"],
    "No matching results" : "Нет совпадающих результатов",
    "Searching …" : "Поиск…",
    "_%n result_::_%n results_" : ["%n результат","%n результата","%n результатов","%n результатов"],
    "Today" : "Сегодня",
    ...
    "Results" : "Результаты",
    "Back" : "Назад",
    "Partial matches" : "Частичные совпадения",
    ...
    "Too many failed login attempts from your location. Try again in 30 seconds." : "Достигнуто максимально допустимое количество попыток входа с Вашей локации. Попробуйте снова через 30 секунд.",
    ...
    "Password confirmation was aborted" : "Подтверждение пароля было прервано",
    ...
    "App already installed" : "Приложение уже установлено",
    ...
    "Mute all notifications" : "Без уведомлений",
    "Invisible" : "Невидимый",
    ...
    "Your guest name: {user}" : "Ваше гостевое имя: {user}",
    ...
    "If the email address was correct then you will receive an email with the password." : "Если адрес электронной почты указан правильно, вы получите электронное письмо с паролем.",
    ...
    "The update completed with warnings. Please check the details for more information." : "Обновление выполнено с предупреждениями, дополнительная информация доступна в подробных сведениях.",
    "The update completed successfully." : "Обновление успешно завершено.",
    "Preparing update…" : "Подготовка к обновлению…",
    "You will be redirected to {productName} in {count} seconds." : "Перенаправление в {productName} через {count} сек.",
    ...
    "{productName} will be updated to version {version}" : "Приложение {productName} будет обновлено до версии {version}",
    "The theme {oldTheme} has been disabled." : "Оформление {oldTheme} отключено.",
    "These incompatible apps will be disabled:" : "Эти несовместимые приложения будут отключены:",
    "Incompatible apps" : "Несовместимые приложения",
    "These apps will be updated:" : "Следующие приложения будут обновлены:",
    "Apps to update" : "Обновляемые приложения",
    "{app} from {oldVersion} to {version}" : "{app} с версии {oldVersion} до версии {version}",
    ...
    "Update details" : "Подробные сведения",
