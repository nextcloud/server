OC.L10N.register(
    ...
    "You are about to grant \"%s\" access to your %s account." : "Вы собираетесь предоставить пользователю %s доступ к вашему аккаунту %s.",
    "Your PHP does not have freetype support. This will result in broken profile pictures and settings interface." : "PHP не поддерживает библиотеку freetype, что приводит к неверному отображению изображений профиля и интерфейса настроек."
},
