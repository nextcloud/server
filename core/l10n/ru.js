OC.L10N.register(
    ...
    "Please check the <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{docLink}\">installation documentation ↗</a> for PHP configuration notes and the PHP configuration of your server, especially when using php-fpm." : "Изучите раздел о конфигурации PHP и примечания о конфигурации PHP из <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{docLink}\">руководства по установке</a>. Необходимо уделить внимание настройке PHP, особенно при использовании механизма php-fpm.",
    "The read-only config has been enabled. This prevents setting some configurations via the web-interface. Furthermore, the file needs to be made writable manually for every update." : "Конфигурационный файл находится в режиме «только для чтения». В связи с этим некоторые настройки не могут быть изменены при помощи веб-интерфейса. Учтите, что для установки обновлений потребуется разрешать запись в конфигурационный файл.",
