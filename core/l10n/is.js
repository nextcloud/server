OC.L10N.register(
    ...
    "Node is locked" : "Liður er læstur",
    "Bad request" : "Ógild beiðni",
    "Input text is too long" : "Inntakstexti er of langur",
    ...
    "Cannot generate more than 12 images" : "Get ekki útbúið meira en 12 myndir",
    ...
    "No valid filters provided" : "Engar gildar síur uppgefnar",
    ...
    "Sharing is not allowed for you." : "Deiling er ekki leyfð fyrir þig.",
    "Sharing is only allowed with group members." : "Deiling er aðeins leyfð með meðlimum hópsins.",
    "Sharing is only allowed within your own groups." : "Deiling er aðeins leyfð innan þinna eigin hópa.",
    "Group sharing is not allowed." : "Hópdeiling er ekki leyfð.",
    "Public link sharing is not allowed." : "Deiling opinberra tengla er ekki leyfð.",
    "Sharing to remote users is not allowed." : "Deiling til fjartengdra notenda er ekki leyfð.",
    "Sharing to remote groups is not allowed." : "Deiling til fjartengdra hópa er ekki leyfð.",
    ...
    "Share with others" : "Deila með öðrum",
    "Can view" : "Getur skoðað",
    "Expiration date" : "Gildir til",
    "Your administrator has enforced a %d days expiration policy." : "Kerfisstjórinn þinn hefur krafist gildistíma að hámarki í %d daga.",
    "Label" : "Skýring",
    "Note to recipients" : "Minnispunktur til viðtakenda",
    "Password" : "Lykilorð",
    ...
    "User" : "Notandi",
    "Windows Command Script" : "Windows skeljarskrifta",
    "Electronic book document" : "Rafbókarskjal",
    "TrueType Font Collection" : "TrueType letursafn",
    "Web Open Font Format" : "Web Open Font Format vefletur",
    "GPX geographic data" : "GPX-hnattstaðsetningargögn",
    "Gzip archive" : "Gzip-safnskrá",
    "Adobe Illustrator document" : "Adobe Illustrator skjal",
    "Java source code" : "Java-frumkóði",
    "JavaScript source code" : "JavaScript-frumkóði",
    "JSON document" : "JSON-skjal",
    "Microsoft Access database" : "Microsoft Access gagnagrunnsskrá",
    "Microsoft OneNote document" : "Microsoft OneNote-skjal",
    "Microsoft Word document" : "Microsoft Word-skjal",
    "Unknown" : "Óþekkt",
    "PDF document" : "PDF-skjal",
    "PostScript document" : "PostScript-skjal",
    "RSS summary" : "RSS-samantekt",
    "Android package" : "Android-pakki",
    "KML geographic data" : "KML-hnattstaðsetningargögn",
    "KML geographic compressed data" : "KML þjöppuð hnattstaðsetningargögn",
    "Lotus Word Pro document" : "Lotus Word Pro skjal",
    "Excel spreadsheet" : "Excel-töflureikniskjal",
    "Excel add-in" : "Excel-viðbót",
    "Excel 2007 binary spreadsheet" : "Excel tvíundarkerfis-töflureikniskjal",
    "Excel spreadsheet template" : "Excel-töflureiknisniðmát",
    "Outlook Message" : "Outlook-skilaboð",
    "PowerPoint presentation" : "PowerPoint-kynning",
    "PowerPoint add-in" : "PowerPoint-viðbót",
    "PowerPoint presentation template" : "PowerPoint sniðmát fyrir glærukynningu",
    "Word document" : "Word-skjal",
    "ODF formula" : "ODF-formúla",
    "ODG drawing" : "ODG-teikning",
    "ODG drawing (Flat XML)" : "ODG-teikning (flatt XML)",
    "ODG template" : "ODG-sniðmát",
    "ODP presentation" : "ODP-kynning",
    "ODP presentation (Flat XML)" : "ODP-glærukynning (flatt XML)",
    "ODP template" : "ODP-sniðmát",
    "ODS spreadsheet" : "ODS-töflureikniskjal",
    "ODS spreadsheet (Flat XML)" : "ODS-töflureikniskjal (flatt XML)",
    "ODS template" : "ODS-sniðmát",
    "ODT document" : "ODT-skjal",
    "ODT document (Flat XML)" : "ODT-skjal (flatt XML)",
    "ODT template" : "ODT-sniðmát",
    "PowerPoint 2007 presentation" : "PowerPoint 2007 kynning",
    "PowerPoint 2007 show" : "PowerPoint 2007 glærusýning",
    "PowerPoint 2007 presentation template" : "PowerPoint 2007 sniðmát fyrir glærukynningu",
    "Excel 2007 spreadsheet" : "Excel 2007 töflureikniskjal",
    "Excel 2007 spreadsheet template" : "Excel 2007 töflureiknisniðmát",
    "Word 2007 document" : "Word 2007 skjal",
    "Word 2007 document template" : "Word-sniðmát fyrir textaskjal",
    "Microsoft Visio document" : "Microsoft Visio-skjal",
    "WordPerfect document" : "WordPerfect-skjal",
    "7-zip archive" : "7-zip safnskrá",
    "Blender scene" : "Blender-sviðsmynd",
    "Bzip2 archive" : "Bzip2-safnskrá",
    "Debian package" : "Debian-pakki",
    "FictionBook document" : "FictionBook-skjal",
    "Unknown font" : "Óþekkt letur",
    "Krita document" : "Krita-skjal",
    "Mobipocket e-book" : "Mobipocket-rafbók",
    "Windows Installer package" : "Windows-uppsetningarpakki",
    "Perl script" : "Perl-skrifta",
    "PHP script" : "PHP-skrifta",
    "Tar archive" : "Tar-safnskrá",
    "XML document" : "XML-skjal",
    "YAML document" : "YAML-skjal",
    "Zip archive" : "Zip-safnskrá",
    "Zstandard archive" : "Zstandard-safnskrá",
    "AAC audio" : "AAC-hljóðskrá",
    "FLAC audio" : "FLAC-hljóðskrá",
    "MPEG-4 audio" : "MPEG-4 hljóðskrá",
    "MP3 audio" : "MP3-hljóðskrá",
    "Ogg audio" : "Ogg-hljóðskrá",
    "RIFF/WAVe standard Audio" : "Stöðluð RIFF/WAVe hljóðskrá",
    "WebM audio" : "WebM-hljóðskrá",
    "MP3 ShoutCast playlist" : "MP3 ShoutCast spilunarlisti",
    "Windows BMP image" : "Windows BMP-mynd",
    "Better Portable Graphics image" : "Better Portable Graphics mynd",
    "EMF image" : "EMF-mynd",
    "GIF image" : "GIF-mynd",
    "HEIC image" : "HEIC-mynd",
    "HEIF image" : "HEIF-mynd",
    "JPEG-2000 JP2 image" : "JPEG-2000 JP2 mynd",
    "JPEG image" : "JPEG-mynd",
    "PNG image" : "PNG-mynd",
    "SVG image" : "SVG-mynd",
    "Truevision Targa image" : "Truevision Targa mynd",
    "TIFF image" : "TIFF-mynd",
    "WebP image" : "WebP-mynd",
    "Digital raw image" : "Stafræn RAW-mynd",
    "Windows Icon" : "Windows-táknmynd",
    "Email message" : "Tölvupóstskilaboð",
    "VCS/ICS calendar" : "VCS/ICS-dagatal",
    "CSS stylesheet" : "CSS-stílsnið",
    "CSV document" : "CSV-skjal",
    "TSV document" : "TSV-skjal",
    "HTML document" : "HTML-skjal",
    "Markdown document" : "Markdown-skjal",
    "Org-mode file" : "Org-mode skrá",
    "Plain text document" : "Hreint textaskjal",
    "Rich Text document" : "Ríkulega sniðið RTF-textaskjal",
    "Electronic business card" : "Rafrænt nafnspjald",
    "C++ source code" : "C++ frumkóði",
    "LDIF address book" : "LDIF-nafnaskrá",
    "NFO document" : "NFO-skjal",
    "PHP source" : "PHP-grunntilfang",
    "Python script" : "Python-skrifta",
    "ReStructuredText document" : "ReStructuredText-skjal",
    "3GPP multimedia file" : "3GPP-margmiðlunarskrá",
    "MPEG video" : "MPEG-myndskeið",
    "DV video" : "DV-myndskeið",
    "MPEG-2 transport stream" : "MPEG-2 transport streymi",
    "MPEG-4 video" : "MPEG-4 myndskeið",
    "Ogg video" : "Ogg-myndskeið",
    "QuickTime video" : "QuickTime myndskeið",
    "WebM video" : "WebM-myndskeið",
    "Flash video" : "Flash-myndskeið",
    "Matroska video" : "Matroska-myndskeið",
    "Windows Media video" : "Windows Media myndskeið",
    "AVI video" : "AVI-myndskeið",
    "Show QR code for mobile app login" : "Birta QR-kóða fyrir innskráningu farsímaforrita",
    "Done" : "Lokið",
    ...
    "Settings" : "Stillingar",
    "Profile" : "Snið",
    "Open apps menu, currently in {app}" : "Opna forritavalmynd, er núna í {app}",
    ...
    "Direct link copied" : "Beinn tengill afritaður",
    "Please copy the link manually:" : "Afritaðu tengilinn handvirkt:",
    "Less from connected services" : "Minna frá tengdum þjónustum",
    "More from connected services" : "Meira frá tengdum þjónustum",
    "Connected services settings" : "Stillingar á tengdum þjónustum",
    ...
    "Remove filter: {name}" : "Fjarlægja síu: {name}",
    "Apps, files, messages, and more" : "Forrit, skrár, skilaboð og fleira",
    "Filters" : "Síur",
    "Clear search" : "Hreinsa leit",
    "Close search" : "Loka leit",
    "Start typing to search" : "Skrifaðu hér til að leita",
    "_Minimum search length is %n character_::_Minimum search length is %n characters_" : ["Lágmarkslengd leitarstrengs er %n stafur","Lágmarkslengd leitarstrengs er %n stafir"],
    "No matching results" : "Engar samsvarandi niðurstöður",
    "Searching …" : "Leita …",
    "_Showing %n result from {name}_::_Showing %n results from {name}_" : ["Birti %n niðurstöðu frá {name}","Birti %n niðurstöður frá {name}"],
    "_%n result_::_%n results_" : ["%n niðurstaða","%n niðurstöður"],
    "Today" : "Í dag",
    "Last 7 days" : "Síðustu 7 daga",
    "Last 30 days" : "Síðustu 30 daga",
    "This year" : "Á þessu ári",
    "Last year" : "Á síðasta ári",
    "Between {startDate} and {endDate}" : "Milli {startDate} og {endDate}",
    "Type" : "Tegund",
    "Date" : "Dagsetning",
    "Search people" : "Leita að fólki",
    "People" : "Fólk",
    "Results" : "Niðurstöður",
    "Back to all results" : "Til baka í allar niðurstöður",
    "Back" : "Til baka",
    "Partial matches" : "Samsvörun að hluta",
    "More from {name}" : "Meira frá {name}",
    ...
    "Too many failed login attempts from your location. Try again in 30 seconds." : "Of margar tilraunir til innskráningar frá staðsetningunni þinni. Prófaðu aftur eftir 30 sekúndur.",
    ...
    "It appears your session token has expired, please refresh the page and try again." : "Það lítur út fyrir að setuteiknið þitt sé útrunnð, endurlestu síðuna og prófaðu aftur.",
    ...
    "Password confirmation was aborted" : "Hætt var við staðfestingu á lykilorði",
    ...
    "App already installed" : "Forrit er nú þegar uppsett",
    ...
    "Loading your contacts …" : "Hleð inn tengiliðum …",
    "Looking for {term} …" : "Leita að {term} …",
    "Search contacts" : "Leita í tengiliðum",
    "Filter by team" : "Sía eftir teymum",
    "All teams" : "Öll teymi",
    "Search contacts in team {team}" : "Leita að tengiliðum í teyminu {team}",
    "Search contacts …" : "Leita í tengiliðum …",
    ...
    "Please log in before granting \"{client}\" access to your {instanceName} account." : "Skráði þig inn áður en þú leyfir \"{client}\" aðgang að {instanceName} notandaaðgangnum þínum.",
    ...
    "Log in using password" : "Skrá inn með lykilorði",
    ...
    "Currently logged in as {userDisplayName} ({userId})." : "Í augnablikinu er skráð inn sem {userDisplayName} ({userId}).",
    "You are about to grant \"{client}\" access to your {instanceName} account." : "Þú ert að fara að leyfa \"{client}\" aðgang að {instanceName} notandaaðgangnum þínum.",
    "More actions" : "Fleiri aðgerðir",
    "User menu" : "Valmynd notandans",
    "Your guest name: {user}" : "Gestanafnið þitt: {user}",
    "You are currently not identified." : "Þú ert ekki auðkennd/ur.",
    "Set public name" : "Setja opinbert nafn",
    "Change public name" : "Breyta opinberu nafni",
    ...
    "Submit" : "Senda inn",
    "If the email address was correct then you will receive an email with the password." : "Ef tölvupóstfangið var rétt munt þú fá sendan tölvupóst með lykilorðinu.",
    ...
    "Forgot password" : "Gleymdi lykilorði",
    ...
    "The update completed with warnings. Please check the details for more information." : "Uppfærslunni lauk án nokkurra aðvarana. Endilega kíktu á ítarlegri upplýsingar ef þú vilt vita meira.",
    "The update completed successfully." : "Uppfærslan tókst.",
    "Preparing update…" : "Undirbý uppfærslu…",
    "You will be redirected to {productName} in {count} seconds." : "Beini þér til {productName} eftir {count} sekúndur.",
    ...
    "{productName} will be updated to version {version}" : "{productName} verður uppfært í útgáfu {version}.",
    "The theme {oldTheme} has been disabled." : "Þema {oldTheme} hefur verið gert óvirkt.",
    "These incompatible apps will be disabled:" : "Eftirfarandi forrit eru ósamhæfð og verið gerð óvirk: %s",
    "Incompatible apps" : "Ósamhæfð forrit",
    "These apps will be updated:" : "Eftirfarandi öpp verða uppfærð:",
    "Apps to update" : "Forrit sem á að uppfæra",
    "{app} from {oldVersion} to {version}" : "{app} úr {oldVersion} í {version}",
    ...
    "Update details" : "Nánar um uppfærslu",
    ...
    "localhost" : "localhost",
    "Encrypted database connection" : "Dulrituð tenging gagnagrunns",
    "Supported modes: disable, allow, prefer, require, verify-ca, verify-full." : "Studdir hamir: disable, allow, prefer, require, verify-ca, verify-full.",
    "Encryption mode" : "Dulritunarhamur",
    "Has to be readable by the web server." : "Verður að vera lesanlegt af vefþjóninum.",
    "CA certificate path" : "Slóð á CA-skilríki",
    "Client certificate path" : "Slóð á skilríki forrits",
    "Client certificate key path" : "Slóð á skilríkilykil forrits",
    "Certificate revocation list path" : "Slóð á afturköllunarlista skilríkja",
    "Do not verify that the server certificate matches the database host" : "Ekki sannprófa að skilríki netþjóns samsvari hýsivél gagnagrunnsins",
    "Installing …" : "Set upp …",
    "Install" : "Setja upp",
    ...
    "Search connected services" : "Leita að tengdum þjónustum",
    "Logging in …" : "Skrái inn …",
    ...
    "Remove filter: {text}" : "Fjarlægja síu: {text}",
