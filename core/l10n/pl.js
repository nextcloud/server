OC.L10N.register(
    ...
    "No valid filters provided" : "Nie podano prawidłowych filtrów",
    ...
    "Log out" : "Wyloguj się",
    "Sharing is not allowed." : "Udostępnianie nie jest dozwolone.",
    "Sharing is not allowed for you." : "Udostępnianie nie jest dla Ciebie dozwolone.",
    "Sharing is only allowed with group members." : "Udostępnianie jest dozwolone wyłącznie członkom grup.",
    "Sharing is only allowed within your own groups." : "Udostępnianie jest dozwolone wyłącznie w obrębie Twoich własnych grup.",
    "Group sharing is not allowed." : "Udostępnianie grupom nie jest dozwolone.",
    "Public link sharing is not allowed." : "Udostępnianie za pomocą linku publicznego nie jest dozwolone.",
    "Sharing to remote users is not allowed." : "Udostępnianie użytkownikom zdalnym nie jest dozwolone.",
    "Sharing to remote groups is not allowed." : "Udostępnianie zdalnym grupom nie jest dozwolone.",
    ...
    "Share with others" : "Udostępnij innym",
    "Can view" : "Może wyświetlać",
    "Expiration date" : "Data wygaśnięcia",
    "Your administrator has enforced a %d days expiration policy." : "Administrator wymusił zasadę wygasania po %d dniach.",
    "Label" : "Etykieta",
    "Note to recipients" : "Notatka dla odbiorców",
    "Password" : "Hasło",
    ...
    "AVI video" : "Wideo AVI",
    "Show QR code for mobile app login" : "Pokaż kod QR do logowania w aplikacji mobilnej",
    "Done" : "Gotowe",
    ...
    "Direct link copied" : "Bezpośredni link skopiowany",
    "Please copy the link manually:" : "Skopiuj odnośnik ręcznie:",
    "Less from connected services" : "Mniej z połączonych usług",
    "More from connected services" : "Więcej z połączonych usług",
    "Connected services settings" : "Ustawienia połączonych usług",
    ...
    "Remove filter: {name}" : "Usuń filtr: {name}",
    "Apps, files, messages, and more" : "Aplikacje, pliki, wiadomości i nie tylko",
    "Filters" : "Filtry",
    "Clear search" : "Wyczyść wyszukiwanie",
    "Close search" : "Zamknij wyszukiwanie",
    "Start typing to search" : "Zacznij pisać, aby wyszukać",
    "_Minimum search length is %n character_::_Minimum search length is %n characters_" : ["Minimalna długość wyszukiwanego tekstu wynosi %n znak","Minimalna długość wyszukiwanego tekstu wynosi %n znaków","Minimalna długość wyszukiwanego tekstu wynosi %n znaków","Minimalna długość wyszukiwanego tekstu wynosi %n znaków"],
    "No matching results" : "Brak pasujących wyników",
    "Searching …" : "Wyszukiwanie …",
    "_Showing %n result from {name}_::_Showing %n results from {name}_" : ["Wyświetlanie %n wynik z {name}","Wyświetlanie %n wyniki z {name}","Wyświetlanie %n wyników z {name}","Wyświetlanie %n wyników z {name}"],
    "_%n result_::_%n results_" : ["%n wynik","%n wyników","%n wyników","%n wyniki"],
    "Today" : "Dzisiaj",
    "Last 7 days" : "Ostatnie 7 dni",
    "Last 30 days" : "Ostatnie 30 dni",
    "This year" : "W tym roku",
    "Last year" : "W zeszłym roku",
    "Between {startDate} and {endDate}" : "Pomiędzy {startDate} a {endDate}",
    "Type" : "Rodzaj",
    "Date" : "Data",
    ...
    "Results" : "Wyniki",
    "Back" : "Wstecz",
    "Partial matches" : "Częściowe dopasowania",
    ...
    "Too many failed login attempts from your location. Try again in 30 seconds." : "Zbyt wiele nieudanych prób logowania z Twojej lokalizacji. Spróbuj ponownie za 30 sekund.",
    ...
    "Password confirmation was aborted" : "Potwierdzenie hasła zostało anulowane",
    ...
    "App already installed" : "Aplikacja jest już zainstalowana",
    ...
    "Appear offline" : "Wyglądaj jako offline",
    ...
    "Your guest name: {user}" : "Twoja nazwa gościa: {user}",
    ...
    "The update completed with warnings. Please check the details for more information." : "Aktualizacja zakończona z ostrzeżeniami. Sprawdź szczegóły, aby uzyskać więcej informacji.",
    "The update completed successfully." : "Aktualizacja zakończona pomyślnie.",
    "Preparing update…" : "Przygotowywanie aktualizacji…",
    "You will be redirected to {productName} in {count} seconds." : "Za {count} sekund nastąpi przekierowanie do {productName}",
    ...
    "{productName} will be updated to version {version}" : "{productName} zostanie zaktualizowany do wersji {version}",
    "The theme {oldTheme} has been disabled." : "Motyw {oldTheme} został wyłączony.",
    "These incompatible apps will be disabled:" : "Niekompatybilne aplikacje zostaną wyłączone:",
    "Incompatible apps" : "Niekompatybilne aplikacje",
    "These apps will be updated:" : "Następujące aplikacje zostaną zaktualizowane:",
    "Apps to update" : "Aplikacje do aktualizacji",
    "{app} from {oldVersion} to {version}" : "{app} z {oldVersion} do {version}",
    ...
    "Remove filter: {text}" : "Usuń filtr: {text}",
