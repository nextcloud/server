OC.L10N.register(
    ...
    "The PHP OPcache module is not properly configured. See the {linkstart}documentation ↗{linkend} for more information." : "O módulo PHP OPcache non está configurado correctamente. Consulta a {linkstart}documentación ↗{linkend} para obter máis información.",
    ...
    "It seems like you are running a 32-bit PHP version. Nextcloud 26 and higher require 64-bit. Please upgrade your OS and PHP to 64-bit! For further details read {linkstart}the documentation page ↗{linkend} about this." : "Parece que estás a executar unha versión de PHP de 32 bits. Nextcloud 26 e superior requiren 64 bits. Actualiza o teu sistema operativo e PHP a 64 bits. Para obter máis información, le {linkstart}a páxina de documentación ↗{linkend} sobre isto.",
    ...
    "The temporary directory of this instance points to an either non-existing or non-writable directory." : "O directorio temporal desta instancia apunta a un directorio inexistente ou non escribible.",
    ...
    "You have not added any info yet" : "Aínda non engadiches ningunha información",
    "{user} has not added any info yet" : "{user} aínda non engadiu ningunha información",
    "Error opening the user status modal, try hard refreshing the page" : "Produciuse un erro ao abrir o modal de estado do usuario, intenta forzar a actualización a páxina",
    ...
    "Toggle password visibility" : "Alterna a visibilidade do contrasinal",
    ...
    "You haven't added any info yet" : "Aínda non engadiches ningunha información",
    "{user} hasn't added any info yet" : "{user} aínda non engadiu ningunha información",
