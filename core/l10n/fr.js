OC.L10N.register(
    ...
    "Share with others" : "Partagés avec d’autres",
    "Can view" : "Peut voir",
    ...
    "AVI video" : "Vidéo AVI",
    "Show QR code for mobile app login" : "Afficher le code QR pour se connecter à l’application mobile",
    "Done" : "Terminé",
    ...
    "Searching …" : "Recherche…",
    "_Showing %n result from {name}_::_Showing %n results from {name}_" : ["Affichage de %n résultat provenant de {name}","Affichage de %n résultats provenant de {name}","Affichage de %n résultat(s) provenant de {name}"],
    "_%n result_::_%n results_" : ["%n résultat","%n résultats","%n résultat(s)"],
    "Today" : "Aujourd’hui",
    ...
    "Incompatible apps" : "Applis incompatibles",
    "These apps will be updated:" : "Les applications suivantes seront mises à jour :",
    "Apps to update" : "Applis à mettre à jour",
