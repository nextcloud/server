OC.L10N.register(
    ...
    "Submit" : "Envoyer",
    "If the email address was correct then you will receive an email with the password." : "Si l'adresse email est correcte, vous recevrez un courriel contenant le mot de passe.",
