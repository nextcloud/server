OC.L10N.register(
    ...
    "You are about to grant \"%s\" access to your %s account." : "Vous êtes sur le point d'accorder à \"%s\" l'accès à votre compte \"%s\".",
    "Your PHP does not have freetype support. This will result in broken profile pictures and settings interface." : "Votre PHP ne prend pas en charge freetype. Cela va casser les images de profil et  l'interface des paramètres."
},
