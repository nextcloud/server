OC.L10N.register(
    ...
    "new" : "جديد",
    "_download %n file_::_download %n files_" : ["تنزيل ملف واحد","تنزيل ملفين","تنزيل %n ملفات","تنزيل %n ملفات","تنزيل %n ملفات"],
    ...
    "read-only" : "قراءة فقط",
    "_{count} file conflict_::_{count} file conflicts_" : ["{count} ملف متعارض","ملفان متعارضان","{count} ملفات متعارضة"," {count} ملفا متعارضا","{count} ملفات متعارضه"],
