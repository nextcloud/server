OC.L10N.register(
    ...
    "_Please enter {minSearchLength} character or more to search_::_Please enter {minSearchLength} characters  or more to search_" : ["يُرجى إدخال {minSearchLength} حرف أو أكثر للبحث","يُرجى إدخال {minSearchLength} حرف أو أكثر للبحث","يُرجى إدخال {minSearchLength} حروف أو أكثر للبحث","يُرجى إدخال {minSearchLength} حروف أو أكثر للبحث","يُرجى إدخال {minSearchLength} حرف أو أكثر للبحث","يُرجى إدخال {minSearchLength} حرف أو أكثر للبحث"],
