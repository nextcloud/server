OC.L10N.register(
    ...
    "Node is locked" : "O nó está trancado",
    ...
    "Sharing is only allowed within your own groups." : "É só permitido compartilhar nos seus próprios grupos.",
    "Group sharing is not allowed." : "Não é permitido compartilhar com grupos.",
    "Public link sharing is not allowed." : "Não é permitido compartilhar por link público.",
    "Sharing to remote users is not allowed." : "Não é permitido compartilhar com usuários remotos.",
    "Sharing to remote groups is not allowed." : "Não é permitido compartilhar com grupos remotos.",
    ...
    "Your administrator has enforced a %d days expiration policy." : "Seu administrador aplicou uma política de validade de %d dias.",
    "Label" : "Rótulo",
    "Note to recipients" : "Nota aos destinatários",
    "Password" : "Senha",
    ...
    "AVI video" : "Vídeo AVI",
    "Show QR code for mobile app login" : "Mostrar código QR para login no aplicativo móvel",
    "Done" : "Concluído",
    ...
    "Less from connected services" : "Menos dos serviços conectados",
    "More from connected services" : "Mais dos serviços conectados",
    "Connected services settings" : "Configurações dos serviços conectados",
    ...
    "Remove filter: {name}" : "Remover filtro: {name}",
    ...
    "_Showing %n result from {name}_::_Showing %n results from {name}_" : ["Exibindo %n resultado de {name}","Exibindo %n de resultados de {name}","Exibindo %n resultados de {name}"],
    ...
    "People" : "Pessoas",
    "Results" : "Resultados",
    "Back to all results" : "Voltar a todos os resultados",
    "Back" : "Voltar",
    "Partial matches" : "Correspondências parciais",
    "More from {name}" : "Mais de {name}",
    ...
    "Password confirmation was aborted" : "A confirmação da senha foi cancelada",
    ...
    "App already installed" : "Aplicativo já instalado",
    ...
    "Looking for {term} …" : "Pesquisando {term} …",
    ...
    "Incompatible apps" : "Aplicativos incompatíveis",
    ...
    "Please specify the port number along with the host name (e.g., localhost:5432)." : "Por favor, especifique o nome do hospedeiro e a porta (p. ex., localhost:5432).",
    "Database host" : "Hospedeiro do banco de dados",
    "localhost" : "localhost",
    "Encrypted database connection" : "Conexão ao banco de dados criptografada ",
    "Supported modes: disable, allow, prefer, require, verify-ca, verify-full." : "Modos compatíveis: disable (desativar), allow (permitir), prefer (preferir), require (requerer), verify-ca (verificar CA), verify-full (verificar completamente).",
    "Encryption mode" : "Modo de criptografia",
    "Has to be readable by the web server." : "Deve ser legível pelo servidor web.",
    "CA certificate path" : "Caminho do certificado da CA",
    "Client certificate path" : "Caminho do certificado do cliente",
    "Client certificate key path" : "Caminho da chave do certificado do cliente",
    "Certificate revocation list path" : "Caminho da lista de revogação de certificados",
    "Do not verify that the server certificate matches the database host" : "Não verifique se o certificado do servidor corresponde ao host do banco de dados",
    ...
    "Notifications, contacts and settings" : "Notificações, contatos e configurações",
    "Previous" : "Anterior",
    ...
    "Remove filter: {text}" : "Remover filtro: {text}",
