OC.L10N.register(
    ...
    "Sharing is not allowed." : "A megosztás nincs engedélyezve.",
    "Sharing is not allowed for you." : "A megosztás nincs engedélyezve Önnek.",
    "Sharing is only allowed with group members." : "A megosztás csak csoporttagokkal van engedélyezve.",
    "Sharing is only allowed within your own groups." : "A megosztás csak a saját csoportjaiban van engedélyezve.",
    "Group sharing is not allowed." : "A csoportos megosztás nincs engedélyezve.",
    "Public link sharing is not allowed." : "A nyilvános hivatkozásos megosztás nincs engedélyezve.",
    "Sharing to remote users is not allowed." : "A távoli felhasználók számára való megosztás nincs engedélyezve.",
    "Sharing to remote groups is not allowed." : "A távoli csoportok számára való megosztás nincs engedélyezve.",
    ...
    "Share with others" : "Megosztás másokkal",
    "Can view" : "Megtekintheti",
    "Expiration date" : "Lejárati idő",
    "Your administrator has enforced a %d days expiration policy." : "A rendszergazda %d napos lejárati házirendet állított be.",
    "Label" : "Címke",
    "Note to recipients" : "Megjegyzés a címzetteknek",
    "Password" : "Jelszó",
    "Your administrator has enforced a password protection." : "A rendszergazda jelszavas védelmet állított be.",
    "Email" : "E-mail",
    "Group" : "Csoport",
    "Team" : "Csapat",
    ...
    "AVI video" : "AVI-videó",
    "Show QR code for mobile app login" : "QR-kód megjelenítése a mobilalkalmazásos bejelentkezéshez",
    "Done" : "Kész",
    ...
    "Less from connected services" : "Kevesebb a kapcsolódó szolgáltatásokból",
    "More from connected services" : "Több a kapcsolódó szolgáltatásokból",
    "Connected services settings" : "Kapcsolódó szolgáltatások beállításai",
    ...
    "Remove filter: {name}" : "Szűrő eltávolítása: {name}",
    "Apps, files, messages, and more" : "Alkalmazások, fájlok, üzenetek és egyebek",
    "Filters" : "Szűrők",
    "Clear search" : "Keresés törlése",
    "Close search" : "Keresés bezárása",
    "Start typing to search" : "Kezdjen el gépelni a kereséshez",
    "_Minimum search length is %n character_::_Minimum search length is %n characters_" : ["A keresés legkisebb hossza %d karakter","A keresés legkisebb hossza %d karakter"],
    "No matching results" : "Nincs találat",
    "Searching …" : "Keresés…",
    "_Showing %n result from {name}_::_Showing %n results from {name}_" : ["%n találat megjelenítése innen: {name}","%n találat megjelenítése innen: {name}"],
    "_%n result_::_%n results_" : ["%n találat","%n találat"],
    "Today" : "Ma",
    ...
    "People" : "Emberek",
    "Results" : "Eredmények",
    "Back to all results" : "Vissza az összes találathoz",
    "Back" : "Vissza",
    "Partial matches" : "Részleges egyezések",
    "More from {name}" : "Több innen: {name}",
    ...
    "Too many failed login attempts from your location. Try again in 30 seconds." : "Túl sok sikertelen bejelentkezési kísérlet az Ön tartózkodási helyéről. Próbálja újra 30 másodperc múlva.",
    ...
    "Password confirmation was aborted" : "A jelszó megerősítése meg lett szakítva",
    ...
    "App already installed" : "Az alkalmazás már telepítve van",
    ...
    "Submit" : "Beküldés",
    "If the email address was correct then you will receive an email with the password." : "Ha az e-mail-cím helyes volt, akkor kapni fog egy levelet a jelszóval.",
    ...
    "The update completed with warnings. Please check the details for more information." : "A frissítés figyelmeztetésekkel fejeződött be. További információkért ellenőrizze a részleteket.",
    "The update completed successfully." : "A frissítés sikeresen befejeződött.",
    "Preparing update…" : "Frissítés előkészítése…",
    "You will be redirected to {productName} in {count} seconds." : "{count} másodpercen belül át lesz irányítva ide: {productName}.",
    ...
    "{productName} will be updated to version {version}" : "A(z) {productName} frissítve lesz erre a verzióra: {version}",
    "The theme {oldTheme} has been disabled." : "A(z) {oldTheme} téma le lett tiltva.",
    "These incompatible apps will be disabled:" : "A következő nem kompatibilis alkalmazások le lesznek tiltva:",
    "Incompatible apps" : "Nem kompatibilis alkalmazások",
    "These apps will be updated:" : "A következő alkalmazások lesznek frissítve:",
    "Apps to update" : "Frissítendő alkalmazások",
    "{app} from {oldVersion} to {version}" : "{app} erről: {oldVersion}, erre: {version}",
    ...
    "Update details" : "Frissítés részletei",
    ...
    "localhost" : "localhost",
    "Encrypted database connection" : "Titkosított adatbázis-kapcsolat",
    "Supported modes: disable, allow, prefer, require, verify-ca, verify-full." : "Támogatott módok: disable, allow, prefer, require, verify-ca, verify-full.",
    "Encryption mode" : "Titkosítási mód",
    "Has to be readable by the web server." : "A webkiszolgáltó által olvashatónak kell lennie.",
    "CA certificate path" : "CA tanúsítványok elérési útja",
    "Client certificate path" : "Klienstanúsítványok elérési útja",
    "Client certificate key path" : "Kliens-tanúsítványkulcsok elérési útja",
    "Certificate revocation list path" : "Tanúsítvány-visszavonási listák elérési útja",
    "Do not verify that the server certificate matches the database host" : "Ne ellenőrizze, hogy a kiszolgáló tanúsítványa megfelel-e az adatbázis-kiszolgálónak",
    ...
    "Remove filter: {text}" : "Szűrő eltávolítása: {text}",
