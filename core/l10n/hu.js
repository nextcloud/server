OC.L10N.register(
    ...
    "<strong>Create an admin account</strong>" : "<strong>Rendszergazda fiók létrehozása</strong>",
    "New admin account name" : "Új rendszergazda fiók név",
    "New admin password" : "Új rendszergazda fiók jelszó",
