OC.L10N.register(
    ...
    "Updated \"%1$s\" to %2$s" : "Frissítve ezt: %1$s erre: %2$s",
    ...
    "The PHP OPcache module is not loaded. <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{docLink}\">For better performance it is recommended</a> to load it into your PHP installation." : "A PHP OCcache modul nincs betöltve. <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{docLink}\">A jobb teljesítményért</a> töltsd be a PHP telepítésbe.",
    ...
    "Use of the the built in php mailer is no longer supported. <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{docLink}\">Please update your email server settings ↗<a/>." : "A beépített PHP mailer használata már nem támogatott. <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{docLink}\">Kérlek frissítsd az levelező beállításaidat ↗<a/>.",
    ...
    "Some app directories are owned by a different user than the web server one. This may be the case if apps have been installed manually. Check the permissions of the following app directories:" : "Néhány alkalmazás könyvtár tulajdonosa különbözik a web serverétől. Ez akkor fordul elő ha az alkalmazás manuálisan lett telepítve. Ellenőrizd a jogosultságokat az alábbi alkalmazás könyvtárainak:",
