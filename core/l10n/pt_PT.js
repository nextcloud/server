OC.L10N.register(
    ...
    "Input text is too long" : "O texto de entrada é muito longo.",
    ...
    "Log out" : "Sair",
    "Sharing is not allowed." : "O compartilhamento não é permitido.",
    "Sharing is not allowed for you." : "O compartilhamento não é permitido para você.",
    "Sharing is only allowed with group members." : "É só permitido compartilhar com membros de grupo.",
    ...
    "AVI video" : "Vídeo AVI",
    "Show QR code for mobile app login" : "Mostrar código QR para o login no aplicativo móvel",
    "Done" : "Concluído",
    ...
    "_%n result_::_%n results_" : ["resultados","resultados","resultados"],
    "Today" : "Hoje",
    ...
    "Too many failed login attempts from your location. Try again in 30 seconds." : "Houve muitas tentativas de login malsucedidas a partir do seu local. Tente novamente em 30 segundos.",
    ...
    "Password confirmation was aborted" : "Falha na confirmação da senha",
    ...
    "App already installed" : "Aplicativos instalados:",
    ...
    "Your guest name: {user}" : "O seu nome de convidado: {user}",
    ...
    "Submit" : "Submeter",
    "If the email address was correct then you will receive an email with the password." : "Se o endereço de e-mail estiver correto, você receberá um e-mail com a senha.",
    ...
    "The update completed with warnings. Please check the details for more information." : "A atualização foi concluída com avisos. Verifique os detalhes para obter mais informações.",
    "The update completed successfully." : "A atualização foi concluída com sucesso.",
    "Preparing update…" : "Preparando a atualização…",
    "You will be redirected to {productName} in {count} seconds." : "Você será redirecionado para {productName} em {count} segundos.",
    ...
    "{productName} will be updated to version {version}" : "{productName} será atualizado para a versão {version}",
    "The theme {oldTheme} has been disabled." : "O tema {oldTheme} foi desativado.",
    "These incompatible apps will be disabled:" : "Estas aplicações incompatíveis irão ser desativadas:",
    "Incompatible apps" : "Aplicações incompatíveis",
    "These apps will be updated:" : "Estas aplicações irão ser atualizadas.",
    "Apps to update" : "Aplicativos para atualizar",
    "{app} from {oldVersion} to {version}" : "{app} de {oldVersion} para {version}",
