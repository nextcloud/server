OC.L10N.register(
    ...
    "Transactional file locking is disabled, this might lead to issues with race conditions. Enable \"filelocking.enabled\" in config.php to avoid these problems. See the <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{docLink}\">documentation ↗</a> for more information." : "Transaktionales Sperren ist deaktiviert, was zu Problemen mit Laufzeitbedingungen führen kann. Aktivieren Sie 'filelocking.enabled' in der config.php um diese Probleme zu vermeiden. Weitere Informationen finden Sie in unserer <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{docLink}\">Dokumentation ↗</a>.",
    ...
    "Thumbnail for {result}" : "Miniaturbild für {result}",
    "Log in" : "Anmelden",
    "Logging in …" : "Melde an…",
    ...
    "Search for {types} …" : "Suche nach  {types}…",
    ...
    "You are currently running PHP 5.6. The current major version of Nextcloud is the last that is supported on PHP 5.6. It is recommended to upgrade the PHP version to 7.0+ to be able to upgrade to Nextcloud 14." : "Sie verwenden  PHP 5.6. Die aktuelle Haup-Version von Nextcloud ist die letzte Version, die PHP 5.6 unterstützt. Es wird empfohlen die PHP-Version auf 7.0 oder höher zu aktualisieren, um in der Lage zu sein, auf Nextcloud 14 zu aktualisieren.",
    "Shared" : "Geteilt",
