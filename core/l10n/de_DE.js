OC.L10N.register(
    ...
    "user@your-nextcloud.org" : "benutzer@dein-nextcloud.org",
    ...
    "Please copy the link manually:" : "Bitte kopieren Sie den Link manuell:",
    ...
    "Accessing site insecurely via HTTP. You are strongly advised to set up your server to require HTTPS instead, as described in the {linkstart}security tips ↗{linkend}. Without it some important web functionality like \"copy to clipboard\" or \"service workers\" will not work!" : "Unsicherer Zugriff auf die Website über HTTP. Es wird dringend empfohlen, Ihren Server so einzurichten, dass stattdessen HTTPS erforderlich ist, wie in den {linkstart}Sicherheitstipps ↗{linkend} beschrieben. Ohne diese funktionieren einige wichtige Webfunktionen wie „In die Zwischenablage kopieren“ oder „Servicemitarbeiter“ nicht!",
