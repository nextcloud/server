OC.L10N.register(
    ...
    "Click the following button to reset your password. If you have not requested the password reset, then ignore this email." : "Zum Zurücksetzen des Passworts auf die folgende Schaltfläche klicken. Wenn Sie das Zurücksetzen des Passworts nicht angefordert haben, bitte diese E-Mail ignorieren.",
    "Click the following link to reset your password. If you have not requested the password reset, then ignore this email." : "Zum Zurücksetzen des Passworts auf den folgenden Link klicken. Wenn Sie das Zurücksetzen des Passworts nicht angefordert haben, bitte diese E-Mail ignorieren.",
    ...
    "Sharing is not allowed for you." : "Teilen ist für Sie nicht erlaubt.",
    "Sharing is only allowed with group members." : "Teilen ist nur mit Gruppenmitgliedern erlaubt.",
    "Sharing is only allowed within your own groups." : "Teilen ist nur innerhalb der eigenen Gruppen erlaubt.",
    "Group sharing is not allowed." : "Gruppenfreigabe ist nicht erlaubt",
    "Public link sharing is not allowed." : "Öffentliches Teilen via Link ist nicht erlaubt",
    "Sharing to remote users is not allowed." : "Teilen mit entfernten Benutzern ist nicht erlaubt.",
    "Sharing to remote groups is not allowed." : "Teilen mit entfernten Gruppen ist nicht erlaubt.",
    "Nextcloud Server" : "Nextcloud-Server",
    "Some of your link shares have been removed" : "Einige Ihrer Linkfreigaben wurden entfernt",
    "Due to a security bug we had to remove some of your link shares. Please see the link for more information." : "Aufgrund eines Sicherheitsfehlers mussten einige Linkfreigaben entfernt werden. Für weitere Informationen siehe Link.",
    ...
    "Searching …" : "Suche …",
    "_Showing %n result from {name}_::_Showing %n results from {name}_" : ["%n Ergebnis von {name} anzeigen","%n Ergebnisse von {name} anzeigen"],
    "_%n result_::_%n results_" : ["%n Ergebnis","%n Ergebnisse"],
    "Today" : "Heute",
    ...
    "People" : "Personen",
    "Results" : "Ergebnisse",
    "Back to all results" : "Zurück zu allen Ergebnissen",
    "Back" : "Zurück",
    "Partial matches" : "Teilübereinstimmungen",
    "More from {name}" : "Mehr von {name}",
    ...
    "Password confirmation was aborted" : "Passwortbestätigung wurde abgebrochen",
    ...
    "App already installed" : "App bereits installiert",
    ...
    "Submit" : "Übermitteln",
    "If the email address was correct then you will receive an email with the password." : "Wenn die E-Mail-Adresse richtig war, erhalten Sie eine E-Mail mit dem Passwort.",
    ...
    "Supported modes: disable, allow, prefer, require, verify-ca, verify-full." : "Unterstützte Modi: deaktivieren, zulassen, bevorzugen, erfordern, verify-ca, verify-full.",
    "Encryption mode" : "Verschlüsselungsmodus",
    "Has to be readable by the web server." : "Muss für den Webserver lesbar sein.",
    "CA certificate path" : "CA-Zertifikatspfad",
    "Client certificate path" : "Client-Zertifikatspfad",
    "Client certificate key path" : "Schlüsselpfad des Client-Zertifikats",
    "Certificate revocation list path" : "Pfad der Zertifikatswiderrufsliste",
    "Do not verify that the server certificate matches the database host" : "Nicht überprüfen, ob das Serverzertifikat mit dem Datenbankhost übereinstimmt",
    ...
    "Please contact your administrator. If you are an administrator, edit the \"trusted_domains\" setting in config/config.php like the example in config.sample.php." : "Bitte die Administration kontaktieren. Wenn Sie der Administration angehören, bitte die \"trusted_domains\"-Einstellung in config/config.php bearbeiten. Siehe das Beispiel in config/config.sample.php.",
    ...
    "Remove filter: {text}" : "Filter entfernen: {text}",
