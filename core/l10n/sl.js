OC.L10N.register(
    ...
    "Input text is too long" : "Vpisano besedilo je predolgo.",
    ...
    "Cannot generate more than 12 images" : "Ni mogoče ustvariti več kot 12 slik",
    "Cannot generate less than 1 image" : "Ni mogoče ustvariti manj kot 1 slike",
    ...
    "No valid filters provided" : "Ni veljavnih filtrov",
    ...
    "Excel 2007 binary spreadsheet" : "Preglednica Excel 2007",
    ...
    "Blender scene" : "Scena programa Blender",
    ...
    "MP3 audio" : "Zvok MP3",
    "Ogg audio" : "Zvok OGG",
    "RIFF/WAVe standard Audio" : "Zvočni zapis RIFF/WAVe",
    "WebM audio" : "Zvok WebM",
    "MP3 ShoutCast playlist" : "Seznam predvajanja MP3 ShoutCast",
    "Windows BMP image" : "Slika Windows BMP",
    "Better Portable Graphics image" : "Bolje prenosna slika",
    "EMF image" : "Slika EMF",
    "GIF image" : "Slika GIF",
    "HEIC image" : "Slika HEIC",
    "HEIF image" : "Slika HEIF",
    "JPEG-2000 JP2 image" : "Slika JPEG-2000 JP2",
    "JPEG image" : "Slika JPEG",
    "PNG image" : "Slika PNG",
    "SVG image" : "Risba SVG",
    "Truevision Targa image" : "Slika Truevision Targa",
    "TIFF image" : "Slika TIFF",
    "WebP image" : "Slika WebP",
    "Digital raw image" : "Surova digitalna slika",
    "Windows Icon" : "Ikona Windows",
    "Email message" : "Elektronsko sporočilo",
    ...
    "3GPP multimedia file" : "Predstavna datoteka 3GPP",
    "MPEG video" : "Video MPEG",
    "DV video" : "Video DV",
    "MPEG-2 transport stream" : "Prenosni pretok MPEG-2",
    ...
    "AVI video" : "Video AVI",
    "Done" : "Končano",
    "Scan QR code to log in" : "Prijava s kodo QR",
    "Use {productName} mobile client you want to connect to scan the code" : "Uporabite program {productName}na mobilni napravi, s katerim želite prebrati kodo za prijavo",
    ...
    "Minimum search length is {minSearchLength} characters" : "Najkrajši iskalni niz je{minSearchLength} znakov",
    ...
    "Between {startDate} and {endDate}" : "Med {startDate} in {endDate}",
    ...
    "Search connected services" : "Poišči povezane storitve",
    "Results" : "Zadetki",
    "Load more results" : "Naloži več zadetkov",
    "Search in" : "Poišči v",
    "Partial matches" : "Delno ujemanje",
    "Log in" : "Prijava",
    ...
    "Too many incorrect login attempts. Please try again in 30 seconds." : "Zaznanih je preveč poskusov prijave. Poskusite ponovno čez 30 sekund.",
    ...
    "Filter by team" : "Filtriraj po skupini",
    "All teams" : "Vse skupine",
    "Search contacts in team {team}" : "Poišči med stiki skupine {team}",
    "Search contacts …" : "Poišči med stiki ...",
    "Reset search" : "Ponastavi iskanje",
    "Could not load your contacts" : "Stikov ni mogoče naložiti",
    "No contacts found" : "Ni najdenih stikov",
    "Contacts list" : "Seznam stikov",
    ...
    "Please log in before granting \"{client}\" access to your {instanceName} account." : "Prijavite se preden odobrite dostop \"{client}\"  do računa {instanceName}.",
    ...
    "Log in using password" : "Prijava z geslom",
    ...
    "Currently logged in as {userDisplayName} ({userId})." : "Trenutno ste prijavljeni kot {userDisplayName} ({userId}).",
    "You are about to grant \"{client}\" access to your {instanceName} account." : "\"{client}\" boste odobrili dostop do računa {instanceName}.",
    ...
    "Set public name" : "Nastavi javno ime",
    "Change public name" : "Spremeni javno ime",
    ...
    "Database type" : "Vrsta podatkovne zbirke",
    ...
    "The update completed with warnings. Please check the details for more information." : "Posodobitev je zaključena z opozorili. Preverite dnevniške zapise za več podrobnosti.",
    "The update completed successfully." : "Posodobitev je bila uspešno zaključena.",
    "Preparing update…" : "Poteka priprava na posodobitev ...",
    "You will be redirected to {productName} in {count} seconds." : "Na program {productName} boste preusmerjeni v {count} sekundah.",
    ...
    "{productName} will be updated to version {version}" : "Aplikacija {productName} bo posodobljena na različico {version}",
    "The theme {oldTheme} has been disabled." : "Tema {oldTheme} je bila onemogočena.",
    "These incompatible apps will be disabled:" : "Zaradi neskladnosti bodo onemogočeni:",
    "Incompatible apps" : "Nezdružljivi programi",
    "These apps will be updated:" : "Posodobljeni bodo naslednji programi:",
    "Apps to update" : "Programi za posodobitev",
    "{app} from {oldVersion} to {version}" : "{app} z različice {oldVersion} na {version}",
    ...
    "Update details" : "Podrobnosti posodobitve",
    ...
    "You are not allowed to access this page." : "Dostop do teh strani zahteva posebna dovoljenja.",
