OC.L10N.register(
    ...
    "Input text is too long" : "Vnešeni tekst je predolg",
    ...
    "Cannot generate more than 12 images" : "Ne morem izdelati več kot 12 slik",
    ...
    "MP3 ShoutCast playlist" : "MP3 ShoutCast predvajalni seznam",
    ...
    "DV video" : "Video DV",
    "MPEG-2 transport stream" : "MPEG-2 prenosni tok",
    ...
    "Minimum search length is {minSearchLength} characters" : "Za iskanje morate vpisati vsaj{minSearchLength} znak(a/ov)",
    ...
    "Search connected services" : "Išči povezane storitve.",
    "Results" : "Zadetki",
    ...
    "Too many incorrect login attempts. Please try again in 30 seconds." : "Preveč poskusov prijave. Poskusite ponovno po 30 sekundah.",
    ...
    "Loading your contacts …" : "Nalagam vaše stike ...",
    "Looking for {term} …" : "Iščem {term} …",
    "Search contacts" : "Poišči med stiki",
    "Filter by team" : "Filtriraj po ekipi",
    "All teams" : "Vse ekipe",
    "Search contacts in team {team}" : "Išči stike v ekipi {team}",
    ...
    "Loading more results …" : "Nalagam več rezultatov ...",
    ...
    "The update completed with warnings. Please check the details for more information." : "Posodobitev zaključena z opozorili. Preverite podrobnosti za več informacij.",
    "The update completed successfully." : "Uspešno posodobljeno.",
    "Preparing update…" : "Pripravljam posodobitev...",
    "You will be redirected to {productName} in {count} seconds." : "Na aplikacijo {productName} boste preusmerjeni v {count} sekundah.",
    ...
    "Incompatible apps" : "Nezdružljive aplikacije",
    "These apps will be updated:" : "Posodobljeni bodo programi:",
    "Apps to update" : "Aplikacije za posodabljanje",
    ...
    "You are not allowed to access this page." : "Nimate dovoljenja za dostop do te strani.",
