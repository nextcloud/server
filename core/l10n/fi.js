OC.L10N.register(
    ...
    "Sharing is not allowed." : "Jakaminen ei ole sallittu.",
    "Sharing is not allowed for you." : "Jakaminen ei ole sallittu kohdallasi.",
    ...
    "Group sharing is not allowed." : "Ryhmäjakaminen ei ole sallittu.",
    "Public link sharing is not allowed." : "Julkisella linkillä jakaminen ei ole sallittu.",
    "Sharing to remote users is not allowed." : "Jakaminen etäkäyttäjille ei ole sallittu.",
    "Sharing to remote groups is not allowed." : "Jakaminen etäryhmille ei ole sallittu.",
    ...
    "Share with others" : "Jaa muiden kanssa",
    "Can view" : "Voi nähdä",
    "Expiration date" : "Vanhenemispäivä",
    "Your administrator has enforced a %d days expiration policy." : "Ylläpitäjä on pakottanut %d päivän vanhenemiskäytännön.",
    "Label" : "Nimike",
    "Note to recipients" : "Huomio vastaanottajille",
    "Password" : "Salasana",
    ...
    "AVI video" : "AVI-video",
    "Show QR code for mobile app login" : "Näytä QR-koodi mobiilisovelluskirjautumista varten",
    "Done" : "Valmis",
    "Scan QR code to log in" : "Skannaa QR-koodi kirjautuaksesi sisään",
    "Use {productName} mobile client you want to connect to scan the code" : "Käytä {productName}-mobiilisovellusta laitteella jonka haluat yhdistää, ja skannaa koodi",
    ...
    "Settings" : "Asetukset",
    "Profile" : "Profiili",
    "Open apps menu, currently in {app}" : "Avaa sovellusvalikko, tällä hetkellä sovelluksessa {app}",
    ...
    "Less from connected services" : "Vähemmän yhdistetyiltä laitteilta",
    "More from connected services" : "Enemmän yhdistetyiltä laitteilta",
    ...
    "Remove filter: {name}" : "Poista suodatin: {name}",
    "Apps, files, messages, and more" : "Sovellukset, tiedostot, viestit ja muuta",
    "Filters" : "Suodattimet",
    "Clear search" : "Tyhjennä haku",
    "Close search" : "Sulje haku",
    "Start typing to search" : "Aloita kirjoittaminen hakeaksesi",
    "_Minimum search length is %n character_::_Minimum search length is %n characters_" : ["Haussa pitää olla vähintään %n merkki","Haussa pitää olla vähintään %n merkkiä"],
    "No matching results" : "Ei tuloksia",
    "Searching …" : "Haetaan …",
    "_%n result_::_%n results_" : ["%n tulos","%n tulosta"],
    "Today" : "Tänään",
    ...
    "People" : "Ihmiset",
    "Results" : "Tulokset",
    "Back to all results" : "Takaisin kaikkiin tuloksiin",
    "Back" : "Takaisin",
    ...
    "Too many failed login attempts from your location. Try again in 30 seconds." : "Liian monta virheellistä kirjautumisyritystä sijainnistasi. Yritä uudelleen 30 sekunnin kuluttua.",
    ...
    "App already installed" : "Sovellus on jo asennettu",
    ...
    "Loading your contacts …" : "Ladataan yhteystietoja …",
    "Looking for {term} …" : "Etsitään {term} …",
    "Search contacts" : "Etsi yhteystietoja",
    "Filter by team" : "Suodata tiimin perusteella",
    "All teams" : "Kaikki tiimit",
    "Search contacts in team {team}" : "Etsi yhteystietoja tiimistä {team}",
    "Search contacts …" : "Etsi yhteystietoja …",
    ...
    "Currently logged in as {userDisplayName} ({userId})." : "Kirjautuneena käyttäjänä {userDisplayName} ({userId}).",
    ...
    "Submit" : "Lähetä",
    "If the email address was correct then you will receive an email with the password." : "Jos sähköpostiosoite oli oikein, saat sähköpostitse salasanan.",
    ...
    "Preparing update…" : "Valmistellaan päivitystä…",
    "You will be redirected to {productName} in {count} seconds." : "Ohjataan {productName}iin {count} sekunnin kuluttua.",
    ...
    "Autoconfig file detected" : "Autoconfig-tiedosto havaittu",
    ...
    "Encrypted database connection" : "Salattu tietokantayhteys",
    "Supported modes: disable, allow, prefer, require, verify-ca, verify-full." : "Tuetut tilat: disable, allow, prefer, require, verify-ca, verify-full.",
    "Encryption mode" : "Salaustila",
    "Has to be readable by the web server." : "Pitää olla web-palvelimen luettavissa.",
    "CA certificate path" : "CA-varmenteen polku",
    "Client certificate path" : "Asiakasvarmenteen polku",
    "Client certificate key path" : "Asiakasvarmenteen avaimen polku",
    "Certificate revocation list path" : "Varmenteen kumoamislistan polku",
    "Do not verify that the server certificate matches the database host" : "Älä vahvista palvelinvarmenteen vastaavan tietokannan palvelinta",
    ...
    "Remove filter: {text}" : "Poista suodatin: {text}",
