OC.L10N.register(
    ...
    "Your web server is not yet set up properly to allow file synchronization because the WebDAV interface seems to be broken." : "השרת שלך לא מוגדר עדיין לאפשר סנכרון קבצים כיוון שמנשק ה־WebDAV פגום ככל הנראה.",
    "Your web server is not set up properly to resolve \"{url}\". Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "השרת שלך לא מוגדר לפתור את הכתובת „{url}”. ניתן למצוא מידע נוסף ב<a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">תיעוד</a> שלנו.",
    "This server has no working Internet connection: Multiple endpoints could not be reached. This means that some of the features like mounting external storage, notifications about updates or installation of third-party apps will not work. Accessing files remotely and sending of notification emails might not work, either. We suggest to enable Internet connection for this server if you want to have all features." : "לשרת זה אין חיבור לאינטרנט: מגוון נקודות קצה אינן נגישות. משמעות הדבר היא שחלק מהתכונות כגון עיגון אחסון חיצוני, הודעות על עדכונים או התקנות של יישומי צד שלישי לא יעבדו. גישה לקבצים מרחוק ושליחת הודעות בדוא״ל לא יעבדו גם כן. אנו ממליצים להפעיל את החיבור של השרת הזה לאינטרנט כדי שכל התכונות תעבודנה.",
    "No memory cache has been configured. To enhance your performance please configure a memcache if available. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "לא הוגדר זיכרון מטמון. כדי לשפר את הביצועים שלך נא להגדיר memcache אם יש אחד כזה. ניתן למצוא מידע נוסף ב<a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">תיעוד</a> שלנו.",
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing Nextcloud from a trusted proxy. If you are not accessing Nextcloud from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to Nextcloud. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "תצורת הכותרות של המתווך ההפוך שגויה או שהגישה שלך אל Nextcloud מתבצעת ממתווך מהימן. אם לא ניגשת ל־Nextcloud ממתווך מהימן, מדובר בפרצת אבטחה שיכולה לאפשר לתוקף לזייף כתובת IP כפי שהיא מיוצגת מול ה־Nextcloud. ניתן למצוא מידע נוסף ב<a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">תיעוד</a> שלנו.",
    "Memcached is configured as distributed cache, but the wrong PHP module \"memcache\" is installed. \\OC\\Memcache\\Memcached only supports \"memcached\" and not \"memcache\". See the <a target=\"_blank\" rel=\"noreferrer\" href=\"{wikiLink}\">memcached wiki about both modules</a>." : "Memcached מוגדר כמטמון מופץ, אבל מודול ה־PHP השגוי המותקן הוא „memcache”.‏ ‎\\OC\\Memcache\\Memcached תומך רק ב־„memcached” ולא ב־ „memcache”. ניתן לצפות ב<a target=\"_blank\" rel=\"noreferrer\" href=\"{wikiLink}\">וויקי של memcached לגבי שני המודולים</a>.",
    ...
    "The PHP OPcache is not properly configured. <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">For better performance we recommend</a> to use following settings in the <code>php.ini</code>:" : "ה־OPcache של PHP אינו מוגדר כראוי. <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">לשיפור הביצועים אנו ממליצים</a> להשתמש בהגדרות הבאות בקובץ <code>php.ini</code>:",
    "The PHP function \"set_time_limit\" is not available. This could result in scripts being halted mid-execution, breaking your installation. We strongly recommend enabling this function." : "פונקציית ה־PHP‏ „set_time_limit” אינה זמינה. מצב זה עשוי לגרום לעצירת סקריפטים באמצע הפעולה ולפגיעה בהתקנה שלך. אנו ממליצים בחום להפעיל את התכונה הזאת.",
    ...
    "The \"{header}\" HTTP header is not configured to equal to \"{expected}\". This is a potential security or privacy risk and we recommend adjusting this setting." : "כותרת ה־HTTP‏ „{header}” אינה מוגדרת כך שתהיה שווה לערך „{expected}”. מדובר בפרצת אבטחה או פרטיות פוטנציאלית ואנו ממליצים להתאים את ההגדרה הזאת בהתאם.",
