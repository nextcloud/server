OC.L10N.register(
    ...
    "No suitable source for randomness found by PHP which is highly discouraged for security reasons. Further information can be found in the <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{docLink}\">documentation</a>." : "אין מקור מתאים לאקראיות שנמצא על ידי PHP, שמאוד לא מומלץ מטעמי אבטחה. מידע נוסף ניתן למצוא בתיעוד.",
    ...
    "You are accessing your instance over a secure connection, however your instance is generating insecure URLs. This most likely means that you are behind a reverse proxy and the overwrite config variables are not set correctly. Please read <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{docLink}\">the documentation page about this</a>." : "אתה ניגש למופע שלך באמצעות חיבור מאובטח, אולם המופע שלך מייצר כתובות אתרים לא מאובטחות. ככל הנראה פירוש הדבר שאתה עומד מאחורי שרת reverse proxy, ומשתני ה-overwrite config אינם מוגדרים בצורה נכונה. אנא קרא את דף התיעוד בנושא זה.",
    "Error occurred while checking server setup" : "שגיאה אירעה בזמן בדיקת התקנת השרת",
    "For more details see the <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"{docLink}\">documentation</a>." : "לפרטים נוספים, עיין בתיעוד.",
