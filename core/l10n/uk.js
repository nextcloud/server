OC.L10N.register(
    ...
    "Shared with you and the group {group} by {owner}" : " {owner} поділився з вами та групою {group}",
    "Shared with you and {circle} by {owner}" : "{owner} поділився з вами та колом {circle}",
