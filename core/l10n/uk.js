OC.L10N.register(
    ...
    "No memory cache has been configured. To enhance your performance please configure a memcache if available. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "Кешування пам'яті не налаштовано. Для покращення швидкодії, будь ласка, налаштуйте кеш пам'яті. Детальну інформацію можна знайти у нашій <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">документації</a>",
    ...
    "can delete" : "можна видалити",
    "access control" : "контроль доступу",
    "Share with users or by mail..." : "Поділитись з користувачами або через пошту...",
    "Share with users or remote users..." : "Поділитись з користувачами або віддаленими користувачами...",
    "Share with users, remote users or by mail..." : "Поділитись з користувачами, віддаленими користувачами або через пошту...",
    ...
    "The update was successful. Redirecting you to Nextcloud now." : "Оновлення було успішним. Зараз відбудеться перенаправлення до Nextcloud.",
