OC.L10N.register(
    ...
    "No valid filters provided" : "Не надано дійсні фільтри",
    ...
    "Update app \"%s\" from App Store" : "Оновлення застосунку \"%s\" з App Store",
    ...
    "Set log level to debug" : "Встановлення рівня деталізації журналу у налагодження",
    ...
    "Share with others" : "Поділитися з іншими",
    "Can view" : "Може переглядати",
    "Expiration date" : "Термін дії",
    "Your administrator has enforced a %d days expiration policy." : "Ваш адміністратор визначив термін давності у %d днів.",
    "Label" : "Мітка",
    "Note to recipients" : "Нотатка отримувачам",
    "Password" : "Пароль",
    ...
    "Use {productName} mobile client you want to connect to scan the code" : "Відскануйте QR-код мобільним застосунком {productName}, який ви бажаєте під'єднати.",
    "Code will expire {timeCountdown} or after use" : "Термін дії коду спливе {timeCountdown} або після використання.",
    ...
    "Less from connected services" : "Менше від під'єднаних служб",
    "More from connected services" : "Більше від під'єднаних служб",
    ...
    "Remove filter: {name}" : "Прибрати фільтр: {name}",
    ...
    "Searching …" : "Шукаю...",
    "_Showing %n result from {name}_::_Showing %n results from {name}_" : ["Показано %n результат від {name}","Показано %n результати від {name}","Показано %n результатів від {name}","Показано %n результатів від {name}"],
    "_%n result_::_%n results_" : ["%n результат","%n результати","%n результатів","%n результатів"],
    "Today" : "Сьогодні",
    ...
    "People" : "Користувачі",
    "Results" : "Результат",
    "Back to all results" : "Назад до всіх результатів",
    "Back" : "Назад",
    "Partial matches" : "Частковий збіг",
    "More from {name}" : "Більше від {name}",
    ...
    "Loading more results …" : "Завантажено більше результатів ...",
    ...
    "Your guest name: {user}" : "Ваше ім'я гостя: {user}",
    ...
    "The update completed with warnings. Please check the details for more information." : "Оновлення виконано із застереженнями. Перегляньте деталі для отримання додаткової інформації.",
    "The update completed successfully." : "Оновлення успішно виконано.",
    "Preparing update…" : "Підготовка до оновлення",
    "You will be redirected to {productName} in {count} seconds." : "Переспрямування до {productName} за {count} сек.",
    ...
    "{productName} will be updated to version {version}" : "{productName} буде оновлено до версії {version}",
    "The theme {oldTheme} has been disabled." : "Тема {oldTheme} є неактивною.",
    "These incompatible apps will be disabled:" : "Такі несумісні застосунки буде вимкнено:",
    "Incompatible apps" : "Несумісні застосунки",
    "These apps will be updated:" : "Ці застосунки буде оновлено:",
    "Apps to update" : "Застосунки до оновлення",
    "{app} from {oldVersion} to {version}" : "{app} із {oldVersion} до {version}",
    ...
    "Unknown password strength" : "Невідома ефективність пароля",
