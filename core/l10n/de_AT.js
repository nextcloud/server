OC.L10N.register(
    ...
    "The reverse proxy headers configuration is incorrect, or you are accessing Nextcloud from a trusted proxy. If you are not accessing Nextcloud from a trusted proxy, this is a security issue and can allow an attacker to spoof their IP address as visible to Nextcloud. Further information can be found in our <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">documentation</a>." : "Die Header-Einstellungen des Reverse Proxy sind falsch, oder du versuchst, dich mit Nextcloud von einem vertrauten Proxy aus zu verbinden. Solltest du Nextcloud nicht von einem vertrauten Proxy aus benutzen wollen, dann stellt die momentane Situation ein Sicherheitsproblem da und erlaubt Hackern, eine für Nextcloud sichtbare IP-Adresse zu nutzen. Weitere Informationen findest du in der <a target=\"_blank\" rel=\"noreferrer\" href=\"{docLink}\">Dokumentation</a>.",
    ...
    "Share" : "Teilen",
    "Share with people on other Nextclouds using the syntax username@example.com/nextcloud" : "Mit Benutzern anderer Nextclouds unter Verwendung der Syntax benutzername@beispiel.com/nextcloud teilen",
