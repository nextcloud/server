...
"_%n minute ago_::_%n minutes ago_" => array("pre %n minuta","pre %n minuta","pre %n minuta"),
"_%n hour ago_::_%n hours ago_" => array("pre %n sat","pre %n sati","pre %n sati"),
"today" => "Danas",
"yesterday" => "juče",
"_%n day ago_::_%n days ago_" => array("Pre %n dan.","Pre %n dana.","Pre %n dana."),
