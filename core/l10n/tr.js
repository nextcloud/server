OC.L10N.register(
    ...
    "Sharing is not allowed." : "Paylaşıma izin verilmiyor.",
    "Sharing is not allowed for you." : "Paylaşım yapmanıza izin verilmiyor.",
    ...
    "Group sharing is not allowed." : "Grup paylaşımına izin verilmiyor.",
    "Public link sharing is not allowed." : "Herkese açık bağlantı paylaşımına izin verilmiyor.",
    "Sharing to remote users is not allowed." : "Uzak kullanıcılar ile paylaşıma izin verilmiyor.",
    "Sharing to remote groups is not allowed." : "Uzak gruplar ile paylaşıma izin verilmiyor.",
    ...
    "Your administrator has enforced a %d days expiration policy." : "Yöneticiniz geçerlilik sonu ilkesini %d gün olarak zorunlu kılmış.",
    "Label" : "Etiket",
    "Note to recipients" : "Alıcılara not",
    "Password" : "Parola",
    ...
    "Excel spreadsheet" : "Excel elektronik tablosu",
    "Excel add-in" : "Excel eklentisi",
    "Excel 2007 binary spreadsheet" : "Excel 2007 binary elektronik tablosu",
    "Excel spreadsheet template" : "Excel elektronik tablosu kalıbı",
    ...
    "ODS spreadsheet" : "ODS elektronik tablosu",
    "ODS spreadsheet (Flat XML)" : "ODS elektronik tablosu (Düz XML)",
    ...
    "Excel 2007 spreadsheet" : "Excel 2007 elektronik tablosu",
    "Excel 2007 spreadsheet template" : "Excel 2007 elektronik tablosu kalıbı",
    ...
    "Show QR code for mobile app login" : "Mobil uygulama oturumu açmak için kare kodu görüntüle",
    "Done" : "Tamam",
    ...
    "Remove filter: {name}" : "Süzgeci kaldır: {name}",
    "Apps, files, messages, and more" : "Uygulamalar, dosyalar, iletiler ve diğerleri",
    "Filters" : "Süzgeçler",
    "Clear search" : "Aramayı temizle",
    "Close search" : "Aramayı kapat",
    "Start typing to search" : "Aramak için yazmaya başlayın",
    "_Minimum search length is %n character_::_Minimum search length is %n characters_" : ["En az %n karakter ile arama yapılabilir","En az %n karakter ile arama yapılabilir"],
    "No matching results" : "Aramaya uyan bir sonuç bulunamadı",
    "Searching …" : "Aranıyor…",
    "_Showing %n result from {name}_::_Showing %n results from {name}_" : ["{name} üzerinden %n sonuç görüntüleniyor","{name} üzerinden %n sonuç görüntüleniyor"],
    "_%n result_::_%n results_" : ["%n sonuç","%n sonuç"],
    "Today" : "Bugün",
    ...
    "People" : "Kişiler",
    "Results" : "Sonuçlar",
    "Back to all results" : "Tüm sonuçlara dön",
    "Back" : "Geri",
    "Partial matches" : "Bir parçası uyanlar",
    "More from {name}" : "{name} üzerinden diğerleri",
    ...
    "Too many failed login attempts from your location. Try again in 30 seconds." : "Konumunuzdan çok sayıda başarısız oturum açma denemesi yapıldı. Lütfen 30 saniye sonra yeniden deneyin.",
    ...
    "Collaborative documents, spreadsheets and presentations, built on Collabora Online." : "Collabora Online üzerinde hazırlanmış iş birlikli belgeler, elektronik tablolar ve sunumlar.",
    "Distraction free note taking app." : "Dikkatinizi dağıtmayan not alma uygulaması.",
    "Password confirmation was aborted" : "Parola onayı iptal edildi",
    ...
    "App already installed" : "Uygulama zaten kurulmuş",
    ...
    "For information how to properly configure your server, please {linkStart}see the documentation{linkEnd}" : "Sunucunuzu nasıl yapılandıracağınız ile ilgili bilgi almak için {linkStart}belgelere bakabilirsiniz{linkEnd}",
    ...
    "localhost" : "localhost",
    "Encrypted database connection" : "Şifreli veri tabanı bağlantısı",
    "Supported modes: disable, allow, prefer, require, verify-ca, verify-full." : "Desteklenen kipler: disable, allow, prefer, require, verify-ca, verify-full.",
    "Encryption mode" : "Şifreleme kipi",
    "Has to be readable by the web server." : "İnternet sunucusu tarafından okunabilir olmalıdır.",
    "CA certificate path" : "CA sertifikası yolu",
    "Client certificate path" : "İstemci sertifikası yolu",
    "Client certificate key path" : "İstemci sertifikası anahtarı yolu",
    "Certificate revocation list path" : "Sertifika geçersiz kılma yolu",
    "Do not verify that the server certificate matches the database host" : "Sunucu sertifikasının veri tabanı sunucusuyla eşleştiği doğrulanmasın",
    ...
    "Failed to create a project" : "Bir proje oluşturulamadı",
    ...
    "Close \"{dialogTitle}\" dialog" : "\"{dialogTitle}\" iletişim kutusunu kapat",
