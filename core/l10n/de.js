OC.L10N.register(
    ...
    "An error occurred. Please contact your admin." : "Ein Fehler ist aufgetreten. Bitte kontaktieren Sie Ihren Administrator.",
    ...
    "Couldn't send reset email. Please make sure your username is correct." : "E-Mail zum Zurücksetzen kann nicht versendet werden. Bitte überprüfen Sie Ihren Benutzernamen.",
    "Could not send reset email because there is no email address for this username. Please contact your administrator." : "Es konnte keine E-Mail verschickt werden um das Passwort zurückzusetzten, da keine E-Mail im Benutzerkonto hinterlegt ist. Bitte kontaktieren Sie Ihren Administrator.",
    ...
    "Please contact the server administrator if this error reappears multiple times, please include the technical details below in your report." : "Bitte wenden Sie sich an den Serveradministrator, sollte dieser Fehler mehrfach auftreten, und fügen Sie Ihrer Anfrage die untenstehenden technischen Details bei.",
    ...
    "Enhanced security has been enabled for your account. Please authenticate using a second factor." : "Die erweiterte Sicherheit wurde für Ihr Konto aktiviert. Bitte authentifizieren Sie sich mit der zweiten Stufe.",
