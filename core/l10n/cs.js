OC.L10N.register(
    ...
    "No valid filters provided" : "Neposkytnuty žádné platné filtry",
    ...
    "Log out" : "Odhlásit se",
    "Sharing is not allowed." : "Sdílení neni povoleno.",
    "Sharing is not allowed for you." : "Tomuto účtu není povoleno sdílení.",
    "Sharing is only allowed with group members." : "Sdílení je povoleno pouze se členy skupin.",
    "Sharing is only allowed within your own groups." : "Sdílení je povoleno pouze se členy skupin, kterých jste členy.",
    "Group sharing is not allowed." : "Skupinové sdílení není povoleno.",
    "Public link sharing is not allowed." : "Sdílení pomocí veřejných odkazů není povoleno.",
    "Sharing to remote users is not allowed." : "Sdílení vzdáleným uživatelům není povoleno.",
    "Sharing to remote groups is not allowed." : "Sdílení vzdáleným skupinám není povoleno.",
    ...
    "Share with others" : "Sdílet s ostatními",
    "Can view" : "Může zobrazovat",
    "Expiration date" : "Datum skončení platnosti",
    "Your administrator has enforced a %d days expiration policy." : "Váš správce vynutil zásadu skončení platnosti za %d dní.",
    "Label" : "Štítek",
    "Note to recipients" : "Poznámka příjemcům",
    "Password" : "Heslo",
    ...
    "AVI video" : "AVI video",
    "Show QR code for mobile app login" : "Zobrazit QR kód pro přihlášení do mobilní aplikace",
    "Done" : "Dokončeno",
    ...
    "Settings" : "Settings",
    "Open apps menu, currently in {app}" : "Otevřít nabídku aplikací, aktuálně v {app}",
    ...
    "Direct link copied" : "Přímý odkaz zkopírován",
    ...
    "Remove filter: {name}" : "Odebrat filtr: {name}",
    "Apps, files, messages, and more" : "Aplikace, soubory, zprávy a další",
    "Filters" : "Filtry",
    ...
    "_Minimum search length is %n character_::_Minimum search length is %n characters_" : ["Minimální délka vyhledávání je %n znak","Minimální délka vyhledávání je %n znaků","Minimální délka vyhledávání je %n znaků","Minimální délka vyhledávání je %n znaků"],
    "Searching …" : "Hledání …",
    "No matching results" : "Žádné odpovídající výsledky",
    "_%n result_::_%n results_" : ["%n výsledek","%n výsledky","%n výsledků","%n výsledků"],
    "Today" : "Dnes",
    ...
    "Too many failed login attempts from your location. Try again in 30 seconds." : "Příliš mnoho neúspěšných pokusů o přihlášení z vaší polohy. Zkuste to znovu za 30 sekund.",
    ...
    "Password confirmation was aborted" : "Potvrzení hesla bylo zrušeno",
    ...
    "Submit" : "Odeslat",
    "If the email address was correct then you will receive an email with the password." : "Pokud byla e-mailová adresa správná, obdržíte e-mail s heslem.",
    ...
    "You will be redirected to {productName} in {count} seconds." : "Za {count} sekund budete přesměrováni do {productName}.",
    ...
    "{productName} will be updated to version {version}" : "{productName} bude zaktualizován na verzi {version}",
    "The theme {oldTheme} has been disabled." : "Motiv vzhledu {oldTheme} byl vypnut.",
    "These incompatible apps will be disabled:" : "Tyto nekompatibilní aplikace budou vypnuty:",
    "Incompatible apps" : "Nekompatibilní aplikace",
    "These apps will be updated:" : "Tyto aplikace budou aktualizovány:",
    "Apps to update" : "Aplikace s aktualizacemi",
