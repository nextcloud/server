OC.L10N.register(
    ...
    "Checking for update of app \"%s\" in App Store" : "Проверка за ажурирање на апликација \"%s\" во продавницата",
    "Update app \"%s\" from App Store" : "Ажурирање на апликација \"%s\" од продавницата",
    "Checked for update of app \"%s\" in App Store" : "Проверка за ажурирање на апликација \"%s\" во appstore",
