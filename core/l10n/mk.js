OC.L10N.register(
    ...
    "<strong>Create an admin account</strong>" : "<strong>Креирај администраторска смета</strong>",
    "New admin account name" : "Нова администраторска сметка",
    "New admin password" : "Лозинка на нова администраторска сметка",
    ...
    "Database account" : "Сметка на база на податоци",
    "Installing …" : "Инсталирање ...",
