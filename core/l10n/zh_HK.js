OC.L10N.register(
    ...
    "Can view" : "可檢視",
    "Expiration date" : "到期日",
    "Your administrator has enforced a %d days expiration policy." : "您的管理員已強制執行 %d 天過期政策。",
    "Label" : "標籤",
    ...
    "Settings" : "設定",
    "Profile" : "個人設定",
    "Open apps menu, currently in {app}" : "開啟應用程式選項單，目前位於 {app}",
    ...
    "Connected services settings" : "已連線服務的設定",
    ...
    "Apps, files, messages, and more" : "應用程式、檔案、訊息及更多",
    "Filters" : "過濾",
    "Clear search" : "清除搜尋",
    "Close search" : "關閉搜尋",
    ...
    "Submit" : "遞交",
    "If the email address was correct then you will receive an email with the password." : "如果電郵地址正確，您將會收到一封包含密碼的電子郵件。",
    ...
    "Client certificate path" : "客戶端證書途徑",
    "Client certificate key path" : "客戶證書密鑰路徑",
    "Certificate revocation list path" : "證書撤銷清單途徑",
