OC.L10N.register(
    ...
    "No valid filters provided" : "有効なフィルターがありません",
    ...
    "Learn more ↗" : "もっと詳しく知る",
    "Can edit" : "編集可能",
    "Share with others" : "他の人に共有",
    "Can view" : "閲覧可能",
    "Expiration date" : "有効期限",
    "Your administrator has enforced a %d days expiration policy." : "管理者が有効期限を%d日に設定しています。",
    "Label" : "ラベル",
    ...
    "AVI video" : "AVI ビデオ",
    "Show QR code for mobile app login" : "モバイルアプリログインのQRコードを表示する",
    "Done" : "完了",
    ...
    "Settings" : "設定",
    "Profile" : "プロフィール",
    "Open apps menu, currently in {app}" : "アプリメニューを開く、現在{app}を開いています",
    ...
    "Remove filter: {name}" : "フィルターを解除：{name}",
    "Apps, files, messages, and more" : "アプリ、ファイル、メッセージなど",
    "Filters" : "フィルター",
    "Clear search" : "検索をクリア",
    "Close search" : "検索を閉じる",
    "Start typing to search" : "入力して検索を開始します",
    "_Minimum search length is %n character_::_Minimum search length is %n characters_" : ["検索の最小長は%n文字です"],
    "No matching results" : "一致する結果はありません",
    "Less from connected services" : "接続済みサービスからの表示を減らす",
    "More from connected services" : "関連サービスのその他の情報",
    "Searching …" : "検索しています…",
    "_Showing %n result from {name}_::_Showing %n results from {name}_" : ["{name}から %n件の結果を表示しています"],
    "_%n result_::_%n results_" : ["結果"],
    "Today" : "今日",
    "Last 7 days" : "7日以内",
    "Last 30 days" : "30日以内",
    "This year" : "今年",
    ...
    "People" : "ユーザー",
    "Results" : "結果",
    "Back to all results" : "すべての検索結果に戻る",
    "Back" : "戻る",
    "Partial matches" : "部分一致",
    "More from {name}" : "{name}からの詳細",
    ...
    "Too many failed login attempts from your location. Try again in 30 seconds." : "お使いの場所からのログイン失敗回数が上限を超えました。30秒後に再度お試しください。",
    ...
    "Mute all notifications" : "全ての通知をミュートします",
    "Invisible" : "オフライン",
    ...
    "localhost" : "localhost",
    "Encrypted database connection" : "暗号化されたデータベース接続",
    "Supported modes: disable, allow, prefer, require, verify-ca, verify-full." : "サポートされているモード：disable、allow、prefer、require、verify-ca、verify-full。",
    "Encryption mode" : "暗号化モード",
    "Has to be readable by the web server." : "Webサーバーが読み取れる形式でなければならない。",
    "CA certificate path" : "CA証明書のパス",
    "Client certificate path" : "クライアント証明書のパス",
    "Client certificate key path" : "クライアント証明書キーのパス",
    "Certificate revocation list path" : "証明書失効リストのパス",
    "Do not verify that the server certificate matches the database host" : "サーバー証明書がデータベースのホストと一致しているかどうかを確認しないでください",
    ...
    "Remove filter: {text}" : "フィルターを解除：{text}",
