OC.L10N.register(
    ...
    "The file was uploaded" : "فایل بارگذاری شد.",
    ...
    "Invalid app password" : "گذرواژه برنامه نامعتبر است.",
    "Could not complete login" : "ورود کامل نشد.",
    ...
    "Could not reset password because the token is expired" : "گذرواژه بازنشانی نشد، چون توکن منقضی شده است.",
    "Could not reset password because the token is invalid" : "گذرواژه بازنشانی نشد، چون توکن نامعتبر است.",
    "Password is too long. Maximum allowed length is 469 characters." : "گذرواژه بیش از حد طولانی است. حداکثر طول مجاز ۴۶۹ نویسه است.",
    ...
    "Not found" : "پیدا نشد.",
    "Node is locked" : "مورد قفل شده است.",
    ...
    "No text to image provider is available" : "هیچ ارائه‌دهنده تبدیل متن به تصویر در دسترس نیست.",
    ...
    "No valid filters provided" : "هیچ فیلتر معتبری ارائه نشده است.",
    ...
    "Update app \"%s\" from App Store" : "به‌روزرسانی برنامه «%s» از فروشگاه برنامه‌ها",
    ...
    "Updated \"%1$s\" to %2$s" : "«%1$s» به %2$s به‌روز شد.",
    ...
    "Nextcloud Server" : "سرور Nextcloud",
    "Some of your link shares have been removed" : "برخی از اشتراک‌گذاری‌های پیوندی شما حذف شده‌اند.",
    "Due to a security bug we had to remove some of your link shares. Please see the link for more information." : "به دلیل یک اشکال امنیتی ناچار شدیم برخی از اشتراک‌گذاری‌های پیوندی شما را حذف کنیم. برای اطلاعات بیشتر، پیوند را ببینید.",
    "The account limit of this instance is reached." : "محدودیت حساب این نمونه به پایان رسیده است.",
    "Enter your subscription key in the support app in order to increase the account limit. This does also grant you all additional benefits that Nextcloud Enterprise offers and is highly recommended for the operation in companies." : "کلید اشتراک خود را در برنامه پشتیبانی وارد کنید تا محدودیت حساب افزایش یابد. این کار همچنین همه مزایای اضافی Nextcloud Enterprise را در اختیار شما قرار می‌دهد و برای استفاده در شرکت‌ها بسیار توصیه می‌شود.",
    ...
    "Use {productName} mobile client you want to connect to scan the code" : "برای اسکن کد، از کلاینت موبایل {productName} که می‌خواهید متصل شود استفاده کنید",
    "Code will expire {timeCountdown} or after use" : "کد پس از {timeCountdown} یا بعد از استفاده منقضی می‌شود",
    "_{count} notification_::_{count} notifications_" : ["{count} اعلان.","{count} اعلان."],
    "More apps" : "برنامه های بیشتر",
    "App store" : "فروشگاه برنامه‌ها",
    "Settings" : "تنظیمات",
    "Open apps menu, currently in {app}" : "باز کردن منوی برنامه‌ها؛ اکنون در {app}",
    ...
    "Search apps, files, tags, messages …" : "جست‌وجوی برنامه‌ها، فایل‌ها، برچسب‌ها، پیام‌ها …",
    ...
    "Minimum search length is {minSearchLength} characters" : "حداقل طول جست‌وجو {minSearchLength} نویسه است",
    ...
    "Search connected services" : "جست‌وجوی سرویس‌های متصل",
    "Results" : "نتایج.",
    ...
    "Wrong login or password." : "نام ورود یا گذرواژه اشتباه است.",
    "This account is disabled" : "این حساب کاربری غیرفعال است.",
    "Too many incorrect login attempts. Please try again in 30 seconds." : "تلاش‌های ناموفق برای ورود بیش از حد است. لطفاً ۳۰ ثانیه دیگر دوباره امتحان کنید.",
    ...
    "Login or email" : "نام ورود یا ایمیل",
    "Your account is not setup for passwordless login." : "حساب شما برای ورود بدون گذرواژه تنظیم نشده است.",
    "Your connection is not secure" : "اتصال شما امن نیست.",
    "Passwordless authentication is only available over a secure connection." : "احراز هویت بدون گذرواژه فقط از طریق اتصال امن در دسترس است.",
    "Browser not supported" : "مرورگر پشتیبانی نمی‌شود.",
    "Passwordless authentication is not supported in your browser." : "احراز هویت بدون گذرواژه در مرورگر شما پشتیبانی نمی‌شود.",
    "Reset password" : "تنظیم مجدد رمز عبور",
    "Back to login" : "بازگشت به ورود.",
    "If this account exists, a password reset message has been sent to its email address. If you do not receive it, verify your email address and/or Login, check your spam/junk folders or ask your local administration for help." : "اگر این حساب وجود داشته باشد، پیامی برای بازنشانی گذرواژه به نشانی ایمیل آن ارسال شده است. اگر آن را دریافت نکردید، نشانی ایمیل یا نام ورود خود را بررسی کنید، پوشه‌های هرزنامه را ببینید یا از مدیر محلی کمک بخواهید.",
    ...
    "Password cannot be changed. Please contact your administrator." : "گذرواژه قابل تغییر نیست. لطفاً با مدیر سامانه تماس بگیرید.",
    "New password" : "گذرواژه جدید",
    "Your files are encrypted. There will be no way to get your data back after your password is reset. If you are not sure what to do, please contact your administrator before you continue. Do you really want to continue?" : "فایل‌های شما رمزگذاری شده‌اند. پس از بازنشانی گذرواژه شما، هیچ راهی برای بازیابی اطلاعات شما وجود نخواهد داشت. اگر مطمئن نیستید که چه کاری باید انجام دهید، لطفاً قبل از ادامه با مدیر خود تماس بگیرید. آیا واقعاً می‌خواهید ادامه دهید؟",
    "I know what I'm doing" : "اطلاع از انجام این کار دارم",
    "Resetting password" : "در حال بازنشانی گذرواژه …",
    "Schedule work & meetings, synced with all your devices." : "زمان‌بندی کار و جلسات، همگام‌سازی‌شده با تمام دستگاه‌های شما.",
    "Keep your colleagues and friends in one place without leaking their private info." : "همکاران و دوستان خود را بدون افشای اطلاعات خصوصی‌شان در یک جا نگه دارید.",
    ...
    "Loading your contacts …" : "در حال بارگذاری مخاطبان شما …",
    "Looking for {term} …" : "در حال جست‌وجوی {term} …",
    "Search contacts" : "جستجوی مخاطبین.",
    "Filter by team" : "فیلتر بر اساس تیم",
    "All teams" : "همه تیم‌ها",
    "Search contacts in team {team}" : "جست‌وجوی مخاطبان در تیم {team}",
    ...
    "Please log in before granting \"{client}\" access to your {instanceName} account." : "پیش از اعطای دسترسی «{client}» به حساب {instanceName} خود وارد شوید.",
    ...
    "Log in using password" : "ورود با گذرواژه",
    ...
    "You are about to grant \"{client}\" access to your {instanceName} account." : "می‌خواهید به «{client}» اجازه دسترسی به حساب {instanceName} خود را بدهید.",
    "More actions" : "اقدامات بیشتر.",
    "User menu" : "منوی کاربر",
    "Your guest name: {user}" : "نام مهمان شما: {user}",
    "You are currently not identified." : "در حال حاضر شناسایی نشده‌اید.",
    "Set public name" : "تنظیم نام عمومی",
    "Change public name" : "تغییر نام عمومی",
    "This share is password-protected" : "این اشتراک با گذرواژه محافظت می‌شود",
    "The password is wrong or expired. Please try again or request a new one." : "گذرواژه اشتباه است یا منقضی شده است. لطفاً دوباره تلاش کنید یا گذرواژه جدیدی درخواست دهید.",
    "Submit" : "ارسال",
    "If the email address was correct then you will receive an email with the password." : "اگر نشانی ایمیل درست باشد، ایمیلی حاوی گذرواژه دریافت خواهید کرد.",
    ...
    "Password is too weak" : "گذرواژه بسیار ضعیف است.",
    "Password is weak" : "گذرواژه ضعیف است.",
    "Password is average" : "گذرواژه متوسط است.",
    "Password is strong" : "گذرواژه قوی است.",
    "Password is very strong" : "گذرواژه بسیار قوی است.",
    "Password is extremely strong" : "گذرواژه فوق‌العاده قوی است.",
    "Unknown password strength" : "قدرت گذرواژه ناشناخته است.",
    ...
    "For information how to properly configure your server, please {linkStart}see the documentation{linkEnd}" : "برای آگاهی از روش درست پیکربندی سرور، لطفاً {linkStart}مستندات را ببینید{linkEnd}.",
    ...
    "Administration account password" : "گذرواژه حساب مدیریت",
    ...
    "SQLite should only be used for minimal and development instances. For production we recommend a different database backend." : "SQLite فقط باید برای نمونه‌های کوچک و محیط توسعه استفاده شود. برای محیط عملیاتی، یک backend پایگاه داده دیگر را توصیه می‌کنیم.",
    ...
    "The update completed with warnings. Please check the details for more information." : "به‌روزرسانی با هشدارهایی کامل شد. برای اطلاعات بیشتر جزئیات را بررسی کنید.",
    "The update completed successfully." : "به‌روزرسانی با موفقیت کامل شد.",
    "Preparing update…" : "در حال آماده‌سازی به‌روزرسانی…",
    "You will be redirected to {productName} in {count} seconds." : "تا {count} ثانیه دیگر به {productName} هدایت می‌شوید.",
    ...
    "Apps to update" : "برنامه‌های آماده به‌روزرسانی",
    "{app} from {oldVersion} to {version}" : "{app} از {oldVersion} به {version}",
    ...
    "To avoid timeouts with larger installations, you can instead run the following command from your installation directory:" : "برای جلوگیری از timeout در نصب‌های بزرگ‌تر، می‌توانید فرمان زیر را از پوشه نصب خود اجرا کنید:",
    ...
    "Type to search for existing projects" : "برای جست‌وجوی پروژه‌های موجود تایپ کنید",
    ...
    "You are not allowed to access this page." : "اجازه دسترسی به این صفحه را ندارید.",
    ...
    "Line: %s" : "خط: %s",
    "Trace" : "ردیابی",
    "It looks like you are trying to reinstall your Nextcloud. However the file CAN_INSTALL is missing from your config directory. Please create the file CAN_INSTALL in your config folder to continue." : "به نظر می‌رسد می‌خواهید Nextcloud خود را دوباره نصب کنید. با این حال فایل CAN_INSTALL در پوشه پیکربندی شما وجود ندارد. برای ادامه، فایل CAN_INSTALL را در پوشه پیکربندی ایجاد کنید.",
    ...
    "This application requires JavaScript for correct operation. Please {linkstart}enable JavaScript{linkend} and reload the page." : "این برنامه برای کارکرد درست به JavaScript نیاز دارد. لطفاً {linkstart}JavaScript را فعال کنید{linkend} و صفحه را دوباره بارگیری کنید.",
    ...
    "We have detected multiple invalid login attempts from your IP. Therefore your next login is throttled up to 30 seconds." : "از این IP چندین تلاش نامعتبر برای ورود شناسایی شده است؛ بنابراین ورود بعدی شما تا ۳۰ ثانیه محدود می‌شود.",
    "Loading apps …" : "در حال بارگذاری برنامه‌ها …",
    "Installing apps …" : "در حال نصب برنامه‌ها …",
    ...
    "Please log in before granting %1$s access to your %2$s account." : "پیش از اعطای دسترسی %1$s به حساب %2$s خود وارد شوید.",
    "Currently logged in as %1$s (%2$s)." : "در حال حاضر با نام %1$s (%2$s) وارد شده‌اید.",
    "You are about to grant %1$s access to your %2$s account." : "می‌خواهید به %1$s اجازه دسترسی به حساب %2$s خود را بدهید.",
    ...
    "For help, see the  <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">documentation</a>." : "برای راهنمایی، <a target=\"_blank\" rel=\"noreferrer noopener\" href=\"%s\">مستندات</a> را ببینید.",
    "Groups" : "گروه ها",
