OC.L10N.register(
    ...
    "can delete" : "می توان حذف کرد",
    "access control" : "کنترل دسترسی",
    "Share with users or by mail..." : "اشتراک گذاری با استفاده کنندگان یا با ایمیل ...",
    "Share with users or remote users..." : "اشتراک گذاری با استفاده کنندگان یا استفاده کنندگان دور ...",
    "Share with users, remote users or by mail..." : "اشتراک گذاری با استفاده کنندگان یا استفاده کنندگان دور یا با ایمیل ...",
    "Share with users or groups..." : "اشتراک گذاری با استفاده کنندگان یا گروه ها ...",
    ...
    "Cheers!" : "سلامتی!",
    "For information how to properly configure your server, please see the <a href=\"%s\" target=\"_blank\" rel=\"noreferrer\">documentation</a>." : "برای اطلاعات نحوه درست تنظیم سرور <a href=\"%s\" target=\"_blank\" rel=\"noreferrer\">مستندات </a> را بررسی کنید",
    "Log out" : "خروج",
    "This action requires you to confirm your password:" : "این اقدام نیاز به تایید رمز عبور شما دارد",
