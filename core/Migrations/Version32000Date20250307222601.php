...
class Version32000Date20250307222601 extends SimpleMigrationStep {
	public function changeSchema(IOutput $output, Closure $schemaClosure, array $options): ?ISchemaWrapper {
		...
		$table->addColumn('etime', Types::SMALLINT, ['notnull' => true, 'default' => 0, 'unsigned' => true]);
		...
		$table->setPrimaryKey(['id'], 'asy_tas_id');

		$table->addIndex(['token'], 'asy_tas_tok');
		$table->addIndex(['status'], 'asy_tas_sta');
